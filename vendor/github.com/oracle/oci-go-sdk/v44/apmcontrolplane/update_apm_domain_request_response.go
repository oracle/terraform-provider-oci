...
func (request UpdateApmDomainRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser) (http.Request, error) {
...
type UpdateApmDomainResponse struct {
