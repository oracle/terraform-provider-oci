...
// CreateConnectionFromBicc The details to create an Oracle Database data asset connection.
...
func (m CreateConnectionFromBicc) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateConnectionFromBicc CreateConnectionFromBicc
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeCreateConnectionFromBicc
	}{
		"BICC_CONNECTION",
		(MarshalTypeCreateConnectionFromBicc)(m),
	}
