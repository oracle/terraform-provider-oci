...
// ConnectionSummaryFromBicc The connection summary details for an Oracle Database data asset.
...
func (m ConnectionSummaryFromBicc) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeConnectionSummaryFromBicc ConnectionSummaryFromBicc
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeConnectionSummaryFromBicc
	}{
		"BICC_CONNECTION",
		(MarshalTypeConnectionSummaryFromBicc)(m),
	}
