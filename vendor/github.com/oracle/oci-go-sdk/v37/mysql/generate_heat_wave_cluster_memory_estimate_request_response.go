...
func (request GenerateHeatWaveClusterMemoryEstimateRequest) HTTPRequest(method, path string) (http.Request, error) {
...
type GenerateHeatWaveClusterMemoryEstimateResponse struct {
