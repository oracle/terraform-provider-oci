...
// AssociatedResourceCollection A collection of resource using a Operation Insights private endpoint.
type AssociatedResourceCollection struct {

	// A list of resource using a Operation Insights private endpoint.
