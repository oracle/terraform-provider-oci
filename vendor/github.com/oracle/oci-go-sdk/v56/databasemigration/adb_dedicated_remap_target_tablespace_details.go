...
func (m AdbDedicatedRemapTargetTablespaceDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAdbDedicatedRemapTargetTablespaceDetails AdbDedicatedRemapTargetTablespaceDetails
	s := struct {
		DiscriminatorParam string `json:"targetType"`
		MarshalTypeAdbDedicatedRemapTargetTablespaceDetails
	}{
		"ADB_D_REMAP",
		(MarshalTypeAdbDedicatedRemapTargetTablespaceDetails)(m),
	}
