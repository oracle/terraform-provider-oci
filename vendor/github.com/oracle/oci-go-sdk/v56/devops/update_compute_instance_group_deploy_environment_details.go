...
func (m UpdateComputeInstanceGroupDeployEnvironmentDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateComputeInstanceGroupDeployEnvironmentDetails UpdateComputeInstanceGroupDeployEnvironmentDetails
	s := struct {
		DiscriminatorParam string `json:"deployEnvironmentType"`
		MarshalTypeUpdateComputeInstanceGroupDeployEnvironmentDetails
	}{
		"COMPUTE_INSTANCE_GROUP",
		(MarshalTypeUpdateComputeInstanceGroupDeployEnvironmentDetails)(m),
	}
