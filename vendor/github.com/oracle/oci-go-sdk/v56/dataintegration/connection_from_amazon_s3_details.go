...
func (m ConnectionFromAmazonS3Details) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeConnectionFromAmazonS3Details ConnectionFromAmazonS3Details
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeConnectionFromAmazonS3Details
	}{
		"AMAZON_S3_CONNECTION",
		(MarshalTypeConnectionFromAmazonS3Details)(m),
	}
