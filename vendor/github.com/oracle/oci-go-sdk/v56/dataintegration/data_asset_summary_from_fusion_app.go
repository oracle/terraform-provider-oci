...
func (m DataAssetSummaryFromFusionApp) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDataAssetSummaryFromFusionApp DataAssetSummaryFromFusionApp
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeDataAssetSummaryFromFusionApp
	}{
		"FUSION_APP_DATA_ASSET",
		(MarshalTypeDataAssetSummaryFromFusionApp)(m),
	}
