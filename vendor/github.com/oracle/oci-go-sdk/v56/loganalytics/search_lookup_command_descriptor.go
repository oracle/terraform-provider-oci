...
func (m SearchLookupCommandDescriptor) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeSearchLookupCommandDescriptor SearchLookupCommandDescriptor
	s := struct {
		DiscriminatorParam string `json:"name"`
		MarshalTypeSearchLookupCommandDescriptor
	}{
		"SEARCH_LOOKUP",
		(MarshalTypeSearchLookupCommandDescriptor)(m),
	}
