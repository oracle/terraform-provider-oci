...
func (request UpdateTagRuleRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request UpdateTagRuleRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request UpdateTagRuleRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
