...
func (m UpdateClientVpnDetails) ValidateEnumValue() (bool, error) {
	...
	if _, ok := GetMappingUpdateClientVpnDetailsAddressingModeEnum(string(m.AddressingMode)); !ok && m.AddressingMode != "" {
...
var mappingUpdateClientVpnDetailsAddressingModeEnumLowerCase = map[string]UpdateClientVpnDetailsAddressingModeEnum{
	"nat":     UpdateClientVpnDetailsAddressingModeNat,
	"routing": UpdateClientVpnDetailsAddressingModeRouting,
}
...
// GetMappingUpdateClientVpnDetailsAddressingModeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingUpdateClientVpnDetailsAddressingModeEnum(val string) (UpdateClientVpnDetailsAddressingModeEnum, bool) {
	enum, ok := mappingUpdateClientVpnDetailsAddressingModeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
