...
func (request ListDrgsByStatesRequest) ValidateEnumValue() (bool, error) {
	...
	if _, ok := GetMappingListDrgsByStatesSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
	...
	if _, ok := GetMappingListDrgsByStatesSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
...
var mappingListDrgsByStatesSortByEnumLowerCase = map[string]ListDrgsByStatesSortByEnum{
	"timecreated": ListDrgsByStatesSortByTimecreated,
	"displayname": ListDrgsByStatesSortByDisplayname,
}
...
// GetMappingListDrgsByStatesSortByEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListDrgsByStatesSortByEnum(val string) (ListDrgsByStatesSortByEnum, bool) {
	enum, ok := mappingListDrgsByStatesSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListDrgsByStatesSortOrderEnumLowerCase = map[string]ListDrgsByStatesSortOrderEnum{
	"asc":  ListDrgsByStatesSortOrderAsc,
	"desc": ListDrgsByStatesSortOrderDesc,
}
...
// GetMappingListDrgsByStatesSortOrderEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListDrgsByStatesSortOrderEnum(val string) (ListDrgsByStatesSortOrderEnum, bool) {
	enum, ok := mappingListDrgsByStatesSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
