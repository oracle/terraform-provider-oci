...
func (request ListReverseConnectionNatIpsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListReverseConnectionNatIpsSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
	...
	if _, ok := GetMappingListReverseConnectionNatIpsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
	...
	if _, ok := GetMappingReverseConnectionNatIpLifecycleStateEnum(string(request.LifecycleState)); !ok && request.LifecycleState != "" {
...
var mappingListReverseConnectionNatIpsSortByEnumLowerCase = map[string]ListReverseConnectionNatIpsSortByEnum{
	"timecreated": ListReverseConnectionNatIpsSortByTimecreated,
	"displayname": ListReverseConnectionNatIpsSortByDisplayname,
}
...
// GetMappingListReverseConnectionNatIpsSortByEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListReverseConnectionNatIpsSortByEnum(val string) (ListReverseConnectionNatIpsSortByEnum, bool) {
	enum, ok := mappingListReverseConnectionNatIpsSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListReverseConnectionNatIpsSortOrderEnumLowerCase = map[string]ListReverseConnectionNatIpsSortOrderEnum{
	"asc":  ListReverseConnectionNatIpsSortOrderAsc,
	"desc": ListReverseConnectionNatIpsSortOrderDesc,
}
...
// GetMappingListReverseConnectionNatIpsSortOrderEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListReverseConnectionNatIpsSortOrderEnum(val string) (ListReverseConnectionNatIpsSortOrderEnum, bool) {
	enum, ok := mappingListReverseConnectionNatIpsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
