...
func (m OkeCanaryApprovalDeployStageSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOkeCanaryApprovalDeployStageSummary OkeCanaryApprovalDeployStageSummary
	s := struct {
		DiscriminatorParam string `json:"deployStageType"`
		MarshalTypeOkeCanaryApprovalDeployStageSummary
	}{
		"OKE_CANARY_APPROVAL",
		(MarshalTypeOkeCanaryApprovalDeployStageSummary)(m),
	}
