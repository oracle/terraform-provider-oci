...
func (m OkeBlueGreenTrafficShiftDeployStageSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOkeBlueGreenTrafficShiftDeployStageSummary OkeBlueGreenTrafficShiftDeployStageSummary
	s := struct {
		DiscriminatorParam string `json:"deployStageType"`
		MarshalTypeOkeBlueGreenTrafficShiftDeployStageSummary
	}{
		"OKE_BLUE_GREEN_TRAFFIC_SHIFT",
		(MarshalTypeOkeBlueGreenTrafficShiftDeployStageSummary)(m),
	}
