...
func newLoadBalancerClientFromBaseClient(baseClient common.BaseClient, configProvider common.ConfigurationProvider) (client LoadBalancerClient, err error) {
	// LoadBalancer service default circuit breaker is enabled
...
func (client LoadBalancerClient) createCidrBlocks(ctx context.Context, request common.OCIRequest, binaryReqBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (common.OCIResponse, error) {

	httpRequest, err := request.HTTPRequest(http.MethodPost, "/loadBalancers/{loadBalancerId}/cidrBlocks", binaryReqBody, extraHeaders)
	if err != nil {
		return nil, err
	}
...
func (client LoadBalancerClient) deleteCidrBlocks(ctx context.Context, request common.OCIRequest, binaryReqBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (common.OCIResponse, error) {

	httpRequest, err := request.HTTPRequest(http.MethodDelete, "/loadBalancers/{loadBalancerId}/cidrBlocks/{name}", binaryReqBody, extraHeaders)
	if err != nil {
		return nil, err
	}
...
func (client LoadBalancerClient) getCidrBlocks(ctx context.Context, request common.OCIRequest, binaryReqBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (common.OCIResponse, error) {

	httpRequest, err := request.HTTPRequest(http.MethodGet, "/loadBalancers/{loadBalancerId}/cidrBlocks/{name}", binaryReqBody, extraHeaders)
	if err != nil {
		return nil, err
	}
...
func (client LoadBalancerClient) listCidrBlocks(ctx context.Context, request common.OCIRequest, binaryReqBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (common.OCIResponse, error) {

	httpRequest, err := request.HTTPRequest(http.MethodGet, "/loadBalancers/{loadBalancerId}/cidrBlocks", binaryReqBody, extraHeaders)
	if err != nil {
		return nil, err
	}
...
func (client LoadBalancerClient) updateCidrBlocks(ctx context.Context, request common.OCIRequest, binaryReqBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (common.OCIResponse, error) {

	httpRequest, err := request.HTTPRequest(http.MethodPut, "/loadBalancers/{loadBalancerId}/cidrBlocks/{name}", binaryReqBody, extraHeaders)
	if err != nil {
		return nil, err
	}
