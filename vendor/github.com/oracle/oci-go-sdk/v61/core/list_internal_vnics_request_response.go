...
func (request ListInternalVnicsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListInternalVnicsSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
	...
	if _, ok := GetMappingListInternalVnicsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
	...
	if _, ok := GetMappingInternalVnicLifecycleStateEnum(string(request.LifecycleState)); !ok && request.LifecycleState != "" {
...
var mappingListInternalVnicsSortByEnumLowerCase = map[string]ListInternalVnicsSortByEnum{
	"timecreated": ListInternalVnicsSortByTimecreated,
	"displayname": ListInternalVnicsSortByDisplayname,
}
...
// GetMappingListInternalVnicsSortByEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListInternalVnicsSortByEnum(val string) (ListInternalVnicsSortByEnum, bool) {
	enum, ok := mappingListInternalVnicsSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
// GetMappingListInternalVnicsSortOrderEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListInternalVnicsSortOrderEnum(val string) (ListInternalVnicsSortOrderEnum, bool) {
	enum, ok := mappingListInternalVnicsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
