...
// ApiPublication API Publication associated with a catalog.
type ApiPublication struct {
	...
	// URL safe title of the API as defined in the Open API Specification.
	TitleSlug *string `mandatory:"false" json:"titleSlug"`

	// URL safe version of the API as defined in the Open API Specification.
	VersionSlug *string `mandatory:"false" json:"versionSlug"`
}

func (m ApiPublication) String() string {
...
func (m ApiPublication) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
