...
func (request GetApmDomainRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser) (http.Request, error) {
...
type GetApmDomainResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The ApmDomain instance
	ApmDomain `presentIn:"body"`
