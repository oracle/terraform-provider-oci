...
type GenerateDataKeysRequest struct {
...
func (request GenerateDataKeysRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser) (http.Request, error) {
...
type GenerateDataKeysResponse struct {
