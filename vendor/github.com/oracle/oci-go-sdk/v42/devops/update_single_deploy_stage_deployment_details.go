...
func (m UpdateSingleDeployStageDeploymentDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateSingleDeployStageDeploymentDetails UpdateSingleDeployStageDeploymentDetails
	s := struct {
		DiscriminatorParam string `json:"deploymentType"`
		MarshalTypeUpdateSingleDeployStageDeploymentDetails
	}{
		"SINGLE_STAGE_DEPLOYMENT",
		(MarshalTypeUpdateSingleDeployStageDeploymentDetails)(m),
	}
