...
func (request ListBlockchainPlatformPatchesRequest) String() string {
...
func (request ListBlockchainPlatformPatchesRequest) RetryPolicy() *common.RetryPolicy {
...
func (response ListBlockchainPlatformPatchesResponse) String() string {
