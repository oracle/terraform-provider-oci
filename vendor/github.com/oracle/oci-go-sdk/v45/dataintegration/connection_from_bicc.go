...
// ConnectionFromBicc The connection details for an Oracle Database data asset.
...
func (m ConnectionFromBicc) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeConnectionFromBicc ConnectionFromBicc
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeConnectionFromBicc
	}{
		"BICC_CONNECTION",
		(MarshalTypeConnectionFromBicc)(m),
	}
