...
func (m TcpTrafficProtocolParameters) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeTcpTrafficProtocolParameters TcpTrafficProtocolParameters
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeTcpTrafficProtocolParameters
	}{
		"TCP",
		(MarshalTypeTcpTrafficProtocolParameters)(m),
	}
