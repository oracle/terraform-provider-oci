...
func (m LoopBackDrgAttachmentNetworkCreateDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m LoopBackDrgAttachmentNetworkCreateDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeLoopBackDrgAttachmentNetworkCreateDetails LoopBackDrgAttachmentNetworkCreateDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeLoopBackDrgAttachmentNetworkCreateDetails
	}{
		"LOOPBACK",
		(MarshalTypeLoopBackDrgAttachmentNetworkCreateDetails)(m),
	}
