...
// PrivateIpNextHopConfiguration The data to create private IP's nextHop configuration.
type PrivateIpNextHopConfiguration struct {
...
func (m PrivateIpNextHopConfiguration) String() string {
...
func (m PrivateIpNextHopConfiguration) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
