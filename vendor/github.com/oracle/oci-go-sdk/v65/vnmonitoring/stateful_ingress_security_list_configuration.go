...
func (m StatefulIngressSecurityListConfiguration) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeStatefulIngressSecurityListConfiguration StatefulIngressSecurityListConfiguration
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeStatefulIngressSecurityListConfiguration
	}{
		"STATEFUL_INGRESS_SECURITY_LIST",
		(MarshalTypeStatefulIngressSecurityListConfiguration)(m),
	}
