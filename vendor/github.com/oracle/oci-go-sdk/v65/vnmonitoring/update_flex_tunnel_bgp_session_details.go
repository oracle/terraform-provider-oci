...
// UpdateFlexTunnelBgpSessionDetails Boarder Gateway Protocol (BGP) fields
type UpdateFlexTunnelBgpSessionDetails struct {
...
func (m UpdateFlexTunnelBgpSessionDetails) String() string {
...
func (m UpdateFlexTunnelBgpSessionDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
