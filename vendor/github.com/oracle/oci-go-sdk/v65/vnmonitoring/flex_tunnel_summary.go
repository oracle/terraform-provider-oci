...
// FlexTunnelSummary Summary of FlexTunnel.
type FlexTunnelSummary struct {
...
func (m FlexTunnelSummary) String() string {
...
func (m FlexTunnelSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
