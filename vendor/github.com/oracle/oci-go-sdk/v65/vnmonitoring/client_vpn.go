...
type ClientVpn struct {
	...
	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that user sent request.
	CompartmentId *string `mandatory:"true" json:"compartmentId"`

	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of clientVPNEndpoint.
	Id *string `mandatory:"true" json:"id"`

	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the attachedSubnet (VNIC) in customer tenancy.
...
func (m ClientVpn) ValidateEnumValue() (bool, error) {
	...
	if _, ok := GetMappingClientVpnLifecycleStateEnum(string(m.LifecycleState)); !ok && m.LifecycleState != "" {
	...
	if _, ok := GetMappingClientVpnAddressingModeEnum(string(m.AddressingMode)); !ok && m.AddressingMode != "" {
	...
	if _, ok := GetMappingClientVpnAuthenticationModeEnum(string(m.AuthenticationMode)); !ok && m.AuthenticationMode != "" {
...
var mappingClientVpnLifecycleStateEnumLowerCase = map[string]ClientVpnLifecycleStateEnum{
	"creating": ClientVpnLifecycleStateCreating,
	"active":   ClientVpnLifecycleStateActive,
	"inactive": ClientVpnLifecycleStateInactive,
	"failed":   ClientVpnLifecycleStateFailed,
...
// GetMappingClientVpnLifecycleStateEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingClientVpnLifecycleStateEnum(val string) (ClientVpnLifecycleStateEnum, bool) {
	enum, ok := mappingClientVpnLifecycleStateEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingClientVpnAddressingModeEnumLowerCase = map[string]ClientVpnAddressingModeEnum{
	"nat":     ClientVpnAddressingModeNat,
	"routing": ClientVpnAddressingModeRouting,
}
...
// GetMappingClientVpnAddressingModeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingClientVpnAddressingModeEnum(val string) (ClientVpnAddressingModeEnum, bool) {
	enum, ok := mappingClientVpnAddressingModeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingClientVpnAuthenticationModeEnumLowerCase = map[string]ClientVpnAuthenticationModeEnum{
	"local":  ClientVpnAuthenticationModeLocal,
	"radius": ClientVpnAuthenticationModeRadius,
	"ldap":   ClientVpnAuthenticationModeLdap,
}
...
// GetMappingClientVpnAuthenticationModeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingClientVpnAuthenticationModeEnum(val string) (ClientVpnAuthenticationModeEnum, bool) {
	enum, ok := mappingClientVpnAuthenticationModeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
