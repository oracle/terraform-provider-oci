...
func (client OpensearchClusterPipelineClient) StartPipeline(ctx context.Context, request StartPipelineRequest) (response StartPipelineResponse, err error) {
	var ociResponse common.OCIResponse
	policy := common.NoRetryPolicy()
	if client.RetryPolicy() != nil {
		policy = *client.RetryPolicy()
...
func (client OpensearchClusterPipelineClient) startPipeline(ctx context.Context, request common.OCIRequest, binaryReqBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (common.OCIResponse, error) {

	httpRequest, err := request.HTTPRequest(http.MethodPut, "/opensearchClusterPipelines/{opensearchClusterPipelineId}/actions/startPipeline", binaryReqBody, extraHeaders)
	if err != nil {
		return nil, err
	}
	...
	response.RawResponse = httpResponse
	if err != nil {
		apiReferenceLink := "https://docs.oracle.com/iaas/api/#/en/opensearch/20180828/OpensearchClusterPipeline/StartPipeline"
		err = common.PostProcessServiceError(err, "OpensearchClusterPipeline", "StartPipeline", apiReferenceLink)
		return response, err
	}
...
func (client OpensearchClusterPipelineClient) StopPipeline(ctx context.Context, request StopPipelineRequest) (response StopPipelineResponse, err error) {
	var ociResponse common.OCIResponse
	policy := common.NoRetryPolicy()
	if client.RetryPolicy() != nil {
		policy = *client.RetryPolicy()
...
func (client OpensearchClusterPipelineClient) stopPipeline(ctx context.Context, request common.OCIRequest, binaryReqBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (common.OCIResponse, error) {

	httpRequest, err := request.HTTPRequest(http.MethodPut, "/opensearchClusterPipelines/{opensearchClusterPipelineId}/actions/stopPipeline", binaryReqBody, extraHeaders)
	if err != nil {
		return nil, err
	}
	...
	response.RawResponse = httpResponse
	if err != nil {
		apiReferenceLink := "https://docs.oracle.com/iaas/api/#/en/opensearch/20180828/OpensearchClusterPipeline/StopPipeline"
		err = common.PostProcessServiceError(err, "OpensearchClusterPipeline", "StopPipeline", apiReferenceLink)
		return response, err
	}
