...
func (m ApiSchemaObjectStorageInputLocation) String() string {
...
func (m ApiSchemaObjectStorageInputLocation) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeApiSchemaObjectStorageInputLocation ApiSchemaObjectStorageInputLocation
	s := struct {
		DiscriminatorParam string `json:"apiSchemaInputLocationType"`
		MarshalTypeApiSchemaObjectStorageInputLocation
	}{
		"OBJECT_STORAGE_LOCATION",
		(MarshalTypeApiSchemaObjectStorageInputLocation)(m),
	}
