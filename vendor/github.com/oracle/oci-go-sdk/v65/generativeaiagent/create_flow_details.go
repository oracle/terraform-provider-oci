...
// CreateFlowDetails The data to create a Flow.
type CreateFlowDetails struct {

	// The OCID of the agent that this Flow is attached to.
	AgentId *string `mandatory:"true" json:"agentId"`

	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the associated agent's compartment. Make sure the compartment is same as the associated agent's compartment.
...
func (m CreateFlowDetails) String() string {
...
func (m CreateFlowDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *CreateFlowDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {
