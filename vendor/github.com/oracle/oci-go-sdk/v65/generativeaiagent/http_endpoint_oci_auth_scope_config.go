...
// HttpEndpointOciAuthScopeConfig Specifies authentication for invoking OCI-protected services using Oracle IAM.
...
func (m HttpEndpointOciAuthScopeConfig) String() string {
...
func (m HttpEndpointOciAuthScopeConfig) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeHttpEndpointOciAuthScopeConfig HttpEndpointOciAuthScopeConfig
	s := struct {
		DiscriminatorParam string `json:"httpEndpointAuthScopeConfigType"`
		MarshalTypeHttpEndpointOciAuthScopeConfig
	}{
		"HTTP_ENDPOINT_OCI_AUTH_SCOPE_CONFIG",
		(MarshalTypeHttpEndpointOciAuthScopeConfig)(m),
	}
