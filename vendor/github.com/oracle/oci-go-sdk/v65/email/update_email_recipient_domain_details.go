...
// UpdateEmailRecipientDomainDetails The attributes to update in the recipient domain.
type UpdateEmailRecipientDomainDetails struct {

	// A string that describes the details about the recipient domain. It does not have to be unique,
...
func (m UpdateEmailRecipientDomainDetails) String() string {
...
func (m UpdateEmailRecipientDomainDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
