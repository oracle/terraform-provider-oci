...
type EmailTrackConfig struct {
	...
	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the email domain resource to which this email tracking configuration applies.
