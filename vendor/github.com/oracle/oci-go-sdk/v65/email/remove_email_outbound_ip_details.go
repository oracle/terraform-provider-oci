...
// RemoveEmailOutboundIpDetails Outbound IP details to be unassigned from the IpPool.
type RemoveEmailOutboundIpDetails struct {
...
func (m RemoveEmailOutboundIpDetails) String() string {
...
func (m RemoveEmailOutboundIpDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
