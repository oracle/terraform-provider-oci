...
// CreateEmailDeliveryConfigIpAssociationDetails Details for creating EmailDeliveryConfig and Outbound IP association.
type CreateEmailDeliveryConfigIpAssociationDetails struct {
...
func (m CreateEmailDeliveryConfigIpAssociationDetails) String() string {
...
func (m CreateEmailDeliveryConfigIpAssociationDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
