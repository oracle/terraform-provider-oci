...
type CreateEmailTrackConfigDetails struct {
	...
	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the email domain resource on which email tracking should be configured.
