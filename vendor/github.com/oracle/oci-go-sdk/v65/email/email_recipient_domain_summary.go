...
// EmailRecipientDomainSummary The properties that define a Recipient Domain.
type EmailRecipientDomainSummary struct {

	// The name of the recipient domain in the Internet Domain Name System (DNS).
	// The recipient domain name must be globally unique for this tenancy.
	...
	// The time of the last change to the Recipient Domain, due to a state change or
	// an update operation.
	// Times are expressed in RFC 3339 (https://tools.ietf.org/html/rfc3339)
	// timestamp format, "YYYY-MM-ddThh:mmZ".
...
func (m EmailRecipientDomainSummary) String() string {
...
func (m EmailRecipientDomainSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
