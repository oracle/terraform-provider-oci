...
// CreateEmailRecipientDomainDetails Properties to create a new recipient domain.
type CreateEmailRecipientDomainDetails struct {
...
func (m CreateEmailRecipientDomainDetails) String() string {
...
func (m CreateEmailRecipientDomainDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
