...
// CreateLinuxContainerInstanceSecurityContextDetails Security context for all containers in a Linux container instance.
type CreateLinuxContainerInstanceSecurityContextDetails struct {
...
func (m CreateLinuxContainerInstanceSecurityContextDetails) String() string {
...
func (m CreateLinuxContainerInstanceSecurityContextDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateLinuxContainerInstanceSecurityContextDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateLinuxContainerInstanceSecurityContextDetails CreateLinuxContainerInstanceSecurityContextDetails
	s := struct {
		DiscriminatorParam string `json:"securityContextType"`
		MarshalTypeCreateLinuxContainerInstanceSecurityContextDetails
	}{
		"LINUX",
		(MarshalTypeCreateLinuxContainerInstanceSecurityContextDetails)(m),
	}
