...
// VbsAccessTokenConfigurationSourceProviderSummary Summary information for a configuration source provider of the type `VBS_ACCESS_TOKEN`.
// This type corresponds to a configuration source provider in VB Studio that is authenticated with a personal access token.
type VbsAccessTokenConfigurationSourceProviderSummary struct {
...
//GetId returns Id
func (m VbsAccessTokenConfigurationSourceProviderSummary) GetId() *string {
	return m.Id
}

//GetCompartmentId returns CompartmentId
func (m VbsAccessTokenConfigurationSourceProviderSummary) GetCompartmentId() *string {
	return m.CompartmentId
}

//GetDisplayName returns DisplayName
func (m VbsAccessTokenConfigurationSourceProviderSummary) GetDisplayName() *string {
	return m.DisplayName
}

//GetDescription returns Description
func (m VbsAccessTokenConfigurationSourceProviderSummary) GetDescription() *string {
	return m.Description
}

//GetTimeCreated returns TimeCreated
func (m VbsAccessTokenConfigurationSourceProviderSummary) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

//GetLifecycleState returns LifecycleState
func (m VbsAccessTokenConfigurationSourceProviderSummary) GetLifecycleState() ConfigurationSourceProviderLifecycleStateEnum {
	return m.LifecycleState
}

//GetPrivateServerConfigDetails returns PrivateServerConfigDetails
func (m VbsAccessTokenConfigurationSourceProviderSummary) GetPrivateServerConfigDetails() *PrivateServerConfigDetails {
	return m.PrivateServerConfigDetails
}

//GetFreeformTags returns FreeformTags
func (m VbsAccessTokenConfigurationSourceProviderSummary) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

//GetDefinedTags returns DefinedTags
func (m VbsAccessTokenConfigurationSourceProviderSummary) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

func (m VbsAccessTokenConfigurationSourceProviderSummary) String() string {
...
func (m VbsAccessTokenConfigurationSourceProviderSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m VbsAccessTokenConfigurationSourceProviderSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeVbsAccessTokenConfigurationSourceProviderSummary VbsAccessTokenConfigurationSourceProviderSummary
	s := struct {
		DiscriminatorParam string `json:"configSourceProviderType"`
		MarshalTypeVbsAccessTokenConfigurationSourceProviderSummary
	}{
		"VBS_ACCESS_TOKEN",
		(MarshalTypeVbsAccessTokenConfigurationSourceProviderSummary)(m),
	}
