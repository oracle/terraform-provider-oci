...
// VbsAccessTokenConfigurationSourceProvider The properties that define a configuration source provider of the type `VBS_ACCESS_TOKEN`.
// This type corresponds to a configuration source provider in VB Studio that is authenticated with a personal access token.
type VbsAccessTokenConfigurationSourceProvider struct {
...
//GetId returns Id
func (m VbsAccessTokenConfigurationSourceProvider) GetId() *string {
	return m.Id
}

//GetCompartmentId returns CompartmentId
func (m VbsAccessTokenConfigurationSourceProvider) GetCompartmentId() *string {
	return m.CompartmentId
}

//GetDisplayName returns DisplayName
func (m VbsAccessTokenConfigurationSourceProvider) GetDisplayName() *string {
	return m.DisplayName
}

//GetDescription returns Description
func (m VbsAccessTokenConfigurationSourceProvider) GetDescription() *string {
	return m.Description
}

//GetTimeCreated returns TimeCreated
func (m VbsAccessTokenConfigurationSourceProvider) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

//GetLifecycleState returns LifecycleState
func (m VbsAccessTokenConfigurationSourceProvider) GetLifecycleState() ConfigurationSourceProviderLifecycleStateEnum {
	return m.LifecycleState
}

//GetPrivateServerConfigDetails returns PrivateServerConfigDetails
func (m VbsAccessTokenConfigurationSourceProvider) GetPrivateServerConfigDetails() *PrivateServerConfigDetails {
	return m.PrivateServerConfigDetails
}

//GetUsername returns Username
func (m VbsAccessTokenConfigurationSourceProvider) GetUsername() *string {
	return m.Username
}

//GetSecretId returns SecretId
func (m VbsAccessTokenConfigurationSourceProvider) GetSecretId() *string {
	return m.SecretId
}

//GetFreeformTags returns FreeformTags
func (m VbsAccessTokenConfigurationSourceProvider) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

//GetDefinedTags returns DefinedTags
func (m VbsAccessTokenConfigurationSourceProvider) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

func (m VbsAccessTokenConfigurationSourceProvider) String() string {
...
func (m VbsAccessTokenConfigurationSourceProvider) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m VbsAccessTokenConfigurationSourceProvider) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeVbsAccessTokenConfigurationSourceProvider VbsAccessTokenConfigurationSourceProvider
	s := struct {
		DiscriminatorParam string `json:"configSourceProviderType"`
		MarshalTypeVbsAccessTokenConfigurationSourceProvider
	}{
		"VBS_ACCESS_TOKEN",
		(MarshalTypeVbsAccessTokenConfigurationSourceProvider)(m),
	}
