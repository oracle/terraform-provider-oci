...
// CreateMarketplaceExternalAttestedMetadataDetails Payload that customer will use to generate JWT for launched instance associated with Marketplace listing
type CreateMarketplaceExternalAttestedMetadataDetails struct {
...
func (m CreateMarketplaceExternalAttestedMetadataDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
