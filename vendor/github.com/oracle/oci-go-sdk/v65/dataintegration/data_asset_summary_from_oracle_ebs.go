...
func (m DataAssetSummaryFromOracleEbs) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDataAssetSummaryFromOracleEbs DataAssetSummaryFromOracleEbs
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeDataAssetSummaryFromOracleEbs
	}{
		"ORACLE_EBS_DATA_ASSET",
		(MarshalTypeDataAssetSummaryFromOracleEbs)(m),
	}
