...
func (m UpdateConnectionFromMySqlHeatWave) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateConnectionFromMySqlHeatWave UpdateConnectionFromMySqlHeatWave
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeUpdateConnectionFromMySqlHeatWave
	}{
		"MYSQL_HEATWAVE_CONNECTION",
		(MarshalTypeUpdateConnectionFromMySqlHeatWave)(m),
	}
