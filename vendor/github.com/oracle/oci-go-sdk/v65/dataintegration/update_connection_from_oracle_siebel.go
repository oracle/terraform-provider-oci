...
func (m UpdateConnectionFromOracleSiebel) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateConnectionFromOracleSiebel UpdateConnectionFromOracleSiebel
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeUpdateConnectionFromOracleSiebel
	}{
		"ORACLE_SIEBEL_CONNECTION",
		(MarshalTypeUpdateConnectionFromOracleSiebel)(m),
	}
