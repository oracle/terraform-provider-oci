...
func (m CreateDataAssetFromMySqlHeatWave) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDataAssetFromMySqlHeatWave CreateDataAssetFromMySqlHeatWave
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeCreateDataAssetFromMySqlHeatWave
	}{
		"MYSQL_HEATWAVE_DATA_ASSET",
		(MarshalTypeCreateDataAssetFromMySqlHeatWave)(m),
	}
