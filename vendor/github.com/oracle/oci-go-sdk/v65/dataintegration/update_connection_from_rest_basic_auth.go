...
func (m UpdateConnectionFromRestBasicAuth) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateConnectionFromRestBasicAuth UpdateConnectionFromRestBasicAuth
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeUpdateConnectionFromRestBasicAuth
	}{
		"REST_BASIC_AUTH_CONNECTION",
		(MarshalTypeUpdateConnectionFromRestBasicAuth)(m),
	}
