...
func (m ConnectionFromMySqlHeatWaveDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeConnectionFromMySqlHeatWaveDetails ConnectionFromMySqlHeatWaveDetails
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeConnectionFromMySqlHeatWaveDetails
	}{
		"MYSQL_HEATWAVE_CONNECTION",
		(MarshalTypeConnectionFromMySqlHeatWaveDetails)(m),
	}
