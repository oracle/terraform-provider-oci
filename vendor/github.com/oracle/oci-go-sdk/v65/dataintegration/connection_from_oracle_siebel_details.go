...
func (m ConnectionFromOracleSiebelDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeConnectionFromOracleSiebelDetails ConnectionFromOracleSiebelDetails
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeConnectionFromOracleSiebelDetails
	}{
		"ORACLE_SIEBEL_CONNECTION",
		(MarshalTypeConnectionFromOracleSiebelDetails)(m),
	}
