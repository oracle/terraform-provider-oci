...
func (m ConnectionSummaryFromOraclePeopleSoft) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeConnectionSummaryFromOraclePeopleSoft ConnectionSummaryFromOraclePeopleSoft
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeConnectionSummaryFromOraclePeopleSoft
	}{
		"ORACLE_PEOPLESOFT_CONNECTION",
		(MarshalTypeConnectionSummaryFromOraclePeopleSoft)(m),
	}
