...
type RegistrationEvent struct {
	...
	Data *RegistrationEventData `mandatory:"true" json:"data"`
...
// GetId returns Id
func (m RegistrationEvent) GetId() *string {
	return m.Id
}

// GetEventSummary returns EventSummary
func (m RegistrationEvent) GetEventSummary() *string {
	return m.EventSummary
}

// GetCompartmentId returns CompartmentId
func (m RegistrationEvent) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetEventSeverity returns EventSeverity
func (m RegistrationEvent) GetEventSeverity() EventSeverityEnum {
	return m.EventSeverity
}

// GetEventDetails returns EventDetails
func (m RegistrationEvent) GetEventDetails() *string {
	return m.EventDetails
}

// GetResourceId returns ResourceId
func (m RegistrationEvent) GetResourceId() *string {
	return m.ResourceId
}

// GetSystemDetails returns SystemDetails
func (m RegistrationEvent) GetSystemDetails() *SystemDetails {
	return m.SystemDetails
}

// GetTimeOccurred returns TimeOccurred
func (m RegistrationEvent) GetTimeOccurred() *common.SDKTime {
	return m.TimeOccurred
}

// GetTimeCreated returns TimeCreated
func (m RegistrationEvent) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m RegistrationEvent) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetLifecycleState returns LifecycleState
func (m RegistrationEvent) GetLifecycleState() EventLifecycleStateEnum {
	return m.LifecycleState
}

// GetLifecycleDetails returns LifecycleDetails
func (m RegistrationEvent) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetIsManagedByAutonomousLinux returns IsManagedByAutonomousLinux
func (m RegistrationEvent) GetIsManagedByAutonomousLinux() *bool {
	return m.IsManagedByAutonomousLinux
}

// GetFreeformTags returns FreeformTags
func (m RegistrationEvent) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m RegistrationEvent) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m RegistrationEvent) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m RegistrationEvent) String() string {
...
func (m RegistrationEvent) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m RegistrationEvent) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeRegistrationEvent RegistrationEvent
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeRegistrationEvent
	}{
		"REGISTRATION",
		(MarshalTypeRegistrationEvent)(m),
	}
