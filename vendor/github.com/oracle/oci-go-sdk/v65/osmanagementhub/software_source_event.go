...
func (m SoftwareSourceEvent) GetEventSeverity() EventSeverityEnum {
...
func (m SoftwareSourceEvent) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeSoftwareSourceEvent SoftwareSourceEvent
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeSoftwareSourceEvent
	}{
		"SOFTWARE_SOURCE",
		(MarshalTypeSoftwareSourceEvent)(m),
	}
