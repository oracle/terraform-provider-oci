...
// CveReport An object that defines a CVE report.
...
// GetId returns Id
func (m CveReport) GetId() *string {
	return m.Id
}

// GetDisplayName returns DisplayName
func (m CveReport) GetDisplayName() *string {
...
func (m CveReport) GetReportVersion() *string {
	return m.ReportVersion
}

// GetDescription returns Description
func (m CveReport) GetDescription() *string {
	return m.Description
}

// GetTimeCreated returns TimeCreated
func (m CveReport) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m CveReport) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetCompartmentIds returns CompartmentIds
func (m CveReport) GetCompartmentIds() []string {
	return m.CompartmentIds
}

// GetIsSubCompartmentIncluded returns IsSubCompartmentIncluded
func (m CveReport) GetIsSubCompartmentIncluded() *bool {
...
func (m CveReport) GetLifecycleState() ReportLifecycleStateEnum {
	return m.LifecycleState
}

// GetLifecycleDetails returns LifecycleDetails
func (m CveReport) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetFreeformTags returns FreeformTags
func (m CveReport) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m CveReport) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m CveReport) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m CveReport) String() string {
...
func (m CveReport) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CveReport) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCveReport CveReport
	s := struct {
		DiscriminatorParam string `json:"reportType"`
		MarshalTypeCveReport
	}{
		"CVE",
		(MarshalTypeCveReport)(m),
	}
