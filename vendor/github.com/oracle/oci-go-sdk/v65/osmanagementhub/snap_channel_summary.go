...
// SnapChannelSummary Provides summary information for a snap channel.
type SnapChannelSummary struct {
...
func (m SnapChannelSummary) String() string {
...
func (m SnapChannelSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
