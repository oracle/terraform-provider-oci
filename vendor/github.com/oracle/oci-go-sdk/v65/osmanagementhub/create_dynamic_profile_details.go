...
func (m CreateDynamicProfileDetails) GetDisplayName() *string {
	return m.DisplayName
}

// GetCompartmentId returns CompartmentId
func (m CreateDynamicProfileDetails) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetDescription returns Description
func (m CreateDynamicProfileDetails) GetDescription() *string {
	return m.Description
}

// GetManagementStationId returns ManagementStationId
func (m CreateDynamicProfileDetails) GetManagementStationId() *string {
	return m.ManagementStationId
}

// GetRegistrationType returns RegistrationType
func (m CreateDynamicProfileDetails) GetRegistrationType() ProfileRegistrationTypeEnum {
	return m.RegistrationType
}

// GetIsDefaultProfile returns IsDefaultProfile
func (m CreateDynamicProfileDetails) GetIsDefaultProfile() *bool {
	return m.IsDefaultProfile
}

// GetFreeformTags returns FreeformTags
func (m CreateDynamicProfileDetails) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m CreateDynamicProfileDetails) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

func (m CreateDynamicProfileDetails) String() string {
...
func (m CreateDynamicProfileDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateDynamicProfileDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDynamicProfileDetails CreateDynamicProfileDetails
	s := struct {
		DiscriminatorParam string `json:"profileType"`
		MarshalTypeCreateDynamicProfileDetails
	}{
		"DYNAMIC",
		(MarshalTypeCreateDynamicProfileDetails)(m),
	}
