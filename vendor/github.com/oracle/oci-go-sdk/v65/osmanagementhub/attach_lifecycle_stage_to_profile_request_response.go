...
type AttachLifecycleStageToProfileRequest struct {
	...
	// The lifecycle stage OCID (https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to attach to the profile
	AttachLifecycleStageToProfileDetails `contributesTo:"body"`
...
type AttachLifecycleStageToProfileResponse struct {
