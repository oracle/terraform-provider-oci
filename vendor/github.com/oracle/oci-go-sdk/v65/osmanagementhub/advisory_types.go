...
var mappingAdvisoryTypesEnum = map[string]AdvisoryTypesEnum{
	"SECURITY":    AdvisoryTypesSecurity,
	"BUGFIX":      AdvisoryTypesBugfix,
	"ENHANCEMENT": AdvisoryTypesEnhancement,
}

var mappingAdvisoryTypesEnumLowerCase = map[string]AdvisoryTypesEnum{
	"security":    AdvisoryTypesSecurity,
	"bugfix":      AdvisoryTypesBugfix,
	"enhancement": AdvisoryTypesEnhancement,
}
...
func GetAdvisoryTypesEnumValues() []AdvisoryTypesEnum {
	values := make([]AdvisoryTypesEnum, 0)
	for _, v := range mappingAdvisoryTypesEnum {
...
func GetMappingAdvisoryTypesEnum(val string) (AdvisoryTypesEnum, bool) {
	enum, ok := mappingAdvisoryTypesEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
