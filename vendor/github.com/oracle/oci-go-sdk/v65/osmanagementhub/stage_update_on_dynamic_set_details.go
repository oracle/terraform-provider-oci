...
// StageUpdateOnDynamicSetDetails Provides the information used to stage updates on a dynamic set.
type StageUpdateOnDynamicSetDetails struct {
...
func (m StageUpdateOnDynamicSetDetails) String() string {
...
func (m StageUpdateOnDynamicSetDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
