...
// VendorSoftwareSource The object that defines a vendor software source. A software source is a collection of packages. For more information, see Managing Software Sources (https://docs.oracle.com/iaas/iaas/osmh/doc/software-sources.htm).
