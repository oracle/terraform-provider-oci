...
// SnapUpdateEvent Provides information for a snap update event.
type SnapUpdateEvent struct {
	...
	Data *SnapUpdateEventData `mandatory:"true" json:"data"`
...
// GetId returns Id
func (m SnapUpdateEvent) GetId() *string {
	return m.Id
}

// GetEventSummary returns EventSummary
func (m SnapUpdateEvent) GetEventSummary() *string {
	return m.EventSummary
}

// GetCompartmentId returns CompartmentId
func (m SnapUpdateEvent) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetEventSeverity returns EventSeverity
func (m SnapUpdateEvent) GetEventSeverity() EventSeverityEnum {
	return m.EventSeverity
}

// GetEventDetails returns EventDetails
func (m SnapUpdateEvent) GetEventDetails() *string {
	return m.EventDetails
}

// GetResourceId returns ResourceId
func (m SnapUpdateEvent) GetResourceId() *string {
	return m.ResourceId
}

// GetSystemDetails returns SystemDetails
func (m SnapUpdateEvent) GetSystemDetails() *SystemDetails {
	return m.SystemDetails
}

// GetTimeOccurred returns TimeOccurred
func (m SnapUpdateEvent) GetTimeOccurred() *common.SDKTime {
	return m.TimeOccurred
}

// GetTimeCreated returns TimeCreated
func (m SnapUpdateEvent) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m SnapUpdateEvent) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetLifecycleState returns LifecycleState
func (m SnapUpdateEvent) GetLifecycleState() EventLifecycleStateEnum {
	return m.LifecycleState
}

// GetLifecycleDetails returns LifecycleDetails
func (m SnapUpdateEvent) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetIsManagedByAutonomousLinux returns IsManagedByAutonomousLinux
func (m SnapUpdateEvent) GetIsManagedByAutonomousLinux() *bool {
	return m.IsManagedByAutonomousLinux
}

// GetFreeformTags returns FreeformTags
func (m SnapUpdateEvent) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m SnapUpdateEvent) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m SnapUpdateEvent) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m SnapUpdateEvent) String() string {
...
func (m SnapUpdateEvent) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m SnapUpdateEvent) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeSnapUpdateEvent SnapUpdateEvent
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeSnapUpdateEvent
	}{
		"SNAP_UPDATE",
		(MarshalTypeSnapUpdateEvent)(m),
	}
