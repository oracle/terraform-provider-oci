...
// WindowsUpdateEvent Provides information for a windows update event.
type WindowsUpdateEvent struct {
	...
	Data *WindowsUpdateEventData `mandatory:"true" json:"data"`
...
// GetId returns Id
func (m WindowsUpdateEvent) GetId() *string {
	return m.Id
}

// GetEventSummary returns EventSummary
func (m WindowsUpdateEvent) GetEventSummary() *string {
	return m.EventSummary
}

// GetCompartmentId returns CompartmentId
func (m WindowsUpdateEvent) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetEventSeverity returns EventSeverity
func (m WindowsUpdateEvent) GetEventSeverity() EventSeverityEnum {
	return m.EventSeverity
}

// GetEventDetails returns EventDetails
func (m WindowsUpdateEvent) GetEventDetails() *string {
	return m.EventDetails
}

// GetResourceId returns ResourceId
func (m WindowsUpdateEvent) GetResourceId() *string {
	return m.ResourceId
}

// GetSystemDetails returns SystemDetails
func (m WindowsUpdateEvent) GetSystemDetails() *SystemDetails {
	return m.SystemDetails
}

// GetTimeOccurred returns TimeOccurred
func (m WindowsUpdateEvent) GetTimeOccurred() *common.SDKTime {
	return m.TimeOccurred
}

// GetTimeCreated returns TimeCreated
func (m WindowsUpdateEvent) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m WindowsUpdateEvent) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetLifecycleState returns LifecycleState
func (m WindowsUpdateEvent) GetLifecycleState() EventLifecycleStateEnum {
	return m.LifecycleState
}

// GetLifecycleDetails returns LifecycleDetails
func (m WindowsUpdateEvent) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetIsManagedByAutonomousLinux returns IsManagedByAutonomousLinux
func (m WindowsUpdateEvent) GetIsManagedByAutonomousLinux() *bool {
	return m.IsManagedByAutonomousLinux
}

// GetFreeformTags returns FreeformTags
func (m WindowsUpdateEvent) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m WindowsUpdateEvent) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m WindowsUpdateEvent) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m WindowsUpdateEvent) String() string {
...
func (m WindowsUpdateEvent) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m WindowsUpdateEvent) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeWindowsUpdateEvent WindowsUpdateEvent
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeWindowsUpdateEvent
	}{
		"WINDOWS_UPDATE",
		(MarshalTypeWindowsUpdateEvent)(m),
	}
