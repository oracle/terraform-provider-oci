...
// StageWindowsUpdatesOnManagedInstanceDetails Provides the information used to download Windows updates on a managed instance.
type StageWindowsUpdatesOnManagedInstanceDetails struct {
...
func (m StageWindowsUpdatesOnManagedInstanceDetails) String() string {
...
func (m StageWindowsUpdatesOnManagedInstanceDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
