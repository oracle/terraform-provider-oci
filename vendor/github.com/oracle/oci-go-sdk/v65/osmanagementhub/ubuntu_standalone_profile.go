...
// UbuntuStandaloneProfile Provides the information for a standalone registration profile.
type UbuntuStandaloneProfile struct {
...
// GetId returns Id
func (m UbuntuStandaloneProfile) GetId() *string {
	return m.Id
}

// GetCompartmentId returns CompartmentId
func (m UbuntuStandaloneProfile) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetDisplayName returns DisplayName
func (m UbuntuStandaloneProfile) GetDisplayName() *string {
	return m.DisplayName
}

// GetDescription returns Description
func (m UbuntuStandaloneProfile) GetDescription() *string {
	return m.Description
}

// GetManagementStationId returns ManagementStationId
func (m UbuntuStandaloneProfile) GetManagementStationId() *string {
	return m.ManagementStationId
}

// GetVendorName returns VendorName
func (m UbuntuStandaloneProfile) GetVendorName() VendorNameEnum {
	return m.VendorName
}

// GetOsFamily returns OsFamily
func (m UbuntuStandaloneProfile) GetOsFamily() OsFamilyEnum {
	return m.OsFamily
}

// GetArchType returns ArchType
func (m UbuntuStandaloneProfile) GetArchType() ArchTypeEnum {
	return m.ArchType
}

// GetTimeCreated returns TimeCreated
func (m UbuntuStandaloneProfile) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeModified returns TimeModified
func (m UbuntuStandaloneProfile) GetTimeModified() *common.SDKTime {
	return m.TimeModified
}

// GetProfileVersion returns ProfileVersion
func (m UbuntuStandaloneProfile) GetProfileVersion() *string {
	return m.ProfileVersion
}

// GetLifecycleState returns LifecycleState
func (m UbuntuStandaloneProfile) GetLifecycleState() ProfileLifecycleStateEnum {
	return m.LifecycleState
}

// GetRegistrationType returns RegistrationType
func (m UbuntuStandaloneProfile) GetRegistrationType() ProfileRegistrationTypeEnum {
	return m.RegistrationType
}

// GetIsDefaultProfile returns IsDefaultProfile
func (m UbuntuStandaloneProfile) GetIsDefaultProfile() *bool {
	return m.IsDefaultProfile
}

// GetIsServiceProvidedProfile returns IsServiceProvidedProfile
func (m UbuntuStandaloneProfile) GetIsServiceProvidedProfile() *bool {
	return m.IsServiceProvidedProfile
}

// GetFreeformTags returns FreeformTags
func (m UbuntuStandaloneProfile) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m UbuntuStandaloneProfile) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m UbuntuStandaloneProfile) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m UbuntuStandaloneProfile) String() string {
...
func (m UbuntuStandaloneProfile) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m UbuntuStandaloneProfile) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUbuntuStandaloneProfile UbuntuStandaloneProfile
	s := struct {
		DiscriminatorParam string `json:"profileType"`
		MarshalTypeUbuntuStandaloneProfile
	}{
		"UBUNTU_STANDALONE",
		(MarshalTypeUbuntuStandaloneProfile)(m),
	}
