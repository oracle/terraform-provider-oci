...
// StageWindowsUpdatesOnManagedInstancesInCompartmentDetails Provides the information used to download Windows updates of a specified type on managed instances within the specified compartment.
type StageWindowsUpdatesOnManagedInstancesInCompartmentDetails struct {
...
func (m StageWindowsUpdatesOnManagedInstancesInCompartmentDetails) String() string {
...
func (m StageWindowsUpdatesOnManagedInstancesInCompartmentDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
