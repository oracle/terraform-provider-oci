...
// RebootDynamicSetDetails Provides the information used for the reboot job.
type RebootDynamicSetDetails struct {
...
func (m RebootDynamicSetDetails) String() string {
...
func (m RebootDynamicSetDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
