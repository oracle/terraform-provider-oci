...
// InstallSnapDetails Provides the information used to install a snap.
type InstallSnapDetails struct {
...
func (m InstallSnapDetails) String() string {
...
func (m InstallSnapDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
