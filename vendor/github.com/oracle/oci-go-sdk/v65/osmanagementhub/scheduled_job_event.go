...
// ScheduledJobEvent Provides information about the scheduled job event.
type ScheduledJobEvent struct {
	...
	Data *ScheduledJobEventData `mandatory:"true" json:"data"`
...
// GetId returns Id
func (m ScheduledJobEvent) GetId() *string {
	return m.Id
}

// GetEventSummary returns EventSummary
func (m ScheduledJobEvent) GetEventSummary() *string {
	return m.EventSummary
}

// GetCompartmentId returns CompartmentId
func (m ScheduledJobEvent) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetEventSeverity returns EventSeverity
func (m ScheduledJobEvent) GetEventSeverity() EventSeverityEnum {
	return m.EventSeverity
}

// GetEventDetails returns EventDetails
func (m ScheduledJobEvent) GetEventDetails() *string {
	return m.EventDetails
}

// GetResourceId returns ResourceId
func (m ScheduledJobEvent) GetResourceId() *string {
	return m.ResourceId
}

// GetSystemDetails returns SystemDetails
func (m ScheduledJobEvent) GetSystemDetails() *SystemDetails {
	return m.SystemDetails
}

// GetTimeOccurred returns TimeOccurred
func (m ScheduledJobEvent) GetTimeOccurred() *common.SDKTime {
	return m.TimeOccurred
}

// GetTimeCreated returns TimeCreated
func (m ScheduledJobEvent) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m ScheduledJobEvent) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetLifecycleState returns LifecycleState
func (m ScheduledJobEvent) GetLifecycleState() EventLifecycleStateEnum {
	return m.LifecycleState
}

// GetLifecycleDetails returns LifecycleDetails
func (m ScheduledJobEvent) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetIsManagedByAutonomousLinux returns IsManagedByAutonomousLinux
func (m ScheduledJobEvent) GetIsManagedByAutonomousLinux() *bool {
	return m.IsManagedByAutonomousLinux
}

// GetFreeformTags returns FreeformTags
func (m ScheduledJobEvent) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m ScheduledJobEvent) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m ScheduledJobEvent) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m ScheduledJobEvent) String() string {
...
func (m ScheduledJobEvent) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m ScheduledJobEvent) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeScheduledJobEvent ScheduledJobEvent
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeScheduledJobEvent
	}{
		"SCHEDULED_JOB",
		(MarshalTypeScheduledJobEvent)(m),
	}
