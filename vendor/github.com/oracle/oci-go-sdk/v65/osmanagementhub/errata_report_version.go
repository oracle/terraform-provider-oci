...
// ErrataReportVersion An object that defines an Errata report with specific version.
type ErrataReportVersion struct {
...
// GetId returns Id
func (m ErrataReportVersion) GetId() *string {
	return m.Id
}

// GetDisplayName returns DisplayName
func (m ErrataReportVersion) GetDisplayName() *string {
...
func (m ErrataReportVersion) GetReportVersion() *string {
	return m.ReportVersion
}

// GetDescription returns Description
func (m ErrataReportVersion) GetDescription() *string {
	return m.Description
}

// GetTimeCreated returns TimeCreated
func (m ErrataReportVersion) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m ErrataReportVersion) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetCompartmentIds returns CompartmentIds
func (m ErrataReportVersion) GetCompartmentIds() []string {
	return m.CompartmentIds
}

// GetIsSubCompartmentIncluded returns IsSubCompartmentIncluded
func (m ErrataReportVersion) GetIsSubCompartmentIncluded() *bool {
	return m.IsSubCompartmentIncluded
}

// GetOsFamilies returns OsFamilies
func (m ErrataReportVersion) GetOsFamilies() []OsFamilyEnum {
	return m.OsFamilies
}
...
func (m ErrataReportVersion) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetFreeformTags returns FreeformTags
func (m ErrataReportVersion) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m ErrataReportVersion) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m ErrataReportVersion) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m ErrataReportVersion) String() string {
...
func (m ErrataReportVersion) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeErrataReportVersion ErrataReportVersion
	s := struct {
		DiscriminatorParam string `json:"reportType"`
		MarshalTypeErrataReportVersion
	}{
		"ERRATA",
		(MarshalTypeErrataReportVersion)(m),
	}
