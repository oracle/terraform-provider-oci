...
// CreateUbuntuStandAloneProfileDetails Provides the information used to create an Ubuntu standalone registration profile.
type CreateUbuntuStandAloneProfileDetails struct {
...
func (m CreateUbuntuStandAloneProfileDetails) GetDisplayName() *string {
	return m.DisplayName
}

// GetCompartmentId returns CompartmentId
func (m CreateUbuntuStandAloneProfileDetails) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetDescription returns Description
func (m CreateUbuntuStandAloneProfileDetails) GetDescription() *string {
	return m.Description
}

// GetManagementStationId returns ManagementStationId
func (m CreateUbuntuStandAloneProfileDetails) GetManagementStationId() *string {
	return m.ManagementStationId
}

// GetRegistrationType returns RegistrationType
func (m CreateUbuntuStandAloneProfileDetails) GetRegistrationType() ProfileRegistrationTypeEnum {
	return m.RegistrationType
}

// GetIsDefaultProfile returns IsDefaultProfile
func (m CreateUbuntuStandAloneProfileDetails) GetIsDefaultProfile() *bool {
	return m.IsDefaultProfile
}

// GetFreeformTags returns FreeformTags
func (m CreateUbuntuStandAloneProfileDetails) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m CreateUbuntuStandAloneProfileDetails) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

func (m CreateUbuntuStandAloneProfileDetails) String() string {
...
func (m CreateUbuntuStandAloneProfileDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateUbuntuStandAloneProfileDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateUbuntuStandAloneProfileDetails CreateUbuntuStandAloneProfileDetails
	s := struct {
		DiscriminatorParam string `json:"profileType"`
		MarshalTypeCreateUbuntuStandAloneProfileDetails
	}{
		"UBUNTU_STANDALONE",
		(MarshalTypeCreateUbuntuStandAloneProfileDetails)(m),
	}
