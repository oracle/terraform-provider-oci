...
// CreateAgentEventDetails The data to create Agent Event
type CreateAgentEventDetails struct {
...
func (m CreateAgentEventDetails) GetEventSummary() *string {
	return m.EventSummary
}

// GetEventDetails returns EventDetails
func (m CreateAgentEventDetails) GetEventDetails() *string {
	return m.EventDetails
}

// GetTimeOccurred returns TimeOccurred
func (m CreateAgentEventDetails) GetTimeOccurred() *common.SDKTime {
	return m.TimeOccurred
}

// GetCompartmentId returns CompartmentId
func (m CreateAgentEventDetails) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetResourceId returns ResourceId
func (m CreateAgentEventDetails) GetResourceId() *string {
	return m.ResourceId
}

// GetSystemDetails returns SystemDetails
func (m CreateAgentEventDetails) GetSystemDetails() *SystemDetails {
	return m.SystemDetails
}

// GetIsManagedByAutonomousLinux returns IsManagedByAutonomousLinux
func (m CreateAgentEventDetails) GetIsManagedByAutonomousLinux() *bool {
	return m.IsManagedByAutonomousLinux
}

// GetFreeformTags returns FreeformTags
func (m CreateAgentEventDetails) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m CreateAgentEventDetails) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

func (m CreateAgentEventDetails) String() string {
...
func (m CreateAgentEventDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateAgentEventDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateAgentEventDetails CreateAgentEventDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCreateAgentEventDetails
	}{
		"AGENT",
		(MarshalTypeCreateAgentEventDetails)(m),
	}
