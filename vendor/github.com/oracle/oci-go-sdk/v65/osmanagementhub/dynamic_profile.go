...
// DynamicProfile Provides the information for a dynamic registration profile.
...
// GetId returns Id
func (m DynamicProfile) GetId() *string {
	return m.Id
}

// GetCompartmentId returns CompartmentId
func (m DynamicProfile) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetDisplayName returns DisplayName
func (m DynamicProfile) GetDisplayName() *string {
	return m.DisplayName
}

// GetDescription returns Description
func (m DynamicProfile) GetDescription() *string {
	return m.Description
}

// GetManagementStationId returns ManagementStationId
func (m DynamicProfile) GetManagementStationId() *string {
	return m.ManagementStationId
}

// GetVendorName returns VendorName
func (m DynamicProfile) GetVendorName() VendorNameEnum {
	return m.VendorName
}

// GetOsFamily returns OsFamily
func (m DynamicProfile) GetOsFamily() OsFamilyEnum {
	return m.OsFamily
}

// GetArchType returns ArchType
func (m DynamicProfile) GetArchType() ArchTypeEnum {
	return m.ArchType
}

// GetTimeCreated returns TimeCreated
func (m DynamicProfile) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeModified returns TimeModified
func (m DynamicProfile) GetTimeModified() *common.SDKTime {
	return m.TimeModified
}

// GetProfileVersion returns ProfileVersion
func (m DynamicProfile) GetProfileVersion() *string {
	return m.ProfileVersion
}

// GetLifecycleState returns LifecycleState
func (m DynamicProfile) GetLifecycleState() ProfileLifecycleStateEnum {
	return m.LifecycleState
}

// GetRegistrationType returns RegistrationType
func (m DynamicProfile) GetRegistrationType() ProfileRegistrationTypeEnum {
	return m.RegistrationType
}

// GetIsDefaultProfile returns IsDefaultProfile
func (m DynamicProfile) GetIsDefaultProfile() *bool {
	return m.IsDefaultProfile
}

// GetIsServiceProvidedProfile returns IsServiceProvidedProfile
func (m DynamicProfile) GetIsServiceProvidedProfile() *bool {
	return m.IsServiceProvidedProfile
}

// GetFreeformTags returns FreeformTags
func (m DynamicProfile) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m DynamicProfile) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m DynamicProfile) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m DynamicProfile) String() string {
...
func (m DynamicProfile) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m DynamicProfile) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDynamicProfile DynamicProfile
	s := struct {
		DiscriminatorParam string `json:"profileType"`
		MarshalTypeDynamicProfile
	}{
		"DYNAMIC",
		(MarshalTypeDynamicProfile)(m),
	}
