...
type ReplacePackagesInSoftwareSourceRequest struct {
	...
	ReplacePackagesInSoftwareSourceDetails `contributesTo:"body"`
...
type ReplacePackagesInSoftwareSourceResponse struct {
