...
// ReportEvent Provides the information used to create the report event.
type ReportEvent struct {
	...
	Data *ReportEventData `mandatory:"true" json:"data"`
...
// GetId returns Id
func (m ReportEvent) GetId() *string {
	return m.Id
}

// GetEventSummary returns EventSummary
func (m ReportEvent) GetEventSummary() *string {
	return m.EventSummary
}

// GetCompartmentId returns CompartmentId
func (m ReportEvent) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetEventSeverity returns EventSeverity
func (m ReportEvent) GetEventSeverity() EventSeverityEnum {
	return m.EventSeverity
}

// GetEventDetails returns EventDetails
func (m ReportEvent) GetEventDetails() *string {
	return m.EventDetails
}

// GetResourceId returns ResourceId
func (m ReportEvent) GetResourceId() *string {
	return m.ResourceId
}

// GetSystemDetails returns SystemDetails
func (m ReportEvent) GetSystemDetails() *SystemDetails {
	return m.SystemDetails
}

// GetTimeOccurred returns TimeOccurred
func (m ReportEvent) GetTimeOccurred() *common.SDKTime {
	return m.TimeOccurred
}

// GetTimeCreated returns TimeCreated
func (m ReportEvent) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m ReportEvent) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetLifecycleState returns LifecycleState
func (m ReportEvent) GetLifecycleState() EventLifecycleStateEnum {
	return m.LifecycleState
}

// GetLifecycleDetails returns LifecycleDetails
func (m ReportEvent) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetIsManagedByAutonomousLinux returns IsManagedByAutonomousLinux
func (m ReportEvent) GetIsManagedByAutonomousLinux() *bool {
	return m.IsManagedByAutonomousLinux
}

// GetFreeformTags returns FreeformTags
func (m ReportEvent) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m ReportEvent) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m ReportEvent) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m ReportEvent) String() string {
...
func (m ReportEvent) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m ReportEvent) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeReportEvent ReportEvent
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeReportEvent
	}{
		"REPORT",
		(MarshalTypeReportEvent)(m),
	}
