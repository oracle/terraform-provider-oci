...
// ErrataReport An object that defines an Errata report.
...
// GetId returns Id
func (m ErrataReport) GetId() *string {
	return m.Id
}

// GetDisplayName returns DisplayName
func (m ErrataReport) GetDisplayName() *string {
	return m.DisplayName
}

// GetCompartmentId returns CompartmentId
func (m ErrataReport) GetCompartmentId() *string {
...
func (m ErrataReport) GetDescription() *string {
	return m.Description
}

// GetTimeCreated returns TimeCreated
func (m ErrataReport) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m ErrataReport) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetCompartmentIds returns CompartmentIds
func (m ErrataReport) GetCompartmentIds() []string {
	return m.CompartmentIds
}

// GetIsSubCompartmentIncluded returns IsSubCompartmentIncluded
func (m ErrataReport) GetIsSubCompartmentIncluded() *bool {
...
func (m ErrataReport) GetLifecycleState() ReportLifecycleStateEnum {
	return m.LifecycleState
}

// GetLifecycleDetails returns LifecycleDetails
func (m ErrataReport) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetFreeformTags returns FreeformTags
func (m ErrataReport) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m ErrataReport) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m ErrataReport) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m ErrataReport) String() string {
...
func (m ErrataReport) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m ErrataReport) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeErrataReport ErrataReport
	s := struct {
		DiscriminatorParam string `json:"reportType"`
		MarshalTypeErrataReport
	}{
		"ERRATA",
		(MarshalTypeErrataReport)(m),
	}
