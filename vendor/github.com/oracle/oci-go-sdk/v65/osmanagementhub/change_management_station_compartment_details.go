...
// ChangeManagementStationCompartmentDetails The details for which compartment to move the resource to.
type ChangeManagementStationCompartmentDetails struct {

	// The OCID of the compartment into which the Management Station should be moved.
