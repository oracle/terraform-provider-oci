...
// CveReportVersion An object that defines a CVE report with specific version.
type CveReportVersion struct {
...
// GetId returns Id
func (m CveReportVersion) GetId() *string {
	return m.Id
}

// GetDisplayName returns DisplayName
func (m CveReportVersion) GetDisplayName() *string {
...
func (m CveReportVersion) GetReportVersion() *string {
	return m.ReportVersion
}

// GetDescription returns Description
func (m CveReportVersion) GetDescription() *string {
	return m.Description
}

// GetTimeCreated returns TimeCreated
func (m CveReportVersion) GetTimeCreated() *common.SDKTime {
...
func (m CveReportVersion) GetIsSubCompartmentIncluded() *bool {
	return m.IsSubCompartmentIncluded
}

// GetOsFamilies returns OsFamilies
func (m CveReportVersion) GetOsFamilies() []OsFamilyEnum {
	return m.OsFamilies
}
...
func (m CveReportVersion) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetFreeformTags returns FreeformTags
func (m CveReportVersion) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m CveReportVersion) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m CveReportVersion) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m CveReportVersion) String() string {
...
func (m CveReportVersion) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCveReportVersion CveReportVersion
	s := struct {
		DiscriminatorParam string `json:"reportType"`
		MarshalTypeCveReportVersion
	}{
		"CVE",
		(MarshalTypeCveReportVersion)(m),
	}
