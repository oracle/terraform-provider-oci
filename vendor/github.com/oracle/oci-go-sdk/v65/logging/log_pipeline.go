...
// LogPipeline Represents a log pipeline resource.
...
func (m LogPipeline) String() string {
...
func (m LogPipeline) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *LogPipeline) UnmarshalJSON(data []byte) (e error) {
	model := struct {
