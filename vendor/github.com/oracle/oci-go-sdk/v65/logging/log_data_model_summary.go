...
// LogDataModelSummary Log data model summary object for LIST operation.
type LogDataModelSummary struct {
...
func (m LogDataModelSummary) String() string {
...
func (m LogDataModelSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
