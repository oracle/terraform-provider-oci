...
// LogPipelineDestinationAttachmentSummary Summary representation of a log pipeline destination attachment.
type LogPipelineDestinationAttachmentSummary struct {
...
func (m LogPipelineDestinationAttachmentSummary) String() string {
...
func (m LogPipelineDestinationAttachmentSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
