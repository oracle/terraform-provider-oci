...
func (request DeleteLogGroupRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["logGroupId"] != nil {
		templateParam := mandatoryParamMap["logGroupId"]
		for _, template := range templateParam {
			replacementParam := *request.LogGroupId
