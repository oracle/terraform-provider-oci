...
// UpdateLogPipelineDetails Log pipeline update content request details.
type UpdateLogPipelineDetails struct {
	...
	// Pipelines for the Log Pipeline
...
func (m UpdateLogPipelineDetails) String() string {
...
func (m UpdateLogPipelineDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *UpdateLogPipelineDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {
