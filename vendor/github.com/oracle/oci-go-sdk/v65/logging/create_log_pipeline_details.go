...
// CreateLogPipelineDetails Log pipeline create request details.
type CreateLogPipelineDetails struct {
...
func (m CreateLogPipelineDetails) String() string {
...
func (m CreateLogPipelineDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *CreateLogPipelineDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {
