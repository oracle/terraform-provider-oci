...
func (m DataEntitySummaryFromSql) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingDataEntitySummaryFromSqlEntityTypeEnum(string(m.EntityType)); !ok && m.EntityType != "" {
...
func (m DataEntitySummaryFromSql) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDataEntitySummaryFromSql DataEntitySummaryFromSql
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeDataEntitySummaryFromSql
	}{
		"SQL_ENTITY",
		(MarshalTypeDataEntitySummaryFromSql)(m),
	}
...
func (m *DataEntitySummaryFromSql) UnmarshalJSON(data []byte) (e error) {
	model := struct {
		...
		EntityType     DataEntitySummaryFromSqlEntityTypeEnum `json:"entityType"`
...
func GetMappingDataEntitySummaryFromSqlEntityTypeEnum(val string) (DataEntitySummaryFromSqlEntityTypeEnum, bool) {
	enum, ok := mappingDataEntitySummaryFromSqlEntityTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
