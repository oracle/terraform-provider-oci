...
func (m DpEndpointSummaryFromPrivate) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingDpEndpointSummaryFromPrivateStateEnum(string(m.State)); !ok && m.State != "" {
...
var mappingDpEndpointSummaryFromPrivateStateEnumLowerCase = map[string]DpEndpointSummaryFromPrivateStateEnum{
	"active":   DpEndpointSummaryFromPrivateStateActive,
	"inactive": DpEndpointSummaryFromPrivateStateInactive,
}
...
func GetMappingDpEndpointSummaryFromPrivateStateEnum(val string) (DpEndpointSummaryFromPrivateStateEnum, bool) {
	enum, ok := mappingDpEndpointSummaryFromPrivateStateEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
