...
func (m EntityShapeFromMessage) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingEntityShapeFromMessageEntityTypeEnum(string(m.EntityType)); !ok && m.EntityType != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for EntityType: %s. Supported values are: %s.", m.EntityType, strings.Join(GetEntityShapeFromMessageEntityTypeEnumStringValues(), ",")))
	}
...
func (m EntityShapeFromMessage) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeEntityShapeFromMessage EntityShapeFromMessage
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeEntityShapeFromMessage
	}{
		"MESSAGE_ENTITY",
		(MarshalTypeEntityShapeFromMessage)(m),
	}
...
func (m *EntityShapeFromMessage) UnmarshalJSON(data []byte) (e error) {
	model := struct {
		...
		EntityType     EntityShapeFromMessageEntityTypeEnum `json:"entityType"`
...
var mappingEntityShapeFromMessageEntityTypeEnum = map[string]EntityShapeFromMessageEntityTypeEnum{
	"TABLE":      EntityShapeFromMessageEntityTypeTable,
	"VIEW":       EntityShapeFromMessageEntityTypeView,
	"FILE":       EntityShapeFromMessageEntityTypeFile,
	"SQL":        EntityShapeFromMessageEntityTypeSql,
	"DATA_STORE": EntityShapeFromMessageEntityTypeDataStore,
	"MESSAGE":    EntityShapeFromMessageEntityTypeMessage,
}

var mappingEntityShapeFromMessageEntityTypeEnumLowerCase = map[string]EntityShapeFromMessageEntityTypeEnum{
	"table":      EntityShapeFromMessageEntityTypeTable,
	"view":       EntityShapeFromMessageEntityTypeView,
	"file":       EntityShapeFromMessageEntityTypeFile,
	"sql":        EntityShapeFromMessageEntityTypeSql,
...
func GetEntityShapeFromMessageEntityTypeEnumValues() []EntityShapeFromMessageEntityTypeEnum {
	values := make([]EntityShapeFromMessageEntityTypeEnum, 0)
	for _, v := range mappingEntityShapeFromMessageEntityTypeEnum {
...
func GetMappingEntityShapeFromMessageEntityTypeEnum(val string) (EntityShapeFromMessageEntityTypeEnum, bool) {
	enum, ok := mappingEntityShapeFromMessageEntityTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
