...
//GetKey returns Key
func (m CreateEntityShapeFromMessage) GetKey() *string {
	return m.Key
}
...
func (m CreateEntityShapeFromMessage) GetParentRef() *ParentReference {
	return m.ParentRef
}
...
func (m CreateEntityShapeFromMessage) GetEntityType() CreateEntityShapeDetailsEntityTypeEnum {
	return m.EntityType
}
...
func (m CreateEntityShapeFromMessage) GetTypes() *TypeLibrary {
	return m.Types
}
...
func (m CreateEntityShapeFromMessage) String() string {
...
func (m CreateEntityShapeFromMessage) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateEntityShapeFromMessage CreateEntityShapeFromMessage
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeCreateEntityShapeFromMessage
	}{
		"MESSAGE_ENTITY",
		(MarshalTypeCreateEntityShapeFromMessage)(m),
	}
