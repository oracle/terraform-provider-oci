...
func (m *AutonomousVmCluster) UnmarshalJSON(data []byte) (e error) {
	model := struct {
		TimeCreated                                  *common.SDKTime                              `json:"timeCreated"`
		LifecycleDetails                             *string                                      `json:"lifecycleDetails"`
		TimeZone                                     *string                                      `json:"timeZone"`
		DistributionAlgorithm                        AutonomousVmClusterDistributionAlgorithmEnum `json:"distributionAlgorithm"`
		...
		ComputeModel                                 AutonomousVmClusterComputeModelEnum          `json:"computeModel"`
		...
		LicenseModel                                 AutonomousVmClusterLicenseModelEnum          `json:"licenseModel"`
		...
		LifecycleState                               AutonomousVmClusterLifecycleStateEnum        `json:"lifecycleState"`
