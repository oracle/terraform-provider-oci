...
// CreateCrossRegionDisasterRecoveryDetails The following are the details necessary to create a disaster recovery (DR) association for an existing Autonomous AI Database with a standby in a remote region.
// *IMPORTANT*
...
type CreateCrossRegionDisasterRecoveryDetails struct {
	...
	// True if allow Oracle services to use the Service Gateway to connect to the Autonomous AI Database.
	...
	// External Authentication applies to the Autonomous AI Databases.
...
func (m CreateCrossRegionDisasterRecoveryDetails) GetBackupDestination() CreateAutonomousDatabaseBaseBackupDestinationEnum {
	return m.BackupDestination
}

// GetAvailabilityDomain returns AvailabilityDomain
func (m CreateCrossRegionDisasterRecoveryDetails) GetAvailabilityDomain() *string {
...
func (m CreateCrossRegionDisasterRecoveryDetails) GetExternalLocation() *string {
...
func (m CreateCrossRegionDisasterRecoveryDetails) GetPreferredCommunicationLanguageLocale() *string {
