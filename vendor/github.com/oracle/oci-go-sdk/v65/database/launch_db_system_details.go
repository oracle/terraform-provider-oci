...
func (m LaunchDbSystemDetails) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSubscriptionId returns SubscriptionId
func (m LaunchDbSystemDetails) GetSubscriptionId() *string {
...
func (m LaunchDbSystemDetails) GetComputeModel() LaunchDbSystemBaseComputeModelEnum {
	return m.ComputeModel
}

// GetComputeCount returns ComputeCount
func (m LaunchDbSystemDetails) GetComputeCount() *int {
