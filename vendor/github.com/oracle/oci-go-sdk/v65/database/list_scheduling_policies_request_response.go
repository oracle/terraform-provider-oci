...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/database/ListSchedulingPolicies.go.html to see an example of how to use ListSchedulingPoliciesRequest.
...
func (request ListSchedulingPoliciesRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListSchedulingPoliciesSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortBy: %s. Supported values are: %s.", request.SortBy, strings.Join(GetListSchedulingPoliciesSortByEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListSchedulingPoliciesSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListSchedulingPoliciesSortOrderEnumStringValues(), ",")))
	}
...
var mappingListSchedulingPoliciesSortByEnum = map[string]ListSchedulingPoliciesSortByEnum{
	"TIMECREATED": ListSchedulingPoliciesSortByTimecreated,
	"DISPLAYNAME": ListSchedulingPoliciesSortByDisplayname,
}

var mappingListSchedulingPoliciesSortByEnumLowerCase = map[string]ListSchedulingPoliciesSortByEnum{
	"timecreated": ListSchedulingPoliciesSortByTimecreated,
	"displayname": ListSchedulingPoliciesSortByDisplayname,
}
...
func GetListSchedulingPoliciesSortByEnumValues() []ListSchedulingPoliciesSortByEnum {
	values := make([]ListSchedulingPoliciesSortByEnum, 0)
	for _, v := range mappingListSchedulingPoliciesSortByEnum {
...
func GetMappingListSchedulingPoliciesSortByEnum(val string) (ListSchedulingPoliciesSortByEnum, bool) {
	enum, ok := mappingListSchedulingPoliciesSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListSchedulingPoliciesSortOrderEnum = map[string]ListSchedulingPoliciesSortOrderEnum{
	"ASC":  ListSchedulingPoliciesSortOrderAsc,
	"DESC": ListSchedulingPoliciesSortOrderDesc,
}

var mappingListSchedulingPoliciesSortOrderEnumLowerCase = map[string]ListSchedulingPoliciesSortOrderEnum{
	"asc":  ListSchedulingPoliciesSortOrderAsc,
	"desc": ListSchedulingPoliciesSortOrderDesc,
}
...
func GetListSchedulingPoliciesSortOrderEnumValues() []ListSchedulingPoliciesSortOrderEnum {
	values := make([]ListSchedulingPoliciesSortOrderEnum, 0)
	for _, v := range mappingListSchedulingPoliciesSortOrderEnum {
		values = append(values, v)
	}
	return values
}
...
func GetMappingListSchedulingPoliciesSortOrderEnum(val string) (ListSchedulingPoliciesSortOrderEnum, bool) {
	enum, ok := mappingListSchedulingPoliciesSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
