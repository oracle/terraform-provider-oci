...
// MountPointDetails Details of the Mount Point.
type MountPointDetails struct {
...
func (m MountPointDetails) String() string {
...
func (m MountPointDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
