...
func (m CreateAutonomousDatabaseFromBackupTimestampDetails) GetVectorUsername() *string {
	return m.VectorUsername
}

// GetVectorPassword returns VectorPassword
func (m CreateAutonomousDatabaseFromBackupTimestampDetails) GetVectorPassword() *string {
	return m.VectorPassword
}

// GetVectorSecretId returns VectorSecretId
func (m CreateAutonomousDatabaseFromBackupTimestampDetails) GetVectorSecretId() *string {
	return m.VectorSecretId
}

// GetVectorSecretVersionNumber returns VectorSecretVersionNumber
func (m CreateAutonomousDatabaseFromBackupTimestampDetails) GetVectorSecretVersionNumber() *int {
...
func (m CreateAutonomousDatabaseFromBackupTimestampDetails) GetExternalAuthentication() []ExternalAuthenticationBase {
