...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/database/ListSchedulingWindows.go.html to see an example of how to use ListSchedulingWindowsRequest.
...
func (request ListSchedulingWindowsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListSchedulingWindowsSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortBy: %s. Supported values are: %s.", request.SortBy, strings.Join(GetListSchedulingWindowsSortByEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListSchedulingWindowsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListSchedulingWindowsSortOrderEnumStringValues(), ",")))
	}
	if _, ok := GetMappingSchedulingWindowSummaryLifecycleStateEnum(string(request.LifecycleState)); !ok && request.LifecycleState != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for LifecycleState: %s. Supported values are: %s.", request.LifecycleState, strings.Join(GetSchedulingWindowSummaryLifecycleStateEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListSchedulingWindowsSortByEnum = map[string]ListSchedulingWindowsSortByEnum{
	"TIMECREATED": ListSchedulingWindowsSortByTimecreated,
	"DISPLAYNAME": ListSchedulingWindowsSortByDisplayname,
}

var mappingListSchedulingWindowsSortByEnumLowerCase = map[string]ListSchedulingWindowsSortByEnum{
	"timecreated": ListSchedulingWindowsSortByTimecreated,
	"displayname": ListSchedulingWindowsSortByDisplayname,
}
...
func GetListSchedulingWindowsSortByEnumValues() []ListSchedulingWindowsSortByEnum {
	values := make([]ListSchedulingWindowsSortByEnum, 0)
	for _, v := range mappingListSchedulingWindowsSortByEnum {
...
func GetMappingListSchedulingWindowsSortByEnum(val string) (ListSchedulingWindowsSortByEnum, bool) {
	enum, ok := mappingListSchedulingWindowsSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListSchedulingWindowsSortOrderEnum = map[string]ListSchedulingWindowsSortOrderEnum{
...
func GetListSchedulingWindowsSortOrderEnumValues() []ListSchedulingWindowsSortOrderEnum {
	values := make([]ListSchedulingWindowsSortOrderEnum, 0)
	for _, v := range mappingListSchedulingWindowsSortOrderEnum {
		values = append(values, v)
	}
	return values
}
...
func GetMappingListSchedulingWindowsSortOrderEnum(val string) (ListSchedulingWindowsSortOrderEnum, bool) {
	enum, ok := mappingListSchedulingWindowsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
