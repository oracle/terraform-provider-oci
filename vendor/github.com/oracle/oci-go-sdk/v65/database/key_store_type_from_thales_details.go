...
// KeyStoreTypeFromThalesDetails Details for Thales CAKM
type KeyStoreTypeFromThalesDetails struct {
...
func (m KeyStoreTypeFromThalesDetails) String() string {
...
func (m KeyStoreTypeFromThalesDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m KeyStoreTypeFromThalesDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeKeyStoreTypeFromThalesDetails KeyStoreTypeFromThalesDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeKeyStoreTypeFromThalesDetails
	}{
		"THALES",
		(MarshalTypeKeyStoreTypeFromThalesDetails)(m),
	}
