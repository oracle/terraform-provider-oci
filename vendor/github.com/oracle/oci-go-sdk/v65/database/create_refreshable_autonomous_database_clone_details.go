...
type CreateRefreshableAutonomousDatabaseCloneDetails struct {
	...
	// The national character set for the Autonomous Database.  The default is AL16UTF16. Use List Autonomous Database Character Sets (https://docs.cloud.oracle.com/autonomousDatabaseCharacterSets) to list the allowed values for an Autonomous Database on shared Exadata infrastructure.
