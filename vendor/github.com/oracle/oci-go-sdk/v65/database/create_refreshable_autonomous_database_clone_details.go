...
func (m CreateRefreshableAutonomousDatabaseCloneDetails) GetVectorUsername() *string {
	return m.VectorUsername
}

// GetVectorPassword returns VectorPassword
func (m CreateRefreshableAutonomousDatabaseCloneDetails) GetVectorPassword() *string {
	return m.VectorPassword
}

// GetVectorSecretId returns VectorSecretId
func (m CreateRefreshableAutonomousDatabaseCloneDetails) GetVectorSecretId() *string {
	return m.VectorSecretId
}

// GetVectorSecretVersionNumber returns VectorSecretVersionNumber
func (m CreateRefreshableAutonomousDatabaseCloneDetails) GetVectorSecretVersionNumber() *int {
...
func (m CreateRefreshableAutonomousDatabaseCloneDetails) GetExternalAuthentication() []ExternalAuthenticationBase {
