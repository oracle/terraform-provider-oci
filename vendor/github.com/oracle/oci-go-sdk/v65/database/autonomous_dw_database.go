...
type AutonomousDwDatabase struct {
	...
	BackupDestination AutonomousDwDatabaseBackupDestinationEnum `mandatory:"false" json:"backupDestination,omitempty"`
	...
	// The area assigned to In-Memory tables in Autonomous AI Database. This property is applicable only to Autonomous AI Database on Dedicated Exadata infrastructure.
	...
	// The date and time the Always Free database will be stopped because of inactivity. If this time is reached without any database activity, the database will automatically be put into the STOPPED state. This property is applicable only to free tier Autonomous AI Database.
	TimeReclamationOfFreeAutonomousDatabase *common.SDKTime `mandatory:"false" json:"timeReclamationOfFreeAutonomousDatabase"`

	// The date and time the Always Free database will be automatically deleted because of inactivity. If the database is in the STOPPED state and without activity until this time, it will be deleted. This property is applicable only to free tier Autonomous AI Database.
	...
	// An array of CPU values that an Autonomous AI Database can be scaled to. This property is applicable only to Autonomous AI Database on Dedicated Exadata infrastructure.
	...
	// This property is applicable only to Autonomous AI Database on Dedicated Exadata infrastructure.
	...
	// Indicates whether the Autonomous AI Database is a virtual clone.
	...
	// The auto-refresh policy for the Autonomous AI Database refreshable clone. You can specify continuous refreshing or a custom refresh schedule.
	AutoRefreshPolicy AutonomousDwDatabaseAutoRefreshPolicyEnum `mandatory:"false" json:"autoRefreshPolicy,omitempty"`
...
func (m AutonomousDwDatabase) ValidateEnumValue() (bool, error) {
	...
	if _, ok := GetMappingAutonomousDwDatabaseBackupDestinationEnum(string(m.BackupDestination)); !ok && m.BackupDestination != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for BackupDestination: %s. Supported values are: %s.", m.BackupDestination, strings.Join(GetAutonomousDwDatabaseBackupDestinationEnumStringValues(), ",")))
	}
	...
	if _, ok := GetMappingAutonomousDwDatabaseAutoRefreshPolicyEnum(string(m.AutoRefreshPolicy)); !ok && m.AutoRefreshPolicy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for AutoRefreshPolicy: %s. Supported values are: %s.", m.AutoRefreshPolicy, strings.Join(GetAutonomousDwDatabaseAutoRefreshPolicyEnumStringValues(), ",")))
	}
...
func (m *AutonomousDwDatabase) UnmarshalJSON(data []byte) (e error) {
	model := struct {
		BackupDestination                       AutonomousDwDatabaseBackupDestinationEnum                 `json:"backupDestination"`
		...
		AutoRefreshPolicy                       AutonomousDwDatabaseAutoRefreshPolicyEnum                 `json:"autoRefreshPolicy"`
...
// AutonomousDwDatabaseBackupDestinationEnum Enum with underlying type: string
type AutonomousDwDatabaseBackupDestinationEnum string

// Set of constants representing the allowable values for AutonomousDwDatabaseBackupDestinationEnum
const (
	AutonomousDwDatabaseBackupDestinationOci   AutonomousDwDatabaseBackupDestinationEnum = "OCI"
	AutonomousDwDatabaseBackupDestinationGcp   AutonomousDwDatabaseBackupDestinationEnum = "GCP"
	AutonomousDwDatabaseBackupDestinationAzure AutonomousDwDatabaseBackupDestinationEnum = "AZURE"
	AutonomousDwDatabaseBackupDestinationAws   AutonomousDwDatabaseBackupDestinationEnum = "AWS"
)

var mappingAutonomousDwDatabaseBackupDestinationEnum = map[string]AutonomousDwDatabaseBackupDestinationEnum{
	"OCI":   AutonomousDwDatabaseBackupDestinationOci,
	"GCP":   AutonomousDwDatabaseBackupDestinationGcp,
	"AZURE": AutonomousDwDatabaseBackupDestinationAzure,
	"AWS":   AutonomousDwDatabaseBackupDestinationAws,
}

var mappingAutonomousDwDatabaseBackupDestinationEnumLowerCase = map[string]AutonomousDwDatabaseBackupDestinationEnum{
	"oci":   AutonomousDwDatabaseBackupDestinationOci,
	"gcp":   AutonomousDwDatabaseBackupDestinationGcp,
	"azure": AutonomousDwDatabaseBackupDestinationAzure,
	"aws":   AutonomousDwDatabaseBackupDestinationAws,
...
// GetAutonomousDwDatabaseBackupDestinationEnumValues Enumerates the set of values for AutonomousDwDatabaseBackupDestinationEnum
func GetAutonomousDwDatabaseBackupDestinationEnumValues() []AutonomousDwDatabaseBackupDestinationEnum {
	values := make([]AutonomousDwDatabaseBackupDestinationEnum, 0)
	for _, v := range mappingAutonomousDwDatabaseBackupDestinationEnum {
		values = append(values, v)
	}
	return values
}

// GetAutonomousDwDatabaseBackupDestinationEnumStringValues Enumerates the set of values in String for AutonomousDwDatabaseBackupDestinationEnum
func GetAutonomousDwDatabaseBackupDestinationEnumStringValues() []string {
	return []string{
		"OCI",
		"GCP",
		"AZURE",
...
// GetMappingAutonomousDwDatabaseBackupDestinationEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingAutonomousDwDatabaseBackupDestinationEnum(val string) (AutonomousDwDatabaseBackupDestinationEnum, bool) {
	enum, ok := mappingAutonomousDwDatabaseBackupDestinationEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
const (
	...
	AutonomousDwDatabaseLifecycleStateArchived                AutonomousDwDatabaseLifecycleStateEnum = "ARCHIVED"
)
...
var mappingAutonomousDwDatabaseLifecycleStateEnum = map[string]AutonomousDwDatabaseLifecycleStateEnum{
	...
	"ARCHIVED":                  AutonomousDwDatabaseLifecycleStateArchived,
}
...
const (
	AutonomousDwDatabaseOpenModeReadOnly  AutonomousDwDatabaseOpenModeEnum = "READ_ONLY"
	AutonomousDwDatabaseOpenModeReadWrite AutonomousDwDatabaseOpenModeEnum = "READ_WRITE"
	AutonomousDwDatabaseOpenModeStandby   AutonomousDwDatabaseOpenModeEnum = "STANDBY"
)

var mappingAutonomousDwDatabaseOpenModeEnum = map[string]AutonomousDwDatabaseOpenModeEnum{
	"READ_ONLY":  AutonomousDwDatabaseOpenModeReadOnly,
	"READ_WRITE": AutonomousDwDatabaseOpenModeReadWrite,
	"STANDBY":    AutonomousDwDatabaseOpenModeStandby,
}
...
// AutonomousDwDatabaseAutoRefreshPolicyEnum Enum with underlying type: string
type AutonomousDwDatabaseAutoRefreshPolicyEnum string

// Set of constants representing the allowable values for AutonomousDwDatabaseAutoRefreshPolicyEnum
const (
	AutonomousDwDatabaseAutoRefreshPolicyContinuous AutonomousDwDatabaseAutoRefreshPolicyEnum = "CONTINUOUS"
	AutonomousDwDatabaseAutoRefreshPolicyCustom     AutonomousDwDatabaseAutoRefreshPolicyEnum = "CUSTOM"
)

var mappingAutonomousDwDatabaseAutoRefreshPolicyEnum = map[string]AutonomousDwDatabaseAutoRefreshPolicyEnum{
	"CONTINUOUS": AutonomousDwDatabaseAutoRefreshPolicyContinuous,
	"CUSTOM":     AutonomousDwDatabaseAutoRefreshPolicyCustom,
}

var mappingAutonomousDwDatabaseAutoRefreshPolicyEnumLowerCase = map[string]AutonomousDwDatabaseAutoRefreshPolicyEnum{
	"continuous": AutonomousDwDatabaseAutoRefreshPolicyContinuous,
	"custom":     AutonomousDwDatabaseAutoRefreshPolicyCustom,
}

// GetAutonomousDwDatabaseAutoRefreshPolicyEnumValues Enumerates the set of values for AutonomousDwDatabaseAutoRefreshPolicyEnum
func GetAutonomousDwDatabaseAutoRefreshPolicyEnumValues() []AutonomousDwDatabaseAutoRefreshPolicyEnum {
	values := make([]AutonomousDwDatabaseAutoRefreshPolicyEnum, 0)
	for _, v := range mappingAutonomousDwDatabaseAutoRefreshPolicyEnum {
		values = append(values, v)
	}
	return values
}

// GetAutonomousDwDatabaseAutoRefreshPolicyEnumStringValues Enumerates the set of values in String for AutonomousDwDatabaseAutoRefreshPolicyEnum
func GetAutonomousDwDatabaseAutoRefreshPolicyEnumStringValues() []string {
	return []string{
		"CONTINUOUS",
		"CUSTOM",
	}
...
// GetMappingAutonomousDwDatabaseAutoRefreshPolicyEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingAutonomousDwDatabaseAutoRefreshPolicyEnum(val string) (AutonomousDwDatabaseAutoRefreshPolicyEnum, bool) {
	enum, ok := mappingAutonomousDwDatabaseAutoRefreshPolicyEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
