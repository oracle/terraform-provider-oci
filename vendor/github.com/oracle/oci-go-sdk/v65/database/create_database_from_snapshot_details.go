...
// CreateDatabaseFromSnapshotDetails The representation of CreateDatabaseFromSnapshotDetails
type CreateDatabaseFromSnapshotDetails struct {

	// The snapshot OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
	SourceSnapshotId *string `mandatory:"true" json:"sourceSnapshotId"`
...
func (m CreateDatabaseFromSnapshotDetails) String() string {
...
func (m CreateDatabaseFromSnapshotDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *CreateDatabaseFromSnapshotDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {
	...
	m.SourceSnapshotId = model.SourceSnapshotId
