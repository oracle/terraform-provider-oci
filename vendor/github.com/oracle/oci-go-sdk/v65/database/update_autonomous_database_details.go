...
// UpdateAutonomousDatabaseDetails Details to update an Oracle Autonomous AI Database.
// **Notes**
...
type UpdateAutonomousDatabaseDetails struct {
	...
	// For Autonomous AI Databases on Dedicated Exadata Infrastructure, the database name must start with an alphabetic character followed with up to 7 alphanumeric characters. Special characters are prohibited.
	// For Autonomous AI Database Serverless instances, the database name must start with an alphabetic character followed with up to 13 alphanumeric characters. Special characters are prohibited. The database name must be unique within the compartment in the region.
...
const (
	...
	UpdateAutonomousDatabaseDetailsDbWorkloadLh   UpdateAutonomousDatabaseDetailsDbWorkloadEnum = "LH"
...
var mappingUpdateAutonomousDatabaseDetailsDbWorkloadEnum = map[string]UpdateAutonomousDatabaseDetailsDbWorkloadEnum{
	...
	"LH":   UpdateAutonomousDatabaseDetailsDbWorkloadLh,
