...
func (m CreateCrossTenancyDisasterRecoveryDetails) GetVectorUsername() *string {
	return m.VectorUsername
}

// GetVectorPassword returns VectorPassword
func (m CreateCrossTenancyDisasterRecoveryDetails) GetVectorPassword() *string {
	return m.VectorPassword
}

// GetVectorSecretId returns VectorSecretId
func (m CreateCrossTenancyDisasterRecoveryDetails) GetVectorSecretId() *string {
	return m.VectorSecretId
}

// GetVectorSecretVersionNumber returns VectorSecretVersionNumber
func (m CreateCrossTenancyDisasterRecoveryDetails) GetVectorSecretVersionNumber() *int {
...
func (m CreateCrossTenancyDisasterRecoveryDetails) GetExternalAuthentication() []ExternalAuthenticationBase {
