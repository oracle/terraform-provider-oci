...
// CreateVirtualAutonomousDatabaseCloneDetails Details to create an Oracle Autonomous AI Database virtual clone.
...
func (m CreateVirtualAutonomousDatabaseCloneDetails) GetSubscriptionId() *string {
...
func (m CreateVirtualAutonomousDatabaseCloneDetails) GetVectorUsername() *string {
	return m.VectorUsername
}

// GetVectorPassword returns VectorPassword
func (m CreateVirtualAutonomousDatabaseCloneDetails) GetVectorPassword() *string {
	return m.VectorPassword
}

// GetVectorSecretId returns VectorSecretId
func (m CreateVirtualAutonomousDatabaseCloneDetails) GetVectorSecretId() *string {
	return m.VectorSecretId
}

// GetVectorSecretVersionNumber returns VectorSecretVersionNumber
func (m CreateVirtualAutonomousDatabaseCloneDetails) GetVectorSecretVersionNumber() *int {
...
func (m CreateVirtualAutonomousDatabaseCloneDetails) GetEncryptionKey() AutonomousDatabaseEncryptionKeyDetails {
...
func (m CreateVirtualAutonomousDatabaseCloneDetails) GetByolComputeCountLimit() *float32 {
...
func (m CreateVirtualAutonomousDatabaseCloneDetails) GetIsDevTier() *bool {
	return m.IsDevTier
}
...
func (m CreateVirtualAutonomousDatabaseCloneDetails) GetSecurityAttributes() map[string]map[string]interface{} {
...
func (m CreateVirtualAutonomousDatabaseCloneDetails) GetAutonomousDatabaseMaintenanceWindow() *AutonomousDatabaseMaintenanceWindowSummary {
...
func (m CreateVirtualAutonomousDatabaseCloneDetails) GetExternalAuthentication() []ExternalAuthenticationBase {
	return m.ExternalAuthentication
}

// GetIsBackupRetentionLocked returns IsBackupRetentionLocked
func (m CreateVirtualAutonomousDatabaseCloneDetails) GetIsBackupRetentionLocked() *bool {
...
func (m *CreateVirtualAutonomousDatabaseCloneDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {
