...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/database/ReinstateDataGuard.go.html to see an example of how to use ReinstateDataGuardRequest.
