...
func (m CreateAutonomousDatabaseDetails) GetClusterPlacementGroupId() *string {
...
func (m CreateAutonomousDatabaseDetails) GetExternalAuthentication() []ExternalAuthenticationBase {
