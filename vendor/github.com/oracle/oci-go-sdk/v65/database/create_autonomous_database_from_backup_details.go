...
func (m CreateAutonomousDatabaseFromBackupDetails) GetVectorUsername() *string {
	return m.VectorUsername
}

// GetVectorPassword returns VectorPassword
func (m CreateAutonomousDatabaseFromBackupDetails) GetVectorPassword() *string {
	return m.VectorPassword
}

// GetVectorSecretId returns VectorSecretId
func (m CreateAutonomousDatabaseFromBackupDetails) GetVectorSecretId() *string {
	return m.VectorSecretId
}

// GetVectorSecretVersionNumber returns VectorSecretVersionNumber
func (m CreateAutonomousDatabaseFromBackupDetails) GetVectorSecretVersionNumber() *int {
...
func (m CreateAutonomousDatabaseFromBackupDetails) GetExternalAuthentication() []ExternalAuthenticationBase {
