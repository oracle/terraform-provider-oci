...
func (m UndeleteAutonomousDatabaseDetails) GetVectorUsername() *string {
	return m.VectorUsername
}

// GetVectorPassword returns VectorPassword
func (m UndeleteAutonomousDatabaseDetails) GetVectorPassword() *string {
	return m.VectorPassword
}

// GetVectorSecretId returns VectorSecretId
func (m UndeleteAutonomousDatabaseDetails) GetVectorSecretId() *string {
	return m.VectorSecretId
}

// GetVectorSecretVersionNumber returns VectorSecretVersionNumber
func (m UndeleteAutonomousDatabaseDetails) GetVectorSecretVersionNumber() *int {
...
func (m UndeleteAutonomousDatabaseDetails) GetIsOracleServiceGatewayAllowed() *bool {
...
func (m UndeleteAutonomousDatabaseDetails) GetExternalAuthentication() []ExternalAuthenticationBase {
