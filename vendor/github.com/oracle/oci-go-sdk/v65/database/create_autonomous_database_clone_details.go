...
func (m CreateAutonomousDatabaseCloneDetails) GetVectorUsername() *string {
	return m.VectorUsername
}

// GetVectorPassword returns VectorPassword
func (m CreateAutonomousDatabaseCloneDetails) GetVectorPassword() *string {
	return m.VectorPassword
}

// GetVectorSecretId returns VectorSecretId
func (m CreateAutonomousDatabaseCloneDetails) GetVectorSecretId() *string {
	return m.VectorSecretId
}

// GetVectorSecretVersionNumber returns VectorSecretVersionNumber
func (m CreateAutonomousDatabaseCloneDetails) GetVectorSecretVersionNumber() *int {
