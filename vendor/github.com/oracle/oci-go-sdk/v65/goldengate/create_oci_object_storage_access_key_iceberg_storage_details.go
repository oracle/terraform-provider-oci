...
// CreateOciObjectStorageAccessKeyIcebergStorageDetails The information about a new OCI Object Storage configuration for an Oracle AI Data Catalog Iceberg catalog
// using access-key/secret-key credentials.
type CreateOciObjectStorageAccessKeyIcebergStorageDetails struct {
...
func (m CreateOciObjectStorageAccessKeyIcebergStorageDetails) String() string {
...
func (m CreateOciObjectStorageAccessKeyIcebergStorageDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateOciObjectStorageAccessKeyIcebergStorageDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateOciObjectStorageAccessKeyIcebergStorageDetails CreateOciObjectStorageAccessKeyIcebergStorageDetails
	s := struct {
		DiscriminatorParam string `json:"storageType"`
		MarshalTypeCreateOciObjectStorageAccessKeyIcebergStorageDetails
	}{
		"OCI_OBJECT_STORAGE_ACCESS_KEY",
		(MarshalTypeCreateOciObjectStorageAccessKeyIcebergStorageDetails)(m),
	}
