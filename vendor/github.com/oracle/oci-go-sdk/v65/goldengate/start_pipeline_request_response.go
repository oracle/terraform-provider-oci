...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/goldengate/StartPipeline.go.html to see an example of how to use StartPipelineRequest.
type StartPipelineRequest struct {
	...
	StartPipelineDetails `contributesTo:"body"`
