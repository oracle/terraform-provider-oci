...
func (m AzureDataLakeStorageIcebergStorage) String() string {
...
func (m AzureDataLakeStorageIcebergStorage) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m AzureDataLakeStorageIcebergStorage) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAzureDataLakeStorageIcebergStorage AzureDataLakeStorageIcebergStorage
	s := struct {
		DiscriminatorParam string `json:"storageType"`
		MarshalTypeAzureDataLakeStorageIcebergStorage
	}{
		"AZURE_DATA_LAKE_STORAGE",
		(MarshalTypeAzureDataLakeStorageIcebergStorage)(m),
	}
