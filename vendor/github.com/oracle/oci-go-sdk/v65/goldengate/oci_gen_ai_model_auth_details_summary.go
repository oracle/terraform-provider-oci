...
// OciGenAiModelAuthDetailsSummary Summary of OCI Generative AI authentication details for an AI Model connection.
type OciGenAiModelAuthDetailsSummary struct {
...
func (m OciGenAiModelAuthDetailsSummary) String() string {
...
func (m OciGenAiModelAuthDetailsSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m OciGenAiModelAuthDetailsSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOciGenAiModelAuthDetailsSummary OciGenAiModelAuthDetailsSummary
	s := struct {
		DiscriminatorParam string `json:"authType"`
		MarshalTypeOciGenAiModelAuthDetailsSummary
	}{
		"OCI_GEN_AI",
		(MarshalTypeOciGenAiModelAuthDetailsSummary)(m),
	}
