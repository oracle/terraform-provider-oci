...
// CreateZfsIcebergStorageDetails The information about a new ZFS storage used in the Iceberg connection for an Oracle AI Data Catalog Iceberg catalogs.
type CreateZfsIcebergStorageDetails struct {
...
func (m CreateZfsIcebergStorageDetails) String() string {
...
func (m CreateZfsIcebergStorageDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateZfsIcebergStorageDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateZfsIcebergStorageDetails CreateZfsIcebergStorageDetails
	s := struct {
		DiscriminatorParam string `json:"storageType"`
		MarshalTypeCreateZfsIcebergStorageDetails
	}{
		"ZFS",
		(MarshalTypeCreateZfsIcebergStorageDetails)(m),
	}
