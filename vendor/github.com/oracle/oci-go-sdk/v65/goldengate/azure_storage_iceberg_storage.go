...
// AzureStorageIcebergStorage Represents an Azure Storage storage used in the Iceberg connection for an Oracle AI Data Catalog Iceberg catalogs.
type AzureStorageIcebergStorage struct {
...
func (m AzureStorageIcebergStorage) String() string {
...
func (m AzureStorageIcebergStorage) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m AzureStorageIcebergStorage) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAzureStorageIcebergStorage AzureStorageIcebergStorage
	s := struct {
		DiscriminatorParam string `json:"storageType"`
		MarshalTypeAzureStorageIcebergStorage
	}{
		"AZURE_STORAGE",
		(MarshalTypeAzureStorageIcebergStorage)(m),
	}
