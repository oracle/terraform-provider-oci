...
type UpdateMicrosoftFabricConnectionDetails struct {
...
func (m UpdateMicrosoftFabricConnectionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateMicrosoftFabricConnectionDetails UpdateMicrosoftFabricConnectionDetails
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeUpdateMicrosoftFabricConnectionDetails
	}{
		"MICROSOFT_FABRIC",
		(MarshalTypeUpdateMicrosoftFabricConnectionDetails)(m),
	}
