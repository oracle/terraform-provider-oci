...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/goldengate/GetDisasterRecoveryPrecheckReport.go.html to see an example of how to use GetDisasterRecoveryPrecheckReportRequest.
type GetDisasterRecoveryPrecheckReportRequest struct {
	...
	FaultDomain *string `mandatory:"true" contributesTo:"query" name:"faultDomain"`
