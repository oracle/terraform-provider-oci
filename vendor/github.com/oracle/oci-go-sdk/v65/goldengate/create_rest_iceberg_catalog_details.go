...
// CreateRestIcebergCatalogDetails The information about a new Rest catalog used in the Iceberg connection.
type CreateRestIcebergCatalogDetails struct {
...
func (m CreateRestIcebergCatalogDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateRestIcebergCatalogDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateRestIcebergCatalogDetails CreateRestIcebergCatalogDetails
	s := struct {
		DiscriminatorParam string `json:"catalogType"`
		MarshalTypeCreateRestIcebergCatalogDetails
	}{
		"REST",
		(MarshalTypeCreateRestIcebergCatalogDetails)(m),
	}
