...
// ZfsWarehouseStorage Represents a ZFS warehouse storage configuration for Oracle AI Data Catalog Storage connection.
type ZfsWarehouseStorage struct {
...
func (m ZfsWarehouseStorage) String() string {
...
func (m ZfsWarehouseStorage) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m ZfsWarehouseStorage) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeZfsWarehouseStorage ZfsWarehouseStorage
	s := struct {
		DiscriminatorParam string `json:"storageType"`
		MarshalTypeZfsWarehouseStorage
	}{
		"ZFS",
		(MarshalTypeZfsWarehouseStorage)(m),
	}
