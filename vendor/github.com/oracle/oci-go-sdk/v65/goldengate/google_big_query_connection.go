...
func (m GoogleBigQueryConnection) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m GoogleBigQueryConnection) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m GoogleBigQueryConnection) GetSecurityAttributes() map[string]map[string]interface{} {
...
func (m GoogleBigQueryConnection) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeGoogleBigQueryConnection GoogleBigQueryConnection
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeGoogleBigQueryConnection
	}{
		"GOOGLE_BIGQUERY",
		(MarshalTypeGoogleBigQueryConnection)(m),
	}
...
var mappingGoogleBigQueryConnectionTechnologyTypeEnum = map[string]GoogleBigQueryConnectionTechnologyTypeEnum{
	"GOOGLE_BIGQUERY": GoogleBigQueryConnectionTechnologyTypeGoogleBigquery,
}

var mappingGoogleBigQueryConnectionTechnologyTypeEnumLowerCase = map[string]GoogleBigQueryConnectionTechnologyTypeEnum{
	"google_bigquery": GoogleBigQueryConnectionTechnologyTypeGoogleBigquery,
}
...
func GetGoogleBigQueryConnectionTechnologyTypeEnumValues() []GoogleBigQueryConnectionTechnologyTypeEnum {
	values := make([]GoogleBigQueryConnectionTechnologyTypeEnum, 0)
	for _, v := range mappingGoogleBigQueryConnectionTechnologyTypeEnum {
...
func GetMappingGoogleBigQueryConnectionTechnologyTypeEnum(val string) (GoogleBigQueryConnectionTechnologyTypeEnum, bool) {
	enum, ok := mappingGoogleBigQueryConnectionTechnologyTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
