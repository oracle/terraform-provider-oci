...
func (m DefaultRefreshConnectionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDefaultRefreshConnectionDetails DefaultRefreshConnectionDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeDefaultRefreshConnectionDetails
	}{
		"DEFAULT",
		(MarshalTypeDefaultRefreshConnectionDetails)(m),
	}
