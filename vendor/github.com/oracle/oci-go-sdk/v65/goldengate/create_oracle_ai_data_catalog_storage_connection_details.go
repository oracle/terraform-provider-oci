...
// CreateOracleAiDataCatalogStorageConnectionDetails The information about a new Oracle AI Data Catalog Storage Connection.
type CreateOracleAiDataCatalogStorageConnectionDetails struct {
	...
	WarehouseStorage CreateWarehouseStorageDetails `mandatory:"true" json:"warehouseStorage"`
...
func (m CreateOracleAiDataCatalogStorageConnectionDetails) GetDisplayName() *string {
	return m.DisplayName
}

// GetDescription returns Description
func (m CreateOracleAiDataCatalogStorageConnectionDetails) GetDescription() *string {
	return m.Description
}

// GetCompartmentId returns CompartmentId
func (m CreateOracleAiDataCatalogStorageConnectionDetails) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetFreeformTags returns FreeformTags
func (m CreateOracleAiDataCatalogStorageConnectionDetails) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m CreateOracleAiDataCatalogStorageConnectionDetails) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetLocks returns Locks
func (m CreateOracleAiDataCatalogStorageConnectionDetails) GetLocks() []AddResourceLockDetails {
	return m.Locks
}

// GetVaultId returns VaultId
func (m CreateOracleAiDataCatalogStorageConnectionDetails) GetVaultId() *string {
	return m.VaultId
}

// GetKeyId returns KeyId
func (m CreateOracleAiDataCatalogStorageConnectionDetails) GetKeyId() *string {
	return m.KeyId
}

// GetNsgIds returns NsgIds
func (m CreateOracleAiDataCatalogStorageConnectionDetails) GetNsgIds() []string {
	return m.NsgIds
}

// GetSubnetId returns SubnetId
func (m CreateOracleAiDataCatalogStorageConnectionDetails) GetSubnetId() *string {
	return m.SubnetId
}

// GetRoutingMethod returns RoutingMethod
func (m CreateOracleAiDataCatalogStorageConnectionDetails) GetRoutingMethod() RoutingMethodEnum {
	return m.RoutingMethod
}

// GetDoesUseSecretIds returns DoesUseSecretIds
func (m CreateOracleAiDataCatalogStorageConnectionDetails) GetDoesUseSecretIds() *bool {
	return m.DoesUseSecretIds
}

// GetSubscriptionId returns SubscriptionId
func (m CreateOracleAiDataCatalogStorageConnectionDetails) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m CreateOracleAiDataCatalogStorageConnectionDetails) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m CreateOracleAiDataCatalogStorageConnectionDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

func (m CreateOracleAiDataCatalogStorageConnectionDetails) String() string {
...
func (m CreateOracleAiDataCatalogStorageConnectionDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateOracleAiDataCatalogStorageConnectionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateOracleAiDataCatalogStorageConnectionDetails CreateOracleAiDataCatalogStorageConnectionDetails
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeCreateOracleAiDataCatalogStorageConnectionDetails
	}{
		"ORACLE_AI_DATA_CATALOG_STORAGE",
		(MarshalTypeCreateOracleAiDataCatalogStorageConnectionDetails)(m),
	}
...
func (m *CreateOracleAiDataCatalogStorageConnectionDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {
		...
		WarehouseStorage        createwarehousestoragedetails                          `json:"warehouseStorage"`
	}{}
	...
	if nn != nil {
		m.WarehouseStorage = nn.(CreateWarehouseStorageDetails)
	} else {
