...
// UpdateZfsWarehouseStorageDetails The information to update the ZFS warehouse storage configuration for Oracle AI Data Catalog Storage connection.
type UpdateZfsWarehouseStorageDetails struct {
	...
	EndpointUrl *string `mandatory:"false" json:"endpointUrl"`
...
func (m UpdateZfsWarehouseStorageDetails) String() string {
...
func (m UpdateZfsWarehouseStorageDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m UpdateZfsWarehouseStorageDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateZfsWarehouseStorageDetails UpdateZfsWarehouseStorageDetails
	s := struct {
		DiscriminatorParam string `json:"storageType"`
		MarshalTypeUpdateZfsWarehouseStorageDetails
	}{
		"ZFS",
		(MarshalTypeUpdateZfsWarehouseStorageDetails)(m),
	}
