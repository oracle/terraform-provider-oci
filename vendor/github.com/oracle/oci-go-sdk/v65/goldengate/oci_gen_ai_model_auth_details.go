...
// OciGenAiModelAuthDetails OCI Generative AI authentication details for an AI Model connection.
type OciGenAiModelAuthDetails struct {
...
func (m OciGenAiModelAuthDetails) String() string {
...
func (m OciGenAiModelAuthDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m OciGenAiModelAuthDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOciGenAiModelAuthDetails OciGenAiModelAuthDetails
	s := struct {
		DiscriminatorParam string `json:"authType"`
		MarshalTypeOciGenAiModelAuthDetails
	}{
		"OCI_GEN_AI",
		(MarshalTypeOciGenAiModelAuthDetails)(m),
	}
