...
// UpdateOracleAiDataCatalogStorageConnectionDetails The information to update an Oracle AI Data Catalog Storage Connection.
type UpdateOracleAiDataCatalogStorageConnectionDetails struct {
	...
	WarehouseName *string `mandatory:"false" json:"warehouseName"`

	WarehouseStorage UpdateWarehouseStorageDetails `mandatory:"false" json:"warehouseStorage"`
...
func (m UpdateOracleAiDataCatalogStorageConnectionDetails) GetDisplayName() *string {
	return m.DisplayName
}

// GetDescription returns Description
func (m UpdateOracleAiDataCatalogStorageConnectionDetails) GetDescription() *string {
	return m.Description
}

// GetFreeformTags returns FreeformTags
func (m UpdateOracleAiDataCatalogStorageConnectionDetails) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m UpdateOracleAiDataCatalogStorageConnectionDetails) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetVaultId returns VaultId
func (m UpdateOracleAiDataCatalogStorageConnectionDetails) GetVaultId() *string {
	return m.VaultId
}

// GetKeyId returns KeyId
func (m UpdateOracleAiDataCatalogStorageConnectionDetails) GetKeyId() *string {
	return m.KeyId
}

// GetNsgIds returns NsgIds
func (m UpdateOracleAiDataCatalogStorageConnectionDetails) GetNsgIds() []string {
	return m.NsgIds
}

// GetSubnetId returns SubnetId
func (m UpdateOracleAiDataCatalogStorageConnectionDetails) GetSubnetId() *string {
	return m.SubnetId
}

// GetRoutingMethod returns RoutingMethod
func (m UpdateOracleAiDataCatalogStorageConnectionDetails) GetRoutingMethod() RoutingMethodEnum {
	return m.RoutingMethod
}

// GetDoesUseSecretIds returns DoesUseSecretIds
func (m UpdateOracleAiDataCatalogStorageConnectionDetails) GetDoesUseSecretIds() *bool {
	return m.DoesUseSecretIds
}

// GetSecurityAttributes returns SecurityAttributes
func (m UpdateOracleAiDataCatalogStorageConnectionDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

func (m UpdateOracleAiDataCatalogStorageConnectionDetails) String() string {
...
func (m UpdateOracleAiDataCatalogStorageConnectionDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m UpdateOracleAiDataCatalogStorageConnectionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateOracleAiDataCatalogStorageConnectionDetails UpdateOracleAiDataCatalogStorageConnectionDetails
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeUpdateOracleAiDataCatalogStorageConnectionDetails
	}{
		"ORACLE_AI_DATA_CATALOG_STORAGE",
		(MarshalTypeUpdateOracleAiDataCatalogStorageConnectionDetails)(m),
	}
...
func (m *UpdateOracleAiDataCatalogStorageConnectionDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {
		...
		WarehouseStorage   updatewarehousestoragedetails     `json:"warehouseStorage"`
	}{}
	...
	if nn != nil {
		m.WarehouseStorage = nn.(UpdateWarehouseStorageDetails)
	} else {
