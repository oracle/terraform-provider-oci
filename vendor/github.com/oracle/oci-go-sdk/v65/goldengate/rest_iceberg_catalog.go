...
// RestIcebergCatalog Represents a Rest catalog used in the Iceberg connection.
...
func (m RestIcebergCatalog) String() string {
...
func (m RestIcebergCatalog) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m RestIcebergCatalog) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeRestIcebergCatalog RestIcebergCatalog
	s := struct {
		DiscriminatorParam string `json:"catalogType"`
		MarshalTypeRestIcebergCatalog
	}{
		"REST",
		(MarshalTypeRestIcebergCatalog)(m),
	}
