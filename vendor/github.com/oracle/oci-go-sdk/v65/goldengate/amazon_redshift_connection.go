...
func (m AmazonRedshiftConnection) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m AmazonRedshiftConnection) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m AmazonRedshiftConnection) GetSecurityAttributes() map[string]map[string]interface{} {
