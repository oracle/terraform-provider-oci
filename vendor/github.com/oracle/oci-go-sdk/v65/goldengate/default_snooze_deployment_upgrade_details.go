...
func (m DefaultSnoozeDeploymentUpgradeDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDefaultSnoozeDeploymentUpgradeDetails DefaultSnoozeDeploymentUpgradeDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeDefaultSnoozeDeploymentUpgradeDetails
	}{
		"DEFAULT",
		(MarshalTypeDefaultSnoozeDeploymentUpgradeDetails)(m),
	}
