...
func (m GenerateLogReaderComponentLibraryUrlDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeGenerateLogReaderComponentLibraryUrlDetails GenerateLogReaderComponentLibraryUrlDetails
	s := struct {
		DiscriminatorParam string `json:"libraryType"`
		MarshalTypeGenerateLogReaderComponentLibraryUrlDetails
	}{
		"LOG_READER_COMPONENT",
		(MarshalTypeGenerateLogReaderComponentLibraryUrlDetails)(m),
	}
