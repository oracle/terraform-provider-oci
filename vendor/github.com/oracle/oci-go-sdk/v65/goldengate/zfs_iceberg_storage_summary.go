...
// ZfsIcebergStorageSummary Summary of the ZFS storage used in the Iceberg connection for an Oracle AI Data Catalog Iceberg catalogs.
type ZfsIcebergStorageSummary struct {
...
func (m ZfsIcebergStorageSummary) String() string {
...
func (m ZfsIcebergStorageSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m ZfsIcebergStorageSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeZfsIcebergStorageSummary ZfsIcebergStorageSummary
	s := struct {
		DiscriminatorParam string `json:"storageType"`
		MarshalTypeZfsIcebergStorageSummary
	}{
		"ZFS",
		(MarshalTypeZfsIcebergStorageSummary)(m),
	}
