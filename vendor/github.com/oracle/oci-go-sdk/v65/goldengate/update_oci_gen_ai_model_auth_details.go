...
// UpdateOciGenAiModelAuthDetails The information to update OCI Generative AI authentication details for an AI Model connection.
type UpdateOciGenAiModelAuthDetails struct {
	...
	KeyFingerprint *string `mandatory:"false" json:"keyFingerprint"`
...
func (m UpdateOciGenAiModelAuthDetails) String() string {
...
func (m UpdateOciGenAiModelAuthDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m UpdateOciGenAiModelAuthDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateOciGenAiModelAuthDetails UpdateOciGenAiModelAuthDetails
	s := struct {
		DiscriminatorParam string `json:"authType"`
		MarshalTypeUpdateOciGenAiModelAuthDetails
	}{
		"OCI_GEN_AI",
		(MarshalTypeUpdateOciGenAiModelAuthDetails)(m),
	}
