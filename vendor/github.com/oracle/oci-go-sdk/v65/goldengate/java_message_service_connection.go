...
func (m JavaMessageServiceConnection) GetSubscriptionId() *string {
	return m.SubscriptionId
}

// GetClusterPlacementGroupId returns ClusterPlacementGroupId
func (m JavaMessageServiceConnection) GetClusterPlacementGroupId() *string {
	return m.ClusterPlacementGroupId
}

// GetSecurityAttributes returns SecurityAttributes
func (m JavaMessageServiceConnection) GetSecurityAttributes() map[string]map[string]interface{} {
