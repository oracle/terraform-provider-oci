...
// MediaWorkflowJobFactSummary Summary of a MediaWorkflowJobFact
type MediaWorkflowJobFactSummary struct {
...
func (m MediaWorkflowJobFactSummary) String() string {
...
func (m MediaWorkflowJobFactSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
