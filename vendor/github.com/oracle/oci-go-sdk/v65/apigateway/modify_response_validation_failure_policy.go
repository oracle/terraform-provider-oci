...
func (m ModifyResponseValidationFailurePolicy) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeModifyResponseValidationFailurePolicy ModifyResponseValidationFailurePolicy
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeModifyResponseValidationFailurePolicy
	}{
		"MODIFY_RESPONSE",
		(MarshalTypeModifyResponseValidationFailurePolicy)(m),
	}
