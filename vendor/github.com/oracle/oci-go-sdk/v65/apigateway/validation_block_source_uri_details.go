...
func (m ValidationBlockSourceUriDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeValidationBlockSourceUriDetails ValidationBlockSourceUriDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeValidationBlockSourceUriDetails
	}{
		"VALIDATION_BLOCK",
		(MarshalTypeValidationBlockSourceUriDetails)(m),
	}
