...
func (request CancelInstanceAgentCommandRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["instanceAgentCommandId"] != nil {
		templateParam := mandatoryParamMap["instanceAgentCommandId"]
		for _, template := range templateParam {
			replacementParam := *request.InstanceAgentCommandId
