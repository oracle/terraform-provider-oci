...
// UpdateEmailSubdomainDetails Details for email subdomain
type UpdateEmailSubdomainDetails struct {
...
func (m UpdateEmailSubdomainDetails) String() string {
...
func (m UpdateEmailSubdomainDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
