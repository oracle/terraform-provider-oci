...
// UpdateVanityDomainDetails The information about scheduled VanityDomain refresh.
type UpdateVanityDomainDetails struct {
	CertificateInfo *CertificateInfo `mandatory:"false" json:"certificateInfo"`
}

func (m UpdateVanityDomainDetails) String() string {
...
func (m UpdateVanityDomainDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
