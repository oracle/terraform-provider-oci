...
// CreateEmailSubdomainDetails Configuration details for email subdomain.
type CreateEmailSubdomainDetails struct {
...
func (m CreateEmailSubdomainDetails) String() string {
...
func (m CreateEmailSubdomainDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
