...
// UpdateVanityDomainActivityDetails The information about scheduled refresh.
type UpdateVanityDomainActivityDetails struct {

	// Expected activity start time
	TimeScheduled *common.SDKTime `mandatory:"false" json:"timeScheduled"`
}

func (m UpdateVanityDomainActivityDetails) String() string {
...
func (m UpdateVanityDomainActivityDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
