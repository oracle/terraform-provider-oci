...
// MfaEnforcementAction Multi-Factor Authentication (MFA) enforcement.
type MfaEnforcementAction struct {
...
func (m MfaEnforcementAction) GetReferenceKey() *string {
	return m.ReferenceKey
}

// GetState returns State
func (m MfaEnforcementAction) GetState() ActionStateEnum {
	return m.State
}

// GetDescription returns Description
func (m MfaEnforcementAction) GetDescription() *string {
	return m.Description
}

func (m MfaEnforcementAction) String() string {
...
func (m MfaEnforcementAction) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m MfaEnforcementAction) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeMfaEnforcementAction MfaEnforcementAction
	s := struct {
		DiscriminatorParam string `json:"actionType"`
		MarshalTypeMfaEnforcementAction
	}{
		"MFA_ENFORCEMENT",
		(MarshalTypeMfaEnforcementAction)(m),
	}
