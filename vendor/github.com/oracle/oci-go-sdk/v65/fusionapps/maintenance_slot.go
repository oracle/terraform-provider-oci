...
// MaintenanceSlot FA maintenance slot information.
type MaintenanceSlot struct {
	MaintenanceStartTimeRule *MaintenanceStartTimeRule `mandatory:"true" json:"maintenanceStartTimeRule"`

	// The quarterly maintenance month group schedule of the Fusion environment family.
	QuarterlyUpgradeBeginTimes *string `mandatory:"true" json:"quarterlyUpgradeBeginTimes"`

	// FA maintenance slot available to use or not. The 'false' value denotes maintenance slot full
	IsAvailable *bool `mandatory:"true" json:"isAvailable"`
}

func (m MaintenanceSlot) String() string {
...
func (m MaintenanceSlot) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
