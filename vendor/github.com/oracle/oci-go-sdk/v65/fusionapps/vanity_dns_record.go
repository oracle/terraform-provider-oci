...
// VanityDnsRecord DNS record for vanity domain
type VanityDnsRecord struct {
...
func (m VanityDnsRecord) String() string {
...
func (m VanityDnsRecord) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
