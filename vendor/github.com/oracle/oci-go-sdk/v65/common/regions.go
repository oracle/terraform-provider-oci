...
const (
    ...
    //RegionMENeom1 region Neom
    RegionMENeom1 Region = "me-neom-1"
    //RegionEUKragujevac1 region Kragujevac
    RegionEUKragujevac1 Region = "eu-kragujevac-1"
    ...
    //RegionUSSaltlake1 region Saltlake
    RegionUSSaltlake1 Region = "us-saltlake-1"
    ...
    //RegionUSQuincy1 region Quincy
    RegionUSQuincy1 Region = "us-quincy-1"
    //RegionEUDublin3 region Dublin
    RegionEUDublin3 Region = "eu-dublin-3"
    //RegionUSBoardman1 region Boardman
    RegionUSBoardman1 Region = "us-boardman-1"
    //RegionUSDesmoines1 region Desmoines
    ...
    //RegionUSWestjordan1 region Westjordan
    ...
    //RegionMEAlrayyan1 region Alrayyan
    RegionMEAlrayyan1 Region = "me-alrayyan-1"
    ...
    //RegionUSTukwila2 region Tukwila
    RegionUSTukwila2 Region = "us-tukwila-2"
    //RegionUSTukwila3 region Tukwila
