...
func (m DisabledServiceDiscoveryConfiguration) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDisabledServiceDiscoveryConfiguration DisabledServiceDiscoveryConfiguration
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeDisabledServiceDiscoveryConfiguration
	}{
		"DISABLED",
		(MarshalTypeDisabledServiceDiscoveryConfiguration)(m),
	}
