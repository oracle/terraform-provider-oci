...
func (m TlsPassthroughIngressGatewayTrafficRouteRuleDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeTlsPassthroughIngressGatewayTrafficRouteRuleDetails TlsPassthroughIngressGatewayTrafficRouteRuleDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeTlsPassthroughIngressGatewayTrafficRouteRuleDetails
	}{
		"TLS_PASSTHROUGH",
		(MarshalTypeTlsPassthroughIngressGatewayTrafficRouteRuleDetails)(m),
	}
