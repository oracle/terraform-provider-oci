...
func (request PauseFilesystemSnapshotPolicyRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["filesystemSnapshotPolicyId"] != nil {
		templateParam := mandatoryParamMap["filesystemSnapshotPolicyId"]
		for _, template := range templateParam {
			replacementParam := *request.FilesystemSnapshotPolicyId
