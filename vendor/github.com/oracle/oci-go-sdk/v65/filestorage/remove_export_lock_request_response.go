...
func (request RemoveExportLockRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["exportId"] != nil {
		templateParam := mandatoryParamMap["exportId"]
		for _, template := range templateParam {
			replacementParam := *request.ExportId
