...
func (request GetExportSetRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["exportSetId"] != nil {
		templateParam := mandatoryParamMap["exportSetId"]
		for _, template := range templateParam {
			replacementParam := *request.ExportSetId
