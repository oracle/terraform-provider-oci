...
const (
	WorkRequestSummaryOperationTypeToggleFilesystemQuotas WorkRequestSummaryOperationTypeEnum = "TOGGLE_FILESYSTEM_QUOTAS"
)

var mappingWorkRequestSummaryOperationTypeEnum = map[string]WorkRequestSummaryOperationTypeEnum{
	"TOGGLE_FILESYSTEM_QUOTAS": WorkRequestSummaryOperationTypeToggleFilesystemQuotas,
}
