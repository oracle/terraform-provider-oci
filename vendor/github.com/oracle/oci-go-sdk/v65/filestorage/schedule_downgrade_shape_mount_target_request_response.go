...
func (request ScheduleDowngradeShapeMountTargetRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["mountTargetId"] != nil {
		templateParam := mandatoryParamMap["mountTargetId"]
		for _, template := range templateParam {
			replacementParam := *request.MountTargetId
