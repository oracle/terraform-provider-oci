...
func (m OutboundConnectorTestResults) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingOutboundConnectorTestResultsOverallResultEnum(string(m.OverallResult)); !ok && m.OverallResult != "" {
...
var mappingOutboundConnectorTestResultsOverallResultEnumLowerCase = map[string]OutboundConnectorTestResultsOverallResultEnum{
	"success":        OutboundConnectorTestResultsOverallResultSuccess,
	"partialsuccess": OutboundConnectorTestResultsOverallResultPartialsuccess,
	"fail":           OutboundConnectorTestResultsOverallResultFail,
}
...
// GetMappingOutboundConnectorTestResultsOverallResultEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingOutboundConnectorTestResultsOverallResultEnum(val string) (OutboundConnectorTestResultsOverallResultEnum, bool) {
	enum, ok := mappingOutboundConnectorTestResultsOverallResultEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
