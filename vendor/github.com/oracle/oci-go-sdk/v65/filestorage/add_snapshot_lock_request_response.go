...
func (request AddSnapshotLockRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["snapshotId"] != nil {
		templateParam := mandatoryParamMap["snapshotId"]
		for _, template := range templateParam {
			replacementParam := *request.SnapshotId
