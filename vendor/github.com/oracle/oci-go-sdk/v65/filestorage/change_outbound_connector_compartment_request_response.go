...
func (request ChangeOutboundConnectorCompartmentRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["outboundConnectorId"] != nil {
		templateParam := mandatoryParamMap["outboundConnectorId"]
		for _, template := range templateParam {
			replacementParam := *request.OutboundConnectorId
