...
func (m LifecycleOperationConfigCategoryDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeLifecycleOperationConfigCategoryDetails LifecycleOperationConfigCategoryDetails
	s := struct {
		DiscriminatorParam string `json:"configCategory"`
		MarshalTypeLifecycleOperationConfigCategoryDetails
	}{
		"LIFECYCLE_OPERATION",
		(MarshalTypeLifecycleOperationConfigCategoryDetails)(m),
	}
