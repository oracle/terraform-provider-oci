...
// RetrievePatchesByConditionDetails Details for listing Patches based on condition.
type RetrievePatchesByConditionDetails struct {
	...
	// Filters patches for the specified Product Ids (PlatformConfiguration Ids corresponding to the Products).
	Products []string `mandatory:"false" json:"products"`

	// Filters patches matching the given Patch Type Id (PlatformConfiguration Id).
	PatchType *string `mandatory:"false" json:"patchType"`

	// Filters patches matching the specified severity level.
	PatchSeverity PatchSeverityEnum `mandatory:"false" json:"patchSeverity,omitempty"`
}

func (m RetrievePatchesByConditionDetails) String() string {
...
func (m RetrievePatchesByConditionDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
