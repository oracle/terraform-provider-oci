...
func (m StringVariable) GetTitle() *string {
	return m.Title
}

// GetDescription returns Description
func (m StringVariable) GetDescription() *string {
	return m.Description
}

// GetIsRequired returns IsRequired
func (m StringVariable) GetIsRequired() *bool {
	return m.IsRequired
}

// GetMandatory returns Mandatory
func (m StringVariable) GetMandatory() *string {
	return m.Mandatory
}

// GetVisible returns Visible
func (m StringVariable) GetVisible() *string {
	return m.Visible
}

func (m StringVariable) String() string {
...
func (m StringVariable) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m StringVariable) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeStringVariable StringVariable
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeStringVariable
	}{
		"STRING",
		(MarshalTypeStringVariable)(m),
	}
