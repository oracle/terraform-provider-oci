...
type GetCompliancePolicyRuleRequest struct {
	...
	CompliancePolicyRuleId *string `mandatory:"true" contributesTo:"path" name:"compliancePolicyRuleId"`
...
type GetCompliancePolicyRuleResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The CompliancePolicyRule instance
	CompliancePolicyRule `presentIn:"body"`
