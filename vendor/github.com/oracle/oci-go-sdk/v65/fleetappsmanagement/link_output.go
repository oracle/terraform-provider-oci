...
type LinkOutput struct {
	...
	DisplayText *string `mandatory:"false" json:"displayText"`
...
func (m LinkOutput) GetTitle() *string {
	return m.Title
}

// GetDescription returns Description
func (m LinkOutput) GetDescription() *string {
	return m.Description
}

// GetIsSensitive returns IsSensitive
func (m LinkOutput) GetIsSensitive() *bool {
	return m.IsSensitive
}

// GetFormat returns Format
func (m LinkOutput) GetFormat() *string {
	return m.Format
}

// GetVisible returns Visible
func (m LinkOutput) GetVisible() *string {
	return m.Visible
}

func (m LinkOutput) String() string {
...
func (m LinkOutput) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m LinkOutput) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeLinkOutput LinkOutput
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeLinkOutput
	}{
		"LINK",
		(MarshalTypeLinkOutput)(m),
	}
