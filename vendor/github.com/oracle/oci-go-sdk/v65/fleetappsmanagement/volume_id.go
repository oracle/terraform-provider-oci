...
func (m VolumeId) GetTitle() *string {
	return m.Title
}

// GetDescription returns Description
func (m VolumeId) GetDescription() *string {
	return m.Description
}

// GetIsRequired returns IsRequired
func (m VolumeId) GetIsRequired() *bool {
	return m.IsRequired
}

// GetMandatory returns Mandatory
func (m VolumeId) GetMandatory() *string {
	return m.Mandatory
}

// GetVisible returns Visible
func (m VolumeId) GetVisible() *string {
	return m.Visible
}
...
func (m VolumeId) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m VolumeId) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeVolumeId VolumeId
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeVolumeId
	}{
		"OCI_CORE_VOLUME_ID",
		(MarshalTypeVolumeId)(m),
	}
