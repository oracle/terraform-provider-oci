...
type SecurityListId struct {
	...
	DependsOn *SecurityListIdDependsOn `mandatory:"false" json:"dependsOn"`
}

// GetTitle returns Title
func (m SecurityListId) GetTitle() *string {
	return m.Title
}

// GetDescription returns Description
func (m SecurityListId) GetDescription() *string {
	return m.Description
}

// GetIsRequired returns IsRequired
func (m SecurityListId) GetIsRequired() *bool {
	return m.IsRequired
}

// GetMandatory returns Mandatory
func (m SecurityListId) GetMandatory() *string {
	return m.Mandatory
}

// GetVisible returns Visible
func (m SecurityListId) GetVisible() *string {
	return m.Visible
}

func (m SecurityListId) String() string {
...
func (m SecurityListId) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m SecurityListId) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeSecurityListId SecurityListId
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeSecurityListId
	}{
		"OCI_CORE_SECURITYLIST_ID",
		(MarshalTypeSecurityListId)(m),
	}
