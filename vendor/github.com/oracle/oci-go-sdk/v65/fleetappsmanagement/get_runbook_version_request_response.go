...
type GetRunbookVersionRequest struct {

	// Unique Runbook Version identifier
	RunbookVersionId *string `mandatory:"true" contributesTo:"path" name:"runbookVersionId"`
...
type GetRunbookVersionResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The RunbookVersion instance
	RunbookVersion `presentIn:"body"`
