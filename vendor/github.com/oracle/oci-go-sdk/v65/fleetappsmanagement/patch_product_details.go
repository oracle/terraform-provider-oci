...
// PatchProductDetails Product
type PatchProductDetails struct {
...
func (m PatchProductDetails) String() string {
...
func (m PatchProductDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
