...
// LogAnalyticsLogGroup Log analytics log group.
type LogAnalyticsLogGroup struct {
	...
	DependsOn *LogAnalyticsLogGroupDependsOn `mandatory:"false" json:"dependsOn"`
}

// GetTitle returns Title
func (m LogAnalyticsLogGroup) GetTitle() *string {
	return m.Title
}

// GetDescription returns Description
func (m LogAnalyticsLogGroup) GetDescription() *string {
	return m.Description
}

// GetIsRequired returns IsRequired
func (m LogAnalyticsLogGroup) GetIsRequired() *bool {
	return m.IsRequired
}

// GetMandatory returns Mandatory
func (m LogAnalyticsLogGroup) GetMandatory() *string {
	return m.Mandatory
}

// GetVisible returns Visible
func (m LogAnalyticsLogGroup) GetVisible() *string {
	return m.Visible
}
...
func (m LogAnalyticsLogGroup) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeLogAnalyticsLogGroup LogAnalyticsLogGroup
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeLogAnalyticsLogGroup
	}{
		"OCI_LOGAN_LOGGROUP_ID",
		(MarshalTypeLogAnalyticsLogGroup)(m),
	}
