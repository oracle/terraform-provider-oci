...
func (m ProductFleetDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeProductFleetDetails ProductFleetDetails
	s := struct {
		DiscriminatorParam string `json:"fleetType"`
		MarshalTypeProductFleetDetails
	}{
		"PRODUCT",
		(MarshalTypeProductFleetDetails)(m),
	}
