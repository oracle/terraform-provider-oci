...
func (m IntegerVariable) GetTitle() *string {
	return m.Title
}

// GetDescription returns Description
func (m IntegerVariable) GetDescription() *string {
	return m.Description
}

// GetIsRequired returns IsRequired
func (m IntegerVariable) GetIsRequired() *bool {
	return m.IsRequired
}

// GetMandatory returns Mandatory
func (m IntegerVariable) GetMandatory() *string {
	return m.Mandatory
}

// GetVisible returns Visible
func (m IntegerVariable) GetVisible() *string {
	return m.Visible
}

func (m IntegerVariable) String() string {
...
func (m IntegerVariable) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m IntegerVariable) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeIntegerVariable IntegerVariable
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeIntegerVariable
	}{
		"INTEGER",
		(MarshalTypeIntegerVariable)(m),
	}
