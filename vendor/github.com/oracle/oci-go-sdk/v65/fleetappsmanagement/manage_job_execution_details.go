...
type ManageJobExecutionDetails struct {
	ActionDetails UserActionDetails `mandatory:"true" json:"actionDetails"`
}
...
func (m *ManageJobExecutionDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {
		ActionDetails useractiondetails `json:"actionDetails"`
	}{}
	...
	if nn != nil {
		m.ActionDetails = nn.(UserActionDetails)
	} else {
		m.ActionDetails = nil
	}
