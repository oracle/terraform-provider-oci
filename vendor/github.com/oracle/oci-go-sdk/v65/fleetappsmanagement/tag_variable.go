...
type TagVariable struct {
	...
	DependsOn *TagVariableDependsOn `mandatory:"false" json:"dependsOn"`
}

// GetTitle returns Title
func (m TagVariable) GetTitle() *string {
	return m.Title
}

// GetDescription returns Description
func (m TagVariable) GetDescription() *string {
	return m.Description
}

// GetIsRequired returns IsRequired
func (m TagVariable) GetIsRequired() *bool {
	return m.IsRequired
}

// GetMandatory returns Mandatory
func (m TagVariable) GetMandatory() *string {
	return m.Mandatory
}

// GetVisible returns Visible
func (m TagVariable) GetVisible() *string {
	return m.Visible
}

func (m TagVariable) String() string {
...
func (m TagVariable) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m TagVariable) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeTagVariable TagVariable
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeTagVariable
	}{
		"OCI_IDENTITY_TAG_VALUE",
		(MarshalTypeTagVariable)(m),
	}
