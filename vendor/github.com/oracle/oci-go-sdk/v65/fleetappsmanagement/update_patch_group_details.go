...
// UpdatePatchGroupDetails The patch group information to be updated.
type UpdatePatchGroupDetails struct {
...
func (m UpdatePatchGroupDetails) String() string {
...
func (m UpdatePatchGroupDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
