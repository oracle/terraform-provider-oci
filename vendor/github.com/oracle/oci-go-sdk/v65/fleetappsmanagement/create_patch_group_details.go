...
// CreatePatchGroupDetails The information about new Patch group.
type CreatePatchGroupDetails struct {
...
func (m CreatePatchGroupDetails) String() string {
...
func (m CreatePatchGroupDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
