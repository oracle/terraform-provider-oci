...
type CloneCatalogItemRequest struct {

	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the CatalogItem.
	CatalogItemId *string `mandatory:"true" contributesTo:"path" name:"catalogItemId"`

	// The information to be updated.
	CloneCatalogItemDetails `contributesTo:"body"`
...
type CloneCatalogItemResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The CatalogItem instance
	CatalogItem `presentIn:"body"`
