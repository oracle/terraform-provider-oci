...
// FleetTargetBasedActionGroupDetails A string variable that holds a value
type FleetTargetBasedActionGroupDetails struct {
...
func (m FleetTargetBasedActionGroupDetails) GetDisplayName() *string {
	return m.DisplayName
}

// GetProduct returns Product
func (m FleetTargetBasedActionGroupDetails) GetProduct() *string {
	return m.Product
}

// GetLifecycleOperation returns LifecycleOperation
func (m FleetTargetBasedActionGroupDetails) GetLifecycleOperation() *string {
	return m.LifecycleOperation
}

// GetActivityId returns ActivityId
func (m FleetTargetBasedActionGroupDetails) GetActivityId() *string {
	return m.ActivityId
}

// GetStatus returns Status
func (m FleetTargetBasedActionGroupDetails) GetStatus() JobStatusEnum {
	return m.Status
}

// GetTimeStarted returns TimeStarted
func (m FleetTargetBasedActionGroupDetails) GetTimeStarted() *common.SDKTime {
	return m.TimeStarted
}

// GetTimeEnded returns TimeEnded
func (m FleetTargetBasedActionGroupDetails) GetTimeEnded() *common.SDKTime {
	return m.TimeEnded
}

func (m FleetTargetBasedActionGroupDetails) String() string {
...
func (m FleetTargetBasedActionGroupDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m FleetTargetBasedActionGroupDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeFleetTargetBasedActionGroupDetails FleetTargetBasedActionGroupDetails
	s := struct {
		DiscriminatorParam string `json:"kind"`
		MarshalTypeFleetTargetBasedActionGroupDetails
	}{
		"FLEET_TARGETS_USING_RUNBOOK",
		(MarshalTypeFleetTargetBasedActionGroupDetails)(m),
	}
