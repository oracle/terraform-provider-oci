...
// PatchNameSelectionDetails Patch Name Details.
// If you set the policy rule by selecting this option, provide a specific patch name.
type PatchNameSelectionDetails struct {
...
func (m PatchNameSelectionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePatchNameSelectionDetails PatchNameSelectionDetails
	s := struct {
		DiscriminatorParam string `json:"selectionType"`
		MarshalTypePatchNameSelectionDetails
	}{
		"PATCH_NAME",
		(MarshalTypePatchNameSelectionDetails)(m),
	}
