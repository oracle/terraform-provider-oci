...
type NumberOutput struct {
	...
	// Number output value.
	Value *float32 `mandatory:"false" json:"value"`
}

// GetTitle returns Title
func (m NumberOutput) GetTitle() *string {
	return m.Title
}

// GetDescription returns Description
func (m NumberOutput) GetDescription() *string {
	return m.Description
}

// GetIsSensitive returns IsSensitive
func (m NumberOutput) GetIsSensitive() *bool {
	return m.IsSensitive
}

// GetFormat returns Format
func (m NumberOutput) GetFormat() *string {
	return m.Format
}

// GetVisible returns Visible
func (m NumberOutput) GetVisible() *string {
	return m.Visible
}

func (m NumberOutput) String() string {
...
func (m NumberOutput) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m NumberOutput) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeNumberOutput NumberOutput
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeNumberOutput
	}{
		"NUMBER",
		(MarshalTypeNumberOutput)(m),
	}
