...
var mappingLifecycleStateEnumEnum = map[string]LifecycleStateEnumEnum{
	"ACTIVE":   LifecycleStateEnumActive,
	"INACTIVE": LifecycleStateEnumInactive,
	"DELETED":  LifecycleStateEnumDeleted,
	"FAILED":   LifecycleStateEnumFailed,
}

var mappingLifecycleStateEnumEnumLowerCase = map[string]LifecycleStateEnumEnum{
	"active":   LifecycleStateEnumActive,
	"inactive": LifecycleStateEnumInactive,
	"deleted":  LifecycleStateEnumDeleted,
	"failed":   LifecycleStateEnumFailed,
...
func GetLifecycleStateEnumEnumValues() []LifecycleStateEnumEnum {
	...
	for _, v := range mappingLifecycleStateEnumEnum {
...
func GetMappingLifecycleStateEnumEnum(val string) (LifecycleStateEnumEnum, bool) {
	enum, ok := mappingLifecycleStateEnumEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
