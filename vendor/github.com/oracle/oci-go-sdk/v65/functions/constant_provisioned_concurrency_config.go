...
func (m ConstantProvisionedConcurrencyConfig) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeConstantProvisionedConcurrencyConfig ConstantProvisionedConcurrencyConfig
	s := struct {
		DiscriminatorParam string `json:"strategy"`
		MarshalTypeConstantProvisionedConcurrencyConfig
	}{
		"CONSTANT",
		(MarshalTypeConstantProvisionedConcurrencyConfig)(m),
	}
