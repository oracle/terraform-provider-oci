...
func (request GetPbfListingVersionRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["pbfListingVersionId"] != nil {
		templateParam := mandatoryParamMap["pbfListingVersionId"]
		for _, template := range templateParam {
			replacementParam := *request.PbfListingVersionId
