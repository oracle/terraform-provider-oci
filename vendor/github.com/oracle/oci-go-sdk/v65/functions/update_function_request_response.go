...
func (request UpdateFunctionRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["functionId"] != nil {
		templateParam := mandatoryParamMap["functionId"]
		for _, template := range templateParam {
			replacementParam := *request.FunctionId
