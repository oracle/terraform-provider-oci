...
// StreamSuccessDestinationDetails The destination stream in the Streaming service to which to send the response of the successful asynchronous function invocation.
