...
// NotificationFailureDestinationDetails The destination topic in the Notifications service to which to send the response of the failed asynchronous function invocation.
