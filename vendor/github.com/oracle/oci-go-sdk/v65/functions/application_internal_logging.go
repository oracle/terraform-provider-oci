...
type ApplicationInternalLogging struct {
	...
	// Lumberjack log group within the namespace.
...
func (m ApplicationInternalLogging) String() string {
...
func (m ApplicationInternalLogging) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
