...
func (request GetFunctionsRuntimeVersionRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["functionsRuntimeVersionId"] != nil {
		templateParam := mandatoryParamMap["functionsRuntimeVersionId"]
		for _, template := range templateParam {
			replacementParam := *request.FunctionsRuntimeVersionId
