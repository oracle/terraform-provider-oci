...
func (m NotificationSuccessDestinationDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeNotificationSuccessDestinationDetails NotificationSuccessDestinationDetails
	s := struct {
		DiscriminatorParam string `json:"kind"`
		MarshalTypeNotificationSuccessDestinationDetails
	}{
		"NOTIFICATION",
		(MarshalTypeNotificationSuccessDestinationDetails)(m),
	}
