...
func (request GetFunctionsRuntimeRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["functionsRuntimeId"] != nil {
		templateParam := mandatoryParamMap["functionsRuntimeId"]
		for _, template := range templateParam {
			replacementParam := *request.FunctionsRuntimeId
