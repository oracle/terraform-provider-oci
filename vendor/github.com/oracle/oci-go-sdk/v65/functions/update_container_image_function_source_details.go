...
func (m UpdateContainerImageFunctionSourceDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateContainerImageFunctionSourceDetails UpdateContainerImageFunctionSourceDetails
	s := struct {
		DiscriminatorParam string `json:"sourceType"`
		MarshalTypeUpdateContainerImageFunctionSourceDetails
	}{
		"CONTAINER_IMAGE",
		(MarshalTypeUpdateContainerImageFunctionSourceDetails)(m),
	}
