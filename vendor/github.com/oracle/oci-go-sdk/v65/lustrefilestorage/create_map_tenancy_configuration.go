...
// CreateMapTenancyConfiguration Response to be returned post successful mapping
type CreateMapTenancyConfiguration struct {

	// The response message
	Message *string `mandatory:"true" json:"message"`
}

func (m CreateMapTenancyConfiguration) String() string {
...
func (m CreateMapTenancyConfiguration) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
