...
// TenancyOverride A construct that stores configuration and capacity reservation overrides for a tenant.
type TenancyOverride struct {
...
func (m TenancyOverride) String() string {
...
func (m TenancyOverride) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
