...
// TenancyOverrideSummary A construct that stores configuration and capacity reservation overrides for a tenant.
type TenancyOverrideSummary struct {

	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the tenant.
	TenancyId *string `mandatory:"true" json:"tenancyId"`

	// The list of overrides for a tenant.
	Overrides []interface{} `mandatory:"true" json:"overrides"`
}

func (m TenancyOverrideSummary) String() string {
...
func (m TenancyOverrideSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
