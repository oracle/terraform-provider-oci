...
// TenancyConfigurationSummary Details of the tenancy configuration
type TenancyConfigurationSummary struct {

	// The tenancy OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
	TenancyId *string `mandatory:"true" json:"tenancyId"`

	// The profile name which is applicable for the given tenancy.
	Profile *string `mandatory:"false" json:"profile"`

	CapacityReservations *CapacityReservationsCollection `mandatory:"false" json:"capacityReservations"`
}

func (m TenancyConfigurationSummary) String() string {
...
func (m TenancyConfigurationSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
