...
// UpdateLfsCpgInfoDetails The data required for creating a LFS CPG Info.
type UpdateLfsCpgInfoDetails struct {

	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the default capacity reservation.
	DefaultCapacityReservationId *string `mandatory:"false" json:"defaultCapacityReservationId"`
...
func (m UpdateLfsCpgInfoDetails) String() string {
...
func (m UpdateLfsCpgInfoDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
