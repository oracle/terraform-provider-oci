...
// CapacityReservationInfo An object that gives more details about a capacity reservation.
...
func (m CapacityReservationInfo) String() string {
...
func (m CapacityReservationInfo) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
