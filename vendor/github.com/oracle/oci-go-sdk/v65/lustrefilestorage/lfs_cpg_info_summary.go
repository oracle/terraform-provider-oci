...
// LfsCpgInfoSummary An object that gives more details about a LFS CPG.
type LfsCpgInfoSummary struct {
...
func (m LfsCpgInfoSummary) String() string {
...
func (m LfsCpgInfoSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
