...
// MapTenancyConfiguration Details required to create tenancy configuration
type MapTenancyConfiguration struct {
...
func (m MapTenancyConfiguration) String() string {
...
func (m MapTenancyConfiguration) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
