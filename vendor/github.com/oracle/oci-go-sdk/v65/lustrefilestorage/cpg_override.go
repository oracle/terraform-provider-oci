...
// CpgOverride A mapping between a customer CPG and an LFS service CPG.
type CpgOverride struct {
...
func (m CpgOverride) String() string {
...
func (m CpgOverride) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
