...
// UpdateCpgOverrideDetails The data required for updating a CPG Override.
type UpdateCpgOverrideDetails struct {
...
func (m UpdateCpgOverrideDetails) String() string {
...
func (m UpdateCpgOverrideDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
