...
// CreateTenancyOverrideDetails The data required for creating a Tenancy Override.
type CreateTenancyOverrideDetails struct {
...
func (m CreateTenancyOverrideDetails) String() string {
...
func (m CreateTenancyOverrideDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
