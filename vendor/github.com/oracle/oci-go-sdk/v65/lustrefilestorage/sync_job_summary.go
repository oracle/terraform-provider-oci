...
type SyncJobSummary struct {
	...
	// Count of files or objects that were skipped during transfer because `isOverwrite` was false.
	// This value will be zero when `isOverwrite` is true.
	SkippedOverwriteCount *int64 `mandatory:"true" json:"skippedOverwriteCount"`

	// Count of files or objects that were overwritten during transfer because `isOverwrite` was true.
