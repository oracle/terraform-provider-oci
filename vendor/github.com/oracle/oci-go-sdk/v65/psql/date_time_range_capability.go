...
// DateTimeRangeCapability Indicates whether a time range is required for the insight.
type DateTimeRangeCapability struct {

	// Indicates whether start and end time parameters are required.
	IsRequired *bool `mandatory:"true" json:"isRequired"`
}

func (m DateTimeRangeCapability) String() string {
...
func (m DateTimeRangeCapability) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
