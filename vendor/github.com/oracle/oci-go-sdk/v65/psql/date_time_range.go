...
// DateTimeRange The start and end timestamps for the requested data.
type DateTimeRange struct {

	// The inclusive start timestamp of the data range.
	...
	// The inclusive end timestamp of the data range.
	// The value must be an RFC 3339 (https://tools.ietf.org/html/rfc3339)
	// timestamp.
	// Example: `2016-08-25T21:10:29Z`
...
func (m DateTimeRange) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
