...
// TableColumn Definition of a single column in the table view
type TableColumn struct {

	// The key used in the row object.
	Name *string `mandatory:"true" json:"name"`

	// Data type: STRING|INT64|DOUBLE|TIMESTAMP|DURATION|PERCENTAGE|ARRAY|JSON...
	DataType *string `mandatory:"true" json:"dataType"`

	// Optional Display Name for the UI header.
	Label *string `mandatory:"false" json:"label"`

	// Optional unit (e.g., "ms", "GB", "Count").
