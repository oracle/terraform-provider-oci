...
func (m ServiceAvailabilityFactorBatchingStrategyDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeServiceAvailabilityFactorBatchingStrategyDetails ServiceAvailabilityFactorBatchingStrategyDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeServiceAvailabilityFactorBatchingStrategyDetails
	}{
		"SERVICE_AVAILABILITY_FACTOR",
		(MarshalTypeServiceAvailabilityFactorBatchingStrategyDetails)(m),
	}
