...
// GiSoftwareComponentDetails Details of 'GI' component in an Exadata software stack.
type GiSoftwareComponentDetails struct {
...
func (m GiSoftwareComponentDetails) String() string {
...
func (m GiSoftwareComponentDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m GiSoftwareComponentDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeGiSoftwareComponentDetails GiSoftwareComponentDetails
	s := struct {
		DiscriminatorParam string `json:"componentType"`
		MarshalTypeGiSoftwareComponentDetails
	}{
		"GI",
		(MarshalTypeGiSoftwareComponentDetails)(m),
	}
...
func (m *GiSoftwareComponentDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {
