...
// SingleTargetPrecheckAction Single Target Precheck Exadata Fleet Update Action details.
type SingleTargetPrecheckAction struct {
...
// GetId returns Id
func (m SingleTargetPrecheckAction) GetId() *string {
	return m.Id
}

// GetDisplayName returns DisplayName
func (m SingleTargetPrecheckAction) GetDisplayName() *string {
	return m.DisplayName
}

// GetCompartmentId returns CompartmentId
func (m SingleTargetPrecheckAction) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetTimeCreated returns TimeCreated
func (m SingleTargetPrecheckAction) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeStarted returns TimeStarted
func (m SingleTargetPrecheckAction) GetTimeStarted() *common.SDKTime {
	return m.TimeStarted
}

// GetTimeFinished returns TimeFinished
func (m SingleTargetPrecheckAction) GetTimeFinished() *common.SDKTime {
	return m.TimeFinished
}

// GetTimeUpdated returns TimeUpdated
func (m SingleTargetPrecheckAction) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetLifecycleState returns LifecycleState
func (m SingleTargetPrecheckAction) GetLifecycleState() ActionLifecycleStatesEnum {
	return m.LifecycleState
}

// GetLifecycleDetails returns LifecycleDetails
func (m SingleTargetPrecheckAction) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetFreeformTags returns FreeformTags
func (m SingleTargetPrecheckAction) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m SingleTargetPrecheckAction) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m SingleTargetPrecheckAction) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m SingleTargetPrecheckAction) String() string {
...
func (m SingleTargetPrecheckAction) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m SingleTargetPrecheckAction) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeSingleTargetPrecheckAction SingleTargetPrecheckAction
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeSingleTargetPrecheckAction
	}{
		"SINGLE_TARGET_PRECHECK",
		(MarshalTypeSingleTargetPrecheckAction)(m),
	}
...
func (m *SingleTargetPrecheckAction) UnmarshalJSON(data []byte) (e error) {
	model := struct {
