...
// VmClusterFsuHome Exadata Fleet Update Home using a VmCluster or CloudVmCluster resource as source.
type VmClusterFsuHome struct {
...
func (m VmClusterFsuHome) GetFsuImageId() *string {
	return m.FsuImageId
}

// GetCompartmentId returns CompartmentId
func (m VmClusterFsuHome) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetHomeName returns HomeName
func (m VmClusterFsuHome) GetHomeName() *string {
	return m.HomeName
}

// GetOracleBase returns OracleBase
func (m VmClusterFsuHome) GetOracleBase() *string {
	return m.OracleBase
}

// GetGroups returns Groups
func (m VmClusterFsuHome) GetGroups() []FsuHomeGroup {
	return m.Groups
}

// GetUser returns User
func (m VmClusterFsuHome) GetUser() *string {
	return m.User
}

// GetId returns Id
func (m VmClusterFsuHome) GetId() *string {
	return m.Id
}

// GetDisplayName returns DisplayName
func (m VmClusterFsuHome) GetDisplayName() *string {
	return m.DisplayName
}

// GetTimeCreated returns TimeCreated
func (m VmClusterFsuHome) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m VmClusterFsuHome) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetLifecycleState returns LifecycleState
func (m VmClusterFsuHome) GetLifecycleState() HomeLifecycleStatesEnum {
	return m.LifecycleState
}

// GetLifecycleDetails returns LifecycleDetails
func (m VmClusterFsuHome) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetFreeformTags returns FreeformTags
func (m VmClusterFsuHome) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m VmClusterFsuHome) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m VmClusterFsuHome) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m VmClusterFsuHome) String() string {
...
func (m VmClusterFsuHome) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m VmClusterFsuHome) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeVmClusterFsuHome VmClusterFsuHome
	s := struct {
		DiscriminatorParam string `json:"kind"`
		MarshalTypeVmClusterFsuHome
	}{
		"VMCLUSTER",
		(MarshalTypeVmClusterFsuHome)(m),
	}
