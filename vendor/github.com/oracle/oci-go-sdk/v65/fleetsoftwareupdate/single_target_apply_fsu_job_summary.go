...
// SingleTargetApplyFsuJobSummary Summary of Single Target Apply Exadata Fleet Update Job resource.
type SingleTargetApplyFsuJobSummary struct {
...
// GetId returns Id
func (m SingleTargetApplyFsuJobSummary) GetId() *string {
	return m.Id
}

// GetDisplayName returns DisplayName
func (m SingleTargetApplyFsuJobSummary) GetDisplayName() *string {
	return m.DisplayName
}

// GetCompartmentId returns CompartmentId
func (m SingleTargetApplyFsuJobSummary) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetFsuActionId returns FsuActionId
func (m SingleTargetApplyFsuJobSummary) GetFsuActionId() *string {
	return m.FsuActionId
}

// GetProgress returns Progress
func (m SingleTargetApplyFsuJobSummary) GetProgress() *JobProgress {
	return m.Progress
}

// GetTimeCreated returns TimeCreated
func (m SingleTargetApplyFsuJobSummary) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeStarted returns TimeStarted
func (m SingleTargetApplyFsuJobSummary) GetTimeStarted() *common.SDKTime {
	return m.TimeStarted
}

// GetTimeUpdated returns TimeUpdated
func (m SingleTargetApplyFsuJobSummary) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetTimeFinished returns TimeFinished
func (m SingleTargetApplyFsuJobSummary) GetTimeFinished() *common.SDKTime {
	return m.TimeFinished
}

// GetLifecycleState returns LifecycleState
func (m SingleTargetApplyFsuJobSummary) GetLifecycleState() JobLifecycleStatesEnum {
	return m.LifecycleState
}

// GetLifecycleDetails returns LifecycleDetails
func (m SingleTargetApplyFsuJobSummary) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetFreeformTags returns FreeformTags
func (m SingleTargetApplyFsuJobSummary) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m SingleTargetApplyFsuJobSummary) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m SingleTargetApplyFsuJobSummary) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m SingleTargetApplyFsuJobSummary) String() string {
...
func (m SingleTargetApplyFsuJobSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m SingleTargetApplyFsuJobSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeSingleTargetApplyFsuJobSummary SingleTargetApplyFsuJobSummary
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeSingleTargetApplyFsuJobSummary
	}{
		"SINGLE_TARGET_APPLY",
		(MarshalTypeSingleTargetApplyFsuJobSummary)(m),
	}
...
func (m *SingleTargetApplyFsuJobSummary) UnmarshalJSON(data []byte) (e error) {
	model := struct {
		Id               *string                           `json:"id"`
