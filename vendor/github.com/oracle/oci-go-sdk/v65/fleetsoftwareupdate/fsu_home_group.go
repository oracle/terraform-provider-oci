...
// FsuHomeGroup Oracle group and OS group representation
type FsuHomeGroup struct {
...
func (m FsuHomeGroup) String() string {
...
func (m FsuHomeGroup) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
