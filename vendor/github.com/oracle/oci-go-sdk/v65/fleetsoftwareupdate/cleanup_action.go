...
// CleanupAction Cleanup Exadata Fleet Update Action details.
...
func (m CleanupAction) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCleanupAction CleanupAction
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCleanupAction
	}{
		"CLEANUP",
		(MarshalTypeCleanupAction)(m),
	}
