...
// SingleTargetPrecheckFsuJobSummary Summary of Single Target Precheck Exadata Fleet Update Job resource.
type SingleTargetPrecheckFsuJobSummary struct {
...
// GetId returns Id
func (m SingleTargetPrecheckFsuJobSummary) GetId() *string {
	return m.Id
}

// GetDisplayName returns DisplayName
func (m SingleTargetPrecheckFsuJobSummary) GetDisplayName() *string {
	return m.DisplayName
}

// GetCompartmentId returns CompartmentId
func (m SingleTargetPrecheckFsuJobSummary) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetFsuActionId returns FsuActionId
func (m SingleTargetPrecheckFsuJobSummary) GetFsuActionId() *string {
	return m.FsuActionId
}

// GetProgress returns Progress
func (m SingleTargetPrecheckFsuJobSummary) GetProgress() *JobProgress {
	return m.Progress
}

// GetTimeCreated returns TimeCreated
func (m SingleTargetPrecheckFsuJobSummary) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeStarted returns TimeStarted
func (m SingleTargetPrecheckFsuJobSummary) GetTimeStarted() *common.SDKTime {
	return m.TimeStarted
}

// GetTimeUpdated returns TimeUpdated
func (m SingleTargetPrecheckFsuJobSummary) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetTimeFinished returns TimeFinished
func (m SingleTargetPrecheckFsuJobSummary) GetTimeFinished() *common.SDKTime {
	return m.TimeFinished
}

// GetLifecycleState returns LifecycleState
func (m SingleTargetPrecheckFsuJobSummary) GetLifecycleState() JobLifecycleStatesEnum {
	return m.LifecycleState
}

// GetLifecycleDetails returns LifecycleDetails
func (m SingleTargetPrecheckFsuJobSummary) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetFreeformTags returns FreeformTags
func (m SingleTargetPrecheckFsuJobSummary) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m SingleTargetPrecheckFsuJobSummary) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m SingleTargetPrecheckFsuJobSummary) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m SingleTargetPrecheckFsuJobSummary) String() string {
...
func (m SingleTargetPrecheckFsuJobSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m SingleTargetPrecheckFsuJobSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeSingleTargetPrecheckFsuJobSummary SingleTargetPrecheckFsuJobSummary
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeSingleTargetPrecheckFsuJobSummary
	}{
		"SINGLE_TARGET_PRECHECK",
		(MarshalTypeSingleTargetPrecheckFsuJobSummary)(m),
	}
...
func (m *SingleTargetPrecheckFsuJobSummary) UnmarshalJSON(data []byte) (e error) {
	model := struct {
		Id               *string                           `json:"id"`
