...
// FsuImageSummary Exadata Fleet Update Image resource summary.
type FsuImageSummary struct {
...
func (m FsuImageSummary) String() string {
...
func (m FsuImageSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
