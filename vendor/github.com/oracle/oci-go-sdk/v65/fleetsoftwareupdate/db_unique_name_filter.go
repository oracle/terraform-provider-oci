...
// DbUniqueNameFilter Database unique name to include in the discovery.
...
func (m DbUniqueNameFilter) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDbUniqueNameFilter DbUniqueNameFilter
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeDbUniqueNameFilter
	}{
		"DB_UNIQUE_NAME",
		(MarshalTypeDbUniqueNameFilter)(m),
	}
