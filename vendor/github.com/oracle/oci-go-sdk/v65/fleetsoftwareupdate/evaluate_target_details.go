...
// EvaluateTargetDetails Evaluate Move database details
type EvaluateTargetDetails struct {
...
func (m EvaluateTargetDetails) String() string {
...
func (m EvaluateTargetDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
