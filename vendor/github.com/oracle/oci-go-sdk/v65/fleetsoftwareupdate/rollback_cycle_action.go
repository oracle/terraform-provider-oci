...
// RollbackCycleAction Rollback Cycle Exadata Fleet Update Action details.
// This will rollback all the targets in the maintenance cycle with the Collection in place.
type RollbackCycleAction struct {
...
func (m RollbackCycleAction) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeRollbackCycleAction RollbackCycleAction
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeRollbackCycleAction
	}{
		"ROLLBACK_MAINTENANCE_CYCLE",
		(MarshalTypeRollbackCycleAction)(m),
	}
