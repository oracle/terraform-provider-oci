...
func (m CreateFiftyFiftyBatchingStrategyDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateFiftyFiftyBatchingStrategyDetails CreateFiftyFiftyBatchingStrategyDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCreateFiftyFiftyBatchingStrategyDetails
	}{
		"FIFTY_FIFTY",
		(MarshalTypeCreateFiftyFiftyBatchingStrategyDetails)(m),
	}
