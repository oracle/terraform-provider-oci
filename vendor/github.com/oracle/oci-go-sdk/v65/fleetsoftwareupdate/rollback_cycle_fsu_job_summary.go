...
type RollbackCycleFsuJobSummary struct {
...
func (m RollbackCycleFsuJobSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeRollbackCycleFsuJobSummary RollbackCycleFsuJobSummary
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeRollbackCycleFsuJobSummary
	}{
		"ROLLBACK_MAINTENANCE_CYCLE",
		(MarshalTypeRollbackCycleFsuJobSummary)(m),
	}
