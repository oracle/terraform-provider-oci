...
func (m CreateDbHomeFsuHomeDetails) GetFsuImageId() *string {
	return m.FsuImageId
}

// GetCompartmentId returns CompartmentId
func (m CreateDbHomeFsuHomeDetails) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetHomeName returns HomeName
func (m CreateDbHomeFsuHomeDetails) GetHomeName() *string {
	return m.HomeName
}

// GetOracleBase returns OracleBase
func (m CreateDbHomeFsuHomeDetails) GetOracleBase() *string {
	return m.OracleBase
}

// GetGroups returns Groups
func (m CreateDbHomeFsuHomeDetails) GetGroups() []CreateFsuHomeGroup {
	return m.Groups
}

// GetUser returns User
func (m CreateDbHomeFsuHomeDetails) GetUser() *string {
	return m.User
}

// GetDisplayName returns DisplayName
func (m CreateDbHomeFsuHomeDetails) GetDisplayName() *string {
	return m.DisplayName
}

// GetFreeformTags returns FreeformTags
func (m CreateDbHomeFsuHomeDetails) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m CreateDbHomeFsuHomeDetails) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

func (m CreateDbHomeFsuHomeDetails) String() string {
...
func (m CreateDbHomeFsuHomeDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateDbHomeFsuHomeDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDbHomeFsuHomeDetails CreateDbHomeFsuHomeDetails
	s := struct {
		DiscriminatorParam string `json:"kind"`
		MarshalTypeCreateDbHomeFsuHomeDetails
	}{
		"DBHOME",
		(MarshalTypeCreateDbHomeFsuHomeDetails)(m),
	}
