...
// SingleTargetApplyFsuJob Single Target Apply Exadata Fleet Update Job resource.
type SingleTargetApplyFsuJob struct {
...
// GetId returns Id
func (m SingleTargetApplyFsuJob) GetId() *string {
	return m.Id
}

// GetDisplayName returns DisplayName
func (m SingleTargetApplyFsuJob) GetDisplayName() *string {
	return m.DisplayName
}

// GetCompartmentId returns CompartmentId
func (m SingleTargetApplyFsuJob) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetFsuActionId returns FsuActionId
func (m SingleTargetApplyFsuJob) GetFsuActionId() *string {
	return m.FsuActionId
}

// GetProgress returns Progress
func (m SingleTargetApplyFsuJob) GetProgress() *JobProgressDetails {
	return m.Progress
}

// GetTimeCreated returns TimeCreated
func (m SingleTargetApplyFsuJob) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeStarted returns TimeStarted
func (m SingleTargetApplyFsuJob) GetTimeStarted() *common.SDKTime {
	return m.TimeStarted
}

// GetTimeUpdated returns TimeUpdated
func (m SingleTargetApplyFsuJob) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetTimeFinished returns TimeFinished
func (m SingleTargetApplyFsuJob) GetTimeFinished() *common.SDKTime {
	return m.TimeFinished
}

// GetLifecycleState returns LifecycleState
func (m SingleTargetApplyFsuJob) GetLifecycleState() JobLifecycleStatesEnum {
	return m.LifecycleState
}

// GetLifecycleDetails returns LifecycleDetails
func (m SingleTargetApplyFsuJob) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetFreeformTags returns FreeformTags
func (m SingleTargetApplyFsuJob) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m SingleTargetApplyFsuJob) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m SingleTargetApplyFsuJob) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m SingleTargetApplyFsuJob) String() string {
...
func (m SingleTargetApplyFsuJob) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m SingleTargetApplyFsuJob) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeSingleTargetApplyFsuJob SingleTargetApplyFsuJob
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeSingleTargetApplyFsuJob
	}{
		"SINGLE_TARGET_APPLY",
		(MarshalTypeSingleTargetApplyFsuJob)(m),
	}
...
func (m *SingleTargetApplyFsuJob) UnmarshalJSON(data []byte) (e error) {
	model := struct {
