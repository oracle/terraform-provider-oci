...
// CreateGuestOsFsuCollectionDetails Details to create a 'GUEST_OS' type Exadata Fleet Update Collection.
// Targets belonging to another 'GUEST_OS' type Exadata Fleet Update Collection will be rejected.
type CreateGuestOsFsuCollectionDetails struct {
...
func (m CreateGuestOsFsuCollectionDetails) GetDisplayName() *string {
	return m.DisplayName
}

// GetServiceType returns ServiceType
func (m CreateGuestOsFsuCollectionDetails) GetServiceType() CollectionServiceTypesEnum {
	return m.ServiceType
}

// GetCompartmentId returns CompartmentId
func (m CreateGuestOsFsuCollectionDetails) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetFreeformTags returns FreeformTags
func (m CreateGuestOsFsuCollectionDetails) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m CreateGuestOsFsuCollectionDetails) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

func (m CreateGuestOsFsuCollectionDetails) String() string {
...
func (m CreateGuestOsFsuCollectionDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateGuestOsFsuCollectionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateGuestOsFsuCollectionDetails CreateGuestOsFsuCollectionDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCreateGuestOsFsuCollectionDetails
	}{
		"GUEST_OS",
		(MarshalTypeCreateGuestOsFsuCollectionDetails)(m),
	}
...
func (m *CreateGuestOsFsuCollectionDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {
