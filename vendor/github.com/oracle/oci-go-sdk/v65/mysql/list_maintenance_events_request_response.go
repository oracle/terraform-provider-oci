...
type ListMaintenanceEventsRequest struct {
	...
	MysqlVersionPre *string `mandatory:"false" contributesTo:"query" name:"mysqlVersionPre"`

	// The MySQL version after the maintenance event.
	MysqlVersionPost *string `mandatory:"false" contributesTo:"query" name:"mysqlVersionPost"`
