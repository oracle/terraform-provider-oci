...
// DbClusterReadEndpoint A read-only endpoint for a shared-storage DB cluster.
// It points to the load balancer that distributes read traffic across DB nodes.
...
func (m DbClusterReadEndpoint) String() string {
...
func (m DbClusterReadEndpoint) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
