...
// DbClusterEndpoint A read and write endpoint for a shared-storage DB cluster.
...
func (m DbClusterEndpoint) String() string {
...
func (m DbClusterEndpoint) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
