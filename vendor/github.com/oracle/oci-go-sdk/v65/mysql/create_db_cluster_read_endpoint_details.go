...
// CreateDbClusterReadEndpointDetails Details used to configure the read-only endpoint for a shared-storage DB cluster.
// It points to the load balancer that distributes read traffic across DB nodes.
type CreateDbClusterReadEndpointDetails struct {
...
func (m CreateDbClusterReadEndpointDetails) String() string {
...
func (m CreateDbClusterReadEndpointDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
