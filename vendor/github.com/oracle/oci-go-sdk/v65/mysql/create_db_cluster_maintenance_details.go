...
// CreateDbClusterMaintenanceDetails Maintenance policy for the shared-storage DB cluster.
type CreateDbClusterMaintenanceDetails struct {
...
func (m CreateDbClusterMaintenanceDetails) String() string {
...
func (m CreateDbClusterMaintenanceDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
