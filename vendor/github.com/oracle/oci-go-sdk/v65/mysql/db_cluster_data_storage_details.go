...
// DbClusterDataStorageDetails Data storage properties for the shared-storage DB cluster.
type DbClusterDataStorageDetails struct {
...
func (m DbClusterDataStorageDetails) String() string {
...
func (m DbClusterDataStorageDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
