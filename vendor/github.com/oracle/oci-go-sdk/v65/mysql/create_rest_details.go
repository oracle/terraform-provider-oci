...
// CreateRestDetails Details required to configure REST while creating a DB System.
type CreateRestDetails struct {
...
func (m CreateRestDetails) String() string {
...
func (m CreateRestDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
