...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/mysql/CopyBackup.go.html to see an example of how to use CopyBackupRequest.
type CopyBackupRequest struct {

	// Details required to copy a given DB system backup to another region.
	CopyBackupDetails `contributesTo:"body"`
