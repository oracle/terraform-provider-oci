...
// UpdateDbClusterReadEndpointDetails Details used to update the read-only endpoint for a shared-storage DB cluster.
// It points to the load balancer that distributes read traffic across DB nodes.
type UpdateDbClusterReadEndpointDetails struct {
...
func (m UpdateDbClusterReadEndpointDetails) String() string {
...
func (m UpdateDbClusterReadEndpointDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
