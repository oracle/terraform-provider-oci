...
// DbClusterDataStorage Data storage settings for the shared-storage DB cluster.
type DbClusterDataStorage struct {
	...
	// The actual allocated storage size for the shared-storage DB cluster. This may be higher than reservedStorageSizeInGBs but
	// less than or equal to maxStorageSizeInGBs.
	AllocatedStorageSizeInGBs *int `mandatory:"false" json:"allocatedStorageSizeInGBs"`
}

func (m DbClusterDataStorage) String() string {
...
func (m DbClusterDataStorage) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
