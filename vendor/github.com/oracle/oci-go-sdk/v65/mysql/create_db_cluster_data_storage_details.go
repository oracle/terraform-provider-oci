...
// CreateDbClusterDataStorageDetails Details used to configure data storage for the shared-storage DB cluster.
type CreateDbClusterDataStorageDetails struct {
...
func (m CreateDbClusterDataStorageDetails) String() string {
...
func (m CreateDbClusterDataStorageDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
