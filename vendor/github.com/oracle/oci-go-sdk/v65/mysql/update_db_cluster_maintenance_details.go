...
// UpdateDbClusterMaintenanceDetails Maintenance policy for the shared-storage DB cluster.
type UpdateDbClusterMaintenanceDetails struct {
...
func (m UpdateDbClusterMaintenanceDetails) String() string {
...
func (m UpdateDbClusterMaintenanceDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
