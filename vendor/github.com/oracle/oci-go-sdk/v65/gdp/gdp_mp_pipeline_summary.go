...
// GdpMpPipelineSummary Retrieves summary pipeline configuration information by identifier.
type GdpMpPipelineSummary struct {
	...
	// A list of public region names and states where the peered pipelines exist.
	PeeringRegions []GdpMpPeeringRegion `mandatory:"true" json:"peeringRegions"`
...
func (m GdpMpPipelineSummary) String() string {
...
func (m GdpMpPipelineSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
