...
// UpdateGdpMpPipelineDetails The pipeline information to be updated.
type UpdateGdpMpPipelineDetails struct {
	...
	// A list of public region names where the peered pipelines exist.
	PeeringRegions []string `mandatory:"false" json:"peeringRegions"`
...
func (m UpdateGdpMpPipelineDetails) String() string {
...
func (m UpdateGdpMpPipelineDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
