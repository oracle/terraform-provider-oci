...
// CreateGdpMpPipelineDetails The information about the new pipeline.
type CreateGdpMpPipelineDetails struct {
...
func (m CreateGdpMpPipelineDetails) String() string {
...
func (m CreateGdpMpPipelineDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
