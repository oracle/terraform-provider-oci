...
// ChangeGdpMpPipelineCompartmentDetails The compartment of the pipeline to be updated.
type ChangeGdpMpPipelineCompartmentDetails struct {
...
func (m ChangeGdpMpPipelineCompartmentDetails) String() string {
...
func (m ChangeGdpMpPipelineCompartmentDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
