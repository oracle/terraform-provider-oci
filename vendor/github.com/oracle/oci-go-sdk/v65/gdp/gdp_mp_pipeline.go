...
// GdpMpPipeline Retrieves pipeline configuration information by identifier.
type GdpMpPipeline struct {
...
func (m GdpMpPipeline) String() string {
...
func (m GdpMpPipeline) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
