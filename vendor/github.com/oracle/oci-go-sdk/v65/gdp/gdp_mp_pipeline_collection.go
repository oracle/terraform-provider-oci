...
// GdpMpPipelineCollection Results of a pipeline search. Contains both summary items and other information, such as metadata.
type GdpMpPipelineCollection struct {

	// List of pipelines within a compartment.
	Items []GdpMpPipelineSummary `mandatory:"true" json:"items"`
}

func (m GdpMpPipelineCollection) String() string {
...
func (m GdpMpPipelineCollection) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
