...
// PeerGdpMpPipelineDetails Details about the peering pipeline.
type PeerGdpMpPipelineDetails struct {

	// OCID of the peering pipeline.
	PeeringGdpMpPipelineId *string `mandatory:"true" json:"peeringGdpMpPipelineId"`
...
func (m PeerGdpMpPipelineDetails) String() string {
...
func (m PeerGdpMpPipelineDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
