...
func (request ChangeOperatorControlAssignmentCompartmentRequest) RetryPolicy() common.OCIRetry {
...
func (request ChangeOperatorControlAssignmentCompartmentRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
