...
const (
	ListTargetAlertPolicyUnassociatedMembersSortByTimecreated ListTargetAlertPolicyUnassociatedMembersSortByEnum = "TIMECREATED"
	ListTargetAlertPolicyUnassociatedMembersSortByDisplayname ListTargetAlertPolicyUnassociatedMembersSortByEnum = "DISPLAYNAME"
)
...
var mappingListTargetAlertPolicyUnassociatedMembersSortByEnum = map[string]ListTargetAlertPolicyUnassociatedMembersSortByEnum{
	"TIMECREATED": ListTargetAlertPolicyUnassociatedMembersSortByTimecreated,
	"DISPLAYNAME": ListTargetAlertPolicyUnassociatedMembersSortByDisplayname,
}
