...
// CreateTargetDatabaseGroupAuditProfileDetails The details used to create a new target group audit profile.
type CreateTargetDatabaseGroupAuditProfileDetails struct {

	// The OCID of the compartment where you want to create the target group audit profile.
	...
	// The display name of the target audit profile. The name does not have to be unique, and it's updatable.
	DisplayName *string `mandatory:"false" json:"displayName"`

	// The description of the target group audit profile.
...
func (m CreateTargetDatabaseGroupAuditProfileDetails) String() string {
...
func (m CreateTargetDatabaseGroupAuditProfileDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
