...
// CreateRegistrationPolicyRequest wrapper for the CreateRegistrationPolicy operation
...
func (request CreateRegistrationPolicyRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request CreateRegistrationPolicyRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request CreateRegistrationPolicyRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request CreateRegistrationPolicyRequest) RetryPolicy() *common.RetryPolicy {
...
func (request CreateRegistrationPolicyRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
...
// CreateRegistrationPolicyResponse wrapper for the CreateRegistrationPolicy operation
...
func (response CreateRegistrationPolicyResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response CreateRegistrationPolicyResponse) HTTPResponse() *http.Response {
