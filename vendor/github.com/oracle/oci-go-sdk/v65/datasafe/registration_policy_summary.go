...
// RegistrationPolicySummary A summary of a registration policy.
...
type RegistrationPolicySummary struct {
	...
	// The current lifecycle state of the registration policy.
	...
	ConnectionOption *PolicyConnectionOption `mandatory:"true" json:"connectionOption"`
...
func (m RegistrationPolicySummary) String() string {
