...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/datasafe/GetReferentialRelation.go.html to see an example of how to use GetReferentialRelationRequest.
type GetReferentialRelationRequest struct {
	...
	ReferentialRelationKey *string `mandatory:"true" contributesTo:"path" name:"referentialRelationKey"`
...
type GetReferentialRelationResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The ReferentialRelation instance
	ReferentialRelation `presentIn:"body"`
