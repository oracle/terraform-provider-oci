...
// UpdateDataSafeTargetDetails The details used to update a target database.
type UpdateDataSafeTargetDetails struct {
	...
	ResourceGroupName *string `mandatory:"false" json:"resourceGroupName"`
	...
	TargetUserId *string `mandatory:"false" json:"targetUserId"`

	// The password of the target database user.
	TargetPassword *string `mandatory:"false" json:"targetPassword"`
	...
	TargetServiceName *string `mandatory:"false" json:"targetServiceName"`

	// used for ssl_server_cert_dn
	TargetDn *string `mandatory:"false" json:"targetDn"`
...
func (m UpdateDataSafeTargetDetails) String() string {
...
func (m UpdateDataSafeTargetDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
