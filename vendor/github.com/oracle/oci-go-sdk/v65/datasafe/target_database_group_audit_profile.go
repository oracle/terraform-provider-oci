...
// TargetDatabaseGroupAuditProfile The resource represents audit profile settings and audit configurations for the database target group.
type TargetDatabaseGroupAuditProfile struct {
	...
	// The OCID of the Data Safe target group for which the audit profile is created.
...
func (m TargetDatabaseGroupAuditProfile) String() string {
...
func (m TargetDatabaseGroupAuditProfile) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
