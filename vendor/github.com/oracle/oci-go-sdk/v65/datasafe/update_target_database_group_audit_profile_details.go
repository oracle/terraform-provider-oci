...
// UpdateTargetDatabaseGroupAuditProfileDetails The details used to update a target group audit profile.
type UpdateTargetDatabaseGroupAuditProfileDetails struct {

	// The description of the target group audit profile.
	Description *string `mandatory:"false" json:"description"`

	// The display name of the target group audit profile. The name does not have to be unique, and it's updatable.
...
func (m UpdateTargetDatabaseGroupAuditProfileDetails) String() string {
...
func (m UpdateTargetDatabaseGroupAuditProfileDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
