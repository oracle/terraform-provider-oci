...
var mappingMigrationPlanLifecycleStateEnum = map[string]MigrationPlanLifecycleStateEnum{
	"CREATING":        MigrationPlanLifecycleStateCreating,
	"UPDATING":        MigrationPlanLifecycleStateUpdating,
	"NEEDS_ATTENTION": MigrationPlanLifecycleStateNeedsAttention,
	"ACTIVE":          MigrationPlanLifecycleStateActive,
	"DELETING":        MigrationPlanLifecycleStateDeleting,
	"DELETED":         MigrationPlanLifecycleStateDeleted,
	"FAILED":          MigrationPlanLifecycleStateFailed,
}

var mappingMigrationPlanLifecycleStateEnumLowerCase = map[string]MigrationPlanLifecycleStateEnum{
	"creating":        MigrationPlanLifecycleStateCreating,
	"updating":        MigrationPlanLifecycleStateUpdating,
	"needs_attention": MigrationPlanLifecycleStateNeedsAttention,
	"active":          MigrationPlanLifecycleStateActive,
...
func GetMigrationPlanLifecycleStateEnumValues() []MigrationPlanLifecycleStateEnum {
	values := make([]MigrationPlanLifecycleStateEnum, 0)
	for _, v := range mappingMigrationPlanLifecycleStateEnum {
...
func GetMappingMigrationPlanLifecycleStateEnum(val string) (MigrationPlanLifecycleStateEnum, bool) {
	enum, ok := mappingMigrationPlanLifecycleStateEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
