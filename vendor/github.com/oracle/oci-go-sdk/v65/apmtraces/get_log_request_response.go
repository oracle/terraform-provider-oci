...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/apmtraces/GetLog.go.html to see an example of how to use GetLogRequest.
type GetLogRequest struct {
	...
	// Log key.
	LogKey *string `mandatory:"true" contributesTo:"path" name:"logKey"`

	// Include logs with log time equal to or greater than this value.
	TimeLogStartedGreaterThanOrEqualTo *common.SDKTime `mandatory:"true" contributesTo:"query" name:"timeLogStartedGreaterThanOrEqualTo"`

	// Include logs with log time less than this value.
	TimeLogEndedLessThan *common.SDKTime `mandatory:"true" contributesTo:"query" name:"timeLogEndedLessThan"`
