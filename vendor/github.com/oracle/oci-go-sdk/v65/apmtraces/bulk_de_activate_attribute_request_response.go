...
type BulkDeActivateAttributeRequest struct {
	...
	// Request body containing the details about the set of attributes to be de-activated.
...
func (request BulkDeActivateAttributeRequest) RetryPolicy() common.OCIRetry {
