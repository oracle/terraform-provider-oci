...
// OracleDataVerificationTableRowCountSummary Table row count comparison result line for Oracle migrations.
type OracleDataVerificationTableRowCountSummary struct {
...
func (m OracleDataVerificationTableRowCountSummary) GetOwner() *string {
	return m.Owner
}

// GetTableName returns TableName
func (m OracleDataVerificationTableRowCountSummary) GetTableName() *string {
	return m.TableName
}

// GetSourceRowCount returns SourceRowCount
func (m OracleDataVerificationTableRowCountSummary) GetSourceRowCount() *int {
	return m.SourceRowCount
}

// GetTargetRowCount returns TargetRowCount
func (m OracleDataVerificationTableRowCountSummary) GetTargetRowCount() *int {
	return m.TargetRowCount
}

// GetVariancePercent returns VariancePercent
func (m OracleDataVerificationTableRowCountSummary) GetVariancePercent() *float64 {
	return m.VariancePercent
}

func (m OracleDataVerificationTableRowCountSummary) String() string {
...
func (m OracleDataVerificationTableRowCountSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m OracleDataVerificationTableRowCountSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOracleDataVerificationTableRowCountSummary OracleDataVerificationTableRowCountSummary
	s := struct {
		DiscriminatorParam string `json:"databaseCombination"`
		MarshalTypeOracleDataVerificationTableRowCountSummary
	}{
		"ORACLE",
		(MarshalTypeOracleDataVerificationTableRowCountSummary)(m),
	}
