...
func (m NfsDataTransferMediumDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeNfsDataTransferMediumDetails NfsDataTransferMediumDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeNfsDataTransferMediumDetails
	}{
		"NFS",
		(MarshalTypeNfsDataTransferMediumDetails)(m),
	}
