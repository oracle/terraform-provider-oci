...
func (m CreateAdbServerlesTablespaceDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateAdbServerlesTablespaceDetails CreateAdbServerlesTablespaceDetails
	s := struct {
		DiscriminatorParam string `json:"targetType"`
		MarshalTypeCreateAdbServerlesTablespaceDetails
	}{
		"ADB_S_REMAP",
		(MarshalTypeCreateAdbServerlesTablespaceDetails)(m),
	}
