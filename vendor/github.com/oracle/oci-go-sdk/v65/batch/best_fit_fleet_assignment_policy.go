...
func (m BestFitFleetAssignmentPolicy) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeBestFitFleetAssignmentPolicy BestFitFleetAssignmentPolicy
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeBestFitFleetAssignmentPolicy
	}{
		"BEST_FIT",
		(MarshalTypeBestFitFleetAssignmentPolicy)(m),
	}
