...
const (
	BatchTaskHierarchyViewShallow BatchTaskHierarchyViewEnum = "SHALLOW"
	BatchTaskHierarchyViewDeep    BatchTaskHierarchyViewEnum = "DEEP"
)

var mappingBatchTaskHierarchyViewEnum = map[string]BatchTaskHierarchyViewEnum{
	"SHALLOW": BatchTaskHierarchyViewShallow,
	"DEEP":    BatchTaskHierarchyViewDeep,
}

var mappingBatchTaskHierarchyViewEnumLowerCase = map[string]BatchTaskHierarchyViewEnum{
	"shallow": BatchTaskHierarchyViewShallow,
	"deep":    BatchTaskHierarchyViewDeep,
}
...
func GetBatchTaskHierarchyViewEnumValues() []BatchTaskHierarchyViewEnum {
	values := make([]BatchTaskHierarchyViewEnum, 0)
	for _, v := range mappingBatchTaskHierarchyViewEnum {
...
func GetMappingBatchTaskHierarchyViewEnum(val string) (BatchTaskHierarchyViewEnum, bool) {
	enum, ok := mappingBatchTaskHierarchyViewEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
