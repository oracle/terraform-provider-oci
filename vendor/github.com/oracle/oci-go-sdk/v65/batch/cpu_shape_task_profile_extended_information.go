...
func (m CpuShapeTaskProfileExtendedInformation) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCpuShapeTaskProfileExtendedInformation CpuShapeTaskProfileExtendedInformation
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCpuShapeTaskProfileExtendedInformation
	}{
		"CPU_SHAPE_TASK_PROFILE_EXTENDED_INFORMATION",
		(MarshalTypeCpuShapeTaskProfileExtendedInformation)(m),
	}
