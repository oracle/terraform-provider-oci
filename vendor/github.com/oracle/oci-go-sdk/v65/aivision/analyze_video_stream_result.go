...
type AnalyzeVideoStreamResult struct {
	...
	VideoStreamTrackedObjects []VideoStreamTrackedObject `mandatory:"false" json:"videoStreamTrackedObjects"`
	...
	// Face Embedding model version.
	FaceEmbeddingModelVersion *string `mandatory:"false" json:"faceEmbeddingModelVersion"`
