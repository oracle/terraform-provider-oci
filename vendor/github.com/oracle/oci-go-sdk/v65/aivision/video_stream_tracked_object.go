...
// VideoStreamTrackedObject Tracked object in a video stream.
type VideoStreamTrackedObject struct {
...
func (m VideoStreamTrackedObject) String() string {
...
func (m VideoStreamTrackedObject) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
