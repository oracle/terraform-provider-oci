...
func (m PrivateStreamNetworkAccessDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePrivateStreamNetworkAccessDetails PrivateStreamNetworkAccessDetails
	s := struct {
		DiscriminatorParam string `json:"streamAccessType"`
		MarshalTypePrivateStreamNetworkAccessDetails
	}{
		"PRIVATE",
		(MarshalTypePrivateStreamNetworkAccessDetails)(m),
	}
