...
// PatchTaskStepProperties patch task step properties
type PatchTaskStepProperties struct {
	...
	// Actual time of retry completion
	TimeCompleted *common.SDKTime `mandatory:"false" json:"timeCompleted"`
}

func (m PatchTaskStepProperties) String() string {
...
func (m PatchTaskStepProperties) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
