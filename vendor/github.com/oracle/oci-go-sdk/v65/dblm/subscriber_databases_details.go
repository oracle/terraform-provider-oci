...
// SubscriberDatabasesDetails SubscriberDatabasesDetails.
type SubscriberDatabasesDetails struct {
	...
	PatchUser *string `mandatory:"true" json:"patchUser"`

	// Path to sudo binary (executable) file
	SudoFilePath *string `mandatory:"true" json:"sudoFilePath"`
}

func (m SubscriberDatabasesDetails) String() string {
...
func (m SubscriberDatabasesDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
