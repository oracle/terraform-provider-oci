...
type ImageVersionsDetails struct {
	...
	// Software image version status (CURRENT, ACTIVE, DRAFT, RESTRICTED, OBSOLETE, DELETED).
	...
	ReferenceVersionKey *int64 `mandatory:"false" json:"referenceVersionKey"`
