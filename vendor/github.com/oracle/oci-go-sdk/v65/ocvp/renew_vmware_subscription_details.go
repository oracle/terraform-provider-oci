...
// RenewVmwareSubscriptionDetails Renewal of a a subscription in a VMware billing link.
type RenewVmwareSubscriptionDetails struct {

	// The commitment term selected for subscription.
	CommitmentTerm CommitmentEnum `mandatory:"true" json:"commitmentTerm"`

	// The OCID (https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm) of the ESXi host that will have their subscription
	// renwed by this subscription.
	EsxiHostId []string `mandatory:"true" json:"esxiHostId"`
}

func (m RenewVmwareSubscriptionDetails) String() string {
...
func (m RenewVmwareSubscriptionDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
