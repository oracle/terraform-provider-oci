...
// UpdateVmwareBillingLinkDetails The VMware billing link information to be updated.
type UpdateVmwareBillingLinkDetails struct {

	// Updated state of the VMware account.
...
func (m UpdateVmwareBillingLinkDetails) String() string {
...
func (m UpdateVmwareBillingLinkDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
