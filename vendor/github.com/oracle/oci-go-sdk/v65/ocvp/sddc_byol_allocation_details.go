...
// SddcByolAllocationDetails The BYOL allocations used for VMware SDDC provisioning.
type SddcByolAllocationDetails struct {
	...
	LoadBalancerByolAllocationId *string `mandatory:"false" json:"loadBalancerByolAllocationId"`
...
func (m SddcByolAllocationDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
