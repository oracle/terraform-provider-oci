...
// VmwareBillingLinkSummary A VMwareBillingLink represents the billing relationship between a VMware customer and OCI tenancy
type VmwareBillingLinkSummary struct {
	...
	// The current state of the VMware accounrt.
...
func (m VmwareBillingLinkSummary) String() string {
...
func (m VmwareBillingLinkSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
