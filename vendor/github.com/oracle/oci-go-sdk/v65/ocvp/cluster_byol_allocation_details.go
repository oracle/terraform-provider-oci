...
// ClusterByolAllocationDetails The BYOL allocations used for VMware Cluster provisioning.
type ClusterByolAllocationDetails struct {
	...
	VsanByolAllocationId *string `mandatory:"false" json:"vsanByolAllocationId"`
...
func (m ClusterByolAllocationDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
