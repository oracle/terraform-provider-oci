...
// VmwareBinaryDownloadInfo The VMware binary download.
type VmwareBinaryDownloadInfo struct {
...
func (m VmwareBinaryDownloadInfo) String() string {
...
func (m VmwareBinaryDownloadInfo) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
