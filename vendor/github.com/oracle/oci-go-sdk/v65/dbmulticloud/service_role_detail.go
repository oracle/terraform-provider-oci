...
// ServiceRoleDetail Service Role details object.
type ServiceRoleDetail struct {
	...
	// Type of service.
	ServiceType ServiceRoleDetailServiceTypeEnum `mandatory:"true" json:"serviceType"`
}

func (m ServiceRoleDetail) String() string {
...
func (m ServiceRoleDetail) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingServiceRoleDetailServiceTypeEnum(string(m.ServiceType)); !ok && m.ServiceType != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for ServiceType: %s. Supported values are: %s.", m.ServiceType, strings.Join(GetServiceRoleDetailServiceTypeEnumStringValues(), ",")))
	}
...
// ServiceRoleDetailServiceTypeEnum Enum with underlying type: string
type ServiceRoleDetailServiceTypeEnum string

// Set of constants representing the allowable values for ServiceRoleDetailServiceTypeEnum
const (
	ServiceRoleDetailServiceTypeKms ServiceRoleDetailServiceTypeEnum = "KMS"
)

var mappingServiceRoleDetailServiceTypeEnum = map[string]ServiceRoleDetailServiceTypeEnum{
	"KMS": ServiceRoleDetailServiceTypeKms,
}

var mappingServiceRoleDetailServiceTypeEnumLowerCase = map[string]ServiceRoleDetailServiceTypeEnum{
	"kms": ServiceRoleDetailServiceTypeKms,
}

// GetServiceRoleDetailServiceTypeEnumValues Enumerates the set of values for ServiceRoleDetailServiceTypeEnum
func GetServiceRoleDetailServiceTypeEnumValues() []ServiceRoleDetailServiceTypeEnum {
	values := make([]ServiceRoleDetailServiceTypeEnum, 0)
	for _, v := range mappingServiceRoleDetailServiceTypeEnum {
		values = append(values, v)
	}
	return values
}

// GetServiceRoleDetailServiceTypeEnumStringValues Enumerates the set of values in String for ServiceRoleDetailServiceTypeEnum
func GetServiceRoleDetailServiceTypeEnumStringValues() []string {
	return []string{
		"KMS",
	}
}

// GetMappingServiceRoleDetailServiceTypeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingServiceRoleDetailServiceTypeEnum(val string) (ServiceRoleDetailServiceTypeEnum, bool) {
	enum, ok := mappingServiceRoleDetailServiceTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
