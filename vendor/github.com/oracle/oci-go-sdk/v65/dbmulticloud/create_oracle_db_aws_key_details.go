...
// CreateOracleDbAwsKeyDetails Create Oracle DB AWS Key object.
type CreateOracleDbAwsKeyDetails struct {
...
func (m CreateOracleDbAwsKeyDetails) String() string {
...
func (m CreateOracleDbAwsKeyDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
