...
type CreateOracleDbGcpKeyRingDetails struct {
	...
	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains Oracle DB GCP Key-Ring Resource.
	...
	// Display name of Oracle DB GCP Key-Ring.
	DisplayName *string `mandatory:"true" json:"displayName"`

	// GCP Key-Ring Id.
	GcpKeyRingId *string `mandatory:"false" json:"gcpKeyRingId"`

	// GCP Key-Ring Resource Type.
