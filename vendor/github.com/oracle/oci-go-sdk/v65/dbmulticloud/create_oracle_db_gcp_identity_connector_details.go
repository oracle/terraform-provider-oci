...
// CreateOracleDbGcpIdentityConnectorDetails This object is about to provide input params to create Oracle DB GCP Identity Connector Resource.
type CreateOracleDbGcpIdentityConnectorDetails struct {

	// Oracle DB Google GCP Identity Connector resource name.
	DisplayName *string `mandatory:"true" json:"displayName"`

	// The ID of the compartment that contains Oracle DB GCP Identity Connector resource.
