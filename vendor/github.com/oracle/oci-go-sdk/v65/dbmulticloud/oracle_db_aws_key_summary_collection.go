...
// OracleDbAwsKeySummaryCollection List of OracleDbAwsKeySummary resources.
type OracleDbAwsKeySummaryCollection struct {

	// This list contains the summary of Oracle DB AWS Key resources.
	Items []OracleDbAwsKeySummary `mandatory:"true" json:"items"`
}

func (m OracleDbAwsKeySummaryCollection) String() string {
...
func (m OracleDbAwsKeySummaryCollection) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
