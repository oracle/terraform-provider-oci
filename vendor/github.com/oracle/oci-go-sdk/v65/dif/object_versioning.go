...
var mappingObjectVersioningEnum = map[string]ObjectVersioningEnum{
	"ENABLED":   ObjectVersioningEnabled,
	"SUSPENDED": ObjectVersioningSuspended,
	"DISABLED":  ObjectVersioningDisabled,
}

var mappingObjectVersioningEnumLowerCase = map[string]ObjectVersioningEnum{
	"enabled":   ObjectVersioningEnabled,
	"suspended": ObjectVersioningSuspended,
	"disabled":  ObjectVersioningDisabled,
}
...
func GetObjectVersioningEnumValues() []ObjectVersioningEnum {
	values := make([]ObjectVersioningEnum, 0)
	for _, v := range mappingObjectVersioningEnum {
...
func GetMappingObjectVersioningEnum(val string) (ObjectVersioningEnum, bool) {
	enum, ok := mappingObjectVersioningEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
