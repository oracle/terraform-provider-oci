...
// OkeDetail Details to reference an existing Oracle Kubernetes Engine cluster.
type OkeDetail struct {
...
func (m OkeDetail) String() string {
...
func (m OkeDetail) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
