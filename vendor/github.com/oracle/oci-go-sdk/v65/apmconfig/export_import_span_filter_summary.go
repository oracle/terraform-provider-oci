...
func (m ExportImportSpanFilterSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeExportImportSpanFilterSummary ExportImportSpanFilterSummary
	s := struct {
		DiscriminatorParam string `json:"configType"`
		MarshalTypeExportImportSpanFilterSummary
	}{
		"SPAN_FILTER",
		(MarshalTypeExportImportSpanFilterSummary)(m),
	}
