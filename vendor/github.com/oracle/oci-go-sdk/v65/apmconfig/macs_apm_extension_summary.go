...
// MacsApmExtensionSummary An object that represents APM Agent provisioning via a Management Agent.
type MacsApmExtensionSummary struct {
...
// GetId returns Id
func (m MacsApmExtensionSummary) GetId() *string {
	return m.Id
}

// GetTimeCreated returns TimeCreated
func (m MacsApmExtensionSummary) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m MacsApmExtensionSummary) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetCreatedBy returns CreatedBy
func (m MacsApmExtensionSummary) GetCreatedBy() *string {
	return m.CreatedBy
}

// GetUpdatedBy returns UpdatedBy
func (m MacsApmExtensionSummary) GetUpdatedBy() *string {
	return m.UpdatedBy
}

// GetEtag returns Etag
func (m MacsApmExtensionSummary) GetEtag() *string {
	return m.Etag
}

// GetFreeformTags returns FreeformTags
func (m MacsApmExtensionSummary) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetDefinedTags returns DefinedTags
func (m MacsApmExtensionSummary) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetSystemTags returns SystemTags
func (m MacsApmExtensionSummary) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

func (m MacsApmExtensionSummary) String() string {
...
func (m MacsApmExtensionSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m MacsApmExtensionSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeMacsApmExtensionSummary MacsApmExtensionSummary
	s := struct {
		DiscriminatorParam string `json:"configType"`
		MarshalTypeMacsApmExtensionSummary
	}{
		"MACS_APM_EXTENSION",
		(MarshalTypeMacsApmExtensionSummary)(m),
	}
