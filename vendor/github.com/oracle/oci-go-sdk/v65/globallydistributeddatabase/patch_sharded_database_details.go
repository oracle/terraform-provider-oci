...
// PatchShardedDatabaseDetails Provide PatchInstuction(s) in items array. All instructions in items have to be of same type.
...
// single operation.
type PatchShardedDatabaseDetails struct {
