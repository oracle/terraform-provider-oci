...
// UploadSignedCertificateAndGenerateWalletDetails Details of the request to upload the CA signed certificates to GSMs and generate wallets for
// GSMs of the sharded database.
type UploadSignedCertificateAndGenerateWalletDetails struct {
