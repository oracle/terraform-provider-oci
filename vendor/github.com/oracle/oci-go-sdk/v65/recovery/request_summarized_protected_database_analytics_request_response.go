...
// RequestSummarizedProtectedDatabaseAnalyticsRequest wrapper for the RequestSummarizedProtectedDatabaseAnalytics operation
type RequestSummarizedProtectedDatabaseAnalyticsRequest struct {

	// Request body with equality filters to scope analytics prior to aggregation.
	RequestSummarizedProtectedDatabaseAnalyticsDetails `contributesTo:"body"`
...
func (request RequestSummarizedProtectedDatabaseAnalyticsRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request RequestSummarizedProtectedDatabaseAnalyticsRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request RequestSummarizedProtectedDatabaseAnalyticsRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request RequestSummarizedProtectedDatabaseAnalyticsRequest) RetryPolicy() *common.RetryPolicy {
...
func (request RequestSummarizedProtectedDatabaseAnalyticsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
// RequestSummarizedProtectedDatabaseAnalyticsResponse wrapper for the RequestSummarizedProtectedDatabaseAnalytics operation
type RequestSummarizedProtectedDatabaseAnalyticsResponse struct {
...
func (response RequestSummarizedProtectedDatabaseAnalyticsResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response RequestSummarizedProtectedDatabaseAnalyticsResponse) HTTPResponse() *http.Response {
