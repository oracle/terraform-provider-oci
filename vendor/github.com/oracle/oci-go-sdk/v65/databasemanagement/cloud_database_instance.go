...
// CloudDatabaseInstance The details of a cloud database instance.
...
func (m CloudDatabaseInstance) String() string {
...
func (m CloudDatabaseInstance) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
