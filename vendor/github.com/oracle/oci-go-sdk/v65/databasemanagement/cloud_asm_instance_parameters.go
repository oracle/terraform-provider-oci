...
// CloudAsmInstanceParameters The initialization parameters for an ASM instance.
type CloudAsmInstanceParameters struct {
...
func (m CloudAsmInstanceParameters) String() string {
...
func (m CloudAsmInstanceParameters) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
