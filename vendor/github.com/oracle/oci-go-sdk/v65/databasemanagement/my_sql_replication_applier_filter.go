...
type MySqlReplicationApplierFilter struct {
	...
	FilterRule *string `mandatory:"false" json:"filterRule"`
}

func (m MySqlReplicationApplierFilter) String() string {
...
func (m MySqlReplicationApplierFilter) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
