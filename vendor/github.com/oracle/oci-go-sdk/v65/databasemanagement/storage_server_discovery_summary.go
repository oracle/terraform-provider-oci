...
// StorageServerDiscoverySummary The summary of the Exadata storage server discovery.
type StorageServerDiscoverySummary struct {
...
// GetId returns Id
func (m StorageServerDiscoverySummary) GetId() *string {
	return m.Id
}

// GetAgentId returns AgentId
func (m StorageServerDiscoverySummary) GetAgentId() *string {
	return m.AgentId
}

// GetConnectorId returns ConnectorId
func (m StorageServerDiscoverySummary) GetConnectorId() *string {
	return m.ConnectorId
}

// GetDisplayName returns DisplayName
func (m StorageServerDiscoverySummary) GetDisplayName() *string {
	return m.DisplayName
}

// GetVersion returns Version
func (m StorageServerDiscoverySummary) GetVersion() *string {
	return m.Version
}

// GetInternalId returns InternalId
func (m StorageServerDiscoverySummary) GetInternalId() *string {
	return m.InternalId
}

// GetStatus returns Status
func (m StorageServerDiscoverySummary) GetStatus() *string {
	return m.Status
}

// GetDiscoverStatus returns DiscoverStatus
func (m StorageServerDiscoverySummary) GetDiscoverStatus() EntityDiscoveredDiscoverStatusEnum {
	return m.DiscoverStatus
}

// GetDiscoverErrorCode returns DiscoverErrorCode
func (m StorageServerDiscoverySummary) GetDiscoverErrorCode() *string {
	return m.DiscoverErrorCode
}

// GetDiscoverErrorMsg returns DiscoverErrorMsg
func (m StorageServerDiscoverySummary) GetDiscoverErrorMsg() *string {
	return m.DiscoverErrorMsg
}

func (m StorageServerDiscoverySummary) String() string {
...
func (m StorageServerDiscoverySummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m StorageServerDiscoverySummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeStorageServerDiscoverySummary StorageServerDiscoverySummary
	s := struct {
		DiscriminatorParam string `json:"entityType"`
		MarshalTypeStorageServerDiscoverySummary
	}{
		"MANAGED_STORAGE_SERVER_DISCOVER_SUMMARY",
		(MarshalTypeStorageServerDiscoverySummary)(m),
	}
