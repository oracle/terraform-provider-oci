...
// InternalRequestQueue An internal representation of Request Queue Entry.
type InternalRequestQueue struct {
...
func (m InternalRequestQueue) String() string {
...
func (m InternalRequestQueue) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
