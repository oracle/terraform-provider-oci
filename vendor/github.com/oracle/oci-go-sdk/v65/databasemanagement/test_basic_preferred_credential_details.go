...
// TestBasicPreferredCredentialDetails The details of the basic preferred credentials.
...
func (m TestBasicPreferredCredentialDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeTestBasicPreferredCredentialDetails TestBasicPreferredCredentialDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeTestBasicPreferredCredentialDetails
	}{
		"BASIC",
		(MarshalTypeTestBasicPreferredCredentialDetails)(m),
	}
