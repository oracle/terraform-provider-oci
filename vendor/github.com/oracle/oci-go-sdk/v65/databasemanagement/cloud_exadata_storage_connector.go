...
// CloudExadataStorageConnector The details of the Exadata storage server connector.
...
// GetId returns Id
func (m CloudExadataStorageConnector) GetId() *string {
	return m.Id
}

// GetDisplayName returns DisplayName
func (m CloudExadataStorageConnector) GetDisplayName() *string {
	return m.DisplayName
}

// GetVersion returns Version
func (m CloudExadataStorageConnector) GetVersion() *string {
	return m.Version
}

// GetInternalId returns InternalId
func (m CloudExadataStorageConnector) GetInternalId() *string {
	return m.InternalId
}

// GetStatus returns Status
func (m CloudExadataStorageConnector) GetStatus() *string {
	return m.Status
}

// GetLifecycleState returns LifecycleState
func (m CloudExadataStorageConnector) GetLifecycleState() DbmResourceLifecycleStateEnum {
	return m.LifecycleState
}

// GetTimeCreated returns TimeCreated
func (m CloudExadataStorageConnector) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m CloudExadataStorageConnector) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetLifecycleDetails returns LifecycleDetails
func (m CloudExadataStorageConnector) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetAdditionalDetails returns AdditionalDetails
func (m CloudExadataStorageConnector) GetAdditionalDetails() map[string]string {
	return m.AdditionalDetails
}

func (m CloudExadataStorageConnector) String() string {
...
func (m CloudExadataStorageConnector) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CloudExadataStorageConnector) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCloudExadataStorageConnector CloudExadataStorageConnector
	s := struct {
		DiscriminatorParam string `json:"resourceType"`
		MarshalTypeCloudExadataStorageConnector
	}{
		"CLOUD_STORAGE_CONNECTOR",
		(MarshalTypeCloudExadataStorageConnector)(m),
	}
