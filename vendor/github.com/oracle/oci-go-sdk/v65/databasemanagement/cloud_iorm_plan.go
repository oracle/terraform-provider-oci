...
// CloudIormPlan The IORM plan from an Exadata storage server.
type CloudIormPlan struct {
...
func (m CloudIormPlan) String() string {
...
func (m CloudIormPlan) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
