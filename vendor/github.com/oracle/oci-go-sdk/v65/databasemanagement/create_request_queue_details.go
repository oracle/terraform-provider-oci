...
// CreateRequestQueueDetails Create Request queue details.
type CreateRequestQueueDetails struct {
...
func (m CreateRequestQueueDetails) String() string {
...
func (m CreateRequestQueueDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
