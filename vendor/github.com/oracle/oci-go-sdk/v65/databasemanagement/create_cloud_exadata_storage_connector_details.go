...
// CreateCloudExadataStorageConnectorDetails The details required to create the connector to the Exadata storage server.
type CreateCloudExadataStorageConnectorDetails struct {
...
func (m CreateCloudExadataStorageConnectorDetails) String() string {
...
func (m CreateCloudExadataStorageConnectorDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
