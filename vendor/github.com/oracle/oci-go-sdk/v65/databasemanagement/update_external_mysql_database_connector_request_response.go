...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/databasemanagement/UpdateExternalMysqlDatabaseConnector.go.html to see an example of how to use UpdateExternalMysqlDatabaseConnectorRequest.
type UpdateExternalMysqlDatabaseConnectorRequest struct {

	// The OCID of the External MySQL Database Connector.
	ExternalMySqlDatabaseConnectorId *string `mandatory:"true" contributesTo:"path" name:"externalMySqlDatabaseConnectorId"`

	// The details required to update MySQL database connector resource.
	UpdateExternalMySqlDatabaseConnectorDetails `contributesTo:"body"`
...
type UpdateExternalMysqlDatabaseConnectorResponse struct {
