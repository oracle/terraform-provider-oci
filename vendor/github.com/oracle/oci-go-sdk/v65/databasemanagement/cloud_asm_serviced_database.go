...
// CloudAsmServicedDatabase The details of a database serviced by a cloud ASM.
type CloudAsmServicedDatabase struct {
...
func (m CloudAsmServicedDatabase) String() string {
...
func (m CloudAsmServicedDatabase) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
