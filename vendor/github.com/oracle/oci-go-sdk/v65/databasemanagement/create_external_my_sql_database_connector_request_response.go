...
type CreateExternalMySqlDatabaseConnectorRequest struct {
	...
	CreateExternalMySqlDatabaseConnectorDetails `contributesTo:"body"`

	// Parameter indicating whether database connection needs to be tested.
	IsTestConnectionParam *bool `mandatory:"true" contributesTo:"query" name:"isTestConnectionParam"`
...
type CreateExternalMySqlDatabaseConnectorResponse struct {
