...
// CloudAsmSummary The summary of a cloud ASM.
type CloudAsmSummary struct {
...
func (m CloudAsmSummary) String() string {
...
func (m CloudAsmSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
