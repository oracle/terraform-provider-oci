...
func (request ListExternalDbHomesRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListExternalDbHomesSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortBy: %s. Supported values are: %s.", request.SortBy, strings.Join(GetListExternalDbHomesSortByEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListExternalDbHomesSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListExternalDbHomesSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
func GetListExternalDbHomesSortByEnumValues() []ListExternalDbHomesSortByEnum {
	values := make([]ListExternalDbHomesSortByEnum, 0)
	for _, v := range mappingListExternalDbHomesSortByEnum {
...
func GetMappingListExternalDbHomesSortByEnum(val string) (ListExternalDbHomesSortByEnum, bool) {
	enum, ok := mappingListExternalDbHomesSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListExternalDbHomesSortOrderEnum = map[string]ListExternalDbHomesSortOrderEnum{
	"ASC":  ListExternalDbHomesSortOrderAsc,
	"DESC": ListExternalDbHomesSortOrderDesc,
}

var mappingListExternalDbHomesSortOrderEnumLowerCase = map[string]ListExternalDbHomesSortOrderEnum{
	"asc":  ListExternalDbHomesSortOrderAsc,
	"desc": ListExternalDbHomesSortOrderDesc,
}
...
func GetListExternalDbHomesSortOrderEnumValues() []ListExternalDbHomesSortOrderEnum {
	values := make([]ListExternalDbHomesSortOrderEnum, 0)
	for _, v := range mappingListExternalDbHomesSortOrderEnum {
		values = append(values, v)
	}
	return values
}
...
func GetMappingListExternalDbHomesSortOrderEnum(val string) (ListExternalDbHomesSortOrderEnum, bool) {
	enum, ok := mappingListExternalDbHomesSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
