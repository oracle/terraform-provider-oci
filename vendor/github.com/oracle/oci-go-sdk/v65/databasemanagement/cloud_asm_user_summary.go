...
// CloudAsmUserSummary The summary of an ASM user.
type CloudAsmUserSummary struct {
...
func (m CloudAsmUserSummary) String() string {
...
func (m CloudAsmUserSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
