...
func (request ListExternalExadataInfrastructuresRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListExternalExadataInfrastructuresSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortBy: %s. Supported values are: %s.", request.SortBy, strings.Join(GetListExternalExadataInfrastructuresSortByEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListExternalExadataInfrastructuresSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListExternalExadataInfrastructuresSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListExternalExadataInfrastructuresSortByEnum = map[string]ListExternalExadataInfrastructuresSortByEnum{
	"TIMECREATED": ListExternalExadataInfrastructuresSortByTimecreated,
	"NAME":        ListExternalExadataInfrastructuresSortByName,
}

var mappingListExternalExadataInfrastructuresSortByEnumLowerCase = map[string]ListExternalExadataInfrastructuresSortByEnum{
	"timecreated": ListExternalExadataInfrastructuresSortByTimecreated,
	"name":        ListExternalExadataInfrastructuresSortByName,
}
...
func GetListExternalExadataInfrastructuresSortByEnumValues() []ListExternalExadataInfrastructuresSortByEnum {
	values := make([]ListExternalExadataInfrastructuresSortByEnum, 0)
	for _, v := range mappingListExternalExadataInfrastructuresSortByEnum {
...
func GetMappingListExternalExadataInfrastructuresSortByEnum(val string) (ListExternalExadataInfrastructuresSortByEnum, bool) {
	enum, ok := mappingListExternalExadataInfrastructuresSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListExternalExadataInfrastructuresSortOrderEnum = map[string]ListExternalExadataInfrastructuresSortOrderEnum{
	"ASC":  ListExternalExadataInfrastructuresSortOrderAsc,
	"DESC": ListExternalExadataInfrastructuresSortOrderDesc,
}

var mappingListExternalExadataInfrastructuresSortOrderEnumLowerCase = map[string]ListExternalExadataInfrastructuresSortOrderEnum{
	"asc":  ListExternalExadataInfrastructuresSortOrderAsc,
	"desc": ListExternalExadataInfrastructuresSortOrderDesc,
}
...
func GetListExternalExadataInfrastructuresSortOrderEnumValues() []ListExternalExadataInfrastructuresSortOrderEnum {
	values := make([]ListExternalExadataInfrastructuresSortOrderEnum, 0)
	for _, v := range mappingListExternalExadataInfrastructuresSortOrderEnum {
		values = append(values, v)
	}
	return values
}
...
func GetMappingListExternalExadataInfrastructuresSortOrderEnum(val string) (ListExternalExadataInfrastructuresSortOrderEnum, bool) {
	enum, ok := mappingListExternalExadataInfrastructuresSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
