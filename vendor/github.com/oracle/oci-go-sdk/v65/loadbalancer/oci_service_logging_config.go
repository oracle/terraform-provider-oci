...
// OciServiceLoggingConfig The representation of OciServiceLoggingConfig
type OciServiceLoggingConfig struct {
	...
	// OCID of tenancy this log belongs to.
	TenancyId *string `mandatory:"false" json:"tenancyId"`

	// Parameters for the category indicated by categoryName
