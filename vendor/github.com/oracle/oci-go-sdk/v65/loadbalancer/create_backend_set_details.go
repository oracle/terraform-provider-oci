...
type CreateBackendSetDetails struct {
	...
	// set, the default value is set to 1s.
	// The value for connectionEstablishmentTimeoutInSeconds must be between 1 and 60 (inclusive).
	...
	// If this field is not set, the default value is set to 300s.
	// The value for keepAliveTimeoutInSeconds must be between 0 and 86400 (inclusive).
