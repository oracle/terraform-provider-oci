...
type ChangeDetectAnomalyJobCompartmentRequest struct {
	...
	ChangeDetectAnomalyJobCompartmentDetails `contributesTo:"body"`
...
func (request ChangeDetectAnomalyJobCompartmentRequest) RetryPolicy() common.OCIRetry {
...
type ChangeDetectAnomalyJobCompartmentResponse struct {
