...
type ObjectListInputDetails struct {
...
func (m ObjectListInputDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeObjectListInputDetails ObjectListInputDetails
	s := struct {
		DiscriminatorParam string `json:"inputType"`
		MarshalTypeObjectListInputDetails
	}{
		"OBJECT_LIST",
		(MarshalTypeObjectListInputDetails)(m),
	}
