...
type UpdateDetectAnomalyJobRequest struct {
	...
	UpdateDetectAnomalyJobDetails `contributesTo:"body"`
...
func (request UpdateDetectAnomalyJobRequest) RetryPolicy() common.OCIRetry {
...
type UpdateDetectAnomalyJobResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The DetectAnomalyJob instance
	DetectAnomalyJob `presentIn:"body"`
