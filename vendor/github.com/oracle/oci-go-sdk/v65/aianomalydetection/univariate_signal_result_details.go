...
// UnivariateSignalResultDetails This contains signal metadata after training is completed.
type UnivariateSignalResultDetails struct {
	...
	// Algorithm hint parameters to be used for training
	AlgorithmHintParameters *string `mandatory:"false" json:"algorithmHintParameters"`

	// Metrics of each signal as part of detection result
	SignalMetricDetails []UnivariateSignalMetricDetails `mandatory:"false" json:"signalMetricDetails"`
}

func (m UnivariateSignalResultDetails) String() string {
...
func (m UnivariateSignalResultDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
