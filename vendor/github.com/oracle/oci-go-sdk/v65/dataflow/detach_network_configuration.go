...
// DetachNetworkConfiguration A Data Flow DetachNetworkConfiguration object.
type DetachNetworkConfiguration struct {
...
func (m DetachNetworkConfiguration) String() string {
...
func (m DetachNetworkConfiguration) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
