...
func (client DataFlowClient) CreateDeployment(ctx context.Context, request CreateDeploymentRequest) (response CreateDeploymentResponse, err error) {
	var ociResponse common.OCIResponse
	policy := common.DefaultRetryPolicy()
	if client.RetryPolicy() != nil {
		policy = *client.RetryPolicy()
...
func (client DataFlowClient) createDeployment(ctx context.Context, request common.OCIRequest, binaryReqBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (common.OCIResponse, error) {

	httpRequest, err := request.HTTPRequest(http.MethodPost, "/computeClusters/{computeClusterId}/deployments", binaryReqBody, extraHeaders)
	if err != nil {
		return nil, err
	}
	...
	response.RawResponse = httpResponse
	if err != nil {
		apiReferenceLink := "https://docs.oracle.com/iaas/api/#/en/data-flow/20200129/Deployment/CreateDeployment"
		err = common.PostProcessServiceError(err, "DataFlow", "CreateDeployment", apiReferenceLink)
		return response, err
	}
...
func (client DataFlowClient) DeleteDeployment(ctx context.Context, request DeleteDeploymentRequest) (response DeleteDeploymentResponse, err error) {
	var ociResponse common.OCIResponse
	policy := common.NoRetryPolicy()
	if client.RetryPolicy() != nil {
		policy = *client.RetryPolicy()
...
func (client DataFlowClient) deleteDeployment(ctx context.Context, request common.OCIRequest, binaryReqBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (common.OCIResponse, error) {

	httpRequest, err := request.HTTPRequest(http.MethodDelete, "/computeClusters/{computeClusterId}/deployments/{deploymentId}", binaryReqBody, extraHeaders)
	if err != nil {
		return nil, err
	}
	...
	response.RawResponse = httpResponse
	if err != nil {
		apiReferenceLink := "https://docs.oracle.com/iaas/api/#/en/data-flow/20200129/Deployment/DeleteDeployment"
		err = common.PostProcessServiceError(err, "DataFlow", "DeleteDeployment", apiReferenceLink)
		return response, err
	}
...
func (client DataFlowClient) GetDeployment(ctx context.Context, request GetDeploymentRequest) (response GetDeploymentResponse, err error) {
	var ociResponse common.OCIResponse
	policy := common.NoRetryPolicy()
	if client.RetryPolicy() != nil {
		policy = *client.RetryPolicy()
...
func (client DataFlowClient) getDeployment(ctx context.Context, request common.OCIRequest, binaryReqBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (common.OCIResponse, error) {

	httpRequest, err := request.HTTPRequest(http.MethodGet, "/computeClusters/{computeClusterId}/deployments/{deploymentId}", binaryReqBody, extraHeaders)
	if err != nil {
		return nil, err
	}
...
// StartOrReplaceComputeCluster Starts or replaces the dataflow compute cluster for a given `computeClusterId`. When provided, If-Match is checked against ETag values of the resource.
// A default retry strategy applies to this operation StartOrReplaceComputeCluster()
func (client DataFlowClient) StartOrReplaceComputeCluster(ctx context.Context, request StartOrReplaceComputeClusterRequest) (response StartOrReplaceComputeClusterResponse, err error) {
	var ociResponse common.OCIResponse
	policy := common.DefaultRetryPolicy()
	if client.RetryPolicy() != nil {
		policy = *client.RetryPolicy()
	...
	ociResponse, err = common.Retry(ctx, request, client.startOrReplaceComputeCluster, policy)
	if err != nil {
		if ociResponse != nil {
			if httpResponse := ociResponse.HTTPResponse(); httpResponse != nil {
				opcRequestId := httpResponse.Header.Get("opc-request-id")
				response = StartOrReplaceComputeClusterResponse{RawResponse: httpResponse, OpcRequestId: &opcRequestId}
			} else {
				response = StartOrReplaceComputeClusterResponse{}
			}
		}
		return
	}
	if convertedResponse, ok := ociResponse.(StartOrReplaceComputeClusterResponse); ok {
		response = convertedResponse
	} else {
		err = fmt.Errorf("failed to convert OCIResponse into StartOrReplaceComputeClusterResponse")
	}
	return
}

// startOrReplaceComputeCluster implements the OCIOperation interface (enables retrying operations)
func (client DataFlowClient) startOrReplaceComputeCluster(ctx context.Context, request common.OCIRequest, binaryReqBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (common.OCIResponse, error) {

	httpRequest, err := request.HTTPRequest(http.MethodPost, "/computeClusters/{computeClusterId}/actions/startOrReplace", binaryReqBody, extraHeaders)
	if err != nil {
		return nil, err
	}
	...
	response.RawResponse = httpResponse
	if err != nil {
		apiReferenceLink := "https://docs.oracle.com/iaas/api/#/en/data-flow/20200129/ComputeCluster/StartOrReplaceComputeCluster"
		err = common.PostProcessServiceError(err, "DataFlow", "StartOrReplaceComputeCluster", apiReferenceLink)
		return response, err
	}
