...
// StopComputeClusterDetails Stop compute cluster optional information.
type StopComputeClusterDetails struct {
...
func (m StopComputeClusterDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
