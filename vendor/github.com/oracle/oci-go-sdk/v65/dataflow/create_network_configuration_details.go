...
// CreateNetworkConfigurationDetails Request payload for creating network configuration.
type CreateNetworkConfigurationDetails struct {
...
func (m CreateNetworkConfigurationDetails) String() string {
...
func (m CreateNetworkConfigurationDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
