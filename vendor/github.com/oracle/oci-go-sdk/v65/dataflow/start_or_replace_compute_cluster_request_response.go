...
// StartOrReplaceComputeClusterRequest wrapper for the StartOrReplaceComputeCluster operation
type StartOrReplaceComputeClusterRequest struct {
...
func (request StartOrReplaceComputeClusterRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request StartOrReplaceComputeClusterRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request StartOrReplaceComputeClusterRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request StartOrReplaceComputeClusterRequest) RetryPolicy() *common.RetryPolicy {
...
func (request StartOrReplaceComputeClusterRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
...
// StartOrReplaceComputeClusterResponse wrapper for the StartOrReplaceComputeCluster operation
type StartOrReplaceComputeClusterResponse struct {
	...
	ComputeClusterId *string `presentIn:"header" name:"computeclusterid"`
}

func (response StartOrReplaceComputeClusterResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response StartOrReplaceComputeClusterResponse) HTTPResponse() *http.Response {
