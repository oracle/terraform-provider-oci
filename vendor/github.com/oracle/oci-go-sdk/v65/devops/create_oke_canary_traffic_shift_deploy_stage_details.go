...
func (m CreateOkeCanaryTrafficShiftDeployStageDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m CreateOkeCanaryTrafficShiftDeployStageDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
