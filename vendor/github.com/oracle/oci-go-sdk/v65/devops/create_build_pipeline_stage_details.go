...
func (m *createbuildpipelinestagedetails) UnmarshalPolymorphicJSON(data []byte) (interface{}, error) {
	...
	case "BUILD":
		...
		return mm, err
	default:
		common.Logf("Recieved unsupported enum value for CreateBuildPipelineStageDetails: %s.", m.BuildPipelineStageType)
		return *m, nil
	}
}
...
func (m createbuildpipelinestagedetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
