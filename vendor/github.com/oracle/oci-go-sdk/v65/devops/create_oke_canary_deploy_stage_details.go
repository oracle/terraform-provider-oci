...
func (m CreateOkeCanaryDeployStageDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m CreateOkeCanaryDeployStageDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
...
func (m CreateOkeCanaryDeployStageDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateOkeCanaryDeployStageDetails CreateOkeCanaryDeployStageDetails
	s := struct {
		DiscriminatorParam string `json:"deployStageType"`
		MarshalTypeCreateOkeCanaryDeployStageDetails
	}{
		"OKE_CANARY_DEPLOYMENT",
		(MarshalTypeCreateOkeCanaryDeployStageDetails)(m),
	}
