...
func (m ComputeInstanceGroupCanaryTrafficShiftDeployStage) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m ComputeInstanceGroupCanaryTrafficShiftDeployStage) GetTagSlugs() []string {
	return m.TagSlugs
}
