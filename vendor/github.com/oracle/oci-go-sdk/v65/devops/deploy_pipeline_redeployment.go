...
func (m DeployPipelineRedeployment) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m DeployPipelineRedeployment) GetTagSlugs() []string {
	return m.TagSlugs
}

// GetCmUrl returns CmUrl
func (m DeployPipelineRedeployment) GetCmUrl() *string {
	return m.CmUrl
}
