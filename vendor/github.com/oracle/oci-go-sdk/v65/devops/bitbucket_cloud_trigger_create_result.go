...
func (m BitbucketCloudTriggerCreateResult) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeBitbucketCloudTriggerCreateResult BitbucketCloudTriggerCreateResult
	s := struct {
		DiscriminatorParam string `json:"triggerSource"`
		MarshalTypeBitbucketCloudTriggerCreateResult
	}{
		"BITBUCKET_CLOUD",
		(MarshalTypeBitbucketCloudTriggerCreateResult)(m),
	}
