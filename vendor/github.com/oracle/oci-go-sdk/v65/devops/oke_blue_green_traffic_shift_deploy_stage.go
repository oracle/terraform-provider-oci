...
func (m OkeBlueGreenTrafficShiftDeployStage) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m OkeBlueGreenTrafficShiftDeployStage) GetTagSlugs() []string {
	return m.TagSlugs
}
...
func (m OkeBlueGreenTrafficShiftDeployStage) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOkeBlueGreenTrafficShiftDeployStage OkeBlueGreenTrafficShiftDeployStage
	s := struct {
		DiscriminatorParam string `json:"deployStageType"`
		MarshalTypeOkeBlueGreenTrafficShiftDeployStage
	}{
		"OKE_BLUE_GREEN_TRAFFIC_SHIFT",
		(MarshalTypeOkeBlueGreenTrafficShiftDeployStage)(m),
	}
