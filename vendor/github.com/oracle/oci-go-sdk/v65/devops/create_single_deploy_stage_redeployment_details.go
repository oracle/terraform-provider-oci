...
func (m CreateSingleDeployStageRedeploymentDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m CreateSingleDeployStageRedeploymentDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
