...
func (m OkeCanaryTrafficShiftDeployStage) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m OkeCanaryTrafficShiftDeployStage) GetTagSlugs() []string {
	return m.TagSlugs
}
