...
func (m DeployPipelineRedeploymentSummary) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m DeployPipelineRedeploymentSummary) GetTagSlugs() []string {
	return m.TagSlugs
}
