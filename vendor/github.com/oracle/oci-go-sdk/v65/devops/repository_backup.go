...
// RepositoryBackup Repository Backup.
...
func (m RepositoryBackup) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
// RepositoryBackupLifecycleStateEnum Enum with underlying type: string
type RepositoryBackupLifecycleStateEnum string

// Set of constants representing the allowable values for RepositoryBackupLifecycleStateEnum
const (
	RepositoryBackupLifecycleStateCreating RepositoryBackupLifecycleStateEnum = "CREATING"
	RepositoryBackupLifecycleStateDeleting RepositoryBackupLifecycleStateEnum = "DELETING"
	RepositoryBackupLifecycleStateFailed   RepositoryBackupLifecycleStateEnum = "FAILED"
	RepositoryBackupLifecycleStateActive   RepositoryBackupLifecycleStateEnum = "ACTIVE"
)

var mappingRepositoryBackupLifecycleStateEnum = map[string]RepositoryBackupLifecycleStateEnum{
	"CREATING": RepositoryBackupLifecycleStateCreating,
	"DELETING": RepositoryBackupLifecycleStateDeleting,
	"FAILED":   RepositoryBackupLifecycleStateFailed,
	"ACTIVE":   RepositoryBackupLifecycleStateActive,
}

var mappingRepositoryBackupLifecycleStateEnumLowerCase = map[string]RepositoryBackupLifecycleStateEnum{
	"creating": RepositoryBackupLifecycleStateCreating,
	"deleting": RepositoryBackupLifecycleStateDeleting,
	"failed":   RepositoryBackupLifecycleStateFailed,
	"active":   RepositoryBackupLifecycleStateActive,
...
// GetRepositoryBackupLifecycleStateEnumValues Enumerates the set of values for RepositoryBackupLifecycleStateEnum
func GetRepositoryBackupLifecycleStateEnumValues() []RepositoryBackupLifecycleStateEnum {
	values := make([]RepositoryBackupLifecycleStateEnum, 0)
	for _, v := range mappingRepositoryBackupLifecycleStateEnum {
		values = append(values, v)
	}
	return values
}

// GetRepositoryBackupLifecycleStateEnumStringValues Enumerates the set of values in String for RepositoryBackupLifecycleStateEnum
func GetRepositoryBackupLifecycleStateEnumStringValues() []string {
	return []string{
		"CREATING",
		"DELETING",
		"FAILED",
...
// GetMappingRepositoryBackupLifecycleStateEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingRepositoryBackupLifecycleStateEnum(val string) (RepositoryBackupLifecycleStateEnum, bool) {
	enum, ok := mappingRepositoryBackupLifecycleStateEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
