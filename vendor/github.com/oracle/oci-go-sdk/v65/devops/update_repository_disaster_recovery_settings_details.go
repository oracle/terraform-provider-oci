...
// UpdateRepositoryDisasterRecoverySettingsDetails The information about new Disaster Recovery Setting to be updated.
type UpdateRepositoryDisasterRecoverySettingsDetails struct {

	// Setting name (case-sensitive).
	DisplayName *string `mandatory:"false" json:"displayName"`

	// The List of additional compartment not included in the Disaster Recovery Plan.
...
func (m UpdateRepositoryDisasterRecoverySettingsDetails) String() string {
...
func (m UpdateRepositoryDisasterRecoverySettingsDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
