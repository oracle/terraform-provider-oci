...
func (m UpdateComputeInstanceGroupCanaryApprovalDeployStageDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m UpdateComputeInstanceGroupCanaryApprovalDeployStageDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
