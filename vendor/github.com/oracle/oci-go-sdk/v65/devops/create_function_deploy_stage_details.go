...
func (m CreateFunctionDeployStageDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m CreateFunctionDeployStageDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
