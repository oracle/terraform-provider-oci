...
func (m ComputeInstanceGroupCanaryTrafficShiftDeployStageSummary) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m ComputeInstanceGroupCanaryTrafficShiftDeployStageSummary) GetTagSlugs() []string {
	return m.TagSlugs
}
