...
func (m ComputeInstanceGroupBlueGreenTrafficShiftDeployStage) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m ComputeInstanceGroupBlueGreenTrafficShiftDeployStage) GetTagSlugs() []string {
	return m.TagSlugs
}
