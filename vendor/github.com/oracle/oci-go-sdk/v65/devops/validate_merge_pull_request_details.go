...
func (m ValidateMergePullRequestDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeValidateMergePullRequestDetails ValidateMergePullRequestDetails
	s := struct {
		DiscriminatorParam string `json:"actionType"`
		MarshalTypeValidateMergePullRequestDetails
	}{
		"VALIDATE",
		(MarshalTypeValidateMergePullRequestDetails)(m),
	}
