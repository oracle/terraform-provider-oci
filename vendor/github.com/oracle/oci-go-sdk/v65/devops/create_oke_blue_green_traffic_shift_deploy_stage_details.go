...
func (m CreateOkeBlueGreenTrafficShiftDeployStageDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m CreateOkeBlueGreenTrafficShiftDeployStageDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
...
func (m CreateOkeBlueGreenTrafficShiftDeployStageDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateOkeBlueGreenTrafficShiftDeployStageDetails CreateOkeBlueGreenTrafficShiftDeployStageDetails
	s := struct {
		DiscriminatorParam string `json:"deployStageType"`
		MarshalTypeCreateOkeBlueGreenTrafficShiftDeployStageDetails
	}{
		"OKE_BLUE_GREEN_TRAFFIC_SHIFT",
		(MarshalTypeCreateOkeBlueGreenTrafficShiftDeployStageDetails)(m),
	}
