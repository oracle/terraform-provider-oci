...
func (m UpdateComputeInstanceGroupCanaryTrafficShiftDeployStageDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m UpdateComputeInstanceGroupCanaryTrafficShiftDeployStageDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
