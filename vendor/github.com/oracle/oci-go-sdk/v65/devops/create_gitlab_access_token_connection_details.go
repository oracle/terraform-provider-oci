...
// CreateGitlabAccessTokenConnectionDetails The details for creating a connection of the type `GITLAB_ACCESS_TOKEN`.
...
func (m CreateGitlabAccessTokenConnectionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateGitlabAccessTokenConnectionDetails CreateGitlabAccessTokenConnectionDetails
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeCreateGitlabAccessTokenConnectionDetails
	}{
		"GITLAB_ACCESS_TOKEN",
		(MarshalTypeCreateGitlabAccessTokenConnectionDetails)(m),
	}
