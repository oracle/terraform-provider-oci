...
func (m CreateComputeInstanceGroupCanaryApprovalDeployStageDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m CreateComputeInstanceGroupCanaryApprovalDeployStageDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
