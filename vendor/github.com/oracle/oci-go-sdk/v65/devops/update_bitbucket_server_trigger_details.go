...
func (m UpdateBitbucketServerTriggerDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateBitbucketServerTriggerDetails UpdateBitbucketServerTriggerDetails
	s := struct {
		DiscriminatorParam string `json:"triggerSource"`
		MarshalTypeUpdateBitbucketServerTriggerDetails
	}{
		"BITBUCKET_SERVER",
		(MarshalTypeUpdateBitbucketServerTriggerDetails)(m),
	}
