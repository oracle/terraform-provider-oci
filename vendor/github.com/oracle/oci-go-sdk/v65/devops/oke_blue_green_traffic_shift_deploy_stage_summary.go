...
func (m OkeBlueGreenTrafficShiftDeployStageSummary) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m OkeBlueGreenTrafficShiftDeployStageSummary) GetTagSlugs() []string {
	return m.TagSlugs
}
