...
func (m *updatedeployenvironmentdetails) UnmarshalPolymorphicJSON(data []byte) (interface{}, error) {
	...
	case "OKE_CLUSTER":
		...
		return mm, err
	default:
		common.Logf("Received unsupported enum value for UpdateDeployEnvironmentDetails: %s.", m.DeployEnvironmentType)
		return *m, nil
	}
}
...
func (m updatedeployenvironmentdetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
