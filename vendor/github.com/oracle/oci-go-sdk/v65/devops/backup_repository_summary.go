...
// BackupRepositorySummary Summary of the Backup Projects.
type BackupRepositorySummary struct {

	// Name of Repository to which the backups exist.
...
func (m BackupRepositorySummary) String() string {
...
func (m BackupRepositorySummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
