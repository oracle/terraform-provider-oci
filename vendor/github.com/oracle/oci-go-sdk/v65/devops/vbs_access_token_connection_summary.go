...
// VbsAccessTokenConnectionSummary Summary information for a connection of the type `VBS_ACCESS_TOKEN`.
...
func (m VbsAccessTokenConnectionSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeVbsAccessTokenConnectionSummary VbsAccessTokenConnectionSummary
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeVbsAccessTokenConnectionSummary
	}{
		"VBS_ACCESS_TOKEN",
		(MarshalTypeVbsAccessTokenConnectionSummary)(m),
	}
