...
func (m BitbucketCloudTriggerSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeBitbucketCloudTriggerSummary BitbucketCloudTriggerSummary
	s := struct {
		DiscriminatorParam string `json:"triggerSource"`
		MarshalTypeBitbucketCloudTriggerSummary
	}{
		"BITBUCKET_CLOUD",
		(MarshalTypeBitbucketCloudTriggerSummary)(m),
	}
