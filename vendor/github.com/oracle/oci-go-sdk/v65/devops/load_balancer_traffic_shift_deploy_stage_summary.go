...
func (m LoadBalancerTrafficShiftDeployStageSummary) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m LoadBalancerTrafficShiftDeployStageSummary) GetTagSlugs() []string {
	return m.TagSlugs
}
