...
func (m LoadBalancerTrafficShiftDeployStageExecutionProgress) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeLoadBalancerTrafficShiftDeployStageExecutionProgress LoadBalancerTrafficShiftDeployStageExecutionProgress
	s := struct {
		DiscriminatorParam string `json:"deployStageType"`
		MarshalTypeLoadBalancerTrafficShiftDeployStageExecutionProgress
	}{
		"LOAD_BALANCER_TRAFFIC_SHIFT",
		(MarshalTypeLoadBalancerTrafficShiftDeployStageExecutionProgress)(m),
	}
