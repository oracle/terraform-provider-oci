...
func (m CreateComputeInstanceGroupCanaryTrafficShiftDeployStageDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m CreateComputeInstanceGroupCanaryTrafficShiftDeployStageDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
