...
func (m UpdateSingleDeployStageDeploymentDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m UpdateSingleDeployStageDeploymentDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
