...
func (m CreateSingleDeployStageDeploymentDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m CreateSingleDeployStageDeploymentDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
