...
// UpdateClusterNamespaceDeployEnvironmentDetails Specifies the OMK cluster namespace environment.
type UpdateClusterNamespaceDeployEnvironmentDetails struct {
...
func (m UpdateClusterNamespaceDeployEnvironmentDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m UpdateClusterNamespaceDeployEnvironmentDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateClusterNamespaceDeployEnvironmentDetails UpdateClusterNamespaceDeployEnvironmentDetails
	s := struct {
		DiscriminatorParam string `json:"deployEnvironmentType"`
		MarshalTypeUpdateClusterNamespaceDeployEnvironmentDetails
	}{
		"CLUSTER_NAMESPACE",
		(MarshalTypeUpdateClusterNamespaceDeployEnvironmentDetails)(m),
	}
...
func (m *UpdateClusterNamespaceDeployEnvironmentDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {
