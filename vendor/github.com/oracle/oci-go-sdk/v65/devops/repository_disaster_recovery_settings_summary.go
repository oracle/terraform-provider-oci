...
// RepositoryDisasterRecoverySettingsSummary Summary of the Repository Disaster Recovery Settings.
type RepositoryDisasterRecoverySettingsSummary struct {

	// Unique identifier that is immutable on creation.
	Id *string `mandatory:"true" json:"id"`

	// Name of Setting. (case-sensitive).
...
func (m RepositoryDisasterRecoverySettingsSummary) String() string {
...
func (m RepositoryDisasterRecoverySettingsSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
