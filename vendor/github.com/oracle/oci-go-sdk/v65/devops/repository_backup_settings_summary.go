...
// RepositoryBackupSettingsSummary Repository Backup Settings Summary.
type RepositoryBackupSettingsSummary struct {
	...
	// The start time after which backups will be created. An RFC3339 formatted datetime string
...
func (m RepositoryBackupSettingsSummary) String() string {
...
func (m RepositoryBackupSettingsSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
