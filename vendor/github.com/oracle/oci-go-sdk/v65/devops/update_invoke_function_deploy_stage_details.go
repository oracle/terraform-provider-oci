...
func (m UpdateInvokeFunctionDeployStageDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m UpdateInvokeFunctionDeployStageDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
