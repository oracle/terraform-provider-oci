...
func (m UpdateDeployPipelineDeploymentDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m UpdateDeployPipelineDeploymentDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
