...
func (m ManualApprovalDeployStageSummary) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m ManualApprovalDeployStageSummary) GetTagSlugs() []string {
	return m.TagSlugs
}
