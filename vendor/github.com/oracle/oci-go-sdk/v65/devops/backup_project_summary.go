...
// BackupProjectSummary Summary of the Backup Projects.
type BackupProjectSummary struct {

	// Name of Project to which the repositories with backup exist.
	ProjectName *string `mandatory:"true" json:"projectName"`

	// DevOps Project Identifier
...
func (m BackupProjectSummary) String() string {
...
func (m BackupProjectSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
