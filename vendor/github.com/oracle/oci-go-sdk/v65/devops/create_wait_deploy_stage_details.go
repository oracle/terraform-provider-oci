...
func (m CreateWaitDeployStageDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m CreateWaitDeployStageDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
...
func (m CreateWaitDeployStageDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateWaitDeployStageDetails CreateWaitDeployStageDetails
	s := struct {
		DiscriminatorParam string `json:"deployStageType"`
		MarshalTypeCreateWaitDeployStageDetails
	}{
		"WAIT",
		(MarshalTypeCreateWaitDeployStageDetails)(m),
	}
