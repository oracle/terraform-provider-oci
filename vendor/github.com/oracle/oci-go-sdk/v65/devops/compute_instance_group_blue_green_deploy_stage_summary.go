...
func (m ComputeInstanceGroupBlueGreenDeployStageSummary) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m ComputeInstanceGroupBlueGreenDeployStageSummary) GetTagSlugs() []string {
	return m.TagSlugs
}
