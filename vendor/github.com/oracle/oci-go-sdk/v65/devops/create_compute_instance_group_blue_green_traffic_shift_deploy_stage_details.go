...
func (m CreateComputeInstanceGroupBlueGreenTrafficShiftDeployStageDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m CreateComputeInstanceGroupBlueGreenTrafficShiftDeployStageDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
