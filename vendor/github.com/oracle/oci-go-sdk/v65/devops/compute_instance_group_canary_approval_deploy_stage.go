...
func (m ComputeInstanceGroupCanaryApprovalDeployStage) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m ComputeInstanceGroupCanaryApprovalDeployStage) GetTagSlugs() []string {
	return m.TagSlugs
}
