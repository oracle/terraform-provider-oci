...
func (m UpdateOkeBlueGreenDeployStageDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m UpdateOkeBlueGreenDeployStageDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
