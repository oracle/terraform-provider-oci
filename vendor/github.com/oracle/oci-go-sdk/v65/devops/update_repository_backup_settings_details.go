...
// UpdateRepositoryBackupSettingsDetails Update Repository Backup Settings Details.
type UpdateRepositoryBackupSettingsDetails struct {
...
func (m UpdateRepositoryBackupSettingsDetails) String() string {
...
func (m UpdateRepositoryBackupSettingsDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
