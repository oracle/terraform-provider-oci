...
func (m CreateBitbucketCloudAppPasswordConnectionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateBitbucketCloudAppPasswordConnectionDetails CreateBitbucketCloudAppPasswordConnectionDetails
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeCreateBitbucketCloudAppPasswordConnectionDetails
	}{
		"BITBUCKET_CLOUD_APP_PASSWORD",
		(MarshalTypeCreateBitbucketCloudAppPasswordConnectionDetails)(m),
	}
