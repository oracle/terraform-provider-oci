...
// CreateRepositoryDisasterRecoverySettingsDetails The information about new Disaster Recovery Setting to be created.
type CreateRepositoryDisasterRecoverySettingsDetails struct {

	// The compartment OCID where the Disaster Recovery Setting is created. This is always the root compartment.
	CompartmentId *string `mandatory:"true" json:"compartmentId"`

	// Identifier of the Primary Disaster Recovery Region. Region identifiers are listed at https://docs.oracle.com/en-us/iaas/Content/General/Concepts/regions.htm
...
func (m CreateRepositoryDisasterRecoverySettingsDetails) String() string {
...
func (m CreateRepositoryDisasterRecoverySettingsDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
