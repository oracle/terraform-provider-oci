...
func (m UpdateDeployPipelineRedeploymentDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m UpdateDeployPipelineRedeploymentDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
...
func (m UpdateDeployPipelineRedeploymentDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateDeployPipelineRedeploymentDetails UpdateDeployPipelineRedeploymentDetails
	s := struct {
		DiscriminatorParam string `json:"deploymentType"`
		MarshalTypeUpdateDeployPipelineRedeploymentDetails
	}{
		"PIPELINE_REDEPLOYMENT",
		(MarshalTypeUpdateDeployPipelineRedeploymentDetails)(m),
	}
