...
func (m UpdateSingleDeployStageRedeploymentDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m UpdateSingleDeployStageRedeploymentDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
