...
func (m OkeCanaryApprovalDeployStageExecutionProgress) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOkeCanaryApprovalDeployStageExecutionProgress OkeCanaryApprovalDeployStageExecutionProgress
	s := struct {
		DiscriminatorParam string `json:"deployStageType"`
		MarshalTypeOkeCanaryApprovalDeployStageExecutionProgress
	}{
		"OKE_CANARY_APPROVAL",
		(MarshalTypeOkeCanaryApprovalDeployStageExecutionProgress)(m),
	}
