...
func (m UpdateOkeCanaryTrafficShiftDeployStageDetails) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m UpdateOkeCanaryTrafficShiftDeployStageDetails) GetTagSlugs() []string {
	return m.TagSlugs
}
...
func (m UpdateOkeCanaryTrafficShiftDeployStageDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateOkeCanaryTrafficShiftDeployStageDetails UpdateOkeCanaryTrafficShiftDeployStageDetails
	s := struct {
		DiscriminatorParam string `json:"deployStageType"`
		MarshalTypeUpdateOkeCanaryTrafficShiftDeployStageDetails
	}{
		"OKE_CANARY_TRAFFIC_SHIFT",
		(MarshalTypeUpdateOkeCanaryTrafficShiftDeployStageDetails)(m),
	}
