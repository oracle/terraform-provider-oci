...
func (m OkeCanaryTrafficShiftDeployStageSummary) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m OkeCanaryTrafficShiftDeployStageSummary) GetTagSlugs() []string {
	return m.TagSlugs
}
...
func (m OkeCanaryTrafficShiftDeployStageSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOkeCanaryTrafficShiftDeployStageSummary OkeCanaryTrafficShiftDeployStageSummary
	s := struct {
		DiscriminatorParam string `json:"deployStageType"`
		MarshalTypeOkeCanaryTrafficShiftDeployStageSummary
	}{
		"OKE_CANARY_TRAFFIC_SHIFT",
		(MarshalTypeOkeCanaryTrafficShiftDeployStageSummary)(m),
	}
