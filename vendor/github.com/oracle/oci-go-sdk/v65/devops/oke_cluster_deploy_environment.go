...
func (m OkeClusterDeployEnvironment) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m OkeClusterDeployEnvironment) GetTagSlugs() []string {
	return m.TagSlugs
}
...
func (m OkeClusterDeployEnvironment) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOkeClusterDeployEnvironment OkeClusterDeployEnvironment
	s := struct {
		DiscriminatorParam string `json:"deployEnvironmentType"`
		MarshalTypeOkeClusterDeployEnvironment
	}{
		"OKE_CLUSTER",
		(MarshalTypeOkeClusterDeployEnvironment)(m),
	}
