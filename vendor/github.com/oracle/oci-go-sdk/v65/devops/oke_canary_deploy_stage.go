...
func (m OkeCanaryDeployStage) GetSecurityAttributes() map[string]map[string]interface{} {
	return m.SecurityAttributes
}

// GetTagSlugs returns TagSlugs
func (m OkeCanaryDeployStage) GetTagSlugs() []string {
	return m.TagSlugs
}
...
func (m OkeCanaryDeployStage) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOkeCanaryDeployStage OkeCanaryDeployStage
	s := struct {
		DiscriminatorParam string `json:"deployStageType"`
		MarshalTypeOkeCanaryDeployStage
	}{
		"OKE_CANARY_DEPLOYMENT",
		(MarshalTypeOkeCanaryDeployStage)(m),
	}
