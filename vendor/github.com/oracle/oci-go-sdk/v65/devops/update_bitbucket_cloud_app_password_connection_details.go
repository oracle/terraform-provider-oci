...
// UpdateBitbucketCloudAppPasswordConnectionDetails The details for updating a connection of the type `BITBUCKET_CLOUD_APP_PASSWORD`.
...
func (m UpdateBitbucketCloudAppPasswordConnectionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateBitbucketCloudAppPasswordConnectionDetails UpdateBitbucketCloudAppPasswordConnectionDetails
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeUpdateBitbucketCloudAppPasswordConnectionDetails
	}{
		"BITBUCKET_CLOUD_APP_PASSWORD",
		(MarshalTypeUpdateBitbucketCloudAppPasswordConnectionDetails)(m),
	}
