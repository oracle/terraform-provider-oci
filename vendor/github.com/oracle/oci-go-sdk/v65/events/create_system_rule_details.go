...
// CreateSystemRuleDetails Object used to create an events2.0 system rule.
type CreateSystemRuleDetails struct {
...
func (m CreateSystemRuleDetails) String() string {
...
func (m CreateSystemRuleDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
