...
// UpdateManagedRuleDetails Object used to update an events2.0 managed rule.
type UpdateManagedRuleDetails struct {
...
func (m UpdateManagedRuleDetails) String() string {
...
func (m UpdateManagedRuleDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
