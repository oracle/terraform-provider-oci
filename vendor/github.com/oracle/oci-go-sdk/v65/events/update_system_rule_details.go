...
// UpdateSystemRuleDetails Object used to update an events2.0 system rule.
type UpdateSystemRuleDetails struct {
...
func (m UpdateSystemRuleDetails) String() string {
...
func (m UpdateSystemRuleDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
