...
// SystemRuleSummary The summary details of rules for Events. For more information, see
// Managing Rules for Events (https://docs.cloud.oracle.com/iaas/Content/Events/Task/managingrules.htm).
type SystemRuleSummary struct {
	...
	// The OCID (https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the tenancy who owns this rule.
...
func (m SystemRuleSummary) String() string {
...
func (m SystemRuleSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
