...
func (request ChangeRuleCompartmentRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["ruleId"] != nil {
		templateParam := mandatoryParamMap["ruleId"]
		for _, template := range templateParam {
			replacementParam := *request.RuleId
