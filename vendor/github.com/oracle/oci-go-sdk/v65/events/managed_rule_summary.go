...
// ManagedRuleSummary The summary details of rules for Events. For more information, see
// Managing Rules for Events (https://docs.cloud.oracle.com/iaas/Content/Events/Task/managingrules.htm).
type ManagedRuleSummary struct {
	...
	// The OCID (https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the tenancy who managed this rule.
	ManagedBy *string `mandatory:"true" json:"managedBy"`
...
func (m ManagedRuleSummary) String() string {
...
func (m ManagedRuleSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
