...
// CreateManagedRuleDetails Object used to create an events2.0 managed rule.
type CreateManagedRuleDetails struct {
...
func (m CreateManagedRuleDetails) String() string {
...
func (m CreateManagedRuleDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
