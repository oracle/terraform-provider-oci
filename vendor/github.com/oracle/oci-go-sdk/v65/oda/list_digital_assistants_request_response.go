...
type ListDigitalAssistantsRequest struct {
	...
	DigitalAssistantId *string `mandatory:"false" contributesTo:"query" name:"digitalAssistantId"`
...
func (request ListDigitalAssistantsRequest) RetryPolicy() common.OCIRetry {
