...
func (m CreateServiceCloudChannelResult) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateServiceCloudChannelResult CreateServiceCloudChannelResult
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCreateServiceCloudChannelResult
	}{
		"SERVICECLOUD",
		(MarshalTypeCreateServiceCloudChannelResult)(m),
	}
