...
// TargetConnectorPluginSummary Summary information for a connector plugin that sends data to a target service.
...
func (m TargetConnectorPluginSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeTargetConnectorPluginSummary TargetConnectorPluginSummary
	s := struct {
		DiscriminatorParam string `json:"kind"`
		MarshalTypeTargetConnectorPluginSummary
	}{
		"TARGET",
		(MarshalTypeTargetConnectorPluginSummary)(m),
	}
