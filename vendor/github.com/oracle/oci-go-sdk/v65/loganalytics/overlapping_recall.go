...
// OverlappingRecall This is the information about overlapping recall requests
type OverlappingRecall struct {
...
func (m OverlappingRecall) String() string {
...
func (m OverlappingRecall) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
