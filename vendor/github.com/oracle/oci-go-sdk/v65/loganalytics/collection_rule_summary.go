...
// CollectionRuleSummary Summary object of a collection rule
type CollectionRuleSummary struct {
...
func (m CollectionRuleSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
