...
func (m UpdateTableCommandDescriptor) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateTableCommandDescriptor UpdateTableCommandDescriptor
	s := struct {
		DiscriminatorParam string `json:"name"`
		MarshalTypeUpdateTableCommandDescriptor
	}{
		"UPDATETABLE",
		(MarshalTypeUpdateTableCommandDescriptor)(m),
	}
