...
// LogSetArchivingDetail This is the configuration for data archival for the specific logsets in this object
type LogSetArchivingDetail struct {

	// This is the list of logsets with their custom active and archival durations
...
func (m LogSetArchivingDetail) String() string {
...
func (m LogSetArchivingDetail) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
