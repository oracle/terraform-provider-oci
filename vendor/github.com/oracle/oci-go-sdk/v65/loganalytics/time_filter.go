...
// TimeFilter Time filter object. If omitted entirely, the system defaults to the last 7 days ending at the current time. The span between start and end must not exceed 7 days.
...
func (m TimeFilter) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
