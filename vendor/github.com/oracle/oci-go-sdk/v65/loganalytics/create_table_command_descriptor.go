...
func (m CreateTableCommandDescriptor) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateTableCommandDescriptor CreateTableCommandDescriptor
	s := struct {
		DiscriminatorParam string `json:"name"`
		MarshalTypeCreateTableCommandDescriptor
	}{
		"CREATETABLE",
		(MarshalTypeCreateTableCommandDescriptor)(m),
	}
