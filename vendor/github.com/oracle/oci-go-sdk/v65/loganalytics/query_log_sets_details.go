...
// QueryLogSetsDetails Input for POST /…/queryLogSets.  The only mandatory field is dataType.
type QueryLogSetsDetails struct {

	// The data type (e.g. LOG, APM, …) for which the log sets are requested.
	DataType StorageDataTypeEnum `mandatory:"true" json:"dataType"`

	// (Optional) log‑index number to filter on.
	LogIndex *int `mandatory:"false" json:"logIndex"`
}

func (m QueryLogSetsDetails) String() string {
...
func (m QueryLogSetsDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
