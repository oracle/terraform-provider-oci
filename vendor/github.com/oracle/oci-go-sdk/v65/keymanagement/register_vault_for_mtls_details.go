...
// RegisterVaultForMtlsDetails Register mTLS configuration request details for a vault.
type RegisterVaultForMtlsDetails struct {

	// Identifier of the fleet associated with the mTLS connection.
	FleetId *string `mandatory:"true" json:"fleetId"`
}

func (m RegisterVaultForMtlsDetails) String() string {
...
func (m RegisterVaultForMtlsDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
