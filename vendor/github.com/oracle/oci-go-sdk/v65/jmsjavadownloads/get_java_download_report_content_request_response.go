...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/jmsjavadownloads/GetJavaDownloadReportContent.go.html to see an example of how to use GetJavaDownloadReportContentRequest.
...
func (request GetJavaDownloadReportContentRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["javaDownloadReportId"] != nil {
		templateParam := mandatoryParamMap["javaDownloadReportId"]
		for _, template := range templateParam {
			replacementParam := *request.JavaDownloadReportId
