...
// UpdateOciCacheBackupDetails The OCI Cache backup information to be updated.
type UpdateOciCacheBackupDetails struct {
...
func (m UpdateOciCacheBackupDetails) String() string {
...
func (m UpdateOciCacheBackupDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
