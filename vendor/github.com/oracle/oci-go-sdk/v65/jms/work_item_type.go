...
const (
	...
	WorkItemTypeAdvUsageJavaLibrariesDynamic WorkItemTypeEnum = "ADV_USAGE_JAVA_LIBRARIES_DYNAMIC"
...
var mappingWorkItemTypeEnum = map[string]WorkItemTypeEnum{
	...
	"ADV_USAGE_JAVA_LIBRARIES_DYNAMIC": WorkItemTypeAdvUsageJavaLibrariesDynamic,
...
func GetWorkItemTypeEnumStringValues() []string {
	return []string{
		...
		"ADV_USAGE_JAVA_LIBRARIES_DYNAMIC",
		"PERFORMANCE_TUNING",
		"JMIGRATE_ANALYSIS",
