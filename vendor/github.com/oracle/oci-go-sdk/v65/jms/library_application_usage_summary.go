...
// LibraryApplicationUsageSummary Summary of an application where a given library was detected statically and/or dynamically. Contains the count of managed instances where the library was detected with this application.
type LibraryApplicationUsageSummary struct {
...
func (m LibraryApplicationUsageSummary) String() string {
...
func (m LibraryApplicationUsageSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
