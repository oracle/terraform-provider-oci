...
// UncorrelatedPackageUsageSummary Summary of an uncorrelated package.
type UncorrelatedPackageUsageSummary struct {
...
func (m UncorrelatedPackageUsageSummary) String() string {
...
func (m UncorrelatedPackageUsageSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
