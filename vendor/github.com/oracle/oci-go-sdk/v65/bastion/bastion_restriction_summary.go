...
// BastionRestrictionSummary Summary information for a bastion restriction resource.
type BastionRestrictionSummary struct {

	// The unique identifier (OCID) of the bastion restriction.
	Id *string `mandatory:"true" json:"id"`

	// The compartment OCID of partner where this resource lives.
	...
	// The public IP address reserved for this bastion. If sourceIp is provided, this will be null.
...
func (m BastionRestrictionSummary) String() string {
...
func (m BastionRestrictionSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
