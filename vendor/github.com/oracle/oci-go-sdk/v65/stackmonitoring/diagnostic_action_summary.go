...
type DiagnosticActionSummary struct {
	...
	DiagnosticActionType *string `mandatory:"true" json:"diagnosticActionType"`
	...
	// The time the diagnostic action set was last updated. An RFC3339 formatted datetime string.
...
func (m DiagnosticActionSummary) String() string {
...
func (m DiagnosticActionSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
