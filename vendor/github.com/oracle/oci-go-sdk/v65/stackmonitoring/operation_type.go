...
var mappingOperationTypeEnum = map[string]OperationTypeEnum{
	...
	"APPLY_MONITORING_TEMPLATE":    OperationTypeApplyMonitoringTemplate,
	"UNAPPLY_MONITORING_TEMPLATE":  OperationTypeUnapplyMonitoringTemplate,
