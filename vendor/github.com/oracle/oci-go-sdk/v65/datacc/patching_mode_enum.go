...
var mappingPatchingModeEnumEnum = map[string]PatchingModeEnumEnum{
	"ROLLING":    PatchingModeEnumRolling,
	"NONROLLING": PatchingModeEnumNonrolling,
}

var mappingPatchingModeEnumEnumLowerCase = map[string]PatchingModeEnumEnum{
	"rolling":    PatchingModeEnumRolling,
	"nonrolling": PatchingModeEnumNonrolling,
}
...
func GetPatchingModeEnumEnumValues() []PatchingModeEnumEnum {
	values := make([]PatchingModeEnumEnum, 0)
	for _, v := range mappingPatchingModeEnumEnum {
...
func GetMappingPatchingModeEnumEnum(val string) (PatchingModeEnumEnum, bool) {
	enum, ok := mappingPatchingModeEnumEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
