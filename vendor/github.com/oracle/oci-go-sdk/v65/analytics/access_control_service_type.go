...
var mappingAccessControlServiceTypeEnum = map[string]AccessControlServiceTypeEnum{
	"ALL": AccessControlServiceTypeAll,
}

var mappingAccessControlServiceTypeEnumLowerCase = map[string]AccessControlServiceTypeEnum{
	"all": AccessControlServiceTypeAll,
}
...
func GetAccessControlServiceTypeEnumValues() []AccessControlServiceTypeEnum {
	values := make([]AccessControlServiceTypeEnum, 0)
	for _, v := range mappingAccessControlServiceTypeEnum {
...
func GetMappingAccessControlServiceTypeEnum(val string) (AccessControlServiceTypeEnum, bool) {
	enum, ok := mappingAccessControlServiceTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
