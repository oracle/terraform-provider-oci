...
// PsaInternalDataCollection Results of a psaInternalData search. Contains PsaInternalDataSummary items.
type PsaInternalDataCollection struct {

	// List of PsaInternalDataSummary.
	Items []PsaInternalDataSummary `mandatory:"true" json:"items"`
}

func (m PsaInternalDataCollection) String() string {
...
func (m PsaInternalDataCollection) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
