...
// PsaInternalDataSummary An internal only object, that will be used by internal services (DBaaS) for validation.
type PsaInternalDataSummary struct {
...
func (m PsaInternalDataSummary) String() string {
...
func (m PsaInternalDataSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
