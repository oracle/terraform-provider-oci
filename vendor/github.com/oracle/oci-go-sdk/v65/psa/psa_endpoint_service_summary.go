...
// PsaEndpointServiceSummary A summary of PSA endpoint resource information. This object is returned when listing PSAendpointServices.
type PsaEndpointServiceSummary struct {
...
func (m PsaEndpointServiceSummary) String() string {
...
func (m PsaEndpointServiceSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
