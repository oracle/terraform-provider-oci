...
// PrivateServiceAccessSummary A summary of Private Service Access endpoint information. This object is returned when listing private service accesses.
type PrivateServiceAccessSummary struct {
	...
	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet that the Private Service Access endpoint
	// belongs to.
	...
	// A unique identifier for the service associated with the Private Service Access endpoint.
	ServiceId *string `mandatory:"true" json:"serviceId"`

	// The Private Service Access endpoint's IPv4 FQDNs, which can be used to access the associated service.
	...
	// This optional field indicates the assigned IPv6 address of the Private Service Access endpoint when it is created in  a dual stack (both IPv4 and IPv6) subnet.
	...
	// A list of the OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm)s of the network security groups that the Private Service Access endpoint's VNIC belongs to.
	// For more information about NSGs, see
	// NetworkSecurityGroup.
	NsgIds []string `mandatory:"false" json:"nsgIds"`

	// The Private Service Access endpoint's IPv6 FQDNs, which can be used to access the associated service.
	// Example: `xyz.oraclecloud.com`
	FqdnsV6 []string `mandatory:"false" json:"fqdnsV6"`

	// The private IP address (in the VCN) that represents the access point for the
	// associated service.
