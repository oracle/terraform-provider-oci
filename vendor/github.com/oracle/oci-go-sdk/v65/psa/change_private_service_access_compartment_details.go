...
// ChangePrivateServiceAccessCompartmentDetails The configuration details needed for the move operation.
type ChangePrivateServiceAccessCompartmentDetails struct {

	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment
	// into which the Private Service Access endpoint should be moved.
