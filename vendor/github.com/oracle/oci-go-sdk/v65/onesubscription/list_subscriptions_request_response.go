...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/onesubscription/ListSubscriptions.go.html to see an example of how to use ListSubscriptionsRequest.
...
var mappingListSubscriptionsSortByEnum = map[string]ListSubscriptionsSortByEnum{
	"ORDERNUMBER":   ListSubscriptionsSortByOrdernumber,
	"TIMEINVOICING": ListSubscriptionsSortByTimeinvoicing,
}
