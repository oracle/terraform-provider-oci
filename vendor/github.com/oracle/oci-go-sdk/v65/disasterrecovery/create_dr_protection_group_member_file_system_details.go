...
func (m CreateDrProtectionGroupMemberFileSystemDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDrProtectionGroupMemberFileSystemDetails CreateDrProtectionGroupMemberFileSystemDetails
	s := struct {
		DiscriminatorParam string `json:"memberType"`
		MarshalTypeCreateDrProtectionGroupMemberFileSystemDetails
	}{
		"FILE_SYSTEM",
		(MarshalTypeCreateDrProtectionGroupMemberFileSystemDetails)(m),
	}
