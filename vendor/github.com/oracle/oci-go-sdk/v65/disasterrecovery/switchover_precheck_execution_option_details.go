...
func (m SwitchoverPrecheckExecutionOptionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeSwitchoverPrecheckExecutionOptionDetails SwitchoverPrecheckExecutionOptionDetails
	s := struct {
		DiscriminatorParam string `json:"planExecutionType"`
		MarshalTypeSwitchoverPrecheckExecutionOptionDetails
	}{
		"SWITCHOVER_PRECHECK",
		(MarshalTypeSwitchoverPrecheckExecutionOptionDetails)(m),
	}
