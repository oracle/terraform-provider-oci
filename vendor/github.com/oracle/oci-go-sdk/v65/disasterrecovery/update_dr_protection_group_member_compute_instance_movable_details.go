...
func (m UpdateDrProtectionGroupMemberComputeInstanceMovableDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateDrProtectionGroupMemberComputeInstanceMovableDetails UpdateDrProtectionGroupMemberComputeInstanceMovableDetails
	s := struct {
		DiscriminatorParam string `json:"memberType"`
		MarshalTypeUpdateDrProtectionGroupMemberComputeInstanceMovableDetails
	}{
		"COMPUTE_INSTANCE_MOVABLE",
		(MarshalTypeUpdateDrProtectionGroupMemberComputeInstanceMovableDetails)(m),
	}
