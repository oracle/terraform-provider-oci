...
func (m CreateDrProtectionGroupMemberObjectStorageBucketDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDrProtectionGroupMemberObjectStorageBucketDetails CreateDrProtectionGroupMemberObjectStorageBucketDetails
	s := struct {
		DiscriminatorParam string `json:"memberType"`
		MarshalTypeCreateDrProtectionGroupMemberObjectStorageBucketDetails
	}{
		"OBJECT_STORAGE_BUCKET",
		(MarshalTypeCreateDrProtectionGroupMemberObjectStorageBucketDetails)(m),
	}
