...
func (m CancelDrPlanExecutionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCancelDrPlanExecutionDetails CancelDrPlanExecutionDetails
	s := struct {
		DiscriminatorParam string `json:"actionType"`
		MarshalTypeCancelDrPlanExecutionDetails
	}{
		"CANCEL",
		(MarshalTypeCancelDrPlanExecutionDetails)(m),
	}
