...
func (m StopDrillExecutionOptionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeStopDrillExecutionOptionDetails StopDrillExecutionOptionDetails
	s := struct {
		DiscriminatorParam string `json:"planExecutionType"`
		MarshalTypeStopDrillExecutionOptionDetails
	}{
		"STOP_DRILL",
		(MarshalTypeStopDrillExecutionOptionDetails)(m),
	}
