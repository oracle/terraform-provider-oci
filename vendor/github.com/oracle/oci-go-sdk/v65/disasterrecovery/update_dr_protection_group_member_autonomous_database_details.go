...
// UpdateDrProtectionGroupMemberAutonomousDatabaseDetails Update properties for an Autonomous Database member.
...
func (m UpdateDrProtectionGroupMemberAutonomousDatabaseDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateDrProtectionGroupMemberAutonomousDatabaseDetails UpdateDrProtectionGroupMemberAutonomousDatabaseDetails
	s := struct {
		DiscriminatorParam string `json:"memberType"`
		MarshalTypeUpdateDrProtectionGroupMemberAutonomousDatabaseDetails
	}{
		"AUTONOMOUS_DATABASE",
		(MarshalTypeUpdateDrProtectionGroupMemberAutonomousDatabaseDetails)(m),
	}
