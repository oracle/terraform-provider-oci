...
func (m UpdateInvokeFunctionUserDefinedStepDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateInvokeFunctionUserDefinedStepDetails UpdateInvokeFunctionUserDefinedStepDetails
	s := struct {
		DiscriminatorParam string `json:"stepType"`
		MarshalTypeUpdateInvokeFunctionUserDefinedStepDetails
	}{
		"INVOKE_FUNCTION",
		(MarshalTypeUpdateInvokeFunctionUserDefinedStepDetails)(m),
	}
