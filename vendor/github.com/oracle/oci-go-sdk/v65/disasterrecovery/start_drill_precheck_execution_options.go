...
func (m StartDrillPrecheckExecutionOptions) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeStartDrillPrecheckExecutionOptions StartDrillPrecheckExecutionOptions
	s := struct {
		DiscriminatorParam string `json:"planExecutionType"`
		MarshalTypeStartDrillPrecheckExecutionOptions
	}{
		"START_DRILL_PRECHECK",
		(MarshalTypeStartDrillPrecheckExecutionOptions)(m),
	}
