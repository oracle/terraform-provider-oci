...
func (m UpdateFqdnAddressListDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateFqdnAddressListDetails UpdateFqdnAddressListDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeUpdateFqdnAddressListDetails
	}{
		"FQDN",
		(MarshalTypeUpdateFqdnAddressListDetails)(m),
	}
