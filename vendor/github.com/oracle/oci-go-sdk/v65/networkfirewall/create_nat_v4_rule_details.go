...
func (m CreateNatV4RuleDetails) GetName() *string {
	return m.Name
}

// GetDescription returns Description
func (m CreateNatV4RuleDetails) GetDescription() *string {
	return m.Description
}

// GetPosition returns Position
func (m CreateNatV4RuleDetails) GetPosition() *RulePosition {
	return m.Position
}

func (m CreateNatV4RuleDetails) String() string {
...
func (m CreateNatV4RuleDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateNatV4RuleDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateNatV4RuleDetails CreateNatV4RuleDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCreateNatV4RuleDetails
	}{
		"NATV4",
		(MarshalTypeCreateNatV4RuleDetails)(m),
	}
