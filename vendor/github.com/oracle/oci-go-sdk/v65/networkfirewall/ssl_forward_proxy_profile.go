...
func (m SslForwardProxyProfile) GetDescription() *string {
...
func (m SslForwardProxyProfile) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeSslForwardProxyProfile SslForwardProxyProfile
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeSslForwardProxyProfile
	}{
		"SSL_FORWARD_PROXY",
		(MarshalTypeSslForwardProxyProfile)(m),
	}
