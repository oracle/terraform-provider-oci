...
func (m *updatetunnelinspectionruledetails) UnmarshalPolymorphicJSON(data []byte) (interface{}, error) {
	...
	case "VXLAN":
		...
		return mm, err
	default:
		common.Logf("Received unsupported enum value for UpdateTunnelInspectionRuleDetails: %s.", m.Protocol)
		return *m, nil
	}
}
...
func (m updatetunnelinspectionruledetails) GetDescription() *string {
