...
func (request ListHostedApplicationsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingHostedApplicationLifecycleStateEnum(string(request.LifecycleState)); !ok && request.LifecycleState != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for LifecycleState: %s. Supported values are: %s.", request.LifecycleState, strings.Join(GetHostedApplicationLifecycleStateEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListHostedApplicationsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListHostedApplicationsSortOrderEnumStringValues(), ",")))
	}
	if _, ok := GetMappingListHostedApplicationsSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortBy: %s. Supported values are: %s.", request.SortBy, strings.Join(GetListHostedApplicationsSortByEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListHostedApplicationsSortOrderEnum = map[string]ListHostedApplicationsSortOrderEnum{
	"ASC":  ListHostedApplicationsSortOrderAsc,
	"DESC": ListHostedApplicationsSortOrderDesc,
}

var mappingListHostedApplicationsSortOrderEnumLowerCase = map[string]ListHostedApplicationsSortOrderEnum{
	"asc":  ListHostedApplicationsSortOrderAsc,
	"desc": ListHostedApplicationsSortOrderDesc,
}
...
func GetListHostedApplicationsSortOrderEnumValues() []ListHostedApplicationsSortOrderEnum {
	values := make([]ListHostedApplicationsSortOrderEnum, 0)
	for _, v := range mappingListHostedApplicationsSortOrderEnum {
...
func GetMappingListHostedApplicationsSortOrderEnum(val string) (ListHostedApplicationsSortOrderEnum, bool) {
	enum, ok := mappingListHostedApplicationsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListHostedApplicationsSortByEnum = map[string]ListHostedApplicationsSortByEnum{
	"timeCreated":    ListHostedApplicationsSortByTimecreated,
	"displayName":    ListHostedApplicationsSortByDisplayname,
	"lifecycleState": ListHostedApplicationsSortByLifecyclestate,
}

var mappingListHostedApplicationsSortByEnumLowerCase = map[string]ListHostedApplicationsSortByEnum{
	"timecreated":    ListHostedApplicationsSortByTimecreated,
	"displayname":    ListHostedApplicationsSortByDisplayname,
	"lifecyclestate": ListHostedApplicationsSortByLifecyclestate,
}
...
func GetListHostedApplicationsSortByEnumValues() []ListHostedApplicationsSortByEnum {
	values := make([]ListHostedApplicationsSortByEnum, 0)
	for _, v := range mappingListHostedApplicationsSortByEnum {
		values = append(values, v)
	}
	return values
}
...
func GetMappingListHostedApplicationsSortByEnum(val string) (ListHostedApplicationsSortByEnum, bool) {
	enum, ok := mappingListHostedApplicationsSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
