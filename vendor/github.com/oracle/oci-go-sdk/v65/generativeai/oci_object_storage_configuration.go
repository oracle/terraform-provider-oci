...
func (m OciObjectStorageConfiguration) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOciObjectStorageConfiguration OciObjectStorageConfiguration
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeOciObjectStorageConfiguration
	}{
		"OBJECT_STORAGE_FILES",
		(MarshalTypeOciObjectStorageConfiguration)(m),
	}
