...
func (m ExtractionConfig) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeExtractionConfig ExtractionConfig
	s := struct {
		DiscriminatorParam string `json:"modelConfigType"`
		MarshalTypeExtractionConfig
	}{
		"EXTRACTION",
		(MarshalTypeExtractionConfig)(m),
	}
