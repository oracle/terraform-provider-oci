...
// DedicatedAiClusterHostingCapacity The capacity for hosting type dedicated AI cluster.
type DedicatedAiClusterHostingCapacity struct {

	// The total number of endpoints can be hosted on this dedicated AI cluster.
