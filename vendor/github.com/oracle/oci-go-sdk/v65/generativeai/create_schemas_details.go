...
type createschemasdetails struct {
	JsonData       []byte
	ConnectionType string `json:"connectionType"`
}

// UnmarshalJSON unmarshals json
func (m *createschemasdetails) UnmarshalJSON(data []byte) error {
	m.JsonData = data
	type Unmarshalercreateschemasdetails createschemasdetails
	s := struct {
		Model Unmarshalercreateschemasdetails
	}{}
...
func (m *createschemasdetails) UnmarshalPolymorphicJSON(data []byte) (interface{}, error) {
	...
	case "DATABASE_TOOLS_CONNECTION":
		mm := CreateSchemasDatabaseToolsConnectionDetails{}
		err = json.Unmarshal(data, &mm)
		return mm, err
	default:
		common.Logf("Received unsupported enum value for CreateSchemasDetails: %s.", m.ConnectionType)
		return *m, nil
	}
}

func (m createschemasdetails) String() string {
...
func (m createschemasdetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
var mappingCreateSchemasDetailsConnectionTypeEnum = map[string]CreateSchemasDetailsConnectionTypeEnum{
	"DATABASE_TOOLS_CONNECTION": CreateSchemasDetailsConnectionTypeDatabaseToolsConnection,
}

var mappingCreateSchemasDetailsConnectionTypeEnumLowerCase = map[string]CreateSchemasDetailsConnectionTypeEnum{
	"database_tools_connection": CreateSchemasDetailsConnectionTypeDatabaseToolsConnection,
}
...
func GetCreateSchemasDetailsConnectionTypeEnumValues() []CreateSchemasDetailsConnectionTypeEnum {
	values := make([]CreateSchemasDetailsConnectionTypeEnum, 0)
	for _, v := range mappingCreateSchemasDetailsConnectionTypeEnum {
...
func GetMappingCreateSchemasDetailsConnectionTypeEnum(val string) (CreateSchemasDetailsConnectionTypeEnum, bool) {
	enum, ok := mappingCreateSchemasDetailsConnectionTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
