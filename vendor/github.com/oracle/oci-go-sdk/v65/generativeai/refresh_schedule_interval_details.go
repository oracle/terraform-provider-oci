...
func (m RefreshScheduleIntervalDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeRefreshScheduleIntervalDetails RefreshScheduleIntervalDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeRefreshScheduleIntervalDetails
	}{
		"INTERVAL",
		(MarshalTypeRefreshScheduleIntervalDetails)(m),
	}
