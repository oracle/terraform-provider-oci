...
// CreateConversationStoreDetails The data to create a ConversationStore.
type CreateConversationStoreDetails struct {

	// Owning compartment OCID for a ConversationStore.
	CompartmentId *string `mandatory:"true" json:"compartmentId"`

	// An optional description of the ConversationStore.
...
func (m CreateConversationStoreDetails) String() string {
...
func (m CreateConversationStoreDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
