...
// CreateLangfuseInstanceDetails The data to create a Langfuse instance.
type CreateLangfuseInstanceDetails struct {
...
func (m CreateLangfuseInstanceDetails) String() string {
...
func (m CreateLangfuseInstanceDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
