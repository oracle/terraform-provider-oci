...
// UpdateHostedApplicationBaseDetails Common update properties shared by HostedApplication and HostedApplicationIam.
type UpdateHostedApplicationBaseDetails struct {
...
func (m UpdateHostedApplicationBaseDetails) String() string {
...
func (m UpdateHostedApplicationBaseDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
