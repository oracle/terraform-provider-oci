...
type Endpoint struct {
	...
	// The ID of the model that is used to create this endpoint.
	ModelId *string `mandatory:"true" json:"modelId"`

	// The compartment OCID to create the endpoint in.
	CompartmentId *string `mandatory:"true" json:"compartmentId"`

	// The ID of the dedicated AI cluster on which the model will be deployed to.
	...
	// The time the endpoint was updated in the format of an RFC3339 datetime string.
