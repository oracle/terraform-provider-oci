...
func (m DataSourceDatabaseToolsConnectionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDataSourceDatabaseToolsConnectionDetails DataSourceDatabaseToolsConnectionDetails
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeDataSourceDatabaseToolsConnectionDetails
	}{
		"DATABASE_TOOLS_CONNECTION",
		(MarshalTypeDataSourceDatabaseToolsConnectionDetails)(m),
	}
