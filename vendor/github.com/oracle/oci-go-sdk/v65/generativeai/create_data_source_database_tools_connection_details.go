...
func (m CreateDataSourceDatabaseToolsConnectionDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDataSourceDatabaseToolsConnectionDetails CreateDataSourceDatabaseToolsConnectionDetails
	s := struct {
		DiscriminatorParam string `json:"connectionType"`
		MarshalTypeCreateDataSourceDatabaseToolsConnectionDetails
	}{
		"DATABASE_TOOLS_CONNECTION",
		(MarshalTypeCreateDataSourceDatabaseToolsConnectionDetails)(m),
	}
