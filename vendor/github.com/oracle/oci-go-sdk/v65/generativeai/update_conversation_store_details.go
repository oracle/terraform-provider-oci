...
// UpdateConversationStoreDetails The data to update a ConversationStore.
type UpdateConversationStoreDetails struct {
...
func (m UpdateConversationStoreDetails) String() string {
...
func (m UpdateConversationStoreDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
