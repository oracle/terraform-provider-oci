...
// The configuration details for the additional classification model-based content moderation on top of basic moderation.
type ContentModerationConfig struct {

	// Whether the service enables additional classification model-based content moderation on top of basic moderation.
