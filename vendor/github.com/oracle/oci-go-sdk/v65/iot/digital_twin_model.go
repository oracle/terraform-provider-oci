...
// DigitalTwinModel A digital twin model, defined using Digital Twins Definition Language (https://github.com/Azure/opendigitaltwins-dtdl/blob/master/DTDL/v3/DTDL.v3.md),
