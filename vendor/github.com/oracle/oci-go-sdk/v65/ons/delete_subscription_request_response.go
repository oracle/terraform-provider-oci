...
func (request DeleteSubscriptionRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["subscriptionId"] != nil {
		templateParam := mandatoryParamMap["subscriptionId"]
		for _, template := range templateParam {
			replacementParam := *request.SubscriptionId
