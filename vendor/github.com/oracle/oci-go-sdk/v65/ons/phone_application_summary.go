...
// PhoneApplicationSummary Summary of the PhoneApplication.
type PhoneApplicationSummary struct {
...
func (m PhoneApplicationSummary) String() string {
...
func (m PhoneApplicationSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
