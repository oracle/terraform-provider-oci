...
// PhoneNumberCollection Results of a phone number search.
type PhoneNumberCollection struct {

	// List of phoneNumbers.
	Items []PhoneNumberSummary `mandatory:"true" json:"items"`
}

func (m PhoneNumberCollection) String() string {
...
func (m PhoneNumberCollection) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
