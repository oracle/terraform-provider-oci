...
// UpdatePhoneNumberDetails The information to be updated.
type UpdatePhoneNumberDetails struct {
...
func (m UpdatePhoneNumberDetails) String() string {
...
func (m UpdatePhoneNumberDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
