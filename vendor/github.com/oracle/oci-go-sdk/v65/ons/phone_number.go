...
// PhoneNumber PhoneNumber resource
type PhoneNumber struct {
	...
	// List of capabilities that this phone number can be used for. Just SMS for now.
	...
	IsoCountryCode *string `mandatory:"true" json:"isoCountryCode"`
...
func (m PhoneNumber) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
