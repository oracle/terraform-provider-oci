...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/bds/RemoveNodeReplaceConfiguration.go.html to see an example of how to use RemoveNodeReplaceConfigurationRequest.
type RemoveNodeReplaceConfigurationRequest struct {
	...
	NodeReplaceConfigurationId *string `mandatory:"true" contributesTo:"path" name:"nodeReplaceConfigurationId"`

	// Details for removing NodeReplaceConfiguration
	RemoveNodeReplaceConfigurationDetails `contributesTo:"body"`
...
type RemoveNodeReplaceConfigurationResponse struct {
