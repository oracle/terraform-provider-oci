...
type GetNodeBackupConfigurationRequest struct {
	...
	NodeBackupConfigurationId *string `mandatory:"true" contributesTo:"path" name:"nodeBackupConfigurationId"`
...
type GetNodeBackupConfigurationResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The NodeBackupConfiguration instance
	NodeBackupConfiguration `presentIn:"body"`
