...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/bds/ForceRefreshResourcePrincipal.go.html to see an example of how to use ForceRefreshResourcePrincipalRequest.
type ForceRefreshResourcePrincipalRequest struct {
	...
	ResourcePrincipalConfigurationId *string `mandatory:"true" contributesTo:"path" name:"resourcePrincipalConfigurationId"`

	// Details of refreshing resource principal session token
	ForceRefreshResourcePrincipalDetails `contributesTo:"body"`
...
type ForceRefreshResourcePrincipalResponse struct {
