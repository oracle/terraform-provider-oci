...
// RemoveNodesDetails The information about the list of nodes to be removed.
type RemoveNodesDetails struct {
...
func (m RemoveNodesDetails) String() string {
...
func (m RemoveNodesDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
