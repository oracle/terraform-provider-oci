...
// CreateBdsLakeConfigurationDetails The request body while creating a BDS lake configuration.
type CreateBdsLakeConfigurationDetails struct {

	// The OCID of the lake.
	LakeId *string `mandatory:"true" json:"lakeId"`

	// The OCID of BDS API key used for the lake integration.
...
func (m CreateBdsLakeConfigurationDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
