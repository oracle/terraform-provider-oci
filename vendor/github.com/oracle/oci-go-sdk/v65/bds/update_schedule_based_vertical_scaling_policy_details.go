...
// UpdateScheduleBasedVerticalScalingPolicyDetails Update details of a schedule based vertical autoscaling policy.
...
func (m UpdateScheduleBasedVerticalScalingPolicyDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateScheduleBasedVerticalScalingPolicyDetails UpdateScheduleBasedVerticalScalingPolicyDetails
	s := struct {
		DiscriminatorParam string `json:"policyType"`
		MarshalTypeUpdateScheduleBasedVerticalScalingPolicyDetails
	}{
		"SCHEDULE_BASED_VERTICAL_SCALING_POLICY",
		(MarshalTypeUpdateScheduleBasedVerticalScalingPolicyDetails)(m),
	}
