...
func (m AddMetricBasedVerticalScalingPolicyDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAddMetricBasedVerticalScalingPolicyDetails AddMetricBasedVerticalScalingPolicyDetails
	s := struct {
		DiscriminatorParam string `json:"policyType"`
		MarshalTypeAddMetricBasedVerticalScalingPolicyDetails
	}{
		"METRIC_BASED_VERTICAL_SCALING_POLICY",
		(MarshalTypeAddMetricBasedVerticalScalingPolicyDetails)(m),
	}
