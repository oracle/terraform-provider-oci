...
// BdsCapacityReservationSummary Summary of a BDS capacity reservation.
type BdsCapacityReservationSummary struct {
	...
	LifecycleState BdsCapacityReservationLifecycleStateEnum `mandatory:"true" json:"lifecycleState"`
...
func (m BdsCapacityReservationSummary) String() string {
...
func (m BdsCapacityReservationSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
