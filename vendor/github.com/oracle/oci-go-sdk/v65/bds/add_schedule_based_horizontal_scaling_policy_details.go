...
// AddScheduleBasedHorizontalScalingPolicyDetails Details of a schedule based horizontal autoscaling policy.
...
func (m AddScheduleBasedHorizontalScalingPolicyDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeAddScheduleBasedHorizontalScalingPolicyDetails AddScheduleBasedHorizontalScalingPolicyDetails
	s := struct {
		DiscriminatorParam string `json:"policyType"`
		MarshalTypeAddScheduleBasedHorizontalScalingPolicyDetails
	}{
		"SCHEDULE_BASED_HORIZONTAL_SCALING_POLICY",
		(MarshalTypeAddScheduleBasedHorizontalScalingPolicyDetails)(m),
	}
