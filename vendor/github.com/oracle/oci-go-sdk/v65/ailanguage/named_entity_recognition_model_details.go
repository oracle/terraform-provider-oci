...
func (m NamedEntityRecognitionModelDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeNamedEntityRecognitionModelDetails NamedEntityRecognitionModelDetails
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeNamedEntityRecognitionModelDetails
	}{
		"NAMED_ENTITY_RECOGNITION",
		(MarshalTypeNamedEntityRecognitionModelDetails)(m),
	}
