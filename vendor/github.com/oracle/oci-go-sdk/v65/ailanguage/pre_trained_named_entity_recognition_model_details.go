...
func (m PreTrainedNamedEntityRecognitionModelDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePreTrainedNamedEntityRecognitionModelDetails PreTrainedNamedEntityRecognitionModelDetails
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypePreTrainedNamedEntityRecognitionModelDetails
	}{
		"PRE_TRAINED_NAMED_ENTITY_RECOGNITION",
		(MarshalTypePreTrainedNamedEntityRecognitionModelDetails)(m),
	}
