...
func (m PreTrainedTranslationModelDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePreTrainedTranslationModelDetails PreTrainedTranslationModelDetails
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypePreTrainedTranslationModelDetails
	}{
		"PRE_TRAINED_TRANSLATION",
		(MarshalTypePreTrainedTranslationModelDetails)(m),
	}
