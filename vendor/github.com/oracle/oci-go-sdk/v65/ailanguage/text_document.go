...
type TextDocument struct {
	...
	// Language code of the document. Please refer to respective model API documentation (https://docs.oracle.com/iaas/iaas/language/using/overview.htm) for supported languages.
