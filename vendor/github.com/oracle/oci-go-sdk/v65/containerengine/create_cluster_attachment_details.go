...
// CreateClusterAttachmentDetails The information about a new ClusterAttachment.
type CreateClusterAttachmentDetails struct {
...
func (m CreateClusterAttachmentDetails) String() string {
...
func (m CreateClusterAttachmentDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
