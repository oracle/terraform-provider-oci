...
// ClusterAttachmentSummary Summary of the ClusterAttachment.
type ClusterAttachmentSummary struct {

	// Unique identifier that is immutable on creation
	Id *string `mandatory:"true" json:"id"`

	// ClusterAttachment Identifier, can be renamed
...
func (m ClusterAttachmentSummary) String() string {
...
func (m ClusterAttachmentSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
