...
func (request GetNodePoolOptionsRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["nodePoolOptionId"] != nil {
		templateParam := mandatoryParamMap["nodePoolOptionId"]
		for _, template := range templateParam {
			replacementParam := *request.NodePoolOptionId
