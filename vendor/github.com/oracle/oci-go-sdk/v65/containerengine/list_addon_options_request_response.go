...
func (request ListAddonOptionsRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["kubernetesVersion"] != nil {
		templateParam := mandatoryParamMap["kubernetesVersion"]
		for _, template := range templateParam {
			replacementParam := *request.KubernetesVersion
