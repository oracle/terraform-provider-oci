...
func (request GetClusterOptionsRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["clusterOptionId"] != nil {
		templateParam := mandatoryParamMap["clusterOptionId"]
		for _, template := range templateParam {
			replacementParam := *request.ClusterOptionId
