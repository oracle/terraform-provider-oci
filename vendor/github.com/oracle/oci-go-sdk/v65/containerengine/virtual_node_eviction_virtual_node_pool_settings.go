...
// VirtualNodeEvictionVirtualNodePoolSettings Virtual Node Eviction Details configuration
type VirtualNodeEvictionVirtualNodePoolSettings struct {
...
func (m VirtualNodeEvictionVirtualNodePoolSettings) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
