...
// ClusterNamespaceProfileSummary Summary of the ClusterNamespaceProfile.
type ClusterNamespaceProfileSummary struct {

	// Unique identifier that is immutable on creation
	Id *string `mandatory:"true" json:"id"`

	// ClusterNamespaceProfile Identifier, can be renamed
...
func (m ClusterNamespaceProfileSummary) String() string {
...
func (m ClusterNamespaceProfileSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
