...
// GovernancePolicyConfig The properties that define policy governance is enabled.
...
func (m GovernancePolicyConfig) String() string {
...
func (m GovernancePolicyConfig) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
