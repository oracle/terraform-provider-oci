...
// ClusterNamespaceSummary Summary of the ClusterNamespace.
type ClusterNamespaceSummary struct {

	// Unique identifier that is immutable on creation
	Id *string `mandatory:"true" json:"id"`

	// ClusterNamespace Identifier, can be renamed
...
func (m ClusterNamespaceSummary) String() string {
...
func (m ClusterNamespaceSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
