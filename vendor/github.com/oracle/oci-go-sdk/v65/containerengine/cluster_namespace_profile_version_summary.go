...
// ClusterNamespaceProfileVersionSummary Summary of the ClusterNamespaceProfile.
type ClusterNamespaceProfileVersionSummary struct {
	...
	// The current state of the ClusterNamespaceProfileVersion.
...
func (m ClusterNamespaceProfileVersionSummary) String() string {
...
func (m ClusterNamespaceProfileVersionSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
