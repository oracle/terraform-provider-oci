...
// CreateAppResourceRequest wrapper for the CreateAppResource operation
type CreateAppResourceRequest struct {
	...
	AppResource `contributesTo:"body"`
...
func (request CreateAppResourceRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request CreateAppResourceRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request CreateAppResourceRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request CreateAppResourceRequest) RetryPolicy() *common.RetryPolicy {
...
func (request CreateAppResourceRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
// CreateAppResourceResponse wrapper for the CreateAppResource operation
type CreateAppResourceResponse struct {
...
func (response CreateAppResourceResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response CreateAppResourceResponse) HTTPResponse() *http.Response {
