...
func (m MappedAttributeSearchRequest) String() string {
...
func (m MappedAttributeSearchRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
