...
// PatchConditionGroupRequest wrapper for the PatchConditionGroup operation
type PatchConditionGroupRequest struct {
	...
	// Update the ConditionGroup with SCIM Patch schema.
...
func (request PatchConditionGroupRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request PatchConditionGroupRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request PatchConditionGroupRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request PatchConditionGroupRequest) RetryPolicy() *common.RetryPolicy {
...
func (request PatchConditionGroupRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
// PatchConditionGroupResponse wrapper for the PatchConditionGroup operation
type PatchConditionGroupResponse struct {
...
func (response PatchConditionGroupResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response PatchConditionGroupResponse) HTTPResponse() *http.Response {
