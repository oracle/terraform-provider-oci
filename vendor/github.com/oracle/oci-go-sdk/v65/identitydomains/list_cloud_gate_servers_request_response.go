...
func (request ListCloudGateServersRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListCloudGateServersSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListCloudGateServersSortOrderEnumStringValues(), ",")))
	}
...
var mappingListCloudGateServersSortOrderEnum = map[string]ListCloudGateServersSortOrderEnum{
	"ASCENDING":  ListCloudGateServersSortOrderAscending,
	"DESCENDING": ListCloudGateServersSortOrderDescending,
}

var mappingListCloudGateServersSortOrderEnumLowerCase = map[string]ListCloudGateServersSortOrderEnum{
	"ascending":  ListCloudGateServersSortOrderAscending,
	"descending": ListCloudGateServersSortOrderDescending,
}
...
func GetListCloudGateServersSortOrderEnumValues() []ListCloudGateServersSortOrderEnum {
	values := make([]ListCloudGateServersSortOrderEnum, 0)
	for _, v := range mappingListCloudGateServersSortOrderEnum {
...
func GetMappingListCloudGateServersSortOrderEnum(val string) (ListCloudGateServersSortOrderEnum, bool) {
	enum, ok := mappingListCloudGateServersSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
