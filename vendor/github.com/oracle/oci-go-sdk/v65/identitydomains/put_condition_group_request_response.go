...
// PutConditionGroupRequest wrapper for the PutConditionGroup operation
type PutConditionGroupRequest struct {
	...
	// Replace the current instance of ConditionGroup with provided payload.
	...
	ConditionGroup `contributesTo:"body"`
...
func (request PutConditionGroupRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request PutConditionGroupRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request PutConditionGroupRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request PutConditionGroupRequest) RetryPolicy() *common.RetryPolicy {
...
func (request PutConditionGroupRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
// PutConditionGroupResponse wrapper for the PutConditionGroup operation
type PutConditionGroupResponse struct {
...
func (response PutConditionGroupResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response PutConditionGroupResponse) HTTPResponse() *http.Response {
