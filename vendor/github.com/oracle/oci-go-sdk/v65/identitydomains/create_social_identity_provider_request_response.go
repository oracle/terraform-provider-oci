...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/identitydomains/CreateSocialIdentityProvider.go.html to see an example of how to use CreateSocialIdentityProviderRequest.
type CreateSocialIdentityProviderRequest struct {
	...
	SocialIdentityProvider `contributesTo:"body"`
...
type CreateSocialIdentityProviderResponse struct {
