...
// ConditionGroups The SCIM protocol defines a standard set of query parameters that can be used to filter, sort, and paginate to return zero or more resources in a query response. Queries MAY be made against a single resource or a resource type endpoint (e.g., /Users), or the service provider Base URI.
type ConditionGroups struct {
	...
	Resources []ConditionGroup `mandatory:"true" json:"Resources"`
...
func (m ConditionGroups) String() string {
...
func (m ConditionGroups) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
