...
// Session Manage SSO Sessions created for a user. This REST API is SCIM compliant.
type Session struct {
	...
	User *SessionUser `mandatory:"true" json:"user"`
	...
	//  - type: string
	//  - uniqueness: none
	IdcsLockedOperations []SessionIdcsLockedOperationsEnum `mandatory:"false" json:"idcsLockedOperations,omitempty"`

	IdcsLockedBy *SessionIdcsLockedBy `mandatory:"false" json:"idcsLockedBy"`
	...
	//  - type: complex
	//  - uniqueness: none
	Apps []SessionApps `mandatory:"false" json:"apps"`
	...
	Idp *SessionIdp `mandatory:"false" json:"idp"`
...
func (m Session) ValidateEnumValue() (bool, error) {
	...
	for _, val := range m.IdcsLockedOperations {
		if _, ok := GetMappingSessionIdcsLockedOperationsEnum(string(val)); !ok && val != "" {
			errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for IdcsLockedOperations: %s. Supported values are: %s.", val, strings.Join(GetSessionIdcsLockedOperationsEnumStringValues(), ",")))
		}
	}
...
// SessionIdcsLockedOperationsEnum Enum with underlying type: string
type SessionIdcsLockedOperationsEnum string

// Set of constants representing the allowable values for SessionIdcsLockedOperationsEnum
const (
	SessionIdcsLockedOperationsReplace SessionIdcsLockedOperationsEnum = "replace"
	SessionIdcsLockedOperationsUpdate  SessionIdcsLockedOperationsEnum = "update"
	SessionIdcsLockedOperationsDelete  SessionIdcsLockedOperationsEnum = "delete"
)

var mappingSessionIdcsLockedOperationsEnum = map[string]SessionIdcsLockedOperationsEnum{
	"replace": SessionIdcsLockedOperationsReplace,
	"update":  SessionIdcsLockedOperationsUpdate,
	"delete":  SessionIdcsLockedOperationsDelete,
}

var mappingSessionIdcsLockedOperationsEnumLowerCase = map[string]SessionIdcsLockedOperationsEnum{
	"replace": SessionIdcsLockedOperationsReplace,
	"update":  SessionIdcsLockedOperationsUpdate,
	"delete":  SessionIdcsLockedOperationsDelete,
}

// GetSessionIdcsLockedOperationsEnumValues Enumerates the set of values for SessionIdcsLockedOperationsEnum
func GetSessionIdcsLockedOperationsEnumValues() []SessionIdcsLockedOperationsEnum {
	values := make([]SessionIdcsLockedOperationsEnum, 0)
	for _, v := range mappingSessionIdcsLockedOperationsEnum {
		values = append(values, v)
	}
	return values
}

// GetSessionIdcsLockedOperationsEnumStringValues Enumerates the set of values in String for SessionIdcsLockedOperationsEnum
func GetSessionIdcsLockedOperationsEnumStringValues() []string {
	return []string{
		"replace",
		"update",
		"delete",
...
// GetMappingSessionIdcsLockedOperationsEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingSessionIdcsLockedOperationsEnum(val string) (SessionIdcsLockedOperationsEnum, bool) {
	enum, ok := mappingSessionIdcsLockedOperationsEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
