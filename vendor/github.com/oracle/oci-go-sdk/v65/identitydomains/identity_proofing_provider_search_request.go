...
func (m IdentityProofingProviderSearchRequest) String() string {
...
func (m IdentityProofingProviderSearchRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
