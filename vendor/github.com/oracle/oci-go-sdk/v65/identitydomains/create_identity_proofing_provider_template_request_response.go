...
// CreateIdentityProofingProviderTemplateRequest wrapper for the CreateIdentityProofingProviderTemplate operation
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/identitydomains/CreateIdentityProofingProviderTemplate.go.html to see an example of how to use CreateIdentityProofingProviderTemplateRequest.
type CreateIdentityProofingProviderTemplateRequest struct {
	...
	IdentityProofingProviderTemplate `contributesTo:"body"`
...
func (request CreateIdentityProofingProviderTemplateRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request CreateIdentityProofingProviderTemplateRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request CreateIdentityProofingProviderTemplateRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request CreateIdentityProofingProviderTemplateRequest) RetryPolicy() *common.RetryPolicy {
...
func (request CreateIdentityProofingProviderTemplateRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
// CreateIdentityProofingProviderTemplateResponse wrapper for the CreateIdentityProofingProviderTemplate operation
type CreateIdentityProofingProviderTemplateResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The IdentityProofingProviderTemplate instance
	IdentityProofingProviderTemplate `presentIn:"body"`
...
func (response CreateIdentityProofingProviderTemplateResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response CreateIdentityProofingProviderTemplateResponse) HTTPResponse() *http.Response {
