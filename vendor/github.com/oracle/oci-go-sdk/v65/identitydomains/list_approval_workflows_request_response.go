...
func (request ListApprovalWorkflowsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListApprovalWorkflowsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListApprovalWorkflowsSortOrderEnumStringValues(), ",")))
	}
...
var mappingListApprovalWorkflowsSortOrderEnum = map[string]ListApprovalWorkflowsSortOrderEnum{
	"ASCENDING":  ListApprovalWorkflowsSortOrderAscending,
	"DESCENDING": ListApprovalWorkflowsSortOrderDescending,
}

var mappingListApprovalWorkflowsSortOrderEnumLowerCase = map[string]ListApprovalWorkflowsSortOrderEnum{
	"ascending":  ListApprovalWorkflowsSortOrderAscending,
	"descending": ListApprovalWorkflowsSortOrderDescending,
}
...
func GetListApprovalWorkflowsSortOrderEnumValues() []ListApprovalWorkflowsSortOrderEnum {
	values := make([]ListApprovalWorkflowsSortOrderEnum, 0)
	for _, v := range mappingListApprovalWorkflowsSortOrderEnum {
...
func GetMappingListApprovalWorkflowsSortOrderEnum(val string) (ListApprovalWorkflowsSortOrderEnum, bool) {
	enum, ok := mappingListApprovalWorkflowsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
