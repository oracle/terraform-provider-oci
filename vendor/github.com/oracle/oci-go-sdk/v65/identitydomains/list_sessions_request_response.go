...
type ListSessionsResponse struct {
	...
	// A list of Sessions instances
	Sessions `presentIn:"body"`
...
const (
	ListSessionsSortOrderAscending  ListSessionsSortOrderEnum = "ASCENDING"
	ListSessionsSortOrderDescending ListSessionsSortOrderEnum = "DESCENDING"
)

var mappingListSessionsSortOrderEnum = map[string]ListSessionsSortOrderEnum{
	"ASCENDING":  ListSessionsSortOrderAscending,
	"DESCENDING": ListSessionsSortOrderDescending,
}
