...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/identitydomains/GetSocialIdentityProvider.go.html to see an example of how to use GetSocialIdentityProviderRequest.
