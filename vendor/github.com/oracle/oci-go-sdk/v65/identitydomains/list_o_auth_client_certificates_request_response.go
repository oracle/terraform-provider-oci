...
func (request ListOAuthClientCertificatesRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListOAuthClientCertificatesSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListOAuthClientCertificatesSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListOAuthClientCertificatesSortOrderEnum = map[string]ListOAuthClientCertificatesSortOrderEnum{
	"ASCENDING":  ListOAuthClientCertificatesSortOrderAscending,
	"DESCENDING": ListOAuthClientCertificatesSortOrderDescending,
}

var mappingListOAuthClientCertificatesSortOrderEnumLowerCase = map[string]ListOAuthClientCertificatesSortOrderEnum{
	"ascending":  ListOAuthClientCertificatesSortOrderAscending,
	"descending": ListOAuthClientCertificatesSortOrderDescending,
}
...
func GetListOAuthClientCertificatesSortOrderEnumValues() []ListOAuthClientCertificatesSortOrderEnum {
	values := make([]ListOAuthClientCertificatesSortOrderEnum, 0)
	for _, v := range mappingListOAuthClientCertificatesSortOrderEnum {
...
func GetMappingListOAuthClientCertificatesSortOrderEnum(val string) (ListOAuthClientCertificatesSortOrderEnum, bool) {
	enum, ok := mappingListOAuthClientCertificatesSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
