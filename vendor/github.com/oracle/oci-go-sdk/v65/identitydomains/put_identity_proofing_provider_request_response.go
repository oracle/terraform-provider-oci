...
// PutIdentityProofingProviderRequest wrapper for the PutIdentityProofingProvider operation
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/identitydomains/PutIdentityProofingProvider.go.html to see an example of how to use PutIdentityProofingProviderRequest.
type PutIdentityProofingProviderRequest struct {

	// ID of the resource.
	IdentityProofingProviderId *string `mandatory:"true" contributesTo:"path" name:"identityProofingProviderId"`
	...
	IdentityProofingProvider `contributesTo:"body"`
...
func (request PutIdentityProofingProviderRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request PutIdentityProofingProviderRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request PutIdentityProofingProviderRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request PutIdentityProofingProviderRequest) RetryPolicy() *common.RetryPolicy {
...
func (request PutIdentityProofingProviderRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
// PutIdentityProofingProviderResponse wrapper for the PutIdentityProofingProvider operation
type PutIdentityProofingProviderResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The IdentityProofingProvider instance
	IdentityProofingProvider `presentIn:"body"`
...
func (response PutIdentityProofingProviderResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response PutIdentityProofingProviderResponse) HTTPResponse() *http.Response {
