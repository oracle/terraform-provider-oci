...
// CreateVerificationClaimRequest wrapper for the CreateVerificationClaim operation
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/identitydomains/CreateVerificationClaim.go.html to see an example of how to use CreateVerificationClaimRequest.
type CreateVerificationClaimRequest struct {
	...
	VerificationClaim `contributesTo:"body"`
...
func (request CreateVerificationClaimRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request CreateVerificationClaimRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request CreateVerificationClaimRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request CreateVerificationClaimRequest) RetryPolicy() *common.RetryPolicy {
...
func (request CreateVerificationClaimRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
...
// CreateVerificationClaimResponse wrapper for the CreateVerificationClaim operation
type CreateVerificationClaimResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The VerificationClaim instance
	VerificationClaim `presentIn:"body"`
...
func (response CreateVerificationClaimResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response CreateVerificationClaimResponse) HTTPResponse() *http.Response {
