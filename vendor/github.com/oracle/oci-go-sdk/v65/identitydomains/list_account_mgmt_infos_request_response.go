...
func (request ListAccountMgmtInfosRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListAccountMgmtInfosSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListAccountMgmtInfosSortOrderEnumStringValues(), ",")))
	}
...
var mappingListAccountMgmtInfosSortOrderEnum = map[string]ListAccountMgmtInfosSortOrderEnum{
	"ASCENDING":  ListAccountMgmtInfosSortOrderAscending,
	"DESCENDING": ListAccountMgmtInfosSortOrderDescending,
}

var mappingListAccountMgmtInfosSortOrderEnumLowerCase = map[string]ListAccountMgmtInfosSortOrderEnum{
	"ascending":  ListAccountMgmtInfosSortOrderAscending,
	"descending": ListAccountMgmtInfosSortOrderDescending,
}
...
func GetListAccountMgmtInfosSortOrderEnumValues() []ListAccountMgmtInfosSortOrderEnum {
	values := make([]ListAccountMgmtInfosSortOrderEnum, 0)
	for _, v := range mappingListAccountMgmtInfosSortOrderEnum {
...
func GetMappingListAccountMgmtInfosSortOrderEnum(val string) (ListAccountMgmtInfosSortOrderEnum, bool) {
	enum, ok := mappingListAccountMgmtInfosSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
