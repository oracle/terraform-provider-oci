...
func (request ListMyDevicesRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListMyDevicesSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListMyDevicesSortOrderEnumStringValues(), ",")))
	}
...
var mappingListMyDevicesSortOrderEnum = map[string]ListMyDevicesSortOrderEnum{
	"ASCENDING":  ListMyDevicesSortOrderAscending,
	"DESCENDING": ListMyDevicesSortOrderDescending,
}

var mappingListMyDevicesSortOrderEnumLowerCase = map[string]ListMyDevicesSortOrderEnum{
	"ascending":  ListMyDevicesSortOrderAscending,
	"descending": ListMyDevicesSortOrderDescending,
}
...
func GetListMyDevicesSortOrderEnumValues() []ListMyDevicesSortOrderEnum {
	values := make([]ListMyDevicesSortOrderEnum, 0)
	for _, v := range mappingListMyDevicesSortOrderEnum {
...
func GetMappingListMyDevicesSortOrderEnum(val string) (ListMyDevicesSortOrderEnum, bool) {
	enum, ok := mappingListMyDevicesSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
