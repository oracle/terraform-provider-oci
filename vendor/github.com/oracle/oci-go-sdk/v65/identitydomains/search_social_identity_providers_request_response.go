...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/identitydomains/SearchSocialIdentityProviders.go.html to see an example of how to use SearchSocialIdentityProvidersRequest.
