...
func (request ListApiKeysRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListApiKeysSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListApiKeysSortOrderEnumStringValues(), ",")))
	}
...
var mappingListApiKeysSortOrderEnum = map[string]ListApiKeysSortOrderEnum{
	"ASCENDING":  ListApiKeysSortOrderAscending,
	"DESCENDING": ListApiKeysSortOrderDescending,
}

var mappingListApiKeysSortOrderEnumLowerCase = map[string]ListApiKeysSortOrderEnum{
	"ascending":  ListApiKeysSortOrderAscending,
	"descending": ListApiKeysSortOrderDescending,
}
...
func GetListApiKeysSortOrderEnumValues() []ListApiKeysSortOrderEnum {
	values := make([]ListApiKeysSortOrderEnum, 0)
	for _, v := range mappingListApiKeysSortOrderEnum {
...
func GetMappingListApiKeysSortOrderEnum(val string) (ListApiKeysSortOrderEnum, bool) {
	enum, ok := mappingListApiKeysSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
