...
type IdentityProofingProviders struct {
	...
	Resources []IdentityProofingProvider `mandatory:"true" json:"Resources"`
...
func (m IdentityProofingProviders) String() string {
...
func (m IdentityProofingProviders) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
