...
func (request ListAppsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListAppsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListAppsSortOrderEnumStringValues(), ",")))
	}
...
var mappingListAppsSortOrderEnum = map[string]ListAppsSortOrderEnum{
	"ASCENDING":  ListAppsSortOrderAscending,
	"DESCENDING": ListAppsSortOrderDescending,
}

var mappingListAppsSortOrderEnumLowerCase = map[string]ListAppsSortOrderEnum{
	"ascending":  ListAppsSortOrderAscending,
	"descending": ListAppsSortOrderDescending,
}
...
func GetListAppsSortOrderEnumValues() []ListAppsSortOrderEnum {
	values := make([]ListAppsSortOrderEnum, 0)
	for _, v := range mappingListAppsSortOrderEnum {
...
func GetMappingListAppsSortOrderEnum(val string) (ListAppsSortOrderEnum, bool) {
	enum, ok := mappingListAppsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
