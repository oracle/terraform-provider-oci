...
func (request ListMyGroupsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListMyGroupsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListMyGroupsSortOrderEnumStringValues(), ",")))
	}
...
var mappingListMyGroupsSortOrderEnum = map[string]ListMyGroupsSortOrderEnum{
	"ASCENDING":  ListMyGroupsSortOrderAscending,
	"DESCENDING": ListMyGroupsSortOrderDescending,
}

var mappingListMyGroupsSortOrderEnumLowerCase = map[string]ListMyGroupsSortOrderEnum{
	"ascending":  ListMyGroupsSortOrderAscending,
	"descending": ListMyGroupsSortOrderDescending,
}
...
func GetListMyGroupsSortOrderEnumValues() []ListMyGroupsSortOrderEnum {
	values := make([]ListMyGroupsSortOrderEnum, 0)
	for _, v := range mappingListMyGroupsSortOrderEnum {
...
func GetMappingListMyGroupsSortOrderEnum(val string) (ListMyGroupsSortOrderEnum, bool) {
	enum, ok := mappingListMyGroupsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
