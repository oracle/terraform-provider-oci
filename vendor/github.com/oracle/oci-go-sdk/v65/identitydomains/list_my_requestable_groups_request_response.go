...
func (request ListMyRequestableGroupsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListMyRequestableGroupsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListMyRequestableGroupsSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListMyRequestableGroupsSortOrderEnum = map[string]ListMyRequestableGroupsSortOrderEnum{
	"ASCENDING":  ListMyRequestableGroupsSortOrderAscending,
	"DESCENDING": ListMyRequestableGroupsSortOrderDescending,
}

var mappingListMyRequestableGroupsSortOrderEnumLowerCase = map[string]ListMyRequestableGroupsSortOrderEnum{
	"ascending":  ListMyRequestableGroupsSortOrderAscending,
	"descending": ListMyRequestableGroupsSortOrderDescending,
}
...
func GetListMyRequestableGroupsSortOrderEnumValues() []ListMyRequestableGroupsSortOrderEnum {
	values := make([]ListMyRequestableGroupsSortOrderEnum, 0)
	for _, v := range mappingListMyRequestableGroupsSortOrderEnum {
...
func GetMappingListMyRequestableGroupsSortOrderEnum(val string) (ListMyRequestableGroupsSortOrderEnum, bool) {
	enum, ok := mappingListMyRequestableGroupsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
