...
func (m ConditionGroupSearchRequest) String() string {
...
func (m ConditionGroupSearchRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
