...
// CreateConditionGroupRequest wrapper for the CreateConditionGroup operation
type CreateConditionGroupRequest struct {
...
func (request CreateConditionGroupRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request CreateConditionGroupRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request CreateConditionGroupRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request CreateConditionGroupRequest) RetryPolicy() *common.RetryPolicy {
...
func (request CreateConditionGroupRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
// CreateConditionGroupResponse wrapper for the CreateConditionGroup operation
type CreateConditionGroupResponse struct {
...
func (response CreateConditionGroupResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response CreateConditionGroupResponse) HTTPResponse() *http.Response {
