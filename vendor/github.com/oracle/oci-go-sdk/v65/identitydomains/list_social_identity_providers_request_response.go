...
// # See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/identitydomains/ListSocialIdentityProviders.go.html to see an example of how to use ListSocialIdentityProvidersRequest.
type ListSocialIdentityProvidersRequest struct {
	...
	SortOrder ListSocialIdentityProvidersSortOrderEnum `mandatory:"false" contributesTo:"query" name:"sortOrder" omitEmpty:"true"`
...
func (request ListSocialIdentityProvidersRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListSocialIdentityProvidersSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListSocialIdentityProvidersSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
type ListSocialIdentityProvidersResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// A list of SocialIdentityProviders instances
	SocialIdentityProviders `presentIn:"body"`
...
const (
	ListSocialIdentityProvidersSortOrderAscending  ListSocialIdentityProvidersSortOrderEnum = "ASCENDING"
	ListSocialIdentityProvidersSortOrderDescending ListSocialIdentityProvidersSortOrderEnum = "DESCENDING"
)

var mappingListSocialIdentityProvidersSortOrderEnum = map[string]ListSocialIdentityProvidersSortOrderEnum{
	"ASCENDING":  ListSocialIdentityProvidersSortOrderAscending,
	"DESCENDING": ListSocialIdentityProvidersSortOrderDescending,
}

var mappingListSocialIdentityProvidersSortOrderEnumLowerCase = map[string]ListSocialIdentityProvidersSortOrderEnum{
	"ascending":  ListSocialIdentityProvidersSortOrderAscending,
	"descending": ListSocialIdentityProvidersSortOrderDescending,
}
...
func GetListSocialIdentityProvidersSortOrderEnumValues() []ListSocialIdentityProvidersSortOrderEnum {
	values := make([]ListSocialIdentityProvidersSortOrderEnum, 0)
	for _, v := range mappingListSocialIdentityProvidersSortOrderEnum {
...
func GetMappingListSocialIdentityProvidersSortOrderEnum(val string) (ListSocialIdentityProvidersSortOrderEnum, bool) {
	enum, ok := mappingListSocialIdentityProvidersSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
