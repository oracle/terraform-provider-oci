...
func (request ListSecurityQuestionsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListSecurityQuestionsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListSecurityQuestionsSortOrderEnumStringValues(), ",")))
	}
...
var mappingListSecurityQuestionsSortOrderEnum = map[string]ListSecurityQuestionsSortOrderEnum{
	"ASCENDING":  ListSecurityQuestionsSortOrderAscending,
	"DESCENDING": ListSecurityQuestionsSortOrderDescending,
}

var mappingListSecurityQuestionsSortOrderEnumLowerCase = map[string]ListSecurityQuestionsSortOrderEnum{
	"ascending":  ListSecurityQuestionsSortOrderAscending,
	"descending": ListSecurityQuestionsSortOrderDescending,
}
...
func GetListSecurityQuestionsSortOrderEnumValues() []ListSecurityQuestionsSortOrderEnum {
	values := make([]ListSecurityQuestionsSortOrderEnum, 0)
	for _, v := range mappingListSecurityQuestionsSortOrderEnum {
...
func GetMappingListSecurityQuestionsSortOrderEnum(val string) (ListSecurityQuestionsSortOrderEnum, bool) {
	enum, ok := mappingListSecurityQuestionsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
