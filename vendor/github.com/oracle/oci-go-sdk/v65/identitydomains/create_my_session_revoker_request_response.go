...
// CreateMySessionRevokerRequest wrapper for the CreateMySessionRevoker operation
type CreateMySessionRevokerRequest struct {
	...
	MySessionRevoker `contributesTo:"body"`
...
func (request CreateMySessionRevokerRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request CreateMySessionRevokerRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request CreateMySessionRevokerRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request CreateMySessionRevokerRequest) RetryPolicy() *common.RetryPolicy {
...
func (request CreateMySessionRevokerRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
...
// CreateMySessionRevokerResponse wrapper for the CreateMySessionRevoker operation
type CreateMySessionRevokerResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The MySessionRevoker instance
	MySessionRevoker `presentIn:"body"`
...
func (response CreateMySessionRevokerResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response CreateMySessionRevokerResponse) HTTPResponse() *http.Response {
