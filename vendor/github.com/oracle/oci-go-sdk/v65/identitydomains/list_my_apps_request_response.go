...
func (request ListMyAppsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListMyAppsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListMyAppsSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListMyAppsSortOrderEnum = map[string]ListMyAppsSortOrderEnum{
	"ASCENDING":  ListMyAppsSortOrderAscending,
	"DESCENDING": ListMyAppsSortOrderDescending,
}

var mappingListMyAppsSortOrderEnumLowerCase = map[string]ListMyAppsSortOrderEnum{
	"ascending":  ListMyAppsSortOrderAscending,
	"descending": ListMyAppsSortOrderDescending,
}
...
func GetListMyAppsSortOrderEnumValues() []ListMyAppsSortOrderEnum {
	values := make([]ListMyAppsSortOrderEnum, 0)
	for _, v := range mappingListMyAppsSortOrderEnum {
...
func GetMappingListMyAppsSortOrderEnum(val string) (ListMyAppsSortOrderEnum, bool) {
	enum, ok := mappingListMyAppsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
