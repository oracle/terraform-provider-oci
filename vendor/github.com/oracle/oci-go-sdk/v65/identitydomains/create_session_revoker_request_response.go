...
// CreateSessionRevokerRequest wrapper for the CreateSessionRevoker operation
type CreateSessionRevokerRequest struct {
	...
	SessionRevoker `contributesTo:"body"`
...
func (request CreateSessionRevokerRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request CreateSessionRevokerRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request CreateSessionRevokerRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request CreateSessionRevokerRequest) RetryPolicy() *common.RetryPolicy {
...
func (request CreateSessionRevokerRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
...
// CreateSessionRevokerResponse wrapper for the CreateSessionRevoker operation
type CreateSessionRevokerResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The SessionRevoker instance
	SessionRevoker `presentIn:"body"`
...
func (response CreateSessionRevokerResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response CreateSessionRevokerResponse) HTTPResponse() *http.Response {
