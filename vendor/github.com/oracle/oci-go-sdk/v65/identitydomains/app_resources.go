...
// AppResources The SCIM protocol defines a standard set of query parameters that can be used to filter, sort, and paginate to return zero or more resources in a query response. Queries MAY be made against a single resource or a resource type endpoint (e.g., /Users), or the service provider Base URI.
type AppResources struct {
	...
	Resources []AppResource `mandatory:"true" json:"Resources"`
...
func (m AppResources) String() string {
...
func (m AppResources) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
