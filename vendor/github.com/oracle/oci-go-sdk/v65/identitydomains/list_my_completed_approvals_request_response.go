...
func (request ListMyCompletedApprovalsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListMyCompletedApprovalsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for SortOrder: %s. Supported values are: %s.", request.SortOrder, strings.Join(GetListMyCompletedApprovalsSortOrderEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingListMyCompletedApprovalsSortOrderEnum = map[string]ListMyCompletedApprovalsSortOrderEnum{
	"ASCENDING":  ListMyCompletedApprovalsSortOrderAscending,
	"DESCENDING": ListMyCompletedApprovalsSortOrderDescending,
}

var mappingListMyCompletedApprovalsSortOrderEnumLowerCase = map[string]ListMyCompletedApprovalsSortOrderEnum{
	"ascending":  ListMyCompletedApprovalsSortOrderAscending,
	"descending": ListMyCompletedApprovalsSortOrderDescending,
}
...
func GetListMyCompletedApprovalsSortOrderEnumValues() []ListMyCompletedApprovalsSortOrderEnum {
	values := make([]ListMyCompletedApprovalsSortOrderEnum, 0)
	for _, v := range mappingListMyCompletedApprovalsSortOrderEnum {
...
func GetMappingListMyCompletedApprovalsSortOrderEnum(val string) (ListMyCompletedApprovalsSortOrderEnum, bool) {
	enum, ok := mappingListMyCompletedApprovalsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
