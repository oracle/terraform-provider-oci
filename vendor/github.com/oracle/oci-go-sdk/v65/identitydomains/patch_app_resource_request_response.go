...
// PatchAppResourceRequest wrapper for the PatchAppResource operation
type PatchAppResourceRequest struct {
	...
	// Update the AppResource with SCIM Patch schema.
...
func (request PatchAppResourceRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request PatchAppResourceRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request PatchAppResourceRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request PatchAppResourceRequest) RetryPolicy() *common.RetryPolicy {
...
func (request PatchAppResourceRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
// PatchAppResourceResponse wrapper for the PatchAppResource operation
type PatchAppResourceResponse struct {

	// The underlying http response
	RawResponse *http.Response

	// The AppResource instance
	AppResource `presentIn:"body"`
...
func (response PatchAppResourceResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response PatchAppResourceResponse) HTTPResponse() *http.Response {
