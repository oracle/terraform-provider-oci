...
// CccFlexNetworkAttachmentSummary Summary information about a Compute Cloud@Customer flexNetworkAttachment.
type CccFlexNetworkAttachmentSummary struct {
...
func (m CccFlexNetworkAttachmentSummary) String() string {
...
func (m CccFlexNetworkAttachmentSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
