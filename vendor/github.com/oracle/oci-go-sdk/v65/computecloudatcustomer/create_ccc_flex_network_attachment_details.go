...
// CreateCccFlexNetworkAttachmentDetails The configuration details for creating Compute Cloud@Customer flexNetworkAttachment.
type CreateCccFlexNetworkAttachmentDetails struct {
...
func (m CreateCccFlexNetworkAttachmentDetails) String() string {
...
func (m CreateCccFlexNetworkAttachmentDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
