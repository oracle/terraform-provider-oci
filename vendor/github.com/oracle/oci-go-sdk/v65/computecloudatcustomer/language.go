...
// Language Specification of a language.
type Language struct {

	// The name of the language.
	Name *string `mandatory:"true" json:"name"`

	// A code representing the language from the ISO 639-1 specification.
	LanguageCode *string `mandatory:"true" json:"languageCode"`

	// A code representing the country from the ISO 3166-1 specification.
...
func (m Language) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
