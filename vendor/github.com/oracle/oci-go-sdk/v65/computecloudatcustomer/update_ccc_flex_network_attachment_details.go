...
// UpdateCccFlexNetworkAttachmentDetails Updates Compute Cloud@Customer flexNetworkAttachment configuration details.
type UpdateCccFlexNetworkAttachmentDetails struct {
...
func (m UpdateCccFlexNetworkAttachmentDetails) String() string {
...
func (m UpdateCccFlexNetworkAttachmentDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
