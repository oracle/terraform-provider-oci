...
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/ddfs/ListWorkRequests.go.html to see an example of how to use ListWorkRequestsRequest.
...
var mappingListWorkRequestsStatusEnum = map[string]ListWorkRequestsStatusEnum{
	...
	"CANCELLED":       ListWorkRequestsStatusCancelled,
}
