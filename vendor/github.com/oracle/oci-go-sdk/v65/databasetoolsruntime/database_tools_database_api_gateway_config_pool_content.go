...
type databasetoolsdatabaseapigatewayconfigpoolcontent struct {
	JsonData                  []byte
	...
	ApiSpecs                  json.RawMessage                                                           `mandatory:"false" json:"apiSpecs"`
	AutoApiSpecs              json.RawMessage                                                           `mandatory:"false" json:"autoApiSpecs"`
...
func (m *databasetoolsdatabaseapigatewayconfigpoolcontent) UnmarshalJSON(data []byte) error {
	m.JsonData = data
	type Unmarshalerdatabasetoolsdatabaseapigatewayconfigpoolcontent databasetoolsdatabaseapigatewayconfigpoolcontent
	s := struct {
		Model Unmarshalerdatabasetoolsdatabaseapigatewayconfigpoolcontent
	}{}
	...
	m.ApiSpecs = s.Model.ApiSpecs
	m.AutoApiSpecs = s.Model.AutoApiSpecs
...
func (m *databasetoolsdatabaseapigatewayconfigpoolcontent) UnmarshalPolymorphicJSON(data []byte) (interface{}, error) {
	...
	switch m.Type {
	case "DEFAULT":
		mm := DatabaseToolsDatabaseApiGatewayConfigPoolContentDefault{}
		err = json.Unmarshal(data, &mm)
		return mm, err
	default:
		common.Logf("Received unsupported enum value for DatabaseToolsDatabaseApiGatewayConfigPoolContent: %s.", m.Type)
		return *m, nil
	}
}

// GetDisplayName returns DisplayName
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetDisplayName() *string {
	return m.DisplayName
}

// GetPoolRouteValue returns PoolRouteValue
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetPoolRouteValue() *string {
	return m.PoolRouteValue
}

// GetDatabaseToolsConnectionId returns DatabaseToolsConnectionId
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetDatabaseToolsConnectionId() *string {
	return m.DatabaseToolsConnectionId
}

// GetMaxPoolSize returns MaxPoolSize
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetMaxPoolSize() *int {
	return m.MaxPoolSize
}

// GetMinPoolSize returns MinPoolSize
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetMinPoolSize() *int {
	return m.MinPoolSize
}

// GetInitialPoolSize returns InitialPoolSize
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetInitialPoolSize() *int {
	return m.InitialPoolSize
}

// GetJwtProfileJwkUrl returns JwtProfileJwkUrl
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetJwtProfileJwkUrl() *string {
	return m.JwtProfileJwkUrl
}

// GetJwtProfileIssuer returns JwtProfileIssuer
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetJwtProfileIssuer() *string {
	return m.JwtProfileIssuer
}

// GetJwtProfileAudience returns JwtProfileAudience
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetJwtProfileAudience() *string {
	return m.JwtProfileAudience
}

// GetJwtProfileRoleClaimName returns JwtProfileRoleClaimName
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetJwtProfileRoleClaimName() *string {
	return m.JwtProfileRoleClaimName
}

// GetDatabaseActionsStatus returns DatabaseActionsStatus
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetDatabaseActionsStatus() DatabaseToolsDatabaseApiGatewayConfigPoolContentDatabaseActionsStatusEnum {
	return m.DatabaseActionsStatus
}

// GetRestEnabledSqlStatus returns RestEnabledSqlStatus
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetRestEnabledSqlStatus() DatabaseToolsDatabaseApiGatewayConfigPoolContentRestEnabledSqlStatusEnum {
	return m.RestEnabledSqlStatus
}

// GetAdvancedProperties returns AdvancedProperties
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetAdvancedProperties() map[string]string {
	return m.AdvancedProperties
}

// GetApiSpecs returns ApiSpecs
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetApiSpecs() json.RawMessage {
	return m.ApiSpecs
}

// GetAutoApiSpecs returns AutoApiSpecs
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetAutoApiSpecs() json.RawMessage {
	return m.AutoApiSpecs
}

// GetTimeCreated returns TimeCreated
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

// GetKey returns Key
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) GetKey() *string {
	return m.Key
}

func (m databasetoolsdatabaseapigatewayconfigpoolcontent) String() string {
...
func (m databasetoolsdatabaseapigatewayconfigpoolcontent) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
var mappingDatabaseToolsDatabaseApiGatewayConfigPoolContentDatabaseActionsStatusEnum = map[string]DatabaseToolsDatabaseApiGatewayConfigPoolContentDatabaseActionsStatusEnum{
	"ENABLED":  DatabaseToolsDatabaseApiGatewayConfigPoolContentDatabaseActionsStatusEnabled,
	"DISABLED": DatabaseToolsDatabaseApiGatewayConfigPoolContentDatabaseActionsStatusDisabled,
}

var mappingDatabaseToolsDatabaseApiGatewayConfigPoolContentDatabaseActionsStatusEnumLowerCase = map[string]DatabaseToolsDatabaseApiGatewayConfigPoolContentDatabaseActionsStatusEnum{
	"enabled":  DatabaseToolsDatabaseApiGatewayConfigPoolContentDatabaseActionsStatusEnabled,
	"disabled": DatabaseToolsDatabaseApiGatewayConfigPoolContentDatabaseActionsStatusDisabled,
}
...
func GetDatabaseToolsDatabaseApiGatewayConfigPoolContentDatabaseActionsStatusEnumValues() []DatabaseToolsDatabaseApiGatewayConfigPoolContentDatabaseActionsStatusEnum {
	values := make([]DatabaseToolsDatabaseApiGatewayConfigPoolContentDatabaseActionsStatusEnum, 0)
	for _, v := range mappingDatabaseToolsDatabaseApiGatewayConfigPoolContentDatabaseActionsStatusEnum {
...
func GetMappingDatabaseToolsDatabaseApiGatewayConfigPoolContentDatabaseActionsStatusEnum(val string) (DatabaseToolsDatabaseApiGatewayConfigPoolContentDatabaseActionsStatusEnum, bool) {
	enum, ok := mappingDatabaseToolsDatabaseApiGatewayConfigPoolContentDatabaseActionsStatusEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingDatabaseToolsDatabaseApiGatewayConfigPoolContentRestEnabledSqlStatusEnum = map[string]DatabaseToolsDatabaseApiGatewayConfigPoolContentRestEnabledSqlStatusEnum{
	"ENABLED":  DatabaseToolsDatabaseApiGatewayConfigPoolContentRestEnabledSqlStatusEnabled,
	"DISABLED": DatabaseToolsDatabaseApiGatewayConfigPoolContentRestEnabledSqlStatusDisabled,
}

var mappingDatabaseToolsDatabaseApiGatewayConfigPoolContentRestEnabledSqlStatusEnumLowerCase = map[string]DatabaseToolsDatabaseApiGatewayConfigPoolContentRestEnabledSqlStatusEnum{
	"enabled":  DatabaseToolsDatabaseApiGatewayConfigPoolContentRestEnabledSqlStatusEnabled,
	"disabled": DatabaseToolsDatabaseApiGatewayConfigPoolContentRestEnabledSqlStatusDisabled,
}
...
func GetDatabaseToolsDatabaseApiGatewayConfigPoolContentRestEnabledSqlStatusEnumValues() []DatabaseToolsDatabaseApiGatewayConfigPoolContentRestEnabledSqlStatusEnum {
	values := make([]DatabaseToolsDatabaseApiGatewayConfigPoolContentRestEnabledSqlStatusEnum, 0)
	for _, v := range mappingDatabaseToolsDatabaseApiGatewayConfigPoolContentRestEnabledSqlStatusEnum {
		values = append(values, v)
	}
	return values
}
...
func GetMappingDatabaseToolsDatabaseApiGatewayConfigPoolContentRestEnabledSqlStatusEnum(val string) (DatabaseToolsDatabaseApiGatewayConfigPoolContentRestEnabledSqlStatusEnum, bool) {
	enum, ok := mappingDatabaseToolsDatabaseApiGatewayConfigPoolContentRestEnabledSqlStatusEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
