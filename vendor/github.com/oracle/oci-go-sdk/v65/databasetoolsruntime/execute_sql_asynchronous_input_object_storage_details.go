...
func (m ExecuteSqlAsynchronousInputObjectStorageDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeExecuteSqlAsynchronousInputObjectStorageDetails ExecuteSqlAsynchronousInputObjectStorageDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeExecuteSqlAsynchronousInputObjectStorageDetails
	}{
		"OBJECT_STORAGE",
		(MarshalTypeExecuteSqlAsynchronousInputObjectStorageDetails)(m),
	}
