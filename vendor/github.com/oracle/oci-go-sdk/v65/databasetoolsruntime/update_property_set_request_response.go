...
func (request UpdatePropertySetRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingUpdatePropertySetPropertySetKeyEnum(string(request.PropertySetKey)); !ok && request.PropertySetKey != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for PropertySetKey: %s. Supported values are: %s.", request.PropertySetKey, strings.Join(GetUpdatePropertySetPropertySetKeyEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
var mappingUpdatePropertySetPropertySetKeyEnum = map[string]UpdatePropertySetPropertySetKeyEnum{
	"APEX_DOCUMENT_GENERATOR": UpdatePropertySetPropertySetKeyApexDocumentGenerator,
	"APEX":                    UpdatePropertySetPropertySetKeyApex,
	"APEX_FA_INTEGRATION":     UpdatePropertySetPropertySetKeyApexFaIntegration,
	"ORACLE_DATABASE_EXTERNAL_AUTHENTICATION": UpdatePropertySetPropertySetKeyOracleDatabaseExternalAuthentication,
}

var mappingUpdatePropertySetPropertySetKeyEnumLowerCase = map[string]UpdatePropertySetPropertySetKeyEnum{
	"apex_document_generator": UpdatePropertySetPropertySetKeyApexDocumentGenerator,
	"apex":                    UpdatePropertySetPropertySetKeyApex,
	"apex_fa_integration":     UpdatePropertySetPropertySetKeyApexFaIntegration,
	"oracle_database_external_authentication": UpdatePropertySetPropertySetKeyOracleDatabaseExternalAuthentication,
...
func GetUpdatePropertySetPropertySetKeyEnumValues() []UpdatePropertySetPropertySetKeyEnum {
	values := make([]UpdatePropertySetPropertySetKeyEnum, 0)
	for _, v := range mappingUpdatePropertySetPropertySetKeyEnum {
...
func GetMappingUpdatePropertySetPropertySetKeyEnum(val string) (UpdatePropertySetPropertySetKeyEnum, bool) {
	enum, ok := mappingUpdatePropertySetPropertySetKeyEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
