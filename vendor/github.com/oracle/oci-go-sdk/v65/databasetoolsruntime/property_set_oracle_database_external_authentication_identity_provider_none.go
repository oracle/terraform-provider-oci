...
func (m PropertySetOracleDatabaseExternalAuthenticationIdentityProviderNone) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePropertySetOracleDatabaseExternalAuthenticationIdentityProviderNone PropertySetOracleDatabaseExternalAuthenticationIdentityProviderNone
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypePropertySetOracleDatabaseExternalAuthenticationIdentityProviderNone
	}{
		"NONE",
		(MarshalTypePropertySetOracleDatabaseExternalAuthenticationIdentityProviderNone)(m),
	}
