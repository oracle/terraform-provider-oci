...
// NotebookSessionLogConfigDetails Configuration details for logging Notebook container's activity.
type NotebookSessionLogConfigDetails struct {
...
func (m NotebookSessionLogConfigDetails) String() string {
...
func (m NotebookSessionLogConfigDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
