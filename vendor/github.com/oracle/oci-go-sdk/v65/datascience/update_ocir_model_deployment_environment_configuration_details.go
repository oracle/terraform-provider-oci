...
func (m UpdateOcirModelDeploymentEnvironmentConfigurationDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateOcirModelDeploymentEnvironmentConfigurationDetails UpdateOcirModelDeploymentEnvironmentConfigurationDetails
	s := struct {
		DiscriminatorParam string `json:"environmentConfigurationType"`
		MarshalTypeUpdateOcirModelDeploymentEnvironmentConfigurationDetails
	}{
		"OCIR_CONTAINER",
		(MarshalTypeUpdateOcirModelDeploymentEnvironmentConfigurationDetails)(m),
	}
