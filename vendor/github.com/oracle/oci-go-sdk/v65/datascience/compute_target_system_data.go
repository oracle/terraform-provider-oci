...
const (
	ComputeTargetSystemDataComputeTypeCustomerOke           ComputeTargetSystemDataComputeTypeEnum = "CUSTOMER_OKE"
...
var mappingComputeTargetSystemDataComputeTypeEnum = map[string]ComputeTargetSystemDataComputeTypeEnum{
	"CUSTOMER_OKE":            ComputeTargetSystemDataComputeTypeCustomerOke,
