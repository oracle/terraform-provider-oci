...
// ModelArtifactSignature Metadata of the model artifact signature.
type ModelArtifactSignature struct {

	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the artifact signature.
	...
	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the model whose artifact has to be signed.
	ModelId *string `mandatory:"true" json:"modelId"`

	// The lifecycle state of the model artifact signature
	LifecycleState ArtifactSignatureLifecycleStateEnum `mandatory:"true" json:"lifecycleState"`

	// Base64 encoded string representing the model artifact digest.
	Digest *string `mandatory:"true" json:"digest"`

	// The signature of the digest generated using kmsKeyId, kmsKeyVersion Id and signingAlgorithm.
...
func (m ModelArtifactSignature) String() string {
...
func (m ModelArtifactSignature) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingArtifactSignatureLifecycleStateEnum(string(m.LifecycleState)); !ok && m.LifecycleState != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for LifecycleState: %s. Supported values are: %s.", m.LifecycleState, strings.Join(GetArtifactSignatureLifecycleStateEnumStringValues(), ",")))
	}
