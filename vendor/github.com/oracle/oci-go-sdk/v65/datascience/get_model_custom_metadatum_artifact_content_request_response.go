...
// GetModelCustomMetadatumArtifactContentRequest wrapper for the GetModelCustomMetadatumArtifactContent operation
//
// # See also
//
// Click https://docs.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/datascience/GetModelCustomMetadatumArtifactContent.go.html to see an example of how to use GetModelCustomMetadatumArtifactContentRequest.
type GetModelCustomMetadatumArtifactContentRequest struct {
...
func (request GetModelCustomMetadatumArtifactContentRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request GetModelCustomMetadatumArtifactContentRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request GetModelCustomMetadatumArtifactContentRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request GetModelCustomMetadatumArtifactContentRequest) RetryPolicy() *common.RetryPolicy {
...
func (request GetModelCustomMetadatumArtifactContentRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
...
// GetModelCustomMetadatumArtifactContentResponse wrapper for the GetModelCustomMetadatumArtifactContent operation
type GetModelCustomMetadatumArtifactContentResponse struct {
...
func (response GetModelCustomMetadatumArtifactContentResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response GetModelCustomMetadatumArtifactContentResponse) HTTPResponse() *http.Response {
