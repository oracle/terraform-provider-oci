...
// ModelGroupVersionHistorySummary Summary information for a modelGroupVersionHistory.
type ModelGroupVersionHistorySummary struct {
...
func (m ModelGroupVersionHistorySummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
