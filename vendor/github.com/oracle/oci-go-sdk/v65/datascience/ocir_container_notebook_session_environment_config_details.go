...
// OcirContainerNotebookSessionEnvironmentConfigDetails Environment configuration details object for OCI Registry.
type OcirContainerNotebookSessionEnvironmentConfigDetails struct {
...
func (m OcirContainerNotebookSessionEnvironmentConfigDetails) String() string {
...
func (m OcirContainerNotebookSessionEnvironmentConfigDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m OcirContainerNotebookSessionEnvironmentConfigDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOcirContainerNotebookSessionEnvironmentConfigDetails OcirContainerNotebookSessionEnvironmentConfigDetails
	s := struct {
		DiscriminatorParam string `json:"notebookSessionEnvironmentType"`
		MarshalTypeOcirContainerNotebookSessionEnvironmentConfigDetails
	}{
		"OCIR_CONTAINER",
		(MarshalTypeOcirContainerNotebookSessionEnvironmentConfigDetails)(m),
	}
