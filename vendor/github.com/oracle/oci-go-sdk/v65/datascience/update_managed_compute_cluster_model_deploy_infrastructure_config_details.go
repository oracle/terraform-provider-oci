...
func (m UpdateManagedComputeClusterModelDeployInfrastructureConfigDetails) String() string {
...
func (m UpdateManagedComputeClusterModelDeployInfrastructureConfigDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m UpdateManagedComputeClusterModelDeployInfrastructureConfigDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateManagedComputeClusterModelDeployInfrastructureConfigDetails UpdateManagedComputeClusterModelDeployInfrastructureConfigDetails
	s := struct {
		DiscriminatorParam string `json:"infrastructureType"`
		MarshalTypeUpdateManagedComputeClusterModelDeployInfrastructureConfigDetails
	}{
		"MANAGED_COMPUTE_CLUSTER",
		(MarshalTypeUpdateManagedComputeClusterModelDeployInfrastructureConfigDetails)(m),
	}
