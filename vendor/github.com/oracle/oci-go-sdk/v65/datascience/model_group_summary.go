...
type ModelGroupSummary struct {
	...
	ModelGroupVersionHistoryId *string `mandatory:"true" json:"modelGroupVersionHistoryId"`

	// The name of the model group version history to which the model group is associated.
	ModelGroupVersionHistoryName *string `mandatory:"true" json:"modelGroupVersionHistoryName"`
