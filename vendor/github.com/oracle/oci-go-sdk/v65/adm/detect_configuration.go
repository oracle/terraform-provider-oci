...
type DetectConfiguration struct {
	...
	// The list of dependencies to be ignored by the recommendation algorithm. The dependency pattern is matched against the 'group:artifact:version' of a dependency.
	// An asterisk (*) in the dependency pattern acts as a wildcard and matches zero or more characters.
	ExcludeList []string `mandatory:"false" json:"excludeList"`
