...
// ArtifactVersionKey Object uniquely identifying an artifact version.
type ArtifactVersionKey struct {
...
func (m ArtifactVersionKey) String() string {
...
func (m ArtifactVersionKey) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
