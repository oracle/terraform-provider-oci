...
// NoticeFile Content of a notice file and the file path to where it is located in the repository.
...
func (m NoticeFile) String() string {
...
func (m NoticeFile) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
