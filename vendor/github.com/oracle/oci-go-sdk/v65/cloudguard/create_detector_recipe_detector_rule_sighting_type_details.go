...
func (m CreateDetectorRecipeDetectorRuleSightingTypeDetails) String() string {
...
func (m CreateDetectorRecipeDetectorRuleSightingTypeDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
