...
func (m ScheduledQueryDataSourceSummaryObjDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeScheduledQueryDataSourceSummaryObjDetails ScheduledQueryDataSourceSummaryObjDetails
	s := struct {
		DiscriminatorParam string `json:"dataSourceFeedProvider"`
		MarshalTypeScheduledQueryDataSourceSummaryObjDetails
	}{
		"SCHEDULEDQUERY",
		(MarshalTypeScheduledQueryDataSourceSummaryObjDetails)(m),
	}
