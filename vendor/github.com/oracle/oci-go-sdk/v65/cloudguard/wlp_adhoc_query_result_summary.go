...
// WlpAdhocQueryResultSummary Adhoc query result resource from running on a resource.
type WlpAdhocQueryResultSummary struct {
...
func (m WlpAdhocQueryResultSummary) String() string {
...
func (m WlpAdhocQueryResultSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
