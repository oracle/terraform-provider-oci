...
// FaTargetDetails Parameters for a Fusion Apps target's details.
type FaTargetDetails struct {

	// List of resources that will be monitored
	MonitoringResources []MonitoringResource `mandatory:"false" json:"monitoringResources"`

	// OCI region where audit logs are to be fetched by Cloud Guard
...
func (m FaTargetDetails) String() string {
...
func (m FaTargetDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m FaTargetDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeFaTargetDetails FaTargetDetails
	s := struct {
		DiscriminatorParam string `json:"targetResourceType"`
		MarshalTypeFaTargetDetails
	}{
		"FACLOUD",
		(MarshalTypeFaTargetDetails)(m),
	}
