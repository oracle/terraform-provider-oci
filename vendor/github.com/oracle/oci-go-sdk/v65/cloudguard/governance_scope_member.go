...
// GovernanceScopeMember The scope member of the governance target.
type GovernanceScopeMember struct {

	// Unique identifier that can't be changed after creation
	Id *string `mandatory:"true" json:"id"`

	// The OCID of the governance detection. Only governanceTargetId is supported now.
...
func (m GovernanceScopeMember) String() string {
...
func (m GovernanceScopeMember) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
