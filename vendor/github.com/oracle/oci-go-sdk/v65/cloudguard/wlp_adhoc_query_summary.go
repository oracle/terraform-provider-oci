...
// WlpAdhocQuerySummary Summary information for a WLP adhoc query.
type WlpAdhocQuerySummary struct {
...
func (m WlpAdhocQuerySummary) String() string {
...
func (m WlpAdhocQuerySummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
