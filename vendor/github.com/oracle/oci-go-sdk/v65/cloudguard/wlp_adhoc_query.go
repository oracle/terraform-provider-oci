...
// WlpAdhocQuery Details of a WLP adhoc query.
type WlpAdhocQuery struct {
...
func (m WlpAdhocQuery) String() string {
...
func (m WlpAdhocQuery) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
