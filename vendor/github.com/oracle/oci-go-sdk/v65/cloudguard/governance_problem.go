...
// GovernanceProblem Governance problems are at the core of Cloud Guard’s functionality. A governance problem resource is created whenever an action or a configuration on a resource triggers a rule in a detector that’s attached to the target of subject tenancy managed by governing tenancy. Each governance problem resource contains all the details for a single problem. This is the information for the governance problem that appears on the Cloud Guard governance problems page of governing tenancy.
type GovernanceProblem struct {
	...
	// Unique identifier of the detector rule that triggered the governance problem
	DetectorRuleId *string `mandatory:"false" json:"detectorRuleId"`

	// Regions where the governance problem is found
	Regions []string `mandatory:"false" json:"regions"`

	// The risk level for the governance problem
	...
	// The date and time for the peak risk score that is observed for the governance problem. Format defined by RFC3339.
	PeakRiskScoreDate *string `mandatory:"false" json:"peakRiskScoreDate"`

	// Peak risk score for the governance problem
	PeakRiskScore *float64 `mandatory:"false" json:"peakRiskScore"`

	// The date and time when the governance problem will be auto resolved. Format defined by RFC3339.
	AutoResolveDate *string `mandatory:"false" json:"autoResolveDate"`

	// Number of days for which peak score is calculated for the governance problem
	PeakRiskScoreLookupPeriodInDays *int `mandatory:"false" json:"peakRiskScoreLookupPeriodInDays"`

	// Unique identifier of the resource affected by the governance problem
	...
	// The additional details of the governance problem
	AdditionalDetails map[string]string `mandatory:"false" json:"additionalDetails"`

	// Description of the governance problem
	Description *string `mandatory:"false" json:"description"`

	// Recommendation for the governance problem
	Recommendation *string `mandatory:"false" json:"recommendation"`

	// User comments on the governance problem
	Comment *string `mandatory:"false" json:"comment"`

	// Unique identifier of the resource impacted by the governance problem
...
func (m GovernanceProblem) String() string {
...
func (m GovernanceProblem) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
