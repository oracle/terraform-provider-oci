...
// GovernanceTargetDetectorRecipe Detector recipe information.
type GovernanceTargetDetectorRecipe struct {
...
func (m GovernanceTargetDetectorRecipe) String() string {
...
func (m GovernanceTargetDetectorRecipe) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
