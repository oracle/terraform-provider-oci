...
// WlpSavedQuerySummary Summary information for a WlpSavedQuery resource.
type WlpSavedQuerySummary struct {
...
func (m WlpSavedQuerySummary) String() string {
...
func (m WlpSavedQuerySummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
