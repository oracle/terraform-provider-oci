...
// WlpSavedQuery Details of a WLP saved query.
type WlpSavedQuery struct {
...
func (m WlpSavedQuery) String() string {
...
func (m WlpSavedQuery) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
