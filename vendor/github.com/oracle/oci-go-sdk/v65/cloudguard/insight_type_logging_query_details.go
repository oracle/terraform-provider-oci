...
func (m InsightTypeLoggingQueryDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeInsightTypeLoggingQueryDetails InsightTypeLoggingQueryDetails
	s := struct {
		DiscriminatorParam string `json:"loggingQueryType"`
		MarshalTypeInsightTypeLoggingQueryDetails
	}{
		"INSIGHT",
		(MarshalTypeInsightTypeLoggingQueryDetails)(m),
	}
