...
func (m *createdistributeddatabasecatalogdetails) UnmarshalPolymorphicJSON(data []byte) (interface{}, error) {
	...
	case "EXADB_XS":
		...
		return mm, err
	case "BASE_DB":
		mm := CreateDistributedDatabaseCatalogWithBaseDbDetails{}
		err = json.Unmarshal(data, &mm)
		return mm, err
	default:
...
const (
	...
	CreateDistributedDatabaseCatalogDetailsSourceBaseDb             CreateDistributedDatabaseCatalogDetailsSourceEnum = "BASE_DB"
)
...
var mappingCreateDistributedDatabaseCatalogDetailsSourceEnum = map[string]CreateDistributedDatabaseCatalogDetailsSourceEnum{
	...
	"BASE_DB":               CreateDistributedDatabaseCatalogDetailsSourceBaseDb,
}
