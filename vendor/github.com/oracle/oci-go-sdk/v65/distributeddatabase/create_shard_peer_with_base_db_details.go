...
// CreateShardPeerWithBaseDbDetails Details required for creation of peer shard.
type CreateShardPeerWithBaseDbDetails struct {
...
func (m CreateShardPeerWithBaseDbDetails) String() string {
...
func (m CreateShardPeerWithBaseDbDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
