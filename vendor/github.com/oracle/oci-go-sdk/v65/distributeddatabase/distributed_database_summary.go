...
const (
	...
	DistributedDatabaseSummaryDbDeploymentTypeBaseDb  DistributedDatabaseSummaryDbDeploymentTypeEnum = "BASE_DB"
)
...
var mappingDistributedDatabaseSummaryDbDeploymentTypeEnum = map[string]DistributedDatabaseSummaryDbDeploymentTypeEnum{
	...
	"BASE_DB":  DistributedDatabaseSummaryDbDeploymentTypeBaseDb,
}
