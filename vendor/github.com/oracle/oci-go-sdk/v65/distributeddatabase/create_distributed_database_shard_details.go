...
func (m *createdistributeddatabasesharddetails) UnmarshalPolymorphicJSON(data []byte) (interface{}, error) {
	...
	case "EXADB_XS":
		...
		return mm, err
	case "BASE_DB":
		mm := CreateDistributedDatabaseShardWithBaseDbDetails{}
		err = json.Unmarshal(data, &mm)
		return mm, err
	default:
...
const (
	...
	CreateDistributedDatabaseShardDetailsSourceBaseDb             CreateDistributedDatabaseShardDetailsSourceEnum = "BASE_DB"
)
...
var mappingCreateDistributedDatabaseShardDetailsSourceEnum = map[string]CreateDistributedDatabaseShardDetailsSourceEnum{
	...
	"BASE_DB":               CreateDistributedDatabaseShardDetailsSourceBaseDb,
}
