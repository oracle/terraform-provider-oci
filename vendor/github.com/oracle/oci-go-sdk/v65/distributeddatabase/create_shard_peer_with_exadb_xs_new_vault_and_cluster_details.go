...
// CreateShardPeerWithExadbXsNewVaultAndClusterDetails Details required for creation of ExaDbXs based shard peer.
type CreateShardPeerWithExadbXsNewVaultAndClusterDetails struct {
...
func (m CreateShardPeerWithExadbXsNewVaultAndClusterDetails) String() string {
...
func (m CreateShardPeerWithExadbXsNewVaultAndClusterDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
