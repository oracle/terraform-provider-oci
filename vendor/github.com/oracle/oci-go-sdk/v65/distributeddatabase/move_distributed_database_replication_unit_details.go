...
// MoveDistributedDatabaseReplicationUnitDetails The details for moving replication units from source shard to destination shard for the Globally distributed database.
type MoveDistributedDatabaseReplicationUnitDetails struct {
...
func (m MoveDistributedDatabaseReplicationUnitDetails) String() string {
...
func (m MoveDistributedDatabaseReplicationUnitDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
