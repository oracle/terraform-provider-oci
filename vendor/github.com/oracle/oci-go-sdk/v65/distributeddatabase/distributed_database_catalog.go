...
func (m *distributeddatabasecatalog) UnmarshalPolymorphicJSON(data []byte) (interface{}, error) {
	...
	switch m.Source {
	case "BASE_DB":
		mm := DistributedDatabaseCatalogWithBaseDb{}
...
const (
	...
	DistributedDatabaseCatalogSourceBaseDb             DistributedDatabaseCatalogSourceEnum = "BASE_DB"
)
...
var mappingDistributedDatabaseCatalogSourceEnum = map[string]DistributedDatabaseCatalogSourceEnum{
	...
	"BASE_DB":               DistributedDatabaseCatalogSourceBaseDb,
}
