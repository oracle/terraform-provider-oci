...
// CreateDistributedDatabaseShardWithBaseDbDetails Globally distributed database shard with base database.
type CreateDistributedDatabaseShardWithBaseDbDetails struct {
	...
	PeerDetails []CreateShardPeerWithBaseDbDetails `mandatory:"false" json:"peerDetails"`
...
func (m CreateDistributedDatabaseShardWithBaseDbDetails) String() string {
...
func (m CreateDistributedDatabaseShardWithBaseDbDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateDistributedDatabaseShardWithBaseDbDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDistributedDatabaseShardWithBaseDbDetails CreateDistributedDatabaseShardWithBaseDbDetails
	s := struct {
		DiscriminatorParam string `json:"source"`
		MarshalTypeCreateDistributedDatabaseShardWithBaseDbDetails
	}{
		"BASE_DB",
		(MarshalTypeCreateDistributedDatabaseShardWithBaseDbDetails)(m),
	}
