...
func (m WebAppAccelerationLoadBalancerSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeWebAppAccelerationLoadBalancerSummary WebAppAccelerationLoadBalancerSummary
	s := struct {
		DiscriminatorParam string `json:"backendType"`
		MarshalTypeWebAppAccelerationLoadBalancerSummary
	}{
		"LOAD_BALANCER",
		(MarshalTypeWebAppAccelerationLoadBalancerSummary)(m),
	}
