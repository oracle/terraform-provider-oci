...
func (request DeleteIdentityProviderRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["identityProviderId"] != nil {
		templateParam := mandatoryParamMap["identityProviderId"]
		for _, template := range templateParam {
			replacementParam := *request.IdentityProviderId
