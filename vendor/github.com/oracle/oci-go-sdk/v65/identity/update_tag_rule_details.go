...
// UpdateTagRuleDetails The representation of UpdateTagRuleDetails
type UpdateTagRuleDetails struct {
	...
	RuleText *string `mandatory:"false" json:"ruleText"`
...
func (m UpdateTagRuleDetails) String() string {
...
func (m UpdateTagRuleDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
