...
// CreatePolicySimulationDetails Properties required for creating a Policy Simulation task.
type CreatePolicySimulationDetails struct {
	...
	// End of the time window for which the Policy Simulation task should process the logs.
...
func (m CreatePolicySimulationDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
