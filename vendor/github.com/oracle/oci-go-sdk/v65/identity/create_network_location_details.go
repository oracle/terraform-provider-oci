...
// CreateNetworkLocationDetails Properties for creating a network location object.
type CreateNetworkLocationDetails struct {

	// The OCID of the tenancy (root compartment) containing the network location object.
	CompartmentId *string `mandatory:"true" json:"compartmentId"`

	// The name you assign to the network location during creation. The name must be unique across all network locations
	// in the tenancy and cannot be changed.
	Name *string `mandatory:"true" json:"name"`

	// The description you assign to the network location during creation. Does not have to be unique, and it's changeable.
...
func (m CreateNetworkLocationDetails) String() string {
...
func (m CreateNetworkLocationDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
