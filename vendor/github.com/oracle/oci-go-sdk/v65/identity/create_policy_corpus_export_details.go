...
// CreatePolicyCorpusExportDetails Properties needed to create Policy Corpus export task.
type CreatePolicyCorpusExportDetails struct {

	// compartmentId whose Policy Corpus needs to be exported for Policy Simulation.
	CompartmentId *string `mandatory:"true" json:"compartmentId"`

	PolicyCorpusUploadPath *ObjectStorageFileUploadLocation `mandatory:"true" json:"policyCorpusUploadPath"`
}

func (m CreatePolicyCorpusExportDetails) String() string {
...
func (m CreatePolicyCorpusExportDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
