...
func (request UpdateNetworkSourceRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["networkSourceId"] != nil {
		templateParam := mandatoryParamMap["networkSourceId"]
		for _, template := range templateParam {
			replacementParam := *request.NetworkSourceId
