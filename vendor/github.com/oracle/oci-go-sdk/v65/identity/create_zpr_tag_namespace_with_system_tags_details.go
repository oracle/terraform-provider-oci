...
// CreateZprTagNamespaceWithSystemTagsDetails Details of the ZPR tag namespace to be created for a specific compartment.
type CreateZprTagNamespaceWithSystemTagsDetails struct {
	...
	// ZPR system tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace.
	// For more information, see Resource Tags (https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm).
	// Example: `{"orcl-internal-zpr": {"administrator": {"value": "true", "mode": "enforce"}}}`
	ZprSystemTags map[string]map[string]interface{} `mandatory:"true" json:"zprSystemTags"`
...
func (m CreateZprTagNamespaceWithSystemTagsDetails) String() string {
...
func (m CreateZprTagNamespaceWithSystemTagsDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
