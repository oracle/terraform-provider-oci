...
// CreateZprTagNamespaceTagDetails Details of the ZPR tag to be created for a specific ZPR tag namespace.
type CreateZprTagNamespaceTagDetails struct {
...
func (m CreateZprTagNamespaceTagDetails) String() string {
...
func (m CreateZprTagNamespaceTagDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *CreateZprTagNamespaceTagDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {
