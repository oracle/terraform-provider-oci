...
// SetCompartmentPropertyDetails The representation of SetCompartmentPropertyDetails
type SetCompartmentPropertyDetails struct {

	// The name of the property to set to the target compartment.
	PropertyName *string `mandatory:"false" json:"propertyName"`

	// The value of the property to set to the target compartment.
	PropertyValue *string `mandatory:"false" json:"propertyValue"`
}

func (m SetCompartmentPropertyDetails) String() string {
...
func (m SetCompartmentPropertyDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
