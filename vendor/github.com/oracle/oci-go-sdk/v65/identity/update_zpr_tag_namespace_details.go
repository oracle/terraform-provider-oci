...
type UpdateZprTagNamespaceDetails struct {
	...
	// The description you assign to the ZPR tag namespace to help you identify it.
	Description *string `mandatory:"false" json:"description"`

	// Indicates whether the ZPR tag namespace is retired.
...
func (m UpdateZprTagNamespaceDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
