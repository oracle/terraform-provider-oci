...
// ObjectStorageFileDownloadLocation Object defining a path in object storage where the file should be downloaded from.
type ObjectStorageFileDownloadLocation struct {

	// Namespace of the bucket where the file is located.
...
func (m ObjectStorageFileDownloadLocation) String() string {
...
func (m ObjectStorageFileDownloadLocation) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
