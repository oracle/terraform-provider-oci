...
// UpdateZprTagNamespaceTagDetails Details of the ZPR tag to be updated for a specific ZPR tag namespace.
type UpdateZprTagNamespaceTagDetails struct {
...
func (m UpdateZprTagNamespaceTagDetails) String() string {
...
func (m UpdateZprTagNamespaceTagDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *UpdateZprTagNamespaceTagDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {
