...
func (request GetGroupRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["groupId"] != nil {
		templateParam := mandatoryParamMap["groupId"]
		for _, template := range templateParam {
			replacementParam := *request.GroupId
