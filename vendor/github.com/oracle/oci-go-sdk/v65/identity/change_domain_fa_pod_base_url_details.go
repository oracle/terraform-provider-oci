...
// ChangeDomainFaPodBaseUrlDetails (For tenancies that support identity domains) Details for updating the fa pod base url of the identity domain.
type ChangeDomainFaPodBaseUrlDetails struct {

	// The fa pod base url of the identity domain.
	FaPodBaseUrl *string `mandatory:"false" json:"faPodBaseUrl"`
}

func (m ChangeDomainFaPodBaseUrlDetails) String() string {
...
func (m ChangeDomainFaPodBaseUrlDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
