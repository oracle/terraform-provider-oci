...
func (request DeleteTagDefaultRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["tagDefaultId"] != nil {
		templateParam := mandatoryParamMap["tagDefaultId"]
		for _, template := range templateParam {
			replacementParam := *request.TagDefaultId
