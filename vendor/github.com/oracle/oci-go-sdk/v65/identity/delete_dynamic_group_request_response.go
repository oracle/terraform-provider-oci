...
func (request DeleteDynamicGroupRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["dynamicGroupId"] != nil {
		templateParam := mandatoryParamMap["dynamicGroupId"]
		for _, template := range templateParam {
			replacementParam := *request.DynamicGroupId
