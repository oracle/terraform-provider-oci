...
// UnsetCompartmentPropertyDetails The representation of UnsetCompartmentPropertyDetails
type UnsetCompartmentPropertyDetails struct {

	// The name of the property to unset from the target compartment.
	PropertyName *string `mandatory:"false" json:"propertyName"`
}

func (m UnsetCompartmentPropertyDetails) String() string {
...
func (m UnsetCompartmentPropertyDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
