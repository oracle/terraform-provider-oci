...
// TenancyDenyPolicyFeatureDetails Resource object containing details of IAM Deny feature status for a given tenancy.
type TenancyDenyPolicyFeatureDetails struct {

	// Id of the customer tenancy.
...
func (m TenancyDenyPolicyFeatureDetails) String() string {
...
func (m TenancyDenyPolicyFeatureDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
