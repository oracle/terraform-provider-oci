...
// ObjectStorageFileUploadLocation Object defining a path in object storage where the file is to uploaded.
type ObjectStorageFileUploadLocation struct {
...
func (m ObjectStorageFileUploadLocation) String() string {
...
func (m ObjectStorageFileUploadLocation) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
