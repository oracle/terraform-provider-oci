...
// NetworkAccessPolicySummary A network access policy.
type NetworkAccessPolicySummary struct {
...
func (m NetworkAccessPolicySummary) String() string {
...
func (m NetworkAccessPolicySummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
