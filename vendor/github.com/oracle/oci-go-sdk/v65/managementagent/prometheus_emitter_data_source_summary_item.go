...
func (m PrometheusEmitterDataSourceSummaryItem) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePrometheusEmitterDataSourceSummaryItem PrometheusEmitterDataSourceSummaryItem
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypePrometheusEmitterDataSourceSummaryItem
	}{
		"PROMETHEUS_EMITTER",
		(MarshalTypePrometheusEmitterDataSourceSummaryItem)(m),
	}
