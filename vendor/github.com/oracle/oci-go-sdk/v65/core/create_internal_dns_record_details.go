...
type CreateInternalDnsRecordDetails struct {
	...
	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to contain the `DnsRecord`.
	CompartmentId *string `mandatory:"true" json:"compartmentId"`

	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Internal Hosted Zone the `DnsRecord` object belongs to.
...
func (m CreateInternalDnsRecordDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingCreateInternalDnsRecordDetailsTypeEnum(string(m.Type)); !ok && m.Type != "" {
...
var mappingCreateInternalDnsRecordDetailsTypeEnumLowerCase = map[string]CreateInternalDnsRecordDetailsTypeEnum{
	"a": CreateInternalDnsRecordDetailsTypeA,
}
...
// GetMappingCreateInternalDnsRecordDetailsTypeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingCreateInternalDnsRecordDetailsTypeEnum(val string) (CreateInternalDnsRecordDetailsTypeEnum, bool) {
	enum, ok := mappingCreateInternalDnsRecordDetailsTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
