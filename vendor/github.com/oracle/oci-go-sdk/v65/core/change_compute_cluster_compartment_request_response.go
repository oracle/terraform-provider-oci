...
func (request ChangeComputeClusterCompartmentRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["computeClusterId"] != nil {
		templateParam := mandatoryParamMap["computeClusterId"]
		for _, template := range templateParam {
			replacementParam := *request.ComputeClusterId
