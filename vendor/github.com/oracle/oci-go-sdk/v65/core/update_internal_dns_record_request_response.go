...
func (request UpdateInternalDnsRecordRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["internalDnsRecordId"] != nil {
		templateParam := mandatoryParamMap["internalDnsRecordId"]
		for _, template := range templateParam {
			replacementParam := *request.InternalDnsRecordId
