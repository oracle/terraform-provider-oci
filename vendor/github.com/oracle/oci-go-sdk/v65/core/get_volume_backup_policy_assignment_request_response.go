...
func (request GetVolumeBackupPolicyAssignmentRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["policyAssignmentId"] != nil {
		templateParam := mandatoryParamMap["policyAssignmentId"]
		for _, template := range templateParam {
			replacementParam := *request.PolicyAssignmentId
