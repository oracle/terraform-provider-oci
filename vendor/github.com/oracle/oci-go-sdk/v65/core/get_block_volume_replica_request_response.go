...
func (request GetBlockVolumeReplicaRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["blockVolumeReplicaId"] != nil {
		templateParam := mandatoryParamMap["blockVolumeReplicaId"]
		for _, template := range templateParam {
			replacementParam := *request.BlockVolumeReplicaId
