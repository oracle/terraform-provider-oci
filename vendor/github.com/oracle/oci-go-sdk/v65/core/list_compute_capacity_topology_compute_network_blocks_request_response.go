...
func (request ListComputeCapacityTopologyComputeNetworkBlocksRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["computeCapacityTopologyId"] != nil {
		templateParam := mandatoryParamMap["computeCapacityTopologyId"]
		for _, template := range templateParam {
			replacementParam := *request.ComputeCapacityTopologyId
