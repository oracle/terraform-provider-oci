...
func (request ChangeVlanCompartmentRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["vlanId"] != nil {
		templateParam := mandatoryParamMap["vlanId"]
		for _, template := range templateParam {
			replacementParam := *request.VlanId
