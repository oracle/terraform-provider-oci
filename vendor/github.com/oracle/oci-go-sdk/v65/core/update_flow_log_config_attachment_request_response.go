...
type UpdateFlowLogConfigAttachmentRequest struct {
	...
	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the flow log configuration attachment.
...
func (request UpdateFlowLogConfigAttachmentRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["flowLogConfigAttachmentId"] != nil {
		templateParam := mandatoryParamMap["flowLogConfigAttachmentId"]
		for _, template := range templateParam {
			replacementParam := *request.FlowLogConfigAttachmentId
