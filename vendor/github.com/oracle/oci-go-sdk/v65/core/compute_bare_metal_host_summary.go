...
type ComputeBareMetalHostSummary struct {
	...
	// The shape of the compute instance that is currently or going to be running on this compute bare metal host.
	...
	// The OCID (https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute instance currently running on this compute bare metal host.
