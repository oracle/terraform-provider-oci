...
// CreateFirmwareReportDetails Details of a FirmwareReport.
type CreateFirmwareReportDetails struct {
...
func (m CreateFirmwareReportDetails) String() string {
...
func (m CreateFirmwareReportDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *CreateFirmwareReportDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {
