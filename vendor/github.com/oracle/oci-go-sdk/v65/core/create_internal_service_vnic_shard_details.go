...
// CreateInternalServiceVnicShardDetails Service vnic shard config details to create shard
type CreateInternalServiceVnicShardDetails struct {
...
func (m CreateInternalServiceVnicShardDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
