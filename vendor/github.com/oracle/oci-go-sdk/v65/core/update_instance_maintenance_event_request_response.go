...
func (request UpdateInstanceMaintenanceEventRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["instanceMaintenanceEventId"] != nil {
		templateParam := mandatoryParamMap["instanceMaintenanceEventId"]
		for _, template := range templateParam {
			replacementParam := *request.InstanceMaintenanceEventId
