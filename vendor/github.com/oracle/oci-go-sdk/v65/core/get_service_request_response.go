...
func (request GetServiceRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["serviceId"] != nil {
		templateParam := mandatoryParamMap["serviceId"]
		for _, template := range templateParam {
			replacementParam := *request.ServiceId
