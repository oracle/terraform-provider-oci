...
func (request DetachVnicRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["vnicAttachmentId"] != nil {
		templateParam := mandatoryParamMap["vnicAttachmentId"]
		for _, template := range templateParam {
			replacementParam := *request.VnicAttachmentId
