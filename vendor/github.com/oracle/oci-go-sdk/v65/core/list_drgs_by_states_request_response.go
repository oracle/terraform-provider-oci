...
type ListDrgsByStatesRequest struct {
	...
	// A query parameter to return resources that match the given compartment OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) exactly.
...
func (request ListDrgsByStatesRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
}
