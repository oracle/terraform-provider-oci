...
func (request CreatePrivateIpNextHopRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["privateIpId"] != nil {
		templateParam := mandatoryParamMap["privateIpId"]
		for _, template := range templateParam {
			replacementParam := *request.PrivateIpId
