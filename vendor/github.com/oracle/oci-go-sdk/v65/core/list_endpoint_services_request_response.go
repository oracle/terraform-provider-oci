...
func (request ListEndpointServicesRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
...
func (request ListEndpointServicesRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListEndpointServicesSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
	...
	if _, ok := GetMappingListEndpointServicesSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
...
var mappingListEndpointServicesSortByEnumLowerCase = map[string]ListEndpointServicesSortByEnum{
	"timecreated": ListEndpointServicesSortByTimecreated,
	"displayname": ListEndpointServicesSortByDisplayname,
}
...
// GetMappingListEndpointServicesSortByEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListEndpointServicesSortByEnum(val string) (ListEndpointServicesSortByEnum, bool) {
	enum, ok := mappingListEndpointServicesSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListEndpointServicesSortOrderEnumLowerCase = map[string]ListEndpointServicesSortOrderEnum{
	"asc":  ListEndpointServicesSortOrderAsc,
	"desc": ListEndpointServicesSortOrderDesc,
}
...
// GetMappingListEndpointServicesSortOrderEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListEndpointServicesSortOrderEnum(val string) (ListEndpointServicesSortOrderEnum, bool) {
	enum, ok := mappingListEndpointServicesSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
