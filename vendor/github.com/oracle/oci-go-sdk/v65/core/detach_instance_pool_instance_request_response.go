...
func (request DetachInstancePoolInstanceRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["instancePoolId"] != nil {
		templateParam := mandatoryParamMap["instancePoolId"]
		for _, template := range templateParam {
			replacementParam := *request.InstancePoolId
