...
type FlowLogConfig struct {
	...
	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the flow
	// log configuration.
	...
	// The flow log configuration's OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
...
func (m FlowLogConfig) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingFlowLogConfigLifecycleStateEnum(string(m.LifecycleState)); !ok && m.LifecycleState != "" {
	...
	if _, ok := GetMappingFlowLogConfigFlowLogTypeEnum(string(m.FlowLogType)); !ok && m.FlowLogType != "" {
...
var mappingFlowLogConfigLifecycleStateEnumLowerCase = map[string]FlowLogConfigLifecycleStateEnum{
	"provisioning": FlowLogConfigLifecycleStateProvisioning,
	"available":    FlowLogConfigLifecycleStateAvailable,
	"terminating":  FlowLogConfigLifecycleStateTerminating,
	"terminated":   FlowLogConfigLifecycleStateTerminated,
...
// GetMappingFlowLogConfigLifecycleStateEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingFlowLogConfigLifecycleStateEnum(val string) (FlowLogConfigLifecycleStateEnum, bool) {
	enum, ok := mappingFlowLogConfigLifecycleStateEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingFlowLogConfigFlowLogTypeEnumLowerCase = map[string]FlowLogConfigFlowLogTypeEnum{
	"all": FlowLogConfigFlowLogTypeAll,
}
...
// GetMappingFlowLogConfigFlowLogTypeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingFlowLogConfigFlowLogTypeEnum(val string) (FlowLogConfigFlowLogTypeEnum, bool) {
	enum, ok := mappingFlowLogConfigFlowLogTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
