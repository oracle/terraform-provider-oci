...
type ListClientVpnUsersRequest struct {
	...
	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ClientVpn.
...
func (request ListClientVpnUsersRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
...
func (request ListClientVpnUsersRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListClientVpnUsersSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
	...
	if _, ok := GetMappingListClientVpnUsersSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
...
var mappingListClientVpnUsersSortByEnumLowerCase = map[string]ListClientVpnUsersSortByEnum{
	"timecreated": ListClientVpnUsersSortByTimecreated,
	"displayname": ListClientVpnUsersSortByDisplayname,
}
...
// GetMappingListClientVpnUsersSortByEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListClientVpnUsersSortByEnum(val string) (ListClientVpnUsersSortByEnum, bool) {
	enum, ok := mappingListClientVpnUsersSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListClientVpnUsersSortOrderEnumLowerCase = map[string]ListClientVpnUsersSortOrderEnum{
	"asc":  ListClientVpnUsersSortOrderAsc,
	"desc": ListClientVpnUsersSortOrderDesc,
}
...
// GetMappingListClientVpnUsersSortOrderEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListClientVpnUsersSortOrderEnum(val string) (ListClientVpnUsersSortOrderEnum, bool) {
	enum, ok := mappingListClientVpnUsersSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
