...
type UpdateInternalPublicIpRequest struct {
	...
	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the internal public IP.
...
func (request UpdateInternalPublicIpRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["internalPublicIpId"] != nil {
		templateParam := mandatoryParamMap["internalPublicIpId"]
		for _, template := range templateParam {
			replacementParam := *request.InternalPublicIpId
