...
func (request ChangeRouteTableCompartmentRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["rtId"] != nil {
		templateParam := mandatoryParamMap["rtId"]
		for _, template := range templateParam {
			replacementParam := *request.RtId
