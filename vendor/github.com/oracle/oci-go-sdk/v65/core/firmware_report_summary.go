...
// FirmwareReportSummary Summary of a FirmwareReport.
type FirmwareReportSummary struct {
	...
	// The time the the FirmwareReport was created. An RFC3339 formatted datetime string
	TimeCreated *common.SDKTime `mandatory:"true" json:"timeCreated"`

	// The current state of the FirmwareReport.
...
func (m FirmwareReportSummary) String() string {
...
func (m FirmwareReportSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
