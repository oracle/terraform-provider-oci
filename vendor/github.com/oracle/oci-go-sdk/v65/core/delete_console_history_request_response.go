...
func (request DeleteConsoleHistoryRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["instanceConsoleHistoryId"] != nil {
		templateParam := mandatoryParamMap["instanceConsoleHistoryId"]
		for _, template := range templateParam {
			replacementParam := *request.InstanceConsoleHistoryId
