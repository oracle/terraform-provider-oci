...
func (request DeleteBootVolumeBackupRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["bootVolumeBackupId"] != nil {
		templateParam := mandatoryParamMap["bootVolumeBackupId"]
		for _, template := range templateParam {
			replacementParam := *request.BootVolumeBackupId
