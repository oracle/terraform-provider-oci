...
func (request ListInternalPublicIpsRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
...
func (request ListInternalPublicIpsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListInternalPublicIpsScopeEnum(string(request.Scope)); !ok && request.Scope != "" {
	...
	if _, ok := GetMappingListInternalPublicIpsLifetimeEnum(string(request.Lifetime)); !ok && request.Lifetime != "" {
...
var mappingListInternalPublicIpsScopeEnumLowerCase = map[string]ListInternalPublicIpsScopeEnum{
	"region":              ListInternalPublicIpsScopeRegion,
	"availability_domain": ListInternalPublicIpsScopeAvailabilityDomain,
}
...
// GetMappingListInternalPublicIpsScopeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListInternalPublicIpsScopeEnum(val string) (ListInternalPublicIpsScopeEnum, bool) {
	enum, ok := mappingListInternalPublicIpsScopeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListInternalPublicIpsLifetimeEnumLowerCase = map[string]ListInternalPublicIpsLifetimeEnum{
	"ephemeral": ListInternalPublicIpsLifetimeEphemeral,
	"reserved":  ListInternalPublicIpsLifetimeReserved,
}
...
// GetMappingListInternalPublicIpsLifetimeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListInternalPublicIpsLifetimeEnum(val string) (ListInternalPublicIpsLifetimeEnum, bool) {
	enum, ok := mappingListInternalPublicIpsLifetimeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
