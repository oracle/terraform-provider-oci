...
// UpdateComputeHostGroupDetails Update details information for a compute host group.
type UpdateComputeHostGroupDetails struct {
...
func (m UpdateComputeHostGroupDetails) String() string {
...
func (m UpdateComputeHostGroupDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
