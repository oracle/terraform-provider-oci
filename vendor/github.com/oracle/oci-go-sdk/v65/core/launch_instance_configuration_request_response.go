...
func (request LaunchInstanceConfigurationRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["instanceConfigurationId"] != nil {
		templateParam := mandatoryParamMap["instanceConfigurationId"]
		for _, template := range templateParam {
			replacementParam := *request.InstanceConfigurationId
