...
func (request ListScanProxiesRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
...
func (request ListScanProxiesRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListScanProxiesSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
	...
	if _, ok := GetMappingListScanProxiesSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
...
var mappingListScanProxiesSortByEnumLowerCase = map[string]ListScanProxiesSortByEnum{
	"timecreated": ListScanProxiesSortByTimecreated,
	"displayname": ListScanProxiesSortByDisplayname,
}
...
// GetMappingListScanProxiesSortByEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListScanProxiesSortByEnum(val string) (ListScanProxiesSortByEnum, bool) {
	enum, ok := mappingListScanProxiesSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListScanProxiesSortOrderEnumLowerCase = map[string]ListScanProxiesSortOrderEnum{
	"asc":  ListScanProxiesSortOrderAsc,
	"desc": ListScanProxiesSortOrderDesc,
}
...
// GetMappingListScanProxiesSortOrderEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListScanProxiesSortOrderEnum(val string) (ListScanProxiesSortOrderEnum, bool) {
	enum, ok := mappingListScanProxiesSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
