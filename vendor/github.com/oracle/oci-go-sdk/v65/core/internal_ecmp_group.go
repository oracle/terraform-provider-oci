...
type InternalEcmpGroup struct {
	...
	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the InternalEcmpGroup.
	CompartmentId *string `mandatory:"true" json:"compartmentId"`

	// The InternalEcmpGroup's Oracle ID (OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm)).
