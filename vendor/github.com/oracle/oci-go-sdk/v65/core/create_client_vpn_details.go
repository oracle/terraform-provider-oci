...
func (m CreateClientVpnDetails) ValidateEnumValue() (bool, error) {
	...
	if _, ok := GetMappingCreateClientVpnDetailsAddressingModeEnum(string(m.AddressingMode)); !ok && m.AddressingMode != "" {
	...
	if _, ok := GetMappingCreateClientVpnDetailsAuthenticationModeEnum(string(m.AuthenticationMode)); !ok && m.AuthenticationMode != "" {
...
var mappingCreateClientVpnDetailsAddressingModeEnumLowerCase = map[string]CreateClientVpnDetailsAddressingModeEnum{
	"nat":     CreateClientVpnDetailsAddressingModeNat,
	"routing": CreateClientVpnDetailsAddressingModeRouting,
}
...
// GetMappingCreateClientVpnDetailsAddressingModeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingCreateClientVpnDetailsAddressingModeEnum(val string) (CreateClientVpnDetailsAddressingModeEnum, bool) {
	enum, ok := mappingCreateClientVpnDetailsAddressingModeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingCreateClientVpnDetailsAuthenticationModeEnumLowerCase = map[string]CreateClientVpnDetailsAuthenticationModeEnum{
	"local":  CreateClientVpnDetailsAuthenticationModeLocal,
	"radius": CreateClientVpnDetailsAuthenticationModeRadius,
	"ldap":   CreateClientVpnDetailsAuthenticationModeLdap,
}
...
// GetMappingCreateClientVpnDetailsAuthenticationModeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingCreateClientVpnDetailsAuthenticationModeEnum(val string) (CreateClientVpnDetailsAuthenticationModeEnum, bool) {
	enum, ok := mappingCreateClientVpnDetailsAuthenticationModeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
