...
func (request GetCpeDeviceShapeRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["cpeDeviceShapeId"] != nil {
		templateParam := mandatoryParamMap["cpeDeviceShapeId"]
		for _, template := range templateParam {
			replacementParam := *request.CpeDeviceShapeId
