...
// CapacityBinPreview Total CPU and memory capacity for each capacity bucket.
type CapacityBinPreview struct {
...
func (m CapacityBinPreview) String() string {
...
func (m CapacityBinPreview) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
