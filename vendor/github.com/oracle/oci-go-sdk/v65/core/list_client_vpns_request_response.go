...
func (request ListClientVpnsRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
...
func (request ListClientVpnsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListClientVpnsSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
	...
	if _, ok := GetMappingListClientVpnsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
...
var mappingListClientVpnsSortByEnumLowerCase = map[string]ListClientVpnsSortByEnum{
	"timecreated": ListClientVpnsSortByTimecreated,
	"displayname": ListClientVpnsSortByDisplayname,
}
...
// GetMappingListClientVpnsSortByEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListClientVpnsSortByEnum(val string) (ListClientVpnsSortByEnum, bool) {
	enum, ok := mappingListClientVpnsSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListClientVpnsSortOrderEnumLowerCase = map[string]ListClientVpnsSortOrderEnum{
	"asc":  ListClientVpnsSortOrderAsc,
	"desc": ListClientVpnsSortOrderDesc,
}
...
// GetMappingListClientVpnsSortOrderEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListClientVpnsSortOrderEnum(val string) (ListClientVpnsSortOrderEnum, bool) {
	enum, ok := mappingListClientVpnsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
