...
type UpdateVirtualCircuitDetails struct {
	...
	// Set to `true` for the VC to carry only encrypted traffic, or set to `false` for the VC to carry unencrypted traffic. If this is not set, the default is `false`.
