...
type UpdateVirtualCircuitDetails struct {
	...
	// Set to `true` to enable Quality of Service (https://docs.oracle.com/iaas/Content/Network/Concepts/qos.htm) (QoS) bandwidth
	...
	// The Quality of Service (https://docs.oracle.com/iaas/Content/Network/Concepts/qos.htm) (QoS) bandwidth reservation
