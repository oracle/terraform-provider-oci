...
func (request ListNextHopsRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["endpointServiceId"] != nil {
		templateParam := mandatoryParamMap["endpointServiceId"]
		for _, template := range templateParam {
			replacementParam := *request.EndpointServiceId
