...
func (request GetResourceIpInventoryRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["dataRequestId"] != nil {
		templateParam := mandatoryParamMap["dataRequestId"]
		for _, template := range templateParam {
			replacementParam := *request.DataRequestId
