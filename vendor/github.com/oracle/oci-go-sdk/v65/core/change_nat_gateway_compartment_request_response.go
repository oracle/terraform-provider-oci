...
func (request ChangeNatGatewayCompartmentRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["natGatewayId"] != nil {
		templateParam := mandatoryParamMap["natGatewayId"]
		for _, template := range templateParam {
			replacementParam := *request.NatGatewayId
