...
func (request GetVolumeGroupReplicaRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["volumeGroupReplicaId"] != nil {
		templateParam := mandatoryParamMap["volumeGroupReplicaId"]
		for _, template := range templateParam {
			replacementParam := *request.VolumeGroupReplicaId
