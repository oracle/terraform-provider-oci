...
// EpDisintermediatedRoute Disintermediated routes
type EpDisintermediatedRoute struct {
...
func (m EpDisintermediatedRoute) String() string {
...
func (m EpDisintermediatedRoute) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
