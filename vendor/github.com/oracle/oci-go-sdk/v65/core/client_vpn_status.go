...
func (m ClientVpnStatus) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingClientVpnStatusLifecycleStateEnum(string(m.LifecycleState)); !ok && m.LifecycleState != "" {
...
var mappingClientVpnStatusLifecycleStateEnumLowerCase = map[string]ClientVpnStatusLifecycleStateEnum{
	"creating": ClientVpnStatusLifecycleStateCreating,
	"active":   ClientVpnStatusLifecycleStateActive,
	"inactive": ClientVpnStatusLifecycleStateInactive,
	"failed":   ClientVpnStatusLifecycleStateFailed,
...
// GetMappingClientVpnStatusLifecycleStateEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingClientVpnStatusLifecycleStateEnum(val string) (ClientVpnStatusLifecycleStateEnum, bool) {
	enum, ok := mappingClientVpnStatusLifecycleStateEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
