...
func (request ListFlowLogConfigsRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
...
func (request ListFlowLogConfigsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListFlowLogConfigsSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
	...
	if _, ok := GetMappingListFlowLogConfigsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
...
var mappingListFlowLogConfigsSortByEnumLowerCase = map[string]ListFlowLogConfigsSortByEnum{
	"timecreated": ListFlowLogConfigsSortByTimecreated,
	"displayname": ListFlowLogConfigsSortByDisplayname,
}
...
// GetMappingListFlowLogConfigsSortByEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListFlowLogConfigsSortByEnum(val string) (ListFlowLogConfigsSortByEnum, bool) {
	enum, ok := mappingListFlowLogConfigsSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
// GetMappingListFlowLogConfigsSortOrderEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListFlowLogConfigsSortOrderEnum(val string) (ListFlowLogConfigsSortOrderEnum, bool) {
	enum, ok := mappingListFlowLogConfigsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
