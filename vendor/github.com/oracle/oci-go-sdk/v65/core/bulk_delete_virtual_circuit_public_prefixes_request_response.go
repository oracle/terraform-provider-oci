...
func (request BulkDeleteVirtualCircuitPublicPrefixesRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["virtualCircuitId"] != nil {
		templateParam := mandatoryParamMap["virtualCircuitId"]
		for _, template := range templateParam {
			replacementParam := *request.VirtualCircuitId
