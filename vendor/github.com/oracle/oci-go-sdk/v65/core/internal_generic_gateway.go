...
type InternalGenericGateway struct {
	...
	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the gateway's compartment.
	...
	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the real gateway that this generic gateway stands for.
	...
	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN the generic gateway belongs to.
	VcnId *string `mandatory:"false" json:"vcnId"`

	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the route table associated with the gateway
	...
	// Resource T
	// ags (https://docs.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
...
func (m InternalGenericGateway) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingInternalGenericGatewayGatewayTypeEnum(string(m.GatewayType)); !ok && m.GatewayType != "" {
	...
	if _, ok := GetMappingInternalGenericGatewayLifecycleStateEnum(string(m.LifecycleState)); !ok && m.LifecycleState != "" {
...
var mappingInternalGenericGatewayGatewayTypeEnumLowerCase = map[string]InternalGenericGatewayGatewayTypeEnum{
	"servicegateway":       InternalGenericGatewayGatewayTypeServicegateway,
	"natgateway":           InternalGenericGatewayGatewayTypeNatgateway,
	"privateaccessgateway": InternalGenericGatewayGatewayTypePrivateaccessgateway,
}
...
// GetMappingInternalGenericGatewayGatewayTypeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingInternalGenericGatewayGatewayTypeEnum(val string) (InternalGenericGatewayGatewayTypeEnum, bool) {
	enum, ok := mappingInternalGenericGatewayGatewayTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingInternalGenericGatewayLifecycleStateEnumLowerCase = map[string]InternalGenericGatewayLifecycleStateEnum{
	"provisioning": InternalGenericGatewayLifecycleStateProvisioning,
	"available":    InternalGenericGatewayLifecycleStateAvailable,
	"attaching":    InternalGenericGatewayLifecycleStateAttaching,
	"attached":     InternalGenericGatewayLifecycleStateAttached,
...
// GetMappingInternalGenericGatewayLifecycleStateEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingInternalGenericGatewayLifecycleStateEnum(val string) (InternalGenericGatewayLifecycleStateEnum, bool) {
	enum, ok := mappingInternalGenericGatewayLifecycleStateEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
