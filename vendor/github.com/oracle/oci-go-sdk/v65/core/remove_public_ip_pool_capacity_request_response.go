...
func (request RemovePublicIpPoolCapacityRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["publicIpPoolId"] != nil {
		templateParam := mandatoryParamMap["publicIpPoolId"]
		for _, template := range templateParam {
			replacementParam := *request.PublicIpPoolId
