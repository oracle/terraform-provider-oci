...
func (request ChangeSecurityListCompartmentRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["securityListId"] != nil {
		templateParam := mandatoryParamMap["securityListId"]
		for _, template := range templateParam {
			replacementParam := *request.SecurityListId
