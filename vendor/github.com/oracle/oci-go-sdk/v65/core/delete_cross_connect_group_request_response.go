...
func (request DeleteCrossConnectGroupRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["crossConnectGroupId"] != nil {
		templateParam := mandatoryParamMap["crossConnectGroupId"]
		for _, template := range templateParam {
			replacementParam := *request.CrossConnectGroupId
