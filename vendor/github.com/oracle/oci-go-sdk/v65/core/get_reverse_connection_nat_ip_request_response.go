...
func (request GetReverseConnectionNatIpRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["reverseConnectionCustomerIp"] != nil {
		templateParam := mandatoryParamMap["reverseConnectionCustomerIp"]
		for _, template := range templateParam {
			replacementParam := *request.ReverseConnectionCustomerIp
