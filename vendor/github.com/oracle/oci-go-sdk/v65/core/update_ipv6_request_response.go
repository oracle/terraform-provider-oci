...
func (request UpdateIpv6Request) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["ipv6Id"] != nil {
		templateParam := mandatoryParamMap["ipv6Id"]
		for _, template := range templateParam {
			replacementParam := *request.Ipv6Id
