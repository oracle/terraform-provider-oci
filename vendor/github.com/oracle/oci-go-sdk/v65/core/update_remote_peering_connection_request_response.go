...
func (request UpdateRemotePeeringConnectionRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["remotePeeringConnectionId"] != nil {
		templateParam := mandatoryParamMap["remotePeeringConnectionId"]
		for _, template := range templateParam {
			replacementParam := *request.RemotePeeringConnectionId
