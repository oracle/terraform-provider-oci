...
func (request GetVtapRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["vtapId"] != nil {
		templateParam := mandatoryParamMap["vtapId"]
		for _, template := range templateParam {
			replacementParam := *request.VtapId
