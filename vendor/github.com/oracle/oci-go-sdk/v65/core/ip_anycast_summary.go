...
// IpAnycastSummary Provides the summary of IP Anycast object created.
type IpAnycastSummary struct {
	...
	// The OCID (https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the IP Anycast Object.
	...
	// The OCID (https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment where BYOIP prefix
	// will be provisioned.
	...
	// List of some keywords related to Anycast object.
	Tags []string `mandatory:"false" json:"tags"`
}

func (m IpAnycastSummary) String() string {
...
func (m IpAnycastSummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
