...
func (request UpdateBootVolumeKmsKeyRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["bootVolumeId"] != nil {
		templateParam := mandatoryParamMap["bootVolumeId"]
		for _, template := range templateParam {
			replacementParam := *request.BootVolumeId
