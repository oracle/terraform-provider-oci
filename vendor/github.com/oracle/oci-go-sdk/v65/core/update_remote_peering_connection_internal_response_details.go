...
type UpdateRemotePeeringConnectionInternalResponseDetails struct {
	...
	// The OCID (https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DRG that has the remote peering connection.
	...
	// The OCID (https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the tenant that contain the remote peering connection.
