...
type CreateInternalGenericGatewayDetails struct {
	...
	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the real gateway that this generic gateway represents.
...
func (m CreateInternalGenericGatewayDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingCreateInternalGenericGatewayDetailsGatewayTypeEnum(string(m.GatewayType)); !ok && m.GatewayType != "" {
...
var mappingCreateInternalGenericGatewayDetailsGatewayTypeEnumLowerCase = map[string]CreateInternalGenericGatewayDetailsGatewayTypeEnum{
	"servicegateway":       CreateInternalGenericGatewayDetailsGatewayTypeServicegateway,
	"natgateway":           CreateInternalGenericGatewayDetailsGatewayTypeNatgateway,
	"privateaccessgateway": CreateInternalGenericGatewayDetailsGatewayTypePrivateaccessgateway,
}
...
// GetMappingCreateInternalGenericGatewayDetailsGatewayTypeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingCreateInternalGenericGatewayDetailsGatewayTypeEnum(val string) (CreateInternalGenericGatewayDetailsGatewayTypeEnum, bool) {
	enum, ok := mappingCreateInternalGenericGatewayDetailsGatewayTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
