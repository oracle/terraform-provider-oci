...
// UpdateInternalServiceVnicShardDetails Service vnic shard config details to update shard. Note that the adConfigs` object you provide replaces the entire existing set of adConfigs.
type UpdateInternalServiceVnicShardDetails struct {
	...
	IpAddressForShardLevelAllocations *string `mandatory:"false" json:"ipAddressForShardLevelAllocations"`

	// Regional anycast IP for NLB service VNICs
	IpAddressForNlbRegional *string `mandatory:"false" json:"ipAddressForNlbRegional"`
...
func (m UpdateInternalServiceVnicShardDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
