...
func (request GetBootVolumeReplicaRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["bootVolumeReplicaId"] != nil {
		templateParam := mandatoryParamMap["bootVolumeReplicaId"]
		for _, template := range templateParam {
			replacementParam := *request.BootVolumeReplicaId
