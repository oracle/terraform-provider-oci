...
// ReleasePublicIpDetails Release public ip address
type ReleasePublicIpDetails struct {
...
func (m ReleasePublicIpDetails) String() string {
...
func (m ReleasePublicIpDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
