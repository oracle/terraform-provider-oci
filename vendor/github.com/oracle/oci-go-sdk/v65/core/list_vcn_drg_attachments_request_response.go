...
func (request ListVcnDrgAttachmentsRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
...
func (request ListVcnDrgAttachmentsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListVcnDrgAttachmentsAttachmentTypeEnum(string(request.AttachmentType)); !ok && request.AttachmentType != "" {
	...
	if _, ok := GetMappingListVcnDrgAttachmentsSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
	...
	if _, ok := GetMappingListVcnDrgAttachmentsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
...
var mappingListVcnDrgAttachmentsAttachmentTypeEnumLowerCase = map[string]ListVcnDrgAttachmentsAttachmentTypeEnum{
	"vcn":                       ListVcnDrgAttachmentsAttachmentTypeVcn,
	"virtual_circuit":           ListVcnDrgAttachmentsAttachmentTypeVirtualCircuit,
	"remote_peering_connection": ListVcnDrgAttachmentsAttachmentTypeRemotePeeringConnection,
	"ipsec_tunnel":              ListVcnDrgAttachmentsAttachmentTypeIpsecTunnel,
...
// GetMappingListVcnDrgAttachmentsAttachmentTypeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListVcnDrgAttachmentsAttachmentTypeEnum(val string) (ListVcnDrgAttachmentsAttachmentTypeEnum, bool) {
	enum, ok := mappingListVcnDrgAttachmentsAttachmentTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListVcnDrgAttachmentsSortByEnumLowerCase = map[string]ListVcnDrgAttachmentsSortByEnum{
	"timecreated": ListVcnDrgAttachmentsSortByTimecreated,
	"displayname": ListVcnDrgAttachmentsSortByDisplayname,
}
...
// GetMappingListVcnDrgAttachmentsSortByEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListVcnDrgAttachmentsSortByEnum(val string) (ListVcnDrgAttachmentsSortByEnum, bool) {
	enum, ok := mappingListVcnDrgAttachmentsSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListVcnDrgAttachmentsSortOrderEnumLowerCase = map[string]ListVcnDrgAttachmentsSortOrderEnum{
	"asc":  ListVcnDrgAttachmentsSortOrderAsc,
	"desc": ListVcnDrgAttachmentsSortOrderDesc,
}
...
// GetMappingListVcnDrgAttachmentsSortOrderEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListVcnDrgAttachmentsSortOrderEnum(val string) (ListVcnDrgAttachmentsSortOrderEnum, bool) {
	enum, ok := mappingListVcnDrgAttachmentsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
