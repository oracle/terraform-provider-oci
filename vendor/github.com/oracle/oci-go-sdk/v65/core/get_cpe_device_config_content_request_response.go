...
func (request GetCpeDeviceConfigContentRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["cpeId"] != nil {
		templateParam := mandatoryParamMap["cpeId"]
		for _, template := range templateParam {
			replacementParam := *request.CpeId
