...
func (request DeleteVolumeBackupRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["volumeBackupId"] != nil {
		templateParam := mandatoryParamMap["volumeBackupId"]
		for _, template := range templateParam {
			replacementParam := *request.VolumeBackupId
