...
type BulkCreatePrivateIpsDetails struct {
	...
	// Use this attribute only with the Oracle Cloud VMware Solution. The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN from which the private IPs is to be drawn. The IP addresses, *if supplied*, must be valid for the given VLAN. See Vlan.
...
func (m BulkCreatePrivateIpsDetails) String() string {
...
func (m BulkCreatePrivateIpsDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
