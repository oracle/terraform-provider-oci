...
func (request GetVolumeBackupPolicyAssetAssignmentRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["assetId"] != nil {
		templateParam := mandatoryParamMap["assetId"]
		for _, template := range templateParam {
			replacementParam := *request.AssetId
