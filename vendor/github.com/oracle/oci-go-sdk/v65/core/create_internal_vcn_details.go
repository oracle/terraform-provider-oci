...
// CreateInternalVcnDetails The representation of CreateInternalVcnDetails
type CreateInternalVcnDetails struct {
...
func (m CreateInternalVcnDetails) String() string {
...
func (m CreateInternalVcnDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
