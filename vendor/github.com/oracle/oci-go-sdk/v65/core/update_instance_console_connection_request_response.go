...
func (request UpdateInstanceConsoleConnectionRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["instanceConsoleConnectionId"] != nil {
		templateParam := mandatoryParamMap["instanceConsoleConnectionId"]
		for _, template := range templateParam {
			replacementParam := *request.InstanceConsoleConnectionId
