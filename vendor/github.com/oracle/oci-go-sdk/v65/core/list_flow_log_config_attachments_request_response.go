...
type ListFlowLogConfigAttachmentsRequest struct {
	...
	// The OCID (https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a resource that has flow logs enabled.
...
func (request ListFlowLogConfigAttachmentsRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
