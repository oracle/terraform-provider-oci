...
func (request GetDhcpOptionsRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["dhcpId"] != nil {
		templateParam := mandatoryParamMap["dhcpId"]
		for _, template := range templateParam {
			replacementParam := *request.DhcpId
