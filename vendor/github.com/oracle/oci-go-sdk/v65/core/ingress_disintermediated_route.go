...
// IngressDisintermediatedRoute Ingress Disintermediated routes
type IngressDisintermediatedRoute struct {
	...
	// common export RT of the route table
	CommonExportRt *int `mandatory:"false" json:"commonExportRt"`
}

func (m IngressDisintermediatedRoute) String() string {
...
func (m IngressDisintermediatedRoute) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
