...
func (request UpdateVolumeAttachmentRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["volumeAttachmentId"] != nil {
		templateParam := mandatoryParamMap["volumeAttachmentId"]
		for _, template := range templateParam {
			replacementParam := *request.VolumeAttachmentId
