...
func (request UpdateCaptureFilterRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["captureFilterId"] != nil {
		templateParam := mandatoryParamMap["captureFilterId"]
		for _, template := range templateParam {
			replacementParam := *request.CaptureFilterId
