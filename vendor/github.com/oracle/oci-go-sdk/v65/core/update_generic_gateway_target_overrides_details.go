...
// UpdateGenericGatewayTargetOverridesDetails Contains details indicating the destination CIDRs that needs to be overridden.
type UpdateGenericGatewayTargetOverridesDetails struct {
...
func (m UpdateGenericGatewayTargetOverridesDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
