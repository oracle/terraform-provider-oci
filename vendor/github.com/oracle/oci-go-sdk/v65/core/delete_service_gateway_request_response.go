...
func (request DeleteServiceGatewayRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["serviceGatewayId"] != nil {
		templateParam := mandatoryParamMap["serviceGatewayId"]
		for _, template := range templateParam {
			replacementParam := *request.ServiceGatewayId
