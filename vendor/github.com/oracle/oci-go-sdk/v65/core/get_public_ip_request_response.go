...
func (request GetPublicIpRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["publicIpId"] != nil {
		templateParam := mandatoryParamMap["publicIpId"]
		for _, template := range templateParam {
			replacementParam := *request.PublicIpId
