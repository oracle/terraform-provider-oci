...
func (request ChangeStreamPoolCompartmentRequest) ReplaceMandatoryParamInPath(client *common.BaseClient, mandatoryParamMap map[string][]common.TemplateParamForPerRealmEndpoint) {
	if mandatoryParamMap["streamPoolId"] != nil {
		templateParam := mandatoryParamMap["streamPoolId"]
		for _, template := range templateParam {
			replacementParam := *request.StreamPoolId
