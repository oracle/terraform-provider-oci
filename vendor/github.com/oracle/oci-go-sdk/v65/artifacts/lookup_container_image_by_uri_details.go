...
// LookupContainerImageByUriDetails Details for fetching a container image by its URI.
type LookupContainerImageByUriDetails struct {
...
func (m LookupContainerImageByUriDetails) String() string {
...
func (m LookupContainerImageByUriDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
