...
// UpdateVbsInstanceDetails The information to be updated.
type UpdateVbsInstanceDetails struct {
...
func (m UpdateVbsInstanceDetails) String() string {
...
func (m UpdateVbsInstanceDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
