...
func (m UpdateDatabaseToolsMcpToolsetCustomizableReportingToolsDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateDatabaseToolsMcpToolsetCustomizableReportingToolsDetails UpdateDatabaseToolsMcpToolsetCustomizableReportingToolsDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeUpdateDatabaseToolsMcpToolsetCustomizableReportingToolsDetails
	}{
		"CUSTOMIZABLE_REPORTING_TOOLS",
		(MarshalTypeUpdateDatabaseToolsMcpToolsetCustomizableReportingToolsDetails)(m),
	}
