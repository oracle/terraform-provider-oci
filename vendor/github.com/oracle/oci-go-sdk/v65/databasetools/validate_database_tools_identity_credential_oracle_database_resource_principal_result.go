...
func (m ValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalResult) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalResult ValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalResult
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalResult
	}{
		"ORACLE_DATABASE_RESOURCE_PRINCIPAL",
		(MarshalTypeValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalResult)(m),
	}
