...
func (m DatabaseToolsKeyStorePasswordSecretIdGenericJdbc) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsKeyStorePasswordSecretIdGenericJdbc DatabaseToolsKeyStorePasswordSecretIdGenericJdbc
	s := struct {
		DiscriminatorParam string `json:"valueType"`
		MarshalTypeDatabaseToolsKeyStorePasswordSecretIdGenericJdbc
	}{
		"SECRETID",
		(MarshalTypeDatabaseToolsKeyStorePasswordSecretIdGenericJdbc)(m),
	}
