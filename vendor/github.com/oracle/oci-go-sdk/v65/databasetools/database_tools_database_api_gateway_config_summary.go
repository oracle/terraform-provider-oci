...
type databasetoolsdatabaseapigatewayconfigsummary struct {
	JsonData         []byte
...
func (m *databasetoolsdatabaseapigatewayconfigsummary) UnmarshalJSON(data []byte) error {
	m.JsonData = data
	type Unmarshalerdatabasetoolsdatabaseapigatewayconfigsummary databasetoolsdatabaseapigatewayconfigsummary
	s := struct {
		Model Unmarshalerdatabasetoolsdatabaseapigatewayconfigsummary
	}{}
...
func (m *databasetoolsdatabaseapigatewayconfigsummary) UnmarshalPolymorphicJSON(data []byte) (interface{}, error) {
	...
	switch m.Type {
	case "DEFAULT":
		mm := DatabaseToolsDatabaseApiGatewayConfigDefaultSummary{}
		err = json.Unmarshal(data, &mm)
		return mm, err
	default:
		common.Logf("Received unsupported enum value for DatabaseToolsDatabaseApiGatewayConfigSummary: %s.", m.Type)
		return *m, nil
	}
}

// GetLifecycleDetails returns LifecycleDetails
func (m databasetoolsdatabaseapigatewayconfigsummary) GetLifecycleDetails() *string {
	return m.LifecycleDetails
}

// GetDefinedTags returns DefinedTags
func (m databasetoolsdatabaseapigatewayconfigsummary) GetDefinedTags() map[string]map[string]interface{} {
	return m.DefinedTags
}

// GetFreeformTags returns FreeformTags
func (m databasetoolsdatabaseapigatewayconfigsummary) GetFreeformTags() map[string]string {
	return m.FreeformTags
}

// GetSystemTags returns SystemTags
func (m databasetoolsdatabaseapigatewayconfigsummary) GetSystemTags() map[string]map[string]interface{} {
	return m.SystemTags
}

// GetLocks returns Locks
func (m databasetoolsdatabaseapigatewayconfigsummary) GetLocks() []ResourceLock {
	return m.Locks
}

// GetId returns Id
func (m databasetoolsdatabaseapigatewayconfigsummary) GetId() *string {
	return m.Id
}

// GetCompartmentId returns CompartmentId
func (m databasetoolsdatabaseapigatewayconfigsummary) GetCompartmentId() *string {
	return m.CompartmentId
}

// GetDisplayName returns DisplayName
func (m databasetoolsdatabaseapigatewayconfigsummary) GetDisplayName() *string {
	return m.DisplayName
}

// GetMetadataSource returns MetadataSource
func (m databasetoolsdatabaseapigatewayconfigsummary) GetMetadataSource() DatabaseApiGatewayConfigMetadataSourceEnum {
	return m.MetadataSource
}

// GetLifecycleState returns LifecycleState
func (m databasetoolsdatabaseapigatewayconfigsummary) GetLifecycleState() DatabaseToolsDatabaseApiGatewayConfigLifecycleStateEnum {
	return m.LifecycleState
}

// GetTimeCreated returns TimeCreated
func (m databasetoolsdatabaseapigatewayconfigsummary) GetTimeCreated() *common.SDKTime {
	return m.TimeCreated
}

// GetTimeUpdated returns TimeUpdated
func (m databasetoolsdatabaseapigatewayconfigsummary) GetTimeUpdated() *common.SDKTime {
	return m.TimeUpdated
}

func (m databasetoolsdatabaseapigatewayconfigsummary) String() string {
...
func (m databasetoolsdatabaseapigatewayconfigsummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
