...
func (m CreateDatabaseToolsSqlReportOracleDatabaseDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDatabaseToolsSqlReportOracleDatabaseDetails CreateDatabaseToolsSqlReportOracleDatabaseDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCreateDatabaseToolsSqlReportOracleDatabaseDetails
	}{
		"ORACLE_DATABASE",
		(MarshalTypeCreateDatabaseToolsSqlReportOracleDatabaseDetails)(m),
	}
