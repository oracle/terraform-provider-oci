...
func (m DatabaseToolsMcpToolsetVersionBuiltInSqlToolsSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsMcpToolsetVersionBuiltInSqlToolsSummary DatabaseToolsMcpToolsetVersionBuiltInSqlToolsSummary
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeDatabaseToolsMcpToolsetVersionBuiltInSqlToolsSummary
	}{
		"BUILT_IN_SQL_TOOLS",
		(MarshalTypeDatabaseToolsMcpToolsetVersionBuiltInSqlToolsSummary)(m),
	}
