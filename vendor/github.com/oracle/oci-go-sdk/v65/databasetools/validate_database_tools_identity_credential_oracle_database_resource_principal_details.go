...
func (m ValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalDetails ValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalDetails
	}{
		"ORACLE_DATABASE_RESOURCE_PRINCIPAL",
		(MarshalTypeValidateDatabaseToolsIdentityCredentialOracleDatabaseResourcePrincipalDetails)(m),
	}
