...
func (m DatabaseToolsMcpServerStorageNone) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsMcpServerStorageNone DatabaseToolsMcpServerStorageNone
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeDatabaseToolsMcpServerStorageNone
	}{
		"NONE",
		(MarshalTypeDatabaseToolsMcpServerStorageNone)(m),
	}
