...
var mappingDatabaseApiGatewayConfigMetadataSourceEnum = map[string]DatabaseApiGatewayConfigMetadataSourceEnum{
	"DATABASE": DatabaseApiGatewayConfigMetadataSourceDatabase,
	"CLOUD":    DatabaseApiGatewayConfigMetadataSourceCloud,
}

var mappingDatabaseApiGatewayConfigMetadataSourceEnumLowerCase = map[string]DatabaseApiGatewayConfigMetadataSourceEnum{
	"database": DatabaseApiGatewayConfigMetadataSourceDatabase,
	"cloud":    DatabaseApiGatewayConfigMetadataSourceCloud,
}
...
func GetDatabaseApiGatewayConfigMetadataSourceEnumValues() []DatabaseApiGatewayConfigMetadataSourceEnum {
	values := make([]DatabaseApiGatewayConfigMetadataSourceEnum, 0)
	for _, v := range mappingDatabaseApiGatewayConfigMetadataSourceEnum {
...
func GetMappingDatabaseApiGatewayConfigMetadataSourceEnum(val string) (DatabaseApiGatewayConfigMetadataSourceEnum, bool) {
	enum, ok := mappingDatabaseApiGatewayConfigMetadataSourceEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
