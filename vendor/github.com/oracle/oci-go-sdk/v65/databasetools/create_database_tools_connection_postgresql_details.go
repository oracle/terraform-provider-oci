...
func (m CreateDatabaseToolsConnectionPostgresqlDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateDatabaseToolsConnectionPostgresqlDetails CreateDatabaseToolsConnectionPostgresqlDetails
	s := struct {
		DiscriminatorParam string `json:"type"`
		MarshalTypeCreateDatabaseToolsConnectionPostgresqlDetails
	}{
		"POSTGRESQL",
		(MarshalTypeCreateDatabaseToolsConnectionPostgresqlDetails)(m),
	}
