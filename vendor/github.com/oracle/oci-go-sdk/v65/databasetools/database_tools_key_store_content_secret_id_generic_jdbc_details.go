...
func (m DatabaseToolsKeyStoreContentSecretIdGenericJdbcDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsKeyStoreContentSecretIdGenericJdbcDetails DatabaseToolsKeyStoreContentSecretIdGenericJdbcDetails
	s := struct {
		DiscriminatorParam string `json:"valueType"`
		MarshalTypeDatabaseToolsKeyStoreContentSecretIdGenericJdbcDetails
	}{
		"SECRETID",
		(MarshalTypeDatabaseToolsKeyStoreContentSecretIdGenericJdbcDetails)(m),
	}
