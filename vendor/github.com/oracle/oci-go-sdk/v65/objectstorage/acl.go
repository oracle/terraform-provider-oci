...
// Acl Short for Access-Control List, this is a list of network restriction rules. ACL Groups contain a list of ACLs to
// restrict the networks from which a request can originate.
type Acl struct {
...
func (m Acl) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
