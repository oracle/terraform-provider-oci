...
// CheckObjectV2Result The contents of CheckObjectV2 API's response body
type CheckObjectV2Result struct {
...
func (m CheckObjectV2Result) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
