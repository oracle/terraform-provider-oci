...
// BucketNameFilter A filter that compares bucket names to a set of prefixes or patterns to determine if a rule applies to a
// given bucket. The filter can contain include glob patterns, exclude glob patterns and inclusion prefixes.
...
func (m BucketNameFilter) String() string {
...
func (m BucketNameFilter) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
