...
// BatchDeleteObjectsDetails Batch delete request details.
type BatchDeleteObjectsDetails struct {
...
func (m BatchDeleteObjectsDetails) String() string {
...
func (m BatchDeleteObjectsDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
