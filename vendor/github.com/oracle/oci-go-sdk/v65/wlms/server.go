...
func (m Server) ValidateEnumValue() (bool, error) {
	...
	if _, ok := GetMappingServerLatestPatchesStatusEnum(string(m.LatestPatchesStatus)); !ok && m.LatestPatchesStatus != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for LatestPatchesStatus: %s. Supported values are: %s.", m.LatestPatchesStatus, strings.Join(GetServerLatestPatchesStatusEnumStringValues(), ",")))
	}
...
var mappingServerLatestPatchesStatusEnum = map[string]ServerLatestPatchesStatusEnum{
	"ON_LATEST_PATCHES": ServerLatestPatchesStatusOnLatestPatches,
	"PATCHING_REQUIRED": ServerLatestPatchesStatusPatchingRequired,
	"UNKNOWN":           ServerLatestPatchesStatusUnknown,
}

var mappingServerLatestPatchesStatusEnumLowerCase = map[string]ServerLatestPatchesStatusEnum{
	"on_latest_patches": ServerLatestPatchesStatusOnLatestPatches,
	"patching_required": ServerLatestPatchesStatusPatchingRequired,
	"unknown":           ServerLatestPatchesStatusUnknown,
}
...
func GetServerLatestPatchesStatusEnumValues() []ServerLatestPatchesStatusEnum {
	values := make([]ServerLatestPatchesStatusEnum, 0)
	for _, v := range mappingServerLatestPatchesStatusEnum {
...
func GetMappingServerLatestPatchesStatusEnum(val string) (ServerLatestPatchesStatusEnum, bool) {
	enum, ok := mappingServerLatestPatchesStatusEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
