...
func (request SynchronizeAutonomousDatabaseToExadataRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request SynchronizeAutonomousDatabaseToExadataRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request SynchronizeAutonomousDatabaseToExadataRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request SynchronizeAutonomousDatabaseToExadataRequest) RetryPolicy() *common.RetryPolicy {
...
func (request SynchronizeAutonomousDatabaseToExadataRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
...
// SynchronizeAutonomousDatabaseToExadataResponse wrapper for the SynchronizeAutonomousDatabaseToExadata operation
type SynchronizeAutonomousDatabaseToExadataResponse struct {
...
func (response SynchronizeAutonomousDatabaseToExadataResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response SynchronizeAutonomousDatabaseToExadataResponse) HTTPResponse() *http.Response {
