...
func (m MacsManagedCloudExadataInsightSummary) GetChargebackPlanDetails() *ChargebackPlanDetails {
...
func (m MacsManagedCloudExadataInsightSummary) GetStatusDetails() *string {
