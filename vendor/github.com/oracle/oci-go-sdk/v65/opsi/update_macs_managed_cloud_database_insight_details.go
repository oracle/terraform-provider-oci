...
type UpdateMacsManagedCloudDatabaseInsightDetails struct {
...
func (m UpdateMacsManagedCloudDatabaseInsightDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateMacsManagedCloudDatabaseInsightDetails UpdateMacsManagedCloudDatabaseInsightDetails
	s := struct {
		DiscriminatorParam string `json:"entitySource"`
		MarshalTypeUpdateMacsManagedCloudDatabaseInsightDetails
	}{
		"MACS_MANAGED_CLOUD_DATABASE",
		(MarshalTypeUpdateMacsManagedCloudDatabaseInsightDetails)(m),
	}
