...
func (m MacsManagedCloudHostConfigurationSummary) GetGpuName() *string {
	return m.GpuName
}

// GetGpuVendor returns GpuVendor
func (m MacsManagedCloudHostConfigurationSummary) GetGpuVendor() *string {
	return m.GpuVendor
}

// GetTotalGpus returns TotalGpus
func (m MacsManagedCloudHostConfigurationSummary) GetTotalGpus() *int {
	return m.TotalGpus
}
