...
// ChangeMacsManagedAutonomousDatabaseInsightConnectionDetails Connection details of a MACS-managed autonomous database insight.
type ChangeMacsManagedAutonomousDatabaseInsightConnectionDetails struct {
...
func (m ChangeMacsManagedAutonomousDatabaseInsightConnectionDetails) String() string {
...
func (m ChangeMacsManagedAutonomousDatabaseInsightConnectionDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m *ChangeMacsManagedAutonomousDatabaseInsightConnectionDetails) UnmarshalJSON(data []byte) (e error) {
	model := struct {
