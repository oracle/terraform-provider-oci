...
type ExternalMysqlDatabaseInsightSummary struct {
	...
	// The DBM owned database connector OCID (https://docs.oracle.com/iaas/iaas/database-management/doc/view-connector-details.html) mapping to the database credentials and connection details.
