...
// CreateVirtualAutonomousDatabaseCloneDetails Details to create an Oracle Autonomous Database virtual clone.
type CreateVirtualAutonomousDatabaseCloneDetails struct {
...
func (m CreateVirtualAutonomousDatabaseCloneDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
...
func (m CreateVirtualAutonomousDatabaseCloneDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateVirtualAutonomousDatabaseCloneDetails CreateVirtualAutonomousDatabaseCloneDetails
	s := struct {
		DiscriminatorParam string `json:"source"`
		MarshalTypeCreateVirtualAutonomousDatabaseCloneDetails
	}{
		"CLONE_TO_VIRTUAL",
		(MarshalTypeCreateVirtualAutonomousDatabaseCloneDetails)(m),
	}
