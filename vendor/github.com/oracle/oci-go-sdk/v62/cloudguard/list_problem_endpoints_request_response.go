...
func (request ListProblemEndpointsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListProblemEndpointsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
	...
	if _, ok := GetMappingListProblemEndpointsSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
...
var mappingListProblemEndpointsSortOrderEnumLowerCase = map[string]ListProblemEndpointsSortOrderEnum{
	"asc":  ListProblemEndpointsSortOrderAsc,
	"desc": ListProblemEndpointsSortOrderDesc,
}
...
func GetMappingListProblemEndpointsSortOrderEnum(val string) (ListProblemEndpointsSortOrderEnum, bool) {
	enum, ok := mappingListProblemEndpointsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListProblemEndpointsSortByEnumLowerCase = map[string]ListProblemEndpointsSortByEnum{
	"timecreated": ListProblemEndpointsSortByTimecreated,
}
...
func GetMappingListProblemEndpointsSortByEnum(val string) (ListProblemEndpointsSortByEnum, bool) {
	enum, ok := mappingListProblemEndpointsSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
