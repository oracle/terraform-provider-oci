...
func (m UpdateOkeBlueGreenDeployStageDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateOkeBlueGreenDeployStageDetails UpdateOkeBlueGreenDeployStageDetails
	s := struct {
		DiscriminatorParam string `json:"deployStageType"`
		MarshalTypeUpdateOkeBlueGreenDeployStageDetails
	}{
		"OKE_BLUE_GREEN_DEPLOYMENT",
		(MarshalTypeUpdateOkeBlueGreenDeployStageDetails)(m),
	}
