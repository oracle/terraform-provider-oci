...
func (m InternalDrgAttachment) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingInternalDrgAttachmentLifecycleStateEnum(string(m.LifecycleState)); !ok && m.LifecycleState != "" {
...
var mappingInternalDrgAttachmentLifecycleStateEnumLowerCase = map[string]InternalDrgAttachmentLifecycleStateEnum{
	"attaching": InternalDrgAttachmentLifecycleStateAttaching,
	"attached":  InternalDrgAttachmentLifecycleStateAttached,
	"detaching": InternalDrgAttachmentLifecycleStateDetaching,
	"detached":  InternalDrgAttachmentLifecycleStateDetached,
...
// GetMappingInternalDrgAttachmentLifecycleStateEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingInternalDrgAttachmentLifecycleStateEnum(val string) (InternalDrgAttachmentLifecycleStateEnum, bool) {
	enum, ok := mappingInternalDrgAttachmentLifecycleStateEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
