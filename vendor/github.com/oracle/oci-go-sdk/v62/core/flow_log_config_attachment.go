...
func (m FlowLogConfigAttachment) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingFlowLogConfigAttachmentLifecycleStateEnum(string(m.LifecycleState)); !ok && m.LifecycleState != "" {
	...
	if _, ok := GetMappingFlowLogConfigAttachmentTargetEntityTypeEnum(string(m.TargetEntityType)); !ok && m.TargetEntityType != "" {
...
// GetMappingFlowLogConfigAttachmentLifecycleStateEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingFlowLogConfigAttachmentLifecycleStateEnum(val string) (FlowLogConfigAttachmentLifecycleStateEnum, bool) {
	enum, ok := mappingFlowLogConfigAttachmentLifecycleStateEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
// GetMappingFlowLogConfigAttachmentTargetEntityTypeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingFlowLogConfigAttachmentTargetEntityTypeEnum(val string) (FlowLogConfigAttachmentTargetEntityTypeEnum, bool) {
	enum, ok := mappingFlowLogConfigAttachmentTargetEntityTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
