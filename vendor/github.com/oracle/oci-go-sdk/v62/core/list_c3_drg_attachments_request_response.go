...
func (request ListC3DrgAttachmentsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListC3DrgAttachmentsAttachmentTypeEnum(string(request.AttachmentType)); !ok && request.AttachmentType != "" {
	...
	if _, ok := GetMappingListC3DrgAttachmentsSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
	...
	if _, ok := GetMappingListC3DrgAttachmentsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
...
var mappingListC3DrgAttachmentsAttachmentTypeEnumLowerCase = map[string]ListC3DrgAttachmentsAttachmentTypeEnum{
	"vcn":                       ListC3DrgAttachmentsAttachmentTypeVcn,
	"virtual_circuit":           ListC3DrgAttachmentsAttachmentTypeVirtualCircuit,
	"remote_peering_connection": ListC3DrgAttachmentsAttachmentTypeRemotePeeringConnection,
	"ipsec_tunnel":              ListC3DrgAttachmentsAttachmentTypeIpsecTunnel,
...
// GetMappingListC3DrgAttachmentsAttachmentTypeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListC3DrgAttachmentsAttachmentTypeEnum(val string) (ListC3DrgAttachmentsAttachmentTypeEnum, bool) {
	enum, ok := mappingListC3DrgAttachmentsAttachmentTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListC3DrgAttachmentsSortByEnumLowerCase = map[string]ListC3DrgAttachmentsSortByEnum{
	"timecreated": ListC3DrgAttachmentsSortByTimecreated,
	"displayname": ListC3DrgAttachmentsSortByDisplayname,
}
...
// GetMappingListC3DrgAttachmentsSortByEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListC3DrgAttachmentsSortByEnum(val string) (ListC3DrgAttachmentsSortByEnum, bool) {
	enum, ok := mappingListC3DrgAttachmentsSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListC3DrgAttachmentsSortOrderEnumLowerCase = map[string]ListC3DrgAttachmentsSortOrderEnum{
	"asc":  ListC3DrgAttachmentsSortOrderAsc,
	"desc": ListC3DrgAttachmentsSortOrderDesc,
}
...
// GetMappingListC3DrgAttachmentsSortOrderEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListC3DrgAttachmentsSortOrderEnum(val string) (ListC3DrgAttachmentsSortOrderEnum, bool) {
	enum, ok := mappingListC3DrgAttachmentsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
