...
func (request ListInternalPublicIpsRequest) HTTPRequest(method, path string) (http.Request, error) {
...
var mappingListInternalPublicIpsScope = map[string]ListInternalPublicIpsScopeEnum{
...
func GetListInternalPublicIpsScopeEnumValues() []ListInternalPublicIpsScopeEnum {
	...
	for _, v := range mappingListInternalPublicIpsScope {
...
var mappingListInternalPublicIpsLifetime = map[string]ListInternalPublicIpsLifetimeEnum{
...
func GetListInternalPublicIpsLifetimeEnumValues() []ListInternalPublicIpsLifetimeEnum {
	...
	for _, v := range mappingListInternalPublicIpsLifetime {
		values = append(values, v)
	}
	return values
}
