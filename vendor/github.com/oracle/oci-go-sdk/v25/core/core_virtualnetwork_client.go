...
func (client VirtualNetworkClient) listReverseConnectionNatIpCidrs(ctx context.Context, request common.OCIRequest) (common.OCIResponse, error) {
	httpRequest, err := request.HTTPRequest(http.MethodGet, "/reverseConnectionNatIpCidrs")
	if err != nil {
		return nil, err
	}
