...
func (request ListPrivateEndpointAssociationsRequest) HTTPRequest(method, path string) (http.Request, error) {
...
var mappingListPrivateEndpointAssociationsSortBy = map[string]ListPrivateEndpointAssociationsSortByEnum{
...
func GetListPrivateEndpointAssociationsSortByEnumValues() []ListPrivateEndpointAssociationsSortByEnum {
	...
	for _, v := range mappingListPrivateEndpointAssociationsSortBy {
...
var mappingListPrivateEndpointAssociationsSortOrder = map[string]ListPrivateEndpointAssociationsSortOrderEnum{
...
func GetListPrivateEndpointAssociationsSortOrderEnumValues() []ListPrivateEndpointAssociationsSortOrderEnum {
	...
	for _, v := range mappingListPrivateEndpointAssociationsSortOrder {
		values = append(values, v)
	}
	return values
}
