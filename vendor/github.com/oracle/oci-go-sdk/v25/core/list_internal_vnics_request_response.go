...
func (request ListInternalVnicsRequest) HTTPRequest(method, path string) (http.Request, error) {
...
var mappingListInternalVnicsSortBy = map[string]ListInternalVnicsSortByEnum{
...
func GetListInternalVnicsSortByEnumValues() []ListInternalVnicsSortByEnum {
	...
	for _, v := range mappingListInternalVnicsSortBy {
...
var mappingListInternalVnicsSortOrder = map[string]ListInternalVnicsSortOrderEnum{
...
func GetListInternalVnicsSortOrderEnumValues() []ListInternalVnicsSortOrderEnum {
	...
	for _, v := range mappingListInternalVnicsSortOrder {
		values = append(values, v)
	}
	return values
}
