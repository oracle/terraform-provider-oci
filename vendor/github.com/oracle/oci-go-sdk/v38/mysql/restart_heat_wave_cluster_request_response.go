...
type RestartHeatWaveClusterRequest struct {
...
func (request RestartHeatWaveClusterRequest) HTTPRequest(method, path string) (http.Request, error) {
...
type RestartHeatWaveClusterResponse struct {
