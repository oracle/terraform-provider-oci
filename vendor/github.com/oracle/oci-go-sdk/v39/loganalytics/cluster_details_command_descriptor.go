...
func (m ClusterDetailsCommandDescriptor) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeClusterDetailsCommandDescriptor ClusterDetailsCommandDescriptor
	s := struct {
		DiscriminatorParam string `json:"name"`
		MarshalTypeClusterDetailsCommandDescriptor
	}{
		"CLUSTER_DETAILS",
		(MarshalTypeClusterDetailsCommandDescriptor)(m),
	}
