...
func (m TimeCompareCommandDescriptor) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeTimeCompareCommandDescriptor TimeCompareCommandDescriptor
	s := struct {
		DiscriminatorParam string `json:"name"`
		MarshalTypeTimeCompareCommandDescriptor
	}{
		"TIME_COMPARE",
		(MarshalTypeTimeCompareCommandDescriptor)(m),
	}
