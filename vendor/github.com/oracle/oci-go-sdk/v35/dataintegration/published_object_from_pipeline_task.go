...
func (m PublishedObjectFromPipelineTask) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePublishedObjectFromPipelineTask PublishedObjectFromPipelineTask
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypePublishedObjectFromPipelineTask
	}{
		"PIPELINE_TASK",
		(MarshalTypePublishedObjectFromPipelineTask)(m),
	}
