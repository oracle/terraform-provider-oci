...
func (m UpdateNonAdbAutoCreateTablespaceDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateNonAdbAutoCreateTablespaceDetails UpdateNonAdbAutoCreateTablespaceDetails
	s := struct {
		DiscriminatorParam string `json:"targetType"`
		MarshalTypeUpdateNonAdbAutoCreateTablespaceDetails
	}{
		"NON_ADB_AUTOCREATE",
		(MarshalTypeUpdateNonAdbAutoCreateTablespaceDetails)(m),
	}
