...
func (request DeleteApmDomainRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser) (http.Request, error) {
...
type DeleteApmDomainResponse struct {
