...
func (m ReverseConnectionConfiguration) ValidateEnumValue() (bool, error) {
	...
	if _, ok := GetMappingReverseConnectionConfigurationLifecycleStateEnum(string(m.LifecycleState)); !ok && m.LifecycleState != "" {
	...
	for _, val := range m.ProxyType {
		if _, ok := GetMappingReverseConnectionConfigurationProxyTypeEnum(string(val)); !ok && val != "" {
	...
	if _, ok := GetMappingReverseConnectionConfigurationDefaultDnsResolutionContextEnum(string(m.DefaultDnsResolutionContext)); !ok && m.DefaultDnsResolutionContext != "" {
	...
	if _, ok := GetMappingReverseConnectionConfigurationDefaultDnsContextTransportEnum(string(m.DefaultDnsContextTransport)); !ok && m.DefaultDnsContextTransport != "" {
...
var mappingReverseConnectionConfigurationLifecycleStateEnumLowerCase = map[string]ReverseConnectionConfigurationLifecycleStateEnum{
	"provisioning": ReverseConnectionConfigurationLifecycleStateProvisioning,
	"available":    ReverseConnectionConfigurationLifecycleStateAvailable,
	"updating":     ReverseConnectionConfigurationLifecycleStateUpdating,
	"terminating":  ReverseConnectionConfigurationLifecycleStateTerminating,
...
// GetMappingReverseConnectionConfigurationLifecycleStateEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingReverseConnectionConfigurationLifecycleStateEnum(val string) (ReverseConnectionConfigurationLifecycleStateEnum, bool) {
	enum, ok := mappingReverseConnectionConfigurationLifecycleStateEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingReverseConnectionConfigurationProxyTypeEnumLowerCase = map[string]ReverseConnectionConfigurationProxyTypeEnum{
	"dns":  ReverseConnectionConfigurationProxyTypeDns,
	"scan": ReverseConnectionConfigurationProxyTypeScan,
}
...
// GetMappingReverseConnectionConfigurationProxyTypeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingReverseConnectionConfigurationProxyTypeEnum(val string) (ReverseConnectionConfigurationProxyTypeEnum, bool) {
	enum, ok := mappingReverseConnectionConfigurationProxyTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingReverseConnectionConfigurationDefaultDnsResolutionContextEnumLowerCase = map[string]ReverseConnectionConfigurationDefaultDnsResolutionContextEnum{
	"service":  ReverseConnectionConfigurationDefaultDnsResolutionContextService,
	"customer": ReverseConnectionConfigurationDefaultDnsResolutionContextCustomer,
}
...
// GetMappingReverseConnectionConfigurationDefaultDnsResolutionContextEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingReverseConnectionConfigurationDefaultDnsResolutionContextEnum(val string) (ReverseConnectionConfigurationDefaultDnsResolutionContextEnum, bool) {
	enum, ok := mappingReverseConnectionConfigurationDefaultDnsResolutionContextEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingReverseConnectionConfigurationDefaultDnsContextTransportEnumLowerCase = map[string]ReverseConnectionConfigurationDefaultDnsContextTransportEnum{
	"tcp": ReverseConnectionConfigurationDefaultDnsContextTransportTcp,
	"udp": ReverseConnectionConfigurationDefaultDnsContextTransportUdp,
}
...
// GetMappingReverseConnectionConfigurationDefaultDnsContextTransportEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingReverseConnectionConfigurationDefaultDnsContextTransportEnum(val string) (ReverseConnectionConfigurationDefaultDnsContextTransportEnum, bool) {
	enum, ok := mappingReverseConnectionConfigurationDefaultDnsContextTransportEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
