...
func (m InternalPublicIp) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingInternalPublicIpLifetimeEnum(string(m.Lifetime)); !ok && m.Lifetime != "" {
	...
	if _, ok := GetMappingInternalPublicIpAssignedEntityTypeEnum(string(m.AssignedEntityType)); !ok && m.AssignedEntityType != "" {
	...
	if _, ok := GetMappingInternalPublicIpLifecycleStateEnum(string(m.LifecycleState)); !ok && m.LifecycleState != "" {
	...
	if _, ok := GetMappingInternalPublicIpScopeEnum(string(m.Scope)); !ok && m.Scope != "" {
...
var mappingInternalPublicIpAssignedEntityTypeEnumLowerCase = map[string]InternalPublicIpAssignedEntityTypeEnum{
	"private_ip":  InternalPublicIpAssignedEntityTypePrivateIp,
	"nat_gateway": InternalPublicIpAssignedEntityTypeNatGateway,
}
...
// GetMappingInternalPublicIpAssignedEntityTypeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingInternalPublicIpAssignedEntityTypeEnum(val string) (InternalPublicIpAssignedEntityTypeEnum, bool) {
	enum, ok := mappingInternalPublicIpAssignedEntityTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingInternalPublicIpLifecycleStateEnumLowerCase = map[string]InternalPublicIpLifecycleStateEnum{
	"provisioning": InternalPublicIpLifecycleStateProvisioning,
	"available":    InternalPublicIpLifecycleStateAvailable,
	"assigning":    InternalPublicIpLifecycleStateAssigning,
	"assigned":     InternalPublicIpLifecycleStateAssigned,
...
// GetMappingInternalPublicIpLifecycleStateEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingInternalPublicIpLifecycleStateEnum(val string) (InternalPublicIpLifecycleStateEnum, bool) {
	enum, ok := mappingInternalPublicIpLifecycleStateEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingInternalPublicIpLifetimeEnumLowerCase = map[string]InternalPublicIpLifetimeEnum{
	"ephemeral": InternalPublicIpLifetimeEphemeral,
	"reserved":  InternalPublicIpLifetimeReserved,
}
...
// GetMappingInternalPublicIpLifetimeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingInternalPublicIpLifetimeEnum(val string) (InternalPublicIpLifetimeEnum, bool) {
	enum, ok := mappingInternalPublicIpLifetimeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingInternalPublicIpScopeEnumLowerCase = map[string]InternalPublicIpScopeEnum{
	"region":              InternalPublicIpScopeRegion,
	"availability_domain": InternalPublicIpScopeAvailabilityDomain,
}
...
// GetMappingInternalPublicIpScopeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingInternalPublicIpScopeEnum(val string) (InternalPublicIpScopeEnum, bool) {
	enum, ok := mappingInternalPublicIpScopeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
