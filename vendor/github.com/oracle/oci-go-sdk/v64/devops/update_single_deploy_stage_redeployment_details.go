...
func (m UpdateSingleDeployStageRedeploymentDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateSingleDeployStageRedeploymentDetails UpdateSingleDeployStageRedeploymentDetails
	s := struct {
		DiscriminatorParam string `json:"deploymentType"`
		MarshalTypeUpdateSingleDeployStageRedeploymentDetails
	}{
		"SINGLE_STAGE_REDEPLOYMENT",
		(MarshalTypeUpdateSingleDeployStageRedeploymentDetails)(m),
	}
