...
func (m ComputeInstanceGroupCanaryApprovalDeployStageSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeComputeInstanceGroupCanaryApprovalDeployStageSummary ComputeInstanceGroupCanaryApprovalDeployStageSummary
	s := struct {
		DiscriminatorParam string `json:"deployStageType"`
		MarshalTypeComputeInstanceGroupCanaryApprovalDeployStageSummary
	}{
		"COMPUTE_INSTANCE_GROUP_CANARY_APPROVAL",
		(MarshalTypeComputeInstanceGroupCanaryApprovalDeployStageSummary)(m),
	}
