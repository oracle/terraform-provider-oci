...
func (m UpdateNonAdbRemapTablespaceDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateNonAdbRemapTablespaceDetails UpdateNonAdbRemapTablespaceDetails
	s := struct {
		DiscriminatorParam string `json:"targetType"`
		MarshalTypeUpdateNonAdbRemapTablespaceDetails
	}{
		"NON_ADB_REMAP",
		(MarshalTypeUpdateNonAdbRemapTablespaceDetails)(m),
	}
