...
// UpdateMetricBasedHorizontalScalingPolicyDetails Update details of a metric based horizontal autoscaling policy.
...
func (m UpdateMetricBasedHorizontalScalingPolicyDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateMetricBasedHorizontalScalingPolicyDetails UpdateMetricBasedHorizontalScalingPolicyDetails
	s := struct {
		DiscriminatorParam string `json:"policyType"`
		MarshalTypeUpdateMetricBasedHorizontalScalingPolicyDetails
	}{
		"METRIC_BASED_HORIZONTAL_SCALING_POLICY",
		(MarshalTypeUpdateMetricBasedHorizontalScalingPolicyDetails)(m),
	}
