...
func (m DatabaseToolsKeyStorePasswordSecretIdMySqlDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsKeyStorePasswordSecretIdMySqlDetails DatabaseToolsKeyStorePasswordSecretIdMySqlDetails
	s := struct {
		DiscriminatorParam string `json:"valueType"`
		MarshalTypeDatabaseToolsKeyStorePasswordSecretIdMySqlDetails
	}{
		"SECRETID",
		(MarshalTypeDatabaseToolsKeyStorePasswordSecretIdMySqlDetails)(m),
	}
