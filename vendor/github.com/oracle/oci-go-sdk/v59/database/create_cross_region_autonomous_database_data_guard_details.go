...
func (m CreateCrossRegionAutonomousDatabaseDataGuardDetails) GetIsOracleServiceGatewayAllowed() *bool {
...
func (m CreateCrossRegionAutonomousDatabaseDataGuardDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateCrossRegionAutonomousDatabaseDataGuardDetails CreateCrossRegionAutonomousDatabaseDataGuardDetails
	s := struct {
		DiscriminatorParam string `json:"source"`
		MarshalTypeCreateCrossRegionAutonomousDatabaseDataGuardDetails
	}{
		"CROSS_REGION_DATAGUARD",
		(MarshalTypeCreateCrossRegionAutonomousDatabaseDataGuardDetails)(m),
	}
