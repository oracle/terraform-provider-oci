...
func (request MergeObjectMetadataRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request MergeObjectMetadataRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request MergeObjectMetadataRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
