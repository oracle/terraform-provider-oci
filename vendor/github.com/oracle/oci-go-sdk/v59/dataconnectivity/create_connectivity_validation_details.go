...
var mappingCreateConnectivityValidationDetailsModelTypeEnumLowerCase = map[string]CreateConnectivityValidationDetailsModelTypeEnum{
	"source_operator": CreateConnectivityValidationDetailsModelTypeSourceOperator,
	"target_operator": CreateConnectivityValidationDetailsModelTypeTargetOperator,
}
...
func GetMappingCreateConnectivityValidationDetailsModelTypeEnum(val string) (CreateConnectivityValidationDetailsModelTypeEnum, bool) {
	enum, ok := mappingCreateConnectivityValidationDetailsModelTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
