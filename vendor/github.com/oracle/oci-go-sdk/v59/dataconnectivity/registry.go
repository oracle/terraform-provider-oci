...
var mappingRegistryLifecycleStateEnumLowerCase = map[string]RegistryLifecycleStateEnum{
	"creating": RegistryLifecycleStateCreating,
	"active":   RegistryLifecycleStateActive,
	"inactive": RegistryLifecycleStateInactive,
	"updating": RegistryLifecycleStateUpdating,
...
func GetMappingRegistryLifecycleStateEnum(val string) (RegistryLifecycleStateEnum, bool) {
	enum, ok := mappingRegistryLifecycleStateEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
