...
func (m EntityShapeFromView) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingEntityShapeFromViewEntityTypeEnum(string(m.EntityType)); !ok && m.EntityType != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for EntityType: %s. Supported values are: %s.", m.EntityType, strings.Join(GetEntityShapeFromViewEntityTypeEnumStringValues(), ",")))
	}
...
func (m EntityShapeFromView) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeEntityShapeFromView EntityShapeFromView
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeEntityShapeFromView
	}{
		"VIEW_ENTITY",
		(MarshalTypeEntityShapeFromView)(m),
	}
...
func (m *EntityShapeFromView) UnmarshalJSON(data []byte) (e error) {
	model := struct {
		...
		EntityType     EntityShapeFromViewEntityTypeEnum `json:"entityType"`
...
var mappingEntityShapeFromViewEntityTypeEnum = map[string]EntityShapeFromViewEntityTypeEnum{
	"TABLE":      EntityShapeFromViewEntityTypeTable,
	"VIEW":       EntityShapeFromViewEntityTypeView,
	"FILE":       EntityShapeFromViewEntityTypeFile,
	"SQL":        EntityShapeFromViewEntityTypeSql,
	"DATA_STORE": EntityShapeFromViewEntityTypeDataStore,
}

var mappingEntityShapeFromViewEntityTypeEnumLowerCase = map[string]EntityShapeFromViewEntityTypeEnum{
	"table":      EntityShapeFromViewEntityTypeTable,
	"view":       EntityShapeFromViewEntityTypeView,
	"file":       EntityShapeFromViewEntityTypeFile,
	"sql":        EntityShapeFromViewEntityTypeSql,
...
func GetEntityShapeFromViewEntityTypeEnumValues() []EntityShapeFromViewEntityTypeEnum {
	values := make([]EntityShapeFromViewEntityTypeEnum, 0)
	for _, v := range mappingEntityShapeFromViewEntityTypeEnum {
...
func GetMappingEntityShapeFromViewEntityTypeEnum(val string) (EntityShapeFromViewEntityTypeEnum, bool) {
	enum, ok := mappingEntityShapeFromViewEntityTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
