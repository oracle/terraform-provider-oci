...
func (m CreateEntityShapeFromView) ValidateEnumValue() (bool, error) {
	...
	if _, ok := mappingCreateEntityShapeDetailsEntityTypeEnum[string(m.EntityType)]; !ok && m.EntityType != "" {
...
func (m CreateEntityShapeFromView) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateEntityShapeFromView CreateEntityShapeFromView
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypeCreateEntityShapeFromView
	}{
		"VIEW_ENTITY",
		(MarshalTypeCreateEntityShapeFromView)(m),
	}
