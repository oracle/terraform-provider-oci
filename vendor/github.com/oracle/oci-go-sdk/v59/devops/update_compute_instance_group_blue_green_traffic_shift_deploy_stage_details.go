...
func (m UpdateComputeInstanceGroupBlueGreenTrafficShiftDeployStageDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateComputeInstanceGroupBlueGreenTrafficShiftDeployStageDetails UpdateComputeInstanceGroupBlueGreenTrafficShiftDeployStageDetails
	s := struct {
		DiscriminatorParam string `json:"deployStageType"`
		MarshalTypeUpdateComputeInstanceGroupBlueGreenTrafficShiftDeployStageDetails
	}{
		"COMPUTE_INSTANCE_GROUP_BLUE_GREEN_TRAFFIC_SHIFT",
		(MarshalTypeUpdateComputeInstanceGroupBlueGreenTrafficShiftDeployStageDetails)(m),
	}
