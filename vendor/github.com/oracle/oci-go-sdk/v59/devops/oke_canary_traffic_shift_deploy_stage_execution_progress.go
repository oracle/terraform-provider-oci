...
func (m OkeCanaryTrafficShiftDeployStageExecutionProgress) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOkeCanaryTrafficShiftDeployStageExecutionProgress OkeCanaryTrafficShiftDeployStageExecutionProgress
	s := struct {
		DiscriminatorParam string `json:"deployStageType"`
		MarshalTypeOkeCanaryTrafficShiftDeployStageExecutionProgress
	}{
		"OKE_CANARY_TRAFFIC_SHIFT",
		(MarshalTypeOkeCanaryTrafficShiftDeployStageExecutionProgress)(m),
	}
