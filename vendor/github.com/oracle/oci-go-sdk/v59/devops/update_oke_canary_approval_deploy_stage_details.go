...
func (m UpdateOkeCanaryApprovalDeployStageDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateOkeCanaryApprovalDeployStageDetails UpdateOkeCanaryApprovalDeployStageDetails
	s := struct {
		DiscriminatorParam string `json:"deployStageType"`
		MarshalTypeUpdateOkeCanaryApprovalDeployStageDetails
	}{
		"OKE_CANARY_APPROVAL",
		(MarshalTypeUpdateOkeCanaryApprovalDeployStageDetails)(m),
	}
