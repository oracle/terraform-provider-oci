...
func (m UpdateAdbServerlesTablespaceDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeUpdateAdbServerlesTablespaceDetails UpdateAdbServerlesTablespaceDetails
	s := struct {
		DiscriminatorParam string `json:"targetType"`
		MarshalTypeUpdateAdbServerlesTablespaceDetails
	}{
		"ADB_S_REMAP",
		(MarshalTypeUpdateAdbServerlesTablespaceDetails)(m),
	}
