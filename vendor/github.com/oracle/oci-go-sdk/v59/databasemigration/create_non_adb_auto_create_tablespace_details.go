...
func (m CreateNonAdbAutoCreateTablespaceDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeCreateNonAdbAutoCreateTablespaceDetails CreateNonAdbAutoCreateTablespaceDetails
	s := struct {
		DiscriminatorParam string `json:"targetType"`
		MarshalTypeCreateNonAdbAutoCreateTablespaceDetails
	}{
		"NON_ADB_AUTOCREATE",
		(MarshalTypeCreateNonAdbAutoCreateTablespaceDetails)(m),
	}
