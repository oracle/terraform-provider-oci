...
func (m NonAdbRemapTablespaceDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeNonAdbRemapTablespaceDetails NonAdbRemapTablespaceDetails
	s := struct {
		DiscriminatorParam string `json:"targetType"`
		MarshalTypeNonAdbRemapTablespaceDetails
	}{
		"NON_ADB_REMAP",
		(MarshalTypeNonAdbRemapTablespaceDetails)(m),
	}
