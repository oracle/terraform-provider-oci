...
// See also
//
// Click https://docs.cloud.oracle.com/en-us/iaas/tools/go-sdk-examples/latest/dataconnectivity/ListConnectionValidations.go.html to see an example of how to use ListConnectionValidationsRequest.
...
var mappingListConnectionValidationsSortByEnum = map[string]ListConnectionValidationsSortByEnum{
	"id":          ListConnectionValidationsSortById,
	"timeCreated": ListConnectionValidationsSortByTimecreated,
	"displayName": ListConnectionValidationsSortByDisplayname,
}
