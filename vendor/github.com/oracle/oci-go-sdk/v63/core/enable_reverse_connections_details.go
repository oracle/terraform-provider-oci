...
func (m EnableReverseConnectionsDetails) ValidateEnumValue() (bool, error) {
	...
	for _, val := range m.ProxyType {
		if _, ok := GetMappingEnableReverseConnectionsDetailsProxyTypeEnum(string(val)); !ok && val != "" {
	...
	if _, ok := GetMappingEnableReverseConnectionsDetailsDefaultDnsResolutionContextEnum(string(m.DefaultDnsResolutionContext)); !ok && m.DefaultDnsResolutionContext != "" {
	...
	if _, ok := GetMappingEnableReverseConnectionsDetailsDefaultDnsContextTransportEnum(string(m.DefaultDnsContextTransport)); !ok && m.DefaultDnsContextTransport != "" {
...
var mappingEnableReverseConnectionsDetailsProxyTypeEnumLowerCase = map[string]EnableReverseConnectionsDetailsProxyTypeEnum{
	"dns":  EnableReverseConnectionsDetailsProxyTypeDns,
	"scan": EnableReverseConnectionsDetailsProxyTypeScan,
}
...
// GetMappingEnableReverseConnectionsDetailsProxyTypeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingEnableReverseConnectionsDetailsProxyTypeEnum(val string) (EnableReverseConnectionsDetailsProxyTypeEnum, bool) {
	enum, ok := mappingEnableReverseConnectionsDetailsProxyTypeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingEnableReverseConnectionsDetailsDefaultDnsResolutionContextEnumLowerCase = map[string]EnableReverseConnectionsDetailsDefaultDnsResolutionContextEnum{
	"service":  EnableReverseConnectionsDetailsDefaultDnsResolutionContextService,
	"customer": EnableReverseConnectionsDetailsDefaultDnsResolutionContextCustomer,
}
...
// GetMappingEnableReverseConnectionsDetailsDefaultDnsResolutionContextEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingEnableReverseConnectionsDetailsDefaultDnsResolutionContextEnum(val string) (EnableReverseConnectionsDetailsDefaultDnsResolutionContextEnum, bool) {
	enum, ok := mappingEnableReverseConnectionsDetailsDefaultDnsResolutionContextEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingEnableReverseConnectionsDetailsDefaultDnsContextTransportEnumLowerCase = map[string]EnableReverseConnectionsDetailsDefaultDnsContextTransportEnum{
	"tcp": EnableReverseConnectionsDetailsDefaultDnsContextTransportTcp,
	"udp": EnableReverseConnectionsDetailsDefaultDnsContextTransportUdp,
}
...
// GetMappingEnableReverseConnectionsDetailsDefaultDnsContextTransportEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingEnableReverseConnectionsDetailsDefaultDnsContextTransportEnum(val string) (EnableReverseConnectionsDetailsDefaultDnsContextTransportEnum, bool) {
	enum, ok := mappingEnableReverseConnectionsDetailsDefaultDnsContextTransportEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
