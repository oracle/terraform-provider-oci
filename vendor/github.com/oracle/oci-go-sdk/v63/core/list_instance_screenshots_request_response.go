...
func (request ListInstanceScreenshotsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if _, ok := GetMappingListInstanceScreenshotsSortByEnum(string(request.SortBy)); !ok && request.SortBy != "" {
	...
	if _, ok := GetMappingListInstanceScreenshotsSortOrderEnum(string(request.SortOrder)); !ok && request.SortOrder != "" {
	...
	if _, ok := GetMappingInstanceScreenshotLifecycleStateEnum(string(request.LifecycleState)); !ok && request.LifecycleState != "" {
...
var mappingListInstanceScreenshotsSortByEnumLowerCase = map[string]ListInstanceScreenshotsSortByEnum{
	"timecreated": ListInstanceScreenshotsSortByTimecreated,
	"displayname": ListInstanceScreenshotsSortByDisplayname,
}
...
// GetMappingListInstanceScreenshotsSortByEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListInstanceScreenshotsSortByEnum(val string) (ListInstanceScreenshotsSortByEnum, bool) {
	enum, ok := mappingListInstanceScreenshotsSortByEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingListInstanceScreenshotsSortOrderEnumLowerCase = map[string]ListInstanceScreenshotsSortOrderEnum{
	"asc":  ListInstanceScreenshotsSortOrderAsc,
	"desc": ListInstanceScreenshotsSortOrderDesc,
}
...
// GetMappingListInstanceScreenshotsSortOrderEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingListInstanceScreenshotsSortOrderEnum(val string) (ListInstanceScreenshotsSortOrderEnum, bool) {
	enum, ok := mappingListInstanceScreenshotsSortOrderEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
