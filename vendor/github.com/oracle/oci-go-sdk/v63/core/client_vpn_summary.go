...
func (m ClientVpnSummary) ValidateEnumValue() (bool, error) {
	...
	if _, ok := GetMappingClientVpnSummaryAddressingModeEnum(string(m.AddressingMode)); !ok && m.AddressingMode != "" {
	...
	if _, ok := GetMappingClientVpnSummaryAuthenticationModeEnum(string(m.AuthenticationMode)); !ok && m.AuthenticationMode != "" {
...
var mappingClientVpnSummaryAddressingModeEnumLowerCase = map[string]ClientVpnSummaryAddressingModeEnum{
	"nat":     ClientVpnSummaryAddressingModeNat,
	"routing": ClientVpnSummaryAddressingModeRouting,
}
...
// GetMappingClientVpnSummaryAddressingModeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingClientVpnSummaryAddressingModeEnum(val string) (ClientVpnSummaryAddressingModeEnum, bool) {
	enum, ok := mappingClientVpnSummaryAddressingModeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
...
var mappingClientVpnSummaryAuthenticationModeEnumLowerCase = map[string]ClientVpnSummaryAuthenticationModeEnum{
	"local":  ClientVpnSummaryAuthenticationModeLocal,
	"radius": ClientVpnSummaryAuthenticationModeRadius,
	"ldap":   ClientVpnSummaryAuthenticationModeLdap,
}
...
// GetMappingClientVpnSummaryAuthenticationModeEnum performs case Insensitive comparison on enum value and return the desired enum
func GetMappingClientVpnSummaryAuthenticationModeEnum(val string) (ClientVpnSummaryAuthenticationModeEnum, bool) {
	enum, ok := mappingClientVpnSummaryAuthenticationModeEnumLowerCase[strings.ToLower(val)]
	return enum, ok
}
