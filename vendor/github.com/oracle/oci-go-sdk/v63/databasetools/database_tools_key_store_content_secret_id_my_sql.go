...
func (m DatabaseToolsKeyStoreContentSecretIdMySql) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseToolsKeyStoreContentSecretIdMySql DatabaseToolsKeyStoreContentSecretIdMySql
	s := struct {
		DiscriminatorParam string `json:"valueType"`
		MarshalTypeDatabaseToolsKeyStoreContentSecretIdMySql
	}{
		"SECRETID",
		(MarshalTypeDatabaseToolsKeyStoreContentSecretIdMySql)(m),
	}
