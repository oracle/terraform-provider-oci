...
func (request ListTagRulesRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request ListTagRulesRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request ListTagRulesRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
