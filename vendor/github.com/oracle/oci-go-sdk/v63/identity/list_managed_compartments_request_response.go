...
func (request ListManagedCompartmentsRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request ListManagedCompartmentsRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request ListManagedCompartmentsRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
