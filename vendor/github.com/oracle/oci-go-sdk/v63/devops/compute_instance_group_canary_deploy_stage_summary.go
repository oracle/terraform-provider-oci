...
func (m ComputeInstanceGroupCanaryDeployStageSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeComputeInstanceGroupCanaryDeployStageSummary ComputeInstanceGroupCanaryDeployStageSummary
	s := struct {
		DiscriminatorParam string `json:"deployStageType"`
		MarshalTypeComputeInstanceGroupCanaryDeployStageSummary
	}{
		"COMPUTE_INSTANCE_GROUP_CANARY_DEPLOYMENT",
		(MarshalTypeComputeInstanceGroupCanaryDeployStageSummary)(m),
	}
