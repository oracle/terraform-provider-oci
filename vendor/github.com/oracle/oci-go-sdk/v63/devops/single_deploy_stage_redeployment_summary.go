...
func (m SingleDeployStageRedeploymentSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeSingleDeployStageRedeploymentSummary SingleDeployStageRedeploymentSummary
	s := struct {
		DiscriminatorParam string `json:"deploymentType"`
		MarshalTypeSingleDeployStageRedeploymentSummary
	}{
		"SINGLE_STAGE_REDEPLOYMENT",
		(MarshalTypeSingleDeployStageRedeploymentSummary)(m),
	}
