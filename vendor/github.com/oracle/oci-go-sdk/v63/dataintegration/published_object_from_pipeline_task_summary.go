...
func (m PublishedObjectFromPipelineTaskSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypePublishedObjectFromPipelineTaskSummary PublishedObjectFromPipelineTaskSummary
	s := struct {
		DiscriminatorParam string `json:"modelType"`
		MarshalTypePublishedObjectFromPipelineTaskSummary
	}{
		"PIPELINE_TASK",
		(MarshalTypePublishedObjectFromPipelineTaskSummary)(m),
	}
