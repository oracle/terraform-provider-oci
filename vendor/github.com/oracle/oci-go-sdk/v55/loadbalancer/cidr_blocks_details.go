...
// CidrBlocksDetails The configuration details of the CidrBlocks.
...
func (m CidrBlocksDetails) String() string {
...
func (m CidrBlocksDetails) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
