...
type CreateInternalVnicDetails struct {
	...
	LaunchType CreateInternalVnicDetailsLaunchTypeEnum `mandatory:"false" json:"launchType,omitempty"`
}
...
func (m CreateInternalVnicDetails) ValidateEnumValue() (bool, error) {
	...
	if _, ok := mappingCreateInternalVnicDetailsLaunchTypeEnum[string(m.LaunchType)]; !ok && m.LaunchType != "" {
		errMessage = append(errMessage, fmt.Sprintf("unsupported enum value for LaunchType: %s. Supported values are: %s.", m.LaunchType, strings.Join(GetCreateInternalVnicDetailsLaunchTypeEnumStringValues(), ",")))
	}
	if len(errMessage) > 0 {
...
// CreateInternalVnicDetailsLaunchTypeEnum Enum with underlying type: string
type CreateInternalVnicDetailsLaunchTypeEnum string

// Set of constants representing the allowable values for CreateInternalVnicDetailsLaunchTypeEnum
const (
	CreateInternalVnicDetailsLaunchTypeMarketplace CreateInternalVnicDetailsLaunchTypeEnum = "MARKETPLACE"
	CreateInternalVnicDetailsLaunchTypeStandard    CreateInternalVnicDetailsLaunchTypeEnum = "STANDARD"
)

var mappingCreateInternalVnicDetailsLaunchTypeEnum = map[string]CreateInternalVnicDetailsLaunchTypeEnum{
	"MARKETPLACE": CreateInternalVnicDetailsLaunchTypeMarketplace,
	"STANDARD":    CreateInternalVnicDetailsLaunchTypeStandard,
}

// GetCreateInternalVnicDetailsLaunchTypeEnumValues Enumerates the set of values for CreateInternalVnicDetailsLaunchTypeEnum
func GetCreateInternalVnicDetailsLaunchTypeEnumValues() []CreateInternalVnicDetailsLaunchTypeEnum {
	values := make([]CreateInternalVnicDetailsLaunchTypeEnum, 0)
	for _, v := range mappingCreateInternalVnicDetailsLaunchTypeEnum {
		values = append(values, v)
	}
	return values
}

// GetCreateInternalVnicDetailsLaunchTypeEnumStringValues Enumerates the set of values in String for CreateInternalVnicDetailsLaunchTypeEnum
func GetCreateInternalVnicDetailsLaunchTypeEnumStringValues() []string {
	return []string{
		"MARKETPLACE",
		"STANDARD",
	}
