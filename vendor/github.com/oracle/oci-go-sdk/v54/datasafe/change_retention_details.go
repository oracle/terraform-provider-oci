...
type ChangeRetentionDetails struct {
	...
	// Indicates the number of months the data that must be stored in the Data Safe.
	OnlineMonths *int `mandatory:"false" json:"onlineMonths"`

	// Indicates the number of months the data that must be stored in the Object Store.
