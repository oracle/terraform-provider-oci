...
func (m DocumentKeyValueDetectionFeature) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDocumentKeyValueDetectionFeature DocumentKeyValueDetectionFeature
	s := struct {
		DiscriminatorParam string `json:"featureType"`
		MarshalTypeDocumentKeyValueDetectionFeature
	}{
		"KEY_VALUE_DETECTION",
		(MarshalTypeDocumentKeyValueDetectionFeature)(m),
	}
