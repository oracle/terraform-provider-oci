...
func (m OkeClusterDeployEnvironmentSummary) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeOkeClusterDeployEnvironmentSummary OkeClusterDeployEnvironmentSummary
	s := struct {
		DiscriminatorParam string `json:"deployEnvironmentType"`
		MarshalTypeOkeClusterDeployEnvironmentSummary
	}{
		"OKE_CLUSTER",
		(MarshalTypeOkeClusterDeployEnvironmentSummary)(m),
	}
