...
// ContinuousQuerySummary A ContinuousQuery that can be used to save and share a given search result.
type ContinuousQuerySummary struct {
...
func (m ContinuousQuerySummary) String() string {
...
func (m ContinuousQuerySummary) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	...
	if _, ok := mappingContinuousQueryLifecycleStateEnum[string(m.LifecycleState)]; !ok && m.LifecycleState != "" {
