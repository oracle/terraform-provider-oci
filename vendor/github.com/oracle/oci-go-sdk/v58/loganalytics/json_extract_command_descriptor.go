...
func (m JsonExtractCommandDescriptor) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeJsonExtractCommandDescriptor JsonExtractCommandDescriptor
	s := struct {
		DiscriminatorParam string `json:"name"`
		MarshalTypeJsonExtractCommandDescriptor
	}{
		"JSON_EXTRACT",
		(MarshalTypeJsonExtractCommandDescriptor)(m),
	}
