...
func (m LinkDetailsCommandDescriptor) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeLinkDetailsCommandDescriptor LinkDetailsCommandDescriptor
	s := struct {
		DiscriminatorParam string `json:"name"`
		MarshalTypeLinkDetailsCommandDescriptor
	}{
		"LINK_DETAILS",
		(MarshalTypeLinkDetailsCommandDescriptor)(m),
	}
