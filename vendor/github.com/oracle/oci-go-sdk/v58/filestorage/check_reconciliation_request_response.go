...
func (request CheckReconciliationRequest) String() string {
	return common.PointerString(request)
}

// HTTPRequest implements the OCIRequest interface
func (request CheckReconciliationRequest) HTTPRequest(method, path string, binaryRequestBody *common.OCIReadSeekCloser, extraHeaders map[string]string) (http.Request, error) {
...
func (request CheckReconciliationRequest) BinaryRequestBody() (*common.OCIReadSeekCloser, bool) {
...
func (request CheckReconciliationRequest) ValidateEnumValue() (bool, error) {
	errMessage := []string{}
	if len(errMessage) > 0 {
...
// CheckReconciliationResponse wrapper for the CheckReconciliation operation
type CheckReconciliationResponse struct {
...
func (response CheckReconciliationResponse) String() string {
	return common.PointerString(response)
}

// HTTPResponse implements the OCIResponse interface
func (response CheckReconciliationResponse) HTTPResponse() *http.Response {
