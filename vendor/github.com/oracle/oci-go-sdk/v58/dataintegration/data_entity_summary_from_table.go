...
func GetMappingDataEntitySummaryFromTableEntityTypeEnum(val string) (DataEntitySummaryFromTableEntityTypeEnum, bool) {
	mappingDataEntitySummaryFromTableEntityTypeEnumIgnoreCase := make(map[string]DataEntitySummaryFromTableEntityTypeEnum)
	for k, v := range mappingDataEntitySummaryFromTableEntityTypeEnum {
		mappingDataEntitySummaryFromTableEntityTypeEnumIgnoreCase[strings.ToLower(k)] = v
	}

	enum, ok := mappingDataEntitySummaryFromTableEntityTypeEnumIgnoreCase[strings.ToLower(val)]
	return enum, ok
}
