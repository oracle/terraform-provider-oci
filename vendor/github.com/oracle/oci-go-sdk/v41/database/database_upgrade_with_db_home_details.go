...
func (m DatabaseUpgradeWithDbHomeDetails) MarshalJSON() (buff []byte, e error) {
	type MarshalTypeDatabaseUpgradeWithDbHomeDetails DatabaseUpgradeWithDbHomeDetails
	s := struct {
		DiscriminatorParam string `json:"source"`
		MarshalTypeDatabaseUpgradeWithDbHomeDetails
	}{
		"DB_HOME",
		(MarshalTypeDatabaseUpgradeWithDbHomeDetails)(m),
	}
