...
### Deprecation
datasource oci_adm_vulnerability_audit_application_dependency_vulnerability is being deprecated use oci_adm_vulnerability_audit_application_dependency_vulnerabities instead Deprecated datasource oci_apm_synthetics_public_vantage_point is being deprecated use oci_apm_synthetics_public_vantage_points instead Deprecated datasource oci_cloud_bridge_appliance_image is being deprecated use oci_cloud_bridge_appliance_images instead Deprecated datasource oci_cloud_guard_data_source_event is being deprecated use oci_cloud_guard_data_source_events instead Deprecated datasource oci_cloud_guard_problem_entity is being deprecated use oci_cloud_guard_problem_entities instead Deprecated datasource oci_cloud_migrations_migration_plan_available_shape is being deprecated use oci_cloud_migrations_migration_plan_available_shapes instead Deprecated datasource oci_data_labeling_service/data_labeling_service_annotation_format is being deprecated use oci_data_labeling_service_annotation_formats instead Deprecated datasource oci_data_safe_alert_policy_rule is being deprecated use oci_data_safe_alert_policy_rules instead Deprecated datasource oci_data_safe_audit_event_analytic is being deprecated use oci_data_safe_audit_event_analytics instead Deprecated datasource oci_data_safe_audit_profile_available_audit_volume is being deprecated use oci_data_safe_audit_profile_available_audit_volumes instead Deprecated datasource oci_data_safe_audit_profile_collected_audit_volume is being deprecated use oci_data_safe_audit_profile_collected_audit_volumes instead Deprecated datasource oci_data_safe_discovery_analytic is being deprecated use oci_data_safe_discovery_analytics instead Deprecated datasource oci_data_safe_masking_analytic is being deprecated use oci_data_safe_masking_analytics instead Deprecated datasource oci_data_safe_masking_reports_masked_column is being deprecated use oci_data_safe_masking_reports_masked_columns instead Deprecated datasource oci_database_management_db_management_private_endpoint_associated_database is being deprecated use oci_database_management_db_management_private_endpoint_associated_databases instead Deprecated datasource oci_database_management_job_executions_status is being deprecated use oci_database_management_job_executions_statuses instead Deprecated datasource oci_database_management_managed_database_sql_tuning_advisor_task is being deprecated use oci_database_management_managed_database_sql_tuning_advisor_tasks instead Deprecated datasource oci_database_management_managed_database_sql_tuning_advisor_tasks_finding is being deprecated use oci_database_management_managed_database_sql_tuning_advisor_tasks_findings instead Deprecated datasource oci_database_management_managed_database_sql_tuning_advisor_tasks_recommendation is being deprecated use oci_database_management_managed_database_sql_tuning_advisor_tasks_recommendations instead Deprecated datasource oci_database_management_managed_database_user_consumer_group_privilege is being deprecated use oci_database_management_managed_database_user_consumer_group_privileges instead Deprecated datasource oci_database_management_managed_database_user_data_access_container is being deprecated use oci_database_management_managed_database_user_data_access_containers instead Deprecated datasource oci_database_management_managed_database_user_object_privilege is being deprecated use oci_database_management_managed_database_user_object_privileges instead Deprecated datasource oci_database_management_managed_database_user_proxied_for_user is being deprecated use oci_database_management_managed_database_user_proxied_for_users instead Deprecated datasource oci_database_management_managed_database_user_role is being deprecated use oci_database_management_managed_database_user_roles instead Deprecated datasource oci_database_management_managed_databases_asm_property is being deprecated use oci_database_management_managed_databases_asm_properties instead Deprecated datasource oci_database_management_managed_databases_database_parameter is being deprecated use oci_database_management_managed_databases_database_parameters instead Deprecated datasource oci_database_management_managed_databases_user_proxy_user is being deprecated use oci_database_management_managed_databases_user_proxy_users instead Deprecated datasource oci_database_management_managed_databases_user_system_privilege is being deprecated use oci_database_management_managed_databases_user_system_privileges instead Deprecated datasource oci_devops_repository_author is being deprecated use oci_devops_repository_authors instead Deprecated datasource oci_devops_repository_path is being deprecated use oci_devops_repository_paths instead Deprecated datasource oci_em_warehouse_em_warehouse_etl_run is being deprecated use oci_em_warehouse_em_warehouse_etl_runs instead Deprecated datasource oci_fusion_apps_fusion_environment_time_available_for_refresh is being deprecated use oci_fusion_apps_fusion_environment_time_available_for_refreshs instead Deprecated datasource oci_golden_gate_message is being deprecated use oci_golden_gate_messages instead Deprecated datasource oci_golden_gate_trail_file is being deprecated use oci_golden_gate_trail_files instead Deprecated datasource oci_golden_gate_trail_sequence is being deprecated use oci_golden_gate_trail_sequences instead Deprecated datasource oci_jms_fleet_installation_site is being deprecated use oci_jms_fleet_installation_sites instead Deprecated datasource oci_opensearch_opensearch_version is being deprecated use oci_opensearch_opensearch_versions instead Deprecated datasource oci_opsi_awr_hub_awr_snapshot is being deprecated use oci_opsi_awr_hub_awr_snapshots instead Deprecated datasource oci_opsi_importable_compute_entity is being deprecated use oci_opsi_importable_compute_entities instead Deprecated datasource oci_optimizer_profile_level is being deprecated use oci_optimizer_profile_levels instead Deprecated datasource oci_optimizer_recommendation_strategy is being deprecated use oci_optimizer_recommendation_strategies instead Deprecated datasource oci_osp_gateway_invoices_invoice_line is being deprecated use oci_osp_gateway_invoices_invoice_lines instead Deprecated datasource oci_usage_proxy_subscription_product is being deprecated use oci_usage_proxy_subscription_products instead Deprecated datasource oci_usage_proxy_subscription_redemption is being deprecated use oci_usage_proxy_subscription_redemptions instead Deprecated datasource oci_usage_proxy_subscription_reward in favour of deprecated use usage_proxy_subscription_rewards instead
### Bug Fix
...
### Added
Terraform code changes to fix compilation error for RegistryLifeCycleState.
...
- Support for EM Warehouse resourceUsage API Addendum:coreUser[API CHANGE ONLY]
...
- Finalize changelog and release for version v4.88.1
...
- Validate project module name during build
...
- ZIP files creation in GitHub Actions workflow
...
- fixed breaking change on opsi host insights data source
- GitHub Actions workflow for creation of magic buttons
- readme.md filename changes
### Bug Fix
...
### Bug Fix
- [UDX-20702] [Terraform] Mysql - Add return body to UpdateBackup api call
...
### Added
Ingress Route Table For NatGateway
