...
sidebar_current: "docs-oci-datasource-identity_domains-account_recovery_setting"
description: |-
  Provides details about a specific Account Recovery Setting in Oracle Cloud Infrastructure Identity Domains service
---
