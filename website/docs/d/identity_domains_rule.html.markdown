...
sidebar_current: "docs-oci-datasource-identity_domains-rule"
description: |-
  Provides details about a specific Rule in Oracle Cloud Infrastructure Identity Domains service
---
...
* `rule_id` - (Required) ID of the resource
