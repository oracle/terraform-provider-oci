...
sidebar_current: "docs-oci-datasource-identity_domains-policy"
description: |-
  Provides details about a specific Policy in Oracle Cloud Infrastructure Identity Domains service
---

# Data Source: oci_identity_domains_policy
...
```hcl
data "oci_identity_domains_policy" "test_policy" {
	#Required
...
* `policy_id` - (Required) ID of the resource
