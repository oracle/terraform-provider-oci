...
sidebar_current: "docs-oci-datasource-identity_domains-auth_token"
description: |-
  Provides details about a specific Auth Token in Oracle Cloud Infrastructure Identity Domains service
---
...
* `auth_token_id` - (Required) ID of the resource
