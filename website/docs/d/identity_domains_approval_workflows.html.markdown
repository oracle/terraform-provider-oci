...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_approval_workflows"
sidebar_current: "docs-oci-datasource-identity_domains-approval_workflows"
description: |-
  Provides the list of Approval Workflows in Oracle Cloud Infrastructure Identity Domains service
---
...
* `approval_workflow_count` - (Optional) OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
...
* `approval_workflows` - The list of approval_workflows.

### ApprovalWorkflow Reference

The following attributes are exported:

* `approval_workflow_steps` - ApprovalWorkflowSteps applicable for the ApprovalWorkflowInstance.
	...
	* `ref` - ApprovalWorkflowSteps URI
		...
		* type: reference
		* uniqueness: none
	* `ocid` - The unique Oracle Cloud Infrastructure identifier of the ApprovalWorkflowStep.
		...
		* type: string
		* uniqueness: none
	* `order` - The order of the ApprovalWorkflowSteps.
		...
		* type: integer
		* uniqueness: none
	* `type` - The type of the ApprovalWorkflowSteps.
		...
		* type: string
		* uniqueness: none
	* `value` - The unique identifier of the ApprovalWorkflowStep.
...
* `delete_in_progress` - A boolean flag indicating this resource in the process of being deleted. Usually set to true when synchronous deletion of the resource would take too long.
	...
	* type: boolean
	* uniqueness: none
* `description` - Description of the ApprovalWorkflow.
...
* `idcs_prevented_operations` - Each value of this attribute specifies an operation that only an internal client may perform on this particular resource.
	...
	* type: string
	* uniqueness: none
* `max_duration` - Max duration of the ApprovalWorkflow must be acted at all levels.
	...
	* type: complex
	* uniqueness: none
	* `unit` - The unit of the max duration.
		...
		* type: string
		* uniqueness: none
	* `value` - The value of the max duration.
...
* `meta` - A complex attribute that contains resource metadata. All sub-attributes are OPTIONAL.
	...
	* `version` - The version of the Resource being returned. This value must be the same as the ETag HTTP response header.
		...
		* type: string
		* uniqueness: none
* `name` - Name of the ApprovalWorkflow.
