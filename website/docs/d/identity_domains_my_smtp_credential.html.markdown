...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_my_smtp_credential"
sidebar_current: "docs-oci-datasource-identity_domains-my_smtp_credential"
description: |-
  Provides details about a specific My Smtp Credential in Oracle Cloud Infrastructure Identity Domains service
---

# Data Source: oci_identity_domains_my_smtp_credential
...
```hcl
data "oci_identity_domains_my_smtp_credential" "test_my_smtp_credential" {
	#Required
...
* `my_smtp_credential_id` - (Required) ID of the resource
