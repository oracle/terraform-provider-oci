...
sidebar_current: "docs-oci-datasource-database_management-cloud_exadata_storage_connector"
description: |-
  Provides details about a specific Cloud Exadata Storage Connector in Oracle Cloud Infrastructure Database Management service
---

# Data Source: oci_database_management_cloud_exadata_storage_connector
...
* `cloud_exadata_storage_connector_id` - (Required) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the connector to the Exadata storage server.
