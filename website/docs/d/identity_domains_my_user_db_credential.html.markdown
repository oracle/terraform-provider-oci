...
sidebar_current: "docs-oci-datasource-identity_domains-my_user_db_credential"
description: |-
  Provides details about a specific My User Db Credential in Oracle Cloud Infrastructure Identity Domains service
---

# Data Source: oci_identity_domains_my_user_db_credential
...
```hcl
data "oci_identity_domains_my_user_db_credential" "test_my_user_db_credential" {
	#Required
...
* `my_user_db_credential_id` - (Required) ID of the resource
