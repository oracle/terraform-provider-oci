...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_condition"
sidebar_current: "docs-oci-datasource-identity_domains-condition"
description: |-
  Provides details about a specific Condition in Oracle Cloud Infrastructure Identity Domains service
---

# Data Source: oci_identity_domains_condition
...
```hcl
data "oci_identity_domains_condition" "test_condition" {
	#Required
	condition_id = oci_identity_domains_condition.test_condition.id
...
* `condition_id` - (Required) ID of the resource
