...
* `items` - Array of audit event summary.
	...
	* `audit_event_time` - The time of the audit event occurrence in the target database.
	...
	* `compartment_id` - The OCID of the compartment containing the audit event. This is the same as that of audit profile of the target database resource compartment.
	...
	* `event_name` - The name of the detail action executed by the user on the target database. i.e ALTER SEQUENCE, CREATE TRIGGER, CREATE INDEX.
	...
	* `object_type` - The type of the object in the source database affected by the action. i.e PL/SQL, SYNONYM, PACKAGE BODY.
	* `operation` - The name of the action executed by the user on the target database. i.e ALTER, CREATE, DROP.
