...
sidebar_current: "docs-oci-datasource-distributed_database-distributed_database"
description: |-
  Provides details about a specific Distributed Database in Oracle Cloud Infrastructure Distributed Database service
---
