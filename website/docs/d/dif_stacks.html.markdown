...
subcategory: "Dif"
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_dif_stacks"
sidebar_current: "docs-oci-datasource-dif-stacks"
description: |-
  Provides the list of Stacks in Oracle Cloud Infrastructure Dif service
---
...
* `id` - (Optional) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Stack.
...
* `stack_collection` - The list of stack_collection.
