...
sidebar_current: "docs-oci-datasource-identity_domains-approval_workflow_step"
description: |-
  Provides details about a specific Approval Workflow Step in Oracle Cloud Infrastructure Identity Domains service
---

# Data Source: oci_identity_domains_approval_workflow_step
...
```hcl
data "oci_identity_domains_approval_workflow_step" "test_approval_workflow_step" {
	#Required
	approval_workflow_step_id = oci_identity_domains_approval_workflow_step.test_approval_workflow_step.id
...
* `approval_workflow_step_id` - (Required) ID of the resource
