...
sidebar_current: "docs-oci-datasource-identity_domains-identity_propagation_trust"
description: |-
  Provides details about a specific Identity Propagation Trust in Oracle Cloud Infrastructure Identity Domains service
---
...
* `identity_propagation_trust_id` - (Required) ID of the resource
