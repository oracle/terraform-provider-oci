...
sidebar_current: "docs-oci-datasource-identity_domains-my_support_account"
description: |-
  Provides details about a specific My Support Account in Oracle Cloud Infrastructure Identity Domains service
---
...
* `my_support_account_id` - (Required) ID of the resource
