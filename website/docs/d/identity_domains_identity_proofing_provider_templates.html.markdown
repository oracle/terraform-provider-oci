...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_identity_proofing_provider_templates"
sidebar_current: "docs-oci-datasource-identity_domains-identity_proofing_provider_templates"
description: |-
  Provides the list of Identity Proofing Provider Templates in Oracle Cloud Infrastructure Identity Domains service
---

# Data Source: oci_identity_domains_identity_proofing_provider_templates
...
* `identity_proofing_provider_template_count` - (Optional) OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
...
* `identity_proofing_provider_templates` - The list of identity_proofing_provider_templates.

### IdentityProofingProviderTemplate Reference
