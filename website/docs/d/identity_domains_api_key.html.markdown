...
sidebar_current: "docs-oci-datasource-identity_domains-api_key"
description: |-
  Provides details about a specific Api Key in Oracle Cloud Infrastructure Identity Domains service
---

# Data Source: oci_identity_domains_api_key
...
```hcl
data "oci_identity_domains_api_key" "test_api_key" {
	#Required
...
* `api_key_id` - (Required) ID of the resource
