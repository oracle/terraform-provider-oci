...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_database_external_container_databases"
sidebar_current: "docs-oci-datasource-database-external_container_databases"
description: |-
  Provides the list of External Container Databases in Oracle Cloud Infrastructure Database service
---
...
* `external_container_databases` - The list of external_container_databases.
