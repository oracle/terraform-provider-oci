...
sidebar_current: "docs-oci-datasource-identity_domains-cloud_gate_mapping"
description: |-
  Provides details about a specific Cloud Gate Mapping in Oracle Cloud Infrastructure Identity Domains service
---
...
* `cloud_gate_mapping_id` - (Required) ID of the resource
