...
sidebar_current: "docs-oci-datasource-certificates_management-certificate"
description: |-
  Provides details about a specific Certificate in Oracle Cloud Infrastructure Certificates Management service
---
