...
sidebar_current: "docs-oci-datasource-identity_domains-app_role"
description: |-
  Provides details about a specific App Role in Oracle Cloud Infrastructure Identity Domains service
---
...
* `app_role_id` - (Required) ID of the resource
