...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_security_question"
sidebar_current: "docs-oci-datasource-identity_domains-security_question"
description: |-
  Provides details about a specific Security Question in Oracle Cloud Infrastructure Identity Domains service
---

# Data Source: oci_identity_domains_security_question
...
```hcl
data "oci_identity_domains_security_question" "test_security_question" {
	#Required
...
* `security_question_id` - (Required) ID of the resource
...
* `active` - This indicates if the question is selected by the Security Admin and is available for the end user.
...
* `ocid` - Unique Oracle Cloud Infrastructure identifier for the SCIM Resource.
	...
	* type: string
	* uniqueness: global
* `question_text` - Locale values for the Question
...
* `tenancy_ocid` - Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
	...
	* type: string
	* uniqueness: none
* `type` - This indicates if the question is a Custom Question added by the Security Admin.
