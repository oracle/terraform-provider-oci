...
sidebar_current: "docs-oci-datasource-identity_domains-security_question_setting"
description: |-
  Provides details about a specific Security Question Setting in Oracle Cloud Infrastructure Identity Domains service
---

# Data Source: oci_identity_domains_security_question_setting
...
```hcl
data "oci_identity_domains_security_question_setting" "test_security_question_setting" {
	#Required
