...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_approval_workflow"
sidebar_current: "docs-oci-datasource-identity_domains-approval_workflow"
description: |-
  Provides details about a specific Approval Workflow in Oracle Cloud Infrastructure Identity Domains service
---
...
* `approval_workflow_id` - (Required) ID of the resource
