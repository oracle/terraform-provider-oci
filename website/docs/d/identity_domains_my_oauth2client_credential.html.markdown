...
sidebar_current: "docs-oci-datasource-identity_domains-my_oauth2client_credential"
description: |-
  Provides details about a specific My O Auth2 Client Credential in Oracle Cloud Infrastructure Identity Domains service
---
...
```hcl
data "oci_identity_domains_my_oauth2client_credential" "test_my_oauth2client_credential" {
	#Required
...
* `my_oauth2client_credential_id` - (Required) ID of the resource
