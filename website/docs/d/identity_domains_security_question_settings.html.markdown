...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_security_question_settings"
sidebar_current: "docs-oci-datasource-identity_domains-security_question_settings"
description: |-
  Provides the list of Security Question Settings in Oracle Cloud Infrastructure Identity Domains service
---
...
* `security_question_settings` - The list of security_question_settings.
