...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_database_tools_database_tools_mcp_servers"
sidebar_current: "docs-oci-datasource-database_tools-database_tools_mcp_servers"
description: |-
  Provides the list of Database Tools Mcp Servers in Oracle Cloud Infrastructure Database Tools service
---
...
* `state` - (Optional) A filter to return resources only when their `databaseToolsMcpServerLifecycleState` matches the specified `databaseToolsMcpServerLifecycleState`.
