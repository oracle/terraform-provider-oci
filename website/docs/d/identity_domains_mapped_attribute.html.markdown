...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_mapped_attribute"
sidebar_current: "docs-oci-datasource-identity_domains-mapped_attribute"
description: |-
  Provides details about a specific Mapped Attribute in Oracle Cloud Infrastructure Identity Domains service
---
...
* `mapped_attribute_id` - (Required) ID of the resource
...
* `attribute_mappings` - A list of attribute mappings between Oracle Identity Cloud Service Resource Type and Account Object Class
	...
	* type: complex
	* uniqueness: none
	* `applies_to_actions` - If specified, indicates a subset of mappedActions to which this attribute-mapping applies.If not specified, this attribute-mapping applies to all mappedActions that use mappedAttributes
		...
		* type: string
		* uniqueness: none
	* `idcs_attribute_name` - The name or expression of an attribute that corresponds to the Oracle Identity Cloud Service Resource referred in the \"idcsResourceType\" attribute.
		...
		* type: string
		* uniqueness: none
	* `managed_object_attribute_name` - The name or expression of an attribute defined in the schema of the Managed Object Class. This is the SCIM compliant Oracle Identity Cloud Service Name of the attribute that maps to the \"idcsName\" attribute in the schema of an Managed Object Class.
		...
		* type: string
		* uniqueness: none
	* `required` - If true, indicates that this attribute must have a value. This attribute maps to the \"required\" sub-attribute in the schema of an Managed Object Class.
		...
		* type: boolean
		* uniqueness: none
	* `saml_format` - Indicates the format of the assertion attribute. Also stores AttributeNamespace for WSFed1.1.
...
* `delete_in_progress` - A boolean flag indicating this resource in the process of being deleted. Usually set to true when synchronous deletion of the resource would take too long.
	...
	* type: boolean
	* uniqueness: none
* `direction` - Direction of the attribute mapping. inbound indicates mapping is from source ManagedObjectClass to Oracle Identity Cloud Service ResourceType. outbound indicates mapping is from Oracle Identity Cloud Service Resource Type to target ManagedObjectClass.
...
* `idcs_prevented_operations` - Each value of this attribute specifies an operation that only an internal client may perform on this particular resource.
	...
	* type: string
	* uniqueness: none
* `idcs_resource_type` - The Oracle Identity Cloud Service Resource Type for which the mapping is being done
...
* `ocid` - Unique Oracle Cloud Infrastructure identifier for the SCIM Resource.
	...
	* type: string
	* uniqueness: global
* `ref_resource_id` - Soft Reference to store Resource ID that holds the mapping
	...
	* type: string
	* uniqueness: none
* `ref_resource_type` - The Reference Resource Type that holds the mapping
