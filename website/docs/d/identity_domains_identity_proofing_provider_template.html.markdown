...
sidebar_current: "docs-oci-datasource-identity_domains-identity_proofing_provider_template"
description: |-
  Provides details about a specific Identity Proofing Provider Template in Oracle Cloud Infrastructure Identity Domains service
---

# Data Source: oci_identity_domains_identity_proofing_provider_template
...
```hcl
data "oci_identity_domains_identity_proofing_provider_template" "test_identity_proofing_provider_template" {
	#Required
	idcs_endpoint = data.oci_identity_domain.test_domain.url
	identity_proofing_provider_template_id = oci_identity_domains_identity_proofing_provider_template.test_identity_proofing_provider_template.id
...
* `identity_proofing_provider_template_id` - (Required) ID of the resource.
