...
sidebar_current: "docs-oci-datasource-database_management-cloud_exadata_storage_server"
description: |-
  Provides details about a specific Cloud Exadata Storage Server in Oracle Cloud Infrastructure Database Management service
---

# Data Source: oci_database_management_cloud_exadata_storage_server
