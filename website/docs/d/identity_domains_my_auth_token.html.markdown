...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_my_auth_token"
sidebar_current: "docs-oci-datasource-identity_domains-my_auth_token"
description: |-
  Provides details about a specific My Auth Token in Oracle Cloud Infrastructure Identity Domains service
---
...
* `my_auth_token_id` - (Required) ID of the resource
