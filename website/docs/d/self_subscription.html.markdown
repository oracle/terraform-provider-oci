...
sidebar_current: "docs-oci-datasource-self-subscription"
description: |-
  Provides details about a specific Subscription in Oracle Cloud Infrastructure Self service
---

# Data Source: oci_self_subscription
...
```hcl
data "oci_self_subscription" "test_subscription" {
	#Required
