...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_approval_workflow_steps"
sidebar_current: "docs-oci-datasource-identity_domains-approval_workflow_steps"
description: |-
  Provides the list of Approval Workflow Steps in Oracle Cloud Infrastructure Identity Domains service
---

# Data Source: oci_identity_domains_approval_workflow_steps
...
* `approval_workflow_steps` - The list of approval_workflow_steps.

### ApprovalWorkflowStep Reference

The following attributes are exported:

* `approvers` - Approvers of the ApprovalWorkflowStep.
	...
	* `ref` - Approver URI
		...
		* type: reference
		* uniqueness: none
	* `display` - The display of the approver.
		...
		* type: string
		* uniqueness: none
	* `ocid` - The unique Oracle Cloud Infrastructure identifier of the approver.
	...
	* `type` - The type of the approver.
		...
		* type: reference
		* uniqueness: none
	* `value` - The unique identifier of the approver.
		...
		* type: string
		* uniqueness: none
* `approvers_expressions` - approversExpressions of ApprovalWorkflowStep
...
* `meta` - A complex attribute that contains resource metadata. All sub-attributes are OPTIONAL.
	...
	* `version` - The version of the Resource being returned. This value must be the same as the ETag HTTP response header.
		...
		* type: string
		* uniqueness: none
* `minimum_approvals` - Minimum number of Approvals required for this step.
...
* `ocid` - Unique Oracle Cloud Infrastructure identifier for the SCIM Resource.
	...
	* type: string
	* uniqueness: global
* `order` - Order of the ApprovalWorkflowStep.
...
* `tenancy_ocid` - Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
	...
	* type: string
	* uniqueness: none
* `type` - Type of ApprovalWorkflowStep
