...
description: |-
  Provides details about a specific Rule in Oracle Cloud Infrastructure Events service
---
...
* `rule_id` - (Required) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this rule. 
