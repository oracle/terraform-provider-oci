...
subcategory: "Costad"
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_costad_cost_alert_subscription"
sidebar_current: "docs-oci-datasource-costad-cost_alert_subscription"
description: |-
  Provides details about a specific Cost Alert Subscription in Oracle Cloud Infrastructure Costad service
---

# Data Source: oci_costad_cost_alert_subscription
...
```hcl
data "oci_costad_cost_alert_subscription" "test_cost_alert_subscription" {
	#Required
