...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_api_keys"
sidebar_current: "docs-oci-datasource-identity_domains-api_keys"
description: |-
  Provides the list of Api Keys in Oracle Cloud Infrastructure Identity Domains service
---
...
* `api_key_count` - (Optional) OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
