...
sidebar_current: "docs-oci-datasource-identity_domains-notification_setting"
description: |-
  Provides details about a specific Notification Setting in Oracle Cloud Infrastructure Identity Domains service
---
