...
subcategory: "Gdp"
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_gdp_gdp_pipelines"
sidebar_current: "docs-oci-datasource-gdp-gdp_pipelines"
description: |-
  Provides the list of Gdp Pipelines in Oracle Cloud Infrastructure Gdp service
---

# Data Source: oci_gdp_gdp_pipelines
...
* `gdp_pipeline_collection` - The list of gdp_pipeline_collection.

### GdpPipeline Reference
