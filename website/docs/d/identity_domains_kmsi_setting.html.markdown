...
sidebar_current: "docs-oci-datasource-identity_domains-kmsi_setting"
description: |-
  Provides details about a specific Kmsi Setting in Oracle Cloud Infrastructure Identity Domains service
---

# Data Source: oci_identity_domains_kmsi_setting
...
```hcl
data "oci_identity_domains_kmsi_setting" "test_kmsi_setting" {
	#Required
