...
sidebar_current: "docs-oci-datasource-batch-batch_context"
description: |-
  Provides details about a specific Batch Context in Oracle Cloud Infrastructure Batch service
---
...
* `batch_context_id` - (Required) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the batch context.
