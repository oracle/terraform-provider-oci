...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_my_pending_approval"
sidebar_current: "docs-oci-datasource-identity_domains-my_pending_approval"
description: |-
  Provides details about a specific My Pending Approval in Oracle Cloud Infrastructure Identity Domains service
---
...
* `my_pending_approval_id` - (Required) ID of the resource
