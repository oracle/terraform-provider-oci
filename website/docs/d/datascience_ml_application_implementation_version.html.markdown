...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_datascience_ml_application_implementation_version"
sidebar_current: "docs-oci-datasource-datascience-ml_application_implementation_version"
description: |-
  Provides details about a specific Ml Application Implementation Version in Oracle Cloud Infrastructure Data Science service
---

# Data Source: oci_datascience_ml_application_implementation_version
...
data "oci_datascience_ml_application_implementation_version" "test_ml_application_implementation_version" {
	#Required
	ml_application_implementation_version_id = oci_datascience_ml_application_implementation_version.test_ml_application_implementation_version.id
}
```
...
* `ml_application_implementation_version_id` - (Required) unique MlApplicationImplementationVersion identifier
