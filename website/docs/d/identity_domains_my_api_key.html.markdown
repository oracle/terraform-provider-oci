...
sidebar_current: "docs-oci-datasource-identity_domains-my_api_key"
description: |-
  Provides details about a specific My Api Key in Oracle Cloud Infrastructure Identity Domains service
---
...
* `my_api_key_id` - (Required) ID of the resource
