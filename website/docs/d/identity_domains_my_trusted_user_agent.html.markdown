...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_my_trusted_user_agent"
sidebar_current: "docs-oci-datasource-identity_domains-my_trusted_user_agent"
description: |-
  Provides details about a specific My Trusted User Agent in Oracle Cloud Infrastructure Identity Domains service
---
...
* `my_trusted_user_agent_id` - (Required) ID of the resource
