...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_network_perimeter"
sidebar_current: "docs-oci-datasource-identity_domains-network_perimeter"
description: |-
  Provides details about a specific Network Perimeter in Oracle Cloud Infrastructure Identity Domains service
---

# Data Source: oci_identity_domains_network_perimeter
...
```hcl
data "oci_identity_domains_network_perimeter" "test_network_perimeter" {
	#Required
...
* `network_perimeter_id` - (Required) ID of the resource
