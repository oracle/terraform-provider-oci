...
sidebar_current: "docs-oci-datasource-distributed_database-distributed_autonomous_database"
description: |-
  Provides details about a specific Distributed Autonomous Database in Oracle Cloud Infrastructure Distributed Database service
---

# Data Source: oci_distributed_database_distributed_autonomous_database
...
```hcl
data "oci_distributed_database_distributed_autonomous_database" "test_distributed_autonomous_database" {
	#Required
