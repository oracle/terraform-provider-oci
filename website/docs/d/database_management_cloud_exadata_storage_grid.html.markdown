...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_database_management_cloud_exadata_storage_grid"
sidebar_current: "docs-oci-datasource-database_management-cloud_exadata_storage_grid"
description: |-
  Provides details about a specific Cloud Exadata Storage Grid in Oracle Cloud Infrastructure Database Management service
---

# Data Source: oci_database_management_cloud_exadata_storage_grid
...
data "oci_database_management_cloud_exadata_storage_grid" "test_cloud_exadata_storage_grid" {
	#Required
	cloud_exadata_storage_grid_id = oci_database_management_cloud_exadata_storage_grid.test_cloud_exadata_storage_grid.id
}
```
...
* `cloud_exadata_storage_grid_id` - (Required) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata storage grid.
