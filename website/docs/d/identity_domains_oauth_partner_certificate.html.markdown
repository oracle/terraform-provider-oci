...
sidebar_current: "docs-oci-datasource-identity_domains-oauth_partner_certificate"
description: |-
  Provides details about a specific O Auth Partner Certificate in Oracle Cloud Infrastructure Identity Domains service
---

# Data Source: oci_identity_domains_oauth_partner_certificate
...
```hcl
data "oci_identity_domains_oauth_partner_certificate" "test_oauth_partner_certificate" {
	#Required
...
* `o_auth_partner_certificate_id` - (Required) ID of the resource
