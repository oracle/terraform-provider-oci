...
sidebar_current: "docs-oci-datasource-identity_domains-dynamic_resource_group"
description: |-
  Provides details about a specific Dynamic Resource Group in Oracle Cloud Infrastructure Identity Domains service
---
...
```hcl
data "oci_identity_domains_dynamic_resource_group" "test_dynamic_resource_group" {
	#Required
	dynamic_resource_group_id = oci_identity_group.test_group.id
...
* `dynamic_resource_group_id` - (Required) ID of the resource
