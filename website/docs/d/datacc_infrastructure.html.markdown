...
sidebar_current: "docs-oci-datasource-datacc-infrastructure"
description: |-
  Provides details about a specific Infrastructure in Oracle Cloud Infrastructure Datacc service
---

# Data Source: oci_datacc_infrastructure
...
```hcl
data "oci_datacc_infrastructure" "test_infrastructure" {
	#Required
