...
sidebar_current: "docs-oci-datasource-identity_domains-self_registration_profile"
description: |-
  Provides details about a specific Self Registration Profile in Oracle Cloud Infrastructure Identity Domains service
---

# Data Source: oci_identity_domains_self_registration_profile
...
```hcl
data "oci_identity_domains_self_registration_profile" "test_self_registration_profile" {
	#Required
...
* `self_registration_profile_id` - (Required) ID of the resource
