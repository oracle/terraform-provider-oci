...
sidebar_current: "docs-oci-datasource-database_management-cloud_asm"
description: |-
  Provides details about a specific Cloud Asm in Oracle Cloud Infrastructure Database Management service
---

# Data Source: oci_database_management_cloud_asm
...
```hcl
data "oci_database_management_cloud_asm" "test_cloud_asm" {
	#Required
