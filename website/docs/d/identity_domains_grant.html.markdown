...
sidebar_current: "docs-oci-datasource-identity_domains-grant"
description: |-
  Provides details about a specific Grant in Oracle Cloud Infrastructure Identity Domains service
---
...
* `grant_id` - (Required) ID of the resource
