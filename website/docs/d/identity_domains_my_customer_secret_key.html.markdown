...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_my_customer_secret_key"
sidebar_current: "docs-oci-datasource-identity_domains-my_customer_secret_key"
description: |-
  Provides details about a specific My Customer Secret Key in Oracle Cloud Infrastructure Identity Domains service
---
...
* `my_customer_secret_key_id` - (Required) ID of the resource
