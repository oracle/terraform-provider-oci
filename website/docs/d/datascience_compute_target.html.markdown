...
sidebar_current: "docs-oci-datasource-datascience-compute_target"
description: |-
  Provides details about a specific Compute Target in Oracle Cloud Infrastructure Data Science service
---
...
* `compute_target_id` - (Required) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute target.
