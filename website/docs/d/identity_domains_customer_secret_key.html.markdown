...
sidebar_current: "docs-oci-datasource-identity_domains-customer_secret_key"
description: |-
  Provides details about a specific Customer Secret Key in Oracle Cloud Infrastructure Identity Domains service
---
...
* `customer_secret_key_id` - (Required) ID of the resource
