...
sidebar_current: "docs-oci-datasource-identity_domains-smtp_credential"
description: |-
  Provides details about a specific Smtp Credential in Oracle Cloud Infrastructure Identity Domains service
---

# Data Source: oci_identity_domains_smtp_credential
...
```hcl
data "oci_identity_domains_smtp_credential" "test_smtp_credential" {
	#Required
...
* `smtp_credential_id` - (Required) ID of the resource
