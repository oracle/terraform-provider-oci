...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_user_attributes_settings"
sidebar_current: "docs-oci-datasource-identity_domains-user_attributes_settings"
description: |-
  Provides the list of User Attributes Settings in Oracle Cloud Infrastructure Identity Domains service
---
...
* `user_attributes_settings` - The list of user_attributes_settings.

### UserAttributesSetting Reference

The following attributes are exported:

* `attribute_settings` - User Schema Attribute Settings
	...
	* returned: default
	* type: complex
	* `end_user_mutability` - End User mutability
		...
		* type: string
		* uniqueness: none
	* `end_user_mutability_canonical_values` - Specifies the list of User mutabilities allowed.
		...
		* type: string
		* uniqueness: none
	* `name` - Fully-qualified attribute or complex mapping Name
