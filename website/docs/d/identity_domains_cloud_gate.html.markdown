...
sidebar_current: "docs-oci-datasource-identity_domains-cloud_gate"
description: |-
  Provides details about a specific Cloud Gate in Oracle Cloud Infrastructure Identity Domains service
---
...
* `cloud_gate_id` - (Required) ID of the resource
