...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_os_management_hub_dynamic_set_managed_instances"
sidebar_current: "docs-oci-datasource-os_management_hub-dynamic_set_managed_instances"
description: |-
  Provides the list of Dynamic Set Managed Instances in Oracle Cloud Infrastructure Os Management Hub service
---

# Data Source: oci_os_management_hub_dynamic_set_managed_instances
...
```hcl
data "oci_os_management_hub_dynamic_set_managed_instances" "test_dynamic_set_managed_instances" {
	#Required
	dynamic_set_id = oci_os_management_hub_dynamic_set.test_dynamic_set.id

	#Optional
	compartment_id = var.compartment_id
	compartment_id_in_subtree = var.dynamic_set_managed_instance_compartment_id_in_subtree
	display_name = var.dynamic_set_managed_instance_display_name
	display_name_contains = var.dynamic_set_managed_instance_display_name_contains
}
```
...
### DynamicSetManagedInstance Reference
