...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_user_attributes_setting"
sidebar_current: "docs-oci-datasource-identity_domains-user_attributes_setting"
description: |-
  Provides details about a specific User Attributes Setting in Oracle Cloud Infrastructure Identity Domains service
---

# Data Source: oci_identity_domains_user_attributes_setting
...
* `user_attributes_setting_id` - (Required) ID of the resource
