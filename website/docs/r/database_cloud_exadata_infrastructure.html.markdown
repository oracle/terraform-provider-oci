...
* `display_name` - (Required) (Updatable) The user-friendly name for the cloud Exadata infrastructure. The name does not need to be unique. 
...
* `shape` - (Required) The shape of the cloud Exadata infrastructure. 
