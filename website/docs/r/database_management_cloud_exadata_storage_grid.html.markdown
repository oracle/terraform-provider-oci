...
sidebar_current: "docs-oci-resource-database_management-cloud_exadata_storage_grid"
description: |-
  Provides the Cloud Exadata Storage Grid resource in Oracle Cloud Infrastructure Database Management service
---
...
```hcl
resource "oci_database_management_cloud_exadata_storage_grid" "test_cloud_exadata_storage_grid" {
	#Required
...
The `timeouts` block allows you to specify [timeouts](https://registry.terraform.io/providers/oracle/oci/latest/docs/guides/changing_timeouts) for certain operations:
	* `create` - (Defaults to 20 minutes), when creating the Cloud Exadata Storage Grid
	* `update` - (Defaults to 20 minutes), when updating the Cloud Exadata Storage Grid
	* `delete` - (Defaults to 20 minutes), when destroying the Cloud Exadata Storage Grid
...
```
$ terraform import oci_database_management_cloud_exadata_storage_grid.test_cloud_exadata_storage_grid "id"
```
