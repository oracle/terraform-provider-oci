...
sidebar_current: "docs-oci-resource-costad-cost_alert_subscription"
description: |-
  Provides the Cost Alert Subscription resource in Oracle Cloud Infrastructure Costad service
---
...
```
$ terraform import oci_costad_cost_alert_subscription.test_cost_alert_subscription "id"
```
