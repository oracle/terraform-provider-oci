...
* `delete_in_progress` - (Optional) (Updatable) A boolean flag indicating this resource in the process of being deleted. Usually set to true when synchronous deletion of the resource would take too long.
	...
	* type: boolean
	* uniqueness: none
* `display_name` - (Required) (Updatable) Group display name
...
* `idcs_prevented_operations` - (Optional) (Updatable) Each value of this attribute specifies an operation that only an internal client may perform on this particular resource.
	...
	* type: string
	* uniqueness: none
* `members` - (Optional) (Updatable) Group members - when requesting members attribute, a max of 10,000 members will be returned in a single request. It is recommended to use startIndex and count to return members in pages instead of in a single response, eg : #attributes=members[startIndex=1%26count=10]
	...
	* type: complex
	* uniqueness: none
	* `date_added` - (Optional) (Updatable) The DateTime the member was added to the Group.
		...
		* type: dateTime
		* uniqueness: none
	* `display` - (Optional) (Updatable) Member display name
	...
	* `membership_ocid` - (Optional) (Updatable) Membership Ocid
		...
		* type: string
		* uniqueness: none
	* `name` - (Optional) (Updatable) Member name
		...
		* type: string
		* uniqueness: none
	* `ocid` - (Optional) (Updatable) OCID of the member of this Group
	...
	* `type` - (Required) (Updatable) Indicates the type of resource--for example, User or Group
		...
		* type: string
		* uniqueness: none
	* `value` - (Required) (Updatable) ID of the member of this Group
...
* `meta` - (Optional) (Updatable) A complex attribute that contains resource metadata. All sub-attributes are OPTIONAL.
	...
	* `version` - (Optional) (Updatable) The version of the Resource being returned. This value must be the same as the ETag HTTP response header.
		...
		* type: string
		* uniqueness: none
* `non_unique_display_name` - (Optional) (Updatable) A human readable name for Group as defined by the Service Consumer
...
* `urnietfparamsscimschemasoracleidcsextensiondynamic_group` - (Optional) (Updatable) Dynamic Group
	...
	* `membership_type` - (Optional) (Updatable) Membership type
		...
		* type: string
		* uniqueness: none
* `urnietfparamsscimschemasoracleidcsextensiongroup_group` - (Optional) (Updatable) Idcs Group
