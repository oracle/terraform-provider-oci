...
sidebar_current: "docs-oci-resource-database_tools_runtime-database_tools_connection_credential_execute_grantee"
description: |-
  Provides the Database Tools Connection Credential Execute Grantee resource in Oracle Cloud Infrastructure Database Tools Runtime service
---
...
* `key` - (Required) The name of the user to grant the EXECUTE privilege on the credential.
...
The `timeouts` block allows you to specify [timeouts](https://registry.terraform.io/providers/oracle/oci/latest/docs/guides/changing_timeouts) for certain operations:
	* `create` - (Defaults to 20 minutes), when creating the Database Tools Connection Credential Execute Grantee
	* `update` - (Defaults to 20 minutes), when updating the Database Tools Connection Credential Execute Grantee
	* `delete` - (Defaults to 20 minutes), when destroying the Database Tools Connection Credential Execute Grantee
...
```
$ terraform import oci_database_tools_runtime_database_tools_connection_credential_execute_grantee.test_database_tools_connection_credential_execute_grantee "databaseToolsConnections/{databaseToolsConnectionId}/credentials/{credentialKey}/executeGrantees/{executeGranteeKey}" 
```
