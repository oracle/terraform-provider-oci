...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_database_management_cloud_exadata_storage_server"
sidebar_current: "docs-oci-resource-database_management-cloud_exadata_storage_server"
description: |-
  Provides the Cloud Exadata Storage Server resource in Oracle Cloud Infrastructure Database Management service
---
...
```hcl
resource "oci_database_management_cloud_exadata_storage_server" "test_cloud_exadata_storage_server" {
	#Required
	cloud_exadata_storage_server_id = oci_database_management_cloud_exadata_storage_server.test_cloud_exadata_storage_server.id
...
* `cloud_exadata_storage_server_id` - (Required) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata storage server.
...
The `timeouts` block allows you to specify [timeouts](https://registry.terraform.io/providers/oracle/oci/latest/docs/guides/changing_timeouts) for certain operations:
	* `create` - (Defaults to 20 minutes), when creating the Cloud Exadata Storage Server
	* `update` - (Defaults to 20 minutes), when updating the Cloud Exadata Storage Server
	* `delete` - (Defaults to 20 minutes), when destroying the Cloud Exadata Storage Server
...
```
$ terraform import oci_database_management_cloud_exadata_storage_server.test_cloud_exadata_storage_server "id"
```
