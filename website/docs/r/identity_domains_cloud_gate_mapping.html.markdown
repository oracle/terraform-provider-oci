...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_cloud_gate_mapping"
sidebar_current: "docs-oci-resource-identity_domains-cloud_gate_mapping"
description: |-
  Provides the Cloud Gate Mapping resource in Oracle Cloud Infrastructure Identity Domains service
---
...
* `cloud_gate` - (Required) (Updatable) Reference to owning Cloud Gate
	...
	* type: complex
	* uniqueness: none
	* `ref` - (Optional) (Updatable) The URI of the OAuth app for this Cloud Gate.
...
* `domain_ocid` - (Optional) (Updatable) Oracle Cloud Infrastructure Domain Id (ocid) in which the resource lives.
	...
	* type: string
	* uniqueness: none
* `gateway_app` - (Required) (Updatable) Reference to gateway application protected by this Cloud Gate
	...
	* type: complex
	* uniqueness: none
	* `ref` - (Optional) (Updatable) The URI to the gateway application protected by this Cloud Gate
		...
		* type: reference
		* uniqueness: none
	* `name` - (Required) (Updatable) The name (Client ID) of the gateway application protected by this Cloud Gate.
		...
		* type: string
		* uniqueness: none
	* `value` - (Required) (Updatable) The id of the gateway application protected by this Cloud Gate.
...
* `ocid` - (Optional) (Updatable) Unique Oracle Cloud Infrastructure identifier for the SCIM Resource.
	...
	* type: string
	* uniqueness: global
* `policy_name` - (Required) (Updatable) The Web Tier policy name used for the App that is mapped to the owning Cloud Gate
...
* `schemas` - (Required) (Updatable) REQUIRED. The schemas attribute is an array of Strings which allows introspection of the supported schema version for a SCIM representation as well any schema extensions supported by that representation. Each String value must be a unique URI. This specification defines URIs for User, Group, and a standard \"enterprise\" extension. All representations of SCIM schema MUST include a non-zero value array with value(s) of the URIs supported by that representation. Duplicate values MUST NOT be included. Value order is not specified and MUST not impact behavior.
	...
	* type: string
	* uniqueness: none
* `server` - (Required) (Updatable) Reference to server block for this mapping
	...
	* type: complex
	* uniqueness: none
	* `ref` - (Optional) (Updatable) The URI to the server block entry
		...
		* type: reference
		* uniqueness: none
	* `value` - (Required) (Updatable) The id of the server block entry.
...
* `tenancy_ocid` - (Optional) (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
	...
	* type: string
	* uniqueness: none
* `upstream_server_group` - (Optional) (Updatable) Reference to upstream block for this mapping
	...
	* type: complex
	* uniqueness: none
	* `ref` - (Optional) (Updatable) The URI to the upstream block entry
	...
	* `ssl` - (Optional) (Updatable) SSL flag for the Upstream Block
		...
		* type: boolean
		* uniqueness: none
	* `value` - (Optional) (Updatable) The id of the upstream block entry.
...
* `cloud_gate` - Reference to owning Cloud Gate
	...
	* type: complex
	* uniqueness: none
	* `ref` - The URI of the OAuth app for this Cloud Gate.
...
* `domain_ocid` - Oracle Cloud Infrastructure Domain Id (ocid) in which the resource lives.
	...
	* type: string
	* uniqueness: none
* `gateway_app` - Reference to gateway application protected by this Cloud Gate
	...
	* type: complex
	* uniqueness: none
	* `ref` - The URI to the gateway application protected by this Cloud Gate
		...
		* type: reference
		* uniqueness: none
	* `name` - The name (Client ID) of the gateway application protected by this Cloud Gate.
		...
		* type: string
		* uniqueness: none
	* `value` - The id of the gateway application protected by this Cloud Gate.
...
* `ocid` - Unique Oracle Cloud Infrastructure identifier for the SCIM Resource.
	...
	* type: string
	* uniqueness: global
* `policy_name` - The Web Tier policy name used for the App that is mapped to the owning Cloud Gate
...
* `schemas` - REQUIRED. The schemas attribute is an array of Strings which allows introspection of the supported schema version for a SCIM representation as well any schema extensions supported by that representation. Each String value must be a unique URI. This specification defines URIs for User, Group, and a standard \"enterprise\" extension. All representations of SCIM schema MUST include a non-zero value array with value(s) of the URIs supported by that representation. Duplicate values MUST NOT be included. Value order is not specified and MUST not impact behavior.
	...
	* type: string
	* uniqueness: none
* `server` - Reference to server block for this mapping
	...
	* type: complex
	* uniqueness: none
	* `ref` - The URI to the server block entry
		...
		* type: reference
		* uniqueness: none
	* `value` - The id of the server block entry.
...
* `tenancy_ocid` - Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
	...
	* type: string
	* uniqueness: none
* `upstream_server_group` - Reference to upstream block for this mapping
	...
	* type: complex
	* uniqueness: none
	* `ref` - The URI to the upstream block entry
	...
	* `ssl` - SSL flag for the Upstream Block
		...
		* type: boolean
		* uniqueness: none
	* `value` - The id of the upstream block entry.
...
The `timeouts` block allows you to specify [timeouts](https://registry.terraform.io/providers/oracle/oci/latest/docs/guides/changing_timeouts) for certain operations:
	* `create` - (Defaults to 20 minutes), when creating the Cloud Gate Mapping
	* `update` - (Defaults to 20 minutes), when updating the Cloud Gate Mapping
	* `delete` - (Defaults to 20 minutes), when destroying the Cloud Gate Mapping
