...
layout: "oci"
page_title: "Oracle Cloud Infrastructure: oci_identity_domains_approval_workflow_step"
sidebar_current: "docs-oci-resource-identity_domains-approval_workflow_step"
description: |-
  Provides the Approval Workflow Step resource in Oracle Cloud Infrastructure Identity Domains service
---
...
* `approvers` - (Optional) Approvers of the ApprovalWorkflowStep.
	...
	* type: complex
	* uniqueness: none
	* `ref` - (Optional) (Updatable) Approver URI
		...
		* type: reference
		* uniqueness: none
	* `display` - (Optional) (Updatable) The display of the approver.
		...
		* type: string
		* uniqueness: none
	* `ocid` - (Optional) The unique Oracle Cloud Infrastructure identifier of the approver.
		...
		* type: string
		* uniqueness: none
	* `type` - (Required) The type of the approver.
		...
		* type: reference
		* uniqueness: none
	* `value` - (Required) The unique identifier of the approver.
		...
		* type: string
		* uniqueness: none
* `approvers_expressions` - (Optional) approversExpressions of ApprovalWorkflowStep
...
* `meta` - (Optional) (Updatable) A complex attribute that contains resource metadata. All sub-attributes are OPTIONAL.
	...
	* `version` - (Optional) The version of the Resource being returned. This value must be the same as the ETag HTTP response header.
		...
		* type: string
		* uniqueness: none
* `minimum_approvals` - (Optional) Minimum number of Approvals required for this step.
...
* `ocid` - (Optional) Unique Oracle Cloud Infrastructure identifier for the SCIM Resource.
	...
	* type: string
	* uniqueness: global
* `order` - (Required) Order of the ApprovalWorkflowStep.
...
* `tenancy_ocid` - (Optional) (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
	...
	* type: string
	* uniqueness: none
* `type` - (Required) Type of ApprovalWorkflowStep
...
The `timeouts` block allows you to specify [timeouts](https://registry.terraform.io/providers/oracle/oci/latest/docs/guides/changing_timeouts) for certain operations:
	* `create` - (Defaults to 20 minutes), when creating the Approval Workflow Step
	* `update` - (Defaults to 20 minutes), when updating the Approval Workflow Step
	* `delete` - (Defaults to 20 minutes), when destroying the Approval Workflow Step
