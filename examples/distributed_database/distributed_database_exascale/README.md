...
- An existing **Cloud VM Cluster** OCID (for `vm_cluster_id`).
...
- The resource schema in this provider generation requires `distributed_database_id` as an input. Provide it via tfvars.
