...
resource "oci_core_private_ip" "test_flex_cidr" {
...
# List IPv6s
data "oci_core_private_ips" "flex_cidr_datasource" {
  vnic_id = oci_core_private_ip.test_flex_cidr.vnic_id
}

output "flex_cidrs" {
  value = [data.oci_core_private_ips.flex_cidr_datasource.private_ips]
}