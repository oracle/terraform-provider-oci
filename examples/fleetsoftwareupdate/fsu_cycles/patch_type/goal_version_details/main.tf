// path: fleetsoftwareupdate/fsu_cycles/patch_type/goal_version_details
...
// Fsu Cycle resource for database version 19 with goal version details
resource "oci_fleet_software_update_fsu_cycle" "test_fsu_cycle_db19_goal_version" {
