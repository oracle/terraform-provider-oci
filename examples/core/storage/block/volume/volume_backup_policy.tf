...
variable "volume_backup_policy_schedules_is_prevent_deletion_enabled" {
  default = false
}

variable "volume_backup_policy_schedules_is_retention_lock_enabled" {
  default = false
}

variable "volume_backup_policy_schedules_retention_period_retention_time_amount" {
  default = 1
}

variable "volume_backup_policy_schedules_retention_period_retention_time_unit" {
  default = "DAYS"
}
