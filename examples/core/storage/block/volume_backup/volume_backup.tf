...
variable "volume_backup_is_indefinite_retention_enabled" {
  default = false
}

variable "volume_backup_is_prevent_deletion_enabled" {
  default = false
}

variable "volume_backup_is_retention_lock_enabled" {
  default = false
}

variable "volume_backup_retention_period_retention_time_amount" {
  default = 1
}

variable "volume_backup_retention_period_retention_time_unit" {
  default = "DAYS"
}
...
output "volumeBackups" {
  value = data.oci_core_volume_backups.test_volume_backup.volume_backups
}
