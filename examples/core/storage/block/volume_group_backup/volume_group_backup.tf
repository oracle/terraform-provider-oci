...
variable "volume_group_backup_is_indefinite_retention_enabled" {
  default = false
}

variable "volume_group_backup_is_prevent_deletion_enabled" {
  default = false
}

variable "volume_group_backup_is_retention_lock_enabled" {
  default = false
}

variable "volume_group_backup_retention_period_retention_time_amount" {
  default = 1
}

variable "volume_group_backup_retention_period_retention_time_unit" {
  default = "DAYS"
}
...
output "volumeGroupBackups" {
  value = data.oci_core_volume_group_backups.test_volume_group_backup.volume_group_backups
}
