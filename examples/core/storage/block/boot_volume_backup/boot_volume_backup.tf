...
variable "boot_volume_backup_is_indefinite_retention_enabled" {
  default = false
}

variable "boot_volume_backup_is_prevent_deletion_enabled" {
  default = false
}

variable "boot_volume_backup_is_retention_lock_enabled" {
  default = false
}

variable "boot_volume_backup_retention_period_retention_time_amount" {
  default = 1
}

variable "boot_volume_backup_retention_period_retention_time_unit" {
  default = "DAYS"
}
...
data "oci_core_boot_volume_backup" "test_boot_volume_backup_from_source_boot_volume_datasource" {
  boot_volume_backup_id = oci_core_boot_volume_backup.test_boot_volume_backup_from_source_boot_volume.id
}
...
output "boot_volume_from_instance_outputs" {
  value = {
    ...
    boot_volume_backup_from_source_boot_volume            = data.oci_core_boot_volume_backup.test_boot_volume_backup_from_source_boot_volume_datasource
