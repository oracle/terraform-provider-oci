...
variable "sensitive_data_models_sensitive_column_app_name" {
  default = "appName"
}

variable "sensitive_data_models_sensitive_column_column_group" {
  default = "columnGroup"
}

variable "sensitive_data_models_sensitive_column_column_name_list" {
  type = list(string)
  default = ["columnName"]
}
...
variable "sensitive_data_models_sensitive_column_object_list" {
  type = list(string)
  default = ["object"]
}
...
variable "sensitive_data_models_sensitive_column_schema_name_list" {
  type = list(string)
  default = ["schemaName"]
}

variable "sensitive_data_models_sensitive_column_status" {
  default = "VALID"
}
