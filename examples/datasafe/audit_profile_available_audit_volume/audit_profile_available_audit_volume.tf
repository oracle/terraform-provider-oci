...
data "oci_data_safe_audit_profile_available_audit_volumes" "test_audit_profile_available_audit_volumes" {
  ...
  # trail_location                      = "UNIFIED_AUDIT_TRAIL"
}
...
output "plural_volume_collection" {
  value = data.oci_data_safe_audit_profile_available_audit_volumes.test_audit_profile_available_audit_volumes.available_audit_volume_collection
}

output "singular_items" {
  value = data.oci_data_safe_audit_profile_available_audit_volume.test_audit_profile_available_audit_volume.items
}
