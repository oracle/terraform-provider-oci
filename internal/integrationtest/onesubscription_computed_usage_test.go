...
var (
	...
	OnesubscriptionOnesubscriptionComputedUsageDataSourceRepresentation = map[string]interface{}{
		...
		"computed_product": acctest.Representation{RepType: acctest.Optional, Create: `${var.computed_product}`},
...
func TestOnesubscriptionComputedUsageResource_basic(t *testing.T) {
	...
	datasourceName := "data.oci_onesubscription_computed_usages.test_computed_usages"
	singularDatasourceName := "data.oci_onesubscription_computed_usage.test_computed_usage"
