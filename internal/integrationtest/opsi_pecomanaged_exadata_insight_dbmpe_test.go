...
var (
	peComanagedExadataInsightDbmpeRequiredOnlyResource = peComanagedExadataInsightDbmpeResourceDependencies +
		acctest.GenerateResourceFromRepresentationMap("oci_opsi_exadata_insight", "test_exadata_insight", acctest.Required, acctest.Create, peComanagedExadataInsightDbmpeRepresentation)

	peComanagedExadataInsightDbmpeResourceConfig = peComanagedExadataInsightDbmpeResourceDependencies +
		acctest.GenerateResourceFromRepresentationMap("oci_opsi_exadata_insight", "test_exadata_insight", acctest.Optional, acctest.Update, peComanagedExadataInsightDbmpeRepresentation)

	peComanagedOpsiExadataInsightDbmpeSingularDataSourceRepresentation = map[string]interface{}{
	...
	peComanagedOpsiExadataInsightDbmpeDataSourceRepresentation = map[string]interface{}{
		...
		"filter":                    acctest.RepresentationGroup{RepType: acctest.Required, Group: peComanagedExadataInsightDbmpeDataSourceFilterRepresentation}}

	peComanagedExadataInsightDbmpeDataSourceFilterRepresentation = map[string]interface{}{
	...
	peComanagedExadataInsightDbmpeRepresentation = map[string]interface{}{
		...
		"lifecycle":                 acctest.RepresentationGroup{RepType: acctest.Required, Group: ignoreChangesPeComanagedExadataInsightDbmpeRepresentation},
		"member_vm_cluster_details": acctest.RepresentationGroup{RepType: acctest.Optional, Group: peComanagedExadataInsightDbmpeMemberVmClusterDetailsRepresentation},
	}

	peComanagedExadataInsightDbmpeMemberVmClusterDetailsRepresentation = map[string]interface{}{
		"compartment_id":           acctest.Representation{RepType: acctest.Optional, Create: `${var.compartment_id}`},
		"member_database_details":  acctest.RepresentationGroup{RepType: acctest.Optional, Group: peComanagedExadataInsightDbmpeMemberVmClusterDetailsMemberDatabaseDetailsRepresentation},
	...
	peComanagedExadataInsightDbmpeMemberVmClusterDetailsMemberDatabaseDetailsRepresentation = map[string]interface{}{
		"compartment_id":           acctest.Representation{RepType: acctest.Optional, Create: `${var.compartment_id}`},
		"credential_details":       acctest.RepresentationGroup{RepType: acctest.Required, Group: peComanagedExadataInsightDbmpeCredentialDetailsRepresentation},
	...
	peComanagedExadataInsightDbmpeCredentialDetailsRepresentation = map[string]interface{}{
	...
	ignoreChangesPeComanagedExadataInsightDbmpeRepresentation = map[string]interface{}{
		"ignore_changes": acctest.Representation{RepType: acctest.Required, Create: []string{`defined_tags`}},
	}

	peComanagedExadataInsightDbmpeResourceDependencies = DefinedTagsDependencies
)
...
func TestPeComanagedExadataInsightDbmpeResource_basic(t *testing.T) {
	...
	envVarsString := compartmentIdVariableStr + compartmentIdUVariableStr + opsiPrivateEndpointIdVariableStr +
		dbmPrivateEndpointIdVariableStr + exadataInfraIdVariableStr + vmClusterIdVariableStr + secretIdVariableStr +
		userNameVariableStr + dbsystemDatabaseIdVariableStr + serviceNameVariableStr
	...
	acctest.SaveConfigContent(config+envVarsString+peComanagedExadataInsightDbmpeResourceDependencies+
		acctest.GenerateResourceFromRepresentationMap("oci_opsi_exadata_insight", "test_exadata_insight", acctest.Optional, acctest.Create, peComanagedExadataInsightDbmpeRepresentation), "opsi", "exadataInsight", t)

	acctest.ResourceTest(t, testAccCheckPeComanagedExadataInsightDbmpeDestroy, []resource.TestStep{
		// verify Create with optionals - Step 0
		{
			Config: config + envVarsString + peComanagedExadataInsightDbmpeResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_opsi_exadata_insight", "test_exadata_insight", acctest.Optional, acctest.Create, peComanagedExadataInsightDbmpeRepresentation),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "member_vm_cluster_details.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "member_vm_cluster_details.0.compartment_id", compartmentId),
				resource.TestCheckResourceAttrSet(resourceName, "member_vm_cluster_details.0.opsi_private_endpoint_id"),
		...
		// verify update to the compartment (the compartment will be switched back in the next step) - Step 1
		{
			Config: config + envVarsString + peComanagedExadataInsightDbmpeResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_opsi_exadata_insight", "test_exadata_insight", acctest.Optional, acctest.Create,
					acctest.RepresentationCopyWithNewProperties(peComanagedExadataInsightDbmpeRepresentation, map[string]interface{}{
		...
		{
			Config: config +
				acctest.GenerateDataSourceFromRepresentationMap("oci_opsi_exadata_insights", "test_exadata_insights", acctest.Optional, acctest.Update, peComanagedOpsiExadataInsightDbmpeDataSourceRepresentation) +
				envVarsString + peComanagedExadataInsightDbmpeResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_opsi_exadata_insight", "test_exadata_insight", acctest.Optional, acctest.Update, peComanagedExadataInsightDbmpeRepresentation),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
		...
		{
			Config: config +
				acctest.GenerateDataSourceFromRepresentationMap("oci_opsi_exadata_insight", "test_exadata_insight", acctest.Required, acctest.Create, peComanagedOpsiExadataInsightDbmpeSingularDataSourceRepresentation) +
				envVarsString + peComanagedExadataInsightDbmpeResourceConfig,
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
		...
		{
			Config:            config + peComanagedExadataInsightDbmpeRequiredOnlyResource,
			ImportState:       true,
...
func testAccCheckPeComanagedExadataInsightDbmpeDestroy(s *terraform.State) error {
...
func init() {
	...
	if !acctest.InSweeperExcludeList("PeComanagedExadataInsightDbmpe") {
		resource.AddTestSweepers("PeComanagedExadataInsightDbmpe", &resource.Sweeper{
			Name:         "PeComanagedExadataInsightDbmpe",
			Dependencies: acctest.DependencyGraph["exadataInsight"],
			F:            sweepPeComanagedExadataInsightDbmpeResource,
		})
	}
}
...
func sweepPeComanagedExadataInsightDbmpeResource(compartment string) error {
	...
	exadataInsightIds, err := getPeComanagedExadataInsightDbmpeIds(compartment)
	if err != nil {
		return err
	}
	for _, exadataInsightId := range exadataInsightIds {
		if ok := acctest.SweeperDefaultResourceId[exadataInsightId]; !ok {
			...
			acctest.WaitTillCondition(acctest.TestAccProvider, &exadataInsightId, PeComanagedExadataInsightDbmpeSweepWaitCondition, time.Duration(3*time.Minute),
				PeComanagedExadataInsightDbmpeSweepResponseFetchOperation, "opsi", true)
		}
	}
	return nil
}

func getPeComanagedExadataInsightDbmpeIds(compartment string) ([]string, error) {
...
func PeComanagedExadataInsightDbmpeSweepWaitCondition(response common.OCIOperationResponse) bool {
...
func PeComanagedExadataInsightDbmpeSweepResponseFetchOperation(client *tf_client.OracleClients, resourceId *string, retryPolicy *common.RetryPolicy) error {
