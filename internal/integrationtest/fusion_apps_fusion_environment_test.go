...
var (
	...
	FusionAppsFusionEnvironmentAdditionalEgressRulesRepresentation = map[string]interface{}{
		"description":          acctest.Representation{RepType: acctest.Required, Create: `description`, Update: `description2`},
		"destination_cidr":     acctest.Representation{RepType: acctest.Required, Create: `203.0.113.5/32`, Update: `203.0.113.6/32`},
		"max_destination_port": acctest.Representation{RepType: acctest.Required, Create: `465`, Update: `587`},
		"min_destination_port": acctest.Representation{RepType: acctest.Required, Create: `465`, Update: `587`},
	}
	...
	acctest.ResourceTest(t, testAccCheckFusionAppsFusionEnvironmentDestroy, []resource.TestStep{
		...
		**/
		...
		// verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				resource.TestCheckResourceAttr(resourceName, "additional_egress_rules.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "additional_egress_rules.0.description", "description"),
				resource.TestCheckResourceAttr(resourceName, "additional_egress_rules.0.destination_cidr", "203.0.113.5/32"),
				resource.TestCheckResourceAttr(resourceName, "additional_egress_rules.0.max_destination_port", "465"),
				resource.TestCheckResourceAttr(resourceName, "additional_egress_rules.0.min_destination_port", "465"),
		...
		// verify updates to updatable parameters
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				resource.TestCheckResourceAttr(resourceName, "additional_egress_rules.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "additional_egress_rules.0.description", "description2"),
				resource.TestCheckResourceAttr(resourceName, "additional_egress_rules.0.destination_cidr", "203.0.113.5/32"),
				resource.TestCheckResourceAttr(resourceName, "additional_egress_rules.0.max_destination_port", "587"),
				resource.TestCheckResourceAttr(resourceName, "additional_egress_rules.0.min_destination_port", "587"),
				resource.TestCheckResourceAttr(resourceName, "additional_language_packs.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "compartment_id", compartmentId),
				resource.TestCheckResourceAttr(resourceName, "create_fusion_environment_admin_user_details.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "create_fusion_environment_admin_user_details.0.email_address", "JohnSmith@example.com"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "additional_egress_rules.#", "1"),
				resource.TestCheckResourceAttr(singularDatasourceName, "additional_egress_rules.0.description", "description2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "additional_egress_rules.0.destination_cidr", "203.0.113.5/32"),
				resource.TestCheckResourceAttr(singularDatasourceName, "additional_egress_rules.0.max_destination_port", "587"),
				resource.TestCheckResourceAttr(singularDatasourceName, "additional_egress_rules.0.min_destination_port", "587"),
