...
var (
	...
	FusionAppsFusionEnvironmentCreateFusionEnvironmentAdminUserDetailsRepresentation = map[string]interface{}{
		...
		"username":      acctest.Representation{RepType: acctest.Required, Create: `username`},
	}
	...
	acctest.ResourceTest(t, testAccCheckFusionAppsFusionEnvironmentDestroy, []resource.TestStep{
		// verify Create
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "create_fusion_environment_admin_user_details.0.username", "username"),
		...
		// verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "rules.0.conditions.0.attribute_value", "attributeValue"),
		...
		// verify updates to updatable parameters
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "rules.0.action", "ALLOW"),
				resource.TestCheckResourceAttr(resourceName, "rules.0.conditions.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "rules.0.conditions.0.attribute_name", "SOURCE_VCN_ID"),
				resource.TestCheckResourceAttr(resourceName, "rules.0.conditions.0.attribute_value", "attributeValue2"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "applied_patch_bundles.#", "1"),
				...
				resource.TestCheckResourceAttrSet(singularDatasourceName, "kms_key_info"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "refresh.#", "1"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "rules.0.conditions.0.attribute_name", "SOURCE_VCN_ID"),
				resource.TestCheckResourceAttr(singularDatasourceName, "rules.0.conditions.0.attribute_value", "attributeValue2"),
