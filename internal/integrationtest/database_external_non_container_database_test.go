	...
	acctest.ResourceTest(t, testAccCheckDatabaseExternalNonContainerDatabaseDestroy, []resource.TestStep{
		...
		// verify datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(datasourceName, "external_non_container_databases.0.system_tags.%", "0"),
				...
				resource.TestCheckResourceAttr(datasourceName, "external_non_container_databases.0.stack_monitoring_config.#", "1"),
