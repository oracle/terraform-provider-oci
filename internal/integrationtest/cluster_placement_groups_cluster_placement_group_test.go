...
var (
	...
	ClusterPlacementGroupsClusterPlacementGroupCapabilitiesItemsRepresentation = map[string]interface{}{
		"name":               acctest.Representation{RepType: acctest.Required, Create: `VM.Standard.E4.Flex`},
		"service":            acctest.Representation{RepType: acctest.Required, Create: `compute`},
		"additional_details": acctest.RepresentationGroup{RepType: acctest.Optional, Group: ClusterPlacementGroupsClusterPlacementGroupCapabilitiesItemsAdditionalDetailsRepresentation},
	}
	ClusterPlacementGroupsClusterPlacementGroupCapabilitiesItemsAdditionalDetailsRepresentation = map[string]interface{}{
		"service_type":                  acctest.Representation{RepType: acctest.Required, Create: `COMPUTE`},
		"cluster_placement_group_count": acctest.Representation{RepType: acctest.Optional, Create: `1`},
		"memory_in_gbs":                 acctest.Representation{RepType: acctest.Optional, Create: `16`},
	...
	acctest.ResourceTest(t, testAccCheckClusterPlacementGroupsClusterPlacementGroupDestroy, []resource.TestStep{
		...
		// verify Create with optionals 3
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "capabilities.0.items.0.additional_details.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "capabilities.0.items.0.additional_details.0.cluster_placement_group_count", "1"),
				resource.TestCheckResourceAttr(resourceName, "capabilities.0.items.0.additional_details.0.memory_in_gbs", "16"),
				resource.TestCheckResourceAttr(resourceName, "capabilities.0.items.0.additional_details.0.ocpus", "1"),
				resource.TestCheckResourceAttr(resourceName, "capabilities.0.items.0.additional_details.0.service_type", "COMPUTE"),
				resource.TestCheckResourceAttr(resourceName, "capabilities.0.items.0.name", "VM.Standard.E4.Flex"),

				resource.TestCheckResourceAttr(resourceName, "capabilities.0.items.0.service", "compute"),
				resource.TestCheckResourceAttr(resourceName, "cluster_placement_group_type", "STANDARD"),
				resource.TestCheckResourceAttr(resourceName, "compartment_id", compartmentId),
				resource.TestCheckResourceAttr(resourceName, "description", "description"),
				resource.TestCheckResourceAttr(resourceName, "freeform_tags.%", "1"),
		...
		// verify singular datasource 7
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "capabilities.0.items.0.additional_details.#", "1"),
				resource.TestCheckResourceAttr(singularDatasourceName, "capabilities.0.items.0.additional_details.0.cluster_placement_group_count", "1"),
				resource.TestCheckResourceAttr(singularDatasourceName, "capabilities.0.items.0.additional_details.0.memory_in_gbs", "16"),
				resource.TestCheckResourceAttr(singularDatasourceName, "capabilities.0.items.0.additional_details.0.ocpus", "1"),
				resource.TestCheckResourceAttr(singularDatasourceName, "capabilities.0.items.0.additional_details.0.service_type", "COMPUTE"),
				resource.TestCheckResourceAttr(singularDatasourceName, "capabilities.0.items.0.name", "VM.Standard.E4.Flex"),

				resource.TestCheckResourceAttr(singularDatasourceName, "capabilities.0.items.0.service", "compute"),
