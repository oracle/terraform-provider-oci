...
var (
	...
	DistributedDatabaseDistributedDatabaseDataSourceRepresentation = map[string]interface{}{
		/*
			...
			"display_name":        acctest.Representation{RepType: acctest.Optional, Create: `CreateSdb567`, Update: `displayName2`},
			"metadata":            acctest.RepresentationGroup{RepType: acctest.Optional, Group: DistributedDatabaseDistributedDatabaseMetadataRepresentation},
		...
		*/
		"compartment_id":     acctest.Representation{RepType: acctest.Required, Create: `${var.compartment_id}`},
		"db_deployment_type": acctest.Representation{RepType: acctest.Optional, Create: `EXADB_XS`},
		"display_name":       acctest.Representation{RepType: acctest.Optional, Create: `mt2-exadbxs-test-3`, Update: `mt2-exadbxs-test-3`},
		// "metadata": acctest.Representation{RepType: acctest.Optional},
		// metadata is computed-only for this datasource; do not configure it.
	...
	// TF_CODE_GEN: TERSI-4920-TOP-24 generated Exascale integration fixtures drifted
	// away from the maintained example module. Keep the active representation and
	// assertions aligned with examples/distributed_database/distributed_database_exascale.
	DistributedDatabaseDistributedDatabaseRepresentation = map[string]interface{}{
		/*
				...
				"compartment_id":                  acctest.Representation{RepType: acctest.Required, Create: `${var.compartment_id}`},
				"database_version":                acctest.Representation{RepType: acctest.Required, Create: `23ai`},
				"db_deployment_type":              acctest.Representation{RepType: acctest.Required, Create: `EXADB_XS`},
				"display_name":                    acctest.Representation{RepType: acctest.Required, Create: `CreateSdb567`, Update: `displayName2`},
				"distributed_database_id":         acctest.Representation{RepType: acctest.Required, Create: `${oci_distributed_database_distributed_database.test_distributed_database.id}`},
				...
				"prefix":                          acctest.Representation{RepType: acctest.Required, Create: `yy9`},
				"private_endpoint_ids":            acctest.Representation{RepType: acctest.Required, Create: []string{`privateEndpointIds`}},
				"shard_details":                   acctest.RepresentationGroup{RepType: acctest.Required, Group: DistributedDatabaseDistributedDatabaseShardDetailsRepresentation},
				...
				"scan_listener_port":              acctest.Representation{RepType: acctest.Optional, Create: `10`},
			...
			DistributedDatabaseDistributedDatabaseCatalogDetailsRepresentation = map[string]interface{}{
				...
				"db_storage_vault_details": acctest.RepresentationGroup{RepType: acctest.Optional, Group: DistributedDatabaseDistributedDatabaseCatalogDetailsDbStorageVaultDetailsRepresentation},
				...
				"peer_details":             acctest.RepresentationGroup{RepType: acctest.Optional, Group: DistributedDatabaseDistributedDatabaseCatalogDetailsPeerDetailsRepresentation},
				"peer_vm_cluster_ids":      acctest.Representation{RepType: acctest.Optional, Create: []string{`peerVmClusterIds`}},
				...
				"vm_cluster_details":       acctest.RepresentationGroup{RepType: acctest.Optional, Group: DistributedDatabaseDistributedDatabaseCatalogDetailsVmClusterDetailsRepresentation},
			...
			DistributedDatabaseDistributedDatabaseShardDetailsRepresentation = map[string]interface{}{
				...
				"source":                   acctest.Representation{RepType: acctest.Required, Create: `EXADB_XS`},
				"availability_domain":      acctest.Representation{RepType: acctest.Optional, Create: `${data.oci_identity_availability_domains.test_availability_domains.availability_domains.0.name}`},
				"db_storage_vault_details": acctest.RepresentationGroup{RepType: acctest.Optional, Group: DistributedDatabaseDistributedDatabaseShardDetailsDbStorageVaultDetailsRepresentation},
				"kms_key_id":               acctest.Representation{RepType: acctest.Optional, Create: `${lookup(data.oci_kms_keys.test_keys_dependency.keys[0], "id")}`},
				"kms_key_version_id":       acctest.Representation{RepType: acctest.Optional, Create: `${oci_kms_key_version.test_key_version.id}`},
				"peer_details":             acctest.RepresentationGroup{RepType: acctest.Optional, Group: DistributedDatabaseDistributedDatabaseShardDetailsPeerDetailsRepresentation},
				"peer_vm_cluster_ids":      acctest.Representation{RepType: acctest.Optional, Create: []string{`peerVmClusterIds`}},
				"shard_space":              acctest.Representation{RepType: acctest.Optional, Create: `shardSpace`},
				"vault_id":                 acctest.Representation{RepType: acctest.Optional, Create: `${oci_kms_vault.test_vault.id}`},
				"vm_cluster_details":       acctest.RepresentationGroup{RepType: acctest.Optional, Group: DistributedDatabaseDistributedDatabaseShardDetailsVmClusterDetailsRepresentation},
				"vm_cluster_id":            acctest.Representation{RepType: acctest.Optional, Create: `${oci_database_vm_cluster.test_vm_cluster.id}`},
		*/
		"catalog_details":    acctest.RepresentationGroup{RepType: acctest.Required, Group: DistributedDatabaseDistributedDatabaseCatalogDetailsRepresentation},
		"character_set":      acctest.Representation{RepType: acctest.Required, Create: `AL32UTF8`},
		...
		"db_deployment_type": acctest.Representation{RepType: acctest.Required, Create: `EXADB_XS`},
		"display_name":       acctest.Representation{RepType: acctest.Required, Create: `mt2-exadbxs-test-3`, Update: `mt2-exadbxs-test-3`},
		// "distributed_database_id":         acctest.Representation{RepType: acctest.Required, Create: `${oci_distributed_database_distributed_database.test_distributed_database.id}`},
		"listener_port":        acctest.Representation{RepType: acctest.Required, Create: `6194`},
		"ncharacter_set":       acctest.Representation{RepType: acctest.Required, Create: `AL16UTF16`},
		"ons_port_local":       acctest.Representation{RepType: acctest.Required, Create: `6195`},
		"ons_port_remote":      acctest.Representation{RepType: acctest.Required, Create: `6196`},
		"prefix":               acctest.Representation{RepType: acctest.Required, Create: `mt2`},
		...
		"freeform_tags": acctest.Representation{RepType: acctest.Optional, Create: map[string]string{"team": "osd-qa"}, Update: map[string]string{"team": "osd-qa"}},
		// "listener_port_tls":               acctest.Representation{RepType: acctest.Optional, Create: `10`},
		...
		// "change_db_backup_config_trigger": acctest.Representation{RepType: acctest.Optional, Create: `0`, Update: `1`},
		// "configure_sharding_trigger":      acctest.Representation{RepType: acctest.Optional, Create: `0`, Update: `1`},
		// Legacy GSM action triggers are intentionally left disabled here. The runtime
		// now guards decommissioned GSM actions with provider errors, so these replayed
		// integration checks need dedicated error expectations before they can be re-enabled.
		// "download_gsm_certificate_signing_request_trigger":      acctest.Representation{RepType: acctest.Optional, Create: `0`, Update: `1`},
		// "generate_gsm_certificate_signing_request_trigger":      acctest.Representation{RepType: acctest.Optional, Create: `0`, Update: `1`},
		// "generate_wallet_trigger":                               acctest.Representation{RepType: acctest.Optional, Create: `0`, Update: `1`},
		// "upload_signed_certificate_and_generate_wallet_trigger": acctest.Representation{RepType: acctest.Optional, Create: `0`, Update: `1`},
	...
	DistributedDatabaseDistributedDatabaseCatalogDetailsRepresentation = map[string]interface{}{
		"admin_password": acctest.Representation{RepType: acctest.Required, Create: `MaskedPwd1234##`},
		"source":         acctest.Representation{RepType: acctest.Required, Create: `EXADB_XS`},
	...
	DistributedDatabaseDistributedDatabaseDbBackupConfigRepresentation = map[string]interface{}{
		...
		"recovery_window_in_days":    acctest.Representation{RepType: acctest.Optional, Create: `45`},
	}
	DistributedDatabaseDistributedDatabasePatchOperationsRepresentation = map[string]interface{}{
		...
		"selection": acctest.Representation{RepType: acctest.Required, Create: `shardDetails[?name == 'mt200004x']`},
		/*
				"value":     acctest.Representation{RepType: acctest.Optional, Create: `{}`},
			}
			DistributedDatabaseDistributedDatabaseCatalogDetailsDbStorageVaultDetailsRepresentation = map[string]interface{}{
				"additional_flash_cache_in_percent": acctest.Representation{RepType: acctest.Optional, Create: `10`},
				"high_capacity_database_storage":    acctest.Representation{RepType: acctest.Optional, Create: `10`},
			}
			DistributedDatabaseDistributedDatabaseCatalogDetailsPeerDetailsRepresentation = map[string]interface{}{
				"availability_domain":      acctest.Representation{RepType: acctest.Optional, Create: `${data.oci_identity_availability_domains.test_availability_domains.availability_domains.0.name}`},
				"db_storage_vault_details": acctest.RepresentationGroup{RepType: acctest.Optional, Group: DistributedDatabaseDistributedDatabaseCatalogDetailsPeerDetailsDbStorageVaultDetailsRepresentation},
				"protection_mode":          acctest.Representation{RepType: acctest.Optional, Create: `MAXIMUM_AVAILABILITY`},
				"transport_type":           acctest.Representation{RepType: acctest.Optional, Create: `SYNC`},
				"vm_cluster_details":       acctest.RepresentationGroup{RepType: acctest.Optional, Group: DistributedDatabaseDistributedDatabaseCatalogDetailsPeerDetailsVmClusterDetailsRepresentation},
				"vm_cluster_id":            acctest.Representation{RepType: acctest.Optional, Create: `${oci_database_vm_cluster.test_vm_cluster.id}`},
			}
			DistributedDatabaseDistributedDatabaseCatalogDetailsVmClusterDetailsRepresentation = map[string]interface{}{
				"backup_network_nsg_ids":        acctest.Representation{RepType: acctest.Optional, Create: []string{`backupNetworkNsgIds`}},
				"backup_subnet_id":              acctest.Representation{RepType: acctest.Optional, Create: `${oci_core_subnet.test_subnet.id}`},
				"domain":                        acctest.Representation{RepType: acctest.Optional, Create: `domain`},
				"enabled_ecpu_count":            acctest.Representation{RepType: acctest.Optional, Create: `10`},
				...
				"ssh_public_keys":               acctest.Representation{RepType: acctest.Optional, Create: []string{`ssh-rsa  sample`}},
				"subnet_id":                     acctest.Representation{RepType: acctest.Optional, Create: `${oci_core_subnet.test_subnet.id}`},
				"total_ecpu_count":              acctest.Representation{RepType: acctest.Optional, Create: `10`},
				"vm_file_system_storage_size":   acctest.Representation{RepType: acctest.Optional, Create: `10`},
			}
			DistributedDatabaseDistributedDatabaseShardDetailsDbStorageVaultDetailsRepresentation = map[string]interface{}{
				"additional_flash_cache_in_percent": acctest.Representation{RepType: acctest.Optional, Create: `10`},
				"high_capacity_database_storage":    acctest.Representation{RepType: acctest.Optional, Create: `10`},
			}
			DistributedDatabaseDistributedDatabaseShardDetailsPeerDetailsRepresentation = map[string]interface{}{
				"availability_domain":      acctest.Representation{RepType: acctest.Optional, Create: `${data.oci_identity_availability_domains.test_availability_domains.availability_domains.0.name}`},
				"db_storage_vault_details": acctest.RepresentationGroup{RepType: acctest.Optional, Group: DistributedDatabaseDistributedDatabaseShardDetailsPeerDetailsDbStorageVaultDetailsRepresentation},
				"protection_mode":          acctest.Representation{RepType: acctest.Optional, Create: `MAXIMUM_AVAILABILITY`},
				"transport_type":           acctest.Representation{RepType: acctest.Optional, Create: `SYNC`},
				"vm_cluster_details":       acctest.RepresentationGroup{RepType: acctest.Optional, Group: DistributedDatabaseDistributedDatabaseShardDetailsPeerDetailsVmClusterDetailsRepresentation},
				"vm_cluster_id":            acctest.Representation{RepType: acctest.Optional, Create: `${oci_database_vm_cluster.test_vm_cluster.id}`},
			}
			DistributedDatabaseDistributedDatabaseShardDetailsVmClusterDetailsRepresentation = map[string]interface{}{
				"backup_network_nsg_ids":        acctest.Representation{RepType: acctest.Optional, Create: []string{`backupNetworkNsgIds`}},
				"backup_subnet_id":              acctest.Representation{RepType: acctest.Optional, Create: `${oci_core_subnet.test_subnet.id}`},
				"domain":                        acctest.Representation{RepType: acctest.Optional, Create: `domain`},
				"enabled_ecpu_count":            acctest.Representation{RepType: acctest.Optional, Create: `10`},
	...
	DistributedDatabaseDistributedDatabaseCatalogDetailsPeerDetailsDbStorageVaultDetailsRepresentation = map[string]interface{}{
		"additional_flash_cache_in_percent": acctest.Representation{RepType: acctest.Optional, Create: `10`},
		"high_capacity_database_storage":    acctest.Representation{RepType: acctest.Optional, Create: `10`},
	}
	DistributedDatabaseDistributedDatabaseCatalogDetailsPeerDetailsVmClusterDetailsRepresentation = map[string]interface{}{
		"backup_network_nsg_ids":        acctest.Representation{RepType: acctest.Optional, Create: []string{`backupNetworkNsgIds`}},
		"backup_subnet_id":              acctest.Representation{RepType: acctest.Optional, Create: `${oci_core_subnet.test_subnet.id}`},
		"domain":                        acctest.Representation{RepType: acctest.Optional, Create: `domain`},
		"enabled_ecpu_count":            acctest.Representation{RepType: acctest.Optional, Create: `10`},
	...
	DistributedDatabaseDistributedDatabaseShardDetailsPeerDetailsDbStorageVaultDetailsRepresentation = map[string]interface{}{
		"additional_flash_cache_in_percent": acctest.Representation{RepType: acctest.Optional, Create: `10`},
		"high_capacity_database_storage":    acctest.Representation{RepType: acctest.Optional, Create: `10`},
	}
	DistributedDatabaseDistributedDatabaseShardDetailsPeerDetailsVmClusterDetailsRepresentation = map[string]interface{}{
		"backup_network_nsg_ids":        acctest.Representation{RepType: acctest.Optional, Create: []string{`backupNetworkNsgIds`}},
		"backup_subnet_id":              acctest.Representation{RepType: acctest.Optional, Create: `${oci_core_subnet.test_subnet.id}`},
		"domain":                        acctest.Representation{RepType: acctest.Optional, Create: `domain`},
		"enabled_ecpu_count":            acctest.Representation{RepType: acctest.Optional, Create: `10`},
	...
	/*
		DistributedDatabaseDistributedDatabaseResourceDependencies = acctest.GenerateResourceFromRepresentationMap("oci_core_network_security_group", "test_network_security_group", acctest.Required, acctest.Create, CoreNetworkSecurityGroupRepresentation) +
			...
			acctest.GenerateResourceFromRepresentationMap("oci_dns_zone", "test_zone", acctest.Required, acctest.Create, DnsZoneRepresentation) +
...
func TestDistributedDatabaseDistributedDatabaseResource_basic(t *testing.T) {
	...
	compartmentId := utils.GetEnvSettingWithDefault("compartment_ocid", utils.GetEnvSettingWithBlankDefault("compartment_id"))
	if compartmentId == "" {
		t.Fatalf("set compartment_ocid or compartment_id before running %s", t.Name())
	}
		...
		// verify Create
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				/*
					...
					resource.TestCheckResourceAttrSet(resourceName, "catalog_details.0.availability_domain"),
					resource.TestCheckResourceAttr(resourceName, "catalog_details.0.db_storage_vault_details.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "catalog_details.0.db_storage_vault_details.0.high_capacity_database_storage", "10"),
					resource.TestCheckResourceAttr(resourceName, "catalog_details.0.source", "EXADB_XS"),
					resource.TestCheckResourceAttr(resourceName, "catalog_details.0.vm_cluster_details.#", "1"),
					resource.TestCheckResourceAttrSet(resourceName, "catalog_details.0.vm_cluster_details.0.backup_subnet_id"),
					resource.TestCheckResourceAttr(resourceName, "catalog_details.0.vm_cluster_details.0.enabled_ecpu_count", "10"),
					resource.TestCheckResourceAttr(resourceName, "catalog_details.0.vm_cluster_details.0.ssh_public_keys.#", "1"),
					resource.TestCheckResourceAttrSet(resourceName, "catalog_details.0.vm_cluster_details.0.subnet_id"),
				...
				*/
				...
				resource.TestCheckResourceAttr(resourceName, "db_backup_config.0.backup_destination_details.0.type", "OBJECT_STORE"),
				resource.TestCheckResourceAttr(resourceName, "db_backup_config.0.is_auto_backup_enabled", "true"),
				resource.TestCheckResourceAttr(resourceName, "db_backup_config.0.recovery_window_in_days", "45"),
				resource.TestCheckResourceAttr(resourceName, "db_deployment_type", "EXADB_XS"),
				resource.TestCheckResourceAttr(resourceName, "display_name", "mt2-exadbxs-test-3"),
				resource.TestCheckResourceAttr(resourceName, "freeform_tags.%", "1"),
				resource.TestCheckResourceAttr(resourceName, "freeform_tags.team", "osd-qa"),
				resource.TestCheckResourceAttr(resourceName, "listener_port", "6194"),
				resource.TestCheckResourceAttr(resourceName, "ncharacter_set", "AL16UTF16"),
				resource.TestCheckResourceAttr(resourceName, "ons_port_local", "6195"),
				resource.TestCheckResourceAttr(resourceName, "ons_port_remote", "6196"),
				resource.TestCheckResourceAttr(resourceName, "prefix", "mt2"),
				resource.TestCheckResourceAttr(resourceName, "private_endpoint_ids.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "private_endpoint_ids.0", privateEndpointId),
				/*
							...
							resource.TestCheckResourceAttrSet(resourceName, "shard_details.0.availability_domain"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.db_storage_vault_details.#", "1"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.db_storage_vault_details.0.high_capacity_database_storage", "10"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.source", "EXADB_XS"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.vm_cluster_details.#", "1"),
							resource.TestCheckResourceAttrSet(resourceName, "shard_details.0.vm_cluster_details.0.backup_subnet_id"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.vm_cluster_details.0.enabled_ecpu_count", "10"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.vm_cluster_details.0.ssh_public_keys.#", "1"),
							resource.TestCheckResourceAttrSet(resourceName, "shard_details.0.vm_cluster_details.0.subnet_id"),
					...
					// verify Create with optionals
					{
						...
						Check: acctest.ComposeAggregateTestCheckFuncWrapper(
							...
							resource.TestCheckResourceAttrSet(resourceName, "catalog_details.0.availability_domain"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.db_storage_vault_details.#", "1"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.db_storage_vault_details.0.additional_flash_cache_in_percent", "10"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.db_storage_vault_details.0.high_capacity_database_storage", "10"),
							...
							resource.TestCheckResourceAttrSet(resourceName, "catalog_details.0.peer_details.0.availability_domain"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.peer_details.0.db_storage_vault_details.#", "1"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.peer_details.0.db_storage_vault_details.0.additional_flash_cache_in_percent", "10"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.peer_details.0.db_storage_vault_details.0.high_capacity_database_storage", "10"),
							...
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.peer_details.0.vm_cluster_details.#", "1"),
							resource.TestCheckResourceAttrSet(resourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.backup_subnet_id"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.domain", "domain"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.enabled_ecpu_count", "10"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.is_diagnostics_events_enabled", "false"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.is_health_monitoring_enabled", "false"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.is_incident_logs_enabled", "false"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.license_model", "LICENSE_INCLUDED"),
							resource.TestCheckResourceAttrSet(resourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.private_zone_id"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.ssh_public_keys.#", "1"),
							resource.TestCheckResourceAttrSet(resourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.subnet_id"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.total_ecpu_count", "10"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.vm_file_system_storage_size", "10"),
							...
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.vm_cluster_details.#", "1"),
							resource.TestCheckResourceAttrSet(resourceName, "catalog_details.0.vm_cluster_details.0.backup_subnet_id"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.vm_cluster_details.0.domain", "domain"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.vm_cluster_details.0.enabled_ecpu_count", "10"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.vm_cluster_details.0.is_diagnostics_events_enabled", "false"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.vm_cluster_details.0.is_health_monitoring_enabled", "false"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.vm_cluster_details.0.is_incident_logs_enabled", "false"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.vm_cluster_details.0.license_model", "LICENSE_INCLUDED"),
							resource.TestCheckResourceAttrSet(resourceName, "catalog_details.0.vm_cluster_details.0.private_zone_id"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.vm_cluster_details.0.ssh_public_keys.#", "1"),
							resource.TestCheckResourceAttrSet(resourceName, "catalog_details.0.vm_cluster_details.0.subnet_id"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.vm_cluster_details.0.total_ecpu_count", "10"),
							resource.TestCheckResourceAttr(resourceName, "catalog_details.0.vm_cluster_details.0.vm_file_system_storage_size", "10"),
							resource.TestCheckResourceAttrSet(resourceName, "catalog_details.0.vm_cluster_id"),
							resource.TestCheckResourceAttr(resourceName, "character_set", "AL32UTF8"),
							...
							resource.TestCheckResourceAttr(resourceName, "prefix", "yy9"),
							resource.TestCheckResourceAttr(resourceName, "private_endpoint_ids.#", "1"),
							...
							resource.TestCheckResourceAttr(resourceName, "scan_listener_port", "10"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.#", "1"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.admin_password", "BEstrO0ng_#11"),
							resource.TestCheckResourceAttrSet(resourceName, "shard_details.0.availability_domain"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.db_storage_vault_details.#", "1"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.db_storage_vault_details.0.additional_flash_cache_in_percent", "10"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.db_storage_vault_details.0.high_capacity_database_storage", "10"),
							...
							resource.TestCheckResourceAttrSet(resourceName, "shard_details.0.peer_details.0.availability_domain"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.peer_details.0.db_storage_vault_details.#", "1"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.peer_details.0.db_storage_vault_details.0.additional_flash_cache_in_percent", "10"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.peer_details.0.db_storage_vault_details.0.high_capacity_database_storage", "10"),
							...
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.peer_details.0.vm_cluster_details.#", "1"),
							resource.TestCheckResourceAttrSet(resourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.backup_subnet_id"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.domain", "domain"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.enabled_ecpu_count", "10"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.is_diagnostics_events_enabled", "false"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.is_health_monitoring_enabled", "false"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.is_incident_logs_enabled", "false"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.license_model", "LICENSE_INCLUDED"),
							resource.TestCheckResourceAttrSet(resourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.private_zone_id"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.ssh_public_keys.#", "1"),
							resource.TestCheckResourceAttrSet(resourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.subnet_id"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.total_ecpu_count", "10"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.vm_file_system_storage_size", "10"),
							...
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.vm_cluster_details.#", "1"),
							resource.TestCheckResourceAttrSet(resourceName, "shard_details.0.vm_cluster_details.0.backup_subnet_id"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.vm_cluster_details.0.domain", "domain"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.vm_cluster_details.0.enabled_ecpu_count", "10"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.vm_cluster_details.0.is_diagnostics_events_enabled", "false"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.vm_cluster_details.0.is_health_monitoring_enabled", "false"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.vm_cluster_details.0.is_incident_logs_enabled", "false"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.vm_cluster_details.0.license_model", "LICENSE_INCLUDED"),
							resource.TestCheckResourceAttrSet(resourceName, "shard_details.0.vm_cluster_details.0.private_zone_id"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.vm_cluster_details.0.ssh_public_keys.#", "1"),
							resource.TestCheckResourceAttrSet(resourceName, "shard_details.0.vm_cluster_details.0.subnet_id"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.vm_cluster_details.0.total_ecpu_count", "10"),
							resource.TestCheckResourceAttr(resourceName, "shard_details.0.vm_cluster_details.0.vm_file_system_storage_size", "10"),
							resource.TestCheckResourceAttrSet(resourceName, "shard_details.0.vm_cluster_id"),
							resource.TestCheckResourceAttr(resourceName, "sharding_method", "SYSTEM"),
		...
		*/
		...
		// verify datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				*/
				resource.TestCheckResourceAttr(datasourceName, "display_name", "mt2-exadbxs-test-3"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				/*
					resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.db_storage_vault_details.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.db_storage_vault_details.0.additional_flash_cache_in_percent", "10"),
					resource.TestCheckResourceAttrSet(singularDatasourceName, "catalog_details.0.db_storage_vault_details.0.db_storage_vault_id"),
					resource.TestCheckResourceAttrSet(singularDatasourceName, "catalog_details.0.db_storage_vault_details.0.display_name"),
					resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.db_storage_vault_details.0.high_capacity_database_storage", "10"),
					...
					resource.TestCheckResourceAttrSet(singularDatasourceName, "catalog_details.0.peer_details.0.availability_domain"),
					resource.TestCheckResourceAttrSet(singularDatasourceName, "catalog_details.0.peer_details.0.container_database_id"),
					resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.peer_details.0.db_storage_vault_details.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.peer_details.0.db_storage_vault_details.0.additional_flash_cache_in_percent", "10"),
					resource.TestCheckResourceAttrSet(singularDatasourceName, "catalog_details.0.peer_details.0.db_storage_vault_details.0.db_storage_vault_id"),
					resource.TestCheckResourceAttrSet(singularDatasourceName, "catalog_details.0.peer_details.0.db_storage_vault_details.0.display_name"),
					resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.peer_details.0.db_storage_vault_details.0.high_capacity_database_storage", "10"),
					...
					resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.peer_details.0.transport_type", "SYNC"),
					resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.peer_details.0.vm_cluster_details.#", "1"),
					resource.TestCheckResourceAttrSet(singularDatasourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.display_name"),
					resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.domain", "domain"),
					resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.enabled_ecpu_count", "10"),
					resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.is_diagnostics_events_enabled", "false"),
					resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.is_health_monitoring_enabled", "false"),
					resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.is_incident_logs_enabled", "false"),
					resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.license_model", "LICENSE_INCLUDED"),
					resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.ssh_public_keys.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.total_ecpu_count", "10"),
					resource.TestCheckResourceAttrSet(singularDatasourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.vm_cluster_id"),
					resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.peer_details.0.vm_cluster_details.0.vm_file_system_storage_size", "10"),
				*/
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.kms_key_id", kmsKeyId),
				resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.vault_id", vaultId),
				resource.TestCheckResourceAttr(singularDatasourceName, "catalog_details.0.vm_cluster_id", vmClusterId),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "db_backup_config.0.recovery_window_in_days", "45"),
				resource.TestCheckResourceAttr(singularDatasourceName, "db_deployment_type", "EXADB_XS"),
				resource.TestCheckResourceAttr(singularDatasourceName, "display_name", "mt2-exadbxs-test-3"),
				resource.TestCheckResourceAttr(singularDatasourceName, "freeform_tags.%", "1"),
				resource.TestCheckResourceAttr(singularDatasourceName, "freeform_tags.team", "osd-qa"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "listener_port", "6194"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "ons_port_local", "6195"),
				resource.TestCheckResourceAttr(singularDatasourceName, "ons_port_remote", "6196"),
				resource.TestCheckResourceAttr(singularDatasourceName, "prefix", "mt2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "private_endpoint_ids.#", "1"),
				resource.TestCheckResourceAttr(singularDatasourceName, "private_endpoint_ids.0", privateEndpointId),
				...
				/*
					resource.TestCheckResourceAttr(singularDatasourceName, "replication_unit", "10"),
					resource.TestCheckResourceAttr(singularDatasourceName, "scan_listener_port", "10"),
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.#", "1"),
					resource.TestCheckResourceAttrSet(singularDatasourceName, "shard_details.0.availability_domain"),
					...
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.db_storage_vault_details.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.db_storage_vault_details.0.additional_flash_cache_in_percent", "10"),
					resource.TestCheckResourceAttrSet(singularDatasourceName, "shard_details.0.db_storage_vault_details.0.db_storage_vault_id"),
					resource.TestCheckResourceAttrSet(singularDatasourceName, "shard_details.0.db_storage_vault_details.0.display_name"),
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.db_storage_vault_details.0.high_capacity_database_storage", "10"),
					...
					resource.TestCheckResourceAttrSet(singularDatasourceName, "shard_details.0.peer_details.0.availability_domain"),
					resource.TestCheckResourceAttrSet(singularDatasourceName, "shard_details.0.peer_details.0.container_database_id"),
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.peer_details.0.db_storage_vault_details.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.peer_details.0.db_storage_vault_details.0.additional_flash_cache_in_percent", "10"),
					resource.TestCheckResourceAttrSet(singularDatasourceName, "shard_details.0.peer_details.0.db_storage_vault_details.0.db_storage_vault_id"),
					resource.TestCheckResourceAttrSet(singularDatasourceName, "shard_details.0.peer_details.0.db_storage_vault_details.0.display_name"),
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.peer_details.0.db_storage_vault_details.0.high_capacity_database_storage", "10"),
					...
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.peer_details.0.transport_type", "SYNC"),
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.peer_details.0.vm_cluster_details.#", "1"),
					resource.TestCheckResourceAttrSet(singularDatasourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.display_name"),
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.domain", "domain"),
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.enabled_ecpu_count", "10"),
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.is_diagnostics_events_enabled", "false"),
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.is_health_monitoring_enabled", "false"),
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.is_incident_logs_enabled", "false"),
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.license_model", "LICENSE_INCLUDED"),
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.ssh_public_keys.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.total_ecpu_count", "10"),
					resource.TestCheckResourceAttrSet(singularDatasourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.vm_cluster_id"),
					resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.peer_details.0.vm_cluster_details.0.vm_file_system_storage_size", "10"),
				*/
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.kms_key_id", kmsKeyId),
				resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.vault_id", vaultId),
				resource.TestCheckResourceAttr(singularDatasourceName, "shard_details.0.vm_cluster_id", vmClusterId),
		...
		// verify resource import
		{
			...
			// TF_CODE_GEN: TERSI-4920-TOP-26 catalog/shard admin_password values are
			// write-only in the service. Import reads cannot recover them, so import
			// verification must ignore these nested secret fields.
			ImportStateVerifyIgnore: []string{
				"catalog_details.0.admin_password",
				"patch_operations",
				"shard_details.0.admin_password",
				"shard_details.1.admin_password",
				"shard_details.2.admin_password",
			},
