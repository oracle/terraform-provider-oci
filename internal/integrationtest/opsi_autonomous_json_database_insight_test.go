...
var (
	AutonomousJsonDatabaseInsightRequiredOnlyResource = AutonomousJsonDatabaseInsightResourceDependencies +
		acctest.GenerateResourceFromRepresentationMap("oci_opsi_database_insight", "test_database_insight", acctest.Required, acctest.Create, autonomousJsonDatabaseInsightRepresentation)

	AutonomousJsonDatabaseInsightResourceConfig = AutonomousJsonDatabaseInsightResourceDependencies +
		acctest.GenerateResourceFromRepresentationMap("oci_opsi_database_insight", "test_database_insight", acctest.Optional, acctest.Update, autonomousJsonDatabaseInsightRepresentation)

	autonomousJsonDatabaseInsightSingularDataSourceRepresentation = map[string]interface{}{
	...
	autonomousJsonDatabaseInsightDataSourceRepresentation = map[string]interface{}{
		"compartment_id":            acctest.Representation{RepType: acctest.Optional, Create: `${var.compartment_id}`},
		"compartment_id_in_subtree": acctest.Representation{RepType: acctest.Optional, Create: `false`},
		"database_type":             acctest.Representation{RepType: acctest.Optional, Create: []string{`AJD-S`}},
		...
		"filter":                    acctest.RepresentationGroup{RepType: acctest.Required, Group: autonomousJsonDatabaseInsightDataSourceFilterRepresentation},
	}

	autonomousJsonDatabaseInsightDataSourceFilterRepresentation = map[string]interface{}{
	...
	autonomousJsonDatabaseInsightRepresentation = map[string]interface{}{
		...
		"is_advanced_features_enabled": acctest.Representation{RepType: acctest.Required, Create: `true`, Update: `false`},
		"database_resource_type":       acctest.Representation{RepType: acctest.Required, Create: `autonomousdatabase`},
		"credential_details":           acctest.RepresentationGroup{RepType: acctest.Required, Group: autonomousJsonDatabaseInsightCredentialDetailsForUpdateRepresentation},
		"connection_details":           acctest.RepresentationGroup{RepType: acctest.Required, Group: autonomousJsonDatabaseInsightConnectionDetailsRepresentation},
		...
		"lifecycle": acctest.RepresentationGroup{RepType: acctest.Required, Group: ignoreChangesAutonomousJsonDatabaseInsightRepresentation},
	}

	autonomousJsonDatabaseInsightCredentialDetailsRepresentation = map[string]interface{}{
		"credential_type": acctest.Representation{RepType: acctest.Required, Create: `CREDENTIALS_BY_VAULT`},
	}

	autonomousJsonDatabaseInsightCredentialDetailsForUpdateRepresentation = map[string]interface{}{
		"credential_type":    acctest.Representation{RepType: acctest.Required, Create: `CREDENTIALS_BY_VAULT`},
	...
	autonomousJsonDatabaseInsightConnectionDetailsRepresentation = map[string]interface{}{
	...
	ignoreChangesAutonomousJsonDatabaseInsightRepresentation = map[string]interface{}{
		"ignore_changes": acctest.Representation{RepType: acctest.Required, Create: []string{`defined_tags`}},
	}

	AutonomousJsonDatabaseInsightResourceDependencies = DefinedTagsDependencies
)

// issue-routing-tag: opsi/controlPlane
func TestOpsiAutonomousJsonDatabaseInsightResource_basic(t *testing.T) {
	httpreplay.SetScenario("TestOpsiAutonomousJsonDatabaseInsightResource_basic")
	...
	autonomousJsonDatabaseId := utils.GetEnvSettingWithBlankDefault("autonomous_database_id")
	autonomousJsonDatabaseIdVariableStr := fmt.Sprintf("variable \"autonomous_database_id\" { default = \"%s\" }\n", autonomousJsonDatabaseId)
	...
	acctest.SaveConfigContent(config+compartmentIdVariableStr+autonomousJsonDatabaseIdVariableStr+adbHostNameVariableStr+adbPortVariableStr+serviceNameVariableStr+secretIdVariableStr+userNamedVariableStr+AutonomousJsonDatabaseInsightResourceDependencies+
		acctest.GenerateResourceFromRepresentationMap("oci_opsi_database_insight", "test_database_insight", acctest.Optional, acctest.Create, autonomousJsonDatabaseInsightRepresentation), "opsi", "databaseInsight", t)

	acctest.ResourceTest(t, testAccCheckOpsiAutonomousJsonDatabaseInsightDestroy, []resource.TestStep{
		// verify create with optional opsiPrivateEndpointId
		{
			Config: config + compartmentIdVariableStr + autonomousJsonDatabaseIdVariableStr + adbHostNameVariableStr + adbPortVariableStr + serviceNameVariableStr + secretIdVariableStr + userNamedVariableStr + AutonomousJsonDatabaseInsightResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_opsi_database_insight", "test_database_insight", acctest.Optional, acctest.Create, autonomousJsonDatabaseInsightRepresentation),
		...
		// verify update to the credential by vault
		{
			Config: config + compartmentIdVariableStr + autonomousJsonDatabaseIdVariableStr + adbHostNameVariableStr + adbPortVariableStr + serviceNameVariableStr + secretIdVariableStr + userNamedVariableStr + AutonomousJsonDatabaseInsightResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_opsi_database_insight", "test_database_insight", acctest.Optional, acctest.Update,
					acctest.RepresentationCopyWithNewProperties(autonomousJsonDatabaseInsightRepresentation, map[string]interface{}{
						"credential_details": acctest.RepresentationGroup{RepType: acctest.Required, Group: autonomousJsonDatabaseInsightCredentialDetailsForUpdateRepresentation},
					})),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				resource.TestCheckResourceAttr(resourceName, "compartment_id", compartmentId),
		...
		{
			Config: config +
				acctest.GenerateDataSourceFromRepresentationMap("oci_opsi_database_insights", "test_database_insights", acctest.Optional, acctest.Update, autonomousJsonDatabaseInsightDataSourceRepresentation) +
				compartmentIdVariableStr + autonomousJsonDatabaseIdVariableStr + adbHostNameVariableStr + adbPortVariableStr + serviceNameVariableStr + secretIdVariableStr + userNamedVariableStr + AutonomousJsonDatabaseInsightResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_opsi_database_insight", "test_database_insight", acctest.Optional, acctest.Update, autonomousJsonDatabaseInsightRepresentation),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
		...
		{
			Config: config +
				acctest.GenerateDataSourceFromRepresentationMap("oci_opsi_database_insight", "test_database_insight", acctest.Required, acctest.Create, autonomousJsonDatabaseInsightSingularDataSourceRepresentation) +
				compartmentIdVariableStr + autonomousJsonDatabaseIdVariableStr + adbHostNameVariableStr + adbPortVariableStr + serviceNameVariableStr + secretIdVariableStr + userNamedVariableStr + AutonomousJsonDatabaseInsightResourceConfig,
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
		...
		{
			Config: config + compartmentIdVariableStr + autonomousJsonDatabaseIdVariableStr + adbHostNameVariableStr + adbPortVariableStr + serviceNameVariableStr + secretIdVariableStr + userNamedVariableStr + AutonomousJsonDatabaseInsightResourceConfig,
		},
		// verify enable
		{
			Config: config + compartmentIdVariableStr + autonomousJsonDatabaseIdVariableStr + adbHostNameVariableStr + adbPortVariableStr + serviceNameVariableStr + secretIdVariableStr + userNamedVariableStr + AutonomousJsonDatabaseInsightResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_opsi_database_insight", "test_database_insight", acctest.Optional, acctest.Update,
					acctest.RepresentationCopyWithNewProperties(autonomousJsonDatabaseInsightRepresentation, map[string]interface{}{
						...
						"is_advanced_features_enabled": acctest.Representation{RepType: acctest.Required, Update: `true`},
					})),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				resource.TestCheckResourceAttr(resourceName, "compartment_id", compartmentId),
		...
		{
			Config:            config + secretIdVariableStr + userNamedVariableStr + AutonomousJsonDatabaseInsightRequiredOnlyResource,
			ImportState:       true,
...
func testAccCheckOpsiAutonomousJsonDatabaseInsightDestroy(s *terraform.State) error {
...
func init() {
	...
	if !acctest.InSweeperExcludeList("OpsiAutonomousJsonDatabaseInsight") {
		resource.AddTestSweepers("OpsiAutonomousJsonDatabaseInsight", &resource.Sweeper{
			Name:         "OpsiAutonomousJsonDatabaseInsight",
			Dependencies: acctest.DependencyGraph["databaseInsight"],
			F:            sweepOpsiAutonomousJsonDatabaseInsightResource,
		})
	}
}

func sweepOpsiAutonomousJsonDatabaseInsightResource(compartment string) error {
	operationsInsightsClient := acctest.GetTestClients(&schema.ResourceData{}).OperationsInsightsClient()
	databaseInsightIds, err := getAutonomousJsonDatabaseInsightIds(compartment)
	if err != nil {
		return err
	}
	for _, databaseInsightId := range databaseInsightIds {
		if ok := acctest.SweeperDefaultResourceId[databaseInsightId]; !ok {
			...
			acctest.WaitTillCondition(acctest.TestAccProvider, &databaseInsightId, autonomousJsonDatabaseInsightSweepWaitCondition, time.Duration(3*time.Minute),
				autonomousJsonDatabaseInsightSweepResponseFetchOperation, "opsi", true)
		}
	}
	return nil
}

func getAutonomousJsonDatabaseInsightIds(compartment string) ([]string, error) {
...
func autonomousJsonDatabaseInsightSweepWaitCondition(response common.OCIOperationResponse) bool {
...
func autonomousJsonDatabaseInsightSweepResponseFetchOperation(client *tf_client.OracleClients, resourceId *string, retryPolicy *common.RetryPolicy) error {
