...
var (
	...
	NlbBackendHealthResourceConfig = acctest.GenerateResourceFromRepresentationMap("oci_core_subnet", "test_subnet", acctest.Required, acctest.Create, subnetRepresentation) +
...
func TestNetworkLoadBalancerBackendHealthResource_basic(t *testing.T) {
	...
	acctest.ResourceTest(t, nil, []resource.TestStep{
		...
		{
			Config: config +
				acctest.GenerateDataSourceFromRepresentationMap("oci_network_load_balancer_backend_health", "test_backend_health", acctest.Required, acctest.Create, nlbBackendHealthSingularDataSourceRepresentation) +
