	...
	acctest.ResourceTest(t, testAccCheckDatabaseExadataInfrastructureDestroy, []resource.TestStep{
		...
		// verify datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttrSet(datasourceName, "exadata_infrastructures.0.compute_model"),
				...
				resource.TestCheckResourceAttr(datasourceName, "exadata_infrastructures.0.database_server_type", "X11M"),
				...
				resource.TestCheckResourceAttr(datasourceName, "exadata_infrastructures.0.system_tags.%", "0"),
				...
				resource.TestCheckResourceAttr(datasourceName, "exadata_infrastructures.0.shape", "ExadataCC.X11M"),
				...
				resource.TestCheckResourceAttr(datasourceName, "exadata_infrastructures.0.storage_server_type", "X11M-HC"),
				resource.TestCheckResourceAttr(datasourceName, "exadata_infrastructures.0.compute_count", "2"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "database_server_type", "X11M"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "shape", "ExadataCC.X11M"),
				resource.TestCheckResourceAttrSet(singularDatasourceName, "state"),
				resource.TestCheckResourceAttr(singularDatasourceName, "storage_count", "3"),
				resource.TestCheckResourceAttr(singularDatasourceName, "storage_server_type", "X11M-HC"),
				resource.TestCheckResourceAttr(singularDatasourceName, "compute_count", "2"),
