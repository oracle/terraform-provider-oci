...
var (
	...
	integrationInstanceRepresentation = map[string]interface{}{
		...
		"attachment_type":           acctest.Representation{RepType: acctest.Optional, Create: `process_automation`},
	...
	acctest.ResourceTest(t, testAccCheckIntegrationIntegrationInstanceDestroy, []resource.TestStep{
		...
		// verify datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				// resource.TestCheckResourceAttrSet(datasourceName, "integration_instances.0.process_automation_log_group_id"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttrSet(singularDatasourceName, "process_automation_log_group_id"),
