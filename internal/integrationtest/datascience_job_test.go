...
var (
	...
	DatascienceJobJobInfrastructureConfigurationDetailsRepresentation = map[string]interface{}{
		"job_infrastructure_type":   acctest.Representation{RepType: acctest.Required, Create: `STANDALONE`, Update: `ME_STANDALONE`},
		"block_storage_size_in_gbs": acctest.Representation{RepType: acctest.Optional, Create: `10`, Update: `11`},
		"compute_target_id":         acctest.Representation{RepType: acctest.Optional, Create: `${oci_datascience_compute_target.test_compute_target.id}`},
		"job_shape_config_details":  acctest.RepresentationGroup{RepType: acctest.Optional, Group: DatascienceJobJobInfrastructureConfigurationDetailsJobShapeConfigDetailsRepresentation},
		"resource_configuration":    acctest.RepresentationGroup{RepType: acctest.Optional, Group: DatascienceJobJobInfrastructureConfigurationDetailsResourceConfigurationRepresentation},
		"shape_name":                acctest.Representation{RepType: acctest.Optional, Create: `${oci_core_shape.test_shape.name}`},
	...
	DatascienceJobJobInfrastructureConfigurationDetailsResourceConfigurationRepresentation = map[string]interface{}{
		"resource_limit_configuration":   acctest.RepresentationGroup{RepType: acctest.Optional, Group: DatascienceJobJobInfrastructureConfigurationDetailsResourceConfigurationResourceLimitConfigurationRepresentation},
		"resource_request_configuration": acctest.RepresentationGroup{RepType: acctest.Optional, Group: DatascienceJobJobInfrastructureConfigurationDetailsResourceConfigurationResourceRequestConfigurationRepresentation},
	}
	...
	DatascienceJobJobInfrastructureConfigurationDetailsResourceConfigurationResourceLimitConfigurationRepresentation = map[string]interface{}{
	...
	DatascienceJobJobInfrastructureConfigurationDetailsResourceConfigurationResourceRequestConfigurationRepresentation = map[string]interface{}{
		"gpus":          acctest.Representation{RepType: acctest.Optional, Create: `10`, Update: `11`},
		"memory_in_gbs": acctest.Representation{RepType: acctest.Optional, Create: `1.0`, Update: `1.1`},
		"ocpus":         acctest.Representation{RepType: acctest.Optional, Create: `1.0`, Update: `1.1`},
	}
	...
	DatascienceJobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsRepresentation = map[string]interface{}{
		...
		"resource_configuration":    acctest.RepresentationGroup{RepType: acctest.Optional, Group: DatascienceJobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsResourceConfigurationRepresentation},
		"shape_name":                acctest.Representation{RepType: acctest.Optional, Create: `${oci_core_shape.test_shape.name}`},
		"subnet_id":                 acctest.Representation{RepType: acctest.Optional, Create: `${oci_core_subnet.test_subnet.id}`},
	}
	...
	DatascienceJobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsResourceConfigurationRepresentation = map[string]interface{}{
		"resource_limit_configuration":   acctest.RepresentationGroup{RepType: acctest.Optional, Group: DatascienceJobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsResourceConfigurationResourceLimitConfigurationRepresentation},
		"resource_request_configuration": acctest.RepresentationGroup{RepType: acctest.Optional, Group: DatascienceJobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsResourceConfigurationResourceRequestConfigurationRepresentation},
	}
	DatascienceJobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsResourceConfigurationResourceLimitConfigurationRepresentation = map[string]interface{}{
		"memory_in_gbs": acctest.Representation{RepType: acctest.Optional, Create: `1.0`},
		"ocpus":         acctest.Representation{RepType: acctest.Optional, Create: `1.0`},
	}
	DatascienceJobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsResourceConfigurationResourceRequestConfigurationRepresentation = map[string]interface{}{
		"gpus":          acctest.Representation{RepType: acctest.Optional, Create: `10`},
		"memory_in_gbs": acctest.Representation{RepType: acctest.Optional, Create: `1.0`},
		"ocpus":         acctest.Representation{RepType: acctest.Optional, Create: `1.0`},
	}

	DatascienceJobResourceDependencies = acctest.GenerateDataSourceFromRepresentationMap("oci_apm_traces_logs", "test_logs", acctest.Required, acctest.Create, ApmTracesLogSingularDataSourceRepresentation) +
		...
		Steps: []resource.TestStep{
			// verify Create with optionals
			{
				...
				Check: acctest.ComposeAggregateTestCheckFuncWrapper(
					...
					resource.TestCheckResourceAttr(resourceName, "job_configuration_details.0.startup_probe_details.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "job_configuration_details.0.startup_probe_details.0.command.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "job_configuration_details.0.startup_probe_details.0.failure_threshold", "10"),
					resource.TestCheckResourceAttr(resourceName, "job_configuration_details.0.startup_probe_details.0.initial_delay_in_seconds", "10"),
					resource.TestCheckResourceAttr(resourceName, "job_configuration_details.0.startup_probe_details.0.job_probe_check_type", "EXEC"),
					resource.TestCheckResourceAttr(resourceName, "job_configuration_details.0.startup_probe_details.0.period_in_seconds", "10"),
					...
					resource.TestCheckResourceAttr(resourceName, "job_environment_configuration_details.0.image", "image"),
					resource.TestCheckResourceAttr(resourceName, "job_environment_configuration_details.0.image_digest", "imageDigest"),
					resource.TestCheckResourceAttrSet(resourceName, "job_environment_configuration_details.0.image_signature_id"),
					...
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.block_storage_size_in_gbs", "10"),
					resource.TestCheckResourceAttrSet(resourceName, "job_infrastructure_configuration_details.0.compute_target_id"),
					...
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.job_shape_config_details.0.memory_in_gbs", "1.0"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.job_shape_config_details.0.ocpus", "1.0"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.resource_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_limit_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_limit_configuration.0.memory_in_gbs", "1.0"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_limit_configuration.0.ocpus", "1.0"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.0.gpus", "10"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.0.memory_in_gbs", "1.0"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.0.ocpus", "1.0"),
					...
					resource.TestCheckResourceAttr(resourceName, "job_log_configuration_details.0.enable_auto_log_creation", "false"),
					resource.TestCheckResourceAttr(resourceName, "job_log_configuration_details.0.enable_logging", "false"),
					resource.TestCheckResourceAttrSet(resourceName, "job_log_configuration_details.0.log_group_id"),
					resource.TestCheckResourceAttrSet(resourceName, "job_log_configuration_details.0.log_id"),
					...
					resource.TestCheckResourceAttrSet(resourceName, "job_node_configuration_details.0.job_network_configuration.0.subnet_id"),
					...
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_configuration_details.0.maximum_runtime_in_minutes", "10"),
					...
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_environment_configuration_details.0.job_environment_type", "OCIR_CONTAINER"),
					...
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.block_storage_size_in_gbs", "10"),
					resource.TestCheckResourceAttrSet(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.compute_target_id"),
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.job_infrastructure_type", "STANDALONE"),
					...
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.job_shape_config_details.0.cpu_baseline", "BASELINE_1_8"),
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.job_shape_config_details.0.memory_in_gbs", "1.0"),
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.job_shape_config_details.0.ocpus", "1.0"),
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.resource_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.resource_configuration.0.resource_limit_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.resource_configuration.0.resource_limit_configuration.0.memory_in_gbs", "1.0"),
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.resource_configuration.0.resource_limit_configuration.0.ocpus", "1.0"),
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.0.gpus", "10"),
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.0.memory_in_gbs", "1.0"),
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.0.ocpus", "1.0"),
					...
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.minimum_success_replicas", "10"),
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.name", "name"),
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.replicas", "10"),
					...
					resource.TestCheckResourceAttr(resourceName, "job_storage_mount_configuration_details_list.0.bucket", "bucket"),
					...
					resource.TestCheckResourceAttr(resourceName, "job_storage_mount_configuration_details_list.0.namespace", "namespace"),
			...
			// verify updates to updatable parameters
			{
				...
				Check: acctest.ComposeAggregateTestCheckFuncWrapper(
					...
					resource.TestCheckResourceAttr(resourceName, "job_environment_configuration_details.0.job_environment_type", "OCIR_CONTAINER"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.block_storage_size_in_gbs", "11"),
					resource.TestCheckResourceAttrSet(resourceName, "job_infrastructure_configuration_details.0.compute_target_id"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.job_infrastructure_type", "ME_STANDALONE"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.job_shape_config_details.#", "1"),
					...
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.job_shape_config_details.0.memory_in_gbs", "1.1"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.job_shape_config_details.0.ocpus", "1.1"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.resource_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_limit_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_limit_configuration.0.memory_in_gbs", "1.1"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_limit_configuration.0.ocpus", "1.1"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.0.gpus", "11"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.0.memory_in_gbs", "1.1"),
					resource.TestCheckResourceAttr(resourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.0.ocpus", "1.1"),
					resource.TestCheckResourceAttrSet(resourceName, "job_infrastructure_configuration_details.0.shape_name"),
					resource.TestCheckResourceAttrSet(resourceName, "job_infrastructure_configuration_details.0.subnet_id"),
					resource.TestCheckResourceAttr(resourceName, "job_log_configuration_details.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "job_log_configuration_details.0.enable_auto_log_creation", "false"),
					...
					resource.TestCheckResourceAttr(resourceName, "job_node_configuration_details.0.startup_order", "IN_ORDER"),
					resource.TestCheckResourceAttr(resourceName, "job_storage_mount_configuration_details_list.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "job_storage_mount_configuration_details_list.0.bucket", "bucket2"),
					...
					resource.TestCheckResourceAttrSet(resourceName, "job_storage_mount_configuration_details_list.0.export_id"),
					resource.TestCheckResourceAttrSet(resourceName, "job_storage_mount_configuration_details_list.0.mount_target_id"),
					resource.TestCheckResourceAttr(resourceName, "job_storage_mount_configuration_details_list.0.namespace", "namespace2"),
					resource.TestCheckResourceAttr(resourceName, "job_storage_mount_configuration_details_list.0.prefix", "prefix2"),
			...
			// verify singular datasource
			{
				...
				Check: acctest.ComposeAggregateTestCheckFuncWrapper(
					...
					resource.TestCheckResourceAttr(singularDatasourceName, "job_configuration_details.0.startup_probe_details.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_configuration_details.0.startup_probe_details.0.command.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_configuration_details.0.startup_probe_details.0.failure_threshold", "10"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_configuration_details.0.startup_probe_details.0.initial_delay_in_seconds", "10"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_configuration_details.0.startup_probe_details.0.job_probe_check_type", "EXEC"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_configuration_details.0.startup_probe_details.0.period_in_seconds", "10"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_environment_configuration_details.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_environment_configuration_details.0.cmd.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_environment_configuration_details.0.entrypoint.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_environment_configuration_details.0.image", "image"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_environment_configuration_details.0.image_digest", "imageDigest"),
					...
					resource.TestCheckResourceAttr(singularDatasourceName, "job_infrastructure_configuration_details.0.block_storage_size_in_gbs", "11"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_infrastructure_configuration_details.0.job_infrastructure_type", "ME_STANDALONE"),
					...
					resource.TestCheckResourceAttr(singularDatasourceName, "job_infrastructure_configuration_details.0.job_shape_config_details.0.memory_in_gbs", "1.1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_infrastructure_configuration_details.0.job_shape_config_details.0.ocpus", "1.1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_infrastructure_configuration_details.0.resource_configuration.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_limit_configuration.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_limit_configuration.0.memory_in_gbs", "1.1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_limit_configuration.0.ocpus", "1.1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.0.gpus", "11"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.0.memory_in_gbs", "1.1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.0.ocpus", "1.1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_log_configuration_details.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_log_configuration_details.0.enable_auto_log_creation", "false"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_log_configuration_details.0.enable_logging", "false"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_network_configuration.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_network_configuration.0.job_network_type", "CUSTOM_NETWORK"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_configuration_details.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_configuration_details.0.command_line_arguments", "commandLineArguments"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_configuration_details.0.environment_variables.%", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_configuration_details.0.job_type", "DEFAULT"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_configuration_details.0.maximum_runtime_in_minutes", "10"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_configuration_details.0.startup_probe_details.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_configuration_details.0.startup_probe_details.0.command.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_configuration_details.0.startup_probe_details.0.failure_threshold", "10"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_configuration_details.0.startup_probe_details.0.initial_delay_in_seconds", "10"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_configuration_details.0.startup_probe_details.0.job_probe_check_type", "EXEC"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_configuration_details.0.startup_probe_details.0.period_in_seconds", "10"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_environment_configuration_details.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_environment_configuration_details.0.cmd.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_environment_configuration_details.0.entrypoint.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_environment_configuration_details.0.image", "image"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_environment_configuration_details.0.image_digest", "imageDigest"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_environment_configuration_details.0.job_environment_type", "OCIR_CONTAINER"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.block_storage_size_in_gbs", "10"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.job_infrastructure_type", "STANDALONE"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.job_shape_config_details.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.job_shape_config_details.0.cpu_baseline", "BASELINE_1_8"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.job_shape_config_details.0.memory_in_gbs", "1.0"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.job_shape_config_details.0.ocpus", "1.0"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.resource_configuration.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.resource_configuration.0.resource_limit_configuration.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.resource_configuration.0.resource_limit_configuration.0.memory_in_gbs", "1.0"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.resource_configuration.0.resource_limit_configuration.0.ocpus", "1.0"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.0.gpus", "10"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.0.memory_in_gbs", "1.0"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.job_infrastructure_configuration_details.0.resource_configuration.0.resource_request_configuration.0.ocpus", "1.0"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.minimum_success_replicas", "10"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.name", "name"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_group_configuration_details_list.0.replicas", "10"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.job_node_type", "MULTI_NODE"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.maximum_runtime_in_minutes", "10"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_node_configuration_details.0.startup_order", "IN_ORDER"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_storage_mount_configuration_details_list.#", "1"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_storage_mount_configuration_details_list.0.bucket", "bucket2"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_storage_mount_configuration_details_list.0.destination_directory_name", "destinationDirectoryName2"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_storage_mount_configuration_details_list.0.destination_path", "destinationPath2"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_storage_mount_configuration_details_list.0.namespace", "namespace2"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_storage_mount_configuration_details_list.0.prefix", "prefix2"),
					resource.TestCheckResourceAttr(singularDatasourceName, "job_storage_mount_configuration_details_list.0.storage_type", "OBJECT_STORAGE"),
