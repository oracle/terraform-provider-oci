...
var (
	CloudBridgeSupportedCloudRegionDataSourceRepresentation = map[string]interface{}{
		...
		"name_contains":     acctest.Representation{RepType: acctest.Optional, Create: `eu-central-1`},
	}
	...
	acctest.ResourceTest(t, nil, []resource.TestStep{
		// verify datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(datasourceName, "supported_cloud_region_collection.0.items.0.name", "eu-central-1"),
			),
		},
	})
}
