...
var (
	...
	OpensearchOpensearchClusterCertificatesRepresentation = map[string]interface{}{
		"certificate_config":                 acctest.RepresentationGroup{RepType: acctest.Optional, Group: OpensearchOpensearchClusterCertificateConfigRepresentation},
		"coordinator_node_host_shape":        acctest.Representation{RepType: acctest.Optional, Create: `VM.Standard.E3.Flex`},
		...
		"ml_node_host_shape":                 acctest.Representation{RepType: acctest.Optional, Create: `VM.Standard.E3.Flex`},
		"ml_node_count":                      acctest.Representation{RepType: acctest.Required, Create: `1`},
		"ml_node_host_memory_gb":             acctest.Representation{RepType: acctest.Required, Create: `20`},
		"ml_node_host_ocpu_count":            acctest.Representation{RepType: acctest.Required, Create: `2`},
		"ml_node_host_type":                  acctest.Representation{RepType: acctest.Required, Create: `FLEX`},
		"ml_node_storage_gb":                 acctest.Representation{RepType: acctest.Required, Create: `50`},
		"coordinator_node_count":             acctest.Representation{RepType: acctest.Optional, Create: `1`},
		"coordinator_node_host_memory_gb":    acctest.Representation{RepType: acctest.Optional, Create: `20`},
		"coordinator_node_host_ocpu_count":   acctest.Representation{RepType: acctest.Optional, Create: `2`},
		"coordinator_node_host_type":         acctest.Representation{RepType: acctest.Optional, Create: `FLEX`},
		...
		"software_version":                   acctest.Representation{RepType: acctest.Required, Create: `2.11.0`, Update: `2.11.0`},
		...
		"security_mode":                      acctest.Representation{RepType: acctest.Optional, Create: `ENFORCING`},
		"security_master_user_name":          acctest.Representation{RepType: acctest.Optional, Create: `${oci_identity_user.test_user.name}`},
		"security_master_user_password_hash": acctest.Representation{RepType: acctest.Optional, Create: `securityMasterUserPasswordHash2`},
	...
	OpensearchOpensearchClusterRepresentationSAUpdate = map[string]interface{}{
		"security_attributes":                acctest.Representation{RepType: acctest.Required, Create: map[string]string{"jai-test.test.mode": "enforce", "jai-test.test.value": "oldVal1"}},
		"search_node_count":                  acctest.Representation{RepType: acctest.Required, Create: `1`},
		"search_node_host_memory_gb":         acctest.Representation{RepType: acctest.Required, Create: `20`},
		"search_node_host_ocpu_count":        acctest.Representation{RepType: acctest.Required, Create: `2`},
		"search_node_host_type":              acctest.Representation{RepType: acctest.Required, Create: `FLEX`},
		...
		"coordinator_node_host_ocpu_count":   acctest.Representation{RepType: acctest.Optional, Create: `2`},
		"coordinator_node_host_type":         acctest.Representation{RepType: acctest.Optional, Create: `FLEX`},
		"maintenance_details":                acctest.RepresentationGroup{RepType: acctest.Required, Group: OpensearchOpensearchClusterMaintenanceDetailsRepresentation},
		"compartment_id":                     acctest.Representation{RepType: acctest.Required, Create: `${var.compartment_id}`},
		"data_node_count":                    acctest.Representation{RepType: acctest.Required, Create: `1`},
		"data_node_host_memory_gb":           acctest.Representation{RepType: acctest.Required, Create: `20`},
		"data_node_host_ocpu_count":          acctest.Representation{RepType: acctest.Required, Create: `2`},
		...
		"vcn_id":                             acctest.Representation{RepType: acctest.Required, Create: `${oci_core_vcn.test_vcn.id}`},
		"security_mode":                      acctest.Representation{RepType: acctest.Optional, Create: `DISABLED`, Update: `ENFORCING`},
		"security_master_user_name":          acctest.Representation{RepType: acctest.Optional, Update: `testuser`},
		"security_master_user_password_hash": acctest.Representation{RepType: acctest.Optional, Update: `securityMasterUserPasswordHash2`},
		"lifecycle":                          acctest.RepresentationGroup{RepType: acctest.Required, Group: ignoreOpenSearchSystemTagsChangesRep},
	}

	OpensearchOpensearchClusterRepresentation2 = map[string]interface{}{
		"maintenance_details":                acctest.RepresentationGroup{RepType: acctest.Optional, Group: OpensearchOpensearchClusterMaintenanceDetailsRepresentation},
		"inbound_cluster_ids":                acctest.Representation{RepType: acctest.Optional, Update: []string{`${oci_opensearch_opensearch_cluster.test_opensearch_cluster_inbound.id}`}},
		"configure_outbound_cluster_trigger": acctest.Representation{RepType: acctest.Optional, Create: `0`, Update: `1`},
		"compartment_id":                     acctest.Representation{RepType: acctest.Required, Create: `${var.compartment_id}`},
		"data_node_count":                    acctest.Representation{RepType: acctest.Required, Create: `1`},
		"data_node_host_memory_gb":           acctest.Representation{RepType: acctest.Required, Create: `20`},
		"data_node_host_ocpu_count":          acctest.Representation{RepType: acctest.Required, Create: `2`},
		"data_node_host_type":                acctest.Representation{RepType: acctest.Required, Create: `FLEX`},
		"data_node_storage_gb":               acctest.Representation{RepType: acctest.Required, Create: `50`},
		"display_name":                       acctest.Representation{RepType: acctest.Required, Create: `tf_provider_cluster_updated`},
		"master_node_count":                  acctest.Representation{RepType: acctest.Required, Create: `1`},
		"master_node_host_memory_gb":         acctest.Representation{RepType: acctest.Required, Create: `20`},
		"master_node_host_ocpu_count":        acctest.Representation{RepType: acctest.Required, Create: `1`},
		"master_node_host_type":              acctest.Representation{RepType: acctest.Required, Create: `FLEX`},
	...
	OpensearchOpensearchClusterRepresentation4 = map[string]interface{}{
		"maintenance_details":                acctest.RepresentationGroup{RepType: acctest.Optional, Group: OpensearchOpensearchClusterMaintenanceDetailsRepresentation},
		"configure_outbound_cluster_trigger": acctest.Representation{RepType: acctest.Optional, Create: `0`, Update: `1`},
		"compartment_id":                     acctest.Representation{RepType: acctest.Required, Create: `${var.compartment_id}`},
		"data_node_count":                    acctest.Representation{RepType: acctest.Required, Create: `1`},
	...
	OpensearchOpensearchClusterRepresentation3 = map[string]interface{}{
		"maintenance_details":                acctest.RepresentationGroup{RepType: acctest.Optional, Group: OpensearchOpensearchClusterMaintenanceDetailsRepresentation},
		"outbound_cluster_config":            acctest.RepresentationGroup{RepType: acctest.Optional, Group: OpensearchOpensearchClusterOutboundClusterConfigRepresentation},
		"compartment_id":                     acctest.Representation{RepType: acctest.Required, Create: `${var.compartment_id}`},
		"data_node_count":                    acctest.Representation{RepType: acctest.Required, Create: `1`},
		"data_node_host_memory_gb":           acctest.Representation{RepType: acctest.Required, Create: `20`},
		"data_node_host_ocpu_count":          acctest.Representation{RepType: acctest.Required, Create: `2`},
	...
	OpensearchOpensearchClusterCertificateConfigRepresentation = map[string]interface{}{
		"cluster_certificate_mode":             acctest.Representation{RepType: acctest.Optional, Update: `OCI_CERTIFICATES_SERVICE`},
		"dashboard_certificate_mode":           acctest.Representation{RepType: acctest.Optional, Update: `OCI_CERTIFICATES_SERVICE`},
		"open_search_api_certificate_id":       acctest.Representation{RepType: acctest.Optional, Update: `${data.oci_certificates_management_certificates.existing.certificate_collection[0].items[0].id}`},
		"open_search_dashboard_certificate_id": acctest.Representation{RepType: acctest.Optional, Update: `${data.oci_certificates_management_certificates.existing.certificate_collection[0].items[0].id}`},
	}
	OpensearchOpensearchClusterMaintenanceDetailsRepresentation = map[string]interface{}{
		"notification_email_ids": acctest.Representation{RepType: acctest.Optional, Create: []string{`test@example.com`}, Update: []string{`test@example.com`}},
	}
	OpensearchOpensearchClusterOutboundClusterConfigRepresentation = map[string]interface{}{
		"is_enabled":        acctest.Representation{RepType: acctest.Required, Update: `true`},
		"outbound_clusters": acctest.RepresentationGroup{RepType: acctest.Required, Group: OpensearchOpensearchClusterOutboundClusterConfigOutboundRepresentation},
	}
	...
	OpensearchOpensearchClusterHorizontalResizeRepresentation = map[string]interface{}{
		...
		"search_node_host_type":              acctest.Representation{RepType: acctest.Required, Create: `FLEX`},
		"search_node_storage_gb":             acctest.Representation{RepType: acctest.Required, Create: `50`},
		"ml_node_count":                      acctest.Representation{RepType: acctest.Required, Create: `1`, Update: `2`},
		"ml_node_host_memory_gb":             acctest.Representation{RepType: acctest.Required, Create: `20`},
		"ml_node_host_ocpu_count":            acctest.Representation{RepType: acctest.Required, Create: `2`},
		"ml_node_host_type":                  acctest.Representation{RepType: acctest.Required, Create: `FLEX`},
		"ml_node_storage_gb":                 acctest.Representation{RepType: acctest.Required, Create: `50`},
	...
	OpensearchOpensearchClusterTagsAfterHorizontalResizeRepresentation = map[string]interface{}{
		"coordinator_node_host_shape":   acctest.Representation{RepType: acctest.Optional, Create: `VM.Standard.E3.Flex`},
		"opendashboard_node_host_shape": acctest.Representation{RepType: acctest.Optional, Create: `VM.Standard.E3.Flex`},
		"master_node_host_shape":        acctest.Representation{RepType: acctest.Optional, Create: `VM.Standard.E3.Flex`},
		"data_node_host_shape":          acctest.Representation{RepType: acctest.Optional, Create: `VM.Standard.E3.Flex`},
		...
		"maintenance_details":           acctest.RepresentationGroup{RepType: acctest.Optional, Group: OpensearchOpensearchClusterMaintenanceDetailsRepresentation},
		"compartment_id":                acctest.Representation{RepType: acctest.Required, Create: `${var.compartment_id}`},
		// Keep counts equal to current state (2) so no new resize is triggered
		"search_node_count":                  acctest.Representation{RepType: acctest.Required, Create: `1`, Update: `2`},
		"search_node_host_memory_gb":         acctest.Representation{RepType: acctest.Required, Create: `20`},
		"search_node_host_ocpu_count":        acctest.Representation{RepType: acctest.Required, Create: `2`},
		"search_node_host_type":              acctest.Representation{RepType: acctest.Required, Create: `FLEX`},
		...
		"vcn_compartment_id":                 acctest.Representation{RepType: acctest.Required, Create: `${var.compartment_id}`},
		"vcn_id":                             acctest.Representation{RepType: acctest.Required, Create: `${oci_core_vcn.test_vcn.id}`},
		// Apply only freeform_tags here (after resize has completed)
	...
	OpensearchOpensearchClusterVerticalResizeRepresentation = map[string]interface{}{
		"coordinator_node_host_shape":        acctest.Representation{RepType: acctest.Optional, Create: `VM.Standard.E3.Flex`, Update: `VM.Standard.E4.Flex`},
		...
		"ml_node_host_shape":                 acctest.Representation{RepType: acctest.Optional, Create: `VM.Standard.E3.Flex`, Update: `VM.Standard.E4.Flex`},
		"maintenance_details":                acctest.RepresentationGroup{RepType: acctest.Optional, Group: OpensearchOpensearchClusterMaintenanceDetailsRepresentation},
		"compartment_id":                     acctest.Representation{RepType: acctest.Required, Create: `${var.compartment_id}`},
		"search_node_count":                  acctest.Representation{RepType: acctest.Required, Create: `1`, Update: `2`},
		"search_node_host_memory_gb":         acctest.Representation{RepType: acctest.Required, Create: `20`},
		...
		"ml_node_storage_gb":                 acctest.Representation{RepType: acctest.Required, Create: `50`},
		"coordinator_node_count":             acctest.Representation{RepType: acctest.Optional, Create: `1`},
		"coordinator_node_host_memory_gb":    acctest.Representation{RepType: acctest.Optional, Create: `20`, Update: `40`},
		"coordinator_node_host_ocpu_count":   acctest.Representation{RepType: acctest.Optional, Create: `2`, Update: `4`},
		"coordinator_node_host_type":         acctest.Representation{RepType: acctest.Optional, Create: `FLEX`},
		"data_node_count":                    acctest.Representation{RepType: acctest.Required, Create: `1`, Update: `2`},
	...
	OpensearchOpensearchClusterDataSourceRepresentation2 = map[string]interface{}{
		"opendashboard_node_host_shape":      acctest.Representation{RepType: acctest.Optional, Create: `VM.Standard.E3.Flex`},
		"master_node_host_shape":             acctest.Representation{RepType: acctest.Optional, Create: `VM.Standard.E3.Flex`},
		"data_node_host_shape":               acctest.Representation{RepType: acctest.Optional, Create: `VM.Standard.E3.Flex`},
		"maintenance_details":                acctest.RepresentationGroup{RepType: acctest.Optional, Group: OpensearchOpensearchClusterMaintenanceDetailsRepresentation},
	...
	OpensearchOpensearchClusterOutboundClusterConfigOutboundRepresentation = map[string]interface{}{
		"display_name":        acctest.Representation{RepType: acctest.Required, Update: `remote-cluster1`},
		"seed_cluster_id":     acctest.Representation{RepType: acctest.Required, Update: `${oci_opensearch_opensearch_cluster.test_opensearch_cluster_outbound.id}`},
		"is_skip_unavailable": acctest.Representation{RepType: acctest.Optional, Update: `true`},
	...
	OpensearchOpensearchClusterLoadBalancerConfigRepresentationUpdateLBaaS = map[string]interface{}{
		...
		"load_balancer_max_bandwidth_in_mbps": acctest.Representation{RepType: acctest.Optional, Update: `600`},
	}

	OpensearchOpensearchClusterLoadBalancerConfigRepresentationUpdateNLB = map[string]interface{}{
		"load_balancer_service_type": acctest.Representation{RepType: acctest.Required, Update: `NETWORK_LOAD_BALANCER`},
	}

	OpensearchOpensearchClusterRepresentationCreateLBaaS = map[string]interface{}{
		"maintenance_details":                acctest.RepresentationGroup{RepType: acctest.Optional, Group: OpensearchOpensearchClusterMaintenanceDetailsRepresentation},
		"compartment_id":                     acctest.Representation{RepType: acctest.Required, Create: `${var.compartment_id}`},
		"data_node_count":                    acctest.Representation{RepType: acctest.Required, Create: `1`},
		"data_node_host_memory_gb":           acctest.Representation{RepType: acctest.Required, Create: `20`},
		...
		"data_node_host_type":                acctest.Representation{RepType: acctest.Required, Create: `FLEX`},
		"data_node_storage_gb":               acctest.Representation{RepType: acctest.Required, Create: `50`},
		"display_name":                       acctest.Representation{RepType: acctest.Required, Create: `tf_provider_cluster_lbaas`},
		"master_node_count":                  acctest.Representation{RepType: acctest.Required, Create: `1`},
		"master_node_host_memory_gb":         acctest.Representation{RepType: acctest.Required, Create: `20`},
		"master_node_host_ocpu_count":        acctest.Representation{RepType: acctest.Required, Create: `1`},
		"master_node_host_type":              acctest.Representation{RepType: acctest.Required, Create: `FLEX`},
	...
	OpensearchOpensearchClusterRepresentationUpdateNLB = map[string]interface{}{
		"load_balancer_config":               acctest.RepresentationGroup{RepType: acctest.Optional, Group: OpensearchOpensearchClusterLoadBalancerConfigRepresentationUpdateNLB},
		"maintenance_details":                acctest.RepresentationGroup{RepType: acctest.Optional, Group: OpensearchOpensearchClusterMaintenanceDetailsRepresentation},
		"compartment_id":                     acctest.Representation{RepType: acctest.Required, Create: `${var.compartment_id}`},
		"data_node_count":                    acctest.Representation{RepType: acctest.Required, Create: `1`},
		"data_node_host_memory_gb":           acctest.Representation{RepType: acctest.Required, Create: `20`},
		...
		"data_node_host_type":                acctest.Representation{RepType: acctest.Required, Create: `FLEX`},
		"data_node_storage_gb":               acctest.Representation{RepType: acctest.Required, Create: `50`},
		"display_name":                       acctest.Representation{RepType: acctest.Required, Create: `tf_provider_cluster_nlb`},
		"master_node_count":                  acctest.Representation{RepType: acctest.Required, Create: `1`},
		"master_node_host_memory_gb":         acctest.Representation{RepType: acctest.Required, Create: `20`},
		"master_node_host_ocpu_count":        acctest.Representation{RepType: acctest.Required, Create: `1`},
		"master_node_host_type":              acctest.Representation{RepType: acctest.Required, Create: `FLEX`},
	...
	OpensearchOpensearchClusterRepresentationUpdateLBaaS = map[string]interface{}{
		"load_balancer_config":               acctest.RepresentationGroup{RepType: acctest.Optional, Group: OpensearchOpensearchClusterLoadBalancerConfigRepresentationUpdateLBaaS},
		"maintenance_details":                acctest.RepresentationGroup{RepType: acctest.Optional, Group: OpensearchOpensearchClusterMaintenanceDetailsRepresentation},
		"compartment_id":                     acctest.Representation{RepType: acctest.Required, Create: `${var.compartment_id}`},
		"data_node_count":                    acctest.Representation{RepType: acctest.Required, Create: `1`},
		"data_node_host_memory_gb":           acctest.Representation{RepType: acctest.Required, Create: `20`},
	...
	OpensearchOpensearchClusterResourceDependenciesForByoc = acctest.GenerateResourceFromRepresentationMap("oci_core_subnet", "test_subnet", acctest.Required, acctest.Create, CoreSubnetRepresentation) +
		...
		acctest.GenerateDataSourceFromRepresentationMap(
			...
			map[string]interface{}{
				"compartment_id": acctest.Representation{RepType: acctest.Required, Create: `${var.compartment_id}`},
				"name":           acctest.Representation{RepType: acctest.Required, Create: `Tersi-Certificate-DND-1`},
			},
		)
...
func TestOpensearchOpensearchClusterResource_CCS(t *testing.T) {
	...
	resourceName := "oci_opensearch_opensearch_cluster.test_opensearch_cluster_outbound"
	resourceNameForSource := "oci_opensearch_opensearch_cluster.test_opensearch_cluster_inbound"

	var resId, resId2 string
	// Save TF content to Create resource with optional properties. This has to be exactly the same as the config part in the "create with optionals" step in the test.
	acctest.SaveConfigContent(config+compartmentIdVariableStr+OpensearchOpensearchClusterResourceDependenciesForCCS+
		acctest.GenerateResourceFromRepresentationMap("oci_opensearch_opensearch_cluster", "test_opensearch_cluster_outbound", acctest.Optional, acctest.Create, OpensearchOpensearchClusterRepresentation)+
		acctest.GenerateResourceFromRepresentationMap("oci_opensearch_opensearch_cluster", "test_opensearch_cluster_inbound", acctest.Optional, acctest.Create, OpensearchOpensearchClusterRepresentation), "opensearch", "opensearchCluster", t)

	acctest.ResourceTest(t, testAccCheckOpensearchOpensearchClusterDestroy, []resource.TestStep{
		{
			Config: config + compartmentIdVariableStr + OpensearchOpensearchClusterResourceDependenciesForCCS,
		...
		//verify configure Remote
		{
			Config: config + compartmentIdVariableStr + OpensearchOpensearchClusterResourceDependencies2 +
				acctest.GenerateResourceFromRepresentationMap("oci_opensearch_opensearch_cluster", "test_opensearch_cluster_outbound", acctest.Optional, acctest.Update, OpensearchOpensearchClusterRepresentation2),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
		...
		//verify CCS update
		{
			...
			Config: config + compartmentIdVariableStr + OpensearchOpensearchClusterResourceDependencies3,
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(

				resource.TestCheckResourceAttr(resourceNameForSource, "compartment_id", compartmentId),
				resource.TestCheckResourceAttr(resourceNameForSource, "data_node_count", "1"),
				resource.TestCheckResourceAttr(resourceNameForSource, "data_node_host_memory_gb", "20"),
				resource.TestCheckResourceAttr(resourceNameForSource, "data_node_host_ocpu_count", "2"),
				resource.TestCheckResourceAttr(resourceNameForSource, "data_node_host_type", "FLEX"),
				resource.TestCheckResourceAttr(resourceNameForSource, "data_node_storage_gb", "50"),
				resource.TestCheckResourceAttr(resourceNameForSource, "display_name", "tf_provider_cluster_updated"),
				resource.TestCheckResourceAttrSet(resourceNameForSource, "id"),
				resource.TestCheckResourceAttr(resourceNameForSource, "master_node_count", "1"),
				resource.TestCheckResourceAttr(resourceNameForSource, "master_node_host_memory_gb", "20"),
				resource.TestCheckResourceAttr(resourceNameForSource, "master_node_host_ocpu_count", "1"),
				resource.TestCheckResourceAttr(resourceNameForSource, "master_node_host_type", "FLEX"),
				resource.TestCheckResourceAttrSet(resourceNameForSource, "opendashboard_fqdn"),
				resource.TestCheckResourceAttr(resourceNameForSource, "opendashboard_node_count", "1"),
				resource.TestCheckResourceAttr(resourceNameForSource, "opendashboard_node_host_memory_gb", "10"),
				resource.TestCheckResourceAttr(resourceNameForSource, "opendashboard_node_host_ocpu_count", "2"),
				resource.TestCheckResourceAttrSet(resourceNameForSource, "opendashboard_private_ip"),
				resource.TestCheckResourceAttrSet(resourceNameForSource, "opensearch_fqdn"),
				resource.TestCheckResourceAttrSet(resourceNameForSource, "opensearch_private_ip"),
				resource.TestCheckResourceAttr(resourceNameForSource, "software_version", "2.11.0"),
				resource.TestCheckResourceAttrSet(resourceNameForSource, "state"),
				resource.TestCheckResourceAttrSet(resourceNameForSource, "subnet_compartment_id"),
				resource.TestCheckResourceAttrSet(resourceNameForSource, "subnet_id"),
				resource.TestCheckResourceAttr(resourceNameForSource, "system_tags.%", "0"),
				resource.TestCheckResourceAttrSet(resourceNameForSource, "time_created"),
				resource.TestCheckResourceAttrSet(resourceNameForSource, "total_storage_gb"),
				resource.TestCheckResourceAttrSet(resourceNameForSource, "vcn_compartment_id"),
				resource.TestCheckResourceAttrSet(resourceNameForSource, "vcn_id"),
...
func TestOpensearchOpensearchClusterResource_securityAttributesUpdate_1(t *testing.T) {
	httpreplay.SetScenario("TestOpensearchOpensearchClusterResource_sa")
	defer httpreplay.SaveScenario()
	...
	// Save TF content to Create resource with optional properties. This has to be exactly the same as the config part in the "create with optionals" step in the test.
	acctest.SaveConfigContent(config+compartmentIdVariableStr+OpensearchOpensearchClusterResourceDependencies+
		acctest.GenerateResourceFromRepresentationMap("oci_opensearch_opensearch_cluster", "test_opensearch_cluster", acctest.Optional, acctest.Create, OpensearchOpensearchClusterRepresentationSAUpdate), "opensearch", "opensearchCluster", t)

	acctest.ResourceTest(t, testAccCheckOpensearchOpensearchClusterDestroy, []resource.TestStep{
		//verify Create
		{
			Config: config + compartmentIdVariableStr + OpensearchOpensearchClusterResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_opensearch_opensearch_cluster", "test_opensearch_cluster", acctest.Optional, acctest.Create, OpensearchOpensearchClusterRepresentationSAUpdate),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				resource.TestCheckResourceAttr(resourceName, "compartment_id", compartmentId),
				resource.TestCheckResourceAttr(resourceName, "data_node_count", "1"),
				resource.TestCheckResourceAttr(resourceName, "data_node_host_memory_gb", "20"),
				...
				resource.TestCheckResourceAttr(resourceName, "coordinator_node_host_memory_gb", "20"),
				resource.TestCheckResourceAttr(resourceName, "coordinator_node_host_ocpu_count", "2"),
				resource.TestCheckResourceAttr(resourceName, "coordinator_node_host_type", "FLEX"),
				...
				resource.TestCheckResourceAttr(resourceName, "ml_node_count", "1"),
				resource.TestCheckResourceAttr(resourceName, "ml_node_host_memory_gb", "20"),
				resource.TestCheckResourceAttr(resourceName, "ml_node_host_ocpu_count", "2"),
				resource.TestCheckResourceAttr(resourceName, "ml_node_host_type", "FLEX"),
				resource.TestCheckResourceAttr(resourceName, "ml_node_storage_gb", "50"),
				resource.TestCheckResourceAttr(resourceName, "display_name", "tf_provider_cluster_updated"),
				resource.TestCheckResourceAttr(resourceName, "master_node_count", "1"),
				resource.TestCheckResourceAttr(resourceName, "master_node_host_memory_gb", "20"),
				resource.TestCheckResourceAttr(resourceName, "master_node_host_ocpu_count", "1"),
		...
		//try update
		{
			Config: func() string {
				configStr := config + compartmentIdVariableStr + OpensearchOpensearchClusterResourceDependencies +
					acctest.GenerateResourceFromRepresentationMap("oci_opensearch_opensearch_cluster", "test_opensearch_cluster", acctest.Optional, acctest.Update, OpensearchOpensearchClusterRepresentationSAUpdate)
				return configStr
			}(),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				resource.TestCheckResourceAttr(resourceName, "compartment_id", compartmentId),
...
func TestOpensearchOpensearchClusterResource_custom_certificate(t *testing.T) {
	...
	var resId, resId2 string
	// Save TF content to Create resource with optional properties. This has to be exactly the same as the config part in the "create with optionals" step in the test.
	acctest.SaveConfigContent(config+compartmentIdVariableStr+OpensearchOpensearchClusterResourceDependenciesForByoc+
		acctest.GenerateResourceFromRepresentationMap("oci_opensearch_opensearch_cluster", "test_opensearch_cluster", acctest.Optional, acctest.Create, OpensearchOpensearchClusterCertificatesRepresentation), "opensearch", "opensearchCluster", t)

	acctest.ResourceTest(t, testAccCheckOpensearchOpensearchClusterDestroy, []resource.TestStep{
		// verify Create
		{
			Config: config + compartmentIdVariableStr + OpensearchOpensearchClusterResourceDependenciesForByoc +
				acctest.GenerateResourceFromRepresentationMap("oci_opensearch_opensearch_cluster", "test_opensearch_cluster", acctest.Optional, acctest.Create, OpensearchOpensearchClusterCertificatesRepresentation),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "ml_node_host_shape", "VM.Standard.E3.Flex"),
				resource.TestCheckResourceAttr(resourceName, "coordinator_node_host_shape", "VM.Standard.E3.Flex"),
				resource.TestCheckResourceAttr(resourceName, "compartment_id", compartmentId),
				resource.TestCheckResourceAttr(resourceName, "coordinator_node_count", "1"),
				resource.TestCheckResourceAttr(resourceName, "coordinator_node_host_memory_gb", "20"),
				resource.TestCheckResourceAttr(resourceName, "coordinator_node_host_ocpu_count", "2"),
		...
		// verify updates to certificates parameters
		{
			Config: config + compartmentIdVariableStr + OpensearchOpensearchClusterResourceDependenciesForByoc +
				acctest.GenerateResourceFromRepresentationMap("oci_opensearch_opensearch_cluster", "test_opensearch_cluster", acctest.Optional, acctest.Update, OpensearchOpensearchClusterCertificatesRepresentation),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				resource.TestCheckResourceAttr(resourceName, "certificate_config.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "certificate_config.0.cluster_certificate_mode", "OCI_CERTIFICATES_SERVICE"),
				resource.TestCheckResourceAttr(resourceName, "certificate_config.0.dashboard_certificate_mode", "OCI_CERTIFICATES_SERVICE"),
				resource.TestCheckResourceAttrSet(resourceName, "certificate_config.0.open_search_api_certificate_id"),
				resource.TestCheckResourceAttrSet(resourceName, "certificate_config.0.open_search_dashboard_certificate_id"),
				resource.TestCheckResourceAttr(resourceName, "data_node_host_shape", "VM.Standard.E3.Flex"),
				resource.TestCheckResourceAttr(resourceName, "master_node_host_shape", "VM.Standard.E3.Flex"),
				resource.TestCheckResourceAttr(resourceName, "opendashboard_node_host_shape", "VM.Standard.E3.Flex"),
				resource.TestCheckResourceAttr(resourceName, "search_node_host_shape", "VM.Standard.E3.Flex"),
				...
				func(s *terraform.State) (err error) {
					resId2, err = acctest.FromInstanceState(s, resourceName, "id")
					if resId != resId2 {
						return fmt.Errorf("updatable parameters error %w", err)
					}
					return err
				},
			),
	...
	acctest.ResourceTest(t, testAccCheckOpensearchOpensearchClusterDestroy, []resource.TestStep{
		...
		// verify horizontal resize
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "search_node_host_type", "FLEX"),
				resource.TestCheckResourceAttr(resourceName, "search_node_storage_gb", "50"),
				resource.TestCheckResourceAttr(resourceName, "ml_node_count", "2"),
				resource.TestCheckResourceAttr(resourceName, "ml_node_host_memory_gb", "20"),
				resource.TestCheckResourceAttr(resourceName, "ml_node_host_ocpu_count", "2"),
				resource.TestCheckResourceAttr(resourceName, "ml_node_host_type", "FLEX"),
				resource.TestCheckResourceAttr(resourceName, "ml_node_storage_gb", "50"),
		...
		{Config: func() string {
			return config + compartmentIdVariableStr + OpensearchOpensearchClusterResourceDependencies + acctest.GenerateResourceFromRepresentationMap("oci_opensearch_opensearch_cluster", "test_opensearch_cluster", acctest.Optional, acctest.Update, OpensearchOpensearchClusterTagsAfterHorizontalResizeRepresentation)
		}(), Check: acctest.ComposeAggregateTestCheckFuncWrapper( // Tags are applied now (no resize in this step) resource.TestCheckResourceAttr(resourceName, "freeform_tags.%", "1"),
			// Counts remain at the post-resize values
			resource.TestCheckResourceAttr(resourceName, "coordinator_node_count", "1"),
			resource.TestCheckResourceAttr(resourceName, "data_node_count", "2"),
			resource.TestCheckResourceAttr(resourceName, "ml_node_count", "2"),
			resource.TestCheckResourceAttr(resourceName, "search_node_count", "2"),
			...
			// Ensure no recreation
			func(s *terraform.State) (err error) {
				resIdAfterTags, err := acctest.FromInstanceState(s, resourceName, "id")
				if resId2 != resIdAfterTags {
					return fmt.Errorf("Resource recreated when it was supposed to be updated.")
				}
				return err
			},
		...
		// verify vertical resize
		{
			...
			Config: func() string {
				...
				// Print the log message after completing the Config assignment
				fmt.Printf("vertical resize completed: %s\n", configStr)
				return configStr
			}(),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "ml_node_host_shape", "VM.Standard.E4.Flex"),
				resource.TestCheckResourceAttr(resourceName, "coordinator_node_host_shape", "VM.Standard.E4.Flex"),

				resource.TestCheckResourceAttr(resourceName, "compartment_id", compartmentId),
				resource.TestCheckResourceAttr(resourceName, "coordinator_node_count", "1"),
				resource.TestCheckResourceAttr(resourceName, "coordinator_node_host_memory_gb", "40"),
				resource.TestCheckResourceAttr(resourceName, "coordinator_node_host_ocpu_count", "4"),
				resource.TestCheckResourceAttr(resourceName, "coordinator_node_host_type", "FLEX"),
				resource.TestCheckResourceAttr(resourceName, "search_node_count", "2"),
				resource.TestCheckResourceAttr(resourceName, "search_node_host_memory_gb", "20"),
				resource.TestCheckResourceAttr(resourceName, "search_node_host_ocpu_count", "2"),
		...
		{Config: func() string {
			// Reuse the exact same config as the prior (vertical resize) step
			return config + compartmentIdVariableStr + OpensearchOpensearchClusterResourceDependencies + acctest.GenerateResourceFromRepresentationMap(
				"oci_opensearch_opensearch_cluster", "test_opensearch_cluster",
				acctest.Optional, acctest.Update, OpensearchOpensearchClusterVerticalResizeRepresentation)
		}(), Check: acctest.ComposeAggregateTestCheckFuncWrapper(resource.TestCheckResourceAttr(resourceName, "state", "ACTIVE"))},
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "coordinator_node_count", "1"),
				resource.TestCheckResourceAttr(singularDatasourceName, "coordinator_node_host_memory_gb", "20"),
				resource.TestCheckResourceAttr(singularDatasourceName, "coordinator_node_host_ocpu_count", "2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "coordinator_node_host_type", "FLEX"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "software_version", "2.11.0"),
...
func TestOpensearchOpensearchClusterResource_loadBalancerConfig(t *testing.T) {
	httpreplay.SetScenario("TestOpensearchOpensearchClusterResource_loadBalancerConfig")
	defer httpreplay.SaveScenario()
	config := acctest.ProviderTestConfig()
	compartmentId := utils.GetEnvSettingWithBlankDefault("compartment_ocid")
	compartmentIdVariableStr := fmt.Sprintf("variable \"compartment_id\" { default = \"%s\" }\n", compartmentId)
	...
	// Save TF content to Create resource with optional properties. This has to be exactly the same as the config part in the "create with optionals" step in the test.
	acctest.SaveConfigContent(config+compartmentIdVariableStr+OpensearchOpensearchClusterResourceDependencies+
		acctest.GenerateResourceFromRepresentationMap("oci_opensearch_opensearch_cluster", "test_opensearch_cluster", acctest.Optional, acctest.Create, OpensearchOpensearchClusterRepresentationCreateLBaaS), "opensearch", "opensearchCluster", t)
	acctest.ResourceTest(t, testAccCheckOpensearchOpensearchClusterDestroy, []resource.TestStep{
		// verify Create cluster with lbaas lb
		{
			Config: config + compartmentIdVariableStr + OpensearchOpensearchClusterResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_opensearch_opensearch_cluster", "test_opensearch_cluster", acctest.Optional, acctest.Create, OpensearchOpensearchClusterRepresentationCreateLBaaS),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				resource.TestCheckResourceAttr(resourceName, "compartment_id", compartmentId),
				resource.TestCheckResourceAttr(resourceName, "data_node_count", "1"),
				resource.TestCheckResourceAttr(resourceName, "data_node_host_memory_gb", "20"),
				...
				resource.TestCheckResourceAttr(resourceName, "data_node_host_type", "FLEX"),
				resource.TestCheckResourceAttr(resourceName, "data_node_storage_gb", "50"),
				resource.TestCheckResourceAttr(resourceName, "display_name", "tf_provider_cluster_lbaas"),
				resource.TestCheckResourceAttr(resourceName, "master_node_count", "1"),
				resource.TestCheckResourceAttr(resourceName, "master_node_host_memory_gb", "20"),
				resource.TestCheckResourceAttr(resourceName, "master_node_host_ocpu_count", "1"),
				resource.TestCheckResourceAttr(resourceName, "master_node_host_type", "FLEX"),
				...
				resource.TestCheckResourceAttr(resourceName, "load_balancer_config.0.load_balancer_service_type", "LOAD_BALANCER"),
				func(s *terraform.State) (err error) {
					resId, err = acctest.FromInstanceState(s, resourceName, "id")
					return err
				},
		...
		// verify lbaas bandwidth update
		{
			Config: func() string {
				configStr := config + compartmentIdVariableStr + OpensearchOpensearchClusterResourceDependencies +
					acctest.GenerateResourceFromRepresentationMap("oci_opensearch_opensearch_cluster", "test_opensearch_cluster", acctest.Optional, acctest.Update, OpensearchOpensearchClusterRepresentationUpdateLBaaS)
				return configStr
			}(),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				resource.TestCheckResourceAttr(resourceName, "compartment_id", compartmentId),
				...
				resource.TestCheckResourceAttr(resourceName, "load_balancer_config.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "load_balancer_config.0.load_balancer_service_type", "LOAD_BALANCER"),
				resource.TestCheckResourceAttr(resourceName, "load_balancer_config.0.load_balancer_min_bandwidth_in_mbps", "50"),
				resource.TestCheckResourceAttr(resourceName, "load_balancer_config.0.load_balancer_max_bandwidth_in_mbps", "600"),
				func(s *terraform.State) (err error) {
					resId2, err = acctest.FromInstanceState(s, resourceName, "id")
					if resId != resId2 {
						return fmt.Errorf("Resource recreated when it was supposed to be updated.")
		...
		// verify lbaas to nlb update
		{
			Config: config + compartmentIdVariableStr + OpensearchOpensearchClusterResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_opensearch_opensearch_cluster", "test_opensearch_cluster", acctest.Optional, acctest.Update, OpensearchOpensearchClusterRepresentationUpdateNLB),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				resource.TestCheckResourceAttr(resourceName, "compartment_id", compartmentId),
				resource.TestCheckResourceAttr(resourceName, "data_node_count", "1"),
				resource.TestCheckResourceAttr(resourceName, "data_node_host_memory_gb", "20"),
				...
				resource.TestCheckResourceAttr(resourceName, "data_node_host_type", "FLEX"),
				resource.TestCheckResourceAttr(resourceName, "data_node_storage_gb", "50"),
				resource.TestCheckResourceAttr(resourceName, "display_name", "tf_provider_cluster_nlb"),
				resource.TestCheckResourceAttr(resourceName, "master_node_count", "1"),
				resource.TestCheckResourceAttr(resourceName, "master_node_host_memory_gb", "20"),
				resource.TestCheckResourceAttr(resourceName, "master_node_host_ocpu_count", "1"),
				resource.TestCheckResourceAttr(resourceName, "master_node_host_type", "FLEX"),
				...
				resource.TestCheckResourceAttrSet(resourceName, "vcn_id"),
				resource.TestCheckResourceAttr(resourceName, "load_balancer_config.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "load_balancer_config.0.load_balancer_service_type", "NETWORK_LOAD_BALANCER"),
				func(s *terraform.State) (err error) {
					resId, err = acctest.FromInstanceState(s, resourceName, "id")
					return err
				},
