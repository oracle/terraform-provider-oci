...
var (
	OsManagementHubManagedInstanceGroupDetachSoftwareSourcesManagementRequiredOnlyResource = OsManagementHubManagedInstanceGroupDetachSoftwareSourcesManagementResourceDependencies +
	...
	OsManagementHubManagedInstanceGroupDetachSoftwareSourcesManagementWorkRequestDetailsRepresentation = map[string]interface{}{
...
func TestOsManagementHubManagedInstanceGroupDetachSoftwareSourcesManagementResource_basic(t *testing.T) {
	...
	resourceNameAttach := "oci_os_management_hub_managed_instance_group_attach_software_sources_management.test_managed_instance_group_attach_software_sources_management"
	resourceName := "oci_os_management_hub_managed_instance_group_detach_software_sources_management.test_managed_instance_group_detach_software_sources_management"
	...
	acctest.ResourceTest(t, nil, []resource.TestStep{
		// Attach software source
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceNameAttach, "software_sources.#", "1"),
			),
		},
