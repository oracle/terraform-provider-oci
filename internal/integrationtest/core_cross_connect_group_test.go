...
var (
	...
	CoreCrossConnectGroupRepresentation = map[string]interface{}{
		...
		"minimum_links":                              acctest.Representation{RepType: acctest.Optional, Create: `1`, Update: `1`},
	}
	...
	acctest.ResourceTest(t, testAccCheckCoreCrossConnectGroupDestroy, []resource.TestStep{
		...
		// verify datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(datasourceName, "cross_connect_groups.0.interface_down_timer_value_in_milliseconds", "1000"),
				resource.TestCheckResourceAttr(datasourceName, "cross_connect_groups.0.is_interface_hold_timer_enabled", "true"),
				resource.TestCheckResourceAttr(datasourceName, "cross_connect_groups.0.is_qos_enabled", "false"),
				...
				resource.TestCheckResourceAttr(datasourceName, "cross_connect_groups.0.minimum_links", "1"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "minimum_links", "1"),
