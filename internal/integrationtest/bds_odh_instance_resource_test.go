...
var (
	...
	bdsInstanceOdhRepresentation = map[string]interface{}{
		...
		"compartment_id":           acctest.Representation{RepType: acctest.Required, Create: `${var.compartment_id}`},
		"display_name":             acctest.Representation{RepType: acctest.Required, Create: `itkafka1`, Update: `displayName2`},
		...
		"cluster_profile":          acctest.Representation{RepType: acctest.Optional, Create: `KAFKA`},
