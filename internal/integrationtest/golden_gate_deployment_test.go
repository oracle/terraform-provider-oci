	...
	var steps = []resource.TestStep{
		...
		// #8 verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "deployment_type", "DATABASE_ORACLE"),
				resource.TestCheckResourceAttr(resourceName, "description", "description"),
				resource.TestCheckResourceAttr(resourceName, "disaster_recovery_status", "ENABLED"),
				...
				resource.TestCheckResourceAttrSet(resourceName, "ogg_data.0.deployment_name"),
				resource.TestCheckResourceAttr(resourceName, "ogg_data.0.group_to_roles_mapping.#", "1"),
				resource.TestCheckResourceAttrSet(resourceName, "ogg_data.0.group_to_roles_mapping.0.administrator_group_id"),
				resource.TestCheckResourceAttrSet(resourceName, "ogg_data.0.group_to_roles_mapping.0.operator_group_id"),
				resource.TestCheckResourceAttrSet(resourceName, "ogg_data.0.group_to_roles_mapping.0.security_group_id"),
				resource.TestCheckResourceAttrSet(resourceName, "ogg_data.0.group_to_roles_mapping.0.user_group_id"),
				resource.TestCheckResourceAttrSet(resourceName, "ogg_data.0.identity_domain_id"),
				resource.TestCheckResourceAttr(resourceName, "ogg_data.0.key", "key"),
				resource.TestCheckResourceAttrSet(resourceName, "ogg_data.0.key_secret_id"),
				resource.TestCheckResourceAttr(resourceName, "ogg_data.0.ogg_version", "oggVersion"),
				resource.TestCheckResourceAttrSet(resourceName, "ogg_data.0.password_secret_id"),
		...
		// #10 verify updates to updatable parameters
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "environment_type", "DEVELOPMENT_OR_TESTING"),
				resource.TestCheckResourceAttr(resourceName, "fault_domain", "faultDomain"),
				...
				resource.TestCheckResourceAttrSet(resourceName, "ogg_data.0.group_to_roles_mapping.0.user_group_id"),
				resource.TestCheckResourceAttrSet(resourceName, "ogg_data.0.identity_domain_id"),
				resource.TestCheckResourceAttr(resourceName, "ogg_data.0.key", "key2"),
				resource.TestCheckResourceAttrSet(resourceName, "ogg_data.0.key_secret_id"),
				resource.TestCheckResourceAttr(resourceName, "ogg_data.0.ogg_version", "oggVersion"),
				resource.TestCheckResourceAttrSet(resourceName, "ogg_data.0.password_secret_id"),
				resource.TestCheckResourceAttr(resourceName, "placements.#", "1"),
		...
		// #12 verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "disaster_recovery_status", "ENABLED"),
				resource.TestCheckResourceAttr(singularDatasourceName, "display_name", "displayName2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "environment_type", "DEVELOPMENT_OR_TESTING"),
				resource.TestCheckResourceAttr(singularDatasourceName, "fault_domain", "faultDomain"),
