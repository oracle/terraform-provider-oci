...
func TestBatchBatchContextShapeResource_basic(t *testing.T) {
	httpreplay.SetScenario("TestBatchBatchContextShapeResource_basic")
	...
	datasourceName := "data.oci_batch_batch_context_shapes.test_batch_context_shapes"
