...
var (
	...
	GoldenGatePipelineRepresentation = map[string]interface{}{
		...
		"cpu_core_count": acctest.Representation{RepType: acctest.Optional, Create: `10`, Update: `11`},
	...
	GoldenGatePipelineProcessOptionsRepresentation = map[string]interface{}{
		...
		"start_using_default_mapping": acctest.Representation{RepType: acctest.Optional, Create: `ENABLED`},
	}
	GoldenGatePipelineProcessOptionsInitialDataLoadRepresentation = map[string]interface{}{
		...
		"adb_wallet_path":          acctest.Representation{RepType: acctest.Optional, Create: `adbWalletPath`, Update: `adbWalletPath2`},
		"bucket":                   acctest.Representation{RepType: acctest.Optional, Create: `bucket`, Update: `bucket2`},
		"initial_load_type":        acctest.Representation{RepType: acctest.Optional, Create: `DB_LINK`, Update: `OBJECT_STORAGE`},
		"namespace":                acctest.Representation{RepType: acctest.Optional, Create: `namespace`, Update: `namespace2`},
		"source_wallet_path":       acctest.Representation{RepType: acctest.Optional, Create: `sourceWalletPath`, Update: `sourceWalletPath2`},
		"target_wallet_path":       acctest.Representation{RepType: acctest.Optional, Create: `targetWalletPath`, Update: `targetWalletPath2`},
	}
	...
	acctest.ResourceTest(t, testAccCheckGoldenGatePipelineDestroy, []resource.TestStep{
		...
		// verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "process_options.0.initial_data_load.0.adb_wallet_path", "adbWalletPath"),
				resource.TestCheckResourceAttr(resourceName, "process_options.0.initial_data_load.0.bucket", "bucket"),
				resource.TestCheckResourceAttr(resourceName, "process_options.0.initial_data_load.0.initial_load_type", "DB_LINK"),
				resource.TestCheckResourceAttr(resourceName, "process_options.0.initial_data_load.0.is_initial_load", "ENABLED"),
				resource.TestCheckResourceAttr(resourceName, "process_options.0.initial_data_load.0.namespace", "namespace"),
				resource.TestCheckResourceAttr(resourceName, "process_options.0.initial_data_load.0.source_wallet_path", "sourceWalletPath"),
				resource.TestCheckResourceAttr(resourceName, "process_options.0.initial_data_load.0.target_wallet_path", "targetWalletPath"),
		...
		// verify updates to updatable parameters
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				resource.TestCheckResourceAttr(resourceName, "compartment_id", compartmentId),
				resource.TestCheckResourceAttr(resourceName, "cpu_core_count", "11"),
				...
				resource.TestCheckResourceAttr(resourceName, "process_options.0.initial_data_load.0.adb_wallet_path", "adbWalletPath2"),
				resource.TestCheckResourceAttr(resourceName, "process_options.0.initial_data_load.0.bucket", "bucket2"),
				resource.TestCheckResourceAttr(resourceName, "process_options.0.initial_data_load.0.initial_load_type", "OBJECT_STORAGE"),
				resource.TestCheckResourceAttr(resourceName, "process_options.0.initial_data_load.0.is_initial_load", "DISABLED"),
				resource.TestCheckResourceAttr(resourceName, "process_options.0.initial_data_load.0.namespace", "namespace2"),
				resource.TestCheckResourceAttr(resourceName, "process_options.0.initial_data_load.0.source_wallet_path", "sourceWalletPath2"),
				resource.TestCheckResourceAttr(resourceName, "process_options.0.initial_data_load.0.target_wallet_path", "targetWalletPath2"),
				resource.TestCheckResourceAttr(resourceName, "process_options.0.replicate_schema_change.#", "1"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "cpu_core_count", "11"),
				resource.TestCheckResourceAttr(singularDatasourceName, "description", "description2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "display_name", "displayName2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "freeform_tags.%", "1"),
				resource.TestCheckResourceAttrSet(singularDatasourceName, "id"),

				resource.TestCheckResourceAttr(singularDatasourceName, "ingress_ips.#", "1"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "process_options.0.initial_data_load.0.adb_wallet_path", "adbWalletPath2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "process_options.0.initial_data_load.0.bucket", "bucket2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "process_options.0.initial_data_load.0.initial_load_type", "OBJECT_STORAGE"),
				resource.TestCheckResourceAttr(singularDatasourceName, "process_options.0.initial_data_load.0.is_initial_load", "DISABLED"),
				resource.TestCheckResourceAttr(singularDatasourceName, "process_options.0.initial_data_load.0.namespace", "namespace2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "process_options.0.initial_data_load.0.source_wallet_path", "sourceWalletPath2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "process_options.0.initial_data_load.0.target_wallet_path", "targetWalletPath2"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "process_options.0.start_using_default_mapping", "ENABLED"),
