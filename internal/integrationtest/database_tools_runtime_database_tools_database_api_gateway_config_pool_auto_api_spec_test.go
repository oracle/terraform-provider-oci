...
var (
	...
	DatabaseToolsRuntimeDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecRepresentation = map[string]interface{}{
		...
		"operations":                                    acctest.Representation{RepType: acctest.Optional, Create: []string{`READ`, `WRITE`}, Update: []string{}},
		"security_schemes":                              acctest.Representation{RepType: acctest.Optional, Create: []string{`BASIC`}, Update: []string{}},
	}
	...
	acctest.ResourceTest(t, testAccCheckDatabaseToolsRuntimeDatabaseToolsDatabaseApiGatewayConfigPoolAutoApiSpecDestroy, []resource.TestStep{
		...
		// verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "operations.0", "READ"),
				resource.TestCheckResourceAttr(resourceName, "operations.1", "WRITE"),
				resource.TestCheckResourceAttrPair(resourceName, "pool_key", poolResourceName, "key"),
				resource.TestCheckResourceAttr(resourceName, "security_schemes.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "security_schemes.0", "BASIC"),
		...
		// verify updates to updatable parameters
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttrSet(resourceName, "key"),
				resource.TestCheckResourceAttr(resourceName, "operations.#", "0"),
				resource.TestCheckResourceAttrPair(resourceName, "pool_key", poolResourceName, "key"),
				resource.TestCheckResourceAttr(resourceName, "security_schemes.#", "0"),
				resource.TestCheckResourceAttrSet(resourceName, "time_created"),
				resource.TestCheckResourceAttrSet(resourceName, "time_updated"),
				resource.TestCheckResourceAttr(resourceName, "type", "DEFAULT"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "operations.#", "0"),
				resource.TestCheckResourceAttr(singularDatasourceName, "security_schemes.#", "0"),
