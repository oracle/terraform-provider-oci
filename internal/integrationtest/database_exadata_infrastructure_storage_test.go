...
var (
	ExadataInfrastructureStorageRequiredOnlyResource = DatabaseExadataInfrastructureResourceDependencies +
	...
	ExadataInfrastructureStorageResourceConfig = DatabaseExadataInfrastructureResourceDependencies +
