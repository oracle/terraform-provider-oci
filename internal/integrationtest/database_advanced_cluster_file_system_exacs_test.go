...
var (
	DatabaseAdvancedClusterFileSystemRequiredOnlyExaCSResource = DatabaseAdvancedClusterFileSystemExaCSResourceDependencies +
		acctest.GenerateResourceFromRepresentationMap("oci_database_advanced_cluster_file_system", "test_advanced_cluster_file_system", acctest.Required, acctest.Create, DatabaseAdvancedClusterFileSystemExaCSRepresentation)

	DatabaseAdvancedClusterFileSystemExaCSResourceConfig = DatabaseAdvancedClusterFileSystemExaCSResourceDependencies +
		acctest.GenerateResourceFromRepresentationMap("oci_database_advanced_cluster_file_system", "test_advanced_cluster_file_system", acctest.Optional, acctest.Update, DatabaseAdvancedClusterFileSystemExaCSRepresentation)

	DatabaseAdvancedClusterFileSystemSingularExaCSDataSourceRepresentation = map[string]interface{}{
	...
	DatabaseAdvancedClusterFileSystemExaCSDataSourceRepresentation = map[string]interface{}{
		"compartment_id": acctest.Representation{RepType: acctest.Required, Create: `${var.compartment_id}`},
		"name":           acctest.Representation{RepType: acctest.Optional, Create: `fileSystemName`},
		"state":          acctest.Representation{RepType: acctest.Optional, Create: `AVAILABLE`},
		"vm_cluster_id":  acctest.Representation{RepType: acctest.Optional, Create: `${oci_database_cloud_vm_cluster.test_cloud_vm_cluster.id}`},
		"filter":         acctest.RepresentationGroup{RepType: acctest.Required, Group: DatabaseAdvancedClusterFileSystemExaCSDataSourceFilterRepresentation}}
	DatabaseAdvancedClusterFileSystemExaCSDataSourceFilterRepresentation = map[string]interface{}{
	...
	DatabaseAdvancedClusterFileSystemExaCSRepresentation = map[string]interface{}{
	...
	DatabaseAdvancedClusterFileSystemExaCSResourceDependencies = DatabaseExascaleCloudVmClusterResourceDependencies +
...
func TestDatabaseAdvancedClusterFileSystemExaCSResource_basic(t *testing.T) {
	httpreplay.SetScenario("TestDatabaseAdvancedClusterFileSystemExaCSResource_basic")
	...
	acctest.SaveConfigContent(config+compartmentIdVariableStr+DatabaseAdvancedClusterFileSystemExaCSResourceDependencies+
		acctest.GenerateResourceFromRepresentationMap("oci_database_advanced_cluster_file_system", "test_advanced_cluster_file_system", acctest.Optional, acctest.Create, DatabaseAdvancedClusterFileSystemExaCSRepresentation), "database", "advancedClusterFileSystem", t)

	acctest.ResourceTest(t, testAccCheckDatabaseAdvancedClusterFileSystemExaCSDestroy, []resource.TestStep{
		// verify Create
		{
			Config: config + compartmentIdVariableStr + DatabaseAdvancedClusterFileSystemExaCSResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_database_advanced_cluster_file_system", "test_advanced_cluster_file_system", acctest.Optional, acctest.Create, DatabaseAdvancedClusterFileSystemExaCSRepresentation),
		...
		{
			Config: config +
				acctest.GenerateDataSourceFromRepresentationMap("oci_database_advanced_cluster_file_systems", "test_advanced_cluster_file_systems", acctest.Optional, acctest.Update, DatabaseAdvancedClusterFileSystemExaCSDataSourceRepresentation) +
				compartmentIdVariableStr + DatabaseAdvancedClusterFileSystemExaCSResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_database_advanced_cluster_file_system", "test_advanced_cluster_file_system", acctest.Optional, acctest.Update, DatabaseAdvancedClusterFileSystemExaCSRepresentation),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
		...
		{
			Config: config +
				acctest.GenerateDataSourceFromRepresentationMap("oci_database_advanced_cluster_file_system", "test_advanced_cluster_file_system", acctest.Required, acctest.Create, DatabaseAdvancedClusterFileSystemSingularExaCSDataSourceRepresentation) +
				compartmentIdVariableStr + DatabaseAdvancedClusterFileSystemExaCSResourceConfig,
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
		...
		{
			Config:                  config + DatabaseAdvancedClusterFileSystemRequiredOnlyExaCSResource,
			ImportState:             true,
...
func testAccCheckDatabaseAdvancedClusterFileSystemExaCSDestroy(s *terraform.State) error {
...
func init() {
	...
	if !acctest.InSweeperExcludeList("DatabaseAdvancedClusterFileSystemExaCS") {
		resource.AddTestSweepers("DatabaseAdvancedClusterFileSystemExaCS", &resource.Sweeper{
			Name:         "DatabaseAdvancedClusterFileSystemExaCS",
			Dependencies: acctest.DependencyGraph["advancedClusterFileSystem"],
			F:            sweepDatabaseAdvancedClusterFileSystemExaCSResource,
		})
	}
}

func sweepDatabaseAdvancedClusterFileSystemExaCSResource(compartment string) error {
	databaseClient := acctest.GetTestClients(&schema.ResourceData{}).DatabaseClient()
	advancedClusterFileSystemIds, err := getDatabaseAdvancedClusterFileSystemExaCSIds(compartment)
	if err != nil {
		return err
	}
	for _, advancedClusterFileSystemId := range advancedClusterFileSystemIds {
		if ok := acctest.SweeperDefaultResourceId[advancedClusterFileSystemId]; !ok {
			...
			acctest.WaitTillCondition(acctest.TestAccProvider, &advancedClusterFileSystemId, DatabaseAdvancedClusterFileSystemExaCSSweepWaitCondition, time.Duration(3*time.Minute),
				DatabaseAdvancedClusterFileSystemExaCSSweepResponseFetchOperation, "database", true)
		}
	}
	return nil
}

func getDatabaseAdvancedClusterFileSystemExaCSIds(compartment string) ([]string, error) {
...
func DatabaseAdvancedClusterFileSystemExaCSSweepWaitCondition(response common.OCIOperationResponse) bool {
...
func DatabaseAdvancedClusterFileSystemExaCSSweepResponseFetchOperation(client *tf_client.OracleClients, resourceId *string, retryPolicy *common.RetryPolicy) error {
