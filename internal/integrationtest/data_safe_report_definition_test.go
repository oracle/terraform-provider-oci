...
var (
	...
	reportDefinitionColumnInfoRepresentation = map[string]interface{}{
		"display_name":  acctest.Representation{RepType: acctest.Required, Create: `Data Safe Target ID`, Update: `Data Safe Target ID`},
	...
	acctest.ResourceTest(t, testAccCheckDataSafeReportDefinitionDestroy, []resource.TestStep{
		// verify Create
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "column_info.0.display_name", "Data Safe Target ID"),
				...
				resource.TestCheckResourceAttr(resourceName, "display_name", "displayName18-test-1"),
		...
		// verify updates to updatable parameters
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "display_name", "displayName19-test"),
				resource.TestCheckResourceAttrSet(resourceName, "id"),
				resource.TestCheckResourceAttrSet(resourceName, "parent_id"),
				resource.TestCheckResourceAttrSet(resourceName, "state"),
				resource.TestCheckResourceAttr(resourceName, "summary.#", "1"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "column_info.0.display_name", "Data Safe Target ID"),
