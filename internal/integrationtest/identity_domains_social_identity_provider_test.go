	...
	acctest.ResourceTest(t, testAccCheckIdentityDomainsSocialIdentityProviderDestroy, []resource.TestStep{
		...
		// verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "apple_key_id", "key-id-123"),
				resource.TestCheckResourceAttr(resourceName, "apple_dev_id", "dev-id-123"),
		...
		// verify updates to updatable parameters
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "admin_scope.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "apple_key_id", "key-id-234"),
				resource.TestCheckResourceAttr(resourceName, "apple_dev_id", "dev-id-234"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "apple_key_id", "key-id-234"),
				resource.TestCheckResourceAttr(singularDatasourceName, "apple_dev_id", "dev-id-234"),
