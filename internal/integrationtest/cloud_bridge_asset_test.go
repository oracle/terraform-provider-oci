...
var (
	...
	//AWS_EC2
	CloudBridgeAwsEc2AssetRequiredOnlyResource = CloudBridgeAssetResourceDependencies +
	...
	CloudBridgeAwsEc2AssetResourceConfig = CloudBridgeAssetResourceDependencies +
	...
	//AWS_EBS
	CloudBridgeAwsEbsAssetRequiredOnlyResource = CloudBridgeAssetResourceDependencies +
	...
	CloudBridgeAwsEbsAssetResourceConfig = CloudBridgeAssetResourceDependencies +
	...
	CloudBridgeAssetResourceDependencies = acctest.GenerateResourceFromRepresentationMap("oci_cloud_bridge_inventory", "test_inventory",
		acctest.Required, acctest.Create, acctest.RepresentationCopyWithNewProperties(CloudBridgeInventoryRepresentation, map[string]interface{}{
