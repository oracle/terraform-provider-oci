	...
	acctest.ResourceTest(t, testAccCheckIdentityDomainsIdentityProviderDestroy, []resource.TestStep{
		...
		// verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "urnietfparamsscimschemasoracleidcsextensionsocial_identity_provider.0.service_provider_name", "Google"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "urnietfparamsscimschemasoracleidcsextensionsocial_identity_provider.0.service_provider_name", "Google"),
