	...
	acctest.ResourceTest(t, nil, []resource.TestStep{
		// Create
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(ResourceDatabaseResourceName, "storage_volume_performance_mode", "HIGH_PERFORMANCE"),
				resource.TestCheckResourceAttr(ResourceDatabaseResourceName, "disk_redundancy", "NORMAL"),
				resource.TestCheckResourceAttr(ResourceDatabaseResourceName, "shape", "VM.Standard.A1.Flex"),
