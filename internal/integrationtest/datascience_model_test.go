...
var (
	...
	DatascienceModelCustomMetadataListRepresentation = map[string]interface{}{
		"category":     acctest.Representation{RepType: acctest.Optional, Create: `category`, Update: `category2`},
		"description":  acctest.Representation{RepType: acctest.Optional, Create: `description`, Update: `description2`},
		"has_artifact": acctest.Representation{RepType: acctest.Optional, Create: `false`, Update: `true`},
		"key":          acctest.Representation{RepType: acctest.Optional, Create: `BaseModel1`, Update: `BaseModel1`},
		"keywords":     acctest.Representation{RepType: acctest.Optional, Create: []string{`keywords`}, Update: []string{`keywords2`}},
	...
	acctest.ResourceTest(t, testAccCheckDatascienceModelDestroy, []resource.TestStep{
		...
		// verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "backup_setting.0.is_backup_enabled", "false"),
				...
				resource.TestCheckResourceAttr(resourceName, "custom_metadata_list.0.has_artifact", "false"),
				...
				resource.TestCheckResourceAttr(resourceName, "custom_metadata_list.0.keywords.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "defined_metadata_list.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "defined_metadata_list.0.category", "category"),
				resource.TestCheckResourceAttr(resourceName, "defined_metadata_list.0.description", "description"),
				resource.TestCheckResourceAttr(resourceName, "defined_metadata_list.0.has_artifact", "false"),
				...
				resource.TestCheckResourceAttr(resourceName, "defined_metadata_list.0.keywords.#", "1"),
				resource.TestCheckResourceAttrSet(resourceName, "created_by"),
				resource.TestCheckResourceAttr(resourceName, "description", "description"),
				resource.TestCheckResourceAttr(resourceName, "display_name", "displayName"),
				resource.TestCheckResourceAttr(resourceName, "freeform_tags.%", "1"),
				resource.TestCheckResourceAttrSet(resourceName, "id"),
				resource.TestCheckResourceAttr(resourceName, "input_schema", "inputSchema"),
				resource.TestCheckResourceAttrSet(resourceName, "is_model_by_reference"),
				resource.TestCheckResourceAttrSet(resourceName, "model_version_set_id"),
				resource.TestCheckResourceAttrSet(resourceName, "model_version_set_name"),
				resource.TestCheckResourceAttr(resourceName, "output_schema", "outputSchema"),
				resource.TestCheckResourceAttrSet(resourceName, "project_id"),
		...
		// verify updates to updatable parameters
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "compartment_id", compartmentId),
				resource.TestCheckResourceAttr(resourceName, "custom_metadata_list.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "custom_metadata_list.0.category", "category2"),
				resource.TestCheckResourceAttr(resourceName, "custom_metadata_list.0.description", "description2"),
				resource.TestCheckResourceAttr(resourceName, "custom_metadata_list.0.has_artifact", "true"),
				resource.TestCheckResourceAttr(resourceName, "custom_metadata_list.0.keywords.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "defined_metadata_list.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "defined_metadata_list.0.category", "category2"),
				resource.TestCheckResourceAttr(resourceName, "defined_metadata_list.0.description", "description2"),
				resource.TestCheckResourceAttr(resourceName, "defined_metadata_list.0.has_artifact", "true"),
				resource.TestCheckResourceAttr(resourceName, "defined_metadata_list.0.keywords.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "custom_metadata_list.0.category", "Performance"),
				resource.TestCheckResourceAttr(resourceName, "custom_metadata_list.0.description", "description"),
				resource.TestCheckResourceAttr(resourceName, "custom_metadata_list.0.key", "BaseModel1"),
		...
		// verify datasource
		{
			Config: config +
				...
				acctest.GenerateResourceFromRepresentationMap("oci_datascience_model", "test_model", acctest.Optional, acctest.Update, DatascienceModelRepresentation),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				resource.TestCheckResourceAttr(datasourceName, "category", "USER"),
				...
				resource.TestCheckResourceAttrSet(datasourceName, "models.0.category"),
				...
				resource.TestCheckResourceAttrSet(datasourceName, "models.0.is_model_by_reference"),
				resource.TestCheckResourceAttrSet(datasourceName, "models.0.model_version_set_id"),
				resource.TestCheckResourceAttrSet(datasourceName, "models.0.model_version_set_name"),
