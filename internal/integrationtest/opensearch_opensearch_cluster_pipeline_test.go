...
var (
	...
	OpensearchOpensearchClusterPipelineDataSourceRepresentation = map[string]interface{}{
		...
		"pipeline_component_id": acctest.Representation{RepType: acctest.Optional, Create: `ocid1.opensearchcluster.oc1.iad.amaaaaaahngrfpyazkwqhgnvrdtzr74fyl4nocmdw6qetnhdmqcx7baoe4zq`},
