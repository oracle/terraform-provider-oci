...
var (
	FleetAppsManagementSchedulerDefinitionScheduledFleetDataSourceRepresentation = map[string]interface{}{
		"scheduler_definition_id": acctest.Representation{RepType: acctest.Required, Create: `${var.scheduler_definition_id}`},
		"display_name":            acctest.Representation{RepType: acctest.Optional, Create: `testWeblogicFleet`},
	}

	FleetAppsManagementSchedulerDefinitionScheduledFleetResourceConfig = ""
...
func TestFleetAppsManagementSchedulerDefinitionScheduledFleetResource_basic(t *testing.T) {
	...
	schedulerDefinitionStr := fmt.Sprintf("variable \"scheduler_definition_id\" { default = \"%s\" }\n", schedulerDefinitionId)
	...
	acctest.ResourceTest(t, nil, []resource.TestStep{
		// verify datasource
		{
			Config: config +
				...
				schedulerDefinitionStr + compartmentIdVariableStr + FleetAppsManagementSchedulerDefinitionScheduledFleetResourceConfig,
