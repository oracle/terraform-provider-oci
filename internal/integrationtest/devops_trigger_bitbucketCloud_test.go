...
var (
	BitbucketCloudTriggerRequiredOnlyResource = BitbucketCloudTriggerResourceDependencies +
		acctest.GenerateResourceFromRepresentationMap("oci_devops_trigger", "test_trigger", acctest.Required, acctest.Create, bitbucketCloudTriggerRepresentation)

	BitbucketCloudTriggerResourceConfig = BitbucketCloudTriggerResourceDependencies +
		acctest.GenerateResourceFromRepresentationMap("oci_devops_trigger", "test_trigger", acctest.Optional, acctest.Update, bitbucketCloudTriggerRepresentation)

	bitbucketCloudTriggerSingularDataSourceRepresentation = map[string]interface{}{
		"trigger_id": acctest.Representation{RepType: acctest.Required, Create: `${oci_devops_trigger.test_trigger.id}`},
	}

	bitbucketCloudTriggerDataSourceRepresentation = map[string]interface{}{
		...
		"filter":         acctest.RepresentationGroup{RepType: acctest.Required, Group: bitbucketCloudTriggerDataSourceFilterRepresentation}}
	bitbucketCloudTriggerDataSourceFilterRepresentation = map[string]interface{}{
		"name":   acctest.Representation{RepType: acctest.Required, Create: `id`},
		"values": acctest.Representation{RepType: acctest.Required, Create: []string{`${oci_devops_trigger.test_trigger.id}`}},
	}

	bitbucketCloudTriggerRepresentation = map[string]interface{}{
		"actions":        acctest.RepresentationGroup{RepType: acctest.Required, Group: bitbucketCloudTriggerActionsRepresentation},
		"project_id":     acctest.Representation{RepType: acctest.Required, Create: `${oci_devops_project.test_project.id}`},
		"trigger_source": acctest.Representation{RepType: acctest.Required, Create: `BITBUCKET_CLOUD`},
	...
	bitbucketCloudTriggerActionsRepresentation = map[string]interface{}{
		...
		"filter":            acctest.RepresentationGroup{RepType: acctest.Optional, Group: bitbucketCloudTriggerActionsFilterRepresentation},
	}
	bitbucketCloudTriggerActionsFilterRepresentation = map[string]interface{}{
		"trigger_source": acctest.Representation{RepType: acctest.Required, Create: `BITBUCKET_CLOUD`},
		"events":         acctest.Representation{RepType: acctest.Optional, Create: []string{`PUSH`}, Update: []string{`PULL_REQUEST_CREATED`}},
		"include":        acctest.RepresentationGroup{RepType: acctest.Optional, Group: bitbucketCloudTriggerActionsFilterIncludeRepresentation},
	}
	bitbucketCloudTriggerActionsFilterIncludeRepresentation = map[string]interface{}{
...
func TestDevopsBitbucketCloudTriggerResource_basic(t *testing.T) {
	...
	acctest.SaveConfigContent(config+compartmentIdVariableStr+BitbucketCloudTriggerResourceDependencies+
		acctest.GenerateResourceFromRepresentationMap("oci_devops_trigger", "test_trigger", acctest.Optional, acctest.Create, bitbucketCloudTriggerRepresentation), "devops", "trigger", t)

	acctest.ResourceTest(t, testAccCheckDevopsTriggerDestroy, []resource.TestStep{
		// verify create
		{
			Config: config + compartmentIdVariableStr + BitbucketCloudTriggerResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_devops_trigger", "test_trigger", acctest.Required, acctest.Create, bitbucketCloudTriggerRepresentation),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "trigger_source", "BITBUCKET_CLOUD"),
		...
		{
			Config: config + compartmentIdVariableStr + BitbucketCloudTriggerResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_devops_trigger", "test_trigger", acctest.Optional, acctest.Create, bitbucketCloudTriggerRepresentation),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				resource.TestCheckResourceAttr(resourceName, "actions.#", "1"),
				resource.TestCheckResourceAttrSet(resourceName, "actions.0.build_pipeline_id"),
				...
				resource.TestCheckResourceAttr(resourceName, "actions.0.filter.0.trigger_source", "BITBUCKET_CLOUD"),
				resource.TestCheckResourceAttr(resourceName, "actions.0.type", "TRIGGER_BUILD_PIPELINE"),
		...
		{
			Config: config +
				acctest.GenerateDataSourceFromRepresentationMap("oci_devops_triggers", "test_triggers", acctest.Optional, acctest.Update, bitbucketCloudTriggerDataSourceRepresentation) +
				compartmentIdVariableStr + BitbucketCloudTriggerResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_devops_trigger", "test_trigger", acctest.Optional, acctest.Update, bitbucketCloudTriggerRepresentation),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
		...
		{
			Config: config +
				acctest.GenerateDataSourceFromRepresentationMap("oci_devops_trigger", "test_trigger", acctest.Required, acctest.Create, bitbucketCloudTriggerSingularDataSourceRepresentation) +
				compartmentIdVariableStr + BitbucketCloudTriggerResourceConfig,
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "actions.0.filter.0.trigger_source", "BITBUCKET_CLOUD"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "trigger_source", "BITBUCKET_CLOUD"),
