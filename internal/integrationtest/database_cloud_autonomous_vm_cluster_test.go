...
var (
	...
	DatabaseCloudAutonomousVmClusterRepresentation = map[string]interface{}{
		...
		"cluster_time_zone":                     acctest.Representation{RepType: acctest.Optional, Create: `Etc/UTC`, Update: `US/Pacific`},
		...
		"total_container_databases":             acctest.Representation{RepType: acctest.Optional, Create: `2`, Update: `3`},
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// verify updates to updatable parameters
			{
				...
				Check: acctest.ComposeAggregateTestCheckFuncWrapper(
					resource.TestCheckResourceAttrSet(resourceName, "cloud_exadata_infrastructure_id"),
					resource.TestCheckResourceAttr(resourceName, "cluster_time_zone", "US/Pacific"),
					resource.TestCheckResourceAttr(resourceName, "compartment_id", compartmentId),
					resource.TestCheckResourceAttr(resourceName, "compute_model", "ECPU"),
					resource.TestCheckResourceAttr(resourceName, "defined_tags.%", "1"),
					...
					resource.TestCheckResourceAttr(resourceName, "scan_listener_port_tls", "2710"),
					resource.TestCheckResourceAttr(resourceName, "security_attributes.%", "0"),
					resource.TestCheckResourceAttrSet(resourceName, "state"),
					resource.TestCheckResourceAttrSet(resourceName, "subnet_id"),
					// 					resource.TestCheckResourceAttr(resourceName, "cpu_core_count_per_node", "40"),
			...
			// verify datasource
			{
				...
				Check: acctest.ComposeAggregateTestCheckFuncWrapper(
					...
					resource.TestCheckResourceAttr(datasourceName, "cloud_autonomous_vm_clusters.0.cluster_time_zone", "US/Pacific"),
					...
					resource.TestCheckResourceAttr(datasourceName, "cloud_autonomous_vm_clusters.0.is_mtls_enabled_vm_cluster", "true"),
					...
					resource.TestCheckResourceAttr(datasourceName, "cloud_autonomous_vm_clusters.0.scan_listener_port_non_tls", "2303"),
					resource.TestCheckResourceAttr(datasourceName, "cloud_autonomous_vm_clusters.0.scan_listener_port_tls", "2710"),
					resource.TestCheckResourceAttr(resourceName, "security_attributes.%", "0"),
			...
			// verify singular datasource
			{
				...
				Check: acctest.ComposeAggregateTestCheckFuncWrapper(
					...
					resource.TestCheckResourceAttr(singularDatasourceName, "cluster_time_zone", "US/Pacific"),
