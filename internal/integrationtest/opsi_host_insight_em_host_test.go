...
import (
	...
	oci_opsi "github.com/oracle/oci-go-sdk/v59/operationsinsights"
...
func TestOpsiEmHostInsightResource_basic(t *testing.T) {
	...
	acctest.ResourceTest(t, testAccCheckOpsiEmHostInsightDestroy, []resource.TestStep{
		...
		{
			Config: config + compartmentIdVariableStr + emBridgeIdVariableStr + enterpriseManagerIdVariableStr + enterpriseManagerEntityIdVariableStr + EmHostInsightResourceConfig,
		},
