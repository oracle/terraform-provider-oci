...
var (
	...
	MeteringComputationUsageCarbonEmissionsQueryQueryDefinitionReportQueryRepresentation = map[string]interface{}{
		...
		"compartment_depth": acctest.Representation{RepType: acctest.Optional, Create: `1`, Update: `2`},
		//"date_range_name":             acctest.Representation{RepType: acctest.Optional, Create: `LAST_TWO_MONTHS`, Update: `LAST_THREE_MONTHS`},
		"emission_calculation_method": acctest.Representation{RepType: acctest.Optional, Create: `SPEND_BASED`, Update: `POWER_BASED`},
		"emission_type":               acctest.Representation{RepType: acctest.Optional, Create: `MARKET_BASED`, Update: `LOCATION_BASED`},
		"granularity":                 acctest.Representation{RepType: acctest.Optional, Create: `MONTHLY`, Update: `DAILY`},
		...
		"time_usage_started":                  acctest.Representation{RepType: acctest.Required, Create: `2024-06-01T00:00:00Z`},
	...
	acctest.ResourceTest(t, testAccCheckMeteringComputationUsageCarbonEmissionsQueryDestroy, []resource.TestStep{
		...
		// verify updates to updatable parameters
		{
			Config: config + tenancyIdVariableStr + MeteringComputationUsageCarbonEmissionsQueryResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_metering_computation_usage_carbon_emissions_query", "test_usage_carbon_emissions_query", acctest.Optional, acctest.Update, MeteringComputationUsageCarbonEmissionsQueryRepresentation),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				resource.TestCheckResourceAttr(resourceName, "compartment_id", `${var.tenancy_id}`),
				...
				//resource.TestCheckResourceAttr(resourceName, "query_definition.0.report_query.0.date_range_name", "LAST_THREE_MONTHS"),
				resource.TestCheckResourceAttr(resourceName, "query_definition.0.report_query.0.emission_calculation_method", "POWER_BASED"),
				resource.TestCheckResourceAttr(resourceName, "query_definition.0.report_query.0.emission_type", "LOCATION_BASED"),
				...
				resource.TestCheckResourceAttrSet(resourceName, "query_definition.0.report_query.0.tenant_id"),
				resource.TestCheckResourceAttr(resourceName, "query_definition.0.report_query.0.time_usage_ended", "2024-07-01T00:00:00Z"),
				resource.TestCheckResourceAttr(resourceName, "query_definition.0.report_query.0.time_usage_started", "2024-06-01T00:00:00Z"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				//resource.TestCheckResourceAttr(singularDatasourceName, "query_definition.0.report_query.0.date_range_name", "LAST_THREE_MONTHS"),
				resource.TestCheckResourceAttr(singularDatasourceName, "query_definition.0.report_query.0.emission_calculation_method", "POWER_BASED"),
				resource.TestCheckResourceAttr(singularDatasourceName, "query_definition.0.report_query.0.emission_type", "LOCATION_BASED"),
				resource.TestCheckResourceAttr(singularDatasourceName, "query_definition.0.report_query.0.granularity", "DAILY"),
