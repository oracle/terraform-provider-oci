...
var (
	...
	FleetAppsManagementRunbookRepresentation = map[string]interface{}{
		...
		// TODO FIXAPP from @Suprita
		// "is_sudo_access_needed": acctest.Representation{RepType: acctest.Optional, Create: `false`, Update: `true`},
		"is_sudo_access_needed": acctest.Representation{RepType: acctest.Optional, Create: `false`},
		"os_type":               acctest.Representation{RepType: acctest.Required, Create: `LINUX`, Update: `WINDOWS`},
		"platform":              acctest.Representation{RepType: acctest.Required, Create: `Oracle Linux`},
	}
	...
	acctest.ResourceTest(t, testAccCheckFleetAppsManagementRunbookDestroy, []resource.TestStep{
		// verify Create
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				// resource.TestCheckResourceAttrSet(resourceName, "runbook_version.0.execution_workflow_details.0.workflow.0.steps.0.group_name"),
				...
				//resource.TestCheckResourceAttr(resourceName, "runbook_version.0.tasks.0.step_name", "Patch_Oracle_Exadata_Database_Service"),
				...
				// resource.TestCheckResourceAttrSet(resourceName, "runbook_version.0.tasks.0.task_record_details.0.execution_details.0.catalog_id"),
				// resource.TestCheckResourceAttr(resourceName, "runbook_version.0.tasks.0.task_record_details.0.execution_details.0.endpoint", "endpoint"),
				...
				// resource.TestCheckResourceAttrSet(resourceName, "runbook_version.0.tasks.0.task_record_details.0.execution_details.0.target_compartment_id"),
				//resource.TestCheckResourceAttr(resourceName, "runbook_version.0.tasks.0.task_record_details.0.scope", "SHARED"),
		...
		// verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttrSet(resourceName, "runbook_version.0.tasks.0.task_record_details.0.execution_details.0.variables.#"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttrSet(singularDatasourceName, "runbook_version.0.tasks.0.task_record_details.0.execution_details.0.variables.#"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "is_sudo_access_needed", "false"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "platform", "Oracle Linux"),
