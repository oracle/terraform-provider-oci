		...
		Steps: []resource.TestStep{
			// verify datasource
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(datasourceName, "db_nodes.0.system_tags.%"),
					resource.TestCheckResourceAttrSet(datasourceName, "db_nodes.0.system_tags.orcl-resource-hierarchy.service_name"),
				),
			},
			// verify singular datasource
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(singularDatasourceName, "system_tags.orcl-resource-hierarchy.service_name"),
				),
			},
		},
	})
