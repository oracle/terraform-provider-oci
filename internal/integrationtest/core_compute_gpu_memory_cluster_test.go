...
var (
	...
	CoreComputeGpuMemoryClusterRepresentation = map[string]interface{}{
		...
		"private_ip_ids":                  acctest.Representation{RepType: acctest.Optional, Create: []string{`${var.private_ip_ids[0]}`, `${var.private_ip_ids[1]}`, `${var.private_ip_ids[2]}`, `${var.private_ip_ids[3]}`, `${var.private_ip_ids[4]}`}, Update: []string{`${var.private_ip_ids[0]}`, `${var.private_ip_ids[1]}`, `${var.private_ip_ids[2]}`, `${var.private_ip_ids[3]}`, `${var.private_ip_ids[4]}`}},
	...
	CoreComputeGpuMemoryClusterGpuMemoryClusterScaleConfigRepresentation = map[string]interface{}{
		...
		"target_size":         acctest.Representation{RepType: acctest.Optional, Create: `1`, Update: `2`},
	}
	...
	GpuMemoryClusterInstanceConfigurationInstanceDetailsLaunchDetailsRepresentation = acctest.RepresentationCopyWithRemovedNestedProperties(
...
func TestCoreComputeGpuMemoryClusterResource_basic(t *testing.T) {
	...
	privateIpIds := utils.GetEnvSettingWithDefault("private_ip_ids", "[]")
	privateIpIdsVariableStr := fmt.Sprintf("variable \"private_ip_ids\" {\n  type = list(string)\n  default = %s\n}\n", privateIpIds)
	...
	acctest.SaveConfigContent(
	...
	acctest.ResourceTest(t, testAccCheckCoreComputeGpuMemoryClusterDestroy, []resource.TestStep{
		// verify Create
		{
			Config: config + compartmentIdVariableStr + gpuMemoryClusterSizeVariableStr + imageIdVariableStr + computeGpuMemoryFabricIdVariableStr + privateIpIdsVariableStr + computeHostGroupIdVariableStr + instanceConfigurationIdVariableStr + CoreComputeGpuMemoryClusterResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_core_compute_gpu_memory_cluster", "test_compute_gpu_memory_cluster", acctest.Required, acctest.Create, CoreComputeGpuMemoryClusterRepresentation),
		...
		// verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "gpu_memory_cluster_scale_config.0.target_size", "1"),
				resource.TestCheckResourceAttrSet(resourceName, "gpu_memory_fabric_id"),
				resource.TestCheckResourceAttrSet(resourceName, "id"),
				resource.TestCheckResourceAttrSet(resourceName, "instance_configuration_id"),
				resource.TestCheckResourceAttr(resourceName, "size", "1"),
				resource.TestCheckResourceAttr(resourceName, "private_ip_ids.#", "5"),
		...
		{
			Config: config + compartmentIdVariableStr + compartmentIdUVariableStr + gpuMemoryClusterSizeVariableStr + imageIdVariableStr + computeGpuMemoryFabricIdVariableStr + privateIpIdsVariableStr + computeHostGroupIdVariableStr + instanceConfigurationIdVariableStr + CoreComputeGpuMemoryClusterResourceDependencies +
		...
		// verify datasource
		{
			Config: config +
				...
				compartmentIdVariableStr + gpuMemoryClusterSizeVariableStr + imageIdVariableStr + computeGpuMemoryFabricIdVariableStr + privateIpIdsVariableStr + computeHostGroupIdVariableStr + instanceConfigurationIdVariableStr + CoreComputeGpuMemoryClusterResourceDependencies +
				acctest.GenerateResourceFromRepresentationMap("oci_core_compute_gpu_memory_cluster", "test_compute_gpu_memory_cluster", acctest.Optional, acctest.Update, CoreComputeGpuMemoryClusterRepresentation),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
		...
		// verify singular datasource
		{
			Config: config +
				...
				compartmentIdVariableStr + gpuMemoryClusterSizeVariableStr + imageIdVariableStr + computeGpuMemoryFabricIdVariableStr + privateIpIdsVariableStr + computeHostGroupIdVariableStr + instanceConfigurationIdVariableStr + CoreComputeGpuMemoryClusterResourceConfig,
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "gpu_memory_cluster_scale_config.0.target_size", "2"),
				resource.TestCheckResourceAttrSet(singularDatasourceName, "id"),
				resource.TestCheckResourceAttr(singularDatasourceName, "size", "2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "private_ip_ids.#", "5"),
