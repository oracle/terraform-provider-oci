...
func TestLoadBalancerLoadBalancerShapeResource_basic(t *testing.T) {
	...
	acctest.ResourceTest(t, nil, []resource.TestStep{
		...
		{
			Config: config +
				acctest.GenerateDataSourceFromRepresentationMap("oci_load_balancer_shapes", "test_load_balancer_shapes", acctest.Required, acctest.Create, loadBalancerShapeDataSourceRepresentation) +
