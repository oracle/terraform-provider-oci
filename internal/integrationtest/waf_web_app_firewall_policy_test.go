...
var (
	...
	webAppFirewallPolicyRequestProtectionRepresentation = map[string]interface{}{
		"body_inspection_size_limit_exceeded_action_name": acctest.Representation{RepType: acctest.Optional, Create: `bodyInspectionSizeLimitExceededActionName`, Update: `bodyInspectionSizeLimitExceededActionName2`},
	...
	acctest.ResourceTest(t, testAccCheckWafWebAppFirewallPolicyDestroy, []resource.TestStep{
		...
		// verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.body_inspection_size_limit_exceeded_action_name", "bodyInspectionSizeLimitExceededActionName"),
...
>>>>>>> theirs
		...
		// verify updates to updatable parameters
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "request_protection.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "request_protection.0.body_inspection_size_limit_exceeded_action_name", "bodyInspectionSizeLimitExceededActionName2"),
...
<<<<<<< ours
				resource.TestCheckResourceAttr(resourceName, "response_access_control.0.rules.0.type", "PROTECTION"),
				resource.TestCheckResourceAttr(resourceName, "response_protection.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "response_protection.0.rules.#", "1"),
...
>>>>>>> theirs
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "request_protection.0.body_inspection_size_limit_exceeded_action_name", "bodyInspectionSizeLimitExceededActionName2"),
...
<<<<<<< ours
				resource.TestCheckResourceAttr(singularDatasourceName, "response_access_control.0.rules.0.type", "PROTECTION"),
