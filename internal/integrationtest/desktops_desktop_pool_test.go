...
var (
	...
	DesktopsDesktopPoolRepresentation = map[string]interface{}{
		...
		"security_attributes":       acctest.Representation{RepType: acctest.Optional, Create: map[string]string{"osd.desktop.value": "A", "osd.desktop.mode": "enforce"}, Update: map[string]string{"osd.desktop.value": "B", "osd.desktop.mode": "enforce"}},
	...
	DesktopsDesktopPoolNetworkConfigurationRepresentation = map[string]interface{}{
		...
		"security_attributes": acctest.Representation{RepType: acctest.Optional, Create: map[string]string{"osd.service.value": "A", "osd.service.mode": "enforce"}, Update: map[string]string{"osd.service.value": "B", "osd.service.mode": "enforce"}},
	}
	...
	DesktopsDesktopPoolPrivateAccessDetailsRepresentation = map[string]interface{}{
		...
		"security_attributes": acctest.Representation{RepType: acctest.Optional, Create: map[string]string{"osd.endpoint.value": "A", "osd.endpoint.mode": "enforce"}, Update: map[string]string{"osd.endpoint.value": "B", "osd.endpoint.mode": "enforce"}},
	}
	...
	acctest.ResourceTest(t, testAccCheckDesktopsDesktopPoolDestroy, []resource.TestStep{
		...
		// verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "maximum_size", "10"),
				resource.TestCheckResourceAttr(resourceName, "network_configuration.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "network_configuration.0.security_attributes.%", "2"),
				resource.TestCheckResourceAttr(resourceName, "network_configuration.0.security_attributes.osd.service.value", "A"),
				resource.TestCheckResourceAttr(resourceName, "network_configuration.0.security_attributes.osd.service.mode", "enforce"),
				resource.TestCheckResourceAttrSet(resourceName, "network_configuration.0.subnet_id"),
				resource.TestCheckResourceAttrSet(resourceName, "network_configuration.0.vcn_id"),
				...
				resource.TestCheckResourceAttr(resourceName, "private_access_details.0.security_attributes.%", "2"),
				resource.TestCheckResourceAttr(resourceName, "private_access_details.0.security_attributes.osd.endpoint.value", "A"),
				resource.TestCheckResourceAttr(resourceName, "private_access_details.0.security_attributes.osd.endpoint.mode", "enforce"),
				...
				resource.TestCheckResourceAttr(resourceName, "security_attributes.osd.desktop.value", "A"),
				resource.TestCheckResourceAttr(resourceName, "security_attributes.osd.desktop.mode", "enforce"),
		...
		// verify updates to updatable parameters
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "network_configuration.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "network_configuration.0.security_attributes.%", "2"),
				resource.TestCheckResourceAttr(resourceName, "network_configuration.0.security_attributes.osd.service.value", "B"),
				resource.TestCheckResourceAttr(resourceName, "network_configuration.0.security_attributes.osd.service.mode", "enforce"),
				resource.TestCheckResourceAttrSet(resourceName, "network_configuration.0.subnet_id"),
				resource.TestCheckResourceAttrSet(resourceName, "network_configuration.0.vcn_id"),
				resource.TestCheckResourceAttr(resourceName, "private_access_details.#", "1"),
				resource.TestCheckResourceAttrSet(resourceName, "private_access_details.0.private_ip"),
				resource.TestCheckResourceAttr(resourceName, "private_access_details.0.security_attributes.%", "2"),
				resource.TestCheckResourceAttr(resourceName, "private_access_details.0.security_attributes.osd.endpoint.value", "B"),
				resource.TestCheckResourceAttr(resourceName, "private_access_details.0.security_attributes.osd.endpoint.mode", "enforce"),
				resource.TestCheckResourceAttrSet(resourceName, "private_access_details.0.subnet_id"),
				resource.TestCheckResourceAttrSet(resourceName, "private_access_details.0.vcn_id"),
				resource.TestCheckResourceAttr(resourceName, "security_attributes.%", "2"),
				resource.TestCheckResourceAttr(resourceName, "security_attributes.osd.desktop.value", "B"),
				resource.TestCheckResourceAttr(resourceName, "security_attributes.osd.desktop.mode", "enforce"),
				resource.TestCheckResourceAttr(resourceName, "shape_config.#", "1"),
				resource.TestCheckResourceAttrSet(resourceName, "shape_config.0.baseline_ocpu_utilization"),
				resource.TestCheckResourceAttrSet(resourceName, "shape_config.0.memory_in_gbs"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "network_configuration.0.security_attributes.%", "2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "network_configuration.0.security_attributes.osd.service.value", "B"),
				resource.TestCheckResourceAttr(singularDatasourceName, "network_configuration.0.security_attributes.osd.service.mode", "enforce"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "private_access_details.0.security_attributes.%", "2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "private_access_details.0.security_attributes.osd.endpoint.value", "B"),
				resource.TestCheckResourceAttr(singularDatasourceName, "private_access_details.0.security_attributes.osd.endpoint.mode", "enforce"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "security_attributes.osd.desktop.value", "B"),
				resource.TestCheckResourceAttr(singularDatasourceName, "security_attributes.osd.desktop.mode", "enforce"),
