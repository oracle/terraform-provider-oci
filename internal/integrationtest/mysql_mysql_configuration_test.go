...
var (
	...
	MysqlMysqlConfigurationVariablesRepresentation = map[string]interface{}{
		...
		"block_encryption_mode":                       acctest.Representation{RepType: acctest.Optional, Create: `aes-128-ecb`},
		"character_set_server":                        acctest.Representation{RepType: acctest.Optional, Create: `ARMSCII8`},
		"collation_server":                            acctest.Representation{RepType: acctest.Optional, Create: `ARMSCII8_GENERAL_CI`},
		...
		"group_replication_consistency":               acctest.Representation{RepType: acctest.Optional, Create: `EVENTUAL`},
		"information_schema_stats_expiry":             acctest.Representation{RepType: acctest.Optional, Create: `10`},
		"innodb_adaptive_hash_index":                  acctest.Representation{RepType: acctest.Optional, Create: `true`},
		"innodb_autoinc_lock_mode":                    acctest.Representation{RepType: acctest.Optional, Create: `2`},
		...
		"innodb_change_buffering":                     acctest.Representation{RepType: acctest.Optional, Create: `NONE`},
		...
		"innodb_numa_interleave":                      acctest.Representation{RepType: acctest.Optional, Create: `false`},
		"innodb_online_alter_log_max_size":            acctest.Representation{RepType: acctest.Optional, Create: `134217728`},
		"innodb_redo_log_capacity":                    acctest.Representation{RepType: acctest.Optional, Create: `104857600`},
		"innodb_rollback_on_timeout":                  acctest.Representation{RepType: acctest.Optional, Create: `false`},
		"innodb_sort_buffer_size":                     acctest.Representation{RepType: acctest.Optional, Create: `1048576`},
		...
		"innodb_strict_mode":                          acctest.Representation{RepType: acctest.Optional, Create: `false`},
		"innodb_undo_log_truncate":                    acctest.Representation{RepType: acctest.Optional, Create: `true`},
		"interactive_timeout":                         acctest.Representation{RepType: acctest.Optional, Create: `10`},
		"join_buffer_size":                            acctest.Representation{RepType: acctest.Optional, Create: `262144`},
		"local_infile":                                acctest.Representation{RepType: acctest.Optional, Create: `true`},
		"long_query_time":                             acctest.Representation{RepType: acctest.Optional, Create: `10`},
		...
		"replica_net_timeout":                         acctest.Representation{RepType: acctest.Optional, Create: `60`},
		"replica_parallel_workers":                    acctest.Representation{RepType: acctest.Optional, Create: `10`},
		"replica_type_conversions":                    acctest.Representation{RepType: acctest.Optional, Create: `ALL_LOSSY`},
		"require_secure_transport":                    acctest.Representation{RepType: acctest.Optional, Create: `false`},
		...
		"table_open_cache":                            acctest.Representation{RepType: acctest.Optional, Create: `4000`},
		"temptable_max_ram":                           acctest.Representation{RepType: acctest.Optional, Create: `1073741824`},
		...
		"thread_pool_query_threads_per_group":         acctest.Representation{RepType: acctest.Optional, Create: `10`},
		"thread_pool_size":                            acctest.Representation{RepType: acctest.Optional, Create: `16`},
		"thread_pool_transaction_delay":               acctest.Representation{RepType: acctest.Optional, Create: `10`},
	...
	acctest.ResourceTest(t, testAccCheckMysqlMysqlConfigurationDestroy, []resource.TestStep{
		...
		// verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "variables.0.auto_increment_increment", "10"),
				...
				resource.TestCheckResourceAttr(resourceName, "variables.0.block_encryption_mode", "aes-128-ecb"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.character_set_server", "ARMSCII8"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.collation_server", "ARMSCII8_GENERAL_CI"),
				...
				resource.TestCheckResourceAttr(resourceName, "variables.0.group_replication_consistency", "EVENTUAL"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.information_schema_stats_expiry", "10"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.innodb_adaptive_hash_index", "true"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.innodb_autoinc_lock_mode", "2"),
				...
				resource.TestCheckResourceAttr(resourceName, "variables.0.innodb_change_buffering", "NONE"),
				...
				resource.TestCheckResourceAttr(resourceName, "variables.0.innodb_numa_interleave", "false"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.innodb_online_alter_log_max_size", "134217728"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.innodb_redo_log_capacity", "104857600"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.innodb_rollback_on_timeout", "false"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.innodb_sort_buffer_size", "1048576"),
				...
				resource.TestCheckResourceAttr(resourceName, "variables.0.innodb_strict_mode", "false"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.innodb_undo_log_truncate", "true"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.interactive_timeout", "10"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.join_buffer_size", "262144"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.local_infile", "true"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.long_query_time", "10"),
				...
				resource.TestCheckResourceAttr(resourceName, "variables.0.replica_net_timeout", "60"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.replica_parallel_workers", "10"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.replica_type_conversions", "ALL_LOSSY"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.require_secure_transport", "false"),
				...
				resource.TestCheckResourceAttr(resourceName, "variables.0.table_open_cache", "4000"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.temptable_max_ram", "1073741824"),
				...
				resource.TestCheckResourceAttr(resourceName, "variables.0.thread_pool_query_threads_per_group", "10"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.thread_pool_size", "16"),
				resource.TestCheckResourceAttr(resourceName, "variables.0.thread_pool_transaction_delay", "10"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.auto_increment_increment", "0"),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.auto_increment_offset", "0"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.binlog_group_commit_sync_delay", "0"),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.binlog_group_commit_sync_no_delay_count", "0"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.block_encryption_mode", ""),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.character_set_server", ""),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.collation_server", ""),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.explain_format", ""),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.explicit_defaults_for_timestamp", "false"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.group_concat_max_len", ""),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.innodb_adaptive_hash_index", "false"),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.innodb_autoinc_lock_mode", "0"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.innodb_strict_mode", "false"),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.innodb_undo_log_truncate", "false"),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.interactive_timeout", "0"),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.join_buffer_size", ""),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.local_infile", "true"),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.long_query_time", "0"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.max_seeks_for_key", ""),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.max_user_connections", ""),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.optimizer_switch", ""),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.range_optimizer_max_mem_size", ""),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.regexp_time_limit", "0"),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.relay_log_space_limit", "8589934592"),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.replica_net_timeout", "0"),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.replica_parallel_workers", "12"),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.replica_type_conversions", ""),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.require_secure_transport", "false"),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.skip_name_resolve", "false"),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.sort_buffer_size", ""),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.sql_generate_invisible_primary_key", "false"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.table_definition_cache", "0"),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.table_open_cache", "0"),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.temptable_max_ram", "1073741824"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.thread_pool_query_threads_per_group", "0"),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.thread_pool_size", "8"),
				resource.TestCheckResourceAttr(singularDatasourceName, "variables.0.thread_pool_transaction_delay", "0"),
