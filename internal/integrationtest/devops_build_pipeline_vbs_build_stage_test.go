...
var (
	BuildPipelineBuildStageVbsRequiredOnlyResource = BuildPipelineBuildStageVbsResourceDependencies +
		acctest.GenerateResourceFromRepresentationMap("oci_devops_build_pipeline_stage", "test_build_pipeline_stage", acctest.Required, acctest.Create, buildPipelineBuildStageVbsRepresentation)

	BuildPipelineBuildStageVbsResourceConfig = BuildPipelineBuildStageVbsResourceDependencies +
		acctest.GenerateResourceFromRepresentationMap("oci_devops_build_pipeline_stage", "test_build_pipeline_stage", acctest.Optional, acctest.Update, buildPipelineBuildStageVbsRepresentation)

	buildPipelineBuildStageVbsSingularDataSourceRepresentation = map[string]interface{}{
	...
	buildPipelineBuildStageVbsDataSourceRepresentation = map[string]interface{}{
		...
		"filter":            acctest.RepresentationGroup{RepType: acctest.Required, Group: buildPipelineBuildStageVbsDataSourceFilterRepresentation}}
	buildPipelineBuildStageVbsDataSourceFilterRepresentation = map[string]interface{}{
	...
	buildPipelineBuildStageVbsRepresentation = map[string]interface{}{
		...
		"build_pipeline_stage_predecessor_collection": acctest.RepresentationGroup{RepType: acctest.Required, Group: buildPipelineBuildStageBuildPipelineStageVbsPredecessorCollectionRepresentation},
		...
		"build_source_collection":                     acctest.RepresentationGroup{RepType: acctest.Required, Group: buildPipelineStageVbsBuildSourceCollectionRepresentation},
	...
	buildPipelineBuildStageBuildPipelineStageVbsPredecessorCollectionRepresentation = map[string]interface{}{
		"items": acctest.RepresentationGroup{RepType: acctest.Required, Group: buildPipelineBuildStageVbsBuildPipelineStagePredecessorCollectionItemsRepresentation},
	}

	buildPipelineStageVbsBuildSourceCollectionRepresentation = map[string]interface{}{
		"items": acctest.RepresentationGroup{RepType: acctest.Required, Group: buildPipelineStageVbsBuildSourceCollectionItemsRepresentation},
	}

	buildPipelineBuildStageVbsBuildPipelineStagePredecessorCollectionItemsRepresentation = map[string]interface{}{
		"id": acctest.Representation{RepType: acctest.Required, Create: `${oci_devops_build_pipeline.test_build_pipeline.id}`},
	}

	vbsRepoUrl  = "https://vbs.org/dlcbld/docktest"
	vbsRepoUrl2 = "https://vbs.org/dlcbld/deliver-artifact-test"

	buildPipelineStageVbsBuildSourceCollectionItemsRepresentation = map[string]interface{}{
		"connection_type": acctest.Representation{RepType: acctest.Required, Create: `VBS`},
		...
		"repository_url":  acctest.Representation{RepType: acctest.Required, Create: vbsRepoUrl, Update: vbsRepoUrl2},
	}

	BuildPipelineBuildStageVbsResourceDependencies = acctest.GenerateResourceFromRepresentationMap("oci_devops_build_pipeline", "test_build_pipeline", acctest.Required, acctest.Create, DevopsBuildPipelineRepresentation) +
...
func TestDevopsBuildPipelineBuildStageVbsResource_basic(t *testing.T) {
	...
	acctest.SaveConfigContent(config+compartmentIdVariableStr+vbsAccessTokenVaultIdStr+BuildPipelineBuildStageVbsResourceDependencies+
		acctest.GenerateResourceFromRepresentationMap("oci_devops_build_pipeline_stage", "test_build_pipeline_stage", acctest.Optional, acctest.Create, buildPipelineBuildStageVbsRepresentation), "devops", "buildPipelineStage", t)

	conf := config + compartmentIdVariableStr + vbsAccessTokenVaultIdStr + BuildPipelineBuildStageVbsResourceDependencies +
		acctest.GenerateResourceFromRepresentationMap("oci_devops_build_pipeline_stage", "test_build_pipeline_stage", acctest.Optional, acctest.Create, buildPipelineBuildStageVbsRepresentation)
	print(conf)
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// verify create
			{
				Config: config + compartmentIdVariableStr + vbsAccessTokenVaultIdStr + BuildPipelineBuildStageVbsResourceDependencies +
					acctest.GenerateResourceFromRepresentationMap("oci_devops_build_pipeline_stage", "test_build_pipeline_stage", acctest.Required, acctest.Create, buildPipelineBuildStageVbsRepresentation),
				Check: acctest.ComposeAggregateTestCheckFuncWrapper(
					...
					resource.TestCheckResourceAttr(resourceName, "build_source_collection.0.items.0.connection_type", "VBS"),
					resource.TestCheckResourceAttr(resourceName, "build_source_collection.0.items.0.name", "primaryBuildSource"),
					resource.TestCheckResourceAttr(resourceName, "build_source_collection.0.items.0.repository_url", "https://vbs.org/dlcbld/docktest"),
			...
			// verify updates to updatable parameters
			{
				...
				Check: acctest.ComposeAggregateTestCheckFuncWrapper(
					...
					resource.TestCheckResourceAttr(resourceName, "build_source_collection.0.items.0.repository_url", "https://vbs.org/dlcbld/deliver-artifact-test"),
					resource.TestCheckResourceAttr(resourceName, "image", "OL7_X86_64_STANDARD_10"),
			...
			{
				Config: config +
					acctest.GenerateDataSourceFromRepresentationMap("oci_devops_build_pipeline_stages", "test_build_pipeline_stages", acctest.Optional, acctest.Update, buildPipelineBuildStageVbsDataSourceRepresentation) +
					compartmentIdVariableStr + vbsAccessTokenVaultIdStr + BuildPipelineBuildStageVbsResourceDependencies +
					acctest.GenerateResourceFromRepresentationMap("oci_devops_build_pipeline_stage", "test_build_pipeline_stage", acctest.Optional, acctest.Update, buildPipelineBuildStageVbsRepresentation),
				Check: acctest.ComposeAggregateTestCheckFuncWrapper(
			...
			{
				Config: config +
					acctest.GenerateDataSourceFromRepresentationMap("oci_devops_build_pipeline_stage", "test_build_pipeline_stage", acctest.Required, acctest.Create, buildPipelineBuildStageVbsSingularDataSourceRepresentation) +
					compartmentIdVariableStr + vbsAccessTokenVaultIdStr + BuildPipelineBuildStageVbsResourceConfig,
				Check: acctest.ComposeAggregateTestCheckFuncWrapper(
					...
					resource.TestCheckResourceAttr(singularDatasourceName, "build_source_collection.0.items.0.connection_type", "VBS"),
					resource.TestCheckResourceAttr(singularDatasourceName, "build_source_collection.0.items.0.name", "primaryBuildSource2"),
					resource.TestCheckResourceAttr(singularDatasourceName, "build_source_collection.0.items.0.repository_url", "https://vbs.org/dlcbld/deliver-artifact-test"),
