...
var (
	DataSafesecurityAssessmentFindingDataSourceRepresentation = map[string]interface{}{
		...
		// "references":                acctest.RepresentationGroup{RepType: acctest.Optional, Group: DataSafeSecurityAssessmentFindingReferencesRepresentation},
	...
	acctest.ResourceTest(t, nil, []resource.TestStep{
		// verify datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				//resource.TestCheckResourceAttrSet(datasourceName, "findings.0.assessment_id"),
				//resource.TestCheckResourceAttrSet(datasourceName, "findings.0.details"),
