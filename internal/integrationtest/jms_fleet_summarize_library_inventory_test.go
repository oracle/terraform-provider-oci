...
var (
	JmsFleetSummarizeLibraryInventoryFleetId           = utils.GetEnvSettingWithBlankDefault("fleet_ocid")
	JmsFleetSummarizeLibraryInventoryManagedInstanceId = utils.GetEnvSettingWithBlankDefault("managed_instance_ocid")

	JmsFleetSummarizeLibraryInventoryDataSourceRepresentation = map[string]interface{}{
		"fleet_id":            acctest.Representation{RepType: acctest.Required, Create: JmsFleetSummarizeLibraryInventoryFleetId},
		"application_id":      acctest.Representation{RepType: acctest.Optional, Create: `dummy-application-id`},
		"managed_instance_id": acctest.Representation{RepType: acctest.Optional, Create: JmsFleetSummarizeLibraryInventoryManagedInstanceId},
