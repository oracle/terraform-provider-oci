	...
	acctest.ResourceTest(t, testAccCheckContainerInstancesContainerInstanceDestroy, []resource.TestStep{
		...
		// verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "containers.0.freeform_tags.%", "1"),
				...
				//resource.TestCheckResourceAttr(resourceName, "vnics.0.freeform_tags.%", "1"),
		...
		// verify default create with multiple containers
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "containers.1.freeform_tags.%", "1"),
