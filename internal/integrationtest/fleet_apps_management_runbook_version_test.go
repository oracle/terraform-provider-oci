...
var (
	...
	FleetAppsManagementRunbookVersionTasksRepresentation = map[string]interface{}{
		...
		//"output_variable_mappings": acctest.RepresentationGroup{RepType: acctest.Optional, Group: FleetAppsManagementRunbookVersionTasksOutputVariableMappingsRepresentation},
	...
	FleetAppsManagementRunbookVersionTasksTaskRecordDetailsRepresentation = map[string]interface{}{
		...
		"is_copy_to_library_enabled": acctest.Representation{RepType: acctest.Optional, Create: `false`, Update: `true`},
		...
		// task_record_id is only used when scope is SHARED
	...
	FleetAppsManagementRunbookVersionTasksTaskRecordDetailsExecutionDetailsRepresentation = map[string]interface{}{
		//  execution_type API, SCRIPT, TERRAFORM
		"execution_type": acctest.Representation{RepType: acctest.Required, Create: `SCRIPT`},
		// command only of SCRIPT execution_type
		"command": acctest.Representation{RepType: acctest.Required, Create: `command`, Update: `command2`},
		// config_file & catalog_id of TERRAFORM type
		...
		// Next 2 are of TERRAFORM execution_type
...
func TestFleetAppsManagementRunbookVersionResource_basic(t *testing.T) {
	...
	testCatalogId := utils.GetEnvSettingWithBlankDefault("test_catalog_id")
	...
	acctest.ResourceTest(t, testAccCheckFleetAppsManagementRunbookVersionDestroy, []resource.TestStep{
		// verify Create
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "execution_workflow_details.0.workflow.0.steps.0.step_name", "stepName"),
		...
		// verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				//resource.TestCheckResourceAttrSet(resourceName, "execution_workflow_details.0.workflow.0.steps.0.group_name"),
				resource.TestCheckResourceAttr(resourceName, "execution_workflow_details.0.workflow.0.steps.0.step_name", "stepName"),
				//resource.TestCheckResourceAttr(resourceName, "execution_workflow_details.0.workflow.0.steps.0.steps.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "execution_workflow_details.0.workflow.0.steps.0.type", "TASK"),
				resource.TestCheckResourceAttr(resourceName, "execution_workflow_details.0.workflow.0.type", "PARALLEL_RESOURCE_GROUP"),
				resource.TestCheckResourceAttr(resourceName, "groups.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "groups.0.name", "Parallel_resource_group"),
				...
				//resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.pause_details.0.duration_in_minutes", "10"),
				...
				//resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.run_on.0.host", "host"),
				resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.run_on.0.kind", "SCHEDULED_INSTANCES"),
				//resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.run_on.0.previous_task_instance_details.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.0.output_variable_name", "outputVariableName"),
				//resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.0.step_name", "stepName"),
				//resource.TestCheckResourceAttrSet(resourceName, "groups.0.properties.0.run_on.0.previous_task_instance_details.0.resource_id"),
				//resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.run_on.0.previous_task_instance_details.0.resource_type", "resourceType"),
				resource.TestCheckResourceAttr(resourceName, "groups.0.type", "PARALLEL_RESOURCE_GROUP"),
				resource.TestCheckResourceAttrSet(resourceName, "id"),
				//resource.TestCheckResourceAttr(resourceName, "rollback_workflow_details.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "rollback_workflow_details.0.scope", "ACTION_GROUP"),
				//resource.TestCheckResourceAttr(resourceName, "rollback_workflow_details.0.workflow.#", "1"),
				//resource.TestCheckResourceAttrSet(resourceName, "rollback_workflow_details.0.workflow.0.group_name"),
				//resource.TestCheckResourceAttr(resourceName, "rollback_workflow_details.0.workflow.0.steps.#", "1"),
				//resource.TestCheckResourceAttrSet(resourceName, "rollback_workflow_details.0.workflow.0.steps.0.group_name"),
				//resource.TestCheckResourceAttr(resourceName, "rollback_workflow_details.0.workflow.0.steps.0.step_name", "stepName"),
				//resource.TestCheckResourceAttr(resourceName, "rollback_workflow_details.0.workflow.0.steps.0.steps.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "rollback_workflow_details.0.workflow.0.steps.0.type", "TASK"),
				//resource.TestCheckResourceAttr(resourceName, "rollback_workflow_details.0.workflow.0.type", "PARALLEL_RESOURCE_GROUP"),
				resource.TestCheckResourceAttrSet(resourceName, "runbook_id"),
				resource.TestCheckResourceAttr(resourceName, "tasks.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.output_variable_mappings.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.output_variable_mappings.0.name", "name"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.output_variable_mappings.0.output_variable_details.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.output_variable_mappings.0.output_variable_details.0.output_variable_name", "outputVariableName"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.output_variable_mappings.0.output_variable_details.0.step_name", "stepName"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.step_name", "stepName"),
				...
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.pause_details.0.duration_in_minutes", "10"),
				...
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.run_on.0.host", "host"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.run_on.0.kind", "SCHEDULED_INSTANCES"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.run_on.0.previous_task_instance_details.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.0.output_variable_name", "outputVariableName"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.0.step_name", "stepName"),
				//resource.TestCheckResourceAttrSet(resourceName, "tasks.0.step_properties.0.run_on.0.previous_task_instance_details.0.resource_id"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.run_on.0.previous_task_instance_details.0.resource_type", "resourceType"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.description", "description"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.#", "1"),
				//resource.TestCheckResourceAttrSet(resourceName, "tasks.0.task_record_details.0.execution_details.0.catalog_id"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.command", "command"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.config_file", "configFile"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.content.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.content.0.bucket", "bucket"),
				//resource.TestCheckResourceAttrSet(resourceName, "tasks.0.task_record_details.0.execution_details.0.content.0.catalog_id"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.content.0.checksum", "checksum"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.content.0.namespace", "namespace"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.content.0.object", "object"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.content.0.source_type", "OBJECT_STORAGE_BUCKET"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.credentials.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.credentials.0.display_name", credsDisplayName),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.credentials.0.id", credsId),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.endpoint", "endpoint"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.execution_type", "SCRIPT"),
		...
		// verify updates to updatable parameters
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.pause_details.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.pause_details.0.duration_in_minutes", "11"),
				resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.pause_details.0.kind", "USER_ACTION"),
				...
				//resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.run_on.0.host", "host2"),
				resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.run_on.0.kind", "SCHEDULED_INSTANCES"),
				//resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.run_on.0.previous_task_instance_details.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.0.output_variable_name", "outputVariableName2"),
				//resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.0.step_name", "stepName2"),
				//resource.TestCheckResourceAttrSet(resourceName, "groups.0.properties.0.run_on.0.previous_task_instance_details.0.resource_id"),
				//resource.TestCheckResourceAttr(resourceName, "groups.0.properties.0.run_on.0.previous_task_instance_details.0.resource_type", "resourceType2"),
				resource.TestCheckResourceAttr(resourceName, "groups.0.type", "PARALLEL_RESOURCE_GROUP"),
				resource.TestCheckResourceAttrSet(resourceName, "id"),
				//resource.TestCheckResourceAttr(resourceName, "rollback_workflow_details.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "rollback_workflow_details.0.scope", "TARGET"),
				//resource.TestCheckResourceAttr(resourceName, "rollback_workflow_details.0.workflow.#", "1"),
				//resource.TestCheckResourceAttrSet(resourceName, "rollback_workflow_details.0.workflow.0.group_name"),
				//resource.TestCheckResourceAttr(resourceName, "rollback_workflow_details.0.workflow.0.steps.#", "1"),
				//resource.TestCheckResourceAttrSet(resourceName, "rollback_workflow_details.0.workflow.0.steps.0.group_name"),
				//resource.TestCheckResourceAttr(resourceName, "rollback_workflow_details.0.workflow.0.steps.0.step_name", "stepName2"),
				//resource.TestCheckResourceAttr(resourceName, "rollback_workflow_details.0.workflow.0.steps.0.steps.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "rollback_workflow_details.0.workflow.0.steps.0.type", "PARALLEL_TASK_GROUP"),
				//resource.TestCheckResourceAttr(resourceName, "rollback_workflow_details.0.workflow.0.type", "ROLLING_RESOURCE_GROUP"),
				resource.TestCheckResourceAttrSet(resourceName, "runbook_id"),
				resource.TestCheckResourceAttr(resourceName, "tasks.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.output_variable_mappings.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.output_variable_mappings.0.name", "name2"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.output_variable_mappings.0.output_variable_details.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.output_variable_mappings.0.output_variable_details.0.output_variable_name", "outputVariableName2"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.output_variable_mappings.0.output_variable_details.0.step_name", "stepName2"),
				...
				resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.pause_details.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.pause_details.0.duration_in_minutes", "11"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.pause_details.0.kind", "USER_ACTION"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.pre_condition", "target.product.name == \"Oracle Weblogic Server\""),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.run_on.#", "1"),
				...
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.run_on.0.host", "host2"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.run_on.0.kind", "SCHEDULED_INSTANCES"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.run_on.0.previous_task_instance_details.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.0.output_variable_name", "outputVariableName2"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.0.step_name", "stepName2"),
				//resource.TestCheckResourceAttrSet(resourceName, "tasks.0.step_properties.0.run_on.0.previous_task_instance_details.0.resource_id"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.step_properties.0.run_on.0.previous_task_instance_details.0.resource_type", "resourceType2"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.description", "description2"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.#", "1"),
				//resource.TestCheckResourceAttrSet(resourceName, "tasks.0.task_record_details.0.execution_details.0.catalog_id"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.command", "command2"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.config_file", "configFile2"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.content.#", "1"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.content.0.bucket", "bucket2"),
				//resource.TestCheckResourceAttrSet(resourceName, "tasks.0.task_record_details.0.execution_details.0.content.0.catalog_id"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.content.0.checksum", "checksum2"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.content.0.namespace", "namespace2"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.content.0.object", "object2"),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.content.0.source_type", "CATALOG"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.credentials.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.credentials.0.display_name", credsDisplayName),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.credentials.0.id", credsId),
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.endpoint", "endpoint2"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.execution_type", "SCRIPT"),
				...
				//resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.is_read_output_variable_enabled", "true"),
				//resource.TestCheckResourceAttrSet(resourceName, "tasks.0.task_record_details.0.execution_details.0.target_compartment_id"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.variables.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.execution_details.0.variables.0.input_variables.#", "1"),
				...
				resource.TestCheckResourceAttr(resourceName, "tasks.0.task_record_details.0.is_copy_to_library_enabled", "true"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				//resource.TestCheckResourceAttr(singularDatasourceName, "execution_workflow_details.0.workflow.0.steps.0.steps.#", "1"),
				...
				//resource.TestCheckResourceAttr(singularDatasourceName, "groups.0.properties.0.pause_details.0.duration_in_minutes", "11"),
				...
				//resource.TestCheckResourceAttr(singularDatasourceName, "groups.0.properties.0.run_on.0.host", "host2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "groups.0.properties.0.run_on.0.kind", "SCHEDULED_INSTANCES"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "groups.0.properties.0.run_on.0.previous_task_instance_details.#", "1"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "groups.0.properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.#", "1"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "groups.0.properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.0.output_variable_name", "outputVariableName2"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "groups.0.properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.0.step_name", "stepName2"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "groups.0.properties.0.run_on.0.previous_task_instance_details.0.resource_type", "resourceType2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "groups.0.type", "PARALLEL_RESOURCE_GROUP"),
				resource.TestCheckResourceAttrSet(singularDatasourceName, "id"),
				resource.TestCheckResourceAttrSet(singularDatasourceName, "name"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "rollback_workflow_details.#", "1"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "rollback_workflow_details.0.scope", "TARGET"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "rollback_workflow_details.0.workflow.#", "1"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "rollback_workflow_details.0.workflow.0.steps.#", "1"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "rollback_workflow_details.0.workflow.0.steps.0.step_name", "stepName2"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "rollback_workflow_details.0.workflow.0.steps.0.steps.#", "1"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "rollback_workflow_details.0.workflow.0.steps.0.type", "PARALLEL_TASK_GROUP"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "rollback_workflow_details.0.workflow.0.type", "ROLLING_RESOURCE_GROUP"),
				resource.TestCheckResourceAttrSet(singularDatasourceName, "state"),
				resource.TestCheckResourceAttr(singularDatasourceName, "tasks.#", "1"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.output_variable_mappings.#", "1"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.output_variable_mappings.0.name", "name2"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.output_variable_mappings.0.output_variable_details.#", "1"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.output_variable_mappings.0.output_variable_details.0.output_variable_name", "outputVariableName2"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.output_variable_mappings.0.output_variable_details.0.step_name", "stepName2"),
				...
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.step_properties.0.pause_details.0.duration_in_minutes", "11"),
				...
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.step_properties.0.run_on.0.host", "host2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.step_properties.0.run_on.0.kind", "SCHEDULED_INSTANCES"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.step_properties.0.run_on.0.previous_task_instance_details.#", "1"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.step_properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.#", "1"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.step_properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.0.output_variable_name", "outputVariableName2"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.step_properties.0.run_on.0.previous_task_instance_details.0.output_variable_details.0.step_name", "stepName2"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.step_properties.0.run_on.0.previous_task_instance_details.0.resource_type", "resourceType2"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.task_record_details.0.execution_details.0.command", "command2"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.task_record_details.0.execution_details.0.config_file", "configFile2"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.task_record_details.0.execution_details.0.content.#", "1"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.task_record_details.0.execution_details.0.content.0.bucket", "bucket2"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.task_record_details.0.execution_details.0.content.0.checksum", "checksum2"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.task_record_details.0.execution_details.0.content.0.namespace", "namespace2"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.task_record_details.0.execution_details.0.content.0.object", "object2"),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.task_record_details.0.execution_details.0.content.0.source_type", "CATALOG"),
				resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.task_record_details.0.execution_details.0.credentials.#", "1"),
				resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.task_record_details.0.execution_details.0.credentials.0.display_name", credsDisplayName),
				resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.task_record_details.0.execution_details.0.credentials.0.id", credsId),
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.task_record_details.0.execution_details.0.endpoint", "endpoint2"),
				...
				//resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.task_record_details.0.execution_details.0.is_read_output_variable_enabled", "true"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "tasks.0.task_record_details.0.is_copy_to_library_enabled", "true"),
