...
var (
	...
	DatabaseAutonomousVmClusterRepresentation = map[string]interface{}{
		...
		"cpu_core_count_per_node":               acctest.Representation{RepType: acctest.Required, Create: `40`, Update: `80`},
		...
		"memory_per_oracle_compute_unit_in_gbs": acctest.Representation{RepType: acctest.Required, Create: `3`},
		"total_container_databases":             acctest.Representation{RepType: acctest.Required, Create: `2`, Update: `3`},
	}
	...
	DatabaseOCPUAutonomousVmClusterRepresentation = acctest.RepresentationCopyWithNewProperties(DatabaseAutonomousVmClusterRepresentation, map[string]interface{}{
		...
		"memory_per_oracle_compute_unit_in_gbs": acctest.Representation{RepType: acctest.Required, Create: `8`},
	})
	...
	acctest.ResourceTest(t, testAccCheckDatabaseAutonomousVmClusterDestroy, []resource.TestStep{
		...
		// verify updates to updatable parameters
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "compartment_id", compartmentId),
				//resource.TestCheckResourceAttr(resourceName, "compute_model", "OCPU"),
				resource.TestCheckResourceAttr(resourceName, "cpu_core_count_per_node", "80"),
				resource.TestCheckResourceAttr(resourceName, "db_servers.#", "2"),
				resource.TestCheckResourceAttr(resourceName, "display_name", "autonomousVmCluster"),
				resource.TestCheckResourceAttrSet(resourceName, "exadata_infrastructure_id"),
				resource.TestCheckResourceAttr(resourceName, "freeform_tags.%", "1"),
		...
		// verify datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(datasourceName, "autonomous_vm_clusters.0.cpu_core_count_per_node", "80"),
				...
				resource.TestCheckResourceAttr(datasourceName, "autonomous_vm_clusters.0.memory_per_oracle_compute_unit_in_gbs", "3"),
				...
				resource.TestCheckResourceAttr(datasourceName, "autonomous_vm_clusters.0.total_container_databases", "3"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				//resource.TestCheckResourceAttr(singularDatasourceName, "compute_model", "OCPU"),
				resource.TestCheckResourceAttr(singularDatasourceName, "cpu_core_count_per_node", "80"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "total_container_databases", "3"),
			),
		},
