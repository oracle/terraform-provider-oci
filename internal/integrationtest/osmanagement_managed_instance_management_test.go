...
var (
	OsmanagementManagedInstanceManagementRequiredOnlyResource = OsmanagementManagedInstanceGroupResourceDependencies +
	...
	OsmanagementManagedInstanceManagementResourceConfig = OsmanagementManagedInstanceGroupResourceDependencies +
	...
	OsmanagementManagedInstanceManagementRepresentation = map[string]interface{}{
	...
	osmanagementSoftwareSourceRepresentation = acctest.GenerateResourceFromRepresentationMap("oci_osmanagement_software_source", "test_parent_software_source", acctest.Required, acctest.Create, acctest.GetMultipleUpdatedRepresenationCopy([]string{"arch_type", "display_name"},
		...
		}, OsmanagementSoftwareSourceRepresentation)) +
		acctest.GenerateResourceFromRepresentationMap("oci_osmanagement_software_source", "test_child_software_source", acctest.Required, acctest.Create, acctest.RepresentationCopyWithNewProperties(acctest.GetMultipleUpdatedRepresenationCopy([]string{"arch_type", "display_name"},
			...
			})) + acctest.GenerateResourceFromRepresentationMap("oci_osmanagement_managed_instance_group", "test_managed_instance_group", acctest.Required, acctest.Create, acctest.GetUpdatedRepresentationCopy("display_name", acctest.Representation{RepType: acctest.Required, Create: groupDisplayName}, OsmanagementManagedInstanceGroupRepresentation))

	ManagedInstanceManagementResourceDependencies = acctest.GenerateResourceFromRepresentationMap("oci_core_instance", "test_instance", acctest.Required, acctest.Create, acctest.RepresentationCopyWithNewProperties(CoreInstanceRepresentation, map[string]interface{}{
...
func TestOsmanagementManagedInstanceManagementResource_basic(t *testing.T) {
	...
	acctest.SaveConfigContent(config+compartmentIdVariableStr+ManagedInstanceManagementResourceDependencies+
		acctest.GenerateResourceFromRepresentationMap("oci_osmanagement_managed_instance_management", "test_managed_instance_management", acctest.Required, acctest.Create, OsmanagementManagedInstanceManagementRepresentation), "osmanagement", "managedInstanceManagement", t)
	...
	acctest.ResourceTest(t, nil, []resource.TestStep{
		...
		{
			Config: config + compartmentIdVariableStr + ManagedInstanceManagementResourceDependencies + osmanagementSoftwareSourceRepresentation +
				acctest.GenerateResourceFromRepresentationMap("oci_osmanagement_managed_instance_management", "test_managed_instance_management", acctest.Optional, acctest.Create, OsmanagementManagedInstanceManagementRepresentation),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				resource.TestCheckResourceAttrSet(resourceName, "managed_instance_id"),
			),
		},
		...
		{
			Config: config + compartmentIdVariableStr + ManagedInstanceManagementResourceDependencies + osmanagementSoftwareSourceRepresentation +
				acctest.GenerateResourceFromRepresentationMap("oci_osmanagement_managed_instance_management", "test_managed_instance_management", acctest.Optional, acctest.Create, acctest.RepresentationCopyWithNewProperties(OsmanagementManagedInstanceManagementRepresentation, map[string]interface{}{
