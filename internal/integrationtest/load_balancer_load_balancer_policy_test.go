...
func TestLoadBalancerLoadBalancerPolicyResource_basic(t *testing.T) {
	...
	acctest.ResourceTest(t, nil, []resource.TestStep{
		...
		{
			Config: config +
				acctest.GenerateDataSourceFromRepresentationMap("oci_load_balancer_policies", "test_load_balancer_policies", acctest.Required, acctest.Create, loadBalancerPolicyDataSourceRepresentation) +
