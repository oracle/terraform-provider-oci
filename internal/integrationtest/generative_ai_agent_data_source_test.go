...
var (
	GenerativeAiAgentDataSourceRequiredOnlyResource = acctest.GenerateResourceFromRepresentationMap("oci_generative_ai_agent_data_source", "test_data_source", acctest.Required, acctest.Create, GenerativeAiAgentDataSourceRepresentation)

	GenerativeAiAgentDataSourceResourceConfig = acctest.GenerateResourceFromRepresentationMap("oci_generative_ai_agent_data_source", "test_data_source", acctest.Optional, acctest.Update, GenerativeAiAgentDataSourceRepresentation)
	...
	GenerativeAiAgentDataSourceDataSourceRepresentation = map[string]interface{}{
		...
		"display_name":      acctest.Representation{RepType: acctest.Optional, Create: `datasource display name`, Update: `displayName2`},
		"knowledge_base_id": acctest.Representation{RepType: acctest.Optional, Create: `${var.knowledge_base_id}`},
	...
	GenerativeAiAgentDataSourceRepresentation = map[string]interface{}{
		...
		"description":   acctest.Representation{RepType: acctest.Optional, Create: `datasource description`, Update: `description2`},
		"display_name":  acctest.Representation{RepType: acctest.Optional, Create: `datasource display name`, Update: `displayName2`},
	...
	GenerativeAiAgentDataSourceDataSourceConfigRepresentation = map[string]interface{}{
		...
		"should_enable_multi_modality": acctest.Representation{RepType: acctest.Optional, Create: `false`},
	}
	GenerativeAiAgentDataSourceDataSourceConfigObjectStoragePrefixesRepresentation = map[string]interface{}{
		"bucket":    acctest.Representation{RepType: acctest.Required, Create: `rashi_test_bucket`},
		"namespace": acctest.Representation{RepType: acctest.Required, Create: `axk4z7krhqfx`},
		"prefix":    acctest.Representation{RepType: acctest.Optional, Create: `policy1.pdf`},
	}
)
...
func TestGenerativeAiAgentDataSourceResource_basic(t *testing.T) {
	...
	acctest.ResourceTest(t, testAccCheckGenerativeAiAgentDataSourceDestroy, []resource.TestStep{
		// verify Create
		{
			Config: config + compartmentIdVariableStr + knowledgeBaseIdVariableStr +
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "knowledge_base_id", knowledgeBaseId),
		...
		// verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "data_source_config.0.object_storage_prefixes.0.bucket", "rashi_test_bucket"),
				resource.TestCheckResourceAttr(resourceName, "data_source_config.0.object_storage_prefixes.0.namespace", "axk4z7krhqfx"),
				resource.TestCheckResourceAttr(resourceName, "data_source_config.0.object_storage_prefixes.0.prefix", "policy1.pdf"),
				resource.TestCheckResourceAttr(resourceName, "data_source_config.0.should_enable_multi_modality", "false"),
				resource.TestCheckResourceAttr(resourceName, "description", "datasource description"),
				resource.TestCheckResourceAttr(resourceName, "display_name", "datasource display name"),
		...
		// verify datasource
		{
			Config: config +
				...
				compartmentIdVariableStr + knowledgeBaseIdVariableStr +
				acctest.GenerateResourceFromRepresentationMap("oci_generative_ai_agent_data_source", "test_data_source", acctest.Optional, acctest.Update, GenerativeAiAgentDataSourceRepresentation),
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
		...
		// verify singular datasource
		{
			Config: config +
				...
				compartmentIdVariableStr + knowledgeBaseIdVariableStr + GenerativeAiAgentDataSourceResourceConfig,
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "data_source_config.0.object_storage_prefixes.0.namespace", "axk4z7krhqfx"),
				resource.TestCheckResourceAttr(resourceName, "data_source_config.0.object_storage_prefixes.0.prefix", "policy1.pdf"),
				resource.TestCheckResourceAttr(singularDatasourceName, "data_source_config.0.should_enable_multi_modality", "false"),
		...
		{
			Config:                  config + knowledgeBaseIdVariableStr + GenerativeAiAgentDataSourceRequiredOnlyResource,
			ImportState:             true,
