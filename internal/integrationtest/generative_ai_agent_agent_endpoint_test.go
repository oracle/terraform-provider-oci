...
var (
	...
	GenerativeAiAgentAgentEndpointDataSourceRepresentation = map[string]interface{}{
		...
		"display_name":   acctest.Representation{RepType: acctest.Optional, Create: `terraform-test-EP`, Update: `terraform-test-EP-updated`},
	...
	GenerativeAiAgentAgentEndpointRepresentation = map[string]interface{}{
		...
		"description":            acctest.Representation{RepType: acctest.Optional, Create: `description`, Update: `description updated for test`},
		"display_name":           acctest.Representation{RepType: acctest.Optional, Create: `terraform-test-EP`, Update: `terraform-test-EP-updated`},
	...
	acctest.ResourceTest(t, testAccCheckGenerativeAiAgentAgentEndpointDestroy, []resource.TestStep{
		...
		// verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "display_name", "terraform-test-EP"),
		...
		// verify updates to updatable parameters
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "description", "description updated for test"),
				resource.TestCheckResourceAttr(resourceName, "display_name", "terraform-test-EP-updated"),
				resource.TestCheckResourceAttr(resourceName, "freeform_tags.%", "1"),
				resource.TestCheckResourceAttrSet(resourceName, "id"),
				resource.TestCheckResourceAttr(resourceName, "session_config.#", "1"),
		...
		// verify datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(datasourceName, "display_name", "terraform-test-EP-updated"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "description", "description updated for test"),
				resource.TestCheckResourceAttr(singularDatasourceName, "display_name", "terraform-test-EP-updated"),
