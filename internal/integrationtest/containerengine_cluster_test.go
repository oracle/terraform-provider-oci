...
var (
	...
	ContainerengineClusterOptionsOpenIdConnectTokenAuthenticationConfigRepresentation = map[string]interface{}{
		...
		"configuration_file":              acctest.Representation{RepType: acctest.Optional, Create: `configurationFile`, Update: `configurationFile2`},
		...
		"issuer_url":                      acctest.Representation{RepType: acctest.Optional, Create: `issuerUrl`, Update: `issuerUrl2`},
	...
	acctest.ResourceTest(t, testAccCheckContainerengineClusterDestroy, []resource.TestStep{
		...
		//verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.configuration_file", "configurationFile"),
		...
		// verify updates to updatable parameters
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.ca_certificate", "caCertificate2"),
				resource.TestCheckResourceAttrSet(resourceName, "options.0.open_id_connect_token_authentication_config.0.client_id"),
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.configuration_file", "configurationFile2"),
				...
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.is_open_id_connect_auth_enabled", "true"),
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.issuer_url", "issuerUrl2"),
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.required_claims.#", "1"),
				...
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.signing_algorithms.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.username_claim", "usernameClaim2"),
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.username_prefix", "usernamePrefix2"),
				resource.TestCheckResourceAttr(resourceName, "options.0.persistent_volume_config.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "options.0.persistent_volume_config.0.freeform_tags.%", "1"),
				resource.TestCheckResourceAttr(resourceName, "options.0.service_lb_config.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "options.0.service_lb_config.0.freeform_tags.%", "1"),
		...
		// verify datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(datasourceName, "clusters.0.options.0.open_id_connect_token_authentication_config.0.configuration_file", "configurationFile2"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_token_authentication_config.0.ca_certificate", "caCertificate2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_token_authentication_config.0.configuration_file", "configurationFile2"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_token_authentication_config.0.issuer_url", "issuerUrl2"),
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_token_authentication_config.0.username_claim", "usernameClaim2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_token_authentication_config.0.username_prefix", "usernamePrefix2"),
