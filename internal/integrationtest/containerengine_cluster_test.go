...
var (
	...
	ContainerengineClusterOptionsOpenIdConnectTokenAuthenticationConfigRepresentation = map[string]interface{}{
		"is_open_id_connect_auth_enabled": acctest.Representation{RepType: acctest.Required, Create: `true`, Update: `true`},
		...
		"client_id":                       acctest.Representation{RepType: acctest.Optional, Create: `6779ef20e75817b79602`},
		"groups_claim":                    acctest.Representation{RepType: acctest.Optional, Create: `groupsClaim`, Update: `groupsClaim2`},
		"groups_prefix":                   acctest.Representation{RepType: acctest.Optional, Create: `groupsPrefix`, Update: `groupsPrefix2`},
		"issuer_url":                      acctest.Representation{RepType: acctest.Optional, Create: `https://url1.com`, Update: `https://url2.com`},
		...
		"username_claim":                  acctest.Representation{RepType: acctest.Optional, Create: `sub`, Update: `sub2`},
		"username_prefix":                 acctest.Representation{RepType: acctest.Optional, Create: `oidc:`, Update: `oidc2:`},
	}
	...
	acctest.ResourceTest(t, testAccCheckContainerengineClusterDestroy, []resource.TestStep{
		...
		//verify Create with optionals
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.username_claim", "sub"),
				...
				resource.TestCheckResourceAttr(resourceName, "open_id_connect_discovery_endpoint.#", "0"),
		...
		// verify updates to updatable parameters
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.ca_certificate", ""),
				resource.TestCheckResourceAttrSet(resourceName, "options.0.open_id_connect_token_authentication_config.0.client_id"),
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.groups_claim", "groupsClaim2"),
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.groups_prefix", "groupsPrefix2"),
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.is_open_id_connect_auth_enabled", "true"),
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.issuer_url", "https://url2.com"),
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.required_claims.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.required_claims.0.key", "key2"),
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.required_claims.0.value", "value2"),
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.signing_algorithms.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.username_claim", "sub2"),
				resource.TestCheckResourceAttr(resourceName, "options.0.open_id_connect_token_authentication_config.0.username_prefix", "oidc2:"),
				resource.TestCheckResourceAttr(resourceName, "options.0.persistent_volume_config.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "options.0.persistent_volume_config.0.freeform_tags.%", "1"),
				resource.TestCheckResourceAttr(resourceName, "options.0.service_lb_config.#", "1"),
				resource.TestCheckResourceAttr(resourceName, "options.0.service_lb_config.0.backend_nsg_ids.#", "1"),
		...
		// verify datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(datasourceName, "clusters.0.options.0.open_id_connect_token_authentication_config.0.ca_certificate", ""),
				...
				resource.TestCheckResourceAttr(datasourceName, "clusters.0.options.0.open_id_connect_token_authentication_config.0.issuer_url", "https://url2.com"),
				...
				resource.TestCheckResourceAttr(datasourceName, "clusters.0.options.0.open_id_connect_token_authentication_config.0.username_claim", "sub2"),
				resource.TestCheckResourceAttr(datasourceName, "clusters.0.options.0.open_id_connect_token_authentication_config.0.username_prefix", "oidc2:"),
				resource.TestCheckResourceAttr(resourceName, "options.0.admission_controller_options.0.is_pod_security_policy_enabled", "false"),
		...
		// verify singular datasource
		{
			...
			Check: acctest.ComposeAggregateTestCheckFuncWrapper(
				...
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_discovery.#", "1"),
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_discovery.0.is_open_id_connect_discovery_enabled", "true"),
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_token_authentication_config.#", "1"),
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_token_authentication_config.0.ca_certificate", ""),
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_token_authentication_config.0.groups_claim", "groupsClaim2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_token_authentication_config.0.groups_prefix", "groupsPrefix2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_token_authentication_config.0.is_open_id_connect_auth_enabled", "true"),
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_token_authentication_config.0.issuer_url", "https://url2.com"),
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_token_authentication_config.0.required_claims.#", "1"),
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_token_authentication_config.0.required_claims.0.key", "key2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_token_authentication_config.0.required_claims.0.value", "value2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_token_authentication_config.0.signing_algorithms.#", "1"),
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_token_authentication_config.0.username_claim", "sub2"),
				resource.TestCheckResourceAttr(singularDatasourceName, "options.0.open_id_connect_token_authentication_config.0.username_prefix", "oidc2:"),
