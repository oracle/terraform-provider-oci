...
func init() {
	...
	RegisterDatasource("oci_cloud_guard_data_source", tf_cloud_guard.CloudGuardDataSourceDataSource())
	RegisterDatasource("oci_cloud_guard_data_source_event", tf_cloud_guard.CloudGuardDataSourceEventDataSource())
	RegisterDatasource("oci_cloud_guard_data_source_events", tf_cloud_guard.CloudGuardDataSourceEventsDataSource())
	RegisterDatasource("oci_cloud_guard_data_sources", tf_cloud_guard.CloudGuardDataSourcesDataSource())
	...
	RegisterDatasource("oci_cloud_guard_problem_entities", tf_cloud_guard.CloudGuardProblemEntitiesDataSource())
	RegisterDatasource("oci_cloud_guard_problem_entity", tf_cloud_guard.CloudGuardProblemEntityDataSource())
	RegisterDatasource("oci_cloud_guard_responder_recipe", tf_cloud_guard.CloudGuardResponderRecipeDataSource())
	RegisterDatasource("oci_cloud_guard_security_policy", tf_cloud_guard.CloudGuardSecurityPolicyDataSource())
	RegisterDatasource("oci_cloud_guard_security_recipe", tf_cloud_guard.CloudGuardSecurityRecipeDataSource())
	RegisterDatasource("oci_cloud_guard_security_zone", tf_cloud_guard.CloudGuardSecurityZoneDataSource())
	...
	RegisterDatasource("oci_cloud_guard_security_policies", tf_cloud_guard.CloudGuardSecurityPoliciesDataSource())
	RegisterDatasource("oci_cloud_guard_security_recipes", tf_cloud_guard.CloudGuardSecurityRecipesDataSource())
	RegisterDatasource("oci_cloud_guard_security_zones", tf_cloud_guard.CloudGuardSecurityZonesDataSource())
	...
	RegisterDatasource("oci_data_safe_alert_policies", tf_data_safe.DataSafeAlertPoliciesDataSource())
	...
	RegisterDatasource("oci_data_safe_alert_policy_rules", tf_data_safe.DataSafeAlertPolicyRulesDataSource())
	RegisterDatasource("oci_data_safe_alerts", tf_data_safe.DataSafeAlertsDataSource())
	RegisterDatasource("oci_data_safe_audit_archive_retrieval", tf_data_safe.DataSafeAuditArchiveRetrievalDataSource())
	RegisterDatasource("oci_data_safe_audit_archive_retrievals", tf_data_safe.DataSafeAuditArchiveRetrievalsDataSource())
	...
	RegisterDatasource("oci_data_safe_audit_events", tf_data_safe.DataSafeAuditEventsDataSource())
	RegisterDatasource("oci_data_safe_audit_policies", tf_data_safe.DataSafeAuditPoliciesDataSource())
	...
	RegisterDatasource("oci_data_safe_audit_profile_available_audit_volumes", tf_data_safe.DataSafeAuditProfileAvailableAuditVolumesDataSource())
	...
	RegisterDatasource("oci_data_safe_audit_profile_collected_audit_volumes", tf_data_safe.DataSafeAuditProfileCollectedAuditVolumesDataSource())
	RegisterDatasource("oci_data_safe_audit_profiles", tf_data_safe.DataSafeAuditProfilesDataSource())
	...
	RegisterDatasource("oci_data_safe_audit_trails", tf_data_safe.DataSafeAuditTrailsDataSource())
	...
	RegisterDatasource("oci_data_safe_discovery_analytics", tf_data_safe.DataSafeDiscoveryAnalyticsDataSource())
	RegisterDatasource("oci_data_safe_discovery_job", tf_data_safe.DataSafeDiscoveryJobDataSource())
	RegisterDatasource("oci_data_safe_discovery_jobs", tf_data_safe.DataSafeDiscoveryJobsDataSource())
	RegisterDatasource("oci_data_safe_discovery_jobs_result", tf_data_safe.DataSafeDiscoveryJobsResultDataSource())
	RegisterDatasource("oci_data_safe_discovery_jobs_results", tf_data_safe.DataSafeDiscoveryJobsResultsDataSource())
	RegisterDatasource("oci_data_safe_library_masking_format", tf_data_safe.DataSafeLibraryMaskingFormatDataSource())
	RegisterDatasource("oci_data_safe_library_masking_formats", tf_data_safe.DataSafeLibraryMaskingFormatsDataSource())
	...
	RegisterDatasource("oci_data_safe_masking_analytics", tf_data_safe.DataSafeMaskingAnalyticsDataSource())
	RegisterDatasource("oci_data_safe_masking_policies", tf_data_safe.DataSafeMaskingPoliciesDataSource())
	...
	RegisterDatasource("oci_data_safe_masking_policies_masking_columns", tf_data_safe.DataSafeMaskingPoliciesMaskingColumnsDataSource())
	...
	RegisterDatasource("oci_data_safe_masking_reports", tf_data_safe.DataSafeMaskingReportsDataSource())
	RegisterDatasource("oci_data_safe_masking_reports_masked_column", tf_data_safe.DataSafeMaskingReportsMaskedColumnDataSource())
	RegisterDatasource("oci_data_safe_masking_reports_masked_columns", tf_data_safe.DataSafeMaskingReportsMaskedColumnsDataSource())
	...
	RegisterDatasource("oci_data_safe_report_definitions", tf_data_safe.DataSafeReportDefinitionsDataSource())
	RegisterDatasource("oci_data_safe_reports", tf_data_safe.DataSafeReportsDataSource())
	RegisterDatasource("oci_data_safe_security_assessment_finding", tf_data_safe.DataSafeSecurityAssessmentFindingsDataSource())
	...
	RegisterDatasource("oci_data_safe_sensitive_data_models", tf_data_safe.DataSafeSensitiveDataModelsDataSource())
	...
	RegisterDatasource("oci_data_safe_sensitive_data_models_sensitive_columns", tf_data_safe.DataSafeSensitiveDataModelsSensitiveColumnsDataSource())
	RegisterDatasource("oci_data_safe_sensitive_type", tf_data_safe.DataSafeSensitiveTypeDataSource())
	RegisterDatasource("oci_data_safe_sensitive_types", tf_data_safe.DataSafeSensitiveTypesDataSource())
	...
	RegisterDatasource("oci_data_safe_target_alert_policy_associations", tf_data_safe.DataSafeTargetAlertPolicyAssociationsDataSource())
	RegisterDatasource("oci_data_safe_target_database", tf_data_safe.DataSafeTargetDatabaseDataSource())
	RegisterDatasource("oci_data_safe_target_database_roles", tf_data_safe.DataSafeTargetDatabaseRolesDataSource())
	RegisterDatasource("oci_data_safe_target_databases", tf_data_safe.DataSafeTargetDatabasesDataSource())
	RegisterDatasource("oci_data_safe_target_databases_columns", tf_data_safe.DataSafeTargetDatabasesColumnsDataSource())
	RegisterDatasource("oci_data_safe_target_databases_schemas", tf_data_safe.DataSafeTargetDatabasesSchemasDataSource())
	RegisterDatasource("oci_data_safe_target_databases_tables", tf_data_safe.DataSafeTargetDatabasesTablesDataSource())
	...
	RegisterDatasource("oci_data_safe_alert_policy", tf_data_safe.DataSafeAlertPolicyDataSource())
	RegisterDatasource("oci_data_safe_alert", tf_data_safe.DataSafeAlertDataSource())
	RegisterDatasource("oci_data_safe_target_database_role", tf_data_safe.DataSafeTargetDatabaseRolesDataSource())
	// database service
	...
	RegisterDatasource("oci_database_management_managed_database_addm_task", tf_database_management.DatabaseManagementManagedDatabaseAddmTaskDataSource())
	RegisterDatasource("oci_database_management_managed_database_addm_tasks", tf_database_management.DatabaseManagementManagedDatabaseAddmTasksDataSource())
	RegisterDatasource("oci_database_management_managed_database_alert_log_count", tf_database_management.DatabaseManagementManagedDatabaseAlertLogCountDataSource())
	RegisterDatasource("oci_database_management_managed_database_alert_log_counts", tf_database_management.DatabaseManagementManagedDatabaseAlertLogCountsDataSource())
	RegisterDatasource("oci_database_management_managed_database_attention_log_count", tf_database_management.DatabaseManagementManagedDatabaseAttentionLogCountDataSource())
	...
	RegisterDatasource("oci_database_management_managed_database_preferred_credential", tf_database_management.DatabaseManagementManagedDatabasePreferredCredentialDataSource())
	RegisterDatasource("oci_database_management_managed_database_preferred_credentials", tf_database_management.DatabaseManagementManagedDatabasePreferredCredentialsDataSource())
	...
	RegisterDatasource("oci_database_management_managed_databases_asm_properties", tf_database_management.DatabaseManagementManagedDatabasesAsmPropertiesDataSource())
	...
	RegisterDatasource("oci_devops_repo_file_line", tf_devops.DevopsRepoFileLineDataSource())
