...
func (s *DatascienceNotebookSessionResourceCrud) updateCompartment(ctx context.Context, compartment interface{}) error {
	...
	_, err := s.Client.ChangeNotebookSessionCompartment(ctx, changeCompartmentRequest)
	if err != nil {
		return err
	}
