...
func RegisterResource() {
	tfresource.RegisterResource("oci_datascience_compute_target", DatascienceComputeTargetResource())
	...
	tfresource.RegisterResource("oci_datascience_model_group", DatascienceModelGroupResource())
	tfresource.RegisterResource("oci_datascience_model_group_artifact", DatascienceModelGroupArtifactResource())
	tfresource.RegisterResource("oci_datascience_model_group_version_history", DatascienceModelGroupVersionHistoryResource())
