...
func TenantmanagercontrolplaneSubscriptionsDataSource() *schema.Resource {
	return &schema.Resource{
		Read: readTenantmanagercontrolplaneSubscriptions,
...
func readTenantmanagercontrolplaneSubscriptions(d *schema.ResourceData, m interface{}) error {
	sync := &TenantmanagercontrolplaneSubscriptionsDataSourceCrud{}
	sync.D = d
...
type TenantmanagercontrolplaneSubscriptionsDataSourceCrud struct {
	D      *schema.ResourceData
	Client *oci_tenantmanagercontrolplane.SubscriptionClient
	Res    *oci_tenantmanagercontrolplane.ListSubscriptionsResponse
}

func (s *TenantmanagercontrolplaneSubscriptionsDataSourceCrud) VoidState() {
	s.D.SetId("")
}

func (s *TenantmanagercontrolplaneSubscriptionsDataSourceCrud) Get() error {
	request := oci_tenantmanagercontrolplane.ListSubscriptionsRequest{}
	...
	if entityVersion, ok := s.D.GetOkExists("entity_version"); ok {
		request.EntityVersion = oci_tenantmanagercontrolplane.ListSubscriptionsEntityVersionEnum(entityVersion.(string))
	}
...
func (s *TenantmanagercontrolplaneSubscriptionsDataSourceCrud) SetData() error {
	if s.Res == nil {
		return nil
	}

	s.D.SetId(tfresource.GenerateDataSourceHashID("TenantmanagercontrolplaneSubscriptionsDataSource-", TenantmanagercontrolplaneSubscriptionsDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = tfresource.ApplyFiltersInCollection(f.(*schema.Set), items, TenantmanagercontrolplaneSubscriptionsDataSource().Schema["subscription_collection"].Elem.(*schema.Resource).Schema)
		subscription["items"] = items
	}
...
func PromotionToMap(obj oci_tenantmanagercontrolplane.Promotion) map[string]interface{} {
...
func SubscriptionSkuToMap(obj oci_tenantmanagercontrolplane.SubscriptionSku) map[string]interface{} {
	result := map[string]interface{}{}
...
func SubscriptionSummaryToMap(obj oci_tenantmanagercontrolplane.SubscriptionSummary) map[string]interface{} {
	result := map[string]interface{}{}
	switch v := (obj).(type) {
	case oci_tenantmanagercontrolplane.ClassicSubscriptionSummary:
		...
		if v.PaymentModel != nil {
			result["payment_model"] = string(*v.PaymentModel)
		}
	...
	case oci_tenantmanagercontrolplane.CloudSubscriptionSummary:
