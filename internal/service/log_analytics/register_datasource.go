...
func RegisterDatasource() {
	...
	tfresource.RegisterDatasource("oci_log_analytics_log_analytics_entity_associations_list", LogAnalyticsLogAnalyticsEntityAssociationsListDataSource())
	...
	tfresource.RegisterDatasource("oci_log_analytics_namespace_field_usage", LogAnalyticsNamespaceFieldUsageDataSource())
	...
	tfresource.RegisterDatasource("oci_log_analytics_namespace_lookup", LogAnalyticsNamespaceLookupDataSource())
	tfresource.RegisterDatasource("oci_log_analytics_namespace_parser_actions", LogAnalyticsNamespaceParserActionsDataSource())
	...
	tfresource.RegisterDatasource("oci_log_analytics_namespace_storage_archival_config", LogAnalyticsNamespaceStorageArchivalConfigDataSource())
	...
	tfresource.RegisterDatasource("oci_log_analytics_namespace_template", LogAnalyticsNamespaceTemplateDataSource())
	tfresource.RegisterDatasource("oci_log_analytics_namespace_templates", LogAnalyticsNamespaceTemplatesDataSource())
