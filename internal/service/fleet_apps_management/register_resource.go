...
func RegisterResource() {
	tfresource.RegisterResource("oci_fleet_apps_management_catalog_item", FleetAppsManagementCatalogItemResource())
	...
	tfresource.RegisterResource("oci_fleet_apps_management_provision", FleetAppsManagementProvisionResource())
	tfresource.RegisterResource("oci_fleet_apps_management_runbook", FleetAppsManagementRunbookResource())
	tfresource.RegisterResource("oci_fleet_apps_management_runbook_version", FleetAppsManagementRunbookVersionResource())
