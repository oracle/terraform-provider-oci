...
func RegisterDatasource() {
	...
	tfresource.RegisterDatasource("oci_metering_computation_usage_statement_email_recipients_group", MeteringComputationUsageStatementEmailRecipientsGroupDataSource())
	tfresource.RegisterDatasource("oci_metering_computation_usage_statement_email_recipients_groups", MeteringComputationUsageStatementEmailRecipientsGroupsDataSource())
}
