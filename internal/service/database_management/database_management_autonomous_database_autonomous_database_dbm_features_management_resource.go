...
type DatabaseManagementAutonomousDatabaseAutonomousDatabaseDbmFeaturesManagementResponse struct {
	enableResponse  *oci_database_management.EnableAutonomousDatabaseManagementFeatureResponse
	disableResponse *oci_database_management.DisableAutonomousDatabaseManagementFeatureResponse
	modifyResponse  *oci_database_management.ModifyAutonomousDatabaseManagementFeatureResponse
}

type DatabaseManagementAutonomousDatabaseAutonomousDatabaseDbmFeaturesManagementResourceCrud struct {
	tfresource.BaseCrud
	Client                 *oci_database_management.DbManagementClient
	Res                    *DatabaseManagementAutonomousDatabaseAutonomousDatabaseDbmFeaturesManagementResponse
...
func (s *DatabaseManagementAutonomousDatabaseAutonomousDatabaseDbmFeaturesManagementResourceCrud) Create() error {
	...
	if operation {
		request := oci_database_management.EnableAutonomousDatabaseManagementFeatureRequest{}
		...
		if featureDetails, ok := s.D.GetOkExists("feature_details"); ok {
			if tmpList := featureDetails.([]interface{}); len(tmpList) > 0 {
				...
				tmp, err := s.mapToAutonomousDatabaseFeatureDetails(fieldKeyFormat)
				if err != nil {
					return err
				}
	...
	log.Printf("Starting disable from create")
	request := oci_database_management.DisableAutonomousDatabaseManagementFeatureRequest{}
...
func autonomousDatabaseAutonomousDatabaseDbmFeaturesManagementWorkRequestShouldRetryFunc(timeout time.Duration) func(response oci_common.OCIOperationResponse) bool {
	startTime := time.Now()
...
func (s *DatabaseManagementAutonomousDatabaseAutonomousDatabaseDbmFeaturesManagementResourceCrud) Update() error {
	...
	log.Printf("[WARN] Operation: %v", operation)
	if operation {
		request := oci_database_management.ModifyAutonomousDatabaseManagementFeatureRequest{}
	...
	log.Printf("[WARN] Starting disable from update")
	request := oci_database_management.DisableAutonomousDatabaseManagementFeatureRequest{}
...
func (s *DatabaseManagementAutonomousDatabaseAutonomousDatabaseDbmFeaturesManagementResourceCrud) Delete() error {
	...
	log.Printf("[WARN] Starting disable from disable")
	request := oci_database_management.DisableAutonomousDatabaseManagementFeatureRequest{}
...
func (s *DatabaseManagementAutonomousDatabaseAutonomousDatabaseDbmFeaturesManagementResourceCrud) mapToAutonomousDatabaseFeatureDetails(fieldKeyFormat string) (oci_database_management.AutonomousDatabaseFeatureDetails, error) {
	...
	case strings.ToLower("DIAGNOSTICS_AND_MANAGEMENT"):
		details := oci_database_management.AutonomousDatabaseDiagnosticsAndManagementFeatureDetails{}
	...
	case strings.ToLower("SQLWATCH"):
		details := oci_database_management.AutonomousDatabaseSqlWatchFeatureDetails{}
		baseObject = details
	default:
...
func AutonomousDatabaseFeatureDetailsToMap(obj *oci_database_management.AutonomousDatabaseFeatureDetails) map[string]interface{} {
	result := map[string]interface{}{}
	switch (*obj).(type) {
	case oci_database_management.AutonomousDatabaseDiagnosticsAndManagementFeatureDetails:
		result["feature"] = "DIAGNOSTICS_AND_MANAGEMENT"
	case oci_database_management.AutonomousDatabaseSqlWatchFeatureDetails:
