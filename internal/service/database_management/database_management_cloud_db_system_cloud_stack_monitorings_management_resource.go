...
type DatabaseManagementCloudDbSystemCloudStackMonitoringsManagementResponse struct {
	enableResponse  *oci_database_management.EnableCloudDbSystemStackMonitoringResponse
	disableResponse *oci_database_management.DisableCloudDbSystemStackMonitoringResponse
}

type DatabaseManagementCloudDbSystemCloudStackMonitoringsManagementResourceCrud struct {
	tfresource.BaseCrud
	Client                 *oci_database_management.DbManagementClient
	Res                    *DatabaseManagementCloudDbSystemCloudStackMonitoringsManagementResponse
	DisableNotFoundRetries bool
}

func (s *DatabaseManagementCloudDbSystemCloudStackMonitoringsManagementResourceCrud) ID() string {
...
func (s *DatabaseManagementCloudDbSystemCloudStackMonitoringsManagementResourceCrud) Create() error {
	...
	if operation {
		request := oci_database_management.EnableCloudDbSystemStackMonitoringRequest{}
	...
	request := oci_database_management.DisableCloudDbSystemStackMonitoringRequest{}
...
func cloudDbSystemCloudStackMonitoringsManagementWorkRequestShouldRetryFunc(timeout time.Duration) func(response oci_common.OCIOperationResponse) bool {
	startTime := time.Now()
...
func (s *DatabaseManagementCloudDbSystemCloudStackMonitoringsManagementResourceCrud) SetData() error {
	return nil
}
