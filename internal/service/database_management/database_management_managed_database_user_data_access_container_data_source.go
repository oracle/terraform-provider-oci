...
func (s *DatabaseManagementManagedDatabaseUserDataAccessContainerDataSourceCrud) SetData() error {
	...
	s.D.SetId(tfresource.GenerateDataSourceHashID("DatabaseManagementManagedDatabaseUserDataAccessContainerDataSource-", DatabaseManagementManagedDatabaseUserDataAccessContainerDataSource(), s.D))
