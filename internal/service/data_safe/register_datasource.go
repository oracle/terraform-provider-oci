...
func RegisterDatasource() {
	...
	tfresource.RegisterDatasource("oci_data_safe_attribute_set", DataSafeAttributeSetDataSource())
	tfresource.RegisterDatasource("oci_data_safe_attribute_set_associated_resources", DataSafeAttributeSetAssociatedResourcesDataSource())
	tfresource.RegisterDatasource("oci_data_safe_attribute_sets", DataSafeAttributeSetsDataSource())
	...
	tfresource.RegisterDatasource("oci_data_safe_audit_profile_target_overrides", DataSafeAuditProfileTargetOverridesDataSource())
	...
	tfresource.RegisterDatasource("oci_data_safe_crypto_assessment", DataSafeCryptoAssessmentDataSource())
	tfresource.RegisterDatasource("oci_data_safe_crypto_assessment_backup_sets", DataSafeCryptoAssessmentBackupSetsDataSource())
	tfresource.RegisterDatasource("oci_data_safe_crypto_assessment_cbom_items", DataSafeCryptoAssessmentCbomItemsDataSource())
	tfresource.RegisterDatasource("oci_data_safe_crypto_assessment_certificates", DataSafeCryptoAssessmentCertificatesDataSource())
	tfresource.RegisterDatasource("oci_data_safe_crypto_assessment_finding_analytics", DataSafeCryptoAssessmentFindingAnalyticsDataSource())
	tfresource.RegisterDatasource("oci_data_safe_crypto_assessment_finding_targets", DataSafeCryptoAssessmentFindingTargetsDataSource())
	tfresource.RegisterDatasource("oci_data_safe_crypto_assessment_findings", DataSafeCryptoAssessmentFindingsDataSource())
	tfresource.RegisterDatasource("oci_data_safe_crypto_assessment_keys", DataSafeCryptoAssessmentKeysDataSource())
	tfresource.RegisterDatasource("oci_data_safe_crypto_assessment_sqlnet_parameter", DataSafeCryptoAssessmentSqlnetParameterDataSource())
	tfresource.RegisterDatasource("oci_data_safe_crypto_assessment_tde_objects", DataSafeCryptoAssessmentTdeObjectsDataSource())
	tfresource.RegisterDatasource("oci_data_safe_crypto_assessment_wallets", DataSafeCryptoAssessmentWalletsDataSource())
	tfresource.RegisterDatasource("oci_data_safe_crypto_assessments", DataSafeCryptoAssessmentsDataSource())
	...
	tfresource.RegisterDatasource("oci_data_safe_masking_policy_referential_relations", DataSafeMaskingPolicyReferentialRelationsDataSource())
	tfresource.RegisterDatasource("oci_data_safe_masking_report", DataSafeMaskingReportDataSource())
	tfresource.RegisterDatasource("oci_data_safe_masking_report_masking_errors", DataSafeMaskingReportMaskingErrorsDataSource())
	...
	tfresource.RegisterDatasource("oci_data_safe_security_assessment_checks", DataSafeSecurityAssessmentChecksDataSource())
	...
	tfresource.RegisterDatasource("oci_data_safe_security_assessment_template_analytics", DataSafeSecurityAssessmentTemplateAnalyticsDataSource())
	tfresource.RegisterDatasource("oci_data_safe_security_assessment_template_association_analytics", DataSafeSecurityAssessmentTemplateAssociationAnalyticsDataSource())
	tfresource.RegisterDatasource("oci_data_safe_security_assessment_template_baseline_comparison", DataSafeSecurityAssessmentTemplateBaselineComparisonDataSource())
	...
	tfresource.RegisterDatasource("oci_data_safe_security_policy_config", DataSafeSecurityPolicyConfigDataSource())
	tfresource.RegisterDatasource("oci_data_safe_security_policy_configs", DataSafeSecurityPolicyConfigsDataSource())
	...
	tfresource.RegisterDatasource("oci_data_safe_sensitive_column_analytics", DataSafeSensitiveColumnAnalyticsDataSource())
	...
	tfresource.RegisterDatasource("oci_data_safe_sensitive_data_model_referential_relation", DataSafeSensitiveDataModelReferentialRelationDataSource())
	tfresource.RegisterDatasource("oci_data_safe_sensitive_data_model_referential_relations", DataSafeSensitiveDataModelReferentialRelationsDataSource())
	...
	tfresource.RegisterDatasource("oci_data_safe_sensitive_type_group", DataSafeSensitiveTypeGroupDataSource())
	tfresource.RegisterDatasource("oci_data_safe_sensitive_type_group_grouped_sensitive_types", DataSafeSensitiveTypeGroupGroupedSensitiveTypesDataSource())
	tfresource.RegisterDatasource("oci_data_safe_sensitive_type_groups", DataSafeSensitiveTypeGroupsDataSource())
	tfresource.RegisterDatasource("oci_data_safe_sensitive_types", DataSafeSensitiveTypesDataSource())
	tfresource.RegisterDatasource("oci_data_safe_sensitive_types_export", DataSafeSensitiveTypesExportDataSource())
	tfresource.RegisterDatasource("oci_data_safe_sensitive_types_exports", DataSafeSensitiveTypesExportsDataSource())
	...
	tfresource.RegisterDatasource("oci_data_safe_target_alert_policy_association_unassociated_target_members", DataSafeTargetAlertPolicyAssociationUnassociatedTargetMembersDataSource())
	...
	tfresource.RegisterDatasource("oci_data_safe_target_database_group", DataSafeTargetDatabaseGroupDataSource())
	tfresource.RegisterDatasource("oci_data_safe_target_database_group_group_member", DataSafeTargetDatabaseGroupGroupMemberDataSource())
	tfresource.RegisterDatasource("oci_data_safe_target_database_groups", DataSafeTargetDatabaseGroupsDataSource())
	...
	tfresource.RegisterDatasource("oci_data_safe_unified_audit_policies", DataSafeUnifiedAuditPoliciesDataSource())
	tfresource.RegisterDatasource("oci_data_safe_unified_audit_policy", DataSafeUnifiedAuditPolicyDataSource())
	tfresource.RegisterDatasource("oci_data_safe_unified_audit_policy_definition", DataSafeUnifiedAuditPolicyDefinitionDataSource())
	tfresource.RegisterDatasource("oci_data_safe_unified_audit_policy_definitions", DataSafeUnifiedAuditPolicyDefinitionsDataSource())
	...
	tfresource.RegisterDatasource("oci_data_safe_user_assessment_password_expiry_date_analytics", DataSafeUserAssessmentPasswordExpiryDateAnalyticsDataSource())
