...
func AiVisionVisionPrivateEndpointResource() *schema.Resource {
...
type AiVisionVisionPrivateEndpointResourceCrud struct {
	...
	Res                    *oci_ai_vision.VisionPrivateEndpoint
	DisableNotFoundRetries bool
}

func (s *AiVisionVisionPrivateEndpointResourceCrud) ID() string {
	return *s.Res.Id
}

func (s *AiVisionVisionPrivateEndpointResourceCrud) CreatedPending() []string {
	return []string{
		string(oci_ai_vision.VisionPrivateEndpointLifecycleStateCreating),
	}
}

func (s *AiVisionVisionPrivateEndpointResourceCrud) CreatedTarget() []string {
	return []string{
		string(oci_ai_vision.VisionPrivateEndpointLifecycleStateActive),
	}
}

func (s *AiVisionVisionPrivateEndpointResourceCrud) DeletedPending() []string {
	return []string{
		string(oci_ai_vision.VisionPrivateEndpointLifecycleStateDeleting),
	}
}

func (s *AiVisionVisionPrivateEndpointResourceCrud) DeletedTarget() []string {
	return []string{
		string(oci_ai_vision.VisionPrivateEndpointLifecycleStateDeleted),
	}
}
...
func (s *AiVisionVisionPrivateEndpointResourceCrud) Get() error {
	...
	s.Res = &response.VisionPrivateEndpoint
	return nil
}
...
func (s *AiVisionVisionPrivateEndpointResourceCrud) Update() error {
	...
	request := oci_ai_vision.UpdateVisionPrivateEndpointRequest{}
...
func (s *AiVisionVisionPrivateEndpointResourceCrud) SetData() error {
...
func VisionPrivateEndpointSummaryToMap(obj oci_ai_vision.VisionPrivateEndpointSummary) map[string]interface{} {
...
func (s *AiVisionVisionPrivateEndpointResourceCrud) updateCompartment(compartment interface{}) error {
	...
	idTmp := s.D.Id()
	changeCompartmentRequest.VisionPrivateEndpointId = &idTmp
