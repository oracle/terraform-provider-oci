...
func OsManagementHubSoftwareSourceRemovePackagesManagementResource() *schema.Resource {
...
type OsManagementHubSoftwareSourceRemovePackagesManagementResourceCrud struct {
	tfresource.BaseCrud
...
func (s *OsManagementHubSoftwareSourceRemovePackagesManagementResourceCrud) ID() string {
	return *s.Res.GetId()
}
...
func (s *OsManagementHubSoftwareSourceRemovePackagesManagementResourceCrud) SetData() error {
	return nil
}
