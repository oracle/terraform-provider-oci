...
func OsManagementHubManagedInstanceGroupRebootManagementResource() *schema.Resource {
...
type OsManagementHubManagedInstanceGroupRebootManagementResourceCrud struct {
	tfresource.BaseCrud
...
func (s *OsManagementHubManagedInstanceGroupRebootManagementResourceCrud) ID() string {
	return *s.Res.Id
}
...
func (s *OsManagementHubManagedInstanceGroupRebootManagementResourceCrud) SetData() error {
	return nil
}

func (s *OsManagementHubManagedInstanceGroupRebootManagementResourceCrud) mapToWorkRequestDetails(fieldKeyFormat string) (oci_os_management_hub.WorkRequestDetails, error) {
