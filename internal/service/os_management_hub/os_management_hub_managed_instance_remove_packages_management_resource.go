...
func OsManagementHubManagedInstanceRemovePackagesManagementResource() *schema.Resource {
...
type OsManagementHubManagedInstanceRemovePackagesManagementResourceCrud struct {
	tfresource.BaseCrud
...
func (s *OsManagementHubManagedInstanceRemovePackagesManagementResourceCrud) ID() string {
	return *s.Res.Id
}
...
func (s *OsManagementHubManagedInstanceRemovePackagesManagementResourceCrud) SetData() error {
	return nil
}

func (s *OsManagementHubManagedInstanceRemovePackagesManagementResourceCrud) mapToWorkRequestDetails(fieldKeyFormat string) (oci_os_management_hub.WorkRequestDetails, error) {
