...
func OsManagementHubLifecycleStageRebootManagementResource() *schema.Resource {
...
type OsManagementHubLifecycleStageRebootManagementResourceCrud struct {
	tfresource.BaseCrud
...
func (s *OsManagementHubLifecycleStageRebootManagementResourceCrud) ID() string {
	return *s.Res.Id
}
...
func (s *OsManagementHubLifecycleStageRebootManagementResourceCrud) SetData() error {
	return nil
}

func (s *OsManagementHubLifecycleStageRebootManagementResourceCrud) mapToWorkRequestDetails(fieldKeyFormat string) (oci_os_management_hub.WorkRequestDetails, error) {
