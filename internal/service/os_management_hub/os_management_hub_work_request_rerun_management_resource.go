...
func OsManagementHubWorkRequestRerunManagementResource() *schema.Resource {
...
type OsManagementHubWorkRequestRerunManagementResourceCrud struct {
	tfresource.BaseCrud
	Client                 *oci_os_management_hub.WorkRequestClient
	Res                    *string
	DisableNotFoundRetries bool
	WorkRequestClient      *oci_os_management_hub.WorkRequestClient
}

func (s *OsManagementHubWorkRequestRerunManagementResourceCrud) ID() string {
	return *s.Res
}
...
func workRequestRerunManagementWorkRequestShouldRetryFunc(timeout time.Duration) func(response oci_common.OCIOperationResponse) bool {
	startTime := time.Now()
...
func (s *OsManagementHubWorkRequestRerunManagementResourceCrud) SetData() error {
	s.D.Set("managed_instances", []interface{}{})
	s.D.Set("work_request_details", []interface{}{})
	return nil
}

func (s *OsManagementHubWorkRequestRerunManagementResourceCrud) mapToWorkRequestDetails(fieldKeyFormat string) (oci_os_management_hub.WorkRequestDetails, error) {
