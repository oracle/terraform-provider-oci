...
func OsManagementHubManagedInstanceRemoveSnapsManagementResource() *schema.Resource {
...
type OsManagementHubManagedInstanceRemoveSnapsManagementResourceCrud struct {
	tfresource.BaseCrud
...
func (s *OsManagementHubManagedInstanceRemoveSnapsManagementResourceCrud) ID() string {
	return *s.Res.Id
}
...
func (s *OsManagementHubManagedInstanceRemoveSnapsManagementResourceCrud) Create() error {
	...
	if snapDetails, ok := s.D.GetOkExists("snap_details"); ok {
		...
		tmp := make([]oci_os_management_hub.RemoveSnapDetails, len(interfaces))
		for i := range interfaces {
			stateDataIndex := i
			fieldKeyFormat := fmt.Sprintf("%s.%d.%%s", "snap_details", stateDataIndex)
			converted, err := s.mapToRemoveSnapDetails(fieldKeyFormat)
			if err != nil {
				return err
			}
			tmp[i] = converted
...
func (s *OsManagementHubManagedInstanceRemoveSnapsManagementResourceCrud) SetData() error {
	return nil
}

func (s *OsManagementHubManagedInstanceRemoveSnapsManagementResourceCrud) mapToRemoveSnapDetails(fieldKeyFormat string) (oci_os_management_hub.RemoveSnapDetails, error) {
...
func RemoveSnapDetailsToMap(obj *oci_os_management_hub.RemoveSnapDetails) map[string]interface{} {
...
func (s *OsManagementHubManagedInstanceRemoveSnapsManagementResourceCrud) mapToWorkRequestDetails(fieldKeyFormat string) (oci_os_management_hub.WorkRequestDetails, error) {
