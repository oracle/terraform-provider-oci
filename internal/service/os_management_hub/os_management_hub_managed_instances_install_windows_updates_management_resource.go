...
func OsManagementHubManagedInstancesInstallWindowsUpdatesManagementResource() *schema.Resource {
...
type OsManagementHubManagedInstancesInstallWindowsUpdatesManagementResourceCrud struct {
	tfresource.BaseCrud
...
func (s *OsManagementHubManagedInstancesInstallWindowsUpdatesManagementResourceCrud) ID() string {
	return *s.Res
}
...
func (s *OsManagementHubManagedInstancesInstallWindowsUpdatesManagementResourceCrud) getManagedInstancesInstallWindowsUpdatesManagementFromWorkRequest(workId *string, retryPolicy *oci_common.RetryPolicy,
	...
	// FIXME: Use compartmentId to set the resource ID
	s.D.SetId(*managedInstancesInstallWindowsUpdatesManagementId)

	return nil
}

func managedInstancesInstallWindowsUpdatesManagementWorkRequestShouldRetryFunc(timeout time.Duration) func(response oci_common.OCIOperationResponse) bool {
	startTime := time.Now()
...
func (s *OsManagementHubManagedInstancesInstallWindowsUpdatesManagementResourceCrud) SetData() error {
	return nil
}

func (s *OsManagementHubManagedInstancesInstallWindowsUpdatesManagementResourceCrud) mapToWorkRequestDetails(fieldKeyFormat string) (oci_os_management_hub.WorkRequestDetails, error) {
