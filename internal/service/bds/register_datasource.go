...
func RegisterDatasource() {
	...
	tfresource.RegisterDatasource("oci_bds_bds_instance_node_backup", BdsBdsInstanceNodeBackupDataSource())
	tfresource.RegisterDatasource("oci_bds_bds_instance_node_backup_configuration", BdsBdsInstanceNodeBackupConfigurationDataSource())
	tfresource.RegisterDatasource("oci_bds_bds_instance_node_backup_configurations", BdsBdsInstanceNodeBackupConfigurationsDataSource())
	tfresource.RegisterDatasource("oci_bds_bds_instance_node_backups", BdsBdsInstanceNodeBackupsDataSource())
	tfresource.RegisterDatasource("oci_bds_bds_instance_node_replace_configuration", BdsBdsInstanceNodeReplaceConfigurationDataSource())
	tfresource.RegisterDatasource("oci_bds_bds_instance_node_replace_configurations", BdsBdsInstanceNodeReplaceConfigurationsDataSource())
