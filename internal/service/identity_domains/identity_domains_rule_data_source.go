...
func IdentityDomainsRuleDataSource() *schema.Resource {
	...
	return tfresource.GetSingularDataSourceItemSchema(IdentityDomainsRuleResource(), fieldMap, readSingularIdentityDomainsRule)
}
...
type IdentityDomainsRuleDataSourceCrud struct {
	D      *schema.ResourceData
	Client *oci_identity_domains.IdentityDomainsClient
	Res    *oci_identity_domains.GetRuleResponse
}
