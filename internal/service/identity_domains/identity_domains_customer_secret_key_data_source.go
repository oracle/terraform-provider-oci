...
func IdentityDomainsCustomerSecretKeyDataSource() *schema.Resource {
	...
	fieldMap["customer_secret_key_id"] = &schema.Schema{
		Type:     schema.TypeString,
		Required: true,
	}
	...
	return tfresource.GetSingularDataSourceItemSchema(IdentityDomainsCustomerSecretKeyResource(), fieldMap, readSingularIdentityDomainsCustomerSecretKey)
}
...
type IdentityDomainsCustomerSecretKeyDataSourceCrud struct {
	D      *schema.ResourceData
	Client *oci_identity_domains.IdentityDomainsClient
	Res    *oci_identity_domains.GetCustomerSecretKeyResponse
}
...
func (s *IdentityDomainsCustomerSecretKeyDataSourceCrud) Get() error {
	...
	if customerSecretKeyId, ok := s.D.GetOkExists("customer_secret_key_id"); ok {
		tmp := customerSecretKeyId.(string)
