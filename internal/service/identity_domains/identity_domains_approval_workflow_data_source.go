...
func IdentityDomainsApprovalWorkflowDataSource() *schema.Resource {
	...
	fieldMap["approval_workflow_id"] = &schema.Schema{
	...
	return tfresource.GetSingularDataSourceItemSchema(IdentityDomainsApprovalWorkflowResource(), fieldMap, readSingularIdentityDomainsApprovalWorkflow)
}
...
type IdentityDomainsApprovalWorkflowDataSourceCrud struct {
	D      *schema.ResourceData
	Client *oci_identity_domains.IdentityDomainsClient
	Res    *oci_identity_domains.GetApprovalWorkflowResponse
}
...
func (s *IdentityDomainsApprovalWorkflowDataSourceCrud) Get() error {
	...
	if approvalWorkflowId, ok := s.D.GetOkExists("approval_workflow_id"); ok {
		tmp := approvalWorkflowId.(string)
