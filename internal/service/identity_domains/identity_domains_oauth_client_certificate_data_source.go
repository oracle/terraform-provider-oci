...
func IdentityDomainsOAuthClientCertificateDataSource() *schema.Resource {
	...
	fieldMap["o_auth_client_certificate_id"] = &schema.Schema{
		Type:     schema.TypeString,
		Required: true,
	}
	...
	return tfresource.GetSingularDataSourceItemSchema(IdentityDomainsOAuthClientCertificateResource(), fieldMap, readSingularIdentityDomainsOAuthClientCertificate)
}
...
type IdentityDomainsOAuthClientCertificateDataSourceCrud struct {
	D      *schema.ResourceData
	Client *oci_identity_domains.IdentityDomainsClient
	Res    *oci_identity_domains.GetOAuthClientCertificateResponse
}
...
func (s *IdentityDomainsOAuthClientCertificateDataSourceCrud) Get() error {
	...
	if oAuthClientCertificateId, ok := s.D.GetOkExists("o_auth_client_certificate_id"); ok {
		tmp := oAuthClientCertificateId.(string)
