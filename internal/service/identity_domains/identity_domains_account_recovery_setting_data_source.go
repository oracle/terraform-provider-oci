...
func IdentityDomainsAccountRecoverySettingDataSource() *schema.Resource {
	...
	fieldMap["account_recovery_setting_id"] = &schema.Schema{
	...
	return tfresource.GetSingularDataSourceItemSchema(IdentityDomainsAccountRecoverySettingResource(), fieldMap, readSingularIdentityDomainsAccountRecoverySetting)
}
...
type IdentityDomainsAccountRecoverySettingDataSourceCrud struct {
	D      *schema.ResourceData
	Client *oci_identity_domains.IdentityDomainsClient
	Res    *oci_identity_domains.GetAccountRecoverySettingResponse
}
