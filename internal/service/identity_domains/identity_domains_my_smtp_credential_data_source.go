...
func IdentityDomainsMySmtpCredentialDataSource() *schema.Resource {
	...
	fieldMap["my_smtp_credential_id"] = &schema.Schema{
		Type:     schema.TypeString,
		Required: true,
	}
	...
	return tfresource.GetSingularDataSourceItemSchema(IdentityDomainsMySmtpCredentialResource(), fieldMap, readSingularIdentityDomainsMySmtpCredential)
}
...
type IdentityDomainsMySmtpCredentialDataSourceCrud struct {
	D      *schema.ResourceData
	Client *oci_identity_domains.IdentityDomainsClient
	Res    *oci_identity_domains.GetMySmtpCredentialResponse
}
...
func (s *IdentityDomainsMySmtpCredentialDataSourceCrud) Get() error {
	...
	if mySmtpCredentialId, ok := s.D.GetOkExists("my_smtp_credential_id"); ok {
		tmp := mySmtpCredentialId.(string)
