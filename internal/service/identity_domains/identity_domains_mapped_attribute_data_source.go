...
func IdentityDomainsMappedAttributeDataSource() *schema.Resource {
	...
	fieldMap["mapped_attribute_id"] = &schema.Schema{
		Type:     schema.TypeString,
		Required: true,
	}
	...
	return tfresource.GetSingularDataSourceItemSchema(IdentityDomainsMappedAttributeResource(), fieldMap, readSingularIdentityDomainsMappedAttribute)
}

func readSingularIdentityDomainsMappedAttribute(d *schema.ResourceData, m interface{}) error {
	sync := &IdentityDomainsMappedAttributeDataSourceCrud{}
	sync.D = d
...
type IdentityDomainsMappedAttributeDataSourceCrud struct {
	D      *schema.ResourceData
	Client *oci_identity_domains.IdentityDomainsClient
	Res    *oci_identity_domains.GetMappedAttributeResponse
}

func (s *IdentityDomainsMappedAttributeDataSourceCrud) VoidState() {
	s.D.SetId("")
}

func (s *IdentityDomainsMappedAttributeDataSourceCrud) Get() error {
...
func (s *IdentityDomainsMappedAttributeDataSourceCrud) SetData() error {
	if s.Res == nil {
		return nil
	}
	...
	s.D.Set("attribute_mappings", attributeMappings)
