...
func IdentityDomainsOAuth2ClientCredentialDataSource() *schema.Resource {
	...
	fieldMap["o_auth2client_credential_id"] = &schema.Schema{
		Type:     schema.TypeString,
		Required: true,
	}
	...
	return tfresource.GetSingularDataSourceItemSchema(IdentityDomainsOAuth2ClientCredentialResource(), fieldMap, readSingularIdentityDomainsOAuth2ClientCredential)
}
...
type IdentityDomainsOAuth2ClientCredentialDataSourceCrud struct {
	D      *schema.ResourceData
	Client *oci_identity_domains.IdentityDomainsClient
	Res    *oci_identity_domains.GetOAuth2ClientCredentialResponse
}
...
func (s *IdentityDomainsOAuth2ClientCredentialDataSourceCrud) Get() error {
	...
	if oAuth2ClientCredentialId, ok := s.D.GetOkExists("o_auth2client_credential_id"); ok {
		tmp := oAuth2ClientCredentialId.(string)
