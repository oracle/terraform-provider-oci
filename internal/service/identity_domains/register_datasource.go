...
func RegisterDatasource() {
	...
	tfresource.RegisterDatasource("oci_identity_domains_identity_proofing_provider", IdentityDomainsIdentityProofingProviderDataSource())
	tfresource.RegisterDatasource("oci_identity_domains_identity_proofing_provider_template", IdentityDomainsIdentityProofingProviderTemplateDataSource())
	tfresource.RegisterDatasource("oci_identity_domains_identity_proofing_provider_templates", IdentityDomainsIdentityProofingProviderTemplatesDataSource())
	tfresource.RegisterDatasource("oci_identity_domains_identity_proofing_providers", IdentityDomainsIdentityProofingProvidersDataSource())
