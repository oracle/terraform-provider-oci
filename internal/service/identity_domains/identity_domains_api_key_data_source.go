...
func IdentityDomainsApiKeyDataSource() *schema.Resource {
	...
	return tfresource.GetSingularDataSourceItemSchema(IdentityDomainsApiKeyResource(), fieldMap, readSingularIdentityDomainsApiKey)
}
...
type IdentityDomainsApiKeyDataSourceCrud struct {
	D      *schema.ResourceData
	Client *oci_identity_domains.IdentityDomainsClient
	Res    *oci_identity_domains.GetApiKeyResponse
}
