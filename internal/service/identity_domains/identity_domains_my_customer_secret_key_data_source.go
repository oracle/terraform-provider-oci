...
func IdentityDomainsMyCustomerSecretKeyDataSource() *schema.Resource {
	...
	fieldMap["my_customer_secret_key_id"] = &schema.Schema{
		Type:     schema.TypeString,
		Required: true,
	}
	...
	return tfresource.GetSingularDataSourceItemSchema(IdentityDomainsMyCustomerSecretKeyResource(), fieldMap, readSingularIdentityDomainsMyCustomerSecretKey)
}
...
type IdentityDomainsMyCustomerSecretKeyDataSourceCrud struct {
	D      *schema.ResourceData
	Client *oci_identity_domains.IdentityDomainsClient
	Res    *oci_identity_domains.GetMyCustomerSecretKeyResponse
}
...
func (s *IdentityDomainsMyCustomerSecretKeyDataSourceCrud) Get() error {
	...
	if myCustomerSecretKeyId, ok := s.D.GetOkExists("my_customer_secret_key_id"); ok {
		tmp := myCustomerSecretKeyId.(string)
