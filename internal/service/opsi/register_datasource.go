...
func RegisterDatasource() {
	...
	tfresource.RegisterDatasource("oci_opsi_chargeback_plan", OpsiChargebackPlanDataSource())
	tfresource.RegisterDatasource("oci_opsi_chargeback_plans", OpsiChargebackPlansDataSource())
