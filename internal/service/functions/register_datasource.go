...
func RegisterDatasource() {
	...
	tfresource.RegisterDatasource("oci_functions_functions_runtime", FunctionsFunctionsRuntimeDataSource())
	tfresource.RegisterDatasource("oci_functions_functions_runtime_version", FunctionsFunctionsRuntimeVersionDataSource())
	tfresource.RegisterDatasource("oci_functions_functions_runtime_versions", FunctionsFunctionsRuntimeVersionsDataSource())
	tfresource.RegisterDatasource("oci_functions_functions_runtimes", FunctionsFunctionsRuntimesDataSource())
