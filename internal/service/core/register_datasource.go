...
func RegisterDatasource() {
	...
	tfresource.RegisterDatasource("oci_core_compute_gpu_memory_cluster", CoreComputeGpuMemoryClusterDataSource())
	tfresource.RegisterDatasource("oci_core_compute_gpu_memory_cluster_instances", CoreComputeGpuMemoryClusterInstancesDataSource())
