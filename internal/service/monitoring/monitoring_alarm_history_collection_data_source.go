...
import (
	...
	oci_monitoring "github.com/oracle/oci-go-sdk/v58/monitoring"
)
...
func (s *MonitoringAlarmHistoryCollectionDataSourceCrud) SetData() error {
	...
	s.D.SetId(tfresource.GenerateDataSourceHashID("MonitoringAlarmHistoryCollectionDataSource-", MonitoringAlarmHistoryCollectionDataSource(), s.D))
