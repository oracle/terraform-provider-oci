...
func RegisterDatasource() {
	...
	tfresource.RegisterDatasource("oci_jms_fleet_library_applications", JmsFleetLibraryApplicationsDataSource())
	tfresource.RegisterDatasource("oci_jms_fleet_library_managed_instances", JmsFleetLibraryManagedInstancesDataSource())
	...
	tfresource.RegisterDatasource("oci_jms_fleet_summarize_library_inventory", JmsSummarizeLibraryInventoryDataSource())
	tfresource.RegisterDatasource("oci_jms_fleet_uncorrelated_package_applications", JmsFleetUncorrelatedPackageApplicationsDataSource())
	tfresource.RegisterDatasource("oci_jms_fleet_uncorrelated_package_managed_instances", JmsFleetUncorrelatedPackageManagedInstancesDataSource())
	tfresource.RegisterDatasource("oci_jms_fleet_uncorrelated_packages", JmsFleetUncorrelatedPackagesDataSource())
	...
	tfresource.RegisterDatasource("oci_jms_task_schedule", JmsTaskScheduleDataSource())
	tfresource.RegisterDatasource("oci_jms_task_schedules", JmsTaskSchedulesDataSource())
