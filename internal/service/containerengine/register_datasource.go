...
func RegisterDatasource() {
	...
	tfresource.RegisterDatasource("oci_containerengine_cluster_attachment", ContainerengineClusterAttachmentDataSource())
	tfresource.RegisterDatasource("oci_containerengine_cluster_attachments", ContainerengineClusterAttachmentsDataSource())
	...
	tfresource.RegisterDatasource("oci_containerengine_cluster_namespace", ContainerengineClusterNamespaceDataSource())
	tfresource.RegisterDatasource("oci_containerengine_cluster_namespace_profile", ContainerengineClusterNamespaceProfileDataSource())
	tfresource.RegisterDatasource("oci_containerengine_cluster_namespace_profile_version", ContainerengineClusterNamespaceProfileVersionDataSource())
	tfresource.RegisterDatasource("oci_containerengine_cluster_namespace_profile_versions", ContainerengineClusterNamespaceProfileVersionsDataSource())
	tfresource.RegisterDatasource("oci_containerengine_cluster_namespace_profiles", ContainerengineClusterNamespaceProfilesDataSource())
	tfresource.RegisterDatasource("oci_containerengine_cluster_namespaces", ContainerengineClusterNamespacesDataSource())
