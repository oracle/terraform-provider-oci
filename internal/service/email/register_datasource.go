...
func RegisterDatasource() {
	...
	tfresource.RegisterDatasource("oci_email_email_ip_pool", EmailEmailIpPoolDataSource())
	tfresource.RegisterDatasource("oci_email_email_ip_pools", EmailEmailIpPoolsDataSource())
	tfresource.RegisterDatasource("oci_email_email_outbound_ips", EmailEmailOutboundIpsDataSource())
