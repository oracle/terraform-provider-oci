...
//)
//
//func LicenseManagerTopUtilizedProductLicenseDataSource() *schema.Resource {
//	return &schema.Resource{
//		Read: readSingularLicenseManagerTopUtilizedProductLicense,
...
//}
//
//func readSingularLicenseManagerTopUtilizedProductLicense(d *schema.ResourceData, m interface{}) error {
//	sync := &LicenseManagerTopUtilizedProductLicenseDataSourceCrud{}
//	sync.D = d
...
//}
//
//type LicenseManagerTopUtilizedProductLicenseDataSourceCrud struct {
//	D      *schema.ResourceData
//	Client *oci_license_manager.LicenseManagerClient
//	Res    *oci_license_manager.ListTopUtilizedProductLicensesResponse
//}
//
//func (s *LicenseManagerTopUtilizedProductLicenseDataSourceCrud) VoidState() {
//	s.D.SetId("")
//}
//
//func (s *LicenseManagerTopUtilizedProductLicenseDataSourceCrud) Get() error {
...
//}
//
//func (s *LicenseManagerTopUtilizedProductLicenseDataSourceCrud) SetData() error {
//	if s.Res == nil {
//		return nil
//	}
//
//	s.D.SetId(tfresource.GenerateDataSourceHashID("LicenseManagerTopUtilizedProductLicenseDataSource-", LicenseManagerTopUtilizedProductLicenseDataSource(), s.D))
//
//	items := []interface{}{}
//	for _, item := range s.Res.Items {
//		items = append(items, TopUtilizedProductLicenseSummaryToMap(item))
//	}
//	s.D.Set("items", items)
//
//	return nil
//}
//
//func TopUtilizedProductLicenseSummaryToMap(obj oci_license_manager.TopUtilizedProductLicenseSummary) map[string]interface{} {
