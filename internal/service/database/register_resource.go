...
func RegisterResource() {
	...
	tfresource.RegisterResource("oci_database_cloud_exadata_infrastructure_configure_exascale_management", DatabaseCloudExadataInfrastructureConfigureExascaleManagementResource())
	...
	tfresource.RegisterResource("oci_database_db_node_snapshot", DatabaseDbNodeSnapshotResource())
	tfresource.RegisterResource("oci_database_db_node_snapshot_management", DatabaseDbNodeSnapshotManagementResource())
	...
	tfresource.RegisterResource("oci_database_data_patch", DatabaseDatabaseDataPatchResource())
	...
	tfresource.RegisterResource("oci_database_execution_action", DatabaseExecutionActionResource())
	tfresource.RegisterResource("oci_database_execution_window", DatabaseExecutionWindowResource())
	...
	tfresource.RegisterResource("oci_database_scheduling_plan", DatabaseSchedulingPlanResource())
	tfresource.RegisterResource("oci_database_scheduling_policy", DatabaseSchedulingPolicyResource())
	tfresource.RegisterResource("oci_database_scheduling_policy_scheduling_window", DatabaseSchedulingPolicySchedulingWindowResource())
