...
func (s *DatabaseAutonomousVmClustersDataSourceCrud) SetData() error {
	...
	for _, r := range s.Res.Items {
		...
		autonomousVmCluster["distribution_algorithm"] = r.DistributionAlgorithm
		...
		if r.MemoryPerComputeUnitInGBs != nil {
			autonomousVmCluster["memory_per_compute_unit_in_gbs"] = *r.MemoryPerComputeUnitInGBs
		}
		...
		if r.SgaPercentage != nil {
			autonomousVmCluster["sga_percentage"] = *r.SgaPercentage
		}
