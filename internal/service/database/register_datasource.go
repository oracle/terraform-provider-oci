...
func RegisterDatasource() {
	tfresource.RegisterDatasource("oci_database_advanced_cluster_file_system", DatabaseAdvancedClusterFileSystemDataSource())
	tfresource.RegisterDatasource("oci_database_advanced_cluster_file_systems", DatabaseAdvancedClusterFileSystemsDataSource())
	...
	tfresource.RegisterDatasource("oci_database_autonomous_container_database_backup", DatabaseAutonomousContainerDatabaseBackupDataSource())
	tfresource.RegisterDatasource("oci_database_autonomous_container_database_backup_list_autonomous_databases_in_backups", DatabaseAutonomousContainerDatabaseBackupListAutonomousDatabasesInBackupsDataSource())
	tfresource.RegisterDatasource("oci_database_autonomous_container_database_backups", DatabaseAutonomousContainerDatabaseBackupsDataSource())
	...
	tfresource.RegisterDatasource("oci_database_db_system_os_patch_history_entries", DatabaseDbSystemOsPatchHistoryEntriesDataSource())
	tfresource.RegisterDatasource("oci_database_db_system_os_patch_history_entry", DatabaseDbSystemOsPatchHistoryEntryDataSource())
	...
	tfresource.RegisterDatasource("oci_database_execution_action", DatabaseExecutionActionDataSource())
	tfresource.RegisterDatasource("oci_database_execution_actions", DatabaseExecutionActionsDataSource())
	tfresource.RegisterDatasource("oci_database_execution_window", DatabaseExecutionWindowDataSource())
	tfresource.RegisterDatasource("oci_database_execution_windows", DatabaseExecutionWindowsDataSource())
	...
	tfresource.RegisterDatasource("oci_database_pluggable_database_snapshot", DatabasePluggableDatabaseSnapshotDataSource())
	tfresource.RegisterDatasource("oci_database_pluggable_database_snapshots", DatabasePluggableDatabaseSnapshotsDataSource())
	...
	tfresource.RegisterDatasource("oci_database_scheduling_plans", DatabaseSchedulingPlansDataSource())
	tfresource.RegisterDatasource("oci_database_scheduling_policies", DatabaseSchedulingPoliciesDataSource())
	tfresource.RegisterDatasource("oci_database_scheduling_policy", DatabaseSchedulingPolicyDataSource())
	tfresource.RegisterDatasource("oci_database_scheduling_policy_recommended_scheduled_actions", DatabaseSchedulingPolicyRecommendedScheduledActionsDataSource())
	tfresource.RegisterDatasource("oci_database_scheduling_policy_scheduling_window", DatabaseSchedulingPolicySchedulingWindowDataSource())
	tfresource.RegisterDatasource("oci_database_scheduling_policy_scheduling_windows", DatabaseSchedulingPolicySchedulingWindowsDataSource())
