...
func (s *DatabaseCloudVmClustersDataSourceCrud) SetData() error {
	...
	for _, r := range s.Res.Items {
		...
		if r.ExascaleDbStorageVaultId != nil {
			cloudVmCluster["exascale_db_storage_vault_id"] = *r.ExascaleDbStorageVaultId
		}
		...
		if r.LiveImageVersionDetails != nil {
			cloudVmCluster["live_image_version_details"] = []interface{}{exadataLiveImageVersionDetailsToMap(r.LiveImageVersionDetails)}
		} else {
			cloudVmCluster["live_image_version_details"] = nil
		}
		...
		if r.OracleLinuxVersion != nil {
			cloudVmCluster["oracle_linux_version"] = *r.OracleLinuxVersion
		}
		...
		cloudVmCluster["storage_management_type"] = r.StorageManagementType
		...
		cloudVmCluster["vm_backup_storage_type"] = r.VmBackupStorageType

		cloudVmCluster["vm_cluster_type"] = r.VmClusterType

		cloudVmCluster["vm_file_system_storage_type"] = r.VmFileSystemStorageType
