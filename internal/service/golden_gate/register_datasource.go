...
func RegisterDatasource() {
	...
	tfresource.RegisterDatasource("oci_golden_gate_deployment_disaster_recovery_precheck_report", GoldenGateDeploymentDisasterRecoveryPrecheckReportDataSource())
