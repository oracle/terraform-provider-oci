...
func RegisterDatasource() {
	...
	tfresource.RegisterDatasource("oci_network_load_balancer_network_load_balancer_backend_set_backend_operational_status", NetworkLoadBalancerNetworkLoadBalancerBackendSetBackendOperationalStatusDataSource())
