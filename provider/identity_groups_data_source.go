...
func (s *GroupsDataSourceCrud) Get() error {
	...
	response, err := s.Client.ListGroups(context.Background(), request, getRetryOptions(false, "identity")...)
	if err != nil {
		return err
	}
	...
	for request.Page != nil {
		listResponse, err := s.Client.ListGroups(context.Background(), request, getRetryOptions(false, "identity")...)
		if err != nil {
			return err
		}
