...
variable "backend_set_health_checker_interval_ms" { default = 10 }
...
variable "backend_set_name" { default = "name" }
		...
		Steps: []resource.TestStep{
			...
			// verify create with optionals
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "health_checker.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "health_checker.0.interval_ms", "10"),
			...
			{
				Config: config + `
variable "backend_set_backend_backup" { default = true }
variable "backend_set_backend_drain" { default = true }
variable "backend_set_backend_ip_address" { default = "ipAddress" }
variable "backend_set_backend_offline" { default = true }
variable "backend_set_backend_port" { default = "80" }
variable "backend_set_backend_weight" { default = 11 }
variable "backend_set_health_checker_interval_ms" { default = 11 }
...
variable "backend_set_ssl_configuration_verify_peer_certificate" { default = true }
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "backend.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "backend.0.backup", "true"),
					resource.TestCheckResourceAttr(resourceName, "backend.0.drain", "true"),
					resource.TestCheckResourceAttr(resourceName, "backend.0.ip_address", "ipAddress"),
					resource.TestCheckResourceAttrSet(resourceName, "backend.0.name"),
					resource.TestCheckResourceAttr(resourceName, "backend.0.offline", "true"),
					resource.TestCheckResourceAttr(resourceName, "backend.0.port", "80"),
					resource.TestCheckResourceAttr(resourceName, "backend.0.weight", "11"),
					resource.TestCheckResourceAttr(resourceName, "health_checker.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "health_checker.0.interval_ms", "11"),
...
variable "backend_set_backend_backup" { default = true }
variable "backend_set_backend_drain" { default = true }
variable "backend_set_backend_ip_address" { default = "ipAddress2" }
variable "backend_set_backend_offline" { default = true }
variable "backend_set_backend_port" { default = 11 }
variable "backend_set_backend_weight" { default = 11 }
variable "backend_set_health_checker_interval_ms" { default = 11 }
variable "backend_set_health_checker_port" { default = 11 }
variable "backend_set_health_checker_protocol" { default = "protocol2" }
variable "backend_set_health_checker_response_body_regex" { default = "responseBodyRegex2" }
variable "backend_set_health_checker_retries" { default = 11 }
variable "backend_set_health_checker_return_code" { default = 11 }
variable "backend_set_health_checker_timeout_in_millis" { default = 11 }
variable "backend_set_health_checker_url_path" { default = "urlPath2" }
variable "backend_set_name" { default = "name2" }
...
variable "backend_set_ssl_configuration_verify_peer_certificate" { default = true }
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "backend.0.backup", "true"),
					resource.TestCheckResourceAttr(resourceName, "backend.0.drain", "true"),
					resource.TestCheckResourceAttr(resourceName, "backend.0.ip_address", "ipAddress2"),
					resource.TestCheckResourceAttrSet(resourceName, "backend.0.name"),
					resource.TestCheckResourceAttr(resourceName, "backend.0.offline", "true"),
					resource.TestCheckResourceAttr(resourceName, "backend.0.port", "11"),
					resource.TestCheckResourceAttr(resourceName, "backend.0.weight", "11"),
					resource.TestCheckResourceAttr(resourceName, "health_checker.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "health_checker.0.interval_ms", "11"),
					resource.TestCheckResourceAttr(resourceName, "health_checker.0.port", "11"),
					resource.TestCheckResourceAttr(resourceName, "health_checker.0.protocol", "protocol2"),
					resource.TestCheckResourceAttr(resourceName, "health_checker.0.response_body_regex", "responseBodyRegex2"),
					resource.TestCheckResourceAttr(resourceName, "health_checker.0.retries", "11"),
					resource.TestCheckResourceAttr(resourceName, "health_checker.0.return_code", "11"),
					resource.TestCheckResourceAttr(resourceName, "health_checker.0.timeout_in_millis", "11"),
    ...
    filter {
    	...
    	values = ["${oci_load_balancer_backend_set.test_backend_set.id}"]
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(datasourceName, "backend_sets.#", "1"),
					resource.TestCheckResourceAttr(datasourceName, "backend_sets.0.backend.#", "1"),
					resource.TestCheckResourceAttr(datasourceName, "backend_sets.0.backend.0.backup", "true"),
					resource.TestCheckResourceAttr(datasourceName, "backend_sets.0.backend.0.drain", "true"),
					resource.TestCheckResourceAttr(datasourceName, "backend_sets.0.backend.0.ip_address", "ipAddress2"),
					resource.TestCheckResourceAttrSet(datasourceName, "backend_sets.0.backend.0.name"),
					resource.TestCheckResourceAttr(datasourceName, "backend_sets.0.backend.0.offline", "true"),
					resource.TestCheckResourceAttr(datasourceName, "backend_sets.0.backend.0.port", "11"),
					resource.TestCheckResourceAttr(datasourceName, "backend_sets.0.backend.0.weight", "11"),
					resource.TestCheckResourceAttr(datasourceName, "backend_sets.0.health_checker.#", "1"),
					resource.TestCheckResourceAttr(datasourceName, "backend_sets.0.health_checker.0.interval_ms", "11"),
					resource.TestCheckResourceAttr(datasourceName, "backend_sets.0.health_checker.0.port", "11"),
					resource.TestCheckResourceAttr(datasourceName, "backend_sets.0.health_checker.0.protocol", "protocol2"),
					...
					resource.TestCheckResourceAttr(datasourceName, "backend_sets.0.name", "name2"),
