...
func (s *RouteTablesDataSourceCrud) Get() error {
	...
	response, err := s.Client.ListRouteTables(context.Background(), request, getRetryOptions(false, "core")...)
	if err != nil {
		return err
	}
	...
	for request.Page != nil {
		listResponse, err := s.Client.ListRouteTables(context.Background(), request, getRetryOptions(false, "core")...)
		if err != nil {
			return err
		}
