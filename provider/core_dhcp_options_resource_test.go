	...
	resource.Test(s.T(), resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("oci_core_dhcp_options.opt6", "display_name", "display_name6"),
					resource.TestCheckResourceAttr("oci_core_dhcp_options.opt6", "options.0.type", "DomainNameServer"),
					resource.TestCheckResourceAttr("oci_core_dhcp_options.opt6", "options.0.server_type", "CustomDnsServer"),
					resource.TestCheckResourceAttrSet("oci_core_dhcp_options.opt6", "options.0.custom_dns_servers.#"),
					resource.TestCheckResourceAttr("oci_core_dhcp_options.opt6", "options.0.custom_dns_servers.0", "8.8.4.4"),
					resource.TestCheckResourceAttr("oci_core_dhcp_options.opt6", "options.0.custom_dns_servers.1", "8.8.8.8"),
					resource.TestCheckResourceAttr("oci_core_dhcp_options.opt6", "options.1.type", "SearchDomain"),
					resource.TestCheckResourceAttr("oci_core_dhcp_options.opt6", "options.1.search_domain_names.0", "test.com"),
				),
			},
		},
	})
