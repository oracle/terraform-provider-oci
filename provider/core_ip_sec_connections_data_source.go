...
func (s *IpSecConnectionsDataSourceCrud) Get() error {
	...
	response, err := s.Client.ListIPSecConnections(context.Background(), request, getRetryOptions(false, "core")...)
	if err != nil {
		return err
	}
	...
	for request.Page != nil {
		listResponse, err := s.Client.ListIPSecConnections(context.Background(), request, getRetryOptions(false, "core")...)
		if err != nil {
			return err
		}
