...
## AutonomousDataWarehouse Resource
...
* `display_name` - (Optional) The user-friendly name for the Autonomous Data Warehouse. The name does not have to be unique.
...
## AutonomousDataWarehouse Singular DataSource
...
## AutonomousDataWarehouse DataSource

Gets a list of autonomous_data_warehouses.
