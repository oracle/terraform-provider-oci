...
func init() {
	RegisterDatasource("oci_devops_build_pipeline_stages", DevopsBuildPipelineStagesDataSource())
}
...
func (s *DevopsBuildPipelineStagesDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DevopsBuildPipelineStagesDataSource-", DevopsBuildPipelineStagesDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, DevopsBuildPipelineStagesDataSource().Schema["build_pipeline_stage_collection"].Elem.(*schema.Resource).Schema)
		buildPipelineStage["items"] = items
	}
