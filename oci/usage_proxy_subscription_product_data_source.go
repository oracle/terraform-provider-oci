...
func init() {
	RegisterDatasource("oci_usage_proxy_subscription_product", UsageProxySubscriptionProductDataSource())
}
...
func (s *UsageProxySubscriptionProductDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("UsageProxySubscriptionProductDataSource-", UsageProxySubscriptionProductDataSource(), s.D))
