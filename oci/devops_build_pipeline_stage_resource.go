...
func init() {
	RegisterResource("oci_devops_build_pipeline_stage", DevopsBuildPipelineStageResource())
}
...
func (s *DevopsBuildPipelineStageResourceCrud) Create() error {
	...
	return s.getBuildPipelineStageFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "devops"), oci_devops.ActionTypeCreated, s.D.Timeout(schema.TimeoutCreate))
}
...
func (s *DevopsBuildPipelineStageResourceCrud) Update() error {
	...
	workId := response.OpcWorkRequestId
	return s.getBuildPipelineStageFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "devops"), oci_devops.ActionTypeUpdated, s.D.Timeout(schema.TimeoutUpdate))
}
