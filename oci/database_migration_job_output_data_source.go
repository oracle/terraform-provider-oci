...
func init() {
	RegisterDatasource("oci_database_migration_job_output", DatabaseMigrationJobOutputDataSource())
}
...
func (s *DatabaseMigrationJobOutputDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseMigrationJobOutputDataSource-", DatabaseMigrationJobOutputDataSource(), s.D))
