...
func init() {
	RegisterDatasource("oci_database_key_store", DatabaseKeyStoreDataSource())
}
...
func DatabaseKeyStoreDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatabaseKeyStoreResource(), fieldMap, readSingularDatabaseKeyStore)
}
