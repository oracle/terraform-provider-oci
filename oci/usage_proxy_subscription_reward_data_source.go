...
func init() {
	RegisterDatasource("oci_usage_proxy_subscription_reward", UsageProxySubscriptionRewardDataSource())
}
...
func (s *UsageProxySubscriptionRewardDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("UsageProxySubscriptionRewardDataSource-", UsageProxySubscriptionRewardDataSource(), s.D))
