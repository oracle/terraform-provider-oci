...
func init() {
	RegisterDatasource("oci_database_database_upgrade_history_entries", DatabaseDatabaseUpgradeHistoryEntriesDataSource())
}
...
func (s *DatabaseDatabaseUpgradeHistoryEntriesDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseDatabaseUpgradeHistoryEntriesDataSource-", DatabaseDatabaseUpgradeHistoryEntriesDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		resources = ApplyFilters(f.(*schema.Set), resources, DatabaseDatabaseUpgradeHistoryEntriesDataSource().Schema["database_upgrade_history_entries"].Elem.(*schema.Resource).Schema)
	}
