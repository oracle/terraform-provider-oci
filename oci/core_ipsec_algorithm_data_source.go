...
func init() {
	RegisterDatasource("oci_core_ipsec_algorithm", CoreIpsecAlgorithmDataSource())
}
...
func (s *CoreIpsecAlgorithmDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("CoreIpsecAlgorithmDataSource-", CoreIpsecAlgorithmDataSource(), s.D))
