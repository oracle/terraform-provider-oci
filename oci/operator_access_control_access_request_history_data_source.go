...
func init() {
	RegisterDatasource("oci_operator_access_control_access_request_history", OperatorAccessControlAccessRequestHistoryDataSource())
}
...
func (s *OperatorAccessControlAccessRequestHistoryDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("OperatorAccessControlAccessRequestHistoryDataSource-", OperatorAccessControlAccessRequestHistoryDataSource(), s.D))
