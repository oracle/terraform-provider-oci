...
func init() {
	RegisterResource("oci_opsi_operations_insights_warehouse_user", OpsiOperationsInsightsWarehouseUserResource())
}
...
func (s *OpsiOperationsInsightsWarehouseUserResourceCrud) Create() error {
	...
	return s.getOperationsInsightsWarehouseUserFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "opsi"), oci_opsi.ActionTypeCreated, s.D.Timeout(schema.TimeoutCreate))
}
...
func (s *OpsiOperationsInsightsWarehouseUserResourceCrud) Update() error {
	...
	workId := response.OpcWorkRequestId
	return s.getOperationsInsightsWarehouseUserFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "opsi"), oci_opsi.ActionTypeUpdated, s.D.Timeout(schema.TimeoutUpdate))
}
