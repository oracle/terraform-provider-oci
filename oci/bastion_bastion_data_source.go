...
func init() {
	RegisterDatasource("oci_bastion_bastion", BastionBastionDataSource())
}
...
func BastionBastionDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(BastionBastionResource(), fieldMap, readSingularBastionBastion)
}
