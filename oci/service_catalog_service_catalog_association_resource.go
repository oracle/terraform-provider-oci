...
import (
	...
	oci_service_catalog "github.com/oracle/oci-go-sdk/v51/servicecatalog"
)

func init() {
	RegisterResource("oci_service_catalog_service_catalog_association", ServiceCatalogServiceCatalogAssociationResource())
}
