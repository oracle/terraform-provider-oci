...
func init() {
	RegisterDatasource("oci_devops_deployment", DevopsDeploymentDataSource())
}
...
func DevopsDeploymentDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DevopsDeploymentResource(), fieldMap, readSingularDevopsDeployment)
}
