...
func init() {
	RegisterDatasource("oci_log_analytics_namespace_scheduled_task", LogAnalyticsNamespaceScheduledTaskDataSource())
}
...
func LogAnalyticsNamespaceScheduledTaskDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(LogAnalyticsNamespaceScheduledTaskResource(), fieldMap, readSingularLogAnalyticsNamespaceScheduledTask)
}
