...
func init() {
	RegisterDatasource("oci_opsi_database_insight", OpsiDatabaseInsightDataSource())
}
...
func OpsiDatabaseInsightDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(OpsiDatabaseInsightResource(), fieldMap, readSingularOpsiDatabaseInsight)
}
...
func (s *OpsiDatabaseInsightDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("OpsiDatabaseInsightsSingularDataSource-", OpsiDatabaseInsightsDataSource(), s.D))
