...
func TestUnitGenerateResourceRepresentationFromMap(t *testing.T) {
	...
	nestedMap1 := map[string]interface{}{
		...
		"nested_nested_property": acctest.RepresentationGroup{acctest.Required, nested2Map},
	}
	...
	testMap := map[string]interface{}{
		...
		"nested_property1":            acctest.RepresentationGroup{acctest.Optional, nestedMap1},
		"nested_property2":            acctest.RepresentationGroup{acctest.Required, nestedMap2},
	}
	...
	assert.Equal(strings.Replace(updatedGroupRequiredCreateConfig, "\t", "", -1),
		acctest.GenerateResourceFromMap(acctest.Required, acctest.Create, acctest.GetUpdatedRepresentationCopy("nested_property1", acctest.RepresentationGroup{acctest.Required, nestedMap1}, testMap)),
