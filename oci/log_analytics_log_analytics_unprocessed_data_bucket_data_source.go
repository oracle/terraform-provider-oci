...
func init() {
	RegisterDatasource("oci_log_analytics_log_analytics_unprocessed_data_bucket", LogAnalyticsLogAnalyticsUnprocessedDataBucketDataSource())
}
...
func (s *LogAnalyticsLogAnalyticsUnprocessedDataBucketDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("LogAnalyticsLogAnalyticsUnprocessedDataBucketDataSource-", LogAnalyticsLogAnalyticsUnprocessedDataBucketDataSource(), s.D))
