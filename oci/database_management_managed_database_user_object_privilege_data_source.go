...
func init() {
	RegisterDatasource("oci_database_management_managed_database_user_object_privilege", DatabaseManagementManagedDatabaseUserObjectPrivilegeDataSource())
}
...
func (s *DatabaseManagementManagedDatabaseUserObjectPrivilegeDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseManagementManagedDatabaseUserObjectPrivilegeDataSource-", DatabaseManagementManagedDatabaseUserObjectPrivilegeDataSource(), s.D))
