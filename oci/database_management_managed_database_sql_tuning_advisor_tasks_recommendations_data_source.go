...
func init() {
	RegisterDatasource("oci_database_management_managed_database_sql_tuning_advisor_tasks_recommendations", DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksRecommendationsDataSource())
}
...
func (s *DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksRecommendationsDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksRecommendationsDataSource-", DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksRecommendationsDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksRecommendationsDataSource().Schema["sql_tuning_advisor_task_recommendation_collection"].Elem.(*schema.Resource).Schema)
		managedDatabaseSqlTuningAdvisorTasksRecommendation["items"] = items
	}
