...
func init() {
	RegisterDatasource("oci_database_management_db_management_private_endpoint", DatabaseManagementDbManagementPrivateEndpointDataSource())
}
...
func DatabaseManagementDbManagementPrivateEndpointDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatabaseManagementDbManagementPrivateEndpointResource(), fieldMap, readSingularDatabaseManagementDbManagementPrivateEndpoint)
}
