...
func init() {
	RegisterDatasource("oci_operator_access_control_operator_control", OperatorAccessControlOperatorControlDataSource())
}
...
func OperatorAccessControlOperatorControlDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(OperatorAccessControlOperatorControlResource(), fieldMap, readSingularOperatorAccessControlOperatorControl)
}
