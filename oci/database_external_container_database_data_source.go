...
func init() {
	RegisterDatasource("oci_database_external_container_database", DatabaseExternalContainerDatabaseDataSource())
}
...
func DatabaseExternalContainerDatabaseDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatabaseExternalContainerDatabaseResource(), fieldMap, readSingularDatabaseExternalContainerDatabase)
}
