...
func init() {
	RegisterDatasource("oci_certificates_management_associations", CertificatesManagementAssociationsDataSource())
}
...
func (s *CertificatesManagementAssociationsDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("CertificatesManagementAssociationsDataSource-", CertificatesManagementAssociationsDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, CertificatesManagementAssociationsDataSource().Schema["association_collection"].Elem.(*schema.Resource).Schema)
		association["items"] = items
	}
