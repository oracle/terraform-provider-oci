...
func init() {
	RegisterDatasource("oci_management_agent_management_agent_plugins", ManagementAgentManagementAgentPluginsDataSource())
}
...
func (s *ManagementAgentManagementAgentPluginsDataSourceCrud) SetData() error {
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		resources = ApplyFilters(f.(*schema.Set), resources, ManagementAgentManagementAgentPluginsDataSource().Schema["management_agent_plugins"].Elem.(*schema.Resource).Schema)
	}
