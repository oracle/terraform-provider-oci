...
func init() {
	RegisterDatasource("oci_devops_build_pipeline_stage", DevopsBuildPipelineStageDataSource())
}
...
func DevopsBuildPipelineStageDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DevopsBuildPipelineStageResource(), fieldMap, readSingularDevopsBuildPipelineStage)
}
