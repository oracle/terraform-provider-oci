...
var (
	BuildPipelineBuildStageGitlabRequiredOnlyResource = BuildPipelineBuildStageGitlabResourceDependencies +
		GenerateResourceFromRepresentationMap("oci_devops_build_pipeline_stage", "test_build_pipeline_stage", Required, Create, buildPipelineBuildStageGitlabRepresentation)

	BuildPipelineBuildStageGitlabResourceConfig = BuildPipelineBuildStageGitlabResourceDependencies +
		GenerateResourceFromRepresentationMap("oci_devops_build_pipeline_stage", "test_build_pipeline_stage", Optional, Update, buildPipelineBuildStageGitlabRepresentation)
	...
	buildPipelineBuildStageGitlabDataSourceRepresentation = map[string]interface{}{
		...
		"filter":            RepresentationGroup{Required, buildPipelineBuildStageGitlabDataSourceFilterRepresentation}}
	...
	buildPipelineBuildStageGitlabRepresentation = map[string]interface{}{
		...
		"build_pipeline_stage_predecessor_collection": RepresentationGroup{Required, buildPipelineBuildStageBuildPipelineStageGitlabPredecessorCollectionRepresentation},
		...
		"build_source_collection":                     RepresentationGroup{Required, buildPipelineStageGitlabBuildSourceCollectionRepresentation},
	...
	buildPipelineBuildStageBuildPipelineStageGitlabPredecessorCollectionRepresentation = map[string]interface{}{
		"items": RepresentationGroup{Required, buildPipelineBuildStageGitlabBuildPipelineStagePredecessorCollectionItemsRepresentation},
	}

	buildPipelineStageGitlabBuildSourceCollectionRepresentation = map[string]interface{}{
		"items": RepresentationGroup{Required, buildPipelineStageGitlabBuildSourceCollectionItemsRepresentation},
	}
	...
	buildPipelineStageGitlabBuildSourceCollectionItemsRepresentation = map[string]interface{}{
		"connection_type": Representation{RepType: Required, Create: `GITLAB`},
	...
	BuildPipelineBuildStageGitlabResourceDependencies = GenerateResourceFromRepresentationMap("oci_devops_build_pipeline", "test_build_pipeline", Required, Create, buildPipelineRepresentation) +
...
func TestDevopsBuildPipelineBuildStageGitlabResource_basic(t *testing.T) {
	...
	SaveConfigContent(config+compartmentIdVariableStr+BuildPipelineBuildStageGitlabResourceDependencies+
		GenerateResourceFromRepresentationMap("oci_devops_build_pipeline_stage", "test_build_pipeline_stage", Optional, Create, buildPipelineBuildStageGitlabRepresentation), "devops", "buildPipelineStage", t)

	conf := config + compartmentIdVariableStr + BuildPipelineBuildStageGitlabResourceDependencies +
		GenerateResourceFromRepresentationMap("oci_devops_build_pipeline_stage", "test_build_pipeline_stage", Optional, Create, buildPipelineBuildStageGitlabRepresentation)
	print(conf)
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: config +
					GenerateDataSourceFromRepresentationMap("oci_devops_build_pipeline_stages", "test_build_pipeline_stages", Optional, Update, buildPipelineBuildStageGitlabDataSourceRepresentation) +
			...
			{
				Config: config +
					GenerateDataSourceFromRepresentationMap("oci_devops_build_pipeline_stage", "test_build_pipeline_stage", Required, Create, buildPipelineBuildStageGitlabSingularDataSourceRepresentation) +
