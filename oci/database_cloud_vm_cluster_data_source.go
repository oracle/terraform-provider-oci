...
func init() {
	RegisterDatasource("oci_database_cloud_vm_cluster", DatabaseCloudVmClusterDataSource())
}
...
func DatabaseCloudVmClusterDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatabaseCloudVmClusterResource(), fieldMap, readSingularDatabaseCloudVmCluster)
}
