...
func init() {
	RegisterDatasource("oci_certificates_management_certificate_authority_version", CertificatesManagementCertificateAuthorityVersionDataSource())
}
...
func (s *CertificatesManagementCertificateAuthorityVersionDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("CertificatesManagementCertificateAuthorityVersionDataSource-", CertificatesManagementCertificateAuthorityVersionDataSource(), s.D))
