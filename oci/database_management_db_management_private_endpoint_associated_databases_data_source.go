...
func init() {
	RegisterDatasource("oci_database_management_db_management_private_endpoint_associated_databases", DatabaseManagementDbManagementPrivateEndpointAssociatedDatabasesDataSource())
}
...
func (s *DatabaseManagementDbManagementPrivateEndpointAssociatedDatabasesDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseManagementDbManagementPrivateEndpointAssociatedDatabasesDataSource-", DatabaseManagementDbManagementPrivateEndpointAssociatedDatabasesDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, DatabaseManagementDbManagementPrivateEndpointAssociatedDatabasesDataSource().Schema["associated_database_collection"].Elem.(*schema.Resource).Schema)
		dbManagementPrivateEndpointAssociatedDatabase["items"] = items
	}
