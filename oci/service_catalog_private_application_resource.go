...
func init() {
	RegisterResource("oci_service_catalog_private_application", ServiceCatalogPrivateApplicationResource())
}
...
func privateApplicationWorkRequestShouldRetryFunc(timeout time.Duration) func(response oci_common.OCIOperationResponse) bool {
	...
	return func(response oci_common.OCIOperationResponse) bool {
		...
		if shouldRetry(response, false, "service_catalog", startTime) {
			return true
		}
