...
func init() {
	RegisterResource("oci_usage_proxy_subscription_redeemable_user", UsageProxySubscriptionRedeemableUserResource())
}
...
func (s *UsageProxySubscriptionRedeemableUserResourceCrud) Create() error {
	...
	request.RequestMetadata.RetryPolicy = GetRetryPolicy(s.DisableNotFoundRetries, "usage_proxy")
