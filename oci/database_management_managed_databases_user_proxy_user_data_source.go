...
func init() {
	RegisterDatasource("oci_database_management_managed_databases_user_proxy_user", DatabaseManagementManagedDatabasesUserProxyUserDataSource())
}
...
func (s *DatabaseManagementManagedDatabasesUserProxyUserDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseManagementManagedDatabasesUserProxyUserDataSource-", DatabaseManagementManagedDatabasesUserProxyUserDataSource(), s.D))
