...
func init() {
	RegisterResource("oci_identity_domain", IdentityDomainResource())
}
...
func (s *IdentityDomainResourceCrud) updateLicenseType(licenseType interface{}) error {
	...
	changeDomainLicenseTypeRequest.RequestMetadata.RetryPolicy = GetRetryPolicy(s.DisableNotFoundRetries, "identity")
...
func (s *IdentityDomainResourceCrud) activate() error {
	...
	activateDomainRequest.RequestMetadata.RetryPolicy = GetRetryPolicy(s.DisableNotFoundRetries, "identity")
...
func (s *IdentityDomainResourceCrud) deActivate() error {
	...
	deactivateDomainRequest.RequestMetadata.RetryPolicy = GetRetryPolicy(s.DisableNotFoundRetries, "identity")
