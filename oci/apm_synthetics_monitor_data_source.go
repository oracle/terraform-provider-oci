...
func init() {
	RegisterDatasource("oci_apm_synthetics_monitor", ApmSyntheticsMonitorDataSource())
}
...
func ApmSyntheticsMonitorDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(ApmSyntheticsMonitorResource(), fieldMap, readSingularApmSyntheticsMonitor)
}
