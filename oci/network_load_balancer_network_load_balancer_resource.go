...
func init() {
	RegisterResource("oci_network_load_balancer_network_load_balancer", NetworkLoadBalancerNetworkLoadBalancerResource())
}
...
func networkLoadBalancerWorkRequestShouldRetryFunc(timeout time.Duration) func(response oci_common.OCIOperationResponse) bool {
	...
	return func(response oci_common.OCIOperationResponse) bool {
		...
		if shouldRetry(response, false, "network_load_balancer", startTime) {
			return true
		}
