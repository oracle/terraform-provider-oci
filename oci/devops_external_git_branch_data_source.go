...
//
//func init() {
//	RegisterDatasource("oci_devops_external_git_branch", DevopsExternalGitBranchDataSource())
//}
//
...
//	}
//
//	s.D.SetId(GenerateDataSourceHashID("DevopsExternalGitBranchDataSource-", DevopsExternalGitBranchDataSource(), s.D))
//
//	branches := []interface{}{}
