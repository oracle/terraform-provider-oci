...
func init() {
	RegisterDatasource("oci_devops_build_pipeline", DevopsBuildPipelineDataSource())
}
...
func DevopsBuildPipelineDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DevopsBuildPipelineResource(), fieldMap, readSingularDevopsBuildPipeline)
}
