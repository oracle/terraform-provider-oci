...
func init() {
	RegisterDatasource("oci_devops_repository_file_line", DevopsRepositoryFileLineDataSource())
}
...
func (s *DevopsRepositoryFileLineDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DevopsRepositoryFileLineDataSource-", DevopsRepositoryFileLineDataSource(), s.D))
