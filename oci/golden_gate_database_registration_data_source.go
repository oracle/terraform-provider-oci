...
func init() {
	RegisterDatasource("oci_golden_gate_database_registration", GoldenGateDatabaseRegistrationDataSource())
}
...
func GoldenGateDatabaseRegistrationDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(GoldenGateDatabaseRegistrationResource(), fieldMap, readSingularGoldenGateDatabaseRegistration)
}
