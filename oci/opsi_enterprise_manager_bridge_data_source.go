...
func init() {
	RegisterDatasource("oci_opsi_enterprise_manager_bridge", OpsiEnterpriseManagerBridgeDataSource())
}
...
func OpsiEnterpriseManagerBridgeDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(OpsiEnterpriseManagerBridgeResource(), fieldMap, readSingularOpsiEnterpriseManagerBridge)
}
