...
func init() {
	RegisterDatasource("oci_database_pluggable_database", DatabasePluggableDatabaseDataSource())
}
...
func DatabasePluggableDatabaseDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatabasePluggableDatabaseResource(), fieldMap, readSingularDatabasePluggableDatabase)
}
