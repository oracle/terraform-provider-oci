...
func init() {
	RegisterDatasource("oci_database_autonomous_database_dataguard_associations", DatabaseAutonomousDatabaseDataguardAssociationsDataSource())
}
...
func (s *DatabaseAutonomousDatabaseDataguardAssociationsDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseAutonomousDatabaseDataguardAssociationsDataSource-", DatabaseAutonomousDatabaseDataguardAssociationsDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		resources = ApplyFilters(f.(*schema.Set), resources, DatabaseAutonomousDatabaseDataguardAssociationsDataSource().Schema["autonomous_database_dataguard_associations"].Elem.(*schema.Resource).Schema)
	}
