...
func init() {
	RegisterResource("oci_appmgmt_control_monitor_plugin_management", AppmgmtControlMonitorPluginManagementResource())
}
...
func createAppmgmtControlMonitorPluginManagement(d *schema.ResourceData, m interface{}) error {
	...
	sync.D = d
	sync.Client = m.(*OracleClients).appmgmtControlClient()
...
func (s *AppmgmtControlMonitorPluginManagementResourceCrud) Create() error {
	...
	request.RequestMetadata.RetryPolicy = GetRetryPolicy(s.DisableNotFoundRetries, "appmgmt_control")
	...
	return s.getMonitorPluginManagementFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "appmgmt_control"), oci_appmgmt_control.ActionTypeCreated, s.D.Timeout(schema.TimeoutCreate))
}
...
func monitorPluginManagementWorkRequestShouldRetryFunc(timeout time.Duration) func(response oci_common.OCIOperationResponse) bool {
	...
	return func(response oci_common.OCIOperationResponse) bool {
		...
		if shouldRetry(response, false, "appmgmt_control", startTime) {
			return true
		}
...
func monitorPluginManagementWaitForWorkRequest(wId *string, entityType string, action oci_appmgmt_control.ActionTypeEnum,
	...
	retryPolicy := GetRetryPolicy(disableFoundRetries, "appmgmt_control")
