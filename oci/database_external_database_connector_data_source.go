...
func init() {
	RegisterDatasource("oci_database_external_database_connector", DatabaseExternalDatabaseConnectorDataSource())
}
...
func DatabaseExternalDatabaseConnectorDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatabaseExternalDatabaseConnectorResource(), fieldMap, readSingularDatabaseExternalDatabaseConnector)
}
