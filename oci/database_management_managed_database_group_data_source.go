...
func init() {
	RegisterDatasource("oci_database_management_managed_database_group", DatabaseManagementManagedDatabaseGroupDataSource())
}
...
func DatabaseManagementManagedDatabaseGroupDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatabaseManagementManagedDatabaseGroupResource(), fieldMap, readSingularDatabaseManagementManagedDatabaseGroup)
}
