...
func init() {
	RegisterDatasource("oci_certificates_management_certificates", CertificatesManagementCertificatesDataSource())
}
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"items": {
							Type:     schema.TypeList,
							Computed: true,
							Elem:     GetDataSourceItemSchema(CertificatesManagementCertificateResource()),
						},
					},
				},
			},
...
func (s *CertificatesManagementCertificatesDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("CertificatesManagementCertificatesDataSource-", CertificatesManagementCertificatesDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, CertificatesManagementCertificatesDataSource().Schema["certificate_collection"].Elem.(*schema.Resource).Schema)
		certificate["items"] = items
	}
