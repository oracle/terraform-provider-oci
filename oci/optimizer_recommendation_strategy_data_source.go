...
func init() {
	RegisterDatasource("oci_optimizer_recommendation_strategy", OptimizerRecommendationStrategyDataSource())
}
...
func (s *OptimizerRecommendationStrategyDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("OptimizerRecommendationStrategyDataSource-", OptimizerRecommendationStrategyDataSource(), s.D))
