...
func init() {
	RegisterDatasource("oci_certificates_management_certificate_authority_versions", CertificatesManagementCertificateAuthorityVersionsDataSource())
}
...
func (s *CertificatesManagementCertificateAuthorityVersionsDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("CertificatesManagementCertificateAuthorityVersionsDataSource-", CertificatesManagementCertificateAuthorityVersionsDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, CertificatesManagementCertificateAuthorityVersionsDataSource().Schema["certificate_authority_version_collection"].Elem.(*schema.Resource).Schema)
		certificateAuthorityVersion["items"] = items
	}
