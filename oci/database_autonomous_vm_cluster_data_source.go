...
func init() {
	RegisterDatasource("oci_database_autonomous_vm_cluster", DatabaseAutonomousVmClusterDataSource())
}
...
func DatabaseAutonomousVmClusterDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatabaseAutonomousVmClusterResource(), fieldMap, readSingularDatabaseAutonomousVmCluster)
}
