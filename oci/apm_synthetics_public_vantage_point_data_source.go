...
func init() {
	RegisterDatasource("oci_apm_synthetics_public_vantage_point", ApmSyntheticsPublicVantagePointDataSource())
}
...
func (s *ApmSyntheticsPublicVantagePointDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("ApmSyntheticsPublicVantagePointDataSource-", ApmSyntheticsPublicVantagePointDataSource(), s.D))
