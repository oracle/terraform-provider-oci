...
func init() {
	RegisterDatasource("oci_database_management_managed_database_sql_tuning_advisor_tasks_summary_report", DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksSummaryReportDataSource())
}
...
func (s *DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksSummaryReportDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksSummaryReportDataSource-", DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksSummaryReportDataSource(), s.D))
