...
func init() {
	RegisterDatasource("oci_database_management_managed_database_user_role", DatabaseManagementManagedDatabaseUserRoleDataSource())
}
...
func (s *DatabaseManagementManagedDatabaseUserRoleDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseManagementManagedDatabaseUserRoleDataSource-", DatabaseManagementManagedDatabaseUserRoleDataSource(), s.D))
