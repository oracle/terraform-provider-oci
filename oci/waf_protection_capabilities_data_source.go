...
func init() {
	RegisterDatasource("oci_waf_protection_capabilities", WafProtectionCapabilitiesDataSource())
}
...
func (s *WafProtectionCapabilitiesDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("WafProtectionCapabilitiesDataSource-", WafProtectionCapabilitiesDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, WafProtectionCapabilitiesDataSource().Schema["protection_capability_collection"].Elem.(*schema.Resource).Schema)
		protectionCapability["items"] = items
	}
