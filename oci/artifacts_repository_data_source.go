...
func init() {
	RegisterDatasource("oci_artifacts_repository", ArtifactsRepositoryDataSource())
}
...
func ArtifactsRepositoryDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(ArtifactsRepositoryResource(), fieldMap, readSingularArtifactsRepository)
}
