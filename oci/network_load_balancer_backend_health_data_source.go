...
func init() {
	RegisterDatasource("oci_network_load_balancer_backend_health", NetworkLoadBalancerBackendHealthDataSource())
}
...
func (s *NetworkLoadBalancerBackendHealthDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("NetworkLoadBalancerBackendHealthDataSource-", NetworkLoadBalancerBackendHealthDataSource(), s.D))
