...
func init() {
	RegisterDatasource("oci_devops_deploy_stage", DevopsDeployStageDataSource())
}
...
func DevopsDeployStageDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DevopsDeployStageResource(), fieldMap, readSingularDevopsDeployStage)
}
