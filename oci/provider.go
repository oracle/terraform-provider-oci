...
func dataSourcesMap() map[string]*schema.Resource {
	return map[string]*schema.Resource{
		...
		"oci_auto_scaling_auto_scaling_configuration":    AutoScalingAutoScalingConfigurationDataSource(),
		"oci_auto_scaling_auto_scaling_configurations":   AutoScalingAutoScalingConfigurationsDataSource(),
		...
		"oci_monitoring_alarm":                           AlarmDataSource(),
		"oci_monitoring_alarms":                          AlarmsDataSource(),
		"oci_monitoring_alarm_statuses":                  AlarmStatusesDataSource(),
		"oci_monitoring_alarm_history_collection":        AlarmHistoryCollectionDataSource(),
		"oci_monitoring_metrics":                         MetricsDataSource(),
		"oci_monitoring_metric_data":                     MetricDataDataSource(),
...
func resourcesMap() map[string]*schema.Resource {
	return map[string]*schema.Resource{
		"oci_auto_scaling_auto_scaling_configuration":             AutoScalingAutoScalingConfigurationResource(),
		...
		"oci_monitoring_alarm":                      AlarmResource(),
