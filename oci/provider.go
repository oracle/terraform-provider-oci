...
func DataSourcesMap() map[string]*schema.Resource {
	return map[string]*schema.Resource{
		"oci_apigateway_gateway":                                      ApigatewayGatewayDataSource(),
		"oci_apigateway_gateways":                                     ApigatewayGatewaysDataSource(),
		"oci_apigateway_deployment":                                   ApigatewayDeploymentDataSource(),
		"oci_apigateway_deployments":                                  ApigatewayDeploymentsDataSource(),
		...
		"oci_database_autonomous_db_versions":                         DatabaseAutonomousDbVersionsDataSource(),
		...
		"oci_database_db_node_console_connection":                     DatabaseDbNodeConsoleConnectionDataSource(),
		"oci_database_db_node_console_connections":                    DatabaseDbNodeConsoleConnectionsDataSource(),
		...
		"oci_datacatalog_catalog":                                     DatacatalogCatalogDataSource(),
		"oci_datacatalog_catalogs":                                    DatacatalogCatalogsDataSource(),
		"oci_datacatalog_catalog_type":                                DatacatalogCatalogTypeDataSource(),
		"oci_datacatalog_catalog_types":                               DatacatalogCatalogTypesDataSource(),
		"oci_datacatalog_connection":                                  DatacatalogConnectionDataSource(),
		"oci_datacatalog_connections":                                 DatacatalogConnectionsDataSource(),
		"oci_datacatalog_data_asset":                                  DatacatalogDataAssetDataSource(),
		"oci_datacatalog_data_assets":                                 DatacatalogDataAssetsDataSource(),
		"oci_dataflow_application":                                    DataflowApplicationDataSource(),
		"oci_dataflow_applications":                                   DataflowApplicationsDataSource(),
		"oci_dataflow_invoke_run":                                     DataflowInvokeRunDataSource(),
		"oci_dataflow_invoke_runs":                                    DataflowInvokeRunsDataSource(),
		"oci_dataflow_run_log":                                        DataflowRunLogDataSource(),
		"oci_dataflow_run_logs":                                       DataflowRunLogsDataSource(),
		"oci_datascience_model":                                       DatascienceModelDataSource(),
		"oci_datascience_models":                                      DatascienceModelsDataSource(),
		"oci_datascience_model_provenance":                            DatascienceModelProvenanceDataSource(),
		"oci_datascience_notebook_session":                            DatascienceNotebookSessionDataSource(),
		"oci_datascience_notebook_sessions":                           DatascienceNotebookSessionsDataSource(),
		"oci_datascience_notebook_session_shapes":                     DatascienceNotebookSessionShapesDataSource(),
		"oci_datascience_project":                                     DatascienceProjectDataSource(),
		"oci_datascience_projects":                                    DatascienceProjectsDataSource(),
		"oci_dns_records":                                             DnsRecordsDataSource(),
		"oci_dns_tsig_key":                                            DnsTsigKeyDataSource(),
		"oci_dns_tsig_keys":                                           DnsTsigKeysDataSource(),
		...
		"oci_identity_network_source":                                 IdentityNetworkSourceDataSource(),
		"oci_identity_network_sources":                                IdentityNetworkSourcesDataSource(),
		...
		"oci_marketplace_accepted_agreement":                          MarketplaceAcceptedAgreementDataSource(),
		"oci_marketplace_accepted_agreements":                         MarketplaceAcceptedAgreementsDataSource(),
		"oci_marketplace_categories":                                  MarketplaceCategoriesDataSource(),
		"oci_marketplace_listing":                                     MarketplaceListingDataSource(),
		"oci_marketplace_listings":                                    MarketplaceListingsDataSource(),
		"oci_marketplace_listing_package":                             MarketplaceListingPackageDataSource(),
		"oci_marketplace_listing_packages":                            MarketplaceListingPackagesDataSource(),
		"oci_marketplace_listing_package_agreements":                  MarketplaceListingPackageAgreementsDataSource(),
		"oci_marketplace_publishers":                                  MarketplacePublishersDataSource(),
		...
		"oci_nosql_index":                                             NosqlIndexDataSource(),
		"oci_nosql_indexes":                                           NosqlIndexesDataSource(),
		"oci_nosql_table":                                             NosqlTableDataSource(),
		"oci_nosql_tables":                                            NosqlTablesDataSource(),
		...
		"oci_osmanagement_managed_instance":                           OsmanagementManagedInstanceDataSource(),
		"oci_osmanagement_managed_instances":                          OsmanagementManagedInstancesDataSource(),
		"oci_osmanagement_managed_instance_group":                     OsmanagementManagedInstanceGroupDataSource(),
		"oci_osmanagement_managed_instance_groups":                    OsmanagementManagedInstanceGroupsDataSource(),
		"oci_osmanagement_software_source":                            OsmanagementSoftwareSourceDataSource(),
		"oci_osmanagement_software_sources":                           OsmanagementSoftwareSourcesDataSource(),
		"oci_streaming_connect_harness":                               StreamingConnectHarnessDataSource(),
		"oci_streaming_connect_harnesses":                             StreamingConnectHarnessesDataSource(),
		"oci_streaming_stream_archiver":                               StreamingStreamArchiverDataSource(),
		"oci_streaming_stream_pool":                                   StreamingStreamPoolDataSource(),
		"oci_streaming_stream_pools":                                  StreamingStreamPoolsDataSource(),
		...
		"oci_waas_http_redirect":                                      WaasHttpRedirectDataSource(),
		"oci_waas_http_redirects":                                     WaasHttpRedirectsDataSource(),
...
func ResourcesMap() map[string]*schema.Resource {
	return map[string]*schema.Resource{
		"oci_apigateway_gateway":                                      ApigatewayGatewayResource(),
		"oci_apigateway_deployment":                                   ApigatewayDeploymentResource(),
		...
		"oci_database_db_node_console_connection":                     DatabaseDbNodeConsoleConnectionResource(),
		...
		"oci_datacatalog_catalog":                                     DatacatalogCatalogResource(),
		"oci_datacatalog_connection":                                  DatacatalogConnectionResource(),
		"oci_datacatalog_data_asset":                                  DatacatalogDataAssetResource(),
		"oci_dataflow_application":                                    DataflowApplicationResource(),
		"oci_dataflow_invoke_run":                                     DataflowInvokeRunResource(),
		"oci_datascience_model":                                       DatascienceModelResource(),
		"oci_datascience_model_provenance":                            DatascienceModelProvenanceResource(),
		"oci_datascience_notebook_session":                            DatascienceNotebookSessionResource(),
		"oci_datascience_project":                                     DatascienceProjectResource(),
		...
		"oci_dns_tsig_key":                                            DnsTsigKeyResource(),
		...
		"oci_identity_network_source":                                 IdentityNetworkSourceResource(),
		...
		"oci_marketplace_accepted_agreement":                          MarketplaceAcceptedAgreementResource(),
		"oci_marketplace_listing_package_agreement":                   MarketplaceListingPackageAgreementResource(),
		"oci_monitoring_alarm":                                        MonitoringAlarmResource(),
		"oci_nosql_index":                                             NosqlIndexResource(),
		"oci_nosql_table":                                             NosqlTableResource(),
		...
		"oci_osmanagement_managed_instance_group":                     OsmanagementManagedInstanceGroupResource(),
		"oci_osmanagement_managed_instance_management":                OsmanagementManagedInstanceManagementResource(),
		"oci_osmanagement_software_source":                            OsmanagementSoftwareSourceResource(),
		"oci_streaming_connect_harness":                               StreamingConnectHarnessResource(),
		"oci_streaming_stream_archiver":                               StreamingStreamArchiverResource(),
		"oci_streaming_stream_pool":                                   StreamingStreamPoolResource(),
		...
		"oci_waas_http_redirect":                                      WaasHttpRedirectResource(),
