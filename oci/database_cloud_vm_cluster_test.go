		...
		Steps: []resource.TestStep{
			// verify create
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "gi_version", "19.0.0.0"),
			...
			// verify datasource
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(datasourceName, "cloud_vm_clusters.0.gi_version", "19.0.0.0"),
					resource.TestCheckResourceAttrSet(resourceName, "hostname"),
					...
					resource.TestCheckResourceAttrSet(datasourceName, "cloud_vm_clusters.0.scan_dns_record_id"),
					resource.TestCheckResourceAttr(datasourceName, "cloud_vm_clusters.0.scan_ip_ids.#", "1"),
			...
			// verify singular datasource
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(singularDatasourceName, "gi_version", "19.0.0.0"),
					resource.TestCheckResourceAttrSet(resourceName, "hostname"),
					...
					resource.TestCheckResourceAttr(singularDatasourceName, "scan_ip_ids.#", "1"),
