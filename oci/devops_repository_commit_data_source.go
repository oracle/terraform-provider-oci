...
func init() {
	RegisterDatasource("oci_devops_repository_commit", DevopsRepositoryCommitDataSource())
}
...
func (s *DevopsRepositoryCommitDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DevopsRepositoryCommitDataSource-", DevopsRepositoryCommitDataSource(), s.D))
