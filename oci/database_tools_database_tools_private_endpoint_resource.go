...
func init() {
	RegisterResource("oci_database_tools_database_tools_private_endpoint", DatabaseToolsDatabaseToolsPrivateEndpointResource())
}
...
func (s *DatabaseToolsDatabaseToolsPrivateEndpointResourceCrud) Create() error {
	...
	return s.getDatabaseToolsPrivateEndpointFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "database_tools"), oci_database_tools.ActionTypeCreated, s.D.Timeout(schema.TimeoutCreate))
}
...
func (s *DatabaseToolsDatabaseToolsPrivateEndpointResourceCrud) Update() error {
	...
	workId := response.OpcWorkRequestId
	return s.getDatabaseToolsPrivateEndpointFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "database_tools"), oci_database_tools.ActionTypeUpdated, s.D.Timeout(schema.TimeoutUpdate))
}
