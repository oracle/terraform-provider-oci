...
func init() {
	RegisterDatasource("oci_certificates_management_certificate_versions", CertificatesManagementCertificateVersionsDataSource())
}
...
func (s *CertificatesManagementCertificateVersionsDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("CertificatesManagementCertificateVersionsDataSource-", CertificatesManagementCertificateVersionsDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, CertificatesManagementCertificateVersionsDataSource().Schema["certificate_version_collection"].Elem.(*schema.Resource).Schema)
		certificateVersion["items"] = items
	}
