...
func init() {
	RegisterDatasource("oci_database_migration_agent", DatabaseMigrationAgentDataSource())
}
...
func DatabaseMigrationAgentDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatabaseMigrationAgentResource(), fieldMap, readSingularDatabaseMigrationAgent)
}
