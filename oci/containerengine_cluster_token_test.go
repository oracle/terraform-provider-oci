...
var (
	clusterTokenSingularDataSourceRepresentation = map[string]interface{}{
		"cluster_id": Representation{repType: Required, create: `${oci_containerengine_cluster.test_cluster.id}`},
	}

	ClusterTokenResourceConfig = generateResourceFromRepresentationMap("oci_containerengine_cluster", "test_cluster", Required, Create, clusterRepresentation) +
...
func TestContainerengineClusterTokenResource_basic(t *testing.T) {
	httpreplay.SetScenario("TestContainerengineClusterTokenResource_basic")
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: config +
					generateDataSourceFromRepresentationMap("oci_containerengine_cluster_token", "test_cluster_token", Optional, Create, clusterTokenSingularDataSourceRepresentation) +
					compartmentIdVariableStr + ClusterTokenResourceConfig,
