...
import (
	...
	oci_health_checks "github.com/oracle/oci-go-sdk/v35/healthchecks"
)
...
func (s *HealthChecksHttpMonitorsDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("HealthChecksHttpMonitorsDataSource-", HealthChecksHttpMonitorsDataSource(), s.D))
