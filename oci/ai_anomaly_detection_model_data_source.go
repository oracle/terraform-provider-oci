...
func init() {
	RegisterDatasource("oci_ai_anomaly_detection_model", AiAnomalyDetectionModelDataSource())
}
...
func AiAnomalyDetectionModelDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(AiAnomalyDetectionModelResource(), fieldMap, readSingularAiAnomalyDetectionModel)
}
