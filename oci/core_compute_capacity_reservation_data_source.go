...
func init() {
	RegisterDatasource("oci_core_compute_capacity_reservation", CoreComputeCapacityReservationDataSource())
}
...
func CoreComputeCapacityReservationDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(CoreComputeCapacityReservationResource(), fieldMap, readSingularCoreComputeCapacityReservation)
}
