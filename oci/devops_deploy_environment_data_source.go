...
func init() {
	RegisterDatasource("oci_devops_deploy_environment", DevopsDeployEnvironmentDataSource())
}
...
func DevopsDeployEnvironmentDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DevopsDeployEnvironmentResource(), fieldMap, readSingularDevopsDeployEnvironment)
}
