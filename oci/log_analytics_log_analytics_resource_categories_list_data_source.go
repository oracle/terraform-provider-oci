...
func init() {
	RegisterDatasource("oci_log_analytics_log_analytics_resource_categories_list", LogAnalyticsLogAnalyticsResourceCategoriesListDataSource())
}
...
func (s *LogAnalyticsLogAnalyticsResourceCategoriesListDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("LogAnalyticsLogAnalyticsResourceCategoriesListDataSource-", LogAnalyticsLogAnalyticsResourceCategoriesListDataSource(), s.D))
