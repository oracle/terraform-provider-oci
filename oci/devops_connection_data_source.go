...
func init() {
	RegisterDatasource("oci_devops_connection", DevopsConnectionDataSource())
}
...
func DevopsConnectionDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DevopsConnectionResource(), fieldMap, readSingularDevopsConnection)
}
