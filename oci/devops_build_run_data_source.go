...
func init() {
	RegisterDatasource("oci_devops_build_run", DevopsBuildRunDataSource())
}
...
func DevopsBuildRunDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DevopsBuildRunResource(), fieldMap, readSingularDevopsBuildRun)
}
