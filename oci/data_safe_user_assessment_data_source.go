...
func init() {
	RegisterDatasource("oci_data_safe_user_assessment", DataSafeUserAssessmentDataSource())
}
...
func DataSafeUserAssessmentDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DataSafeUserAssessmentResource(), fieldMap, readSingularDataSafeUserAssessment)
}
