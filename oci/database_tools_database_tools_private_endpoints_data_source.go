...
func init() {
	RegisterDatasource("oci_database_tools_database_tools_private_endpoints", DatabaseToolsDatabaseToolsPrivateEndpointsDataSource())
}
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"items": {
							Type:     schema.TypeList,
							Computed: true,
							Elem:     GetDataSourceItemSchema(DatabaseToolsDatabaseToolsPrivateEndpointResource()),
						},
					},
				},
			},
...
func (s *DatabaseToolsDatabaseToolsPrivateEndpointsDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseToolsDatabaseToolsPrivateEndpointsDataSource-", DatabaseToolsDatabaseToolsPrivateEndpointsDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, DatabaseToolsDatabaseToolsPrivateEndpointsDataSource().Schema["database_tools_private_endpoint_collection"].Elem.(*schema.Resource).Schema)
		databaseToolsPrivateEndpoint["items"] = items
	}
