...
func init() {
	RegisterResource("oci_waf_network_address_list", WafNetworkAddressListResource())
}
...
func (s *WafNetworkAddressListResourceCrud) Create() error {
	...
	return s.getNetworkAddressListFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "waf"), oci_waf.WorkRequestResourceActionTypeCreated, s.D.Timeout(schema.TimeoutCreate))
}
...
func (s *WafNetworkAddressListResourceCrud) Update() error {
	...
	workId := response.OpcWorkRequestId
	return s.getNetworkAddressListFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "waf"), oci_waf.WorkRequestResourceActionTypeUpdated, s.D.Timeout(schema.TimeoutUpdate))
}
