...
func init() {
	RegisterDatasource("oci_operator_access_control_operator_control_assignment", OperatorAccessControlOperatorControlAssignmentDataSource())
}
...
func OperatorAccessControlOperatorControlAssignmentDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(OperatorAccessControlOperatorControlAssignmentResource(), fieldMap, readSingularOperatorAccessControlOperatorControlAssignment)
}
...
func readSingularOperatorAccessControlOperatorControlAssignment(d *schema.ResourceData, m interface{}) error {
	...
	sync.D = d
	sync.Client = m.(*OracleClients).operatorControlAssignmentClient()
