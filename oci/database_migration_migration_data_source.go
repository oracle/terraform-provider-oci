...
func init() {
	RegisterDatasource("oci_database_migration_migration", DatabaseMigrationMigrationDataSource())
}
...
func DatabaseMigrationMigrationDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatabaseMigrationMigrationResource(), fieldMap, readSingularDatabaseMigrationMigration)
}
