...
func init() {
	RegisterDatasource("oci_log_analytics_log_analytics_preference", LogAnalyticsLogAnalyticsPreferenceDataSource())
}
...
func (s *LogAnalyticsLogAnalyticsPreferenceDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("LogAnalyticsLogAnalyticsPreferenceDataSource-", LogAnalyticsLogAnalyticsPreferenceDataSource(), s.D))
