...
func init() {
	RegisterDatasource("oci_datascience_job", DatascienceJobDataSource())
}
...
func DatascienceJobDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatascienceJobResource(), fieldMap, readSingularDatascienceJob)
}
