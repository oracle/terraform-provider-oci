...
func init() {
	RegisterDatasource("oci_operator_access_control_operator_controls", OperatorAccessControlOperatorControlsDataSource())
}
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"items": {
							Type:     schema.TypeList,
							Computed: true,
							Elem:     GetDataSourceItemSchema(OperatorAccessControlOperatorControlResource()),
						},
					},
				},
			},
...
func (s *OperatorAccessControlOperatorControlsDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("OperatorAccessControlOperatorControlsDataSource-", OperatorAccessControlOperatorControlsDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, OperatorAccessControlOperatorControlsDataSource().Schema["operator_control_collection"].Elem.(*schema.Resource).Schema)
		operatorControl["items"] = items
	}
