...
func init() {
	RegisterResource("oci_devops_repository", DevopsRepositoryResource())
}
...
func (s *DevopsRepositoryResourceCrud) Create() error {
	...
	return s.getRepositoryFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "devops"), oci_devops.ActionTypeCreated, s.D.Timeout(schema.TimeoutCreate))
}
...
func (s *DevopsRepositoryResourceCrud) Update() error {
	...
	workId := response.OpcWorkRequestId
	return s.getRepositoryFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "devops"), oci_devops.ActionTypeUpdated, s.D.Timeout(schema.TimeoutUpdate))
}
