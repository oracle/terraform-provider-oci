...
//
//func init() {
//	RegisterDatasource("oci_devops_external_git_repository", DevopsExternalGitRepositoryDataSource())
//}
//
...
//	}
//
//	s.D.SetId(GenerateDataSourceHashID("DevopsExternalGitRepositoryDataSource-", DevopsExternalGitRepositoryDataSource(), s.D))
//
