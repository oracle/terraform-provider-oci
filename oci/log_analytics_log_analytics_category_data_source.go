...
func init() {
	RegisterDatasource("oci_log_analytics_log_analytics_category", LogAnalyticsLogAnalyticsCategoryDataSource())
}
...
func (s *LogAnalyticsLogAnalyticsCategoryDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("LogAnalyticsLogAnalyticsCategoryDataSource-", LogAnalyticsLogAnalyticsCategoryDataSource(), s.D))
