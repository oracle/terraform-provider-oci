...
func init() {
	RegisterDatasource("oci_core_drg_route_distribution_statements", CoreDrgRouteDistributionStatementsDataSource())
}
...
func (s *CoreDrgRouteDistributionStatementsDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("CoreDrgRouteDistributionStatementsDataSource-", CoreDrgRouteDistributionStatementsDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		resources = ApplyFilters(f.(*schema.Set), resources, CoreDrgRouteDistributionStatementsDataSource().Schema["drg_route_distribution_statements"].Elem.(*schema.Resource).Schema)
	}
