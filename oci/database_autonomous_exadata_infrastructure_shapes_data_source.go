...
func (s *DatabaseAutonomousExadataInfrastructureShapesDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseAutonomousExadataInfrastructureShapesDataSource-", DatabaseAutonomousExadataInfrastructureShapesDataSource(), s.D))
