...
func init() {
	RegisterDatasource("oci_appmgmt_control_monitored_instance", AppmgmtControlMonitoredInstanceDataSource())
}
...
func (s *AppmgmtControlMonitoredInstanceDataSourceCrud) Get() error {
	...
	request.RequestMetadata.RetryPolicy = GetRetryPolicy(false, "appmgmt_control")
...
func (s *AppmgmtControlMonitoredInstanceDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("AppmgmtControlMonitoredInstanceDataSource-", AppmgmtControlMonitoredInstanceDataSource(), s.D))
