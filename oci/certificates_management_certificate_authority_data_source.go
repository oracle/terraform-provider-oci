...
func init() {
	RegisterDatasource("oci_certificates_management_certificate_authority", CertificatesManagementCertificateAuthorityDataSource())
}
...
func CertificatesManagementCertificateAuthorityDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(CertificatesManagementCertificateAuthorityResource(), fieldMap, readSingularCertificatesManagementCertificateAuthority)
}
