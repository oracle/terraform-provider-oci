...
func init() {
	RegisterDatasource("oci_datacatalog_metastore", DatacatalogMetastoreDataSource())
}
...
func DatacatalogMetastoreDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatacatalogMetastoreResource(), fieldMap, readSingularDatacatalogMetastore)
}
