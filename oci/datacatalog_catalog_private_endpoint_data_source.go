...
func init() {
	RegisterDatasource("oci_datacatalog_catalog_private_endpoint", DatacatalogCatalogPrivateEndpointDataSource())
}
...
func DatacatalogCatalogPrivateEndpointDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatacatalogCatalogPrivateEndpointResource(), fieldMap, readSingularDatacatalogCatalogPrivateEndpoint)
}
