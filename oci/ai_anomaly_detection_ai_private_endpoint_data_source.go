...
func init() {
	RegisterDatasource("oci_ai_anomaly_detection_ai_private_endpoint", AiAnomalyDetectionAiPrivateEndpointDataSource())
}
...
func AiAnomalyDetectionAiPrivateEndpointDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(AiAnomalyDetectionAiPrivateEndpointResource(), fieldMap, readSingularAiAnomalyDetectionAiPrivateEndpoint)
}
