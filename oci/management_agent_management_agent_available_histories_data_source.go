...
import (
	...
	oci_management_agent "github.com/oracle/oci-go-sdk/v37/managementagent"
)

func init() {
	RegisterDatasource("oci_management_agent_management_agent_available_histories", ManagementAgentManagementAgentAvailableHistoriesDataSource())
}
...
func (s *ManagementAgentManagementAgentAvailableHistoriesDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("ManagementAgentManagementAgentAvailableHistoriesDataSource-", ManagementAgentManagementAgentAvailableHistoriesDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		resources = ApplyFilters(f.(*schema.Set), resources, ManagementAgentManagementAgentAvailableHistoriesDataSource().Schema["availability_histories"].Elem.(*schema.Resource).Schema)
	}
