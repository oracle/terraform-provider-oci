...
func init() {
	RegisterDatasource("oci_jms_summarize_resource_inventory", JmsSummarizeResourceInventoryDataSource())
}
...
func (s *JmsSummarizeResourceInventoryDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("JmsSummarizeResourceInventoryDataSource-", JmsSummarizeResourceInventoryDataSource(), s.D))
