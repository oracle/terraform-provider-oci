...
func (ctx *resourceDiscoveryContext) printErrors() {
	...
	for _, resourceDiscoveryError := range ctx.errorList {
		if resourceDiscoveryError.parentResource == "export" {
			color.Red(fmt.Sprintf("Error discovering `%s` resources: %s", resourceDiscoveryError.resourceType, resourceDiscoveryError.error.Error()))
		} else {
			color.Red(fmt.Sprintf("Error discovering `%s` resources for %s: %s", resourceDiscoveryError.resourceType, resourceDiscoveryError.parentResource, resourceDiscoveryError.error.Error()))
		}
