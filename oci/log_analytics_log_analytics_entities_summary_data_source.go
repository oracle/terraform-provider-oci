...
func init() {
	RegisterDatasource("oci_log_analytics_log_analytics_entities_summary", LogAnalyticsLogAnalyticsEntitiesSummaryDataSource())
}
...
func (s *LogAnalyticsLogAnalyticsEntitiesSummaryDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("LogAnalyticsLogAnalyticsEntitiesSummaryDataSource-", LogAnalyticsLogAnalyticsEntitiesSummaryDataSource(), s.D))
