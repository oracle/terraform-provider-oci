...
func init() {
	RegisterDatasource("oci_database_management_managed_database_sql_tuning_advisor_task", DatabaseManagementManagedDatabaseSqlTuningAdvisorTaskDataSource())
}
...
func (s *DatabaseManagementManagedDatabaseSqlTuningAdvisorTaskDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseManagementManagedDatabaseSqlTuningAdvisorTaskDataSource-", DatabaseManagementManagedDatabaseSqlTuningAdvisorTaskDataSource(), s.D))
