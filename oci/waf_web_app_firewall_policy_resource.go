...
func init() {
	RegisterResource("oci_waf_web_app_firewall_policy", WafWebAppFirewallPolicyResource())
}
...
func (s *WafWebAppFirewallPolicyResourceCrud) Create() error {
	...
	return s.getWebAppFirewallPolicyFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "waf"), oci_waf.WorkRequestResourceActionTypeCreated, s.D.Timeout(schema.TimeoutCreate))
}
...
func (s *WafWebAppFirewallPolicyResourceCrud) Update() error {
	...
	workId := response.OpcWorkRequestId
	return s.getWebAppFirewallPolicyFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "waf"), oci_waf.WorkRequestResourceActionTypeUpdated, s.D.Timeout(schema.TimeoutUpdate))
}
