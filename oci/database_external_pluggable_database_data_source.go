...
func init() {
	RegisterDatasource("oci_database_external_pluggable_database", DatabaseExternalPluggableDatabaseDataSource())
}
...
func DatabaseExternalPluggableDatabaseDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatabaseExternalPluggableDatabaseResource(), fieldMap, readSingularDatabaseExternalPluggableDatabase)
}
