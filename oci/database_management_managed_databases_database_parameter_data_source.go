...
func init() {
	RegisterDatasource("oci_database_management_managed_databases_database_parameter", DatabaseManagementManagedDatabasesDatabaseParameterDataSource())
}
...
func (s *DatabaseManagementManagedDatabasesDatabaseParameterDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseManagementManagedDatabasesDatabaseParameterDataSource-", DatabaseManagementManagedDatabasesDatabaseParameterDataSource(), s.D))
