...
func init() {
	RegisterDatasource("oci_database_management_managed_database_sql_tuning_advisor_tasks_sql_execution_plan", DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksSqlExecutionPlanDataSource())
}
...
func (s *DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksSqlExecutionPlanDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksSqlExecutionPlanDataSource-", DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksSqlExecutionPlanDataSource(), s.D))
