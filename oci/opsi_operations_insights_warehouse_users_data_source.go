...
func init() {
	RegisterDatasource("oci_opsi_operations_insights_warehouse_users", OpsiOperationsInsightsWarehouseUsersDataSource())
}
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"items": {
							Type:     schema.TypeList,
							Computed: true,
							Elem:     GetDataSourceItemSchema(OpsiOperationsInsightsWarehouseUserResource()),
						},
					},
				},
			},
...
func (s *OpsiOperationsInsightsWarehouseUsersDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("OpsiOperationsInsightsWarehouseUsersDataSource-", OpsiOperationsInsightsWarehouseUsersDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, OpsiOperationsInsightsWarehouseUsersDataSource().Schema["operations_insights_warehouse_user_summary_collection"].Elem.(*schema.Resource).Schema)
		operationsInsightsWarehouseUser["items"] = items
	}
