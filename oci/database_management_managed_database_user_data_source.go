...
func init() {
	RegisterDatasource("oci_database_management_managed_database_user", DatabaseManagementManagedDatabaseUserDataSource())
}
...
func (s *DatabaseManagementManagedDatabaseUserDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseManagementManagedDatabaseUserDataSource-", DatabaseManagementManagedDatabaseUserDataSource(), s.D))
