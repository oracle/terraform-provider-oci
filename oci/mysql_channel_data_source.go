...
func init() {
	RegisterDatasource("oci_mysql_channel", MysqlChannelDataSource())
}
...
func MysqlChannelDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(MysqlChannelResource(), fieldMap, readSingularMysqlChannel)
}
