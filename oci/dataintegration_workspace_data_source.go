...
func init() {
	RegisterDatasource("oci_dataintegration_workspace", DataintegrationWorkspaceDataSource())
}
...
func DataintegrationWorkspaceDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DataintegrationWorkspaceResource(), fieldMap, readSingularDataintegrationWorkspace)
}
