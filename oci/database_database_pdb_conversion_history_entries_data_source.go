...
func init() {
	RegisterDatasource("oci_database_database_pdb_conversion_history_entries", DatabaseDatabasePdbConversionHistoryEntriesDataSource())
}
...
func (s *DatabaseDatabasePdbConversionHistoryEntriesDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseDatabasePdbConversionHistoryEntriesDataSource-", DatabaseDatabasePdbConversionHistoryEntriesDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		resources = ApplyFilters(f.(*schema.Set), resources, DatabaseDatabasePdbConversionHistoryEntriesDataSource().Schema["pdb_conversion_history_entries"].Elem.(*schema.Resource).Schema)
	}
