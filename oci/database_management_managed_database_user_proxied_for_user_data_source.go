...
func init() {
	RegisterDatasource("oci_database_management_managed_database_user_proxied_for_user", DatabaseManagementManagedDatabaseUserProxiedForUserDataSource())
}
...
func (s *DatabaseManagementManagedDatabaseUserProxiedForUserDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseManagementManagedDatabaseUserProxiedForUserDataSource-", DatabaseManagementManagedDatabaseUserProxiedForUserDataSource(), s.D))
