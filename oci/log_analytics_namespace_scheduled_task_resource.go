...
func init() {
	RegisterResource("oci_log_analytics_namespace_scheduled_task", LogAnalyticsNamespaceScheduledTaskResource())
}
...
func (s *LogAnalyticsNamespaceScheduledTaskResourceCrud) SetData() error {
	...
	if result.GetDefinedTags() != nil {
		s.D.Set("defined_tags", definedTagsToMap(result.GetDefinedTags()))
	}
