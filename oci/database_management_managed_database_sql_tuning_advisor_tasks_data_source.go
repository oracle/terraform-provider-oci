...
func init() {
	RegisterDatasource("oci_database_management_managed_database_sql_tuning_advisor_tasks", DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksDataSource())
}
...
func (s *DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksDataSource-", DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksDataSource().Schema["sql_tuning_advisor_task_collection"].Elem.(*schema.Resource).Schema)
		managedDatabaseSqlTuningAdvisorTask["items"] = items
	}
