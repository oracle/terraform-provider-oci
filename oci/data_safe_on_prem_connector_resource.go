...
import (
	...
	oci_data_safe "github.com/oracle/oci-go-sdk/v37/datasafe"
)

func init() {
	RegisterResource("oci_data_safe_on_prem_connector", DataSafeOnPremConnectorResource())
}
...
type DataSafeOnPremConnectorResourceCrud struct {
	...
	Res                    *oci_data_safe.OnPremConnector
...
func (s *DataSafeOnPremConnectorResourceCrud) CreatedPending() []string {
	return []string{
		string(oci_data_safe.OnPremConnectorLifecycleStateCreating),
	}
}
...
func (s *DataSafeOnPremConnectorResourceCrud) DeletedPending() []string {
	return []string{
		string(oci_data_safe.OnPremConnectorLifecycleStateDeleting),
	}
}

func (s *DataSafeOnPremConnectorResourceCrud) DeletedTarget() []string {
	return []string{
		string(oci_data_safe.OnPremConnectorLifecycleStateDeleted),
	}
}
...
func onPremConnectorWaitForWorkRequest(wId *string, entityType string, action oci_data_safe.WorkRequestResourceActionTypeEnum,
	...
	if identifier == nil || response.Status == oci_data_safe.WorkRequestStatusFailed {
		return nil, getErrorFromOnPremConnectorWorkRequest(client, wId, retryPolicy, entityType, action)
	}

	return identifier, nil
}

func getErrorFromOnPremConnectorWorkRequest(client *oci_data_safe.DataSafeClient, wId *string, retryPolicy *oci_common.RetryPolicy, entityType string, action oci_data_safe.WorkRequestResourceActionTypeEnum) error {
...
func (s *DataSafeOnPremConnectorResourceCrud) Get() error {
	...
	s.Res = &response.OnPremConnector
	return nil
}
...
func (s *DataSafeOnPremConnectorResourceCrud) Update() error {
	...
	request := oci_data_safe.UpdateOnPremConnectorRequest{}
