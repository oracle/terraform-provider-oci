...
func init() {
	RegisterResource("oci_devops_trigger", DevopsTriggerResource())
}
...
func (s *DevopsTriggerResourceCrud) Create() error {
	...
	return s.getTriggerFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "devops"), oci_devops.ActionTypeCreated, s.D.Timeout(schema.TimeoutCreate))
}
...
func (s *DevopsTriggerResourceCrud) Update() error {
	...
	workId := response.OpcWorkRequestId
	return s.getTriggerFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "devops"), oci_devops.ActionTypeUpdated, s.D.Timeout(schema.TimeoutUpdate))
}
