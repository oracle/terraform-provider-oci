...
func init() {
	RegisterDatasource("oci_devops_project", DevopsProjectDataSource())
}
...
func DevopsProjectDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DevopsProjectResource(), fieldMap, readSingularDevopsProject)
}
