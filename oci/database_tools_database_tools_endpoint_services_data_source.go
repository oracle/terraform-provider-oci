...
func init() {
	RegisterDatasource("oci_database_tools_database_tools_endpoint_services", DatabaseToolsDatabaseToolsEndpointServicesDataSource())
}
...
func (s *DatabaseToolsDatabaseToolsEndpointServicesDataSourceCrud) Get() error {
	...
	request.RequestMetadata.RetryPolicy = GetRetryPolicy(false, "database_tools")
...
func (s *DatabaseToolsDatabaseToolsEndpointServicesDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseToolsDatabaseToolsEndpointServicesDataSource-", DatabaseToolsDatabaseToolsEndpointServicesDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, DatabaseToolsDatabaseToolsEndpointServicesDataSource().Schema["database_tools_endpoint_service_collection"].Elem.(*schema.Resource).Schema)
		databaseToolsEndpointService["items"] = items
	}
