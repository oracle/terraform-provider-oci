...
func init() {
	RegisterDatasource("oci_devops_repository_diff", DevopsRepositoryDiffDataSource())
}
...
func (s *DevopsRepositoryDiffDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DevopsRepositoryDiffDataSource-", DevopsRepositoryDiffDataSource(), s.D))
