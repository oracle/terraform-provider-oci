...
func init() {
	RegisterDatasource("oci_waf_network_address_list", WafNetworkAddressListDataSource())
}
...
func WafNetworkAddressListDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(WafNetworkAddressListResource(), fieldMap, readSingularWafNetworkAddressList)
}
