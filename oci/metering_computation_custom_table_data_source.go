...
func init() {
	RegisterDatasource("oci_metering_computation_custom_table", MeteringComputationCustomTableDataSource())
}
...
func MeteringComputationCustomTableDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(MeteringComputationCustomTableResource(), fieldMap, readSingularMeteringComputationCustomTable)
}
