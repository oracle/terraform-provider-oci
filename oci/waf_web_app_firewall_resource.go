...
func init() {
	RegisterResource("oci_waf_web_app_firewall", WafWebAppFirewallResource())
}
...
func (s *WafWebAppFirewallResourceCrud) Create() error {
	...
	request.RequestMetadata.RetryPolicy = GetRetryPolicy(s.DisableNotFoundRetries, "waf")
	...
	return s.getWebAppFirewallFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "waf"), oci_waf.WorkRequestResourceActionTypeCreated, s.D.Timeout(schema.TimeoutCreate))
}
...
func webAppFirewallWorkRequestShouldRetryFunc(timeout time.Duration) func(response oci_common.OCIOperationResponse) bool {
	...
	return func(response oci_common.OCIOperationResponse) bool {
		...
		if shouldRetry(response, false, "waf", startTime) {
			return true
		}
...
func webAppFirewallWaitForWorkRequest(wId *string, entityType string, action oci_waf.WorkRequestResourceActionTypeEnum,
	...
	retryPolicy := GetRetryPolicy(disableFoundRetries, "waf")
...
func (s *WafWebAppFirewallResourceCrud) Update() error {
	...
	if systemTags, ok := s.D.GetOkExists("system_tags"); ok {
		convertedSystemTags, err := mapToSystemTags(systemTags.(map[string]interface{}))
		if err != nil {
			return err
		}
	...
	workId := response.OpcWorkRequestId
	return s.getWebAppFirewallFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "waf"), oci_waf.WorkRequestResourceActionTypeUpdated, s.D.Timeout(schema.TimeoutUpdate))
}
...
func WebAppFirewallSummaryToMap(obj oci_waf.WebAppFirewallSummary) map[string]interface{} {
	...
	if obj.GetDefinedTags() != nil {
		result["defined_tags"] = definedTagsToMap(obj.GetDefinedTags())
	}
	...
	if obj.GetSystemTags() != nil {
		result["system_tags"] = systemTagsToMap(obj.GetSystemTags())
	}
...
func (s *WafWebAppFirewallResourceCrud) updateCompartment(compartment interface{}) error {
	...
	changeCompartmentRequest.RequestMetadata.RetryPolicy = GetRetryPolicy(s.DisableNotFoundRetries, "waf")
