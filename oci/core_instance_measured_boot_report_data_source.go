...
func init() {
	RegisterDatasource("oci_core_instance_measured_boot_report", CoreInstanceMeasuredBootReportDataSource())
}
...
func (s *CoreInstanceMeasuredBootReportDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("CoreInstanceMeasuredBootReportDataSource-", CoreInstanceMeasuredBootReportDataSource(), s.D))
