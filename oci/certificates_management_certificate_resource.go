...
func init() {
	RegisterResource("oci_certificates_management_certificate", CertificatesManagementCertificateResource())
}
...
func (s *CertificatesManagementCertificateResourceCrud) Create() error {
	...
	request.RequestMetadata.RetryPolicy = GetRetryPolicy(s.DisableNotFoundRetries, "certificates_management")
...
func (s *CertificatesManagementCertificateResourceCrud) updateCompartment(compartment interface{}) error {
	...
	changeCompartmentRequest.RequestMetadata.RetryPolicy = GetRetryPolicy(s.DisableNotFoundRetries, "certificates_management")
