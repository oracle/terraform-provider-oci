...
var (
	...
	deploymentOggDataRepresentation = map[string]interface{}{
		...
		"certificate":     Representation{repType: Optional, create: `certificate`, update: `certificate2`},
		...
		Steps: []resource.TestStep{
			...
			// verify create with optionals
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ogg_data.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "ogg_data.0.admin_username", "adminUsername"),
					resource.TestCheckResourceAttr(resourceName, "ogg_data.0.certificate", "certificate"),
					resource.TestCheckResourceAttrSet(resourceName, "ogg_data.0.deployment_name"),
					resource.TestCheckResourceAttrSet(resourceName, "subnet_id"),
			...
			// verify updates to updatable parameters
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "ogg_data.0.certificate", "certificate2"),
					resource.TestCheckResourceAttrSet(resourceName, "ogg_data.0.deployment_name"),
					resource.TestCheckResourceAttrSet(resourceName, "subnet_id"),
			...
			// verify singular datasource
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(singularDatasourceName, "ogg_data.0.certificate", "certificate2"),
