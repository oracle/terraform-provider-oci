...
func init() {
	RegisterDatasource("oci_devops_trigger", DevopsTriggerDataSource())
}
...
func DevopsTriggerDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DevopsTriggerResource(), fieldMap, readSingularDevopsTrigger)
}
