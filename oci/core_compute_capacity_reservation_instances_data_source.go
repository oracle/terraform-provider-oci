...
func init() {
	RegisterDatasource("oci_core_compute_capacity_reservation_instances", CoreComputeCapacityReservationInstancesDataSource())
}
...
func (s *CoreComputeCapacityReservationInstancesDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("CoreComputeCapacityReservationInstancesDataSource-", CoreComputeCapacityReservationInstancesDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		resources = ApplyFilters(f.(*schema.Set), resources, CoreComputeCapacityReservationInstancesDataSource().Schema["capacity_reservation_instances"].Elem.(*schema.Resource).Schema)
	}
