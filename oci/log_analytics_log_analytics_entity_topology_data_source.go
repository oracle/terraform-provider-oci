...
func init() {
	RegisterDatasource("oci_log_analytics_log_analytics_entity_topology", LogAnalyticsLogAnalyticsEntityTopologyDataSource())
}
...
func (s *LogAnalyticsLogAnalyticsEntityTopologyDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("LogAnalyticsLogAnalyticsEntityTopologyDataSource-", LogAnalyticsLogAnalyticsEntityTopologyDataSource(), s.D))
