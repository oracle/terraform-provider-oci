...
func init() {
	RegisterDatasource("oci_certificates_management_certificate", CertificatesManagementCertificateDataSource())
}
...
func CertificatesManagementCertificateDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(CertificatesManagementCertificateResource(), fieldMap, readSingularCertificatesManagementCertificate)
}
