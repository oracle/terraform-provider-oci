...
func init() {
	RegisterDatasource("oci_dns_resolver_endpoint", DnsResolverEndpointDataSource())
}
...
func DnsResolverEndpointDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DnsResolverEndpointResource(), fieldMap, readSingularDnsResolverEndpoint)
}
