...
func init() {
	RegisterDatasource("oci_database_management_managed_databases_user_proxy_users", DatabaseManagementManagedDatabasesUserProxyUsersDataSource())
}
...
func (s *DatabaseManagementManagedDatabasesUserProxyUsersDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseManagementManagedDatabasesUserProxyUsersDataSource-", DatabaseManagementManagedDatabasesUserProxyUsersDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, DatabaseManagementManagedDatabasesUserProxyUsersDataSource().Schema["proxy_user_collection"].Elem.(*schema.Resource).Schema)
		managedDatabasesUserProxyUser["items"] = items
	}
