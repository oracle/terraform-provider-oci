...
func init() {
	RegisterDatasource("oci_ocvp_supported_skus", OcvpSupportedSkusDataSource())
}
...
func (s *OcvpSupportedSkusDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("OcvpSupportedSkusDataSource-", OcvpSupportedSkusDataSource(), s.D))
