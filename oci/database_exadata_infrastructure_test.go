		...
		Steps: []resource.TestStep{
			...
			// verify datasource
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(datasourceName, "exadata_infrastructures.0.netmask", "255.254.255.0"),
			...
			// verify singular datasource
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(singularDatasourceName, "netmask", "255.254.255.0"),
