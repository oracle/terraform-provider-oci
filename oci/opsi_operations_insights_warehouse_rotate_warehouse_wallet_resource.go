...
func init() {
	RegisterResource("oci_opsi_operations_insights_warehouse_rotate_warehouse_wallet", OpsiOperationsInsightsWarehouseRotateWarehouseWalletResource())
}
...
func (s *OpsiOperationsInsightsWarehouseRotateWarehouseWalletResourceCrud) ID() string {
	return GenerateDataSourceHashID("OpsiOperationsInsightsWarehouseRotateWarehouseWalletResource-", OpsiOperationsInsightsWarehouseRotateWarehouseWalletResource(), s.D)
}
...
func (s *OpsiOperationsInsightsWarehouseRotateWarehouseWalletResourceCrud) Create() error {
	...
	err = s.getOperationsInsightsWarehouseRotateWarehouseWalletFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "opsi"), oci_opsi.ActionTypeRelated, s.D.Timeout(schema.TimeoutCreate))
	if err != nil {
		return err
	}
	if operationsInsightsWarehouseId, ok := s.D.GetOkExists("operations_insights_warehouse_id"); ok {
