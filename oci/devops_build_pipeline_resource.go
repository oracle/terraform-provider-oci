...
func init() {
	RegisterResource("oci_devops_build_pipeline", DevopsBuildPipelineResource())
}
...
func (s *DevopsBuildPipelineResourceCrud) Create() error {
	...
	return s.getBuildPipelineFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "devops"), oci_devops.ActionTypeCreated, s.D.Timeout(schema.TimeoutCreate))
}
...
func (s *DevopsBuildPipelineResourceCrud) Update() error {
	...
	workId := response.OpcWorkRequestId
	return s.getBuildPipelineFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "devops"), oci_devops.ActionTypeUpdated, s.D.Timeout(schema.TimeoutUpdate))
}
