...
func init() {
	RegisterDatasource("oci_database_management_managed_database_user_consumer_group_privilege", DatabaseManagementManagedDatabaseUserConsumerGroupPrivilegeDataSource())
}
...
func (s *DatabaseManagementManagedDatabaseUserConsumerGroupPrivilegeDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseManagementManagedDatabaseUserConsumerGroupPrivilegeDataSource-", DatabaseManagementManagedDatabaseUserConsumerGroupPrivilegeDataSource(), s.D))
