...
func init() {
	RegisterDatasource("oci_database_vm_cluster_updates", DatabaseVmClusterUpdatesDataSource())
}
...
func (s *DatabaseVmClusterUpdatesDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseVmClusterUpdatesDataSource-", DatabaseVmClusterUpdatesDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		resources = ApplyFilters(f.(*schema.Set), resources, DatabaseVmClusterUpdatesDataSource().Schema["vm_cluster_updates"].Elem.(*schema.Resource).Schema)
	}
