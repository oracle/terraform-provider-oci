...
func init() {
	RegisterDatasource("oci_database_migration_connection", DatabaseMigrationConnectionDataSource())
}
...
func DatabaseMigrationConnectionDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatabaseMigrationConnectionResource(), fieldMap, readSingularDatabaseMigrationConnection)
}
