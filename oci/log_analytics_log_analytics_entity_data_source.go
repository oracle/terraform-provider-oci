...
func init() {
	RegisterDatasource("oci_log_analytics_log_analytics_entity", LogAnalyticsLogAnalyticsEntityDataSource())
}
...
func LogAnalyticsLogAnalyticsEntityDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(LogAnalyticsLogAnalyticsEntityResource(), fieldMap, readSingularLogAnalyticsLogAnalyticsEntity)
}
