...
import (
	...
	oci_apm_synthetics "github.com/oracle/oci-go-sdk/v43/apmsynthetics"
)

func init() {
	RegisterDatasource("oci_apm_synthetics_result", ApmSyntheticsResultDataSource())
}
...
func (s *ApmSyntheticsResultDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("ApmSyntheticsResultDataSource-", ApmSyntheticsResultDataSource(), s.D))
