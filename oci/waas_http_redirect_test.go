...
var (
	...
	httpRedirectRepresentation = map[string]interface{}{
		"compartment_id": Representation{repType: Required, create: `${var.compartment_id}`},
		"domain":         Representation{repType: Required, create: `example.net`},
	...
	httpRedirectTargetRepresentation = map[string]interface{}{
		"host":     Representation{repType: Required, create: `example.com`, update: `example2.com`},
		...
		Steps: []resource.TestStep{
			// verify create
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "domain", "example.net"),
					resource.TestCheckResourceAttr(resourceName, "target.#", "1"),
					resource.TestCheckResourceAttr(resourceName, "target.0.host", "example.com"),
			...
			// verify datasource
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(datasourceName, "http_redirects.0.domain", "example.net"),
			...
			// verify singular datasource
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(singularDatasourceName, "domain", "example.net"),
