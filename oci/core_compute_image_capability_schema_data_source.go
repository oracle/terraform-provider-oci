...
func init() {
	RegisterDatasource("oci_core_compute_image_capability_schema", CoreComputeImageCapabilitySchemaDataSource())
}
...
func CoreComputeImageCapabilitySchemaDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(CoreComputeImageCapabilitySchemaResource(), fieldMap, readSingularCoreComputeImageCapabilitySchema)
}
