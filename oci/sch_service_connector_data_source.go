...
func init() {
	RegisterDatasource("oci_sch_service_connector", SchServiceConnectorDataSource())
}
...
func SchServiceConnectorDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(SchServiceConnectorResource(), fieldMap, readSingularSchServiceConnector)
}
