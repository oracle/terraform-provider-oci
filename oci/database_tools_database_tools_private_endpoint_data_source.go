...
func init() {
	RegisterDatasource("oci_database_tools_database_tools_private_endpoint", DatabaseToolsDatabaseToolsPrivateEndpointDataSource())
}
...
func DatabaseToolsDatabaseToolsPrivateEndpointDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatabaseToolsDatabaseToolsPrivateEndpointResource(), fieldMap, readSingularDatabaseToolsDatabaseToolsPrivateEndpoint)
}
