...
func init() {
	RegisterDatasource("oci_database_migration_job_advisor_report", DatabaseMigrationJobAdvisorReportDataSource())
}
...
func (s *DatabaseMigrationJobAdvisorReportDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseMigrationJobAdvisorReportDataSource-", DatabaseMigrationJobAdvisorReportDataSource(), s.D))
