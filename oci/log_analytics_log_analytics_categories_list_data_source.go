...
func init() {
	RegisterDatasource("oci_log_analytics_log_analytics_categories_list", LogAnalyticsLogAnalyticsCategoriesListDataSource())
}
...
func (s *LogAnalyticsLogAnalyticsCategoriesListDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("LogAnalyticsLogAnalyticsCategoriesListDataSource-", LogAnalyticsLogAnalyticsCategoriesListDataSource(), s.D))
