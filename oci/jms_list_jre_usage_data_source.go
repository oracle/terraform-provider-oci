...
func init() {
	RegisterDatasource("oci_jms_list_jre_usage", JmsListJreUsageDataSource())
}
...
func (s *JmsListJreUsageDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("JmsListJreUsageDataSource-", JmsListJreUsageDataSource(), s.D))
