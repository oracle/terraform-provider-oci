...
func init() {
	RegisterDatasource("oci_kms_replication_status", KmsReplicationStatusDataSource())
}
...
func (s *KmsReplicationStatusDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("KmsReplicationStatusDataSource-", KmsReplicationStatusDataSource(), s.D))
