...
func init() {
	tf_provider.RegisterDatasource("oci_analytics_analytics_instance", AnalyticsAnalyticsInstanceDataSource())
}
...
func AnalyticsAnalyticsInstanceDataSource() *schema.Resource {
	...
	return tf_provider.GetSingularDataSourceItemSchema(AnalyticsAnalyticsInstanceResource(), fieldMap, readSingularAnalyticsAnalyticsInstance)
}
