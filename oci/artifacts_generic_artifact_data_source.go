...
func init() {
	RegisterDatasource("oci_artifacts_generic_artifact", ArtifactsGenericArtifactDataSource())
}
...
func ArtifactsGenericArtifactDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(ArtifactsGenericArtifactResource(), fieldMap, readSingularArtifactsGenericArtifact)
}
