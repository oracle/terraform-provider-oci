...
import (
	...
	"github.com/oracle/oci-go-sdk/v34/apigateway"
	oci_apigateway "github.com/oracle/oci-go-sdk/v34/apigateway"
)

func init() {
	RegisterDatasource("oci_apigateway_api_deployment_specification", ApigatewayApiDeploymentSpecificationDataSource())
}
