...
func init() {
	RegisterDatasource("oci_database_migration_job", DatabaseMigrationJobDataSource())
}
...
func DatabaseMigrationJobDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatabaseMigrationJobResource(), fieldMap, readSingularDatabaseMigrationJob)
}
