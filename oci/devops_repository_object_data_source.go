...
func init() {
	RegisterDatasource("oci_devops_repository_object", DevopsRepositoryObjectDataSource())
}
...
func (s *DevopsRepositoryObjectDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DevopsRepositoryObjectDataSource-", DevopsRepositoryObjectDataSource(), s.D))
