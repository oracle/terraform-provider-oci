...
func init() {
	RegisterDatasource("oci_identity_tag_standard_tag_namespace_template", IdentityTagStandardTagNamespaceTemplateDataSource())
}
...
func (s *IdentityTagStandardTagNamespaceTemplateDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("IdentityTagStandardTagNamespaceTemplateDataSource-", IdentityTagStandardTagNamespaceTemplateDataSource(), s.D))
