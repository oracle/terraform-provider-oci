...
import (
	...
	oci_email "github.com/oracle/oci-go-sdk/v52/email"
)

func init() {
	RegisterDatasource("oci_email_email_domain", EmailEmailDomainDataSource())
}
...
func EmailEmailDomainDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(EmailEmailDomainResource(), fieldMap, readSingularEmailEmailDomain)
}
