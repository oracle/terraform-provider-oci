...
func init() {
	RegisterDatasource("oci_computeinstanceagent_instance_agent_plugin", ComputeinstanceagentInstanceAgentPluginDataSource())
}
...
func (s *ComputeinstanceagentInstanceAgentPluginDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("ComputeinstanceagentInstanceAgentPluginDataSource-", ComputeinstanceagentInstanceAgentPluginDataSource(), s.D))
