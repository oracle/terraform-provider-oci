...
func init() {
	RegisterDatasource("oci_core_drg_route_table_route_rules", CoreDrgRouteTableRouteRulesDataSource())
}
...
func (s *CoreDrgRouteTableRouteRulesDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("CoreDrgRouteTableRouteRulesDataSource-", CoreDrgRouteTableRouteRulesDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		resources = ApplyFilters(f.(*schema.Set), resources, CoreDrgRouteTableRouteRulesDataSource().Schema["drg_route_rules"].Elem.(*schema.Resource).Schema)
	}
