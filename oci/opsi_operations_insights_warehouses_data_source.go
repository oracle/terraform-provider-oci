...
func init() {
	RegisterDatasource("oci_opsi_operations_insights_warehouses", OpsiOperationsInsightsWarehousesDataSource())
}
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"items": {
							Type:     schema.TypeList,
							Computed: true,
							Elem:     GetDataSourceItemSchema(OpsiOperationsInsightsWarehouseResource()),
						},
					},
				},
			},
...
func (s *OpsiOperationsInsightsWarehousesDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("OpsiOperationsInsightsWarehousesDataSource-", OpsiOperationsInsightsWarehousesDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, OpsiOperationsInsightsWarehousesDataSource().Schema["operations_insights_warehouse_summary_collection"].Elem.(*schema.Resource).Schema)
		operationsInsightsWarehouse["items"] = items
	}
