...
func init() {
	RegisterDatasource("oci_optimizer_histories", OptimizerHistoriesDataSource())
}
...
func (s *OptimizerHistoriesDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("OptimizerHistoriesDataSource-", OptimizerHistoriesDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, OptimizerHistoriesDataSource().Schema["history_collection"].Elem.(*schema.Resource).Schema)
		history["items"] = items
	}
