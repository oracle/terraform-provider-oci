...
func init() {
	RegisterDatasource("oci_devops_repository", DevopsRepositoryDataSource())
}
...
func DevopsRepositoryDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DevopsRepositoryResource(), fieldMap, readSingularDevopsRepository)
}
