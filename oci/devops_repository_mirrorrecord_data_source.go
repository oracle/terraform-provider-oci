...
func init() {
	RegisterDatasource("oci_devops_repository_mirrorrecord", DevopsRepositoryMirrorrecordDataSource())
}
...
func (s *DevopsRepositoryMirrorrecordDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DevopsRepositoryMirrorrecordDataSource-", DevopsRepositoryMirrorrecordDataSource(), s.D))
