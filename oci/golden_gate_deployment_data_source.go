...
func init() {
	RegisterDatasource("oci_golden_gate_deployment", GoldenGateDeploymentDataSource())
}
...
func GoldenGateDeploymentDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(GoldenGateDeploymentResource(), fieldMap, readSingularGoldenGateDeployment)
}
