...
func init() {
	RegisterDatasource("oci_data_labeling_service_annotation_format", DataLabelingServiceAnnotationFormatDataSource())
}
...
func (s *DataLabelingServiceAnnotationFormatDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DataLabelingServiceAnnotationFormatDataSource-", DataLabelingServiceAnnotationFormatDataSource(), s.D))
