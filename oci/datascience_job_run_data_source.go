...
func init() {
	RegisterDatasource("oci_datascience_job_run", DatascienceJobRunDataSource())
}
...
func DatascienceJobRunDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatascienceJobRunResource(), fieldMap, readSingularDatascienceJobRun)
}
