...
func init() {
	RegisterResource("oci_operator_access_control_operator_control", OperatorAccessControlOperatorControlResource())
}
...
func createOperatorAccessControlOperatorControl(d *schema.ResourceData, m interface{}) error {
	...
	sync.D = d
	sync.Client = m.(*OracleClients).operatorControlClient()
...
func (s *OperatorAccessControlOperatorControlResourceCrud) Create() error {
	...
	request.RequestMetadata.RetryPolicy = GetRetryPolicy(s.DisableNotFoundRetries, "operator_access_control")
...
func (s *OperatorAccessControlOperatorControlResourceCrud) updateCompartment(compartment interface{}) error {
	...
	changeCompartmentRequest.RequestMetadata.RetryPolicy = GetRetryPolicy(s.DisableNotFoundRetries, "operator_access_control")
