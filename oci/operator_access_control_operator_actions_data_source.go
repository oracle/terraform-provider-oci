...
func init() {
	RegisterDatasource("oci_operator_access_control_operator_actions", OperatorAccessControlOperatorActionsDataSource())
}
...
func (s *OperatorAccessControlOperatorActionsDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("OperatorAccessControlOperatorActionsDataSource-", OperatorAccessControlOperatorActionsDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, OperatorAccessControlOperatorActionsDataSource().Schema["operator_action_collection"].Elem.(*schema.Resource).Schema)
		operatorAction["items"] = items
	}
