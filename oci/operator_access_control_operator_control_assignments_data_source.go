...
func init() {
	RegisterDatasource("oci_operator_access_control_operator_control_assignments", OperatorAccessControlOperatorControlAssignmentsDataSource())
}
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"items": {
							Type:     schema.TypeList,
							Computed: true,
							Elem:     GetDataSourceItemSchema(OperatorAccessControlOperatorControlAssignmentResource()),
						},
					},
				},
			},
...
func (s *OperatorAccessControlOperatorControlAssignmentsDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("OperatorAccessControlOperatorControlAssignmentsDataSource-", OperatorAccessControlOperatorControlAssignmentsDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, OperatorAccessControlOperatorControlAssignmentsDataSource().Schema["operator_control_assignment_collection"].Elem.(*schema.Resource).Schema)
		operatorControlAssignment["items"] = items
	}
