...
func init() {
	RegisterDatasource("oci_opsi_operations_insights_warehouse_user", OpsiOperationsInsightsWarehouseUserDataSource())
}
...
func OpsiOperationsInsightsWarehouseUserDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(OpsiOperationsInsightsWarehouseUserResource(), fieldMap, readSingularOpsiOperationsInsightsWarehouseUser)
}
