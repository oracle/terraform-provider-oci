...
func init() {
	RegisterDatasource("oci_identity_tag_standard_tag_namespace_templates", IdentityTagStandardTagNamespaceTemplatesDataSource())
}
...
func (s *IdentityTagStandardTagNamespaceTemplatesDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("IdentityTagStandardTagNamespaceTemplatesDataSource-", IdentityTagStandardTagNamespaceTemplatesDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		resources = ApplyFilters(f.(*schema.Set), resources, IdentityTagStandardTagNamespaceTemplatesDataSource().Schema["standard_tag_namespace_templates"].Elem.(*schema.Resource).Schema)
	}
