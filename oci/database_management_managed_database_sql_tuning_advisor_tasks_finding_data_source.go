...
func init() {
	RegisterDatasource("oci_database_management_managed_database_sql_tuning_advisor_tasks_finding", DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksFindingDataSource())
}
...
func (s *DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksFindingDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksFindingDataSource-", DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksFindingDataSource(), s.D))
