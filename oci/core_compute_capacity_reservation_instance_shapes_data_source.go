...
func init() {
	RegisterDatasource("oci_core_compute_capacity_reservation_instance_shapes", CoreComputeCapacityReservationInstanceShapesDataSource())
}
...
func (s *CoreComputeCapacityReservationInstanceShapesDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("CoreComputeCapacityReservationInstanceShapesDataSource-", CoreComputeCapacityReservationInstanceShapesDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		resources = ApplyFilters(f.(*schema.Set), resources, CoreComputeCapacityReservationInstanceShapesDataSource().Schema["compute_capacity_reservation_instance_shapes"].Elem.(*schema.Resource).Schema)
	}
