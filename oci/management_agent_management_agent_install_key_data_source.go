...
func init() {
	RegisterDatasource("oci_management_agent_management_agent_install_key", ManagementAgentManagementAgentInstallKeyDataSource())
}
...
func ManagementAgentManagementAgentInstallKeyDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(ManagementAgentManagementAgentInstallKeyResource(), fieldMap, readSingularManagementAgentManagementAgentInstallKey)
}
