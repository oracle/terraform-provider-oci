...
func init() {
	RegisterDatasource("oci_apm_synthetics_script", ApmSyntheticsScriptDataSource())
}
...
func ApmSyntheticsScriptDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(ApmSyntheticsScriptResource(), fieldMap, readSingularApmSyntheticsScript)
}
