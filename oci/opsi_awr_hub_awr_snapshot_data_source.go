...
func init() {
	RegisterDatasource("oci_opsi_awr_hub_awr_snapshot", OpsiAwrHubAwrSnapshotDataSource())
}
...
func (s *OpsiAwrHubAwrSnapshotDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("OpsiAwrHubAwrSnapshotDataSource-", OpsiAwrHubAwrSnapshotDataSource(), s.D))
