...
func init() {
	RegisterDatasource("oci_data_safe_security_assessment_findings", DataSafeSecurityAssessmentFindingsDataSource())
}
...
func (s *DataSafeSecurityAssessmentFindingsDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DataSafeSecurityAssessmentFindingsDataSource-", DataSafeSecurityAssessmentFindingsDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		resources = ApplyFilters(f.(*schema.Set), resources, DataSafeSecurityAssessmentFindingsDataSource().Schema["findings"].Elem.(*schema.Resource).Schema)
	}
