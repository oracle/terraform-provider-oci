...
func init() {
	RegisterDatasource("oci_certificates_management_certificate_version", CertificatesManagementCertificateVersionDataSource())
}
...
func (s *CertificatesManagementCertificateVersionDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("CertificatesManagementCertificateVersionDataSource-", CertificatesManagementCertificateVersionDataSource(), s.D))
