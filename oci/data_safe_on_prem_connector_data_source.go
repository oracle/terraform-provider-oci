...
func init() {
	RegisterDatasource("oci_data_safe_on_prem_connector", DataSafeOnPremConnectorDataSource())
}
...
func DataSafeOnPremConnectorDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DataSafeOnPremConnectorResource(), fieldMap, readSingularDataSafeOnPremConnector)
}
