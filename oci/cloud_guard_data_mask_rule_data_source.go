...
func init() {
	RegisterDatasource("oci_cloud_guard_data_mask_rule", CloudGuardDataMaskRuleDataSource())
}
...
func CloudGuardDataMaskRuleDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(CloudGuardDataMaskRuleResource(), fieldMap, readSingularCloudGuardDataMaskRule)
}
