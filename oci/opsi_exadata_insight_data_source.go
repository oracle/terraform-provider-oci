...
func init() {
	RegisterDatasource("oci_opsi_exadata_insight", OpsiExadataInsightDataSource())
}
...
func OpsiExadataInsightDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(OpsiExadataInsightResource(), fieldMap, readSingularOpsiExadataInsight)
}
...
func (s *OpsiExadataInsightDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("OpsiExadataInsightsSingularDataSource-", OpsiExadataInsightDataSource(), s.D))
