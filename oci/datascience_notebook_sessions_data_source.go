...
import (
	...
	oci_datascience "github.com/oracle/oci-go-sdk/v28/datascience"
)
...
func (s *DatascienceNotebookSessionsDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatascienceNotebookSessionsDataSource-", DatascienceNotebookSessionsDataSource(), s.D))
