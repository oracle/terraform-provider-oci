...
func init() {
	RegisterDatasource("oci_cloud_guard_managed_list", CloudGuardManagedListDataSource())
}
...
func CloudGuardManagedListDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(CloudGuardManagedListResource(), fieldMap, readSingularCloudGuardManagedList)
}
