...
func init() {
	RegisterDatasource("oci_database_tools_database_tools_connection", DatabaseToolsDatabaseToolsConnectionDataSource())
}
...
func DatabaseToolsDatabaseToolsConnectionDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatabaseToolsDatabaseToolsConnectionResource(), fieldMap, readSingularDatabaseToolsDatabaseToolsConnection)
}
...
func (s *DatabaseToolsDatabaseToolsConnectionDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseToolsDatabaseToolsConnectionDataSource-", DatabaseToolsDatabaseToolsConnectionDataSource(), s.D))
