...
import (
	...
	oci_optimizer "github.com/oracle/oci-go-sdk/v29/optimizer"
)

func init() {
	RegisterDatasource("oci_optimizer_recommendation", OptimizerRecommendationDataSource())
}
...
func OptimizerRecommendationDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(OptimizerRecommendationResource(), fieldMap, readSingularOptimizerRecommendation)
}
