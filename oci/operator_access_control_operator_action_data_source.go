...
func init() {
	RegisterDatasource("oci_operator_access_control_operator_action", OperatorAccessControlOperatorActionDataSource())
}
...
func readSingularOperatorAccessControlOperatorAction(d *schema.ResourceData, m interface{}) error {
	...
	sync.D = d
	sync.Client = m.(*OracleClients).operatorActionsClient()
