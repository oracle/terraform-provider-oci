...
func init() {
	RegisterDatasource("oci_dataflow_private_endpoint", DataflowPrivateEndpointDataSource())
}
...
func DataflowPrivateEndpointDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DataflowPrivateEndpointResource(), fieldMap, readSingularDataflowPrivateEndpoint)
}
