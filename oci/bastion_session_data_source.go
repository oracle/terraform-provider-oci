...
func init() {
	RegisterDatasource("oci_bastion_session", BastionSessionDataSource())
}
...
func BastionSessionDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(BastionSessionResource(), fieldMap, readSingularBastionSession)
}
