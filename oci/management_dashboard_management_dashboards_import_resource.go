...
import (
	...
	oci_management_dashboard "github.com/oracle/oci-go-sdk/v43/managementdashboard"
)

func init() {
	RegisterResource("oci_management_dashboard_management_dashboards_import", ManagementDashboardManagementDashboardsImportResource())
}
...
func (s *ManagementDashboardManagementDashboardsImportResourceCrud) ID() string {
	return GenerateDataSourceHashID("ManagementDashboardManagementDashboardsImportResource-", ManagementDashboardManagementDashboardsImportResource(), s.D)
}
