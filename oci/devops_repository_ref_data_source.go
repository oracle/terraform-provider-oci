...
func init() {
	RegisterDatasource("oci_devops_repository_ref", DevopsRepositoryRefDataSource())
}
...
func DevopsRepositoryRefDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DevopsRepositoryRefResource(), fieldMap, readSingularDevopsRepositoryRef)
}
...
func (s *DevopsRepositoryRefDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DevopsRepositoryRefDataSource-", DevopsRepositoryRefDataSource(), s.D))
