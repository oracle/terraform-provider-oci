...
func init() {
	RegisterDatasource("oci_database_cloud_exadata_infrastructure", DatabaseCloudExadataInfrastructureDataSource())
}
...
func DatabaseCloudExadataInfrastructureDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatabaseCloudExadataInfrastructureResource(), fieldMap, readSingularDatabaseCloudExadataInfrastructure)
}
