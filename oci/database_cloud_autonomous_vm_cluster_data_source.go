...
func init() {
	RegisterDatasource("oci_database_cloud_autonomous_vm_cluster", DatabaseCloudAutonomousVmClusterDataSource())
}
...
func DatabaseCloudAutonomousVmClusterDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(DatabaseCloudAutonomousVmClusterResource(), fieldMap, readSingularDatabaseCloudAutonomousVmCluster)
}
