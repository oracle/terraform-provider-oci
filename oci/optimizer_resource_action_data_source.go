...
func init() {
	RegisterDatasource("oci_optimizer_resource_action", OptimizerResourceActionDataSource())
}
...
func OptimizerResourceActionDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(OptimizerResourceActionResource(), fieldMap, readSingularOptimizerResourceAction)
}
