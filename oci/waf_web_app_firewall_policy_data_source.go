...
func init() {
	RegisterDatasource("oci_waf_web_app_firewall_policy", WafWebAppFirewallPolicyDataSource())
}
...
func WafWebAppFirewallPolicyDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(WafWebAppFirewallPolicyResource(), fieldMap, readSingularWafWebAppFirewallPolicy)
}
