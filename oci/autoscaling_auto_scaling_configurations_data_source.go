...
import (
	...
	oci_auto_scaling "github.com/oracle/oci-go-sdk/v42/autoscaling"
)
...
func (s *AutoScalingAutoScalingConfigurationsDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("AutoScalingAutoScalingConfigurationsDataSource-", AutoScalingAutoScalingConfigurationsDataSource(), s.D))
