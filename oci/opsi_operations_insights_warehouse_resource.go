...
func init() {
	RegisterResource("oci_opsi_operations_insights_warehouse", OpsiOperationsInsightsWarehouseResource())
}
...
func (s *OpsiOperationsInsightsWarehouseResourceCrud) Create() error {
	...
	return s.getOperationsInsightsWarehouseFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "opsi"), oci_opsi.ActionTypeCreated, s.D.Timeout(schema.TimeoutCreate))
}
...
func operationsInsightsWarehouseWorkRequestShouldRetryFunc(timeout time.Duration) func(response oci_common.OCIOperationResponse) bool {
	...
	return func(response oci_common.OCIOperationResponse) bool {
		...
		if shouldRetry(response, false, "opsi", startTime) {
			return true
		}
...
func (s *OpsiOperationsInsightsWarehouseResourceCrud) Update() error {
	...
	workId := response.OpcWorkRequestId
	return s.getOperationsInsightsWarehouseFromWorkRequest(workId, GetRetryPolicy(s.DisableNotFoundRetries, "opsi"), oci_opsi.ActionTypeRelated, s.D.Timeout(schema.TimeoutUpdate))
}
