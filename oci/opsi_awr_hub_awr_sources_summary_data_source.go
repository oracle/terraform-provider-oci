...
func init() {
	RegisterDatasource("oci_opsi_awr_hub_awr_sources_summary", OpsiAwrHubAwrSourcesSummaryDataSource())
}
...
func (s *OpsiAwrHubAwrSourcesSummaryDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("OpsiAwrHubAwrSourcesSummaryDataSource-", OpsiAwrHubAwrSourcesSummaryDataSource(), s.D))
