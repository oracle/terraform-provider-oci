...
var (
	ca_cert1              = tf_common.GetEnvSettingWithBlankDefault("ca_cert1")
	private_key_1_no_pass = tf_common.GetEnvSettingWithBlankDefault("private_key_1_no_pass")
	public_cert_1_no_pass = tf_common.GetEnvSettingWithBlankDefault("public_cert_1_no_pass")

	ca_cert2           = tf_common.GetEnvSettingWithBlankDefault("ca_cert2")
	private_key_2_pass = tf_common.GetEnvSettingWithBlankDefault("private_key_2_pass")
	public_cert_2_pass = tf_common.GetEnvSettingWithBlankDefault("public_cert_2_pass")
	passphrase_2       = tf_common.GetEnvSettingWithBlankDefault("passphrase_2")
	...
	AnalyticsInstanceVanityUrlRequiredOnlyResource = AnalyticsInstanceVanityUrlResourceDependencies +
		tf_common.GenerateResourceFromRepresentationMap("oci_analytics_analytics_instance_vanity_url", "test_analytics_instance_vanity_url", tf_common.Required, tf_common.Create, analyticsInstanceVanityUrlRepresentation1)
	...
	analyticsInstanceVanityUrlRepresentation1 = map[string]interface{}{
		...
		"ca_certificate":     tf_common.Representation{RepType: tf_common.Required, Create: ca_cert1, Update: ca_cert2},
		"hosts":              tf_common.Representation{RepType: tf_common.Required, Create: []string{`test1.robcorobotics.com`}},
		"private_key":        tf_common.Representation{RepType: tf_common.Required, Create: private_key_1_no_pass, Update: private_key_2_pass},
		"public_certificate": tf_common.Representation{RepType: tf_common.Required, Create: public_cert_1_no_pass, Update: public_cert_2_pass},
		"description":        tf_common.Representation{RepType: tf_common.Optional, Create: `description`},
		"passphrase":         tf_common.Representation{RepType: tf_common.Optional, Create: ``, Update: passphrase_2},
	}

	analyticsInstanceVanityUrlRepresentation2 = map[string]interface{}{
		"analytics_instance_id": tf_common.Representation{RepType: tf_common.Required, Create: `${oci_analytics_analytics_instance.test_analytics_instance.id}`},
		"ca_certificate":        tf_common.Representation{RepType: tf_common.Required, Create: ca_cert2, Update: ca_cert1},
		"hosts":                 tf_common.Representation{RepType: tf_common.Required, Create: []string{`test1.robcorobotics.com`}},
		"private_key":           tf_common.Representation{RepType: tf_common.Required, Create: private_key_2_pass, Update: private_key_1_no_pass},
		"public_certificate":    tf_common.Representation{RepType: tf_common.Required, Create: public_cert_2_pass, Update: public_cert_1_no_pass},
		"description":           tf_common.Representation{RepType: tf_common.Optional, Create: `description`},
		"passphrase":            tf_common.Representation{RepType: tf_common.Optional, Create: passphrase_2, Update: ``},
	}

	AnalyticsInstanceVanityUrlResourceDependencies = tf_common.GenerateResourceFromRepresentationMap("oci_analytics_analytics_instance", "test_analytics_instance", tf_common.Required, tf_common.Create, analyticsInstanceRepresentation)
)

func getEnvWithNewlineExpansion(env_variable string) string {
	return strings.ReplaceAll(tf_common.GetEnvSettingWithBlankDefault(env_variable), "\\n", "\n")
}
...
func TestAnalyticsAnalyticsInstanceVanityUrlResource_basic(t *testing.T) {
	...
	tf_common.SaveConfigContent(config+compartmentIdVariableStr+AnalyticsInstanceVanityUrlResourceDependencies+
		tf_common.GenerateResourceFromRepresentationMap("oci_analytics_analytics_instance_vanity_url", "test_analytics_instance_vanity_url", tf_common.Optional, tf_common.Create, analyticsInstanceVanityUrlRepresentation2), "analytics", "analyticsInstanceVanityUrl", t)

	tf_common.ResourceTest(t, testAccCheckAnalyticsAnalyticsInstanceVanityUrlDestroy, []resource.TestStep{
		// verify Create
		{
		...
		{
			Config: config + compartmentIdVariableStr + idcsAccessTokenVariableStr + AnalyticsInstanceVanityUrlResourceDependencies +
				tf_common.GenerateResourceFromRepresentationMap("oci_analytics_analytics_instance_vanity_url", "test_analytics_instance_vanity_url", tf_common.Optional, tf_common.Create, analyticsInstanceVanityUrlRepresentation2),
			Check: tf_common.ComposeAggregateTestCheckFuncWrapper(
				resource.TestCheckResourceAttrSet(resourceName, "analytics_instance_id"),
		...
		{
			Config: config + compartmentIdVariableStr + idcsAccessTokenVariableStr + AnalyticsInstanceVanityUrlResourceDependencies +
				tf_common.GenerateResourceFromRepresentationMap("oci_analytics_analytics_instance_vanity_url", "test_analytics_instance_vanity_url", tf_common.Optional, tf_common.Update, analyticsInstanceVanityUrlRepresentation2),
			Check: tf_common.ComposeAggregateTestCheckFuncWrapper(
				resource.TestCheckResourceAttrSet(resourceName, "analytics_instance_id"),
				resource.TestCheckResourceAttr(resourceName, "ca_certificate", ca_cert1_val),
				resource.TestCheckResourceAttr(resourceName, "description", "description"),
