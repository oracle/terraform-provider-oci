...
var (
	...
	tagDataSourceRepresentation = map[string]interface{}{
		...
		"filter":           acctest.RepresentationGroup{acctest.Required, tagDataSourceFilterRepresentation}}
	...
	tagRepresentation = map[string]interface{}{
		...
		"validator":        acctest.RepresentationGroup{acctest.Optional, tagValidatorRepresentation},
	}
