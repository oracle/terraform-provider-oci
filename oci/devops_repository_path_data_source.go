...
func init() {
	RegisterDatasource("oci_devops_repository_path", DevopsRepositoryPathDataSource())
}
...
func (s *DevopsRepositoryPathDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DevopsRepositoryPathDataSource-", DevopsRepositoryPathDataSource(), s.D))
