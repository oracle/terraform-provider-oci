...
func init() {
	RegisterDatasource("oci_database_management_managed_database_sql_tuning_advisor_tasks_recommendation", DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksRecommendationDataSource())
}
...
func (s *DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksRecommendationDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksRecommendationDataSource-", DatabaseManagementManagedDatabaseSqlTuningAdvisorTasksRecommendationDataSource(), s.D))
