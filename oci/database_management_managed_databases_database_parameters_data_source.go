...
func init() {
	RegisterDatasource("oci_database_management_managed_databases_database_parameters", DatabaseManagementManagedDatabasesDatabaseParametersDataSource())
}
...
func (s *DatabaseManagementManagedDatabasesDatabaseParametersDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseManagementManagedDatabasesDatabaseParametersDataSource-", DatabaseManagementManagedDatabasesDatabaseParametersDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		items = ApplyFiltersInCollection(f.(*schema.Set), items, DatabaseManagementManagedDatabasesDatabaseParametersDataSource().Schema["database_parameters_collection"].Elem.(*schema.Resource).Schema)
		managedDatabasesDatabaseParameter["items"] = items
	}
