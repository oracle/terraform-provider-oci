...
func init() {
	RegisterDatasource("oci_ai_anomaly_detection_data_asset", AiAnomalyDetectionDataAssetDataSource())
}
...
func AiAnomalyDetectionDataAssetDataSource() *schema.Resource {
	...
	return GetSingularDataSourceItemSchema(AiAnomalyDetectionDataAssetResource(), fieldMap, readSingularAiAnomalyDetectionDataAsset)
}
