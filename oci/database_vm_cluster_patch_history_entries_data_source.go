...
func init() {
	RegisterDatasource("oci_database_vm_cluster_patch_history_entries", DatabaseVmClusterPatchHistoryEntriesDataSource())
}
...
func (s *DatabaseVmClusterPatchHistoryEntriesDataSourceCrud) SetData() error {
	...
	s.D.SetId(GenerateDataSourceHashID("DatabaseVmClusterPatchHistoryEntriesDataSource-", DatabaseVmClusterPatchHistoryEntriesDataSource(), s.D))
	...
	if f, fOk := s.D.GetOkExists("filter"); fOk {
		resources = ApplyFilters(f.(*schema.Set), resources, DatabaseVmClusterPatchHistoryEntriesDataSource().Schema["patch_history_entries"].Elem.(*schema.Resource).Schema)
	}
